...
public class DiscreteSliderComponent extends SliderComponent {
   ...
   protected void updateMessage() {
      this.setMessage(this.messageProvider.apply(String.format("%." + this.decimalPlaces + "f", this.discreteValue())));
   }
   ...
   public static DiscreteSliderComponent parse(Element element) {
      ...
      return new DiscreteSliderComponent(
         Sizing.content(), UIParsing.parseDouble(element.getAttributeNode("min")), UIParsing.parseDouble(element.getAttributeNode("max"))
      );
   }
}
