...
public class ComponentMapImplMixin {
   @ModifyExpressionValue(
      ...
      at = {@At(
         value = "FIELD",
         target = "Lnet/minecraft/core/component/PatchedDataComponentMap;prototype:Lnet/minecraft/core/component/DataComponentMap;"
      )}
   )
   ...
   @WrapOperation(
      ...
      at = {@At(
         value = "INVOKE",
         target = "Lnet/minecraft/component/ComponentMap;equals(Ljava/lang/Object;)Z"
      ), @At(
         value = "INVOKE",
         target = "Lnet/minecraft/core/component/DataComponentMap;equals(Ljava/lang/Object;)Z"
      )}
   )
   private boolean prioritiseDerivedMap(DataComponentMap instance, Object object, Operation<Boolean> original) {
      return object instanceof DerivedComponentMap derivedComponentMap
         ? (Boolean)original.call(new Object[]{derivedComponentMap, instance})
         : (Boolean)original.call(new Object[]{instance, object});
   }
}
