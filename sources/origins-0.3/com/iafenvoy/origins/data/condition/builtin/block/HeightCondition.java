...
public record HeightCondition(Comparison comparison) implements BlockCondition {
   public static final MapCodec<HeightCondition> CODEC = RecordCodecBuilder.mapCodec(
      i -> i.group(Comparison.CODEC.forGetter(HeightCondition::comparison)).apply(i, HeightCondition::new)
   );
