...
public record TargetConditionCondition(EntityCondition condition) implements BiEntityCondition {
   public static final MapCodec<TargetConditionCondition> CODEC = RecordCodecBuilder.mapCodec(
      i -> i.group(EntityCondition.CODEC.fieldOf("condition").forGetter(TargetConditionCondition::condition)).apply(i, TargetConditionCondition::new)
   );
