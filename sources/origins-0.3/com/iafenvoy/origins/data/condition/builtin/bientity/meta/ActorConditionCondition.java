...
public record ActorConditionCondition(EntityCondition condition) implements BiEntityCondition {
   public static final MapCodec<ActorConditionCondition> CODEC = RecordCodecBuilder.mapCodec(
      i -> i.group(EntityCondition.CODEC.fieldOf("condition").forGetter(ActorConditionCondition::condition)).apply(i, ActorConditionCondition::new)
   );
