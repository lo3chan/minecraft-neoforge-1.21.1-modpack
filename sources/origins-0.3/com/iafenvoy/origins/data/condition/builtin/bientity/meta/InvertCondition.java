...
public record InvertCondition(BiEntityCondition condition) implements BiEntityCondition {
   public static final MapCodec<InvertCondition> CODEC = RecordCodecBuilder.mapCodec(
      i -> i.group(BiEntityCondition.CODEC.fieldOf("condition").forGetter(InvertCondition::condition)).apply(i, InvertCondition::new)
   );
