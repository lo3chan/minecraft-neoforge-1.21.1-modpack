...
public record ExplodeAction(float power, DestructionType destructionType, Optional<BlockCondition> indestructible, boolean createFire) implements EntityAction {
   ...
   public void execute(@NotNull Entity source) {
      ...
      if (!level.isClientSide()) {
         ...
         level.explode(
            null, level.damageSources().explosion(null, null), calculator, pos.x, pos.y, pos.z, this.power, this.createFire, ExplosionInteraction.MOB
         );
      }
   }
}
