...
public class ModifyEffectAmplifierPower extends Power implements ModifierPowerHelper {
   public static final MapCodec<ModifyEffectAmplifierPower> CODEC = RecordCodecBuilder.mapCodec(
      i -> i.group(
   ...
   public ModifyEffectAmplifierPower(Power.BaseSettings settings, List<Holder<MobEffect>> effect, List<Modifier> modifier) {
      super(settings);
      this.effect = effect;
