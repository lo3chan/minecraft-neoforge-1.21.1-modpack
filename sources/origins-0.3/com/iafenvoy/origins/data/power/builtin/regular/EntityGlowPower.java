...
public class EntityGlowPower extends Power implements GlowPowerHelper {
   public static final MapCodec<EntityGlowPower> CODEC = RecordCodecBuilder.mapCodec(
      i -> i.group(
            ...
            Codec.INT.optionalFieldOf("color", -1).forGetter(EntityGlowPower::getColor)
         )
   ...
   public EntityGlowPower(Power.BaseSettings settings, EntityCondition entityCondition, BiEntityCondition biEntityCondition, boolean useTeam, int color) {
      super(settings);
