...
public interface RegisterTooltipComponentFactoryEvent {
   TypeTrackedEvent<TooltipComponent, RegisterTooltipComponentFactoryEvent> EVENT = EventFactory.createTypeTracked(
      RegisterTooltipComponentFactoryEvent.class, callbacks -> data -> {
   ...
   ClientTooltipComponent getComponent(TooltipComponent var1);
}
