...
public class StructureUtil {
   ...
   public static Pair<BlockPos, Holder<Structure>> findNearestMapStructure(
      ServerLevel serverLevel, HolderSet<Structure> structureHolderSet, BlockPos pos, int range, boolean findUnexplored
   ) {
      ...
      if (nearest == null) {
         ...
         return ((BlockPos)nearest.getFirst()).distManhattan(pos) <= 5000 ? nearest : null;
      }
   }
}
