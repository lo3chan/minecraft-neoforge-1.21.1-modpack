...
public class DAHugeMushroomFeatureConfiguration implements FeatureConfiguration {
   public static final Codec<DAHugeMushroomFeatureConfiguration> CODEC = RecordCodecBuilder.create(
   ...
   public DAHugeMushroomFeatureConfiguration(
      BlockStateProvider cap, BlockStateProvider stem, BlockStateProvider rootsProvider, int radius, int baseHeight, int randomHeight, int trunkRadius
   ) {
