...
public final class DATreeGrower {
   ...
   public static final TreeGrower CONBERRY = new TreeGrower("conberry", Optional.empty(), Optional.of(DAConfiguredFeatures.CONBERRY_TREE), Optional.empty());
   public static final TreeGrower YAGROOT = new TreeGrower(
      "yagroot", Optional.empty(), Optional.of(DAConfiguredFeatures.YAGROOT_TREE_CONFIGURATION), Optional.empty()
   );
   public static final TreeGrower CRUDEROOT = new TreeGrower(
      "cruderoot", Optional.empty(), Optional.of(DAConfiguredFeatures.CRUDEROOT_TREE_CONFIGURATION), Optional.empty()
   );
   public static final TreeGrower SUNROOT = new TreeGrower("sunroot", Optional.empty(), Optional.of(DAConfiguredFeatures.SUNROOT_TREE), Optional.empty());
}
