...
public class DABoatItem extends BoatItem {
   ...
   private DABoatEntity getBoat(Level level, HitResult hitResult) {
      return (DABoatEntity)(this.hasChest
         ? new DAChestBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z)
         : new DABoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z));
   }
}
