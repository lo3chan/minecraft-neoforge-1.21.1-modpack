...
public class Quail extends SittingAetherAnimal {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new TemptGoal(this, 1.0, itemStack -> itemStack.is(DATags.Items.QUAIL_FOOD), false));
      this.goalSelector.addGoal(4, new FollowParentGoal(this, 1.1));
      this.goalSelector.addGoal(5, new WaterAvoidingRandomStrollGoal(this, 1.0));
      this.goalSelector.addGoal(6, new LookAtPlayerGoal(this, Player.class, 6.0F));
      this.goalSelector.addGoal(7, new RandomLookAroundGoal(this));
      this.goalSelector.addGoal(8, new SittingAetherAnimal.RandomSittingGoal(this));
   }

   public static Builder createAttributes() {
      return createMobAttributes().add(Attributes.MAX_HEALTH, 6.0).add(Attributes.MOVEMENT_SPEED, 0.25);
   }

   public SpawnGroupData finalizeSpawn(
      ServerLevelAccessor levelAccessor, DifficultyInstance difficultyInstance, MobSpawnType spawnType, SpawnGroupData spawnGroupData
   ) {
   ...
   public void aiStep() {
      ...
      if (!this.level().isClientSide && this.isAlive() && !this.isBaby() && --this.eggTime <= 0) {
         ...
         this.spawnAtLocation((ItemLike)DAItems.QUAIL_EGG.get());
   ...
   public Quail getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
      Quail baby = (Quail)((EntityType)DAEntities.QUAIL.get()).create(serverLevel);
      if (baby != null) {
         baby.setVariant((QuailVariants)Util.getRandom(QuailVariants.values(), this.random));
      }
   ...
   protected SoundEvent getAmbientSound() {
      return (SoundEvent)DASounds.QUAIL_AMBIENT.get();
   }

   protected SoundEvent getHurtSound(DamageSource p_28262_) {
      return (SoundEvent)DASounds.QUAIL_HURT.get();
   }

   protected SoundEvent getDeathSound() {
      return (SoundEvent)DASounds.QUAIL_DEATH.get();
   }
   ...
   public QuailVariants getVariant() {
      return QuailVariants.byId(this.getTypeVariant() & 0xFF);
   }
