...
public class Venomite extends AetherAnimal implements NeutralMob, FlyingAnimal {
   ...
   protected void registerGoals() {
      this.goalSelector.addGoal(0, new Venomite.VenomiteAttackGoal(this, 1.399999976158142, true));
      this.goalSelector.addGoal(1, new FollowPlayerGoal(this, 1.0, 1.0));
      this.goalSelector.addGoal(2, new WaterAvoidingRandomFlyingGoal(this, 1.0));
      this.goalSelector.addGoal(3, new FloatGoal(this));
      this.targetSelector.addGoal(1, new Venomite.VenomiteHurtByOtherGoal(this).setAlertOthers(new Class[0]));
      this.targetSelector.addGoal(2, new Venomite.VenomiteBecomeAngryTargetGoal(this));
   ...
   public void remove(RemovalReason removalReason) {
      if (!this.level().isClientSide && this.isDeadOrDying() && this.random.nextBoolean()) {
         VenomiteBubble bubble = new VenomiteBubble((EntityType<? extends VenomiteBubble>)DAEntities.VENOMITE_BUBBLE.get(), this.level());
   ...
   public void aiStep() {
      super.aiStep();
      if (!this.level().isClientSide) {
         boolean flag = this.isAngry() && this.getTarget() != null && this.getTarget().distanceToSqr(this) < 4.0;
