...
public class DAPlacedFeatures {
   ...
   private static ResourceKey<PlacedFeature> createKey(String name) {
      return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath("deep_aether", name));
   }
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> context) {
      ...
      register(
         context,
         POISON_LAKE_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.POISON_LAKE_CONFIGURATION),
      ...
      register(
         context,
         POISON_SPRING_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.POISON_SPRING_CONFIGURATION),
      ...
      register(
         context,
         FALLEN_AERGLOW_FOREST,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.FALLEN_AERGLOW_TREE),
         CountPlacement.of(1),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         BiomeFilter.biome(),
      ...
      register(
         context,
         EMPTY_FALLEN_AERGLOW_FOREST,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.EMPTY_FALLEN_AERGLOW_TREE),
         CountPlacement.of(1),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         BiomeFilter.biome(),
      ...
      register(
         context,
         AERGLOW_FOREST_MUSHROOM_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.HUGE_LIGHTCAP_MUSHROOM),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(1, 0.1F, 1))
      );
      register(
         context,
         AERGLOW_FOREST_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ROSEROOT_AND_BLUE_ROSEROOT_TREES_PLACEMENT),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1))
      );
      register(
         context,
         GOLDEN_GROVE_TREES,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.SUNROOT_AND_CONBERRY_TREES_PLACEMENT),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(30, 0.1F, 1))
      );
      register(
         context,
         YAGROOT_SWAMP_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.YAGROOT_AND_CRUDEROOT_TREES_PLACEMENT),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(20, 0.1F, 2))
      );
      register(
         context,
         AETHER_MOSS_PATCHES,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AETHER_MOSS_PATCH_BONEMEAL),
         CountPlacement.of(5),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         InSquarePlacement.spread(),
         BiomeFilter.biome(),
      ...
      register(
         ...
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AETHER_COARSE_DIRT_PATCH),
         CountPlacement.of(1),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         InSquarePlacement.spread(),
         BiomeFilter.biome(),
      ...
      register(
         context,
         GOLDEN_VINES_PATCH,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.GOLDEN_VINES_PATCH),
         CountPlacement.of(9),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         BiomeFilter.biome(),
         new DungeonBlacklistFilter()
      ...
      register(
         ...
         configuredFeatures.getOrThrow(DAConfiguredFeatures.VIRULENT_QUICKSAND_PATCH),
         RarityFilter.onAverageOnceEvery(10),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         BiomeFilter.biome(),
         new DungeonBlacklistFilter()
      ...
      register(
         context,
         BLUE_AERGLOW_FOREST_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.BLUE_ROSEROOT_TREES_PLACEMENT),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1))
      );
      register(
         context,
         MYSTIC_AERGLOW_FOREST_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ROSEROOT_TREES_PLACEMENT),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(10, 0.1F, 1))
      );
      register(
         context,
         AERLAVENDER_PATCH,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERLAVENDER_PATCH),
         NoiseThresholdCountPlacement.of(-0.8, 5, 9),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         BiomeFilter.biome()
      );
      register(
         context,
         AETHER_CATTAIL_PATCH,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AETHER_CATTAILS_PATCH),
      ...
      register(
         context,
         AERGLOW_FOREST_FLOWERS,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ROSEROOT_FOREST_FLOWERS),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP,
         BiomeFilter.biome()
      );
      register(
         context,
         MYSTIC_AERGLOW_FOREST_FLOWERS,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.MYSTIC_ROSEROOT_FOREST_FLOWERS),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP,
         BiomeFilter.biome()
      );
      register(
         context,
         SKY_TULIPS,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.SKY_TULIPS),
         RarityFilter.onAverageOnceEvery(16),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome()
      );
      register(
         context,
         GOLDEN_ASPESS,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.GOLDEN_ASPESS),
         RarityFilter.onAverageOnceEvery(16),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome()
      );
      register(
         context,
         ECHAISY,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ECHAISY),
         RarityFilter.onAverageOnceEvery(16),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome()
      );
      register(
         context,
         AERGLOW_FOREST_GRASS,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ROSEROOT_FOREST_GRASS),
         CountPlacement.of(3),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP,
         BiomeFilter.biome()
      ...
      register(
         context,
         ASETERITE,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ASETERITE_CONFIGURATION),
      ...
      register(
         context,
         CLORITE,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.CLORITE_CONFIGURATION),
         NitrogenPlacedFeatureBuilders.commonOrePlacement(1, HeightRangePlacement.uniform(VerticalAnchor.aboveBottom(0), VerticalAnchor.belowTop(0)))
      );
      register(
         context,
         SKYJADE,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ORE_SKYJADE_CONFIGURATION),
      ...
      register(
         context,
         MORE_SKYJADE,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.ORE_MORE_SKYJADE_CONFIGURATION),
      ...
      register(
         context,
         GOLDEN_GRASS_PATCH,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.GOLDEN_GRASS_PATCH),
         NoiseThresholdCountPlacement.of(-0.8, 5, 9),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         BiomeFilter.biome()
      ...
      register(
         ...
         configuredFeatures.getOrThrow(DAConfiguredFeatures.GOLDEN_GROVE_GRASS_PATCH),
         NoiseThresholdCountPlacement.of(-0.8, 5, 9),
         InSquarePlacement.spread(),
         PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
         BiomeFilter.biome()
      ...
      register(
         context,
         STERLING_AERCLOUD_PLACEMENT,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.STERLING_AERCLOUD_CONFIGURATION),
         HeightRangePlacement.uniform(VerticalAnchor.absolute(200), VerticalAnchor.absolute(255)),
         ImprovedRarityFilter.onAverageOnceEvery(5.0E-4F),
         InSquarePlacement.spread(),
         BiomeFilter.biome(),
         new DungeonBlacklistFilter()
      );
      register(
         context,
         AERCLOUD_CLOUD,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERCLOUD_CLOUD),
      ...
      register(
         ...
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERCLOUD_CLOUD_OVERGROWN),
         HeightRangePlacement.uniform(VerticalAnchor.absolute(175), VerticalAnchor.absolute(175)),
         CountPlacement.of(1),
         BiomeFilter.biome()
      );
      register(
         context,
         AERCLOUD_RAIN_CLOUD,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERCLOUD_RAIN_CLOUD),
         HeightRangePlacement.uniform(VerticalAnchor.absolute(175), VerticalAnchor.absolute(175)),
         CountPlacement.of(1),
         BiomeFilter.biome()
      );
      register(
         context,
         AERCLOUD_ROOTS,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERCLOUD_ROOTS),
      ...
      register(
         context,
         TOTEM,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.TOTEM),
         CountPlacement.of(1),
         InSquarePlacement.spread(),
         HeightmapPlacement.onHeightmap(Types.MOTION_BLOCKING_NO_LEAVES),
         BiomeFilter.biome()
      );
      register(
         context,
         PATCH_SQUASH,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.PATCH_SQUASH),
      ...
      register(
         ...
         configuredFeatures.getOrThrow(DAConfiguredFeatures.LUMINESCENT_SKYROOT_FOREST_TREES),
         CountPlacement.of(10),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome(),
         BiomeFilter.biome(),
         PlacementUtils.filteredByBlockSurvival((Block)AetherBlocks.SKYROOT_SAPLING.get()),
         new DungeonBlacklistFilter()
      );
      register(
         context,
         LUMINESCENT_SKYROOT_FOREST_VEGETATION,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.LUMINESCENT_SKYROOT_FOREST_VEGETATION),
         NoiseThresholdCountPlacement.of(-0.8, 1, 10),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 2), 4),
         BiomeFilter.biome()
      );
      register(
         context,
         AERCLOUD_TREES,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERCLOUD_TREE_CONFIGURATION),
         CountPlacement.of(1),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome(),
         BiomeFilter.biome(),
      ...
      register(
         ...
         configuredFeatures.getOrThrow(DAConfiguredFeatures.OVERGROWN_CLOUD_MUSHROOM_TREES),
         CountPlacement.of(2),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome(),
         BiomeFilter.biome(),
      ...
      register(
         context,
         AERCLOUD_GRASS,
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERCLOUD_GRASS),
         NoiseThresholdCountPlacement.of(-0.8, 5, 9),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome(),
         new DungeonBlacklistFilter()
      ...
      register(
         ...
         configuredFeatures.getOrThrow(DAConfiguredFeatures.AERCLOUD_ROOTS_CARPET),
