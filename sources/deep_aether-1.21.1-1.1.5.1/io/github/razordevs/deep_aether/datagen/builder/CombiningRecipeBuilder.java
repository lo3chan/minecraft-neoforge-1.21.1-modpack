...
public class CombiningRecipeBuilder implements RecipeBuilder {
   ...
   public void save(RecipeOutput output, ResourceLocation location) {
      MoaFodder fodder = (MoaFodder)this.resultStack.get(DADataComponentTypes.MOA_FODDER);
      ...
      CombinerRecipe recipe = new CombinerRecipe(
         Objects.requireNonNullElse(this.group, ""), this.category, this.ingredients, this.resultStack, this.experience, this.processingTime
      );
