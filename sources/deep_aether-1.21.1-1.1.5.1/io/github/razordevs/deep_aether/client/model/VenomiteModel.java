...
public class VenomiteModel extends EntityModel<Venomite> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition head = partdefinition.addOrReplaceChild(
         "head",
         CubeListBuilder.create().texOffs(17, 19).addBox(-3.0F, -2.0F, -4.0F, 6.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 19.0F, -4.0F)
      );
      head.addOrReplaceChild(
         "head_r1",
         CubeListBuilder.create().texOffs(38, 16).addBox(1.0F, -12.0F, -10.5F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 7.0F, 4.0F, 0.0F, 0.3054F, 0.0F)
      );
      head.addOrReplaceChild(
         "head_r2",
         CubeListBuilder.create().texOffs(38, 16).addBox(-1.0F, -12.0F, -10.5F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
      ...
      PartDefinition body = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 22)
            .addBox(-2.0F, -3.0F, -4.0F, 4.0F, 4.6F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(16, 26)
            .addBox(-2.0F, -2.3F, 0.0F, 4.0F, 3.5F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 19.0F, 0.0F)
      );
      body.addOrReplaceChild(
         "body_r1",
         CubeListBuilder.create().texOffs(0, 6).addBox(0.25F, -0.4F, -2.0F, 0.0F, 2.4F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-2.0F, 2.0F, -2.0F, 0.0F, 0.0F, -0.3491F)
      );
      body.addOrReplaceChild(
         "body_r2",
         CubeListBuilder.create().texOffs(0, 4).addBox(-0.25F, -0.4F, -2.0F, 0.0F, 2.4F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(2.0F, 2.0F, -2.0F, 0.0F, 0.0F, 0.3491F)
      );
      body.addOrReplaceChild(
         "tail",
         CubeListBuilder.create().texOffs(32, 27).addBox(0.0F, -6.0F, -1.0F, 0.0F, 8.0F, 13.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 0.0F, 3.0F)
      );
      body.addOrReplaceChild(
         "bubble",
         CubeListBuilder.create().texOffs(13, 8).addBox(-3.0F, -1.0F, -1.6F, 6.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
      ...
      wingsfront.addOrReplaceChild(
         "left",
         CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -2.0F, 12.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(2.0F, 0.0F, 0.0F)
      );
      wingsfront.addOrReplaceChild(
         "right",
         CubeListBuilder.create().texOffs(0, 4).addBox(-12.0F, 0.0F, -2.0F, 12.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-2.0F, 0.0F, 0.0F)
      );
      ...
      wingsback.addOrReplaceChild(
         "right2",
         CubeListBuilder.create().texOffs(0, 19).addBox(-9.0F, 0.0F, -2.0F, 9.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-2.0F, 0.0F, 0.0F)
      );
      wingsback.addOrReplaceChild(
         "left2",
         CubeListBuilder.create().texOffs(19, 16).addBox(0.0F, 0.0F, -2.0F, 9.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(2.0F, 0.0F, 0.0F)
      );
   ...
   public void setupAnim(Venomite entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (ageInTicks % 20.0F >= 10.0F) {
         ...
         this.tail.xRot = Mth.lerp(a, 0.25F, -0.1F);
      }
   }
