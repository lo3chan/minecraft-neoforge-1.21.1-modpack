...
public class ClassicAerwhaleModelLayer extends RenderLayer<Aerwhale, EntityModel<Aerwhale>> {
   private static final RenderType SADDLED_AERWHALE_CLASSIC = RenderType.armorCutoutNoCull(
      ResourceLocation.fromNamespaceAndPath("deep_aether", "textures/entity/aerwhale_saddled_classic.png")
   );
