...
public class ScarfModel extends HumanoidModel<LivingEntity> {
   ...
   public ScarfModel(ModelPart root) {
      ...
      this.body[3] = root.getChild("body_rot_3");
   }
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 16)
            .addBox(-2.0F, -1.5F, -1.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F))
            .texOffs(12, 0)
            .addBox(-2.0F, 0.5F, -3.0F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(16, 17)
            .addBox(0.0F, -2.5F, 0.0F, 0.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(6.0F, -2.0F, -2.0F)
      );
      ...
      body_3.addOrReplaceChild(
         ...
         PartPose.offsetAndRotation(-7.0F, -22.5F, 24.0F, 0.0F, 3.1416F, 0.0F)
      );
