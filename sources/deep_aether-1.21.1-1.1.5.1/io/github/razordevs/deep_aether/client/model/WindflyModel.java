...
public class WindflyModel extends EntityModel<Windfly> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      partdefinition.addOrReplaceChild(
         "body",
         CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.25F, -6.0F, 3.0F, 3.0F, 11.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-0.5F, 20.0F, 1.0F)
      );
      partdefinition.addOrReplaceChild(
         "leftWing",
         CubeListBuilder.create().texOffs(-34, 27).addBox(-1.25F, 0.0F, -8.25F, 23.0F, 0.0F, 34.0F, new CubeDeformation(0.0F)),
         PartPose.offset(1.5F, 19.0F, -0.75F)
      );
      partdefinition.addOrReplaceChild(
         "rightWing",
         CubeListBuilder.create().texOffs(-34, 27).mirror().addBox(-21.75F, 0.0F, -8.25F, 23.0F, 0.0F, 34.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offset(-1.5F, 19.0F, -0.75F)
      );
      partdefinition.addOrReplaceChild(
         "bb_main",
         CubeListBuilder.create()
            .texOffs(28, 0)
            .addBox(-1.5F, -2.25F, -5.0F, 3.0F, 3.0F, 11.0F, new CubeDeformation(0.0F))
            .texOffs(0, 14)
            .addBox(-1.5F, -7.0F, -7.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.1F)),
