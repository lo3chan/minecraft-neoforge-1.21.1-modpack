...
public class AerwhaleModelLayer extends RenderLayer<Aerwhale, EntityModel<Aerwhale>> {
   private static final RenderType SADDLED_AERWHALE = RenderType.armorCutoutNoCull(
      ResourceLocation.fromNamespaceAndPath("deep_aether", "textures/entity/aerwhale_saddled.png")
   );
