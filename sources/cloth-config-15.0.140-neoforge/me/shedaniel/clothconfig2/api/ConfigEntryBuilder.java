...
public interface ConfigEntryBuilder {
   ...
   default KeyCodeBuilder startKeyCodeField(Component fieldNameKey, Key value) {
   ...
   default <T> DropdownMenuBuilder<T> startDropdownMenu(
      Component fieldNameKey, T value, Function<String, T> toObjectFunction, DropdownBoxEntry.SelectionCellCreator<T> cellCreator
   ) {
   ...
   default <T> DropdownMenuBuilder<T> startDropdownMenu(
      ...
      Function<T, Component> toTextFunction,
   ...
   default <T> DropdownMenuBuilder<T> startDropdownMenu(
      Component fieldNameKey, T value, Function<String, T> toObjectFunction, Function<T, Component> toTextFunction
   ) {
      return this.startDropdownMenu(
         fieldNameKey,
   ...
   default DropdownMenuBuilder<String> startStringDropdownMenu(Component fieldNameKey, String value, DropdownBoxEntry.SelectionCellCreator<String> cellCreator) {
      return this.startDropdownMenu(fieldNameKey, DropdownMenuBuilder.TopCellElementBuilder.of(value, s -> s, Component::literal), cellCreator);
   }

   default DropdownMenuBuilder<String> startStringDropdownMenu(
      Component fieldNameKey, String value, Function<String, Component> toTextFunction, DropdownBoxEntry.SelectionCellCreator<String> cellCreator
   ) {
   ...
   default DropdownMenuBuilder<String> startStringDropdownMenu(Component fieldNameKey, String value) {
      return this.startDropdownMenu(
         fieldNameKey, DropdownMenuBuilder.TopCellElementBuilder.of(value, s -> s, Component::literal), new DropdownBoxEntry.DefaultSelectionCellCreator<>()
      );
   }
