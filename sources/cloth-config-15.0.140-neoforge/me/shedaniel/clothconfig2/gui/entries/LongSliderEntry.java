...
public class LongSliderEntry extends TooltipListEntry<Long> {
   ...
   public LongSliderEntry(
      Component fieldName, long minimum, long maximum, long value, Consumer<Long> saveConsumer, Component resetButtonKey, Supplier<Long> defaultValue
   ) {
   ...
   private class Slider extends AbstractSliderButton {
      ...
      protected void applyValue() {
         LongSliderEntry.this.value
            .set((long)(LongSliderEntry.this.minimum + Math.abs(LongSliderEntry.this.maximum - LongSliderEntry.this.minimum) * this.value));
      }
