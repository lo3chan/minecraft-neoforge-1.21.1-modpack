...
public class IntegerSliderEntry extends TooltipListEntry<Integer> {
   ...
   public IntegerSliderEntry(
      Component fieldName, int minimum, int maximum, int value, Component resetButtonKey, Supplier<Integer> defaultValue, Consumer<Integer> saveConsumer
   ) {
   ...
   public IntegerSliderEntry(
      ...
      this.resetButton = Button.builder(resetButtonKey, widget -> this.setValue(defaultValue.get()))
   ...
   public void setValue(int value) {
      this.sliderWidget.setValue((double)(Mth.clamp(value, this.minimum, this.maximum) - this.minimum) / Math.abs(this.maximum - this.minimum));
   ...
   private class Slider extends AbstractSliderButton {
      ...
      public void updateMessage() {
         this.setMessage(IntegerSliderEntry.this.textGetter.apply(IntegerSliderEntry.this.value.get()));
      }

      protected void applyValue() {
         IntegerSliderEntry.this.value
            .set((int)(IntegerSliderEntry.this.minimum + Math.abs(IntegerSliderEntry.this.maximum - IntegerSliderEntry.this.minimum) * this.value));
      }
