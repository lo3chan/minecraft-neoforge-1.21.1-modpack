...
public class KeyCodeBuilder extends FieldBuilder<ModifierKeyCode, KeyCodeEntry, KeyCodeBuilder> {
   ...
   public KeyCodeBuilder setErrorSupplier(@Nullable Function<Key, Optional<Component>> errorSupplier) {
   ...
   public KeyCodeBuilder setKeySaveConsumer(Consumer<Key> saveConsumer) {
      return this.setModifierSaveConsumer(keyCode -> saveConsumer.accept(keyCode.getKeyCode()));
   }

   public KeyCodeBuilder setDefaultValue(Supplier<Key> defaultValue) {
   ...
   public KeyCodeBuilder setDefaultValue(Key defaultValue) {
   ...
   public KeyCodeBuilder setKeyTooltipSupplier(@NotNull Function<Key, Optional<Component[]>> tooltipSupplier) {
