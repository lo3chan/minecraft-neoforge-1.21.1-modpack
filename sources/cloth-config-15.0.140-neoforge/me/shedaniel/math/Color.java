...
public final class Color {
   ...
   public static Color ofRGBA(float var0, float var1, float var2, float var3) {
      return ofRGBA((int)(var0 * 255.0F + 0.5), (int)(var1 * 255.0F + 0.5), (int)(var2 * 255.0F + 0.5), (int)(var3 * 255.0F + 0.5));
   }
   ...
   public static int HSBtoRGB(float var0, float var1, float var2) {
      ...
      if (var1 == 0.0F) {
         ...
         float var9;
         float var6 = (var9 = (var0 - (float)Math.floor(var0)) * 6.0F) - (float)Math.floor(var9);
   ...
   public final Color brighter(double var1) {
      ...
      if (var3 == 0 && var4 == 0 && var5 == 0) {
         ...
         return ofRGBA(
            Math.min((int)(var3 / (1.0 / var1)), 255), Math.min((int)(var4 / (1.0 / var1)), 255), Math.min((int)(var5 / (1.0 / var1)), 255), this.getAlpha()
         );
      }
   }
   ...
   public final Color darker(double var1) {
      return ofRGBA(
         Math.max((int)(this.getRed() * (1.0 / var1)), 0),
         Math.max((int)(this.getGreen() * (1.0 / var1)), 0),
         Math.max((int)(this.getBlue() * (1.0 / var1)), 0),
         this.getAlpha()
      );
   }
