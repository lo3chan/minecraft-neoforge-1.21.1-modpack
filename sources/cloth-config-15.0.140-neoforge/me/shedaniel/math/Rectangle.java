...
public class Rectangle implements Cloneable {
   ...
   public Rectangle intersection(Rectangle var1) {
      ...
      int var5 = var1.y;
      long var6;
      var6 = (var6 = var2) + this.width;
      long var8;
      var8 = (var8 = var3) + this.height;
      long var10;
      var10 = (var10 = var4) + var1.width;
      long var12;
      var12 = (var12 = var5) + var1.height;
      if (var2 < var4) {
         var2 = var4;
      }
   ...
   public Rectangle union(Rectangle var1) {
      long var2 = this.width;
      long var4 = this.height;
      if ((var2 | var4) < 0L) {
         return new Rectangle(var1);
      } else {
         long var6 = var1.width;
         long var8 = var1.height;
         if ((var6 | var8) < 0L) {
   ...
   public void add(int var1, int var2) {
      if ((this.width | this.height) < 0) {
         ...
         int var3 = this.x;
         int var4 = this.y;
         long var5 = this.width;
         long var7 = this.height;
         var5 += var3;
         var7 += var4;
         if (var3 > var1) {
            var3 = var1;
   ...
   public void grow(int var1, int var2) {
      long var3 = this.x;
      long var5 = this.y;
      long var7 = this.width;
      long var9 = this.height;
      var7 += var3;
      var9 += var5;
      var3 -= var1;
      var5 -= var2;
