...
public class DefaultGuiProviders {
   ...
   private static final Function<Enum<?>, Component> DEFAULT_NAME_PROVIDER = t -> Component.translatable(
   ...
   public static GuiRegistry apply(GuiRegistry registry) {
      ...
      registry.registerAnnotationProvider(
         (i18n, field, config, defaults, guiProvider) -> {
            ...
            return Collections.singletonList(
               ENTRY_BUILDER.startIntSlider(Component.translatable(i18n), Utils.getUnsafely(field, config, 0), (int)bounds.min(), (int)bounds.max())
      ...
      registry.registerAnnotationProvider(
         (i18n, field, config, defaults, guiProvider) -> {
            ConfigEntry.BoundedDiscrete bounds = field.getAnnotation(ConfigEntry.BoundedDiscrete.class);
            return Collections.singletonList(
               ENTRY_BUILDER.startLongSlider(Component.translatable(i18n), Utils.getUnsafely(field, config, 0L), bounds.min(), bounds.max())
                  .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
                  .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
                  .build()
            );
      ...
      registry.registerAnnotationProvider(
         (i18n, field, config, defaults, guiProvider) -> {
            ...
            return Collections.singletonList(
               ENTRY_BUILDER.startColorField(Component.translatable(i18n), Utils.getUnsafely(field, config, 0))
      ...
      registry.registerAnnotationProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startSubCategory(Component.translatable(i18n), getChildren(i18n, field, config, defaults, guiProvider))
      ...
      registry.registerPredicateProvider(
         (i18n, field, config, defaults, guiProvider) -> {
            ...
            return Collections.singletonList(
               ENTRY_BUILDER.startSelector(Component.translatable(i18n), enums, Utils.getUnsafely(field, config, Utils.getUnsafely(field, defaults)))
                  .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
                  .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
                  .build()
            );
      ...
      registry.registerPredicateProvider(
         (i18n, field, config, defaults, registry1) -> Collections.singletonList(
            ENTRY_BUILDER.startIntList(Component.translatable(i18n), Utils.getUnsafely(field, config))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerPredicateProvider(
         (i18n, field, config, defaults, registry1) -> Collections.singletonList(
            ENTRY_BUILDER.startLongList(Component.translatable(i18n), Utils.getUnsafely(field, config))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerPredicateProvider(
         (i18n, field, config, defaults, registry1) -> Collections.singletonList(
            ENTRY_BUILDER.startFloatList(Component.translatable(i18n), Utils.getUnsafely(field, config))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerPredicateProvider(
         (i18n, field, config, defaults, registry1) -> Collections.singletonList(
            ENTRY_BUILDER.startDoubleList(Component.translatable(i18n), Utils.getUnsafely(field, config))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerPredicateProvider(
         (i18n, field, config, defaults, registry1) -> Collections.singletonList(
            ENTRY_BUILDER.startStrList(Component.translatable(i18n), Utils.getUnsafely(field, config))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
                  ...
                  (elem, nestedListListEntry) -> {
                     if (elem == null) {
                        ...
                        return new MultiElementListEntry<>(
                           Component.translatable(classI13n),
                           newDefaultElemValue,
                        ...
                        return new MultiElementListEntry<>(
                           Component.translatable(classI13n), elem, getChildren(classI13n, fieldTypeParam, elem, defaultElemValue, registry1), true
                        );
                     }
                  }
               )
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startBooleanToggle(Component.translatable(i18n), Utils.getUnsafely(field, config, false))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .setYesNoTextSupplier(bool -> {
                  String key = i18n + ".boolean." + bool;
                  String translate = I18n.get(key, new Object[0]);
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startIntField(Component.translatable(i18n), Utils.getUnsafely(field, config, 0))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startIntList(Component.translatable(i18n), Lists.newArrayList((Integer[])Utils.getUnsafely(field, config, new Integer[0])))
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startLongField(Component.translatable(i18n), Utils.getUnsafely(field, config, 0L))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startLongList(Component.translatable(i18n), Lists.newArrayList((Long[])Utils.getUnsafely(field, config, new Long[0])))
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startFloatField(Component.translatable(i18n), Utils.getUnsafely(field, config, 0.0F))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startFloatList(Component.translatable(i18n), Lists.newArrayList((Float[])Utils.getUnsafely(field, config, new Float[0])))
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startFloatList(
                  Component.translatable(i18n), Lists.newArrayList(Arrays.asList(ArrayUtils.toObject(Utils.getUnsafely(field, config, new float[0]))))
               )
               .setDefaultValue(() -> defaults == null ? null : Lists.newArrayList(Arrays.asList(ArrayUtils.toObject(Utils.getUnsafely(field, defaults)))))
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startDoubleField(Component.translatable(i18n), Utils.getUnsafely(field, config, 0.0))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startDoubleList(Component.translatable(i18n), Lists.newArrayList((Double[])Utils.getUnsafely(field, config, new Double[0])))
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startDoubleList(
                  Component.translatable(i18n), Lists.newArrayList(Arrays.asList(ArrayUtils.toObject(Utils.getUnsafely(field, config, new double[0]))))
               )
               .setDefaultValue(() -> defaults == null ? null : Lists.newArrayList(Arrays.asList(ArrayUtils.toObject(Utils.getUnsafely(field, defaults)))))
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startStrField(Component.translatable(i18n), Utils.getUnsafely(field, config, ""))
               .setDefaultValue(() -> Utils.getUnsafely(field, defaults))
               .setSaveConsumer(newValue -> Utils.setUnsafely(field, config, newValue))
               .build()
         ),
      ...
      registry.registerTypeProvider(
         (i18n, field, config, defaults, guiProvider) -> Collections.singletonList(
            ENTRY_BUILDER.startStrList(Component.translatable(i18n), Lists.newArrayList((String[])Utils.getUnsafely(field, config, new String[0])))
