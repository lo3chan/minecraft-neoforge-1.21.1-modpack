...
public class ExampleInits {
   public static void exampleCommonInit() {
      ...
      AutoConfig.getConfigHolder(ExampleConfig.class).registerSaveListener((manager, data) -> InteractionResult.SUCCESS);
      AutoConfig.getConfigHolder(ExampleConfig.class).registerLoadListener((manager, newData) -> InteractionResult.SUCCESS);
   }
