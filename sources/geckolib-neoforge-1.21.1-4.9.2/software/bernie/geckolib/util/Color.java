...
public record Color(int argbInt) {
   ...
   public static Color ofRGBA(float r, float g, float b, float a) {
      return ofRGBA((int)(r * 255.0F + 0.5), (int)(g * 255.0F + 0.5F), (int)(b * 255.0F + 0.5F), (int)(a * 255.0F + 0.5F));
   }
   ...
   public static Color ofARGB(float a, float r, float g, float b) {
      return ofARGB((int)(a * 255.0F + 0.5F), (int)(r * 255.0F + 0.5), (int)(g * 255.0F + 0.5F), (int)(b * 255.0F + 0.5F));
   }
   ...
   public Color darker(float factor) {
      return ofRGBA(
         Math.max((int)(this.getRed() * (1.0F / factor)), 0),
         Math.max((int)(this.getGreen() * (1.0F / factor)), 0),
         Math.max((int)(this.getBlue() * (1.0F / factor)), 0),
         this.getAlpha()
      );
   }
