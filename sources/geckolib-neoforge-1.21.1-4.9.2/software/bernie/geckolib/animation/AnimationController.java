...
public class AnimationController<T extends GeoAnimatable> {
   ...
   protected PlayState handleAnimationState(AnimationState<T> state) {
      if (this.triggeredAnimation != null) {
         ...
         if (!this.hasAnimationFinished() && (!this.handlingTriggeredAnimations || this.getStateHandler().handle(state) == PlayState.CONTINUE)) {
      ...
      return this.getStateHandler().handle(state);
   }
                     ...
                     if (bone == null) {
                        ...
                        if (!rotationKeyFrames.xKeyframes().isEmpty()) {
                           boneAnimationQueue.addNextRotation(
                              ...
                              this.getAnimationPointAtTick(rotationKeyFrames.xKeyframes(), 0.0, true, Axis.X),
                              this.getAnimationPointAtTick(rotationKeyFrames.yKeyframes(), 0.0, true, Axis.Y),
                              this.getAnimationPointAtTick(rotationKeyFrames.zKeyframes(), 0.0, true, Axis.Z)
                           );
                        }
                        ...
                        if (!positionKeyFrames.xKeyframes().isEmpty()) {
                           boneAnimationQueue.addNextPosition(
                              ...
                              this.transitionLength,
                              boneSnapshot,
                              this.getAnimationPointAtTick(positionKeyFrames.xKeyframes(), 0.0, false, Axis.X),
                              this.getAnimationPointAtTick(positionKeyFrames.yKeyframes(), 0.0, false, Axis.Y),
                              this.getAnimationPointAtTick(positionKeyFrames.zKeyframes(), 0.0, false, Axis.Z)
                           );
                        }
                        ...
                        if (!scaleKeyFrames.xKeyframes().isEmpty()) {
                           boneAnimationQueue.addNextScale(
                              ...
                              this.transitionLength,
                              boneSnapshot,
                              this.getAnimationPointAtTick(scaleKeyFrames.xKeyframes(), 0.0, false, Axis.X),
                              this.getAnimationPointAtTick(scaleKeyFrames.yKeyframes(), 0.0, false, Axis.Y),
                              this.getAnimationPointAtTick(scaleKeyFrames.zKeyframes(), 0.0, false, Axis.Z)
                           );
                        }
                     }
                  }
         ...
         if (boneAnimationQueue == null) {
            ...
            if (!rotationKeyFrames.xKeyframes().isEmpty()) {
               boneAnimationQueue.addRotations(
                  this.getAnimationPointAtTick(rotationKeyFrames.xKeyframes(), adjustedTick, true, Axis.X),
                  this.getAnimationPointAtTick(rotationKeyFrames.yKeyframes(), adjustedTick, true, Axis.Y),
                  this.getAnimationPointAtTick(rotationKeyFrames.zKeyframes(), adjustedTick, true, Axis.Z)
               );
            }

            if (!positionKeyFrames.xKeyframes().isEmpty()) {
               boneAnimationQueue.addPositions(
                  this.getAnimationPointAtTick(positionKeyFrames.xKeyframes(), adjustedTick, false, Axis.X),
                  this.getAnimationPointAtTick(positionKeyFrames.yKeyframes(), adjustedTick, false, Axis.Y),
                  this.getAnimationPointAtTick(positionKeyFrames.zKeyframes(), adjustedTick, false, Axis.Z)
               );
            }

            if (!scaleKeyFrames.xKeyframes().isEmpty()) {
               boneAnimationQueue.addScales(
                  this.getAnimationPointAtTick(scaleKeyFrames.xKeyframes(), adjustedTick, false, Axis.X),
                  this.getAnimationPointAtTick(scaleKeyFrames.yKeyframes(), adjustedTick, false, Axis.Y),
                  this.getAnimationPointAtTick(scaleKeyFrames.zKeyframes(), adjustedTick, false, Axis.Z)
               );
            }
         }
      }
         ...
         if (adjustedTick >= keyframeDataxx.getStartTick() && this.executedKeyFrames.add(keyframeDataxx)) {
            if (this.customKeyframeHandler == null) {
               GeckoLibConstants.LOGGER
                  .log(
                     Level.WARN,
                     "Custom Instruction Keyframe found for "
                        + this.animatable.getClass().getSimpleName()
                        + " -> "
                        + this.getName()
                        + ", but no keyframe handler registered"
   ...
   private AnimationPoint getAnimationPointAtTick(List<Keyframe<MathValue>> frames, double tick, boolean isRotation, Axis axis) {
