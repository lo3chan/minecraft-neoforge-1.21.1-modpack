...
public abstract class HumanoidArmorLayerMixin<T extends LivingEntity, M extends HumanoidModel<T>, A extends HumanoidModel<T>> {
   ...
   public boolean geckolib$wrapArmorPieceRender(
      HumanoidArmorLayer<T, M, A> renderLayer,
      PoseStack poseStack,
      ...
      return !InternalUtil.tryRenderGeoArmorPiece(
         poseStack,
         bufferSource,
         entity,
         entity.getItemBySlot(equipmentSlot),
         equipmentSlot,
         (M)renderLayer.getParentModel(),
         baseModel,
         partialTick,
         packedLight,
         limbSwing,
