...
public record Bone(
   ...
   public static JsonDeserializer<Bone> deserializer() throws JsonParseException {
      return (json, type, context) -> {
         ...
         PolyMesh polyMesh = (PolyMesh)GsonHelper.getAsObject(obj, "poly_mesh", null, context, PolyMesh.class);
         ...
         TextureMesh[] textureMeshes = JsonUtil.jsonArrayToObjectArray(
            GsonHelper.getAsJsonArray(obj, "texture_meshes", new JsonArray(0)), context, TextureMesh.class
         );
         return new Bone(
            bindPoseRotation,
            cubes,
