...
public final class BiomeHooks {
   ...
   @ExpectPlatform
   @Transformed
   private static ClimateSettings extractClimateSettings(Biome biome) {
   ...
   public static class ClimateWrapped implements ClimateProperties.Mutable {
      ...
      public ClimateWrapped(ClimateSettings climateSettings) {
   ...
   public static class GenerationSettingsWrapped implements GenerationProperties {
      ...
      public Iterable<Holder<PlacedFeature>> getFeatures(Decoration decoration) {
         return (Iterable<Holder<PlacedFeature>>)(decoration.ordinal() >= this.settings.features().size()
            ? Collections.emptyList()
            : (Iterable)this.settings.features().get(decoration.ordinal()));
      }
   ...
   public static class MutableBiomeWrapped extends BiomeHooks.BiomeWrapped implements BiomeProperties.Mutable {
      public MutableBiomeWrapped(Biome biome, GenerationProperties.Mutable generationProperties, SpawnProperties.Mutable spawnProperties) {
         this(
            biome,
            new BiomeHooks.ClimateWrapped(BiomeHooks.extractClimateSettings(biome)),
            new BiomeHooks.EffectsWrapped(biome.getSpecialEffects()),
