...
public interface PacketTransformer {
   void inbound(
      NetworkManager.Side var1,
      ResourceLocation var2,
      RegistryFriendlyByteBuf var3,
      NetworkManager.PacketContext var4,
      PacketTransformer.TransformationSink var5
   );

   void outbound(NetworkManager.Side var1, ResourceLocation var2, RegistryFriendlyByteBuf var3, PacketTransformer.TransformationSink var4);
   ...
   public interface TransformationSink {
      void accept(NetworkManager.Side var1, ResourceLocation var2, RegistryFriendlyByteBuf var3);
   }
}
