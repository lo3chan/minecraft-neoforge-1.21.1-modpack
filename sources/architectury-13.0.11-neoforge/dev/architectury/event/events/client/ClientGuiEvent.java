...
public interface ClientGuiEvent {
   ...
   public interface RenderHud {
      void renderHud(GuiGraphics var1, DeltaTracker var2);
   }
   ...
   public interface ScreenRenderPost {
      void render(Screen var1, GuiGraphics var2, int var3, int var4, DeltaTracker var5);
   }

   @OnlyIn(Dist.CLIENT)
   public interface ScreenRenderPre {
      EventResult render(Screen var1, GuiGraphics var2, int var3, int var4, DeltaTracker var5);
   }
