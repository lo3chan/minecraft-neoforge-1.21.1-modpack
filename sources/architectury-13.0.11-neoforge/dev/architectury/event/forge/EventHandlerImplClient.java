...
public class EventHandlerImplClient {
   ...
   public static void event(Pre event) {
   ...
   public static void event(Post event) {
   ...
   public static void eventRenderGameOverlayEvent(net.neoforged.neoforge.client.event.RenderGuiEvent.Post event) {
   ...
   public static void event(LoggingIn event) {
   ...
   public static void event(LoggingOut event) {
   ...
   public static void eventInitScreenEvent(net.neoforged.neoforge.client.event.ScreenEvent.Init.Pre event) {
   ...
   public static void eventInitScreenEvent(net.neoforged.neoforge.client.event.ScreenEvent.Init.Post event) {
   ...
   public static void eventRenderGameOverlayEvent(DebugText event) {
   ...
   public static void event(ClientChatReceivedEvent event) {
      CompoundEventResult<Component> process = dev.architectury.event.events.client.ClientChatEvent.RECEIVED
         .invoker()
         .process(event.getBoundChatType(), event.getMessage());
   ...
   public static void eventWorldEvent(Load event) {
   ...
   public static void event(Opening event) {
   ...
   public static void eventDrawScreenEvent(net.neoforged.neoforge.client.event.ScreenEvent.Render.Pre event) {
      if (ClientGuiEvent.RENDER_PRE
         .invoker()
         .render(event.getScreen(), event.getGuiGraphics(), event.getMouseX(), event.getMouseY(), Minecraft.getInstance().getTimer())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventDrawScreenEvent(net.neoforged.neoforge.client.event.ScreenEvent.Render.Post event) {
      ClientGuiEvent.RENDER_POST
         .invoker()
         .render(event.getScreen(), event.getGuiGraphics(), event.getMouseX(), event.getMouseY(), Minecraft.getInstance().getTimer());
   }
   ...
   public static void eventContainerScreenEvent(Background event) {
      ClientGuiEvent.RENDER_CONTAINER_BACKGROUND
         .invoker()
         .render(
            event.getContainerScreen(),
   ...
   public static void eventContainerScreenEvent(Foreground event) {
      ClientGuiEvent.RENDER_CONTAINER_FOREGROUND
         .invoker()
         .render(
            event.getContainerScreen(),
            event.getGuiGraphics(),
   ...
   public static void eventPlayerInteractEvent(RightClickEmpty event) {
   ...
   public static void eventPlayerInteractEvent(LeftClickEmpty event) {
   ...
   public static void eventRenderTooltipEvent(net.neoforged.neoforge.client.event.RenderTooltipEvent.Pre event) {
   ...
   public static void eventRenderTooltipEvent(Color event) {
      GuiGraphics graphics = event.getGraphics();
      ClientTooltipEvent.additionalContexts().setItem(event.getItemStack());
   ...
   public static void eventMouseScrollEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseScrolled.Pre event) {
      if (ClientScreenInputEvent.MOUSE_SCROLLED_PRE
         .invoker()
         .mouseScrolled(Minecraft.getInstance(), event.getScreen(), event.getMouseX(), event.getMouseY(), event.getScrollDeltaX(), event.getScrollDeltaY())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventMouseScrollEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseScrolled.Post event) {
      ClientScreenInputEvent.MOUSE_SCROLLED_POST
         .invoker()
         .mouseScrolled(Minecraft.getInstance(), event.getScreen(), event.getMouseX(), event.getMouseY(), event.getScrollDeltaX(), event.getScrollDeltaY());
   }
   ...
   public static void eventMouseClickedEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseButtonPressed.Pre event) {
      if (ClientScreenInputEvent.MOUSE_CLICKED_PRE
         .invoker()
         .mouseClicked(Minecraft.getInstance(), event.getScreen(), event.getMouseX(), event.getMouseY(), event.getButton())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventMouseClickedEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseButtonPressed.Post event) {
   ...
   public static void eventMouseDragEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseDragged.Pre event) {
      if (ClientScreenInputEvent.MOUSE_DRAGGED_PRE
         .invoker()
         .mouseDragged(
            Minecraft.getInstance(), event.getScreen(), event.getMouseX(), event.getMouseY(), event.getMouseButton(), event.getDragX(), event.getDragY()
         )
         .isFalse()) {
         event.setCanceled(true);
      }
   ...
   public static void eventMouseDragEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseDragged.Post event) {
   ...
   public static void eventMouseReleasedEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseButtonReleased.Pre event) {
      if (ClientScreenInputEvent.MOUSE_RELEASED_PRE
         .invoker()
         .mouseReleased(Minecraft.getInstance(), event.getScreen(), event.getMouseX(), event.getMouseY(), event.getButton())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventMouseReleasedEvent(net.neoforged.neoforge.client.event.ScreenEvent.MouseButtonReleased.Post event) {
      ClientScreenInputEvent.MOUSE_RELEASED_PRE
         .invoker()
         .mouseReleased(Minecraft.getInstance(), event.getScreen(), event.getMouseX(), event.getMouseY(), event.getButton());
   }
   ...
   public static void eventKeyboardCharTypedEvent(net.neoforged.neoforge.client.event.ScreenEvent.CharacterTyped.Pre event) {
      if (ClientScreenInputEvent.CHAR_TYPED_PRE
         .invoker()
         .charTyped(Minecraft.getInstance(), event.getScreen(), event.getCodePoint(), event.getModifiers())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventKeyboardCharTypedEvent(net.neoforged.neoforge.client.event.ScreenEvent.CharacterTyped.Post event) {
   ...
   public static void eventKeyboardKeyPressedEvent(net.neoforged.neoforge.client.event.ScreenEvent.KeyPressed.Pre event) {
      if (ClientScreenInputEvent.KEY_PRESSED_PRE
         .invoker()
         .keyPressed(Minecraft.getInstance(), event.getScreen(), event.getKeyCode(), event.getScanCode(), event.getModifiers())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventKeyboardKeyPressedEvent(net.neoforged.neoforge.client.event.ScreenEvent.KeyPressed.Post event) {
      ClientScreenInputEvent.KEY_PRESSED_POST
         .invoker()
         .keyPressed(Minecraft.getInstance(), event.getScreen(), event.getKeyCode(), event.getScanCode(), event.getModifiers());
   }
   ...
   public static void eventKeyboardKeyReleasedEvent(net.neoforged.neoforge.client.event.ScreenEvent.KeyReleased.Pre event) {
      if (ClientScreenInputEvent.KEY_RELEASED_PRE
         .invoker()
         .keyReleased(Minecraft.getInstance(), event.getScreen(), event.getKeyCode(), event.getScanCode(), event.getModifiers())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventKeyboardKeyReleasedEvent(net.neoforged.neoforge.client.event.ScreenEvent.KeyReleased.Post event) {
      ClientScreenInputEvent.KEY_RELEASED_POST
         .invoker()
         .keyReleased(Minecraft.getInstance(), event.getScreen(), event.getKeyCode(), event.getScanCode(), event.getModifiers());
   }
   ...
   public static void eventInputEvent(MouseScrollingEvent event) {
   ...
   public static void eventInputEvent(net.neoforged.neoforge.client.event.InputEvent.MouseButton.Pre event) {
      if (ClientRawInputEvent.MOUSE_CLICKED_PRE
         .invoker()
         .mouseClicked(Minecraft.getInstance(), event.getButton(), event.getAction(), event.getModifiers())
         .isFalse()) {
         event.setCanceled(true);
      }
   }
   ...
   public static void eventInputEvent(net.neoforged.neoforge.client.event.InputEvent.MouseButton.Post event) {
   ...
   public static void eventInputEvent(Key event) {
      ClientRawInputEvent.KEY_PRESSED
         .invoker()
         .keyPressed(Minecraft.getInstance(), event.getKey(), event.getScanCode(), event.getAction(), event.getModifiers());
   }
