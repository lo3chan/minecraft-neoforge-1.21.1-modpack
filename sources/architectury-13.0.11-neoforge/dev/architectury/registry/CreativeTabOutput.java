...
public interface CreativeTabOutput extends Output {
   ...
   default void acceptAfter(ItemStack after, ItemLike item, TabVisibility visibility) {
      this.acceptAfter(after, new ItemStack(item), visibility);
   }

   default void acceptAfter(ItemStack after, ItemLike item) {
      this.acceptAfter(after, new ItemStack(item), TabVisibility.PARENT_AND_SEARCH_TABS);
   }

   default void acceptAllAfter(ItemStack after, Collection<ItemStack> stacks, TabVisibility visibility) {
   ...
   default void acceptAllAfter(ItemStack after, Collection<ItemStack> stacks) {
      this.acceptAllAfter(after, stacks, TabVisibility.PARENT_AND_SEARCH_TABS);
   }
   ...
   default void acceptAfter(ItemLike after, ItemLike item, TabVisibility visibility) {
   ...
   default void acceptAllAfter(ItemLike after, Collection<ItemStack> stacks, TabVisibility visibility) {
   ...
   default void acceptBefore(ItemStack before, ItemStack stack) {
      this.acceptBefore(before, stack, TabVisibility.PARENT_AND_SEARCH_TABS);
   }

   default void acceptBefore(ItemStack before, ItemLike item, TabVisibility visibility) {
      this.acceptBefore(before, new ItemStack(item), visibility);
   }

   default void acceptBefore(ItemStack before, ItemLike item) {
      this.acceptBefore(before, new ItemStack(item), TabVisibility.PARENT_AND_SEARCH_TABS);
   }

   default void acceptAllBefore(ItemStack before, Collection<ItemStack> stacks, TabVisibility visibility) {
   ...
   default void acceptAllBefore(ItemStack before, Collection<ItemStack> stacks) {
      this.acceptAllBefore(before, stacks, TabVisibility.PARENT_AND_SEARCH_TABS);
   }
   ...
   default void acceptBefore(ItemLike before, ItemLike item, TabVisibility visibility) {
   ...
   default void acceptAllBefore(ItemLike before, Collection<ItemStack> stacks, TabVisibility visibility) {
