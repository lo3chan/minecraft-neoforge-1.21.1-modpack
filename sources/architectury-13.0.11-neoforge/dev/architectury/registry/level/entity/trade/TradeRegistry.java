...
public class TradeRegistry {
   ...
   public static void registerVillagerTrade(VillagerProfession profession, int level, ItemListing... trades) {
      if (level < 1) {
   ...
   @ExpectPlatform
   @Transformed
   private static void registerVillagerTrade0(VillagerProfession profession, int level, ItemListing... trades) {
