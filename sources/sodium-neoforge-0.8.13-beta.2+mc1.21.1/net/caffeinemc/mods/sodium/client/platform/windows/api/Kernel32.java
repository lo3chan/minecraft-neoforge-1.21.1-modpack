...
public class Kernel32 {
   ...
   private static final long PFN_GetCommandLineA = APIUtil.apiGetFunctionAddress(LIBRARY, "GetCommandLineA");
   ...
   public static String getModuleFileName(long phModule) {
      ByteBuffer lpFileName = MemoryUtil.memAlignedAlloc(16, 65534);

      String var4;
      try {
         int length = JNI.callPPI(phModule, MemoryUtil.memAddress(lpFileName), lpFileName.capacity() / 2, PFN_GetModuleFileNameW);
         if (length == 0) {
