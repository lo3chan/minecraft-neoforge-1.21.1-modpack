...
public class RecipeListener {
   ...
   public static void checkBanned(RightClickBlock event) {
      ...
      event.setCanceled(
         RecipeHooks.checkInteractionBanned(player, level, blockPos, direction, itemStack, blockState, !player.getItemInHand(interactionHand).isEmpty())
      );
   }

   public static void onNeighborNotified(NeighborNotifyEvent event) {
