...
public record MoaType(
   ItemStack egg,
   int maxJumps,
   float speed,
   int spawnChance,
   ResourceLocation moaTexture,
   ResourceLocation saddleTexture,
   Optional<ResourceLocation> jumpsTexture
) {
   public static final Codec<MoaType> CODEC = RecordCodecBuilder.create(
      in -> in.group(
