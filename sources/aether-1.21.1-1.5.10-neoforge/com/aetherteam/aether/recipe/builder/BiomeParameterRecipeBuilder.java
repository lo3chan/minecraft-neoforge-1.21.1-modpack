...
public class BiomeParameterRecipeBuilder implements RecipeBuilder {
   ...
   public static BiomeParameterRecipeBuilder recipe(
      BlockStateIngredient ingredient, Block result, ResourceKey<Biome> biomeKey, BiomeParameterRecipeSerializer.Factory<?> factory
   ) {
      return recipe(BlockPropertyPair.of(result, Optional.empty()), ingredient, Optional.of(Either.left(biomeKey)), factory);
   }

   public static BiomeParameterRecipeBuilder recipe(
      BlockStateIngredient ingredient, BlockPropertyPair resultPair, ResourceKey<Biome> biomeKey, BiomeParameterRecipeSerializer.Factory<?> factory
   ) {
   ...
   public static BiomeParameterRecipeBuilder recipe(
      BlockStateIngredient ingredient, Block result, TagKey<Biome> biomeTag, BiomeParameterRecipeSerializer.Factory<?> factory
   ) {
      return recipe(BlockPropertyPair.of(result, Optional.empty()), ingredient, Optional.of(Either.right(biomeTag)), factory);
   }

   public static BiomeParameterRecipeBuilder recipe(
      BlockStateIngredient ingredient, BlockPropertyPair resultPair, TagKey<Biome> biomeTag, BiomeParameterRecipeSerializer.Factory<?> factory
   ) {
