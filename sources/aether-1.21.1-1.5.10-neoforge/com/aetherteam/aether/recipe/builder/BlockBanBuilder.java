...
public class BlockBanBuilder extends PlacementBanBuilder {
   ...
   public static PlacementBanBuilder recipe(
      BlockStateIngredient ingredient, Optional<BlockStateIngredient> bypassBlock, Either<ResourceKey<Biome>, TagKey<Biome>> biome
   ) {
