...
public abstract class AbstractAetherCookingRecipe extends AbstractCookingRecipe {
   ...
   public AbstractAetherCookingRecipe(
      RecipeType<?> recipeType, String group, AetherBookCategory category, Ingredient ingredient, ItemStack result, float experience, int cookingTime
   ) {
