...
public abstract class PlacementBanRecipeSerializer<T, S extends Predicate<T>, R extends RecipeInput, F extends AbstractPlacementBanRecipe<T, S, R>>
   ...
   public void toNetwork(RegistryFriendlyByteBuf buffer, F recipe) {
      ...
      buffer.writeOptional(
         ...
         (buf, blockStateIngredient) -> BlockStateIngredient.CONTENTS_STREAM_CODEC.encode((RegistryFriendlyByteBuf)buf, blockStateIngredient)
      );
   }

   public PlacementBanRecipeSerializer.CookieBaker<T, S, R, F> getFactory() {
      return this.factory;
   }

   public interface CookieBaker<T, S extends Predicate<T>, R extends RecipeInput, F extends AbstractPlacementBanRecipe<T, S, R>>
      extends Function3<Either<ResourceKey<Biome>, TagKey<Biome>>, Optional<BlockStateIngredient>, S, F> {
      F apply(Either<ResourceKey<Biome>, TagKey<Biome>> var1, Optional<BlockStateIngredient> var2, S var3);
   }
}
