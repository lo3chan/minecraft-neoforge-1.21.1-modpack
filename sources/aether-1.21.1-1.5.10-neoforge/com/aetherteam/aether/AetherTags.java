...
public class AetherTags {
   public static class Biomes {
      ...
      private static TagKey<Biome> tag(String name) {
         return TagKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   }
   ...
   public static class Blocks {
      ...
      private static TagKey<Block> tag(String name) {
         return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   }
   ...
   public static class DamageTypes {
      ...
      private static TagKey<DamageType> tag(String name) {
         return TagKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   }
   ...
   public static class Entities {
      ...
      private static TagKey<EntityType<?>> tag(String name) {
         return TagKey.create(Registries.ENTITY_TYPE, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   }
   ...
   public static class Fluids {
      ...
      private static TagKey<Fluid> tag(String name) {
         return TagKey.create(Registries.FLUID, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   }
   ...
   public static class Items {
      ...
      private static TagKey<Item> tag(String name) {
         return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   ...
   public static class SoundEvents {
      ...
      private static TagKey<SoundEvent> tag(String name) {
         return TagKey.create(Registries.SOUND_EVENT, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   }
   ...
   public static class Structures {
      ...
      private static TagKey<Structure> tag(String name) {
         return TagKey.create(Registries.STRUCTURE, ResourceLocation.fromNamespaceAndPath("aether", name));
      }
   }
}
