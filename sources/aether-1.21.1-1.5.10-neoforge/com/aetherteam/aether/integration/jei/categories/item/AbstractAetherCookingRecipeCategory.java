...
public abstract class AbstractAetherCookingRecipeCategory<T> extends AbstractRecipeCategory<T> {
   public static final ResourceLocation FLAME_TEXTURE = ResourceLocation.fromNamespaceAndPath("aether", "textures/gui/sprites/menu/lit_progress.png");
   public static final ResourceLocation ARROW_TEXTURE = ResourceLocation.fromNamespaceAndPath("aether", "textures/gui/sprites/menu/burn_progress.png");
   public static final ResourceLocation INCUBATION_PROGRESS_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "aether", "textures/gui/sprites/menu/incubation_progress.png"
   );
   protected final IDrawable fuelIndicator;
   protected final IDrawableAnimated animatedProgressArrow;

   public AbstractAetherCookingRecipeCategory(
      String id,
      ResourceLocation uid,
      IDrawable background,
      IDrawable icon,
      IDrawable fuelIndicator,
      IDrawableAnimated animatedProgressArrow,
   ...
   protected void drawExperience(AbstractCookingRecipe recipe, GuiGraphics guiGraphics, int y, IDrawable background) {
      ...
      if (experience > 0.0F) {
         ...
         guiGraphics.drawString(fontRenderer, experienceString, background.getWidth() - stringWidth, y, -8355712, false);
      }
   }
   ...
   protected void drawCookingTime(GuiGraphics guiGraphics, int y, int time, IDrawable background) {
      if (time > 0) {
         ...
         guiGraphics.drawString(fontRenderer, timeString, background.getWidth() - stringWidth, y, -8355712, false);
      }
   }
}
