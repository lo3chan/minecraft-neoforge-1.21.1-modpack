...
public class IncubationRecipeCategory extends AbstractAetherCookingRecipeCategory<IncubationRecipe> implements IRecipeCategory<IncubationRecipe> {
   public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("aether", "incubation");
   public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("aether", "textures/gui/menu/incubator.png");
   public static final RecipeType<IncubationRecipe> RECIPE_TYPE = RecipeType.create("aether", "incubation", IncubationRecipe.class);
   ...
   public IncubationRecipeCategory(IGuiHelper guiHelper) {
      super(
         ...
         guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack((ItemLike)AetherBlocks.INCUBATOR.get())),
         guiHelper.drawableBuilder(FLAME_TEXTURE, 0, 0, 14, 14).setTextureSize(14, 14).build(),
         guiHelper.createAnimatedDrawable(
            guiHelper.drawableBuilder(INCUBATION_PROGRESS_TEXTURE, 0, 0, 10, 54).setTextureSize(10, 54).build(), 5700, StartDirection.BOTTOM, false
         ),
         RECIPE_TYPE
      );
   }
   ...
   public void setRecipe(IRecipeLayoutBuilder builder, IncubationRecipe recipe, IFocusGroup focusGroup) {
      ...
      builder.addSlot(RecipeIngredientRole.INPUT, 1, 1).addIngredients((Ingredient)recipeIngredients.getFirst());
   }
