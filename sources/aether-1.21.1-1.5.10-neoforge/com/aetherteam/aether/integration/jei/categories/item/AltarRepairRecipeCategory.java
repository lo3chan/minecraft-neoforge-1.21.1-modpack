...
public class AltarRepairRecipeCategory extends AbstractAetherCookingRecipeCategory<AltarRepairRecipe> implements IRecipeCategory<AltarRepairRecipe> {
   public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("aether", "repairing");
   public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("aether", "textures/gui/menu/altar.png");
   public static final RecipeType<AltarRepairRecipe> RECIPE_TYPE = RecipeType.create("aether", "repairing", AltarRepairRecipe.class);
   ...
   public AltarRepairRecipeCategory(IGuiHelper guiHelper) {
      super(
         ...
         guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack((ItemLike)AetherBlocks.ALTAR.get())),
   ...
   public void setRecipe(IRecipeLayoutBuilder builder, AltarRepairRecipe recipe, IFocusGroup focusGroup) {
      ...
      ItemStack damagedItem = ((Ingredient)recipeIngredients.getFirst()).getItems()[0].copy();
      damagedItem.setDamageValue(damagedItem.getMaxDamage() * 3 / 4);
      builder.addSlot(RecipeIngredientRole.INPUT, 1, 1).addIngredients(Ingredient.of(new ItemStack[]{damagedItem}));
