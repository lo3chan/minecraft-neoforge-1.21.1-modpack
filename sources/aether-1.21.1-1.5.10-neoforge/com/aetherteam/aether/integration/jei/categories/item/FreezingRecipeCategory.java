...
public class FreezingRecipeCategory extends AbstractAetherCookingRecipeCategory<FreezingRecipe> implements IRecipeCategory<FreezingRecipe> {
   public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("aether", "freezing");
   public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("aether", "textures/gui/menu/freezer.png");
   public static final RecipeType<FreezingRecipe> RECIPE_TYPE = RecipeType.create("aether", "freezing", FreezingRecipe.class);
   ...
   public FreezingRecipeCategory(IGuiHelper guiHelper) {
      super(
         ...
         guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack((ItemLike)AetherBlocks.FREEZER.get())),
         guiHelper.drawableBuilder(FLAME_TEXTURE, 0, 0, 14, 14).setTextureSize(14, 14).build(),
         guiHelper.createAnimatedDrawable(
            guiHelper.drawableBuilder(ARROW_TEXTURE, 0, 0, 24, 16).setTextureSize(24, 16).build(), 100, StartDirection.LEFT, false
         ),
         RECIPE_TYPE
      );
   }
