...
public class EnchantingRecipeCategory extends AbstractAetherCookingRecipeCategory<EnchantingRecipe> implements IRecipeCategory<EnchantingRecipe> {
   public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath("aether", "enchanting");
   public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath("aether", "textures/gui/menu/altar.png");
   public static final RecipeType<EnchantingRecipe> RECIPE_TYPE = RecipeType.create("aether", "enchanting", EnchantingRecipe.class);
