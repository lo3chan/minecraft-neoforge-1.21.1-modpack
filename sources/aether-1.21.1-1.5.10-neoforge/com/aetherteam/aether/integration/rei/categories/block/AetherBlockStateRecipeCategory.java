...
public class AetherBlockStateRecipeCategory<R extends AbstractBlockStateRecipe> extends AbstractBlockStateRecipeCategory<R> {
   ...
   public static AetherBlockStateRecipeCategory<AccessoryFreezableRecipe> accessoryFreezable() {
      return new AetherBlockStateRecipeCategory<>(
         "accessory_freezable", AetherREIServerPlugin.ACCESSORY_FREEZABLE, 84, 28, EntryStacks.of((ItemLike)AetherItems.ICE_RING.get())
      );
   }

   public static AetherBlockStateRecipeCategory<IcestoneFreezableRecipe> icestoneFreezable() {
      return new AetherBlockStateRecipeCategory<>(
         "icestone_freezable", AetherREIServerPlugin.ICESTONE_FREEZABLE, 84, 28, EntryStacks.of((ItemLike)AetherBlocks.ICESTONE.get())
      );
   }

   public static AetherBlockStateRecipeCategory<AmbrosiumRecipe> ambrosium() {
      return new AetherBlockStateRecipeCategory<>(
         "ambrosium_enchanting", AetherREIServerPlugin.AMBROSIUM_ENCHANTING, 84, 28, EntryStacks.of((ItemLike)AetherItems.AMBROSIUM_SHARD.get())
      );
   }
}
