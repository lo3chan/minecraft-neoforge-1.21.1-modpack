...
public class PlacementBanRecipeDisplay<R extends AbstractPlacementBanRecipe<?, ?, ?>> extends BasicDisplay {
   ...
   protected PlacementBanRecipeDisplay(
      CategoryIdentifier<? extends PlacementBanRecipeDisplay<R>> categoryIdentifier,
      List<EntryIngredient> inputs,
      Either<ResourceKey<Biome>, TagKey<Biome>> biome,
      Optional<BlockStateIngredient> bypassBlock,
      Optional<BlockStateIngredient> blockStateIngredient,
