...
public class SkyrootBoatItem extends Item {
   ...
   public SkyrootBoatItem(boolean hasChest, Properties properties) {
      super(properties);
   ...
   private Boat getBoat(Level level, HitResult hitResult) {
      return (Boat)(this.hasChest
         ? new SkyrootChestBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z)
         : new SkyrootBoat(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z));
   }
}
