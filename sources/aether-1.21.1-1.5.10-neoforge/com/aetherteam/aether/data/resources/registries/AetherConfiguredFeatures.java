...
public class AetherConfiguredFeatures {
   ...
   private static ResourceKey<ConfiguredFeature<?, ?>> createKey(String name) {
      return ResourceKey.create(Registries.CONFIGURED_FEATURE, ResourceLocation.fromNamespaceAndPath("aether", name));
   }
   ...
   public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
      ...
      register(
         context,
         COLD_AERCLOUD_CONFIGURATION,
         (Feature)AetherFeatures.AERCLOUD.get(),
         AetherConfiguredFeatureBuilders.aercloud(16, AetherFeatureStates.COLD_AERCLOUD)
      );
      register(
         context,
         BLUE_AERCLOUD_CONFIGURATION,
         (Feature)AetherFeatures.AERCLOUD.get(),
         AetherConfiguredFeatureBuilders.aercloud(8, AetherFeatureStates.BLUE_AERCLOUD)
      );
      register(
         context,
         GOLDEN_AERCLOUD_CONFIGURATION,
         (Feature)AetherFeatures.AERCLOUD.get(),
         AetherConfiguredFeatureBuilders.aercloud(4, AetherFeatureStates.GOLDEN_AERCLOUD)
      );
      register(context, CRYSTAL_ISLAND_CONFIGURATION, (Feature)AetherFeatures.CRYSTAL_ISLAND.get(), NoneFeatureConfiguration.INSTANCE);
      register(
         context,
         SKYROOT_TREE_CONFIGURATION,
         Feature.TREE,
      ...
      register(
         context,
         CRYSTAL_TREE_CONFIGURATION,
         Feature.TREE,
         new TreeConfigurationBuilder(
               BlockStateProvider.simple(AetherFeatureStates.SKYROOT_LOG),
               new CrystalTreeTrunkPlacer(7, 0, 0),
               new WeightedStateProvider(new Builder().add(AetherFeatureStates.CRYSTAL_LEAVES, 4).add(AetherFeatureStates.CRYSTAL_FRUIT_LEAVES, 1).build()),
      ...
      register(
         context,
         HOLIDAY_TREE_CONFIGURATION,
         Feature.TREE,
         new TreeConfigurationBuilder(
               BlockStateProvider.simple(AetherFeatureStates.SKYROOT_LOG),
               new StraightTrunkPlacer(9, 0, 0),
               new WeightedStateProvider(new Builder().add(AetherFeatureStates.HOLIDAY_LEAVES, 4).add(AetherFeatureStates.DECORATED_HOLIDAY_LEAVES, 1).build()),
            ...
            .decorators(
               ImmutableList.of(
                  new HolidayTreeDecorator(
                     new WeightedStateProvider(new Builder().add(AetherFeatureStates.SNOW, 10).add(AetherFeatureStates.PRESENT, 1).build())
                  )
               )
            )
            .build()
      ...
      register(
         context,
         GRASS_PATCH_CONFIGURATION,
         Feature.RANDOM_PATCH,
         NitrogenConfiguredFeatureBuilders.grassPatch(BlockStateProvider.simple(Blocks.SHORT_GRASS), 32)
      );
      register(
         context,
         TALL_GRASS_PATCH_CONFIGURATION,
         Feature.RANDOM_PATCH,
         NitrogenConfiguredFeatureBuilders.tallGrassPatch(BlockStateProvider.simple(Blocks.TALL_GRASS))
      );
      register(
         context,
         WHITE_FLOWER_PATCH_CONFIGURATION,
         Feature.FLOWER,
         NitrogenConfiguredFeatureBuilders.grassPatch(
            new WeightedStateProvider(SimpleWeightedRandomList.builder().add(AetherFeatureStates.WHITE_FLOWER, 1)), 64
         )
      );
      register(
         context,
         PURPLE_FLOWER_PATCH_CONFIGURATION,
         Feature.FLOWER,
         NitrogenConfiguredFeatureBuilders.grassPatch(
            new WeightedStateProvider(SimpleWeightedRandomList.builder().add(AetherFeatureStates.PURPLE_FLOWER, 1)), 64
         )
      );
      register(
         context,
         ...
         Feature.RANDOM_PATCH,
         NitrogenConfiguredFeatureBuilders.grassPatch(new WeightedStateProvider(SimpleWeightedRandomList.builder().add(AetherFeatureStates.BERRY_BUSH, 1)), 32)
      );
      register(
         context,
         QUICKSOIL_SHELF_CONFIGURATION,
         ...
         new ShelfConfiguration(
            ...
            UniformInt.of(0, 48),
            HolderSet.direct(Block::builtInRegistryHolder, new Block[]{(Block)AetherBlocks.AETHER_GRASS_BLOCK.get()})
         )
      );
      register(
         context,
         WATER_LAKE_CONFIGURATION,
      ...
      register(
         ...
         AetherConfiguredFeatureBuilders.spring(
            ...
            4,
            1,
            HolderSet.direct(Block::builtInRegistryHolder, new Block[]{(Block)AetherBlocks.HOLYSTONE.get(), (Block)AetherBlocks.AETHER_DIRT.get()})
         )
      );
      ...
      register(
         context,
         ORE_GRAVITITE_BURIED_CONFIGURATION,
         Feature.ORE,
      ...
      register(
         context,
         TREES_SKYROOT_AND_GOLDEN_OAK_CONFIGURATION,
         Feature.RANDOM_SELECTOR,
         new RandomFeatureConfiguration(
            List.of(
               new WeightedPlacedFeature(
                  PlacementUtils.inlinePlaced(
                     configuredFeatures.getOrThrow(GOLDEN_OAK_TREE_CONFIGURATION),
                     new PlacementModifier[]{PlacementUtils.filteredByBlockSurvival((Block)AetherBlocks.GOLDEN_OAK_SAPLING.get())}
                  ),
                  0.01F
               )
            ),
            PlacementUtils.inlinePlaced(
               configuredFeatures.getOrThrow(SKYROOT_TREE_CONFIGURATION),
      ...
      register(
         context,
         SINGLE_GOLD_DUNGEON_FLOWER_CONFIGURATION,
         Feature.SIMPLE_BLOCK,
         new SimpleBlockConfiguration(new WeightedStateProvider(new Builder().add(Blocks.DANDELION.defaultBlockState()).add(Blocks.POPPY.defaultBlockState())))
      );
      register(
         context,
         GOLD_DUNGEON_ISLAND_FOLIAGE_CONFIGURATION,
         Feature.RANDOM_SELECTOR,
         new RandomFeatureConfiguration(
            List.of(
               new WeightedPlacedFeature(
            ...
            PlacementUtils.inlinePlaced(
               configuredFeatures.getOrThrow(SINGLE_GOLD_DUNGEON_FLOWER_CONFIGURATION), new PlacementModifier[]{PlacementUtils.isEmpty()}
            )
         )
      );
   }
