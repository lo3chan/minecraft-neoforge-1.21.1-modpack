...
public class AetherStructureProcessorLists {
   ...
   private static ResourceKey<StructureProcessorList> createKey(String name) {
      return ResourceKey.create(Registries.PROCESSOR_LIST, ResourceLocation.fromNamespaceAndPath("aether", name));
   }
   ...
   public static void bootstrap(BootstrapContext<StructureProcessorList> context) {
      register(
         ...
         BRONZE_ROOM,
         List.of(
            BronzeDungeonPiece.BRONZE_DUNGEON_STONE, BronzeDungeonPiece.TRAPPED_CARVED_STONE, BronzeDungeonPiece.AVOID_DUNGEONS, DoubleDropsProcessor.INSTANCE
         )
      );
      register(context, BRONZE_TUNNEL, List.of(BronzeDungeonPiece.AVOID_DUNGEONS, BronzeDungeonPiece.BRONZE_DUNGEON_STONE, DoubleDropsProcessor.INSTANCE));
      register(context, BRONZE_BOSS_ROOM, List.of(BronzeDungeonPiece.LOCKED_SENTRY_STONE, BossRoomProcessor.INSTANCE));
      register(context, SILVER_ROOM, List.of(SilverDungeonPiece.LOCKED_ANGELIC_STONE, DoubleDropsProcessor.INSTANCE));
      register(context, SILVER_FLOOR, List.of(SilverDungeonPiece.LOCKED_ANGELIC_STONE, SilverDungeonPiece.TRAPPED_ANGELIC_STONE, DoubleDropsProcessor.INSTANCE));
      register(context, SILVER_BOSS_ROOM, List.of(DoubleDropsProcessor.INSTANCE, BossRoomProcessor.INSTANCE));
      register(context, GOLD_ISLAND, List.of(SurfaceRuleProcessor.INSTANCE, VerticalGradientProcessor.INSTANCE, DoubleDropsProcessor.INSTANCE));
      register(context, GOLD_TUNNEL, List.of(GoldDungeonPiece.MOSSY_HOLYSTONE, NoReplaceProcessor.AIR, DoubleDropsProcessor.INSTANCE));
      register(context, GOLD_BOSS_ROOM, List.of(GoldDungeonPiece.LOCKED_HELLFIRE_STONE, BossRoomProcessor.INSTANCE));
   }
