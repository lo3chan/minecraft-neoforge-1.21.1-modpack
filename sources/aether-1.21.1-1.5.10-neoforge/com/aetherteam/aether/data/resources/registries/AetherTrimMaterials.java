...
public class AetherTrimMaterials {
   ...
   private static ResourceKey<TrimMaterial> createKey(String name) {
      return ResourceKey.create(Registries.TRIM_MATERIAL, ResourceLocation.fromNamespaceAndPath("aether", name));
   }

   public static void bootstrap(BootstrapContext<TrimMaterial> context) {
      register(context, ZANITE, (Item)AetherItems.ZANITE_GEMSTONE.get(), Style.EMPTY.withColor(8009440), 1.0F);
      register(context, GRAVITITE, ((Block)AetherBlocks.ENCHANTED_GRAVITITE.get()).asItem(), Style.EMPTY.withColor(13391043), 1.0F);
      register(context, GOLDEN_AMBER, ((Item)AetherItems.GOLDEN_AMBER.get()).asItem(), Style.EMPTY.withColor(16299311), 0.6F);
   }
