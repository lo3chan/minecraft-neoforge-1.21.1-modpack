...
public class AetherNoises {
   ...
   private static ResourceKey<NoiseParameters> createKey(String name) {
      return ResourceKey.create(Registries.NOISE, ResourceLocation.fromNamespaceAndPath("aether", name));
   }
   ...
   public static void register(
      BootstrapContext<NoiseParameters> context, ResourceKey<NoiseParameters> key, int firstOctave, double firstAmplitude, double... amplitudes
   ) {
