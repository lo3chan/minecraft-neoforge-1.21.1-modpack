...
public class AetherStructureSets {
   ...
   private static ResourceKey<StructureSet> createKey(String name) {
      return ResourceKey.create(Registries.STRUCTURE_SET, ResourceLocation.fromNamespaceAndPath("aether", name));
   }
   ...
   public static void bootstrap(BootstrapContext<StructureSet> context) {
      ...
      context.register(
         LARGE_AERCLOUD,
         new StructureSet(structures.getOrThrow(AetherStructures.LARGE_AERCLOUD), new RandomSpreadStructurePlacement(6, 3, RandomSpreadType.LINEAR, 15536586))
      );
      Holder<StructureSet> airborneSetHolder = context.register(
      ...
      context.register(
         BRONZE_DUNGEON,
         new StructureSet(
            structures.getOrThrow(AetherStructures.BRONZE_DUNGEON),
            new RandomSpreadStructurePlacement(
               Vec3i.ZERO,
               FrequencyReductionMethod.DEFAULT,
               1.0F,
               32146754,
               Optional.of(new ExclusionZone(airborneSetHolder, 4)),
               6,
               5,
