...
public class AetherStructures {
   ...
   private static ResourceKey<Structure> createKey(String name) {
      return ResourceKey.create(Registries.STRUCTURE, ResourceLocation.fromNamespaceAndPath("aether", name));
   }
   ...
   public static void bootstrap(BootstrapContext<Structure> context) {
      ...
      context.register(
         LARGE_AERCLOUD,
         new LargeAercloudStructure(
            AetherStructureBuilders.structure(biomes.getOrThrow(AetherTags.Biomes.HAS_LARGE_AERCLOUD), Decoration.SURFACE_STRUCTURES, TerrainAdjustment.NONE),
      ...
      context.register(
         BRONZE_DUNGEON,
         new BronzeDungeonStructure(
            AetherStructureBuilders.structure(
               biomes.getOrThrow(AetherTags.Biomes.HAS_BRONZE_DUNGEON), mobSpawnsPiece, Decoration.TOP_LAYER_MODIFICATION, TerrainAdjustment.NONE
            ),
            8,
            32,
            24,
      ...
      context.register(
         SILVER_DUNGEON,
         new SilverDungeonStructure(
            AetherStructureBuilders.structure(
               biomes.getOrThrow(AetherTags.Biomes.HAS_SILVER_DUNGEON), mobSpawnsBox, Decoration.SURFACE_STRUCTURES, TerrainAdjustment.NONE
            ),
            128,
            2,
            18,
      ...
      context.register(
         GOLD_DUNGEON,
         new GoldDungeonStructure(
            AetherStructureBuilders.structure(
               biomes.getOrThrow(AetherTags.Biomes.HAS_GOLD_DUNGEON), mobSpawnsBox, Decoration.SURFACE_STRUCTURES, TerrainAdjustment.NONE
            ),
            8,
            20,
            40,
            ...
            PlacementUtils.inlinePlaced(
               configurations.getOrThrow(AetherConfiguredFeatures.GOLDEN_OAK_TREE_CONFIGURATION), new PlacementModifier[]{RarityFilter.onAverageOnceEvery(64)}
            ),
