...
public class AetherPlacedFeatures {
   ...
   private static ResourceKey<PlacedFeature> createKey(String name) {
      return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath("aether", name));
   }
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> context) {
      ...
      register(
         ...
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.COLD_AERCLOUD_CONFIGURATION),
         AetherPlacedFeatureBuilders.aercloudPlacement(32, 64, 7)
      );
      register(
         context,
         BLUE_AERCLOUD_PLACEMENT,
      ...
      register(
         ...
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.GOLDEN_AERCLOUD_CONFIGURATION),
         AetherPlacedFeatureBuilders.aercloudPlacement(96, 32, 75)
      );
      register(
         context,
         CRYSTAL_ISLAND_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.CRYSTAL_ISLAND_CONFIGURATION),
      ...
      register(
         context,
         SKYROOT_MEADOW_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.TREES_SKYROOT_AND_GOLDEN_OAK_CONFIGURATION),
         AetherPlacedFeatureBuilders.treePlacement(RarityFilter.onAverageOnceEvery(1))
      );
      register(
         context,
         SKYROOT_GROVE_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.TREES_SKYROOT_AND_GOLDEN_OAK_CONFIGURATION),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(2, 0.1F, 1))
      );
      register(
         context,
         SKYROOT_WOODLAND_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.TREES_SKYROOT_AND_GOLDEN_OAK_CONFIGURATION),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(5, 0.1F, 1))
      );
      register(
         context,
         SKYROOT_FOREST_TREES_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.TREES_SKYROOT_AND_GOLDEN_OAK_CONFIGURATION),
         AetherPlacedFeatureBuilders.treePlacement(PlacementUtils.countExtra(6, 0.1F, 1))
      );
      register(
         context,
         HOLIDAY_TREE_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.HOLIDAY_TREE_CONFIGURATION),
      ...
      register(
         context,
         GRASS_PATCH_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.GRASS_PATCH_CONFIGURATION),
      ...
      register(
         context,
         TALL_GRASS_PATCH_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.TALL_GRASS_PATCH_CONFIGURATION),
      ...
      register(context, AETHER_GRASS_BONEMEAL, configuredFeatures.getOrThrow(VegetationFeatures.SINGLE_PIECE_OF_GRASS), PlacementUtils.isEmpty());
      register(context, ENCHANTED_AETHER_GRASS_BONEMEAL, configuredFeatures.getOrThrow(VegetationFeatures.SINGLE_PIECE_OF_GRASS), PlacementUtils.isEmpty());
      register(
         context,
         WHITE_FLOWER_PATCH_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.WHITE_FLOWER_PATCH_CONFIGURATION),
      ...
      register(
         context,
         PURPLE_FLOWER_PATCH_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.PURPLE_FLOWER_PATCH_CONFIGURATION),
      ...
      register(
         context,
         BERRY_BUSH_PATCH_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.BERRY_BUSH_PATCH_CONFIGURATION),
         RarityFilter.onAverageOnceEvery(8),
         ImprovedLayerPlacementModifier.of(Types.MOTION_BLOCKING, UniformInt.of(0, 1), 4),
         BiomeFilter.biome()
      );
      register(
         context,
         QUICKSOIL_SHELF_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.QUICKSOIL_SHELF_CONFIGURATION),
      ...
      register(
         context,
         WATER_LAKE_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.WATER_LAKE_CONFIGURATION),
      ...
      register(
         context,
         WATER_SPRING_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.WATER_SPRING_CONFIGURATION),
      ...
      register(
         context,
         ORE_AETHER_DIRT_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.ORE_AETHER_DIRT_CONFIGURATION),
      ...
      register(
         context,
         ORE_ICESTONE_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.ORE_ICESTONE_CONFIGURATION),
      ...
      register(
         ...
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.ORE_AMBROSIUM_CONFIGURATION),
         NitrogenPlacedFeatureBuilders.commonOrePlacement(20, HeightRangePlacement.uniform(VerticalAnchor.bottom(), VerticalAnchor.aboveBottom(128)))
      );
      register(
         context,
         ORE_ZANITE_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.ORE_ZANITE_CONFIGURATION),
      ...
      register(
         context,
         ORE_GRAVITITE_BURIED_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.ORE_GRAVITITE_BURIED_CONFIGURATION),
      ...
      register(
         context,
         ORE_GRAVITITE_PLACEMENT,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.ORE_GRAVITITE_CONFIGURATION),
      ...
      register(
         context,
         GOLD_DUNGEON_ISLAND_FOLIAGE,
         configuredFeatures.getOrThrow(AetherConfiguredFeatures.GOLD_DUNGEON_ISLAND_FOLIAGE_CONFIGURATION),
