...
public class AetherLanguageData extends AetherLanguageProvider {
   ...
   protected void addTranslations() {
      ...
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_BUILDING_BLOCKS.get(), "Aether Building Blocks");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_DUNGEON_BLOCKS.get(), "Aether Dungeon Blocks");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_NATURAL_BLOCKS.get(), "Aether Natural Blocks");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_FUNCTIONAL_BLOCKS.get(), "Aether Functional Blocks");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_REDSTONE_BLOCKS.get(), "Aether Redstone Blocks");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_EQUIPMENT_AND_UTILITIES.get(), "Aether Equipment & Utilities");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_ARMOR_AND_ACCESSORIES.get(), "Aether Armor & Accessories");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_FOOD_AND_DRINKS.get(), "Aether Food & Drinks");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_INGREDIENTS.get(), "Aether Ingredients");
      this.addCreativeTab((CreativeModeTab)AetherCreativeTabs.AETHER_SPAWN_EGGS.get(), "Aether Spawn Eggs");
      ...
      this.addLore(
         AetherItems.AECHOR_PETAL, "The petal of an Aechor Plant with a sweet aroma to it. These are a Moa's favorite food and can be used to feed baby Moas."
      );
      this.addLore(
         AetherBlocks.AEROGEL,
         "The result of the Aether's unique climate and lava combining. These blocks can be crafted into various decorative blocks and are blast-resistant."
      );
      this.addLore(
         AetherBlocks.AEROGEL_SLAB,
         "Crafted from Aerogel. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.AEROGEL_STAIRS, "Crafted from Aerogel. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      this.addLore(
         AetherBlocks.AEROGEL_WALL, "Crafted from Aerogel. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      this.addLore(
         AetherBlocks.AETHER_DIRT,
         "A pale dirt. It can be found in the Aether and can also be used to grow native trees. It can grow into grass with enough light."
      );
      this.addLore(
         AetherBlocks.AETHER_DIRT_PATH,
         "A type of path made from flattening Aether Dirt with a shovel. These can be good for long roads or just exterior gardens."
      );
      this.addLore(
         AetherItems.AETHER_PORTAL_FRAME,
         "A portable frame containing the power to travel to the Aether or back to the Overworld. Not something you're likely to find naturally."
      );
      ...
      this.addLore(
         ...
         "Grass found in the Aether dimension. It can be used to grow trees native to the Aether. It is much more pale than normal grass."
      );
      this.addLore(
         AetherItems.AGILITY_CAPE,
         "An uncommon cape found in Bronze and Silver Dungeons. It makes the wearer's legs stronger, therefore they can walk up blocks instantly."
      );
      ...
      this.addLore(
         AetherItems.AMBROSIUM_SHARD, "The Aether's Coal equivalent. These have the healing property of restoring a small amount of health when eaten."
      );
      ...
      this.addLore(
         AetherBlocks.ANGELIC_SLAB,
         "Crafted from Angelic Stone. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.ANGELIC_STONE,
         "Angelic Stone is the main block that makes up Silver Dungeons. There is a chance some of them can be traps when generated in dungeons, but you cannot collect them as traps. It is unbreakable until you have defeated the boss, but it's worth it for that block."
      );
      this.addLore(
         AetherBlocks.ANGELIC_WALL, "Crafted from Angelic Stone. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      this.addLore(
         AetherBlocks.ANGELIC_STAIRS, "Crafted from Angelic Stone. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      this.addLore(
         AetherBlocks.BERRY_BUSH,
      ...
      this.addLore(
         AetherBlocks.BERRY_BUSH_STEM, "This is the result of harvesting the Blue Berries from a Berry Bush. It can take some time for them to grow back."
      );
      ...
      this.addLore(
         ...
         "A sweet-smelling gummy that can be found in chests in Bronze and Silver dungeons. It fully restores the Player's hunger when eaten. Very useful for boss fights."
      );
      ...
      this.addLore(
         AetherItems.BRONZE_DUNGEON_KEY, "A dull key that is dropped from the Slider after being defeated. You can use it to claim the treasure you earned!"
      );
      this.addLore(
         AetherItems.CANDY_CANE, "Dropped by mobs killed with a Candy Cane Sword! They can be used to repair this weapon, and they're a very tasty treat."
      );
      this.addLore(
         AetherItems.CANDY_CANE_SWORD,
      ...
      this.addLore(
         AetherBlocks.CARVED_SLAB,
         "Crafted from Carved Stone. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.CARVED_STAIRS, "Crafted from Carved Stone. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      ...
      this.addLore(
         AetherBlocks.CARVED_WALL, "Crafted from Carved Stone. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      ...
      this.addLore(
         ...
         "It may look like a normal chest, but it really isn't. As soon as you right-click on it, a Chest Mimic will pop out! These appear in Bronze and Silver Dungeons."
      );
      this.addLore(
         AetherItems.CLOUD_STAFF,
         "A staff with a light and fluffy top. It summons small Cloud Minions to fight next to the user for a short period of time by shooting large Cloud Crystals."
      );
      this.addLore(
         AetherBlocks.COLD_AERCLOUD,
         "A cold cloud found in the skies of the Aether. It can be used to make Cold Parachutes, and break drops that would otherwise be very dangerous."
      );
      ...
      this.addLore(
         ...
         "Leaves that come from Crystal Trees, which generate on floating islands. Sometimes they bear fruit that can cure Inebriation."
      );
      ...
      this.addLore(
         AetherBlocks.ENCHANTED_AETHER_GRASS_BLOCK, "An Aether Grass Block that has been enchanted to allow for increasing harvest rates of Blue Berries."
      );
      ...
      this.addLore(
         AetherItems.FLAMING_SWORD,
         "An ancient sword which burns its foes to a crisp. It almost hurts to touch! Using this on animals can make them drop cooked meat!"
      );
      ...
      this.addLore(
         AetherItems.GINGERBREAD_MAN,
         "Found in presents under Holiday Trees, these are the most common holiday item. They are very abundant when dropped from Presents."
      );
      this.addLore(
         AetherItems.GOLD_DUNGEON_KEY,
      ...
      this.addLore(
         ...
         "A golden cloud found in small quantities, higher in the air than normal. The properties are similar to Cold Aerclouds, but the Golden Parachutes they produce have much more durability."
      );
      this.addLore(
         AetherItems.GOLDEN_AMBER,
         "These round golden orbs can be obtained by mining Golden Oak Logs with a Zanite or Gravitite Axe. Their main purpose is to craft Golden Darts and Dart Shooters."
      );
      this.addLore(
         AetherItems.GOLDEN_GUMMY_SWET,
         "A sour-tasting gummy that can be found in chests in Bronze and Silver Dungeons. It fully restores the Player's hunger when eaten. Very useful for boss fights."
      );
      this.addLore(
         AetherItems.GOLDEN_DART,
         "The ammo for Golden Dart Shooters. Crafted with Skyroot Sticks and Golden Amber, enchanting these converts them to Enchanted Darts."
      );
      ...
      this.addLore(
         AetherItems.GOLDEN_FEATHER, "A fluffy feather found in Silver Dungeons. When worn, the wearer becomes lighter than air and can descend slowly."
      );
      ...
      this.addLore(
         ...
         "These golden leaves generate with Golden Oak Trees. They spawn golden particles in a radius of 5 blocks. They yield Golden Oak Saplings and Skyroot Sticks when they decay."
      );
      this.addLore(
         AetherBlocks.GOLDEN_OAK_LOG,
         "A Skyroot Log which contains Golden Amber inside. When broken with an axe, they drop Skyroot Logs, and if the axe is Zanite or Gravitite, they will drop Golden Amber."
      );
      this.addLore(
         AetherBlocks.GOLDEN_OAK_SAPLING,
         "These large saplings, when planted, will grow into huge Golden Oak Trees! You can use Bone Meal to speed up the process."
      );
      this.addLore(
         AetherBlocks.GOLDEN_OAK_WOOD,
         "A Skyroot Log which contains Golden Amber Inside. When broken with an axe, they drop Skyroot Logs, and if the axe is Zanite or Gravitite, they will drop Golden Amber. Crafted to have bark on all sides."
      );
      ...
      this.addLore(
         AetherItems.GRAVITITE_AXE,
         "Part of the Aether's best tool tier. This Axe not only makes wood blocks float, but it can mine Golden Oak Logs for Golden Amber!"
      );
      ...
      this.addLore(
         AetherBlocks.GRAVITITE_ORE,
         "This is the Aether's rarest ore. It has floating properties and will float upward when there is nothing above it. These can be enchanted into Enchanted Gravitite blocks."
      );
      this.addLore(
         AetherItems.GRAVITITE_PICKAXE,
         "Part of the Aether's best tool tier. When mining with this powerful tool, you can right-click on any stone block, and it will levitate into the air! You can mine any ore with this pickaxe."
      );
      this.addLore(
         AetherItems.GRAVITITE_SHOVEL,
         "Part of the Aether's best tool tier. This shovel has the special ability to make dirt blocks or sand levitate! When combined with enchantments such as Efficiency, it will instantly break Aether Dirt!"
      );
      this.addLore(
         AetherItems.GRAVITITE_SWORD,
         "Part of the Aether's best tool tier. When attacking with this powerful weapon, anything you hit will be flung into the air, causing lots of damage!"
      );
      this.addLore(
         AetherItems.GRAVITITE_HOE,
         "Part of the Aether's best tool tier. It can be used to harvest many plant-based or organic blocks and can also make them float."
      );
      this.addLore(
         AetherItems.HEALING_STONE,
      ...
      this.addLore(
         AetherBlocks.HELLFIRE_SLAB,
         "Crafted from Hellfire Stone. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.HELLFIRE_STONE,
         "A warm, red stone that makes up most of the Gold Dungeon's interior. It cannot be destroyed until the Sun Spirit is defeated."
      );
      this.addLore(
         AetherBlocks.HELLFIRE_WALL, "Crafted from Hellfire Stone. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      this.addLore(
         AetherBlocks.HELLFIRE_STAIRS, "Crafted from Hellfire Stone. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      ...
      this.addLore(
         AetherBlocks.HOLYSTONE,
         "The Aether's native rock. It can be used in various ways, such as tool creation, construction, and crafting Holystone Bricks."
      );
      ...
      this.addLore(
         AetherBlocks.HOLYSTONE_BRICK_SLAB,
         "Crafted from Holystone Bricks. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.HOLYSTONE_BRICK_STAIRS,
         "Crafted from Holystone Bricks. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      this.addLore(
         AetherBlocks.HOLYSTONE_BRICK_WALL,
         "Crafted from Holystone Bricks. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      this.addLore(AetherBlocks.HOLYSTONE_BUTTON, "Crafted from Holystone, a button used to activate mechanisms and redstone.");
      this.addLore(
         AetherItems.HOLYSTONE_HOE,
         "One of the Aether's stone tools. It can be used to harvest many plant-based or organic blocks, and till dirt blocks into farmable land. It will randomly drop Ambrosium Shards during use."
      );
      this.addLore(
         AetherItems.HOLYSTONE_PICKAXE, "One of the Aether's stone tools. It can mine Zanite Ore and will randomly drop Ambrosium Shards while mining."
      );
      ...
      this.addLore(
         AetherItems.HOLYSTONE_SHOVEL,
         "One of the Aether's stone tools. It can mine Quicksoil and all other blocks a Stone Shovel can mine, except it drops random Ambrosium Shards."
      );
      this.addLore(
         AetherBlocks.HOLYSTONE_SLAB,
         "Crafted from Holystone. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.HOLYSTONE_STAIRS, "Crafted from Holystone. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      ...
      this.addLore(
         AetherBlocks.HOLYSTONE_WALL, "Crafted from Holystone. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      ...
      this.addLore(
         AetherBlocks.ICESTONE,
         "Icestone is a common ore that can be used as fuel for a Freezer. It can be used to freeze nearby liquids such as lava and water."
      );
      this.addLore(
         AetherBlocks.ICESTONE_SLAB,
         "Crafted from Icestone. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.ICESTONE_STAIRS, "Crafted from Icestone. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      this.addLore(
         AetherBlocks.ICESTONE_WALL, "Crafted from Icestone. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      this.addLore(
         AetherBlocks.INCUBATOR,
         "Used to incubate Moas. You use Ambrosium Torches for the fuel. The process can take quite some time, but it is worth the wait once your Moa of choice hatches!"
      );
      this.addLore(
         AetherItems.INVISIBILITY_CLOAK,
      ...
      this.addLore(
         ...
         "A very rare item found in Gold Dungeons. Using this will give you an extra permanent heart! The feeling of using it is very strange and hard to describe."
      );
      this.addLore(
         AetherBlocks.LIGHT_ANGELIC_STONE,
         "The light version of Angelic Stone. It is less common than Angelic Stone, but it looks really nice as a decorative block."
      );
      this.addLore(
         AetherBlocks.LIGHT_HELLFIRE_STONE,
         "The light version of Hellfire Stone. It can be found in Gold Dungeons along with Hellfire Stone, but like its counterpart, it cannot be collected until the boss is defeated."
      );
      ...
      this.addLore(
         AetherBlocks.MOSSY_HOLYSTONE, "A more aged Holystone, it is found near dungeons and has pale colored vines growing on it. It can be very decorative!"
      );
      this.addLore(
         AetherBlocks.MOSSY_HOLYSTONE_SLAB,
         "Crafted from Mossy Holystone. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.MOSSY_HOLYSTONE_STAIRS,
         "Crafted from Mossy Holystone. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      this.addLore(
         AetherBlocks.MOSSY_HOLYSTONE_WALL,
         "Crafted from Mossy Holystone. Can be used for decorative enclosures and defenses. Great for keeping nasty intruders away!"
      );
      ...
      this.addLore(
         AetherItems.NEPTUNE_BOOTS,
         "Found in Bronze Dungeons, this armor allows for faster swimming in water. The full set is a much better replacement for the Depth Strider enchantment."
      );
      this.addLore(
         AetherItems.NEPTUNE_CHESTPLATE,
         "Found in Bronze Dungeons, this armor allows for faster swimming in water. Combined with an Iron Bubble, this armor set is super useful for defeating underwater temples."
      );
      this.addLore(
         AetherItems.NEPTUNE_GLOVES,
         "Found in Bronze Dungeons, these gloves are required to complete the Neptune armor set, which allows for underwater walking."
      );
      this.addLore(
         AetherItems.NEPTUNE_HELMET,
         "Found in Bronze Dungeons, this armor allows faster swimming in water. Combined with an Iron Bubble, this armor set is super useful for defeating underwater temples."
      );
      this.addLore(
         AetherItems.NEPTUNE_LEGGINGS,
         "Found in Bronze Dungeons, this armor allows faster swimming in water. Combined with an Iron Bubble, this armor set is super useful for defeating underwater temples."
      );
      this.addLore(AetherItems.NETHERITE_GLOVES, "A pair of gloves needed to complete the Netherite armor set.");
      this.addLore(
         AetherItems.HAMMER_OF_KINGBDOGZ, "A mighty hammer that shoots heavy projectiles at mobs. It's said that Kingbdogz actually held this hammer."
      );
      this.addLore(
         AetherItems.OBSIDIAN_BOOTS,
         "A super powerful piece of armor, more powerful than diamond. This armor is only obtainable by standing in water while wearing Phoenix armor, converting it to obsidian."
      );
      this.addLore(
         AetherItems.OBSIDIAN_CHESTPLATE,
         "A super powerful piece of armor, more powerful than diamond. This armor is only obtainable by standing in water while wearing Phoenix armor, converting it to obsidian."
      );
      this.addLore(
         AetherItems.OBSIDIAN_GLOVES, "Needed to complete the obsidian armor set, you can obtain these by standing in water while wearing Phoenix Gloves."
      );
      this.addLore(
         AetherItems.OBSIDIAN_HELMET,
         "A super powerful piece of armor, more powerful than diamond. This armor is only obtainable by standing in water while wearing Phoenix armor, converting it to obsidian."
      );
      this.addLore(
         AetherItems.OBSIDIAN_LEGGINGS,
         "A super powerful piece of armor, more powerful than diamond. This armor is only obtainable by standing in water while wearing Phoenix armor, converting it to obsidian."
      );
      this.addLore(
         AetherItems.PHOENIX_BOOTS,
         "Found in Gold Dungeons, when fully worn, this armor set grants fire resistance; you can swim in lava as well. Be careful when standing in water, as it will turn into obsidian armor."
      );
      ...
      this.addLore(
         AetherItems.PHOENIX_CHESTPLATE,
         "Found in Gold Dungeons, when fully worn, this armor set grants fire resistance; you can swim in lava as well. Be careful when standing in water, as it will turn into obsidian armor."
      );
      this.addLore(
         AetherItems.PHOENIX_GLOVES,
         "Found in Gold Dungeons, these gloves are required to finish the Phoenix armor set. If you stand in water for long enough, they will turn into Obsidian Gloves."
      );
      this.addLore(
      ...
      this.addLore(
         AetherItems.PHOENIX_LEGGINGS,
         "Found in Gold Dungeons, when fully worn, this armor set grants fire resistance; you can swim in lava as well. Be careful when standing in water, as it will turn into obsidian armor."
      );
      this.addLore(
         AetherItems.PIG_SLAYER,
         "Kills any pig-type mob with nothing with a single blow, or stronger ones with a couple blows. But why would you want to do that? Great for traversing the Nether."
      );
      this.addLore(
         AetherBlocks.PILLAR, "The main part of the Silver Dungeon's decorative pillars; they spawn all around the dungeon and are excellent for building."
      );
      ...
      this.addLore(
         AetherBlocks.PURPLE_FLOWER,
         "These pretty violet flowers can be found in large numbers around the Aether. They can be crafted into Purple Dye when placed in a Crafting Table."
      );
      this.addLore(
         AetherBlocks.QUICKSOIL,
         "A silky sand with extremely slippery properties. It can be seen floating on the side of the Aether's islands. Be careful around it, or you'll fall off."
      );
      this.addLore(
         AetherBlocks.QUICKSOIL_GLASS, "After enchanting Quicksoil, you can get this tinted glass. It is slightly slippery and makes for a great window."
      );
      ...
      this.addLore(
         AetherItems.REGENERATION_STONE,
         "A treasure found in Silver Dungeons. This stone makes the wearer feel healthy and heals their wounds. The effects can stack with other Regeneration Stones."
      );
      this.addLore(
         AetherItems.SHIELD_OF_REPULSION,
      ...
      this.addLore(
         AetherItems.SILVER_DUNGEON_KEY,
         "A reflective key that is given to you by the Valkyrie Queen after defeating her. Use it to claim the treasure she left behind!"
      );
      ...
      this.addLore(
         AetherItems.SKYROOT_AXOLOTL_BUCKET,
         "A Skyroot Bucket with a friendly Axolotl in it. Axolotls can be incredibly helpful aquatic partners. So, it's best to keep one on hand if you're exploring wet environments."
      );
      this.addLore(
         AetherBlocks.SKYROOT_BED,
         "Crafted with wool and Skyroot Planks. You can only sleep at night to skip nighttime, but during the day you can set your respawn point in the Aether. You cannot sleep while monsters are nearby."
      );
      this.addLore(
         AetherItems.SKYROOT_BOAT,
         "While the Aether does not have many large bodies of water, a boat can occasionally be a useful tool for crossing large distances over ice!"
      );
      this.addLore(
         AetherItems.SKYROOT_CHEST_BOAT,
         "A Skyroot Boat with a handy Chest in the back. It is useful for transporting more items over long stretches of water, which are famously difficult to find in the Aether."
      );
      this.addLore(
         AetherBlocks.SKYROOT_BOOKSHELF,
         "Crafted from Skyroot Planks and Books. Bookshelves can be used to enhance the enchanting capabilities of an Enchanting Table."
      );
      ...
      this.addLore(
         AetherItems.SKYROOT_COD_BUCKET, "A bucket with a Cod in it! Make sure to keep the water topped up or your new friend won't survive the journey home."
      );
      this.addLore(
         AetherBlocks.SKYROOT_DOOR,
         "Crafted from Skyroot Planks, an ornate door helpful for keeping an enclosed and safe space without worry of monsters wandering in."
      );
      ...
      this.addLore(
         AetherBlocks.SKYROOT_HANGING_SIGN, "Crafted from Stripped Skyroot Logs and Chains. A helpful sign perfect for writing messages and directions on."
      );
      this.addLore(
         AetherItems.SKYROOT_HOE,
         "One of the Aether's wooden tools, used to till dirt to allow for the planting of crops. It can also double the drops of many plant-based or organic blocks."
      );
      ...
      this.addLore(
         ...
         "These spawn with Skyroot Trees. They can be double-dropped with Skyroot Axes. When put in a Crafting Table, they will provide 4 Skyroot Planks."
      );
      this.addLore(
         AetherBlocks.SKYROOT_WOOD, "Skyroot Logs crafted to be smooth on all sides. When put in a Crafting Table, they will provide 4 Skyroot Planks."
      );
      this.addLore(AetherItems.SKYROOT_MILK_BUCKET, "A bucket full of fresh milk; drink it to heal potion effects.");
      this.addLore(
         AetherItems.SKYROOT_PICKAXE,
         "One of the Aether's wooden tools. When mining Holystone or Ambrosium Ore, the drops will be doubled. This is even better when combined with an enchantment such as Fortune when mining Ambrosium Shards!"
      );
      this.addLore(
         AetherBlocks.SKYROOT_PLANKS,
         "Skyroot Planks can be made into various tools, blocks, and items. They are crafted from Skyroot Logs and make a great building material."
      );
      ...
      this.addLore(
         AetherItems.SKYROOT_POISON_BUCKET,
      ...
      this.addLore(
         AetherItems.SKYROOT_POWDER_SNOW_BUCKET,
         "A Skyroot Bucket that has been filled with Powder Snow. With quick reactions, it can be used to break the deadliest of falls, even in the Nether!"
      );
      this.addLore(
         AetherItems.SKYROOT_PUFFERFISH_BUCKET,
         "A Skyroot Bucket with a Pufferfish inside. This item serves as a useful way to transport the defensive and poisonous Pufferfish."
      );
      this.addLore(
         AetherItems.SKYROOT_REMEDY_BUCKET, "A Skyroot Bucket containing a soothing remedy. It has a strong smell. Drinking this will cure deadly poison."
      );
      ...
      this.addLore(
         AetherBlocks.SKYROOT_SLAB,
         "Crafted from Skyroot Planks. Slabs are half blocks, versatile for decoration and smooth slopes. Try adding some to a building's roofing!"
      );
      this.addLore(
         AetherBlocks.SKYROOT_STAIRS, "Crafted from Skyroot Planks. Stairs are useful for adding verticality to builds and are often used for decoration too!"
      );
      ...
      this.addLore(
         AetherItems.SKYROOT_SWORD,
         "One of the Aether's wooden tools. It has a low amount of durability and doubles mob drops. It makes an excellent weapon for collecting food when combined with enchantments such as Looting and Fire Aspect."
      );
      this.addLore(
         AetherItems.SKYROOT_TADPOLE_BUCKET,
         "A Skyroot Bucket with a Tadpole inside. Transporting a Tadpole to a new biome can change what type of Frog it grows up into!"
      );
      this.addLore(
         AetherBlocks.SKYROOT_TRAPDOOR,
         "Crafted from Skyroot Planks. A trapdoor is useful for covering one block wide entryways. Often used to add extra protection to staircases."
      );
      this.addLore(
         AetherItems.SKYROOT_TROPICAL_FISH_BUCKET,
         "A Skyroot Bucket containing a Tropical Fish. A helpful way to transport and catalog the numerous varieties of Tropical Fish."
      );
      ...
      this.addLore(
         ...
         "A Skyroot Log that has had its bark stripped away with an Axe. When put in a Crafting Table, they will provide 4 Skyroot Planks."
      );
      this.addLore(
         AetherBlocks.STRIPPED_SKYROOT_WOOD,
         "Stripped Skyroot Logs crafted to be smooth on all sides. When put in a Crafting Table, they will provide 4 Skyroot Planks."
      );
      this.addLore(
         AetherBlocks.SUN_ALTAR,
         "An altar containing the power to control the sun itself! It is dropped by the Sun Spirit after you defeat him. Use it to control the time of day."
      );
      this.addLore(
         AetherItems.SWET_CAPE,
         "A common cape that is found in Bronze Dungeons. It allows for the wearer to ride Swets, as they become friendly when they see someone wearing it."
      );
      this.addLore(
         AetherItems.SWET_BALL,
         "A gooey orb that is dropped from Blue Swets. It can be used to fertilize soil. Another use is to put it alongside String to make a Lead."
      );
      this.addLore(
         AetherBlocks.TREASURE_CHEST,
         "A Treasure Chest, these are found after defeating a Bronze, Silver, or Gold dungeon. They can be opened with the key from the dungeon boss."
      );
      this.addLore(
         AetherItems.VALKYRIE_AXE,
         "A tool unique to the Silver Dungeon. This Axe has a very far reach and very high attack power. You can use this to your advantage, but be warned, the attack cooldown is very high."
      );
      this.addLore(
         AetherItems.VALKYRIE_BOOTS,
         "An armor unique to the Silver Dungeon. When fully worn, you are granted temporary flight. Quite useful for getting to high places."
      );
      this.addLore(
         AetherItems.VALKYRIE_CAPE, "A rare cape that is found in Silver Dungeons. When worn, the wearer becomes lighter than air and can descend slowly."
      );
      this.addLore(
         AetherItems.VALKYRIE_CHESTPLATE,
         "An armor unique to the Silver Dungeon. When fully worn, you are granted temporary flight. Quite useful for getting to high places."
      );
      this.addLore(
         AetherItems.VALKYRIE_GLOVES, "An armor unique to the Silver Dungeon. The gloves are needed to complete the armor set, which grants temporary flight."
      );
      this.addLore(
         AetherItems.VALKYRIE_HELMET,
         "An armor unique to the Silver Dungeon. When fully worn, you are granted temporary flight. Quite useful for getting to high places."
      );
      this.addLore(
         AetherItems.VALKYRIE_HOE,
         "A tool unique to the Silver Dungeon. This hoe has an incredibly far reach, allowing you to pointlessly till dirt from a safe distance."
      );
      this.addLore(
         AetherItems.VALKYRIE_LANCE, "A tool unique to the Bronze Dungeon. This long-range weapon is very good for defeating Zephyrs and Valkyrie Queens."
      );
      this.addLore(
         AetherItems.VALKYRIE_LEGGINGS,
         "An armor unique to the Silver Dungeon. When fully worn, you are granted temporary flight. Quite useful for getting to high places."
      );
      this.addLore(
         AetherItems.VALKYRIE_PICKAXE,
         "A tool unique to the Silver Dungeon. This pickaxe is very useful when it comes to mining blocks from under islands, as it has a very far reach, almost double the normal reach! It is also quite useful for fighting the Slider."
      );
      this.addLore(
         AetherItems.VALKYRIE_SHOVEL,
         "A tool unique to the Silver Dungeon. This shovel can help you reach Quicksoil from a safer distance; quite useful wouldn't you say?"
      );
      ...
      this.addLore(
         AetherItems.VICTORY_MEDAL, "Proof of defeating a lesser Valkyrie. Use these to prove to the Valkyrie Queen you are worthy enough to fight her!"
      );
      ...
      this.addLore(
         AetherItems.ZANITE_AXE,
         "One of the Aether's mid-tier tools, you can mine wood faster than stone, and it will get even faster as the tool is worn down."
      );
      ...
      this.addLore(
         ...
         "The Aether's version of iron. These shiny purple gems can be made into tools and armor that increase in strength when used."
      );
      this.addLore(AetherItems.ZANITE_GLOVES, "A pair of gloves, needed to complete the Zanite armor set.");
      this.addLore(
         AetherItems.ZANITE_HOE,
         "One of the Aether's mid-tier tools, It can be used to harvest many plant-based or organic blocks. It will get even faster at harvesting as the tool is worn down."
      );
      ...
      this.addLore(
         AetherItems.ZANITE_PICKAXE,
         "One of the Aether's mid-tier tools, it mines what iron can, except as its durability decreases, it gets faster. Be careful though, as when it's repaired it will be as slow as before!"
      );
      this.addLore(AetherItems.ZANITE_RING, "A ring which allows you to mine faster. It doesn't last for long, so use it wisely!");
      this.addLore(
         AetherItems.ZANITE_SHOVEL,
         "One of the Aether's mid-tier tools, as you mine Aether Dirt and Quicksoil, the durability will decrease and the shovel will get faster. If you wait long enough, it will start breaking blocks instantly! Be careful repairing it, as it will be slower when there is more durability."
      );
      this.addLore(
         AetherItems.ZANITE_SWORD,
         "One of the Aether's mid-tier tools, the attack damage on this sword starts at iron level and will increase up to twice as strong as it loses durability."
      );
      ...
      this.addLoreUnique(
         ...
         "A mysterious hammer that can shoot projectiles. At one point, it vanished from existence. It's said this was actually Jeb's hammer at one point."
      );
      this.addLoreUnique(
         "item.aether.swet_banner",
         "A decorative banner with the likeness of a Swet. By placing this down you can prevent them from appearing around your home."
      );
      ...
      this.addServerConfig(
         "world_generation",
         "generate_holiday_tree_seasonally",
      ...
      this.addServerConfig(
         "multiplayer", "sun_altar_whitelist", "Makes it so that only whitelisted users or anyone with permission level 4 can use the Sun Altar on a server"
      );
      ...
      this.addServerConfig(
         "modpack", "spawn_in_aether", "Spawns the player in the Aether dimension; this is best enabled alongside other modpack configuration to avoid issues"
      );
      ...
      this.addServerConfig(
         "modpack", "disable_eternal_day", "Removes eternal day so that the Aether has a normal daylight cycle even before defeating the Sun Spirit"
      );
      ...
      this.addCommonConfig(
         "gameplay", "start_with_portal", "On world creation, the player is given an Aether Portal Frame item to automatically go to the Aether with"
      );
      this.addCommonConfig(
         "gameplay", "enable_startup_loot", "When the player enters the Aether, they are given a Book of Lore and Golden Parachutes as starting loot"
      );
      this.addCommonConfig(
         "gameplay",
         "reposition_slider_message",
         "Moves the message for when a player attacks the Slider with an incorrect item to be above the hotbar instead of in chat"
      );
      this.addCommonConfig(
         "gameplay", "repeat_sun_spirit_dialogue", "Determines whether the Sun Spirit's dialogue when meeting him should play through every time you meet him"
      );
      ...
      this.addCommonConfig(
         "data_pack", "add_temporary_freezing_automatically", "Sets the Aether Temporary Freezing data pack to be added to new worlds automatically"
      );
      ...
      this.addCommonConfig(
         "modpack",
         "enable_immersive_portals_compatibility",
      ...
      this.addClientConfig(
         "rendering", "disable_aether_skybox", "Disables the Aether's custom skybox in case you have a shader that is incompatible with custom skyboxes"
      );
      ...
      this.addClientConfig(
         "audio", "disable_aether_boss_music", "Disables the Aether's boss fight music, only works if 'Disables Aether music manager' is false"
      );
      this.addClientConfig(
         "audio",
         "disable_aether_menu_music",
