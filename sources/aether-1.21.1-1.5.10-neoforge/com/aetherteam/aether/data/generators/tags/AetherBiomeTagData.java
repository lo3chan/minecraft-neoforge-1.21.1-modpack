...
public class AetherBiomeTagData extends BiomeTagsProvider {
   public AetherBiomeTagData(PackOutput output, CompletableFuture<Provider> registries, @Nullable ExistingFileHelper helper) {
      super(output, registries, "aether", helper);
   }

   public void addTags(Provider provider) {
      this.tag(AetherTags.Biomes.IS_AETHER)
         .add(new ResourceKey[]{AetherBiomes.SKYROOT_MEADOW, AetherBiomes.SKYROOT_GROVE, AetherBiomes.SKYROOT_WOODLAND, AetherBiomes.SKYROOT_FOREST});
      ...
      this.tag(AetherTags.Biomes.HAS_RUINED_PORTAL_STANDARD)
         .add(new ResourceKey[]{Biomes.FOREST, Biomes.SNOWY_TAIGA, Biomes.MUSHROOM_FIELDS, Biomes.SNOWY_PLAINS, Biomes.PLAINS});
      ...
      this.tag(AetherTags.Biomes.HAS_RUINED_PORTAL_MOUNTAIN).add(new ResourceKey[]{Biomes.WINDSWEPT_HILLS, Biomes.STONY_PEAKS});
      ...
      this.tag(AetherTags.Biomes.PODZOL_CONVERSION).add(new ResourceKey[]{Biomes.OLD_GROWTH_PINE_TAIGA, Biomes.OLD_GROWTH_SPRUCE_TAIGA, Biomes.BAMBOO_JUNGLE});
