...
public abstract class AetherItemModelProvider extends NitrogenItemModelProvider {
   ...
   public void lanceItem(Item item, String location) {
      ((ItemModelBuilder)((ItemModelBuilder)this.withExistingParent(this.itemName(item), this.mcLoc("item/handheld")))
   ...
   public void nameableWeapon(Item item, String location, String renamedVariant) {
      ((ItemModelBuilder)this.withExistingParent(renamedVariant, this.mcLoc("item/handheld")))
         .texture("layer0", this.modLoc("item/" + location + renamedVariant));
      ((ItemModelBuilder)((ItemModelBuilder)this.withExistingParent(this.itemName(item), this.mcLoc("item/handheld")))
            .texture("layer0", this.modLoc("item/" + location + this.itemName(item))))
         .override()
         .predicate(ResourceLocation.fromNamespaceAndPath("aether", "named"), 1.0F)
         .model(this.getExistingFile(this.modLoc("item/" + renamedVariant)))
         .end();
   }
   ...
   public void dyedGlovesItem(Item item, String location) {
      ItemModelBuilder builder = (ItemModelBuilder)((ItemModelBuilder)((ItemModelBuilder)this.withExistingParent(
               this.itemName(item), this.mcLoc("item/generated")
            ))
            .texture("layer0", this.modLoc("item/" + location + this.itemName(item))))
      ...
      for (ResourceKey<TrimMaterial> trimMaterial : NitrogenItemModelProvider.VANILLA_TRIM_MATERIALS) {
         String material = trimMaterial.location().getPath();
         String name = this.itemName(item) + "_" + material + "_trim";
         ((ItemModelBuilder)((ItemModelBuilder)((ItemModelBuilder)this.withExistingParent(name, this.mcLoc("item/generated")))
                  .texture("layer0", this.modLoc("item/" + location + this.itemName(item))))
               .texture("layer1", this.modLoc("item/" + location + this.itemName(item) + "_overlay")))
   ...
   public void aercloudItem(Block block) {
      ((ItemModelBuilder)((ItemModelBuilder)this.withExistingParent(this.blockName(block), this.mcLoc("block/cube_all")))
            .texture("all", this.texture(this.blockName(block), "natural/")))
   ...
   public void itemOverlayDungeonBlock(Block block, Block baseBlock, String overlay) {
      ((ItemModelBuilder)((ItemModelBuilder)((ItemModelBuilder)((ItemModelBuilder)((ItemModelBuilder)this.withExistingParent(
                  ...
                  .texture("face", this.texture(this.blockName(baseBlock), "dungeon/")))
               .element()
               .from(0.0F, 0.0F, 0.0F)
