...
public abstract class AetherBlockStateProvider extends NitrogenBlockStateProvider {
   ...
   public void grassBlock(Block baseBlock, Block blockForSnow, Block blockForDirt) {
      ...
      ModelFile grassSnowed = this.cubeBottomTop(
         this.name(blockForSnow) + "_snow",
      ...
      this.getVariantBuilder(baseBlock).forAllStatesExcept(state -> {
         boolean snowy = (Boolean)state.getValue(SnowyDirtBlock.SNOWY);
   ...
   public void dirtPath(Block block, Block dirtBlock) {
      ModelFile path = ((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)this.models()
                     .withExistingParent(this.name(block), this.mcLoc("block/dirt_path")))
      ...
      this.getVariantBuilder(block)
         .forAllStatesExcept(state -> ConfiguredModel.allYRotations(path, 0, false), new Property[]{AetherBlockStateProperties.DOUBLE_DROPS});
   }
   ...
   public void aercloud(
      Block block,
      ResourceLocation upInside,
      ResourceLocation upOutside,
      ResourceLocation downOutside,
      ResourceLocation downInside,
      ResourceLocation northOutside,
      ResourceLocation northInside,
      ResourceLocation southInside,
      ResourceLocation southOutside,
      ResourceLocation westOutside,
      ResourceLocation westInside,
      ResourceLocation eastInside,
      ResourceLocation eastOutside,
      ResourceLocation particle
   ) {
      ModelFile model = ((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)this.models()
                                                                     .withExistingParent(this.name(block), this.mcLoc("block/block")))
                        ...
                        .element()
                        .from(0.0F, 15.998F, 0.0F)
                        .to(16.0F, 16.0F, 16.0F)
                        .face(Direction.DOWN)
                        .texture("#up_inside")
                        .uvs(0.0F, 16.0F, 16.0F, 0.0F)
                     ...
                     .element()
                     .from(0.0F, 0.0F, 0.0F)
                     .to(16.0F, 0.002F, 16.0F)
                     .face(Direction.DOWN)
                     .texture("#down_outside")
                     .uvs(0.0F, 0.0F, 16.0F, 16.0F)
                  ...
                  .element()
                  .from(0.0F, 0.0F, 0.0F)
                  .to(16.0F, 16.0F, 0.002F)
                  .face(Direction.NORTH)
                  .texture("#north_outside")
                  .uvs(0.0F, 0.0F, 16.0F, 16.0F)
                  .cullface(Direction.NORTH)
                  .end()
                  .face(Direction.SOUTH)
                  .texture("#north_inside")
                  .uvs(16.0F, 0.0F, 0.0F, 16.0F)
                  .cullface(Direction.NORTH)
                  .end()
                  .end())
               .element()
               .from(0.0F, 0.0F, 15.998F)
               .to(16.0F, 16.0F, 16.0F)
               .face(Direction.NORTH)
               .texture("#south_inside")
               .uvs(16.0F, 0.0F, 0.0F, 16.0F)
            ...
            .element()
            .from(0.0F, 0.0F, 0.0F)
            .to(0.002F, 16.0F, 16.0F)
            .face(Direction.WEST)
            .texture("#west_outside")
            .uvs(0.0F, 0.0F, 16.0F, 16.0F)
         ...
         .end()
         .face(Direction.EAST)
         .texture("#east_outside")
         .uvs(0.0F, 0.0F, 16.0F, 16.0F)
         .cullface(Direction.EAST)
         .end()
         .end();
      this.getVariantBuilder(block).partialState().addModels(new ConfiguredModel[]{new ConfiguredModel(model)});
   }

   public void farmland(Block block, Block dirtBlock) {
      ModelFile farmland = ((BlockModelBuilder)((BlockModelBuilder)this.models().withExistingParent(this.name(block), this.mcLoc("block/template_farmland")))
            .texture("dirt", this.modLoc("block/natural/" + this.name(dirtBlock))))
         .texture("top", this.modLoc("block/construction/" + this.name(block)));
      ModelFile moist = ((BlockModelBuilder)((BlockModelBuilder)this.models()
               .withExistingParent(this.name(block) + "_moist", this.mcLoc("block/template_farmland")))
            .texture("dirt", this.modLoc("block/natural/" + this.name(dirtBlock))))
         .texture("top", this.modLoc("block/construction/" + this.name(block) + "_moist"));
      this.getVariantBuilder(block).forAllStatesExcept(state -> {
         int moisture = (Integer)state.getValue(AetherFarmBlock.MOISTURE);
   ...
   public void randomBlockDoubleDrops(Block block, String location) {
      this.getVariantBuilder(block)
         .forAllStatesExcept(
            state -> ConfiguredModel.allYRotations(this.cubeAll(block, location), 0, false), new Property[]{AetherBlockStateProperties.DOUBLE_DROPS}
         );
   }
   ...
   public void blockDoubleDrops(Block block, String location) {
      this.getVariantBuilder(block)
         .forAllStatesExcept(
            state -> ConfiguredModel.builder().modelFile(this.cubeAll(block, location)).build(), new Property[]{AetherBlockStateProperties.DOUBLE_DROPS}
         );
   }
   ...
   public void altar(Block block) {
      ModelFile altar = this.cubeBottomTop(
         this.name(block),
   ...
   public ModelFile bush(Block block, Block stem) {
      return ((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)this.models()
                              .withExistingParent(this.name(block), this.mcLoc("block/block")))
                           .texture("particle", this.texture(this.name(block), "natural/")))
                        .texture("bush", this.texture(this.name(block), "natural/")))
                     .texture("stem", this.texture(this.name(stem), "natural/")))
                  .element()
                  .from(0.0F, 0.0F, 0.0F)
                  .to(16.0F, 16.0F, 16.0F)
                  .shade(true)
                  .allFaces((direction, builder) -> builder.texture("#bush").end())
                  .end())
               .element()
               .from(0.8F, 0.0F, 8.0F)
               .to(15.2F, 16.0F, 8.0F)
   ...
   public BlockModelBuilder pottedStemModel(Block block, Block stem, String location) {
      return (BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)this.models()
                                                .withExistingParent(this.name(block), this.mcLoc("block/block")))
                                             .texture("particle", this.mcLoc("block/flower_pot")))
                                          .texture("stem", this.modLoc("block/" + location + this.name(stem))))
                                       .texture("dirt", this.mcLoc("block/dirt")))
                                    .texture("flowerpot", this.mcLoc("block/flower_pot")))
                                 .element()
                                 .from(5.0F, 0.0F, 5.0F)
                                 .to(6.0F, 6.0F, 11.0F)
                                 .face(Direction.NORTH)
                                 .uvs(10.0F, 10.0F, 11.0F, 16.0F)
                                 .texture("#flowerpot")
                                 .end()
                                 .face(Direction.EAST)
                                 .uvs(5.0F, 10.0F, 11.0F, 16.0F)
                                 .texture("#flowerpot")
                                 .end()
                                 .face(Direction.SOUTH)
                                 .uvs(5.0F, 10.0F, 6.0F, 16.0F)
                                 .texture("#flowerpot")
                                 .end()
                                 .face(Direction.WEST)
                                 .uvs(5.0F, 10.0F, 11.0F, 16.0F)
                           ...
                           .end()
                           .face(Direction.UP)
                           .uvs(6.0F, 5.0F, 10.0F, 6.0F)
                           .texture("#flowerpot")
                           .end()
                           .face(Direction.DOWN)
                           .uvs(6.0F, 10.0F, 10.0F, 11.0F)
                           .texture("#flowerpot")
                           .cullface(Direction.DOWN)
                           .end()
                           .end())
                        .element()
                        .from(6.0F, 0.0F, 10.0F)
                        .to(10.0F, 6.0F, 11.0F)
                        .face(Direction.NORTH)
                        .uvs(6.0F, 10.0F, 10.0F, 16.0F)
                        .texture("#flowerpot")
                     ...
                     .to(10.0F, 4.0F, 10.0F)
                     .face(Direction.UP)
                     .uvs(6.0F, 6.0F, 10.0F, 10.0F)
                     .texture("#dirt")
                     .end()
                     .face(Direction.DOWN)
                     .uvs(6.0F, 12.0F, 10.0F, 16.0F)
                     .texture("#flowerpot")
                     .cullface(Direction.DOWN)
                     .end()
                     .end())
   ...
   public void pottedStem(Block stem, String location) {
      ...
      this.getVariantBuilder(stem).partialState().addModels(new ConfiguredModel[]{new ConfiguredModel(pot)});
   }

   public void pottedBush(Block bush, Block stem, String location) {
      ModelFile pot = ((BlockModelBuilder)((BlockModelBuilder)((BlockModelBuilder)this.pottedStemModel(bush, stem, location)
                  .texture("stem", this.modLoc("block/" + location + this.name(stem))))
               .texture("bush", this.modLoc("block/" + location + this.name(bush))))
            .element()
            .from(3.0F, 6.0F, 3.0F)
            .to(13.0F, 16.0F, 13.0F)
            .face(Direction.NORTH)
            ...
            .end())
         .renderType(ResourceLocation.withDefaultNamespace("cutout"));
      this.getVariantBuilder(bush).partialState().addModels(new ConfiguredModel[]{new ConfiguredModel(pot)});
   }
   ...
   public void invisibleBlock(Block block, Block baseBlock) {
      ...
      this.getVariantBuilder(block)
         .forAllStatesExcept(
            state -> !state.getValue(DoorwayBlock.INVISIBLE)
               ? ConfiguredModel.builder().modelFile(visible).build()
               : ConfiguredModel.builder().modelFile(invisible).build(),
            new Property[0]
         );
   }
   ...
   public void pillarTop(FacingPillarBlock block) {
      ...
      ((VariantBlockStateBuilder)((VariantBlockStateBuilder)((VariantBlockStateBuilder)((VariantBlockStateBuilder)((VariantBlockStateBuilder)this.getVariantBuilder(
                           block
                        )
                        .partialState()
                        .with(FacingPillarBlock.FACING, Direction.DOWN)
                        .modelForState()
                        .modelFile(vertical)
                        .rotationX(180)
                        .addModel())
                     .partialState()
                     .with(FacingPillarBlock.FACING, Direction.EAST)
                     .modelForState()
                     ...
                     .addModel())
                  .partialState()
                  .with(FacingPillarBlock.FACING, Direction.NORTH)
                  .modelForState()
                  .modelFile(horizontal)
                  .rotationX(90)
                  .addModel())
               .partialState()
               .with(FacingPillarBlock.FACING, Direction.SOUTH)
               .modelForState()
               .modelFile(horizontal)
               .rotationX(90)
               .rotationY(180)
               .addModel())
            .partialState()
            .with(FacingPillarBlock.FACING, Direction.UP)
            .modelForState()
            .modelFile(vertical)
            .addModel())
         .partialState()
         .with(FacingPillarBlock.FACING, Direction.WEST)
         .modelForState()
         .modelFile(horizontal)
         .rotationX(90)
         .rotationY(270)
   ...
   public void present(Block block) {
      ModelFile present = this.cubeBottomTop(
         this.name(block),
   ...
   public void sunAltar(Block block) {
      ModelFile sunAltar = this.cubeBottomTop(
         this.name(block),
         this.extend(this.texture(this.name(block), "utility/"), "_side"),
         this.texture("hellfire_stone", "dungeon/"),
         this.extend(this.texture(this.name(block), "utility/"), "_top")
      );
   ...
   public void bed(Block block, Block dummyBlock) {
      ...
      this.getVariantBuilder(block).forAllStatesExcept(state -> {
         ...
         BedPart part = (BedPart)state.getValue(BlockStateProperties.BED_PART);
   ...
   public void frostedIce(Block block, Block base) {
      this.getVariantBuilder(block)
         .forAllStates(
            state -> {
               int age = (Integer)state.getValue(AetherFrostedIceBlock.AGE);
               return ConfiguredModel.builder()
                  .modelFile(
                     ((BlockModelBuilder)this.models().cubeAll(this.name(block) + "_" + age, this.mcLoc("block/" + this.name(base) + "_" + age)))
                        .renderType(ResourceLocation.withDefaultNamespace("translucent"))
                  )
                  .build();
            }
   ...
   public void unstableObsidian(Block block) {
      this.getVariantBuilder(block)
         .forAllStates(
            state -> {
               int age = (Integer)state.getValue(UnstableObsidianBlock.AGE);
               return ConfiguredModel.builder()
                  .modelFile(this.models().cubeAll(this.name(block) + "_" + age, this.texture(this.name(block) + "_" + age, "miscellaneous/")))
                  .build();
            }
         );
   }
