...
public class LogoRendererMixin {
   ...
   private void render(
      ...
      LogoRenderer renderer = (LogoRenderer)this;
      if (renderer instanceof CustomPosition customPosition) {
         original.call(
            new Object[]{
               instance,
               atlasLocation,
               (int)customPosition.getXOffset(x),
               (int)customPosition.getYOffset(y),
               uOffset,
               vOffset,
               width,
               height,
         ...
         original.call(new Object[]{instance, atlasLocation, x, y, uOffset, vOffset, width, height, textureWidth, textureHeight});
      }
   }
}
