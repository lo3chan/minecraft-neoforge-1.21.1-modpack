...
public class IceCrystal extends AbstractCrystal implements WeaknessDamage {
   ...
   public IceCrystal(Level level, Entity shooter) {
      ...
      this.xPower = Mth.sin(rotation) * 0.2;
      this.zPower = -Mth.cos(rotation) * 0.2;
   ...
   public void doDamage(Entity entity) {
      if (this.getOwner() != entity
         ...
         && livingEntity.hurt(AetherDamageTypes.indirectEntityDamageSource(this.level(), AetherDamageTypes.ICE_CRYSTAL, this, this.getOwner()), 7.0F)) {
