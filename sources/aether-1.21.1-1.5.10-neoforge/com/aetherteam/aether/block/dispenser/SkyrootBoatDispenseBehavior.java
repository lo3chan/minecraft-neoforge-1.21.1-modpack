...
public class SkyrootBoatDispenseBehavior extends DefaultDispenseItemBehavior {
   ...
   public ItemStack execute(BlockSource source, ItemStack stack) {
      ...
      double d0 = 0.5625 + ((EntityType)AetherEntityTypes.SKYROOT_BOAT.get()).getWidth() / 2.0;
      ...
      Boat boat = (Boat)(this.isChestBoat ? new SkyrootChestBoat(serverLevel, d1, d2, d3) : new SkyrootBoat(serverLevel, d1, d2, d3));
