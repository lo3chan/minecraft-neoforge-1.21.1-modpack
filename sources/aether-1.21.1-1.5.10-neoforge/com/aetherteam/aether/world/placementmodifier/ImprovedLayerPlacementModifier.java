...
public class ImprovedLayerPlacementModifier extends PlacementModifier {
   public static final MapCodec<ImprovedLayerPlacementModifier> CODEC = RecordCodecBuilder.mapCodec(
      codec -> codec.group(
            Types.CODEC.fieldOf("heightmap").forGetter(modifier -> modifier.heightmap),
            IntProvider.codec(0, 256).fieldOf("count").forGetter(modifier -> modifier.count),
            Codec.INT.optionalFieldOf("verticalBounds", -2147483648).forGetter(modifier -> modifier.verticalBounds)
         )
   ...
   private ImprovedLayerPlacementModifier(Types heightmap, IntProvider count, int verticalBounds) {
      this.heightmap = heightmap;
      this.count = count;
      this.verticalBounds = verticalBounds;
   }

   public static ImprovedLayerPlacementModifier of(Types heightmap, IntProvider count, int verticalBounds) {
