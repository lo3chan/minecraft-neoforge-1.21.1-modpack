...
public record ShelfConfiguration(BlockStateProvider block, FloatProvider radius, UniformInt yRange, HolderSet<Block> validBlocks)
   implements FeatureConfiguration {
   public static final Codec<ShelfConfiguration> CODEC = RecordCodecBuilder.create(
