...
public class BorderBoxPosTest extends PosRuleTest {
   public static final MapCodec<BorderBoxPosTest> CODEC = RecordCodecBuilder.mapCodec(
   ...
   private boolean isBorderBlock(int relativeX, int relativeY, int relativeZ) {
      return relativeX == this.baseX
         || relativeX == this.width
         || relativeY == this.baseY
         || relativeY == this.height
         || relativeZ == this.baseZ
         || relativeZ == this.length;
   }
