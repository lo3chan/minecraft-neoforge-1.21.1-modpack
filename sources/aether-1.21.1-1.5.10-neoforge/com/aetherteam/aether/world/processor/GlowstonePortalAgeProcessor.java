...
public class GlowstonePortalAgeProcessor extends StructureProcessor {
   public static final MapCodec<GlowstonePortalAgeProcessor> CODEC = Codec.FLOAT
      .fieldOf("mossiness")
      .xmap(GlowstonePortalAgeProcessor::new, codec -> codec.mossiness);
   ...
   public StructureBlockInfo process(
      ...
      return newState != null ? new StructureBlockInfo(blockPos, newState, relativeBlockInfo.nbt()) : relativeBlockInfo;
   }
