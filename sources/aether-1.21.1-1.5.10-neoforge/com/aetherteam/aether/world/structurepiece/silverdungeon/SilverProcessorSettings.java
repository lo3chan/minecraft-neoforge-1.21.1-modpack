...
public record SilverProcessorSettings(
   Holder<StructureProcessorList> roomSettings, Holder<StructureProcessorList> floorSettings, Holder<StructureProcessorList> bossSettings
) {
   public static final MapCodec<SilverProcessorSettings> CODEC = RecordCodecBuilder.mapCodec(
