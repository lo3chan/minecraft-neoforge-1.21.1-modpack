...
public record GoldProcessorSettings(
   Holder<StructureProcessorList> islandSettings, Holder<StructureProcessorList> tunnelSettings, Holder<StructureProcessorList> bossSettings
) {
   public static final MapCodec<GoldProcessorSettings> CODEC = RecordCodecBuilder.mapCodec(
