...
public class SheepuffWoolLayer extends RenderLayer<Sheepuff, SheepuffModel> {
   private static final ResourceLocation SHEEPUFF_WOOL_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "aether", "textures/entity/mobs/sheepuff/sheepuff_wool.png"
   );
   ...
   public void render(
      ...
      if (!sheepuff.isSheared()) {
         ...
         if (sheepuff.isInvisible()) {
            ...
            if (flag) {
               ((SheepuffModel)this.getParentModel()).copyPropertiesTo(woolModel);
