...
public class AechorPlantModel extends EntityModel<AechorPlant> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition stem = partDefinition.addOrReplaceChild(
         "stem", CubeListBuilder.create().texOffs(24, 13).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F), PartPose.offset(0.0F, 1.0F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "head",
         CubeListBuilder.create().texOffs(0, 12).addBox(-3.0F, -3.0F, -3.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.75F)),
         PartPose.offset(0.0F, 1.0F, 0.0F)
      );
      stem.addOrReplaceChild(
         "thorn_1", CubeListBuilder.create().texOffs(32, 13).addBox(-1.75F, 1.25F, -1.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.ZERO
      );
      stem.addOrReplaceChild(
         "thorn_2", CubeListBuilder.create().texOffs(32, 13).addBox(-1.0F, 2.25F, 0.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.ZERO
      );
      stem.addOrReplaceChild(
         "thorn_3", CubeListBuilder.create().texOffs(32, 13).addBox(0.75F, 1.25F, 0.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.ZERO
      );
      stem.addOrReplaceChild(
         "thorn_4", CubeListBuilder.create().texOffs(32, 13).addBox(0.0F, 2.25F, -1.75F, 1.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.ZERO
      );
      PartDefinition stamenStem1 = stem.addOrReplaceChild(
         "stamen_stem_1", CubeListBuilder.create().texOffs(36, 13).addBox(0.0F, -9.0F, -1.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.ZERO
      );
      PartDefinition stamenStem2 = stem.addOrReplaceChild(
         "stamen_stem_2", CubeListBuilder.create().texOffs(36, 13).addBox(0.0F, -9.0F, -1.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.ZERO
      );
      PartDefinition stamenStem3 = stem.addOrReplaceChild(
         "stamen_stem_3", CubeListBuilder.create().texOffs(36, 13).addBox(0.0F, -9.0F, -1.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.ZERO
      );
      stamenStem1.addOrReplaceChild(
         "stamen_tip_1", CubeListBuilder.create().texOffs(32, 15).addBox(0.0F, -9.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.125F)), PartPose.ZERO
      );
      stamenStem2.addOrReplaceChild(
         "stamen_tip_2", CubeListBuilder.create().texOffs(32, 15).addBox(0.0F, -9.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.125F)), PartPose.ZERO
      );
      stamenStem3.addOrReplaceChild(
         "stamen_tip_3", CubeListBuilder.create().texOffs(32, 15).addBox(0.0F, -9.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.125F)), PartPose.ZERO
      );

      for (int i = 1; i <= 10; i++) {
         stem.addOrReplaceChild(
            "leaf_" + i, CubeListBuilder.create().texOffs(38, 13).addBox(-2.0F, -1.0F, -9.5F, 4.0F, 1.0F, 8.0F, new CubeDeformation(-0.15F)), PartPose.ZERO
         );
      }
      ...
      for (int i = 1; i <= 5; i++) {
         stem.addOrReplaceChild(
            "upper_petal_" + i,
            CubeListBuilder.create().texOffs(28, 2).addBox(-4.0F, -1.0F, -12.0F, 8.0F, 1.0F, 10.0F, new CubeDeformation(-0.25F)),
            PartPose.ZERO
         );
      }
      ...
      for (int i = 1; i <= 5; i++) {
         stem.addOrReplaceChild(
            "lower_petal_" + i,
            CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -1.0F, -12.0F, 8.0F, 1.0F, 10.0F, new CubeDeformation(-0.25F)),
            PartPose.offset(0.0F, -1.0F, 0.0F)
         );
      }
