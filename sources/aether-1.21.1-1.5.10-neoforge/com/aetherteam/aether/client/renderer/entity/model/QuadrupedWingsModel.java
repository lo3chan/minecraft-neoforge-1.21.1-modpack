...
public class QuadrupedWingsModel<T extends WingedAnimal> extends EntityModel<T> {
   ...
   public static LayerDefinition createMainLayer(float offset) {
      ...
      PartDefinition leftWingInnerDef = partDefinition.addOrReplaceChild(
         "left_wing_inner",
         CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.0F, -16.0F, 0.0F, 2.0F, 16.0F, 8.0F),
         PartPose.offset(-4.0F, 2.0F + offset, -4.0F)
      );
      leftWingInnerDef.addOrReplaceChild(
         "left_wing_outer",
         CubeListBuilder.create().texOffs(20, 0).mirror().addBox(-1.0F, -16.0F, 5.0E-4F, 2.0F, 16.0F, 7.999F),
         PartPose.offset(0.0F, -16.0F, 0.0F)
      );
      PartDefinition rightWingInnerDef = partDefinition.addOrReplaceChild(
         "right_wing_inner", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -16.0F, 0.0F, 2.0F, 16.0F, 8.0F), PartPose.offset(4.0F, 2.0F + offset, -4.0F)
      );
      rightWingInnerDef.addOrReplaceChild(
         "right_wing_outer", CubeListBuilder.create().texOffs(20, 0).addBox(-1.0F, -16.0F, 5.0E-4F, 2.0F, 16.0F, 7.999F), PartPose.offset(0.0F, -16.0F, 0.0F)
      );
   ...
   public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      if (!Minecraft.getInstance().isPaused()) {
         ...
         this.leftWingInner.zRot = -(entity.getWingAngle() + wingBend + 1.5707964F);
         this.leftWingOuter.zRot = -(entity.getWingAngle() - wingBend + 1.5707964F) - this.leftWingInner.zRot;
