...
public class ValkyrieQueenRenderer extends MobRenderer<ValkyrieQueen, ValkyrieModel<ValkyrieQueen>> {
   private static final ResourceLocation VALKYRIE_QUEEN_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "aether", "textures/entity/mobs/valkyrie_queen/valkyrie_queen.png"
   );

   public ValkyrieQueenRenderer(Context context) {
