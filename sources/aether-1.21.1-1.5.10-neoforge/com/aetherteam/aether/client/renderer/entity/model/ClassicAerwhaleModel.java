...
public class ClassicAerwhaleModel extends EntityModel<Aerwhale> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      partDefinition.addOrReplaceChild(
         "middle_body", CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, -6.0F, 1.0F, 15.0F, 15.0F, 15.0F), PartPose.offset(0.0F, -1.0F, 14.0F)
      );
      ...
      partDefinition.addOrReplaceChild(
         "back_body", CubeListBuilder.create().texOffs(0, 30).addBox(-6.0F, -9.0F, -8.5F, 9.0F, 9.0F, 12.0F), PartPose.offset(0.0F, 2.2F, 38.0F)
      );
      partDefinition.addOrReplaceChild(
         "back_fin_right",
         CubeListBuilder.create().texOffs(0, 51).addBox(-4.0F, 0.0F, -6.0F, 24.0F, 3.0F, 12.0F),
         PartPose.offsetAndRotation(-5.0F, 2.2F, 38.0F, -0.10471976F, -2.5497515F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "back_fin_left",
         CubeListBuilder.create().texOffs(0, 51).addBox(-4.0F, 0.0F, -6.0F, 24.0F, 3.0F, 12.0F),
         PartPose.offsetAndRotation(3.0F, 2.2F, 38.0F, 0.10471976F, -0.5934119F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "fin_right",
         CubeListBuilder.create().texOffs(0, 66).addBox(-12.0F, 1.4F, -6.0F, 12.0F, 3.0F, 6.0F),
         PartPose.offsetAndRotation(-10.0F, 4.0F, 10.0F, 0.0F, 0.17453292F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "fin_left",
         CubeListBuilder.create().texOffs(0, 66).addBox(0.0F, 1.4F, -6.0F, 12.0F, 3.0F, 6.0F),
         PartPose.offsetAndRotation(7.0F, 4.0F, 10.0F, 0.0F, -0.17453292F, 0.0F)
      );
