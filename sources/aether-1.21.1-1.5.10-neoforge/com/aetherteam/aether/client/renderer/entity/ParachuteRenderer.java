...
public class ParachuteRenderer extends EntityRenderer<Parachute> {
   ...
   public ParachuteRenderer(Context context, Supplier<? extends Block> parachuteBlock) {
      super(context);
   ...
   public void render(Parachute parachute, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
      ...
      Minecraft.getInstance()
         .getBlockRenderer()
         .renderSingleBlock(this.parachuteBlock.get().defaultBlockState(), poseStack, buffer, packedLight, OverlayTexture.NO_OVERLAY);
      poseStack.popPose();
