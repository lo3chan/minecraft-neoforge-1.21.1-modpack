...
public class ValkyrieWingsModel<T extends Entity> extends EntityModel<T> {
   ...
   public static LayerDefinition createMainLayer(float offsetY, float offsetZ) {
      ...
      partDefinition.addOrReplaceChild(
         "right_wing",
         CubeListBuilder.create().texOffs(24, 31).mirror().addBox(-19.0F, -4.5F, 0.0F, 19.0F, 8.0F, 1.0F),
         PartPose.offsetAndRotation(-0.5F, offsetY, offsetZ, 0.0F, 0.2F, 0.125F)
      );
      partDefinition.addOrReplaceChild(
         "left_wing",
         CubeListBuilder.create().texOffs(24, 31).addBox(0.0F, -4.5F, 0.0F, 19.0F, 8.0F, 1.0F),
         PartPose.offsetAndRotation(0.5F, offsetY, offsetZ, 0.0F, -0.2F, -0.125F)
      );
