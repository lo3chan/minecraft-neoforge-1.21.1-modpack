...
public class ValkyrieModel<T extends AbstractValkyrie> extends HumanoidModel<T> {
   public final ModelPart upperBody = this.body.getChild("upper_body");
   public final ModelPart rightShoulder = this.rightArm.getChild("right_shoulder");
   public final ModelPart leftShoulder = this.leftArm.getChild("left_shoulder");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition head = partDefinition.addOrReplaceChild(
         "head", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F), PartPose.ZERO
      );
      PartDefinition body = partDefinition.addOrReplaceChild(
         "body", CubeListBuilder.create().texOffs(12, 16).addBox(-3.0F, 0.0F, -1.5F, 6.0F, 12.0F, 3.0F), PartPose.ZERO
      );
      body.addOrReplaceChild(
         "upper_body", CubeListBuilder.create().texOffs(12, 16).addBox(-3.0F, 0.5F, -1.25F, 6.0F, 5.0F, 3.0F, new CubeDeformation(0.75F)), PartPose.ZERO
      );
      PartDefinition rightArm = partDefinition.addOrReplaceChild(
         "right_arm",
         CubeListBuilder.create().texOffs(30, 16).addBox(-3.0F, -1.5F, -1.5F, 3.0F, 12.0F, 3.0F),
         PartPose.offsetAndRotation(-4.0F, 1.5F, 0.0F, 0.0F, 0.0F, 0.05F)
      );
      rightArm.addOrReplaceChild(
         "right_shoulder", CubeListBuilder.create().texOffs(30, 16).addBox(-3.0F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.75F)), PartPose.ZERO
      );
      PartDefinition leftArm = partDefinition.addOrReplaceChild(
         "left_arm",
         CubeListBuilder.create().texOffs(30, 16).mirror().addBox(-1.0F, -1.5F, -1.5F, 3.0F, 12.0F, 3.0F),
         PartPose.offsetAndRotation(5.0F, 1.5F, 0.0F, 0.0F, 0.0F, -0.05F)
      );
      leftArm.addOrReplaceChild(
         "left_shoulder",
         CubeListBuilder.create().texOffs(30, 16).mirror().addBox(-1.0F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.75F)),
         PartPose.ZERO
      );
      partDefinition.addOrReplaceChild(
         "right_leg", CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F), PartPose.offset(-1.0F, 12.0F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "left_leg", CubeListBuilder.create().texOffs(0, 16).mirror().addBox(-2.0F, 0.0F, -1.5F, 3.0F, 12.0F, 3.0F), PartPose.offset(2.0F, 12.0F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "right_front_skirt",
         CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -1.0F, 3.0F, 6.0F, 1.0F),
         PartPose.offsetAndRotation(-3.0F, 9.0F, -1.5F, -0.2F, 0.0F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "left_front_skirt",
         CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, -1.0F, 3.0F, 6.0F, 1.0F),
         PartPose.offsetAndRotation(0.0F, 9.0F, -1.5F, -0.2F, 0.0F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "right_back_skirt",
         CubeListBuilder.create().texOffs(0, 0).addBox(0.0F, 0.0F, 0.0F, 3.0F, 6.0F, 1.0F),
         PartPose.offsetAndRotation(-3.0F, 9.0F, 1.5F, 0.2F, 0.0F, 0.0F)
      );
      partDefinition.addOrReplaceChild(
         "left_back_skirt",
      ...
      partDefinition.addOrReplaceChild(
         "right_side_skirt",
         CubeListBuilder.create().texOffs(55, 19).addBox(-1.0F, 0.0F, 0.0F, 1.0F, 6.0F, 3.01F),
         PartPose.offsetAndRotation(-3.0F, 9.0F, -1.505F, 0.0F, 0.0F, 0.2F)
      );
      partDefinition.addOrReplaceChild(
         "left_side_skirt",
         CubeListBuilder.create().texOffs(55, 19).addBox(0.0F, 0.0F, 0.0F, 1.0F, 6.0F, 3.01F),
         PartPose.offsetAndRotation(3.0F, 9.0F, -1.505F, 0.0F, 0.0F, -0.2F)
      );
      PartDefinition swordHandle = rightArm.addOrReplaceChild(
         "sword_handle", CubeListBuilder.create().texOffs(9, 16).addBox(-2.5F, 8.0F, 1.5F, 2.0F, 2.0F, 1.0F), PartPose.ZERO
      );
      swordHandle.addOrReplaceChild(
         "sword_hilt", CubeListBuilder.create().texOffs(32, 10).addBox(-3.0F, 6.5F, -2.75F, 3.0F, 5.0F, 1.0F, new CubeDeformation(0.5F)), PartPose.ZERO
      );
      ...
      swordHandle.addOrReplaceChild(
         "sword_blade_middle", CubeListBuilder.create().texOffs(42, 18).addBox(-2.0F, 7.5F, -22.5F, 1.0F, 3.0F, 10.0F), PartPose.ZERO
      );
