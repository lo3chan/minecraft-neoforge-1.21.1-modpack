...
public class PhygRenderer extends MobRenderer<Phyg, PigModel<Phyg>> {
   private static final ResourceLocation PHYG_TEXTURE = ResourceLocation.fromNamespaceAndPath("aether", "textures/entity/mobs/phyg/phyg.png");

   public PhygRenderer(Context context) {
      super(context, new PigModel(context.bakeLayer(AetherModelLayers.PHYG)), 0.7F);
      this.addLayer(
         new QuadrupedWingsLayer(
            this,
            new QuadrupedWingsModel(context.bakeLayer(AetherModelLayers.PHYG_WINGS)),
            ResourceLocation.fromNamespaceAndPath("aether", "textures/entity/mobs/phyg/phyg_wings.png")
         )
      );
      this.addLayer(
         new SaddleLayer(
            this, new PigModel(context.bakeLayer(AetherModelLayers.PHYG_SADDLE)), ResourceLocation.withDefaultNamespace("textures/entity/pig/pig_saddle.png")
         )
      );
