...
public class ThunderCrystalRenderer extends AbstractCrystalRenderer<ThunderCrystal> {
   private static final ResourceLocation THUNDER_CRYSTAL_TEXTURE = ResourceLocation.fromNamespaceAndPath(
      "aether", "textures/entity/projectile/crystals/electric_ball.png"
   );

   public ThunderCrystalRenderer(Context context) {
