...
public abstract class MultiModelRenderer<T extends Mob, M extends EntityModel<T>, N extends M, O extends M> extends MobRenderer<T, M> {
   public MultiModelRenderer(Context context, N defaultModel, float shadowRadius) {
   ...
   public M getModel() {
      return (M)(AetherConfig.CLIENT.legacy_models.get() ? this.getOldModel() : this.getDefaultModel());
   }
