...
public class EvilWhirlwindParticle extends AbstractWhirlwindParticle<EvilWhirlwind> {
   ...
   public EvilWhirlwindParticle(
      ClientLevel level, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed, float scale, SpriteSet sprite
   ) {
   ...
   public void render(VertexConsumer consumer, Camera camera, float partialTicks) {
      float f = (this.age + partialTicks) / this.lifetime * 32.0F;
