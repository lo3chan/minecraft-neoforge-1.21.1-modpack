...
public abstract class AbstractRecipeBookScreen<A extends RecipeInput, B extends Recipe<A>, T extends RecipeBookMenu<A, B>, S extends RecipeBookComponent>
   extends AbstractContainerScreen<T>
   implements RecipeUpdateListener,
   RecipeBookBehavior<T, AbstractRecipeBookScreen<A, B, T, S>> {
   ...
   protected void initScreen(int leftOffset) {
      ...
      this.addRenderableWidget(
         new ImageButton(this.getGuiLeft() + leftOffset, this.height / 2 - 49, 20, 18, RecipeBookComponent.RECIPE_BUTTON_SPRITES, button -> {
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int button) {
      return this.getRecipeBookComponent().mouseClicked(mouseX, mouseY, button)
         ? true
         : this.widthTooNarrow && this.getRecipeBookComponent().isVisible() || super.mouseClicked(mouseX, mouseY, button);
   }
