...
public class AetherLogoRenderer extends LogoRenderer {
   private static final ResourceLocation AETHER_LOGO = ResourceLocation.fromNamespaceAndPath("aether", "textures/gui/title/aether.png");
   ...
   public void renderLogo(GuiGraphics guiGraphics, int screenWidth, float transparency, int height) {
      ...
      int logoX = this.alignedLeft ? 28 : (int)(screenWidth / 2.0F - 95.0F);
      int logoY = this.alignedLeft ? 25 : 36;
      guiGraphics.blit(AETHER_LOGO, logoX, logoY, 0.0F, 0.0F, 190, 38, 190, 38);
