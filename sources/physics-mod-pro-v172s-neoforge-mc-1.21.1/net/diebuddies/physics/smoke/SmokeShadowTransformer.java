...
public enum SmokeShadowTransformer {
   DISABLED("physicsmod.gui.disabled", SmokeShadowTransformer::getEmptyTransformer),
   COMPLEMENTARY("Complementary", SmokeShadowTransformer::getComplementaryReimaginedShadowTransformer),
   BSL("BSL", SmokeShadowTransformer::getBSLShadowTransformer),
   SEUS_RENEWED("SEUS Renewed", SmokeShadowTransformer::getSEUSRenewedShadowTransformer),
   NOSTALGIA_VX("Nostalgia VX", SmokeShadowTransformer::getNostalgiaVXShadowTransformer),
   SILDUR_LITE("Sildur Lite", SmokeShadowTransformer::getSildurLiteShadowTransformer),
   SILDUR_MEDIUM("Sildur Medium", SmokeShadowTransformer::getSildurMediumShadowTransformer),
   SILDUR_HIGH("Sildur High", SmokeShadowTransformer::getSildurHighShadowTransformer),
   SILDUR_EXTREME("Sildur Extreme", SmokeShadowTransformer::getSildurExtremeShadowTransformer),
   ASTRA_LEX("AstraLex", SmokeShadowTransformer::getAstraLexShadowTransformer),
   MAKE_UP("MakeUp", SmokeShadowTransformer::getMakeUpShadowTransformer),
   VANILLA_PLUS("Vanilla Plus", SmokeShadowTransformer::getVanillaPlusShadowTransformer);
