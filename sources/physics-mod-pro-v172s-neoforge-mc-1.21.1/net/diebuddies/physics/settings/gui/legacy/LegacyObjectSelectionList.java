...
public abstract class LegacyObjectSelectionList<E extends LegacyObjectSelectionList.Entry<E>> extends LegacyAbstractSelectionList<E> {
   private static final Component USAGE_NARRATION = Component.translatable("narration.selection.usage");
   private boolean inFocus;

   public LegacyObjectSelectionList(Minecraft p_94442_, int p_94443_, int p_94444_, int p_94445_, int p_94446_, int p_94447_) {
   ...
   public abstract static class Entry<E extends LegacyObjectSelectionList.Entry<E>>
