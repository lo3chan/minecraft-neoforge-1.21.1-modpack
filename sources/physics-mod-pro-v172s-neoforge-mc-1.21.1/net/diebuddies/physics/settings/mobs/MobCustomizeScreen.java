...
public class MobCustomizeScreen extends LegacyOptionsSubScreen {
   ...
   protected void init() {
      this.list = new MobSelectionList(
         this.minecraft, this.width, this.height, 32, this.height - 32, 25, block -> this.minecraft.setScreen(new MobEditScreen(this, this.options, block))
      );
            ...
            button -> PopupWidget.create(
               ...
               response -> {
                  if (response == PopupWidget.PopupResponse.YES) {
                     ...
                     this.minecraft.setScreen(new MobSettingsScreen(this.lastScreen, this.options));
                  }
               }
            )
         )
