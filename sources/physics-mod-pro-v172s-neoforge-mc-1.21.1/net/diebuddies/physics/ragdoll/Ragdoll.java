...
public class Ragdoll implements DoublyLinkedList.NodeStorage<Ragdoll> {
   ...
   public RagdollJoint addConnection(int from, int connectedTo, boolean fixed, boolean onlyVisual) {
      ...
      RagdollJoint ragdollJoint = new RagdollJoint(
         from,
         connectedTo,
         new Vector3d(pivotPoint.x - localPos1.x, pivotPoint.y - localPos1.y, pivotPoint.z - localPos1.z).mul(scaleTo),
         new Vector3d(pivotPoint.x - localPos2.x, pivotPoint.y - localPos2.y, pivotPoint.z - localPos2.z).mul(scaleFrom)
      );
   ...
   public class Node {
      ...
      public List<Ragdoll.Node> children = new ObjectArrayList();
