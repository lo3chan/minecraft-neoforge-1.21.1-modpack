...
public class SnowballItemRenderer<T extends Entity & ItemSupplier> extends EntityRenderer<T> {
   private static final float MIN_CAMERA_DISTANCE_SQUARED = 12.25F;
   private final ItemRenderer itemRenderer;
   private final float scale;
   private final boolean fullBright;

   public SnowballItemRenderer(Context context, float f, boolean bl) {
      super(context);
   ...
   public SnowballItemRenderer(Context context) {
   ...
   public ResourceLocation getTextureLocation(Entity entity) {
      return ConfigClient.snowballModel != 2 ? PhysicsMod.SNOWBALL_TEXTURE : TextureAtlas.LOCATION_BLOCKS;
   }
}
