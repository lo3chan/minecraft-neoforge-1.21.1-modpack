...
public class SnowParticle extends WeatherParticle {
   ...
   public SnowParticle(ClientLevel clientLevel, double x, double y, double z, double vx, double vy, double vz) {
      ...
      this.dampingY = 0.98;
      this.dampingZ = 0.999;
      this.setColor(255, 255, 255, (int)((155 + (int)(Math.random() * 40.0)) * ConfigClient.particleSnowOpacity));
   }
   ...
   public void render(VertexConsumer vertexConsumer, Camera camera, float renderPercent) {
      ...
      if (StarterClient.sodium) {
         ...
         vertexConsumer.addVertex(tmp0.x() + currentX, tmp0.y() + currentY, tmp0.z() + currentZ)
            .setUv(u1, v1)
            .setColor(this.r, this.g, this.b, this.a)
            .setLight(light);
         vertexConsumer.addVertex(tmp1.x() + currentX, tmp1.y() + currentY, tmp1.z() + currentZ)
            .setUv(u1, v0)
            .setColor(this.r, this.g, this.b, this.a)
            .setLight(light);
         vertexConsumer.addVertex(tmp2.x() + currentX, tmp2.y() + currentY, tmp2.z() + currentZ)
            .setUv(u0, v0)
            .setColor(this.r, this.g, this.b, this.a)
            .setLight(light);
         vertexConsumer.addVertex(tmp3.x() + currentX, tmp3.y() + currentY, tmp3.z() + currentZ)
            .setUv(u0, v1)
            .setColor(this.r, this.g, this.b, this.a)
            .setLight(light);
      }
