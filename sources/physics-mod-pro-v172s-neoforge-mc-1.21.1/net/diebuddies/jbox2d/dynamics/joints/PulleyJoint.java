...
public class PulleyJoint extends Joint {
   ...
   public void initVelocityConstraints(SolverData data) {
      ...
      if (data.step.warmStarting) {
         ...
         vA.x = vA.x + this.m_invMassA * PA.x;
         vA.y = vA.y + this.m_invMassA * PA.y;
         wA += this.m_invIA * Vec2.cross(this.m_rA, PA);
         vB.x = vB.x + this.m_invMassB * PB.x;
         vB.y = vB.y + this.m_invMassB * PB.y;
   ...
   public boolean solvePositionConstraints(SolverData data) {
      ...
      cA.x = cA.x + this.m_invMassA * PA.x;
      cA.y = cA.y + this.m_invMassA * PA.y;
      aA += this.m_invIA * Vec2.cross(rA, PA);
      cB.x = cB.x + this.m_invMassB * PB.x;
      cB.y = cB.y + this.m_invMassB * PB.y;
