...
public class PxArticulationSensorFlags extends NativeObject {
   ...
   public static PxArticulationSensorFlags createAt(long address, byte flags) {
      __placement_new_PxArticulationSensorFlags(address, flags);
      PxArticulationSensorFlags createdObj = wrapPointer(address);
   ...
   public PxArticulationSensorFlags(byte flags) {
      this.address = _PxArticulationSensorFlags(flags);
   }
