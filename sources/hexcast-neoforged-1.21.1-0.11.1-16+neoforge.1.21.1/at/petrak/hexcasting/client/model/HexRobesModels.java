...
public class HexRobesModels {
   ...
   public static LayerDefinition variant1() {
      ...
      PartDefinition Horns = partdefinition.addOrReplaceChild(
         "Horns",
         CubeListBuilder.create()
            .texOffs(24, 0)
      ...
      PartDefinition Skirt = partdefinition.addOrReplaceChild("Skirt", CubeListBuilder.create(), PartPose.offset(0.0F, 12.0F, -2.0F));
      PartDefinition Left_r1 = Skirt.addOrReplaceChild(
         "Left_r1",
         CubeListBuilder.create().texOffs(48, 32).mirror().addBox(0.1F, 0.0F, -4.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 0.0F, 0.0F, -0.1309F)
      );
      PartDefinition Right_r1 = Skirt.addOrReplaceChild(
         "Right_r1",
         CubeListBuilder.create().texOffs(48, 32).addBox(-4.0F, 0.0F, -4.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.0F, 0.0F, 4.0F, 0.0F, 0.0F, 0.1309F)
      );
