...
public class Vec3Iota extends Iota {
   ...
   public boolean toleratesOther(Iota that) {
      return typesMatch(this, that) && that instanceof Vec3Iota viota && this.getVec3().distanceToSqr(viota.getVec3()) < 1.0E-8;
   }
   ...
   public static Vec3Iota deserialize(Tag tag) throws IllegalArgumentException {
      ...
      if (tag.getType() == LongArrayTag.TYPE) {
         LongArrayTag lat = HexUtils.downcast(tag, LongArrayTag.TYPE);
