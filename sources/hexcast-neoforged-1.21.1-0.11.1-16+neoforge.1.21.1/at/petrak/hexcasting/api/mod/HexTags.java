...
public class HexTags {
   public static final class Actions {
      ...
      public static TagKey<ActionRegistryEntry> create(String name) {
         return TagKey.create(IXplatAbstractions.INSTANCE.getActionRegistry().key(), HexAPI.modLoc(name));
      }
   }
   ...
   public static final class Blocks {
      ...
      public static TagKey<Block> create(String name) {
         return TagKey.create(Registries.BLOCK, HexAPI.modLoc(name));
      }
   }
   ...
   public static final class Entities {
      ...
      public static TagKey<EntityType<?>> create(String name) {
         return TagKey.create(Registries.ENTITY_TYPE, HexAPI.modLoc(name));
      }
   }
   ...
   public static final class Items {
      ...
      public static TagKey<Item> create(String name) {
         return create(HexAPI.modLoc(name));
      }
