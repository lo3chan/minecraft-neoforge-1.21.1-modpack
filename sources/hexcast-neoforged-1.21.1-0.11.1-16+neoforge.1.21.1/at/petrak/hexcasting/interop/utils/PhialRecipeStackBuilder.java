...
public class PhialRecipeStackBuilder {
   ...
   public static Pair<List<ItemStack>, List<ItemStack>> createStacks() {
      ...
      long quenchedShard = 300000L;
      long quenchedBlock = 1200000L;
      if (dust > 0L) {
   ...
   public static boolean shouldAddRecipe() {
      return HexConfig.common().dustMediaAmount() > 0L || HexConfig.common().shardMediaAmount() > 0L || HexConfig.common().chargedCrystalMediaAmount() > 0L;
   }
}
