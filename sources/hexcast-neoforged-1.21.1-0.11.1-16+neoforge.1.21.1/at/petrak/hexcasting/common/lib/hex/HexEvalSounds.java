...
public class HexEvalSounds {
   ...
   public static final EvalSound NOTHING = make("nothing", new EvalSound(null, -2147483648));
   ...
   public static final EvalSound MISHAP = make("mishap", new EvalSound(HexSounds.CAST_FAILURE, 4000));
   ...
   public static void register(BiConsumer<EvalSound, ResourceLocation> r) {
      for (Entry<ResourceLocation, EvalSound> e : SOUNDS.entrySet()) {
