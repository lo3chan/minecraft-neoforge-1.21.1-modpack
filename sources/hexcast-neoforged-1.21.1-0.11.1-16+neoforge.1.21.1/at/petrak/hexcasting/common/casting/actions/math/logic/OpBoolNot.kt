...
@SourceDebugExtension(["SMAP\nOpBoolNot.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OpBoolNot.kt\nat/petrak/hexcasting/common/casting/actions/math/logic/OpBoolNot\n+ 2 ActionUtils.kt\nat/petrak/hexcasting/api/casting/OperatorUtils\n*L\n1#1,17:1\n299#2:18\n*S KotlinDebug\n*F\n+ 1 OpBoolNot.kt\nat/petrak/hexcasting/common/casting/actions/math/logic/OpBoolNot\n*L\n14#1:18\n*E\n"])
public object OpBoolNot : ConstMediaAction {
   public open val argc: Int = 1

   public override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
      return CollectionsKt.listOf(new BooleanIota(!OperatorUtils.getBool(args, 0, this.getArgc())));
   }
