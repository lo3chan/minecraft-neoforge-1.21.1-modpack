...
@SourceDebugExtension(["SMAP\nOpArcSin.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OpArcSin.kt\nat/petrak/hexcasting/common/casting/actions/math/trig/OpArcSin\n+ 2 ActionUtils.kt\nat/petrak/hexcasting/api/casting/OperatorUtils\n*L\n1#1,19:1\n300#2:20\n*S KotlinDebug\n*F\n+ 1 OpArcSin.kt\nat/petrak/hexcasting/common/casting/actions/math/trig/OpArcSin\n*L\n16#1:20\n*E\n"])
public object OpArcSin : ConstMediaAction {
   ...
   public override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
      return CollectionsKt.listOf(new DoubleIota(Math.asin(OperatorUtils.getDoubleBetween(args, 0, -1.0, 1.0, OpArcCos.INSTANCE.getArgc()))));
   }
