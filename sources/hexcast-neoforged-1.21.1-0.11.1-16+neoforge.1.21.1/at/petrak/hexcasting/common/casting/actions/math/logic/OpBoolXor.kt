...
@SourceDebugExtension(["SMAP\nOpBoolXor.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OpBoolXor.kt\nat/petrak/hexcasting/common/casting/actions/math/logic/OpBoolXor\n+ 2 ActionUtils.kt\nat/petrak/hexcasting/api/casting/OperatorUtils\n*L\n1#1,18:1\n299#2:19\n*S KotlinDebug\n*F\n+ 1 OpBoolXor.kt\nat/petrak/hexcasting/common/casting/actions/math/logic/OpBoolXor\n*L\n15#1:19\n*E\n"])
public object OpBoolXor : ConstMediaAction {
   public open val argc: Int = 2

   public override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
      return CollectionsKt.listOf(new BooleanIota(OperatorUtils.getBool(args, 0, this.getArgc()) xor OperatorUtils.getBool(args, 1, this.getArgc())));
   }
