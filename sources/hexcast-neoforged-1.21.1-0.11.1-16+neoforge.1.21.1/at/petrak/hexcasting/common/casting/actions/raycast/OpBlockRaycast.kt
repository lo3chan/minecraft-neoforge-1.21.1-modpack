...
@SourceDebugExtension(["SMAP\nOpBlockRaycast.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OpBlockRaycast.kt\nat/petrak/hexcasting/common/casting/actions/raycast/OpBlockRaycast\n+ 2 ActionUtils.kt\nat/petrak/hexcasting/api/casting/OperatorUtils\n*L\n1#1,45:1\n306#2:46\n*S KotlinDebug\n*F\n+ 1 OpBlockRaycast.kt\nat/petrak/hexcasting/common/casting/actions/raycast/OpBlockRaycast\n*L\n39#1:46\n*E\n"])
public object OpBlockRaycast : ConstMediaAction {
   ...
   public override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
      ...
      if (blockHitResult.getType() === Type.BLOCK && env.isVecInRange(Vec3.atCenterOf(blockHitResult.getBlockPos() as Vec3i))) {
         val var8: BlockPos = blockHitResult.getBlockPos();
         var10000 = CollectionsKt.listOf(new Vec3Iota(Vec3.atCenterOf(var8 as Vec3i)));
      } else {
