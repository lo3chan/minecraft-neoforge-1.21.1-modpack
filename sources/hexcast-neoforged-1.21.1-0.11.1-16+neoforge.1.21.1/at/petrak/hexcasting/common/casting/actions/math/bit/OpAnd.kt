...
@SourceDebugExtension(["SMAP\nOpAnd.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OpAnd.kt\nat/petrak/hexcasting/common/casting/actions/math/bit/OpAnd\n+ 2 ActionUtils.kt\nat/petrak/hexcasting/api/casting/OperatorUtils\n+ 3 _Collections.kt\nkotlin/collections/CollectionsKt___CollectionsKt\n*L\n1#1,29:1\n301#2:30\n304#2:37\n774#3:31\n865#3:32\n1761#3,3:33\n866#3:36\n*S KotlinDebug\n*F\n+ 1 OpAnd.kt\nat/petrak/hexcasting/common/casting/actions/math/bit/OpAnd\n*L\n20#1:30\n24#1:37\n24#1:31\n24#1:32\n24#1:33,3\n24#1:36\n*E\n"])
public object OpAnd : ConstMediaAction {
   public open val argc: Int = 2

   public override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
      val var4: Any = OperatorUtils.getLongOrList(args, 0, this.getArgc()).map(OpAnd::execute$lambda$1, OpAnd::execute$lambda$5);
   ...
   fun `execute$lambda$0`(`$args`: java.util.List, num1: java.lang.Long): java.util.List {
      return CollectionsKt.listOf(new DoubleIota((double)(num1 and OperatorUtils.getLong(`$args`, 1, INSTANCE.getArgc()))));
   }
   ...
   fun `execute$lambda$4`(`$args`: java.util.List, list1: SpellList): java.util.List {
      ...
      val `$this$asActionResult$iv`: java.lang.Iterable = list1;
      val `destination$iv$iv`: java.util.Collection = new ArrayList();

      for (Object element$iv$iv : $this$filter$iv) {
         val x: Iota = `element$iv$iv` as Iota;
         val `$this$any$iv`: java.lang.Iterable = list2;
         var var10000: Boolean;
         if (list2 is java.util.Collection && (list2 as java.util.Collection).isEmpty()) {
            var10000 = false;
         } else {
            val var14: java.util.Iterator = `$this$any$iv`.iterator();
