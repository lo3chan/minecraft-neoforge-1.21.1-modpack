...
@SourceDebugExtension(["SMAP\nOpEntityPos.kt\nKotlin\n*S Kotlin\n*F\n+ 1 OpEntityPos.kt\nat/petrak/hexcasting/common/casting/actions/OpEntityPos\n+ 2 ActionUtils.kt\nat/petrak/hexcasting/api/casting/OperatorUtils\n*L\n1#1,18:1\n308#2:19\n*S KotlinDebug\n*F\n+ 1 OpEntityPos.kt\nat/petrak/hexcasting/common/casting/actions/OpEntityPos\n*L\n15#1:19\n*E\n"])
public class OpEntityPos(feet: Boolean) : ConstMediaAction {
   public final val feet: Boolean
   ...
   public override fun execute(args: List<Iota>, env: CastingEnvironment): List<Iota> {
      ...
      val `$this$asActionResult$iv`: Vec3 = if (this.feet) e.position() else e.getEyePosition();
      return CollectionsKt.listOf(new Vec3Iota(`$this$asActionResult$iv`));
   }
