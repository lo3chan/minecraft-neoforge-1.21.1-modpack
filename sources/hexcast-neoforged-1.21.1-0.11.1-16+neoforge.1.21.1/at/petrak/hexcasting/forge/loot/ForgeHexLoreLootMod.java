...
public class ForgeHexLoreLootMod extends LootModifier {
   public static final Supplier<MapCodec<ForgeHexLoreLootMod>> CODEC = Suppliers.memoize(
      () -> RecordCodecBuilder.mapCodec(
         inst -> codecStart(inst).and(Codec.DOUBLE.fieldOf("chance").forGetter(it -> it.chance)).apply(inst, ForgeHexLoreLootMod::new)
      )
   );
   ...
   public MapCodec<ForgeHexLoreLootMod> codec() {
      return (MapCodec<ForgeHexLoreLootMod>)ForgeHexLootMods.INJECT_LORE.get();
   }
}
