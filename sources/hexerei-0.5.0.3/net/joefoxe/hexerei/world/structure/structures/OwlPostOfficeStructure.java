...
public class OwlPostOfficeStructure extends Structure {
   public static final MapCodec<OwlPostOfficeStructure> CODEC = RecordCodecBuilder.mapCodec(
   ...
   public StructureType<?> type() {
      return (StructureType<?>)ModStructures.OWL_POST_OFFICE.get();
   }
}
