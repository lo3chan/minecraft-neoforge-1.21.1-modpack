...
public record PotionBottleTypeData(PotionFluid.BottleType bottleType) {
   ...
   public static final Codec<PotionBottleTypeData> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(PotionFluid.BottleType.CODEC.fieldOf("Bottle").forGetter(PotionBottleTypeData::bottleType))
         .apply(instance, PotionBottleTypeData::new)
   );
   public static StreamCodec<ByteBuf, PotionBottleTypeData> STREAM_CODEC = ByteBufCodecs.fromCodec(CODEC);
}
