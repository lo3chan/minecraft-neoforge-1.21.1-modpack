...
public class BookOfShadowsRecipeCategory implements IRecipeCategory<BookOfShadowsRecipe> {
   public static final ResourceLocation UID = HexereiUtil.getResource("book_of_shadows_dye");
   ...
   public BookOfShadowsRecipeCategory(IGuiHelper helper) {
      ...
      this.icon = new ExtraBookOfShadowsIcon(() -> new ItemStack((ItemLike)ModItems.BOOK_OF_SHADOWS.get()));
   }
