...
public class ExtraBookOfShadowsIcon implements IDrawable {
   ...
   public void draw(GuiGraphics guiGraphics, int xOffset, int yOffset) {
      ...
      if (timer <= 0.1 && this.findNewRecipe || this.recipeShown == null) {
         ...
         this.color1 = DyeColor.byId(this.rand.nextInt(DyeColor.values().length - 1)).getTextureDiffuseColor();
         this.color2 = DyeColor.byId(this.rand.nextInt(DyeColor.values().length - 1)).getTextureDiffuseColor();
      }
