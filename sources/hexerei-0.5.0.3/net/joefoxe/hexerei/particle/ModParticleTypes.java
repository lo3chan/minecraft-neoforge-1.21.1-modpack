...
public class ModParticleTypes {
   public static final DeferredRegister<ParticleType<?>> PARTICLES = DeferredRegister.create(BuiltInRegistries.PARTICLE_TYPE, "hexerei");
   public static final DeferredHolder<ParticleType<?>, ParticleType<CauldronParticleData>> CAULDRON = PARTICLES.register(
      "cauldron_particle", () -> new ParticleType<CauldronParticleData>(true) {
   ...
   public static final DeferredHolder<ParticleType<?>, SimpleParticleType> BLOOD_BIT = PARTICLES.register(
      "blood_bit_particle", () -> new SimpleParticleType(true)
   );
   ...
   public static final DeferredHolder<ParticleType<?>, SimpleParticleType> EXTINGUISH = PARTICLES.register(
      "extinguish_particle", () -> new SimpleParticleType(true)
   );
   ...
   public static final DeferredHolder<ParticleType<?>, SimpleParticleType> OWL_TELEPORT_BARN = PARTICLES.register(
      "owl_teleport_barn", () -> new SimpleParticleType(true)
   );
   public static final DeferredHolder<ParticleType<?>, SimpleParticleType> OWL_TELEPORT_BARRED = PARTICLES.register(
      "owl_teleport_barred", () -> new SimpleParticleType(true)
   );
   public static final DeferredHolder<ParticleType<?>, SimpleParticleType> OWL_TELEPORT_SNOWY = PARTICLES.register(
      "owl_teleport_snowy", () -> new SimpleParticleType(true)
   );
   public static final DeferredHolder<ParticleType<?>, SimpleParticleType> MAHOGANY_LEAVES = PARTICLES.register(
      "mahogany_leaves", () -> new SimpleParticleType(true)
   );
   public static final DeferredHolder<ParticleType<?>, SimpleParticleType> WITCH_HAZEL_LEAVES = PARTICLES.register(
      "witch_hazel_leaves", () -> new SimpleParticleType(true)
   );
}
