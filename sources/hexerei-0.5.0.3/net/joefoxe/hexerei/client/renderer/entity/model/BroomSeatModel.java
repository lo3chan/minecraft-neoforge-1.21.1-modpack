   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Satchel = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(42, 25)
            .addBox(3.0F, -2.0F, -6.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(40, 4)
            .addBox(3.0F, -2.25F, -6.25F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(42, 18)
            .addBox(3.0F, -2.0F, 4.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(41, 10)
            .addBox(3.0F, -2.25F, 4.25F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(43, 33)
            .addBox(4.5F, -3.5F, 2.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(44, 41)
            .addBox(4.5F, -3.5F, -5.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
         PartPose.offset(1.0F, 24.0F, 0.0F)
      );
      PartDefinition Seat = partdefinition.addOrReplaceChild(
         "Seat",
         CubeListBuilder.create().texOffs(2, 6).addBox(-8.0F, 0.0F, -4.5F, 6.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
         PartPose.offset(10.0F, 20.0F, 0.0F)
      );
      PartDefinition cube_r1 = Seat.addOrReplaceChild(
         "cube_r1",
         CubeListBuilder.create().texOffs(4, 21).addBox(-1.25F, -3.925F, -5.0F, 2.0F, 8.0F, 9.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-1.0F, -2.0F, 0.5F, 0.0F, 0.0F, 0.0436F)
      );
