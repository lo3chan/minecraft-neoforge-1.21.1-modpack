   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Satchel = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 14)
            .addBox(4.5F, -3.5F, -1.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(1, 2)
            .addBox(3.0F, -2.0F, -3.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(15, 27)
            .addBox(3.0F, -2.25F, -3.25F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(18, 19)
            .addBox(3.0F, -2.25F, 1.25F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(1, 7)
            .addBox(3.0F, -2.0F, 1.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
