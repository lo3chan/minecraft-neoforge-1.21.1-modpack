...
public class BroomNetheriteTipModel extends ListModel<BroomEntity> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition NetheriteTip = partdefinition.addOrReplaceChild(
         "NetheriteTip",
      ...
      PartDefinition ring_r1 = NetheriteTip.addOrReplaceChild(
         "ring_r1",
      ...
      PartDefinition cube_r1 = NetheriteTip.addOrReplaceChild(
         "cube_r1",
   ...
   public void renderToBuffer(PoseStack poseStack, VertexConsumer buffer, int packedLight, int packedOverlay, int color) {
      this.NetheriteTip.render(poseStack, buffer, packedLight, packedOverlay, color);
   }
