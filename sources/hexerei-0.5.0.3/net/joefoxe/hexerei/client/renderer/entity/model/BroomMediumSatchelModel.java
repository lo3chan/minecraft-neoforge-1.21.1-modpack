   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Satchel = partdefinition.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            .texOffs(0, 14)
            .addBox(3.5F, -3.5F, -1.5F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
            .texOffs(0, 7)
            .addBox(1.0F, -1.5F, 1.0F, 7.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(14, 18)
            .addBox(1.0F, -1.75F, 1.25F, 7.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(1.0F, -1.5F, -3.0F, 7.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
            .texOffs(14, 25)
            .addBox(1.0F, -1.75F, -3.25F, 7.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
