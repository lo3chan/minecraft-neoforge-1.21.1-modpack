...
public class CrowContainer extends AbstractContainerMenu {
   ...
   public CrowContainer(int windowId, final CrowEntity crowEntity, Inventory playerInventory, Player player) {
      ...
      this.layoutPlayerInventorySlots(14, 119);
      if (crowEntity != null) {
         IItemHandler itemHandler = (IItemHandler)crowEntity.getCapability(ItemHandler.ENTITY);
         this.addSlot(new SlotItemHandler(itemHandler, 0, 86, 22) {
         ...
         this.addSlot(new SlotItemHandler(itemHandler, 1, 37, 22) {
            public int getMaxStackSize() {
               return 1;
            }
         ...
         this.addSlot(new SlotItemHandler(itemHandler, 2, 134, 22) {
            public int getMaxStackSize() {
               return 1;
            }
   ...
   public void playSound() {
      this.crowEntity.level().playSound(null, this.crowEntity.blockPosition(), (SoundEvent)SoundEvents.UI_BUTTON_CLICK.value(), SoundSource.BLOCKS, 1.0F, 1.0F);
   }
   ...
   public boolean stillValid(Player playerIn) {
      return this.crowEntity.isRemoved() ? false : !(playerIn.distanceToSqr(this.crowEntity) > 64.0);
   }
