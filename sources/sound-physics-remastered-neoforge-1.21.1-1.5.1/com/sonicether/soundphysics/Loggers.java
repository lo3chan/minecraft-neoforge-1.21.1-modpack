...
public class Loggers {
   ...
   private static final Logger DEBUG_LOGGER = LogManager.getLogger(String.format("Sound Physics - %s", "Debug"));
   private static final Logger PROFILING_LOGGER = LogManager.getLogger(String.format("Sound Physics - %s", "Profiling"));
   private static final Logger ENVIRONMENT_LOGGER = LogManager.getLogger(String.format("Sound Physics - %s", "Environment"));
   private static final Logger OCCLUSION_LOGGER = LogManager.getLogger(String.format("Sound Physics - %s", "Occlusion"));
   private static final Logger LOGGER = LogManager.getLogger(String.format("Sound Physics - %s", "General"));
