...
public class EBEConfigModifier implements BiConsumer<Properties, Map<String, Component>>, Consumer<Runnable> {
   ...
   public static void modifyEBEConfig(Set<String> ebeAffectingJemsFound) {
      ...
      ebeReloader.run();
      EMFUtils.log(
         "EBE config modified by EMF, the following blocks have been disabled in EBE because they have custom entity models (this can be disabled in EMF's settings): "
            + ebeAffectingJemsFound
      );
   }

   public void accept(Properties overrideConfigValues, Map<String, Component> overrideReasons) {
      if (chestsDisabled) {
         overrideConfigValues.setProperty("render_enhanced_chests", "false");
         overrideReasons.put(
            "render_enhanced_chests", Component.literal("EBE Enhanced Chests are disabled by a loaded EMF model!").withStyle(ChatFormatting.YELLOW)
         );
      }
      ...
      if (shulkerBoxesDisabled) {
         ...
         overrideReasons.put(
            "render_enhanced_shulker_boxes",
            Component.literal("EBE Enhanced Shulker Boxes are disabled by a loaded EMF model!").withStyle(ChatFormatting.YELLOW)
         );
      }
      ...
      if (bellsDisabled) {
         ...
         overrideReasons.put(
            "render_enhanced_bells", Component.literal("EBE Enhanced Bells are disabled by a loaded EMF model!").withStyle(ChatFormatting.YELLOW)
         );
      }
      ...
      if (bedsDisabled) {
         ...
         overrideReasons.put(
            "render_enhanced_beds", Component.literal("EBE Enhanced Beds are disabled by a loaded EMF model!").withStyle(ChatFormatting.YELLOW)
         );
      }
      ...
      if (signsDisabled) {
         ...
         overrideReasons.put(
            "render_enhanced_signs", Component.literal("EBE Enhanced Signs are disabled by a loaded EMF model!").withStyle(ChatFormatting.YELLOW)
         );
      }
      ...
      if (decoratedPotsDisabled) {
         ...
         overrideReasons.put(
            "render_enhanced_decorated_pots",
            Component.literal("EBE Enhanced Decorated Pots are disabled by a loaded EMF model!").withStyle(ChatFormatting.YELLOW)
         );
      }
   }
