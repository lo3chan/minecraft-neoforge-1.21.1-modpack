      ...
      for (Entry<Object, Object> objectObjectEntry : properties.entrySet()) {
         ...
         if (key != null && key.startsWith(keyPrefix)) {
            ...
            if (!variableKey.isBlank() && !instruction.isBlank()) {
               GlobalVariableFloatProperty.InnerTester tester = new GlobalVariableFloatProperty.InnerTester(
                  instruction, emfEntity -> GlobalVariableFactory.getGlobalVariable(variableKey), variableKey
               );
