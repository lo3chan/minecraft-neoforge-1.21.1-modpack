...
public record MenuStateUpdateMessage(int elementType, String name, Object elementState) implements CustomPacketPayload {
   public static final Type<MenuStateUpdateMessage> TYPE = new Type(ResourceLocation.fromNamespaceAndPath("tanshugetrees", "guistate_update"));
   ...
   public static void registerMessage(FMLCommonSetupEvent event) {
      TanshugetreesMod.addNetworkMessage(TYPE, STREAM_CODEC, MenuStateUpdateMessage::handleMenuState);
   }
}
