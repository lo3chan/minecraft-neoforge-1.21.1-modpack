            ...
            switch (id) {
               ...
               case "move":
                  try {
                     ...
                     Move move = new Move(
                        animData.getPFromStr(block.get(1)), Float.parseFloat(block.get(3)), (int)(Integer.parseInt(block.get(2)) * 0.02), ease
                     );
                     String var13 = block.get(pos);
                     switch (var13) {
                        case "repeat":
                           this.elements.add(new Repeat(move, (int)(Integer.parseInt(block.get(pos + 2)) * 0.02), Integer.parseInt(block.get(pos + 1))));
                           continue;
                        case "yoyo":
                           this.elements.add(new Yoyo(move, (int)(Integer.parseInt(block.get(pos + 2)) * 0.02), Integer.parseInt(block.get(pos + 1))));
                           continue;
                        case "pause":
                           this.elements.add(new Pauseable(move, (int)(Integer.parseInt(block.get(pos + 1)) * 0.02)));
                           continue;
                        default:
               ...
               case "pause":
                  try {
                     this.elements.add(new Pause((int)(Integer.parseInt(block.get(1)) * 0.02)));
