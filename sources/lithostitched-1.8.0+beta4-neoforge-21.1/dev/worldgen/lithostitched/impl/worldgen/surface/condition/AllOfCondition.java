...
public record AllOfCondition(List<ConditionSource> conditions) implements ConditionSource {
   public static final MapCodec<AllOfCondition> CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(ConditionSource.CODEC.listOf().fieldOf("conditions").forGetter(AllOfCondition::conditions))
   ...
   public net.minecraft.world.level.levelgen.SurfaceRules.Condition apply(Context context) {
      return new AllOfCondition.Condition(
