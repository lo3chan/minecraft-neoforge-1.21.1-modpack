...
public final class RandomBlockProvider extends BlockStateProvider {
   public static final MapCodec<RandomBlockProvider> CODEC = LithostitchedCodecs.BLOCK_SET
      .fieldOf("blocks")
      .xmap(RandomBlockProvider::new, RandomBlockProvider::blocks);
   ...
   public BlockState getState(RandomSource random, BlockPos pos) {
      return this.blocks.getRandomElement(random).<Block>map(Holder::value).orElse(Blocks.AIR).defaultBlockState();
   }
}
