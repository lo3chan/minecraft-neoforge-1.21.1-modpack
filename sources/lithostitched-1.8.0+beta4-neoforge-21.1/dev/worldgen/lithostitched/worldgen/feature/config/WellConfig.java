...
public record WellConfig(
   ...
   public static final Codec<WellConfig> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            ...
            BlockStateProvider.CODEC
               .fieldOf("suspicious_provider")
               .orElse(BlockStateProvider.simple(Blocks.SUSPICIOUS_SAND))
               .forGetter(WellConfig::suspiciousProvider),
            ...
            ResourceKey.codec(Registries.LOOT_TABLE)
               .fieldOf("suspicious_loot_table")
               .orElse(BuiltInLootTables.DESERT_WELL_ARCHAEOLOGY)
               .forGetter(WellConfig::suspiciousLootTable)
         )
