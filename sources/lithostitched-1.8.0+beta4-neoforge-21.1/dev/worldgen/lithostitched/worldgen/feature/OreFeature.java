...
public class OreFeature extends Feature<OreConfig> {
   ...
   public boolean place(FeaturePlaceContext<OreConfig> context) {
      ...
      OreConfig config = (OreConfig)context.config();
      float $$5 = random.nextFloat() * 3.1415927F;
      float $$6 = config.size() / 8.0F;
      int $$7 = Mth.ceil((config.size() / 16.0F * 2.0F + 1.0F) / 2.0F);
      double $$8 = origin.getX() + Math.sin($$5) * $$6;
      double $$9 = origin.getX() - Math.sin($$5) * $$6;
      double $$10 = origin.getZ() + Math.cos($$5) * $$6;
      double $$11 = origin.getZ() - Math.cos($$5) * $$6;
   ...
   protected boolean doPlace(
      ...
      for (int $$19 = 0; $$19 < $$17; $$19++) {
         ...
         double $$24 = random.nextDouble() * $$17 / 16.0;
         double $$25 = ((MiscUtils.sin(3.1415927F * $$20) + 1.0F) * $$24 + 1.0) / 2.0;
         $$18[$$19 * 4] = $$21;
         $$18[$$19 * 4 + 1] = $$22;
         $$18[$$19 * 4 + 2] = $$23;
         $$18[$$19 * 4 + 3] = $$25;
      ...
      try {
         for (int $$33 = 0; $$33 < $$17; $$33++) {
            ...
            if (!($$34 < 0.0)) {
               ...
               for (int x = $$38; x <= $$41; x++) {
                  double $$45 = (x + 0.5 - $$35) / $$34;
                  if ($$45 * $$45 < 1.0) {
                     for (int y = $$39; y <= $$42; y++) {
                        double $$47 = (y + 0.5 - $$36) / $$34;
                        if ($$45 * $$45 + $$47 * $$47 < 1.0) {
                           for (int z = $$40; z <= $$43; z++) {
                              double $$49 = (z + 0.5 - $$37) / $$34;
