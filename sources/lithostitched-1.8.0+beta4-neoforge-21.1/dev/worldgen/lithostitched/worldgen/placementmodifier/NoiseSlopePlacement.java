...
public class NoiseSlopePlacement extends PlacementModifier {
   public static final MapCodec<NoiseSlopePlacement> CODEC = RecordCodecBuilder.mapCodec(
   ...
   public NoiseSlopePlacement(ResourceKey<NoiseParameters> noise, int slope, int offset, double xzScale, double yScale) {
      this.noise = noise;
      this.slope = slope;
      this.offset = offset;
   ...
   public ResourceKey<NoiseParameters> noise() {
      return this.noise;
   }
