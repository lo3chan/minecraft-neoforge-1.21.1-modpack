...
public class FNL {
   ...
   private FNL.NoiseType mNoiseType = FNL.NoiseType.OpenSimplex2;
   private FNL.RotationType3D mRotationType3D = FNL.RotationType3D.None;
   private FNL.TransformType3D mTransformType3D = FNL.TransformType3D.DefaultOpenSimplex2;
   private FNL.FractalType mFractalType = FNL.FractalType.None;
   ...
   private FNL.CellularDistanceFunction mCellularDistanceFunction = FNL.CellularDistanceFunction.EuclideanSq;
   private FNL.CellularReturnType mCellularReturnType = FNL.CellularReturnType.Distance;
   private float mCellularJitterModifier = 1.0F;
   private FNL.DomainWarpType mDomainWarpType = FNL.DomainWarpType.OpenSimplex2;
   private FNL.TransformType3D mWarpTransformType3D = FNL.TransformType3D.DefaultOpenSimplex2;
   ...
   public void SetNoiseType(FNL.NoiseType noiseType) {
      this.mNoiseType = noiseType;
      this.UpdateTransformType3D();
   }

   public void SetRotationType3D(FNL.RotationType3D rotationType3D) {
      this.mRotationType3D = rotationType3D;
      this.UpdateTransformType3D();
      this.UpdateWarpTransformType3D();
   }

   public void SetFractalType(FNL.FractalType fractalType) {
   ...
   public void SetCellularDistanceFunction(FNL.CellularDistanceFunction cellularDistanceFunction) {
      this.mCellularDistanceFunction = cellularDistanceFunction;
   }

   public void SetCellularReturnType(FNL.CellularReturnType cellularReturnType) {
   ...
   public void SetDomainWarpType(FNL.DomainWarpType domainWarpType) {
   ...
   public void DomainWarp(FNL.Vector2 coord) {
      switch (this.mFractalType) {
   ...
   public void DomainWarp(FNL.Vector3 coord) {
      switch (this.mFractalType) {
         case DomainWarpProgressive:
            this.DomainWarpFractalProgressive(coord);
            break;
   ...
   private void UpdateTransformType3D() {
      switch (this.mRotationType3D) {
         case ImproveXYPlanes:
            this.mTransformType3D = FNL.TransformType3D.ImproveXYPlanes;
            break;
         case ImproveXZPlanes:
            this.mTransformType3D = FNL.TransformType3D.ImproveXZPlanes;
            break;
         default:
            switch (this.mNoiseType) {
               case OpenSimplex2:
               case OpenSimplex2S:
                  this.mTransformType3D = FNL.TransformType3D.DefaultOpenSimplex2;
                  break;
               default:
                  this.mTransformType3D = FNL.TransformType3D.None;
            }
      }
   }
   ...
   private void UpdateWarpTransformType3D() {
      switch (this.mRotationType3D) {
         case ImproveXYPlanes:
            this.mWarpTransformType3D = FNL.TransformType3D.ImproveXYPlanes;
            break;
         case ImproveXZPlanes:
            this.mWarpTransformType3D = FNL.TransformType3D.ImproveXZPlanes;
            break;
         default:
            switch (this.mDomainWarpType) {
               case OpenSimplex2:
               case OpenSimplex2Reduced:
                  this.mWarpTransformType3D = FNL.TransformType3D.DefaultOpenSimplex2;
                  break;
               default:
                  this.mWarpTransformType3D = FNL.TransformType3D.None;
            }
      }
   }
   ...
   private float SingleCellular(int seed, double x, double y) {
      ...
      if (this.mCellularDistanceFunction == FNL.CellularDistanceFunction.Euclidean && this.mCellularReturnType != FNL.CellularReturnType.CellValue) {
         distance0 = FastSqrt(distance0);
         if (this.mCellularReturnType != FNL.CellularReturnType.Distance) {
   ...
   private void DoSingleDomainWarp(int seed, float amp, float freq, double x, double y, FNL.Vector2 coord) {
      switch (this.mDomainWarpType) {
         case OpenSimplex2:
   ...
   private void DoSingleDomainWarp(int seed, float amp, float freq, double x, double y, double z, FNL.Vector3 coord) {
      switch (this.mDomainWarpType) {
         case OpenSimplex2:
   ...
   private void DomainWarpSingle(FNL.Vector2 coord) {
      int seed = this.mSeed;
   ...
   private void DomainWarpSingle(FNL.Vector3 coord) {
      int seed = this.mSeed;
      float amp = this.mDomainWarpAmp * this.mFractalBounding;
      float freq = this.mFrequency;
      double xs = coord.x;
   ...
   private void DomainWarpFractalProgressive(FNL.Vector2 coord) {
      int seed = this.mSeed;
      float amp = this.mDomainWarpAmp * this.mFractalBounding;
      float freq = this.mFrequency;
   ...
   private void DomainWarpFractalProgressive(FNL.Vector3 coord) {
      int seed = this.mSeed;
      float amp = this.mDomainWarpAmp * this.mFractalBounding;
      float freq = this.mFrequency;
   ...
   private void DomainWarpFractalIndependent(FNL.Vector2 coord) {
      double xs = coord.x;
      double ys = coord.y;
      switch (this.mDomainWarpType) {
         case OpenSimplex2:
   ...
   private void DomainWarpFractalIndependent(FNL.Vector3 coord) {
      double xs = coord.x;
      double ys = coord.y;
      double zs = coord.z;
      switch (this.mWarpTransformType3D) {
   ...
   private void SingleDomainWarpBasicGrid(int seed, float warpAmp, float frequency, double x, double y, FNL.Vector2 coord) {
   ...
   private void SingleDomainWarpBasicGrid(int seed, float warpAmp, float frequency, double x, double y, double z, FNL.Vector3 coord) {
      double xf = x * frequency;
      double yf = y * frequency;
   ...
   private void SingleDomainWarpSimplexGradient(int seed, float warpAmp, float frequency, double x, double y, FNL.Vector2 coord, boolean outGradOnly) {
      float SQRT3 = 1.7320508F;
      float G2 = 0.21132487F;
      x *= frequency;
      y *= frequency;
   ...
   private void SingleDomainWarpOpenSimplex2Gradient(
      int seed, float warpAmp, float frequency, double x, double y, double z, FNL.Vector3 coord, boolean outGradOnly
   ) {
      x *= frequency;
      y *= frequency;
      z *= frequency;
   ...
   public static enum FractalType implements StringRepresentable {
      None("none"),
      FBm("fbm"),
      Ridged("ridged"),
      PingPong("ping_pong"),
      ...
      private FractalType(String name) {
         this.name = name;
      }
