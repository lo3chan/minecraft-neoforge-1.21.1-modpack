...
public record BiomeEffects(
   ...
   Optional<GrassColorModifier> grassColorModifier,
   ...
   public static final Codec<BiomeEffects> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            ...
            GrassColorModifier.CODEC.optionalFieldOf("grass_color_modifier").forGetter(BiomeEffects::grassColorModifier),
            ...
            Codec.floatRange(0.0F, 1.0F).optionalFieldOf("music_volume").forGetter(BiomeEffects::musicVolume)
         )
