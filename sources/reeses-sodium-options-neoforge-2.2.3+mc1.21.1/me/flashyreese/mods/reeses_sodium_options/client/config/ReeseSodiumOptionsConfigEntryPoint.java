...
public class ReeseSodiumOptionsConfigEntryPoint implements ConfigEntryPoint {
   ...
   public void registerConfigLate(ConfigBuilder builder) {
      builder.registerOwnModOptions().setNonTintedIcon(this.modIcon()).addPage(this.createOptionsPage(builder));
   }
   ...
   private OptionGroupBuilder createGeneralOptions(ConfigBuilder builder) {
      return builder.createOptionGroup()
         ...
         .addOption(
            builder.createBooleanOption(this.optionId("enabled"))
   ...
   private OptionGroupBuilder createAppearanceOptions(ConfigBuilder builder) {
      return builder.createOptionGroup()
         ...
         .addOption(
            builder.createEnumOption(this.optionId("tab_header_collapse_mode"), ReeseSodiumOptionsConfig.TabHeaderCollapseMode.class)
         ...
         .addOption(
            builder.createIntegerOption(this.optionId("tooltip_delay"))
               ...
               .setDefaultValue(500)
               .setRange(0, 5000, 100)
               .setValueFormatter(value -> Component.translatable("rso.options.value.milliseconds", new Object[]{value}))
   ...
   private OptionGroupBuilder createBehaviorOptions(ConfigBuilder builder) {
      return builder.createOptionGroup()
         ...
         .addOption(
            builder.createIntegerOption(this.optionId("search_result_limit"))
               ...
               .setDefaultValue(15)
               .setRange(1, 50, 1)
               .setValueFormatter(value -> Component.translatable("rso.options.value.results", new Object[]{value}))
               .setBinding(
                  value -> ReeseSodiumOptionsConfig.config().setSearchResultLimit(value), () -> ReeseSodiumOptionsConfig.config().getSearchResultLimit()
               )
               .setStorageHandler(ReeseSodiumOptionsConfig.STORAGE_HANDLER)
               .setApplyHook(ReeseSodiumOptionsConfig::rebuildCurrentScreen)
         )
         ...
         .addOption(
            builder.createEnumOption(this.optionId("disabled_option_visibility"), ReeseSodiumOptionsConfig.DisabledOptionVisibility.class)
         ...
         .addOption(
            builder.createEnumOption(this.optionId("focus_border_mode"), ReeseSodiumOptionsConfig.FocusBorderMode.class)
   ...
   private OptionGroupBuilder createSupportOptions(ConfigBuilder builder) {
      return builder.createOptionGroup()
         ...
         .addOption(
            builder.createExternalButtonOption(this.optionId("support_project"))
               ...
               .setScreenConsumer(screen -> Util.getPlatform().openUri("https://ko-fi.com/flashyreese"))
         );
   }

   private OptionBuilder createBooleanOption(
      ConfigBuilder builder, String name, Consumer<Boolean> setter, Supplier<Boolean> getter, boolean defaultValue, boolean rebuildScreen
   ) {
      BooleanOptionBuilder option = builder.createBooleanOption(this.optionId(name))
   ...
   private ResourceLocation optionId(String path) {
      return ResourceLocation.fromNamespaceAndPath("reeses-sodium-options", path);
   }

   private ResourceLocation modIcon() {
      return ResourceLocation.fromNamespaceAndPath("reeses-sodium-options", "icon.png");
   }
}
