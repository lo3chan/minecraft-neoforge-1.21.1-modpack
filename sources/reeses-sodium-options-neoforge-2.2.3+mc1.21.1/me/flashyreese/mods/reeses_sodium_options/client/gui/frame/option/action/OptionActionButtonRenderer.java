...
final class OptionActionButtonRenderer {
   ...
   private static final int BACKGROUND = 1711276032;
   private static final int BACKGROUND_HOVERED = -1610612736;
   private static final int BACKGROUND_DISABLED = 855638016;
   ...
   static void render(GuiGraphics guiGraphics, ResourceLocation icon, LayoutBounds buttonBounds, int mouseX, int mouseY, boolean focused, boolean active) {
      ...
      guiGraphics.fill(
         buttonBounds.x(), buttonBounds.y(), buttonBounds.getLimitX(), buttonBounds.getLimitY(), active ? (hovered ? -1610612736 : 1711276032) : 855638016
      );
