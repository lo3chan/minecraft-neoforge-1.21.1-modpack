...
public class TabFrame extends AbstractFrame {
   ...
   public static final double TAB_RAIL_MAX_WIDTH_RATIO = 0.35;
   ...
   public TabFrame(
      ...
      List<Tab<?>> tabs,
      Runnable onSetTab,
      Holder<String> tabRailSelectedTab,
      Holder<String> tabRailSelectedGroup,
      Holder<Integer> tabRailScrollBarOffset,
      Holder<Boolean> scrollSelectedTabIntoView,
      Holder<Integer> optionPageScrollBarOffset,
      Set<String> manuallyCollapsedTabGroups,
      OptionStateStore optionStateStore
   ) {
   ...
   public boolean mouseScrolled(double mouseX, double mouseY, double horizontalAmount, double verticalAmount) {
      return super.mouseScrolled(mouseX, mouseY, horizontalAmount, verticalAmount)
         || this.tabRail.mouseScrolled(mouseX, mouseY, horizontalAmount, verticalAmount);
   }
   ...
   public static class Builder {
      ...
      public TabFrame.Builder setDimension(LayoutBounds dim) {
         this.dim = dim;
         return this;
      }
      ...
      public TabFrame.Builder setTabRailSelectedTab(Holder<String> tabRailSelectedTab) {
         this.tabRailSelectedTab = tabRailSelectedTab;
         return this;
      }

      public TabFrame.Builder setTabRailSelectedGroup(Holder<String> tabRailSelectedGroup) {
         this.tabRailSelectedGroup = tabRailSelectedGroup;
         return this;
      }

      public TabFrame.Builder setTabRailScrollBarOffset(Holder<Integer> tabRailScrollBarOffset) {
         this.tabRailScrollBarOffset = tabRailScrollBarOffset;
         return this;
      }

      public TabFrame.Builder setScrollSelectedTabIntoView(Holder<Boolean> scrollSelectedTabIntoView) {
         this.scrollSelectedTabIntoView = scrollSelectedTabIntoView;
         return this;
      }

      public TabFrame.Builder setOptionPageScrollBarOffset(Holder<Integer> optionPageScrollBarOffset) {
         this.optionPageScrollBarOffset = optionPageScrollBarOffset;
         return this;
      }

      public TabFrame.Builder setManuallyCollapsedTabGroups(Set<String> manuallyCollapsedTabGroups) {
         this.manuallyCollapsedTabGroups = manuallyCollapsedTabGroups;
         return this;
      }

      public TabFrame.Builder setOptionStateStore(OptionStateStore optionStateStore) {
         this.optionStateStore = optionStateStore;
         return this;
      }

      public TabFrame.Builder withScreen(Screen screen) {
         this.screen = screen;
         return this;
      }
      ...
      public TabFrame build() {
         ...
         return new TabFrame(
            ...
            this.functions,
            this.onSetTab,
            this.tabRailSelectedTab,
            this.tabRailSelectedGroup,
            this.tabRailScrollBarOffset,
            this.scrollSelectedTabIntoView,
            this.optionPageScrollBarOffset,
            this.manuallyCollapsedTabGroups,
            this.optionStateStore
         );
      }
   }
}
