...
public class ScrollableFrame extends AbstractFrame {
   ...
   public ScrollableFrame(
      ...
      Holder<Integer> verticalScrollBarOffset,
      Holder<Integer> horizontalScrollBarOffset
   ) {
   ...
   public void setupFrame() {
      ...
      if (this.scrollLayout.canScrollHorizontal()) {
         this.horizontalScrollBar = new ScrollBarWidget(
            this.scrollLayout.horizontalScrollBarBounds(),
            ScrollBarWidget.ScrollDirection.HORIZONTAL,
            this.contentFrameDim().width(),
            this.scrollLayout.viewport().width(),
            offset -> {
      ...
      if (this.scrollLayout.canScrollVertical()) {
         this.verticalScrollBar = new ScrollBarWidget(
            this.scrollLayout.verticalScrollBarBounds(),
            ScrollBarWidget.ScrollDirection.VERTICAL,
            this.contentFrameDim().height(),
            this.scrollLayout.viewport().height(),
            offset -> {
   ...
   public void render(@NotNull GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
      if (this.scrollLayout.hasScrollBars()) {
         if (this.renderOutline) {
            this.drawBorder(
               guiGraphics, this.getFrameDim().x(), this.getFrameDim().y(), this.getFrameDim().getLimitX(), this.getFrameDim().getLimitY(), -5592406
            );
         }
   ...
   public boolean mouseClicked(double mouseX, double mouseY, int button) {
      return super.mouseClicked(mouseX, mouseY, button)
         || this.scrollLayout.canScrollHorizontal() && this.horizontalScrollBar.mouseClicked(mouseX, mouseY, button)
         || this.scrollLayout.canScrollVertical() && this.verticalScrollBar.mouseClicked(mouseX, mouseY, button);
   }

   public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
      return super.mouseDragged(mouseX, mouseY, button, deltaX, deltaY)
         || this.scrollLayout.canScrollHorizontal() && this.horizontalScrollBar.mouseDragged(mouseX, mouseY, button, deltaX, deltaY)
         || this.scrollLayout.canScrollVertical() && this.verticalScrollBar.mouseDragged(mouseX, mouseY, button, deltaX, deltaY);
   }

   public boolean mouseReleased(double mouseX, double mouseY, int button) {
      return super.mouseReleased(mouseX, mouseY, button)
         || this.scrollLayout.canScrollHorizontal() && this.horizontalScrollBar.mouseReleased(mouseX, mouseY, button)
         || this.scrollLayout.canScrollVertical() && this.verticalScrollBar.mouseReleased(mouseX, mouseY, button);
   }

   @Override
   public boolean mouseScrolled(double mouseX, double mouseY, double horizontalAmount, double verticalAmount) {
      return super.mouseScrolled(mouseX, mouseY, horizontalAmount, verticalAmount)
         || this.scrollLayout.canScrollHorizontal() && this.horizontalScrollBar.mouseScrolled(mouseX, mouseY, horizontalAmount, verticalAmount)
         || this.scrollLayout.canScrollVertical() && this.verticalScrollBar.mouseScrolled(mouseX, mouseY, horizontalAmount, verticalAmount);
   }

   public boolean scrollToStart() {
      return !this.scrollLayout.canScrollVertical() ? false : this.setVerticalOffset(0);
   }

   public boolean scrollToEnd() {
      return !this.scrollLayout.canScrollVertical() ? false : this.setVerticalOffset(2147483647);
   }

   public boolean scrollPage(int direction) {
      if (this.scrollLayout.canScrollVertical() && direction != 0) {
         int pageSize = Math.max(6, this.scrollLayout.viewport().height() - 18);
   ...
   @Nullable
   public OptionRow findFirstOptionRow() {
      return this.findFirstOptionRow(control -> true);
   }

   @Nullable
   public OptionRow findLastOptionRow() {
      return this.findLastOptionRow(control -> true);
   }

   @Nullable
   public OptionRow findFirstVisibleOptionRow() {
      return this.findFirstOptionRow(this::isOptionRowVisible);
   }

   @Nullable
   public OptionRow findLastVisibleOptionRow() {
   ...
   public static class Builder {
      ...
      public ScrollableFrame.Builder withDimension(LayoutBounds dim) {
         this.dim = dim;
         return this;
      }

      public ScrollableFrame.Builder withRenderOutline(boolean state) {
         this.renderOutline = state;
         return this;
      }

      public ScrollableFrame.Builder withVerticalScrollBarOffset(Holder<Integer> verticalScrollBarOffset) {
         this.verticalScrollBarOffset = verticalScrollBarOffset;
         return this;
      }

      public ScrollableFrame.Builder withHorizontalScrollBarOffset(Holder<Integer> horizontalScrollBarOffset) {
         this.horizontalScrollBarOffset = horizontalScrollBarOffset;
         return this;
      }

      public ScrollableFrame.Builder withFrame(AbstractFrame frame) {
         this.frame = frame;
         return this;
      }

      public ScrollableFrame.Builder withScreen(Screen screen) {
         this.screen = screen;
         return this;
      }

      public ScrollableFrame.Builder withModOptions(ModOptions modConfig) {
         this.modOptions = modConfig;
         return this;
      }

      public ScrollableFrame build() {
         return new ScrollableFrame(
            this.dim, this.screen, this.modOptions, this.frame, this.renderOutline, this.verticalScrollBarOffset, this.horizontalScrollBarOffset
         );
      }
   }
}
