...
final class SodiumControlElementOptionRow extends BaseWidget implements OptionRow {
   ...
   private final SodiumControlElementOptionRow.StubOptionList list;
   ...
   SodiumControlElementOptionRow(Screen screen, LayoutBounds dim, ColorTheme theme, Option option) {
      ...
      this.theme = theme;
      this.option = option;
      this.list = new SodiumControlElementOptionRow.StubOptionList(this.toSodiumDim(dim));
   ...
   public ComponentPath nextFocusPath(FocusNavigationEvent navigation) {
      return !this.isFocused() && this.option.isEnabled() ? ComponentPath.leaf(this) : null;
   }
   ...
   private void relayoutElement(LayoutBounds dim) {
      ...
      ((SodiumWidgetDimensions)this.list).rso$setDimensions(sodiumDim);
