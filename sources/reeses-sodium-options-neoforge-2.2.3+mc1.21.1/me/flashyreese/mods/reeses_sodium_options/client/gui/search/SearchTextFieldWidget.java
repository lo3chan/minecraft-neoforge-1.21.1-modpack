...
public class SearchTextFieldWidget extends TextFieldWidget {
   ...
   public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float delta) {
      ...
      if (this.showClearButton()) {
         ...
         if (hovered) {
            this.drawRect(
               guiGraphics, buttonBounds.x(), buttonBounds.y(), buttonBounds.getLimitX(), buttonBounds.getLimitY(), GuiThemes.DEFAULT_BUTTON.bgHighlight
            );
         }

         int textX = buttonBounds.getCenterX() - this.getStringWidth(CLEAR_BUTTON_LABEL) / 2;
         int textY = buttonBounds.getCenterY() - 9 / 2;
