...
public class ToolContentComponent {
   ...
   public boolean hasDefinedMod(String mod) {
      for (ItemStack stack : this.items) {
         if (stack.has(Registries.DEFINED_MOD)) {
            if (((String)stack.get(Registries.DEFINED_MOD)).equals(mod)) {
               return true;
            }
   ...
   public boolean equals(Object object) {
      return this == object ? true : object instanceof ToolContentComponent component && ItemStack.listMatches(this.items, component.items);
   }
