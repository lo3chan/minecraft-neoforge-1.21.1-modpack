...
public class InDimensionCondition implements Condition {
   public static Codec<InDimensionCondition> CODEC = RecordCodecBuilder.create(
      builder -> builder.group(
            Level.RESOURCE_KEY_CODEC.listOf().fieldOf("dimension_is").forGetter(inDimensionCondition -> new ArrayList<>(inDimensionCondition.validWorlds))
         )
