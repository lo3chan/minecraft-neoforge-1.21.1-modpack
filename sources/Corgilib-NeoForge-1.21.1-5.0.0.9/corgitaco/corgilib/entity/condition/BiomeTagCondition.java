...
public class BiomeTagCondition implements Condition {
   public static final Codec<BiomeTagCondition> CODEC = RecordCodecBuilder.create(
      builder -> builder.group(
            TagKey.codec(Registries.BIOME).listOf().fieldOf("biome_tag_is").forGetter(biomeTagCondition -> new ArrayList<>(biomeTagCondition.biomeTags))
         )
         .apply(builder, BiomeTagCondition::new)
   );
