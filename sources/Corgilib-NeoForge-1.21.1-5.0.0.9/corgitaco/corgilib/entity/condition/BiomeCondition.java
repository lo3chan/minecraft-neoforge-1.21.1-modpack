...
public class BiomeCondition implements Condition {
   public static final Codec<BiomeCondition> CODEC = RecordCodecBuilder.create(
      builder -> builder.group(CodecUtil.BIOME_CODEC.listOf().fieldOf("biome_is").forGetter(biomeCondition -> new ArrayList<>(biomeCondition.biomes)))
