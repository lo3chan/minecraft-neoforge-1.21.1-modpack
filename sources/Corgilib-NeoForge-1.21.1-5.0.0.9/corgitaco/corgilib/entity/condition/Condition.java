...
public interface Condition {
   Codec<Condition> CODEC = Codec.lazyInitialized(
      () -> CorgiLibRegistry.CONDITION.get().byNameCodec().dispatchStable(Condition::codec, MapCodec::assumeMapUnsafe)
   );

   boolean passes(ConditionContext var1);
