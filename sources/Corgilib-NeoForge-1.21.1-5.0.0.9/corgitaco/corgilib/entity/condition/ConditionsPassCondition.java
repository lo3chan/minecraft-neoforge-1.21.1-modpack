...
public record ConditionsPassCondition(List<Condition> filters) implements Condition {
   public static final Codec<ConditionsPassCondition> CODEC = RecordCodecBuilder.create(
      builder -> builder.group(Condition.CODEC.listOf().fieldOf("filters").forGetter(ConditionsPassCondition::filters))
