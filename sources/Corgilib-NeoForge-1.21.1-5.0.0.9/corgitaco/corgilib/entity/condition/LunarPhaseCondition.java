...
public class LunarPhaseCondition implements Condition {
   public static final Codec<LunarPhaseCondition> CODEC = RecordCodecBuilder.create(
      builder -> builder.group(
            Codec.INT.listOf().fieldOf("is_valid_moon_phase").forGetter(lunarPhaseCondition -> new ArrayList(lunarPhaseCondition.validMoonPhases))
         )
         .apply(builder, LunarPhaseCondition::new)
   );
