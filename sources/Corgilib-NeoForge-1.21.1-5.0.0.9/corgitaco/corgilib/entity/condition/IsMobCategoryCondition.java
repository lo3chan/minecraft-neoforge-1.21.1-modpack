...
public record IsMobCategoryCondition(MobCategory category) implements Condition {
   public static final Codec<IsMobCategoryCondition> CODEC = RecordCodecBuilder.create(
      builder -> builder.group(MobCategory.CODEC.fieldOf("mob_category").forGetter(IsMobCategoryCondition::category))
