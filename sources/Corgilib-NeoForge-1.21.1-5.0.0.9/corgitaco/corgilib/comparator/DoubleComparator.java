...
public class DoubleComparator {
   public static final Codec<DoubleComparator> CODEC = Codec.STRING
      .comapFlatMap(s -> DataResult.success(new DoubleComparator(s)), doubleComparator -> doubleComparator.original);
   ...
   public boolean check(double number) {
      return this.check.test(this.checkAgainst, number);
   }
}
