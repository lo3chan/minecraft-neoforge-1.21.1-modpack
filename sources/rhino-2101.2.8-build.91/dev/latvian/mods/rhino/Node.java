...
public class Node implements Iterable<Node> {
   ...
   public Node(int nodeType, int line, int column) {
      this.type = nodeType;
      this.setLineColumnNumber(line, column);
   }
   ...
   public final int labelId() {
      if (this.type != 133 && this.type != 73 && this.type != 167) {
         Kit.codeBug();
      }
      ...
      switch (this.type) {
         ...
         case 143:
            ...
            return switch (this.first.type) {
               case 7 -> this.first.endCheckIf();
               case 82 -> this.first.endCheckTry();
               case 116 -> this.first.endCheckSwitch();
               case 132 -> this.first.endCheckLabel();
               default -> this.endCheckBlock();
            };
         case 133:
            if (this.next != null) {
