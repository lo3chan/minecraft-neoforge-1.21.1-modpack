...
final class NativeDate extends IdScriptableObject {
   ...
   private static double TimeClip(double d) {
      if (Double.isNaN(d) || d == 1.0 / 0.0 || d == -1.0 / 0.0 || Math.abs(d) > 8.64E15) {
         return 0.0 / 0.0;
      } else {
   ...
   private static double jsStaticFunction_UTC(Context cx, Object[] args) {
      return args.length == 0 ? 0.0 / 0.0 : TimeClip(date_msecFromArgs(args, cx));
   }
   ...
   private static double date_parseString(String s) {
      ...
      if (!Double.isNaN(d)) {
         ...
         if (year >= 0 && mon >= 0 && mday >= 0) {
            ...
            double msec = date_msecFromDate(year, mon, mday, hour, min, sec, 0.0);
   ...
   private static String toLocale_helper(double t, int methodId) {
      DateFormat formatter = switch (methodId) {
         case 5 -> localeDateTimeFormatter;
         case 6 -> localeTimeFormatter;
         case 7 -> localeDateFormatter;
   ...
   protected int findPrototypeId(String s) {
      return switch (s) {
         ...
         case "toLocaleTimeString" -> 6;
         case "toLocaleDateString" -> 7;
         case "toUTCString" -> 8;
         case "toSource" -> 9;
         case "valueOf" -> 10;
         case "getTime" -> 11;
         ...
         case "getUTCHours" -> 22;
         case "getMinutes" -> 23;
         case "getUTCMinutes" -> 24;
         case "getSeconds" -> 25;
         case "getUTCSeconds" -> 26;
         case "getMilliseconds" -> 27;
         case "getUTCMilliseconds" -> 28;
         case "getTimezoneOffset" -> 29;
         case "setTime" -> 30;
         case "setMilliseconds" -> 31;
         case "setUTCMilliseconds" -> 32;
         case "setSeconds" -> 33;
         case "setUTCSeconds" -> 34;
         case "setMinutes" -> 35;
         case "setUTCMinutes" -> 36;
         case "setHours" -> 37;
         case "setUTCHours" -> 38;
         case "setDate" -> 39;
         case "setUTCDate" -> 40;
