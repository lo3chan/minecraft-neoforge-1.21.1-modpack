...
public class TypeUtils {
   ...
   public static Class<?> getRawType(Type type) {
      if (type instanceof Class<?> clz) {
         ...
         if (type instanceof ParameterizedType paramType) {
            if (paramType.getRawType() instanceof Class<?> clz) {
               return clz;
            }
         } else {
   ...
   public static Type getComponentType(Type type, Type fallback) {
      if (type instanceof Class<?> c) {
         ...
         return type instanceof GenericArrayType arr ? arr.getGenericComponentType() : fallback;
      }
   }
   ...
   static {
      ...
      cacheType(
         TypeInfo.VOID, TypeInfo.BOOLEAN, TypeInfo.BYTE, TypeInfo.SHORT, TypeInfo.INT, TypeInfo.LONG, TypeInfo.FLOAT, TypeInfo.DOUBLE, TypeInfo.CHARACTER
      );
      cacheType(TypeInfo.NUMBER, TypeInfo.STRING, TypeInfo.STRING_ARRAY, TypeInfo.CLASS, TypeInfo.DATE, TypeInfo.CONTEXT, TypeInfo.SCRIPTABLE);
      cacheType(
         TypeInfo.RUNNABLE,
