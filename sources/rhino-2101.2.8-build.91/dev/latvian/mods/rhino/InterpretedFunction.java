...
final class InterpretedFunction extends NativeFunction implements Script {
   ...
   public Object exec(Context cx, Scriptable scope) {
      if (!this.isScript()) {
         ...
         if (!cx.hasTopCallScope()) {
            ret = cx.doTopCall(scope, this, scope, ScriptRuntime.EMPTY_OBJECTS, this.idata.isStrict);
         } else {
   ...
   protected int getParamCount() {
      if (this.idata.arity >= 0) {
         return this.idata.arity;
      } else {
         return this.idata.argsHasRest ? this.idata.argCount - 1 : this.idata.argCount;
      }
   }
