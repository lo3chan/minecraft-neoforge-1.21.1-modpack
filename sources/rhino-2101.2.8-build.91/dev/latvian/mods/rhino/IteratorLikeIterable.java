   ...
   public final class Itr implements Iterator<Object> {
      ...
      public boolean hasNext() {
         if (this.isDone) {
            ...
            Object val = IteratorLikeIterable.this.next
               .call(IteratorLikeIterable.this.cx, IteratorLikeIterable.this.scope, IteratorLikeIterable.this.iterator, ScriptRuntime.EMPTY_OBJECTS);
            Object doneval = ScriptableObject.getProperty(
               ScriptableObject.ensureScriptable(val, IteratorLikeIterable.this.cx), "done", IteratorLikeIterable.this.cx
            );
