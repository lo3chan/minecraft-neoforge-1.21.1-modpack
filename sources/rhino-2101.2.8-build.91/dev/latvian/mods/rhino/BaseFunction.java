...
public class BaseFunction extends IdScriptableObject implements Function {
   ...
   private int namePropertyAttributes = 3;
   ...
   static void init(Scriptable scope, boolean sealed, Context cx) {
      ...
      obj.setStandardPropertyAttributes(3);
   ...
   protected Object getInstanceIdValue(int id, Context cx) {
      return switch (id) {
         case 1 -> this.lengthPropertyAttributes >= 0 ? this.getLength() : NOT_FOUND;
         case 2 -> this.arityPropertyAttributes >= 0 ? this.getArity() : NOT_FOUND;
         case 3 -> this.namePropertyAttributes >= 0 ? (this.nameValue != null ? this.nameValue : this.getFunctionName()) : NOT_FOUND;
         case 4 -> this.getPrototypeProperty(cx);
         case 5 -> this.getArguments(cx);
      ...
      switch (id) {
         ...
         case 3:
            if (value == NOT_FOUND) {
               ...
               this.nameValue = ScriptRuntime.toString(cx, value);
            } else {
               this.nameValue = "";
            }
