...
public class BoundFunction extends BaseFunction {
   ...
   public Object call(Context cx, Scriptable scope, Scriptable thisObj, Object[] extraArgs) {
      Scriptable callThis = this.boundThis;
   ...
   public Scriptable construct(Context cx, Scriptable scope, Object[] extraArgs) {
      if (this.targetFunction instanceof Constructable) {
         return ((Constructable)this.targetFunction).construct(cx, scope, concat(this.boundArgs, extraArgs));
      } else {
   ...
   public String getFunctionName() {
      return this.targetFunction instanceof BaseFunction ? "bound " + ((BaseFunction)this.targetFunction).getFunctionName() : "";
   }
}
