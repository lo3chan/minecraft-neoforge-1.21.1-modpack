...
final class NativeError extends IdScriptableObject {
   ...
   static NativeError makeAggregate(Context cx, Scriptable scope, IdFunctionObject ctorObj, Object[] args) {
      ...
      if (arglen < 1) {
         ...
         Object iterator = ScriptRuntime.callIterator(args[0], cx, scope);
         ...
         try (IteratorLikeIterable it = new IteratorLikeIterable(cx, scope, iterator)) {
            ...
            obj.defineProperty(cx, "errors", newArray, 2);
         }
   ...
   protected void fillConstructorProperties(IdFunctionObject ctor, Context cx) {
      ...
      this.addIdFunctionProperty(ctor, ERROR_TAG, -2, "isError", 1, cx);
   ...
   private static final class ProtoProps {
      ...
      public Object getStackTraceLimit(Context cx) {
         return this.stackTraceLimit >= 0 ? this.stackTraceLimit : 1.0 / 0.0;
      }
