...
public class ClassFileWriter {
   ...
   private static String descriptorToInternalName(String descriptor) {
      return switch (descriptor.charAt(0)) {
         case 'B', 'C', 'D', 'F', 'I', 'J', 'S', 'V', 'Z', '[' -> descriptor;
   ...
   public void add(int theOpCode, int theOperand) {
      ...
      switch (theOpCode) {
         ...
         case 198:
         case 199:
            if ((theOperand & -2147483648) != -2147483648 && (theOperand < 0 || theOperand > 65535)) {
               throw new IllegalArgumentException("Bad label for branch");
            }

            int branchPC = this.itsCodeBufferTop;
            this.addToCodeBuffer(theOpCode);
            if ((theOperand & -2147483648) != -2147483648) {
               this.addToCodeInt16(theOperand);
   ...
   public void add(int theOpCode, String className, String fieldName, String fieldType) {
      ...
      newStack = switch (theOpCode) {
         case 178, 180 -> newStack + fieldSize;
         case 179, 181 -> newStack - fieldSize;
   ...
   private void addLabelFixup(int label, int fixupSite) {
      if (label >= 0) {
         ...
         if (label >= this.itsLabelTableTop) {
            ...
            this.itsFixupTable[top] = (long)label << 32 | fixupSite;
         }
      }
   }
   ...
   public void addExceptionHandler(int startLabel, int endLabel, int handlerLabel, String catchClassName) {
      if ((startLabel & -2147483648) != -2147483648) {
         throw new IllegalArgumentException("Bad startLabel");
      } else if ((endLabel & -2147483648) != -2147483648) {
         throw new IllegalArgumentException("Bad endLabel");
      } else if ((handlerLabel & -2147483648) != -2147483648) {
   ...
   public static final class MHandle {
      ...
      public boolean equals(Object obj) {
         if (obj == this) {
            ...
            return !(obj instanceof ClassFileWriter.MHandle mh)
               ? false
               : this.tag == mh.tag && this.owner.equals(mh.owner) && this.name.equals(mh.name) && this.desc.equals(mh.desc);
         }
      }
   ...
   final class StackMapTable {
      ...
      private boolean isSuperBlockEnd(int opcode) {
         return switch (opcode) {
            case 167, 170, 171, 172, 173, 174, 176, 177, 191, 200 -> true;
            default -> false;
         };
      }
      ...
      private boolean isBranch(int opcode) {
         return switch (opcode) {
            case 153, 154, 155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 165, 166, 167, 198, 199, 200 -> true;
            default -> false;
         };
      }
      ...
      private long pop2() {
         long type = this.pop();
         return TypeInfo.isTwoWords((int)type) ? type : type << 32 | this.pop() & 16777215;
      }
