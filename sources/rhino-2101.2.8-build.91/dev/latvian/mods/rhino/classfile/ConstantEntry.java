      ...
      if (obj instanceof ConstantEntry entry) {
         if (this.type != entry.type) {
            ...
            return switch (this.type) {
               case 3, 4 -> this.intval == entry.intval;
               case 5, 6 -> this.longval == entry.longval;
               default -> throw new RuntimeException("unsupported constant type");
               case 12 -> this.str1.equals(entry.str1) && this.str2.equals(entry.str2);
               case 18 -> this.intval == entry.intval && this.str1.equals(entry.str1) && this.str2.equals(entry.str2);
            };
         }
      } else {
         return false;
