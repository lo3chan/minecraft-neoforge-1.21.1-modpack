...
public final class Interpreter extends Icode implements Evaluator {
   ...
   public static Object resumeGenerator(Context cx, Scriptable scope, int operation, Object savedState, Object value) {
      ...
      if (operation == 2) {
         ...
         } catch (GeneratorState.GeneratorClosedException var8) {
            throw var8;
                           ...
                           while (true) {
                              ...
                              switch (op) {
                                 ...
                                 case -75:
                                    ...
                                    if (valuex == DBL_MRK) {
                                       valuex = ScriptRuntime.wrapNumber(sDbl[stackTop]);
                                    }

                                    stack[stackTop] = ScriptRuntime.getValueFunctionAndThisOptional(cx, valuex);
                                 ...
                                 case -73:
                                    ...
                                    stack[stackTop] = ScriptRuntime.getPropFunctionAndThisOptional(cx, frame.scope, objx, stringReg);
                                    stack[++stackTop] = cx.lastStoredScriptable();
                                    continue;
                                 case -72:
                                    ...
                                    continue;
                                 case -71:
                                    Object valx = frame.stack[stackTop];
                                    stackTop--;
                                    if (valx == null || Undefined.isUndefined(valx)) {
                                       frame.pc += 2;
                                       continue;
                                    }
                                    break label864;
                                 ...
                                 case -65: {
                                    ...
                                    NativeIterator.StopIteration si = new NativeIterator.StopIteration(
                                       cx, frame.result == UniqueTag.DOUBLE_MARK ? frame.resultDbl : frame.result
                                    );
                                 ...
                                 case -63: {
                                    ...
                                    generatorState.returnedException = new JavaScriptException(
                                       cx, NativeIterator.getStopIterationObject(frame.scope, cx), frame.idata.itsSourceFile, sourceLine
                                    );
                                    break;
                                 }
                                 case -62:
                                 ...
                                 case 71:
                                    ...
                                    if (op == 71) {
                                       ...
                                       if (fun instanceof InterpretedFunction ifun) {
                                          ...
                                          Interpreter.CallFrame calleeFrame = initFrame(
                                             cx, calleeScope, funThisObj, stack, sDbl, stackTop + 2, indexReg, ifun, callParentFrame
                                          );
                                          if (op != -55) {
                                       ...
                                       if (fun instanceof IdFunctionObject ifun
                                          ...
                                          && ScriptRuntime.getCallable(cx, funThisObj) instanceof InterpretedFunction iApplyCallable) {
                                       ...
                                       if (fun instanceof ScriptRuntime.NoSuchMethodShim noSuchMethodShim
                                          && noSuchMethodShim.noSuchMethodMethod instanceof InterpretedFunction ifun) {
                                          frame = initFrameForNoSuchMethod(
                                             cx, frame, indexReg, stack, sDbl, stackTop, op, funThisObj, calleeScope, noSuchMethodShim, ifun
                                          );
                                          continue label1024;
                                       }
                                 ...
                                 case 66:
                                    ...
                                    Object valxx = ScriptRuntime.newArrayLiteral(cx, frame.scope, data, skipIndexces);
                                    stack[stackTop] = valxx;
                                    continue;
                                 case -30: {
                                 ...
                                 case -18:
                                    ...
                                    continue;
                                 case -17:
                                    Object objx = stack[stackTop - 1];
                                    if (objx == DBL_MRK) {
                                       objx = ScriptRuntime.wrapNumber(sDbl[stackTop - 1]);
                                    }
                                    ...
                                    stack[stackTop - 1] = ScriptRuntime.getElemFunctionAndThis(cx, frame.scope, objx, id);
                                    stack[stackTop] = cx.lastStoredScriptable();
                                    continue;
                                 case -16:
                                    Object objxx = stack[stackTop];
                                    if (objxx == DBL_MRK) {
                                       objxx = ScriptRuntime.wrapNumber(sDbl[stackTop]);
                                    }

                                    stack[stackTop] = ScriptRuntime.getPropFunctionAndThis(cx, frame.scope, objxx, stringReg);
                                    stack[++stackTop] = cx.lastStoredScriptable();
                                    continue;
                                 case -15:
                                 ...
                                 case 74:
                                    ...
                                    Scriptable lhs = (Scriptable)stack[--stackTop];
                                    stack[stackTop] = op == 8
                                       ? ScriptRuntime.setName(cx, frame.scope, lhs, rhs, stringReg)
                                       : ScriptRuntime.strictSetName(cx, frame.scope, lhs, rhs, stringReg);
                                    continue;
                                 case 9:
                                 case 10:
                                 case 11:
                                 ...
                                 case 30:
                                    ...
                                    if (lhs instanceof InterpretedFunction f) {
                                       ...
                                       Interpreter.CallFrame calleeFrame = initFrame(
                                          cx, frame.scope, newInstance, stack, sDbl, stackTop + 1, indexReg, f, frame
                                       );
                                    ...
                                    Object[] var101 = getArgsArray(stack, sDbl, stackTop + 1, indexReg);
                                    stack[stackTop] = ctor.construct(cx, frame.scope, var101);
                                    continue;
                                 case 32:
                                 ...
                                 case 63:
                                    indexReg += frame.localShift;
                                    IdEnumeration valxx = (IdEnumeration)stack[indexReg];
                                    stack[++stackTop] = op == 62 ? valxx.next(cx) : valxx.getId(cx);
                                    continue;
                                 case 64:
                                 ...
                                 case 67:
                                    Object[] data = (Object[])stack[stackTop];
                                    int[] getterSetters = (int[])stack[--stackTop];
                                    Object[] idsx = (Object[])stack[--stackTop];
                                    Object valxxx = ScriptRuntime.newObjectLiteral(cx, frame.scope, idsx, data, getterSetters);
                                    stack[stackTop] = valxxx;
                                    continue;
                                 case 68: {
                                    Ref ref = (Ref)stack[stackTop];
                                 ...
                                 case 72:
                                    ...
                                    stack[stackTop] = ScriptRuntime.specialRef(cx, frame.scope, objxx, stringReg);
                                    continue;
                                 case 158:
                                    break label943;
                              }
   ...
   private static int doCallSpecial(
      Context cx, Interpreter.CallFrame frame, Object[] stack, double[] sDbl, int stackTop, byte[] iCode, int indexReg, boolean isOptionalChainingCall
   ) {
      ...
      if (isNew) {
         ...
         stack[stackTop] = ScriptRuntime.callSpecial(
            cx, frame.scope, function, functionThis, outArgs, frame.thisObj, callType, frame.idata.itsSourceFile, sourceLine, isOptionalChainingCall
         );
      }
   ...
   private static int doSetConstVar(
      Interpreter.CallFrame frame, Object[] stack, double[] sDbl, int stackTop, Object[] vars, double[] varDbls, int[] varAttributes, int indexReg, Context cx
   ) {
      if (!frame.useActivation) {
   ...
   private static int doSetVar(
      Context cx, Interpreter.CallFrame frame, Object[] stack, double[] sDbl, int stackTop, Object[] vars, double[] varDbls, int[] varAttributes, int indexReg
   ) {
      if (!frame.useActivation) {
         if ((varAttributes[indexReg] & 1) == 0) {
            vars[indexReg] = stack[stackTop];
   ...
   private static int doGetVar(
      Interpreter.CallFrame frame, Object[] stack, double[] sDbl, int stackTop, Object[] vars, double[] varDbls, int indexReg, Context cx
   ) {
      stackTop++;
      if (!frame.useActivation) {
   ...
   private static class CallFrame implements Cloneable {
      ...
      void initializeArgs(Context cx, Scriptable callerScope, Object[] args, double[] argsDbl, int argShift, int argCount) {
         ...
         if (this.idata.itsFunctionType != 0) {
            ...
            if (this.useActivation) {
               if (this.idata.itsFunctionType == 4) {
                  this.scope = ScriptRuntime.createArrowFunctionActivation(cx, this.scope, this.fnOrScript, args, this.idata.isStrict, this.idata.argsHasRest);
               } else {
                  this.scope = ScriptRuntime.createFunctionActivation(cx, this.scope, this.fnOrScript, args, this.idata.isStrict, this.idata.argsHasRest);
               }
            }
         } else {
         ...
         if (this.idata.argsHasRest) {
            int offset = this.idata.argCount - 1;
            Object[] vals;
            if (argCount >= this.idata.argCount) {
      ...
      public boolean equals(Object other) {
         if (other instanceof Interpreter.CallFrame otherCallFrame) {
            ...
            if (cx.hasTopCallScope()) {
               ...
               return (Boolean)cx.doTopCall(
                  top, (c, scope, thisObj, args) -> this.equalsInTopScope(otherCallFrame), top, ScriptRuntime.EMPTY_OBJECTS, this.isStrictTopFrame()
               );
            }
         } else {
            return false;
      ...
      private Boolean equalsInTopScope(Interpreter.CallFrame other) {
         return EqualObjectGraphs.withThreadLocal(eq -> equals(this, other, eq, this.localContext.factory.enter()));
      }
      ...
      private boolean fieldsEqual(Interpreter.CallFrame other, EqualObjectGraphs equal, Context cx) {
         return this.frameIndex == other.frameIndex
            && this.pc == other.pc
            && Interpreter.compareIdata(this.idata, other.idata)
            && equal.equalGraphs(cx, this.varSource.stack, other.varSource.stack)
            && Arrays.equals(this.varSource.sDbl, other.varSource.sDbl)
            && equal.equalGraphs(cx, this.thisObj, other.thisObj)
            && equal.equalGraphs(cx, this.fnOrScript, other.fnOrScript)
            && equal.equalGraphs(cx, this.scope, other.scope);
      }
   }
}
