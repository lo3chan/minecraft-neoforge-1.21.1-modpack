...
public class TopLevel extends IdScriptableObject {
   ...
   public static Constructable getBuiltinCtor(Context cx, Scriptable scope, TopLevel.Builtins type) {
   ...
   static Constructable getNativeErrorCtor(Context cx, Scriptable scope, TopLevel.NativeErrors type) {
      assert scope.getParentScope() == null;
