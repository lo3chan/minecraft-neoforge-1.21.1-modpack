...
public class InfixExpression extends AstNode {
   ...
   public void setLeft(AstNode left) {
      this.assertNotNull(left);
      this.left = left;
      this.setLineColumnNumber(left.getLineno(), left.getColumn());
      left.setParent(this);
   }
   ...
   public boolean hasSideEffects() {
      return switch (this.getType()) {
         case 75, 106, 107 -> this.left != null && this.left.hasSideEffects() || this.right != null && this.right.hasSideEffects();
         case 90 -> this.right != null && this.right.hasSideEffects();
