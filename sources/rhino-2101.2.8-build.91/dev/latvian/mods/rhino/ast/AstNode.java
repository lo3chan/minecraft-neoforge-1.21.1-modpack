...
public abstract class AstNode extends Node implements Comparable<AstNode> {
   ...
   public boolean hasSideEffects() {
      return switch (this.getType()) {
         case -1, 2, 3, 4, 5, 6, 7, 8, 30, 31, 35, 37, 38, 50, 51, 56, 57, 65, 69, 70, 71, 73, 82, 83, 91, 92, 93, 94, 95, 96, 97, 98, 99, 100, 101, 102, 103, 108, 109, 111, 112, 113, 114, 115, 116, 119, 120, 121, 122, 123, 124, 125, 126, 127, 131, 132, 133, 134, 136, 137, 141, 142, 143, 144, 155, 156, 160, 161, 167, 174 -> true;
         default -> false;
      };
   }
