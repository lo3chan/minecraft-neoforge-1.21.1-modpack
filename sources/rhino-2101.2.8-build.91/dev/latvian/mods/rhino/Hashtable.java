...
public class Hashtable implements Iterable<Hashtable.Entry> {
   ...
   public void put(Context cx, Object key, Object value) {
      ...
      Hashtable.Entry ev = this.map.putIfAbsent(nv, nv);
      if (ev == null) {
         if (this.first == null) {
   ...
   public Object get(Context cx, Object key) {
      ...
      Hashtable.Entry v = this.map.get(e);
      return v == null ? null : v.value;
   }

   public Hashtable.Entry getEntry(Context cx, Object key) {
      Hashtable.Entry e = new Hashtable.Entry(cx, key, null);
   ...
   public Object delete(Context cx, Object key) {
      Hashtable.Entry e = new Hashtable.Entry(cx, key, null);
      Hashtable.Entry v = this.map.remove(e);
      if (v == null) {
         return null;
      } else {
         if (v == this.first) {
   ...
   public boolean deleteEntry(Context cx, Object key) {
      return this.getEntry(cx, key) != null && this.delete(cx, key) != null;
   }
