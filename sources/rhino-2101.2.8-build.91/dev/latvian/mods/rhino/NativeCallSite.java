...
public class NativeCallSite extends IdScriptableObject {
   ...
   public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
      if (!f.hasTag("CallSite")) {
         ...
         return switch (id) {
            case 1 -> make(scope, f, cx);
            case 2, 3, 4, 9 -> Undefined.INSTANCE;
            case 5 -> getFunctionName(thisObj, cx);
            case 6 -> null;
            case 7 -> getFileName(thisObj, cx);
            case 8 -> getLineNumber(thisObj, cx);
            case 10, 11, 12, 13, 14 -> Boolean.FALSE;
            case 15 -> js_toString(thisObj, cx);
