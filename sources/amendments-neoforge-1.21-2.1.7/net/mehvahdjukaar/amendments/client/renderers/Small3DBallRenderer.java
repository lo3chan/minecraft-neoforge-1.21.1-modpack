...
public class Small3DBallRenderer extends ThrownProjectile3DRenderer<Entity> {
   ...
   public Small3DBallRenderer(Context context, float scale, ResourceLocation texture, boolean translucent) {
   ...
   public void renderBall(Entity entity, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, int packedLight) {
      this.model.render(poseStack, bufferSource.getBuffer(this.renderType.apply(this.getTextureLocation(entity))), packedLight, OverlayTexture.NO_OVERLAY);
   }
}
