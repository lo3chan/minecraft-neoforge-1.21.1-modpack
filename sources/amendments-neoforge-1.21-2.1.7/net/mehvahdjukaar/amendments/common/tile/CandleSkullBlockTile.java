...
public class CandleSkullBlockTile extends EnhancedSkullBlockTile {
   ...
   protected void loadAdditional(CompoundTag tag, Provider registries) {
      ...
      if (tag.contains("Candle", 10)) {
         c = Utils.readBlockState(tag.getCompound("Candle"), this.level);
      }
   ...
   public boolean tryAddingCandle(CandleBlock candle) {
      if (this.candle.isAir() || candle == this.candle.getBlock() && (Integer)this.candle.getValue(CandleBlock.CANDLES) != 4) {
