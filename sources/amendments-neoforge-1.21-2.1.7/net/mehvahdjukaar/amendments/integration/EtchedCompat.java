...
import gg.moonflower.etched.common.component.DiscAppearanceComponent.LabelPattern;
...
public class EtchedCompat {
   public static void drawDisc(ItemStack item, PoseStack poseStack, MultiBufferSource bufferSource, int lu, int lv) {
      DiscAppearanceComponent app = (DiscAppearanceComponent)item.getOrDefault(CompatObjects.DISC_APPEARANCE.get(), DiscAppearanceComponent.DEFAULT);
      ...
      LabelPattern pattern = app.pattern();
