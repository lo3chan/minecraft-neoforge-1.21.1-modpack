...
public class TileEntityTerrapinEgg extends BlockEntity {
   ...
   protected void loadAdditional(CompoundTag compound, Provider provider) {
      ...
      if (AMCompat.contains(compound, "Parent1Data")) {
         this.parent1 = new TileEntityTerrapinEgg.ParentData(AMCompat.getCompound(compound, "Parent1Data"));
      }

      if (AMCompat.contains(compound, "Parent2Data")) {
         this.parent2 = new TileEntityTerrapinEgg.ParentData(AMCompat.getCompound(compound, "Parent2Data"));
      }
   }
   ...
   public static class ParentData {
      ...
      public ParentData(CompoundTag tag) {
         this(
            TerrapinTypes.values()[Mth.clamp(AMCompat.getInt(tag, "TerrapinType"), 0, TerrapinTypes.values().length - 1)],
