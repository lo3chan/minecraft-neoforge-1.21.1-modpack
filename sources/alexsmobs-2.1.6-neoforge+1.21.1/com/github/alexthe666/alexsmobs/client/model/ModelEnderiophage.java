...
public class ModelEnderiophage extends AdvancedEntityModel<EntityEnderiophage> {
   ...
   public void setupAnim(EntityEnderiophage entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (entity.isPassenger()) {
         ...
         this.body.rotateAngleY = this.body.rotateAngleY + 1.5707964F * entity.passengerIndex;
         this.sheath.setScale(1.0F, (float)(0.8500000238418579 + Math.sin(ageInTicks) * 0.15000000596046448), 1.0F);
         this.collar.rotationPointY = this.collar.rotationPointY - (float)(Math.sin(ageInTicks) * 0.15000000596046448 - 0.15000000596046448) * 12.0F;
         this.capsid
            .setScale(
               (float)(0.8500000238418579 + Math.sin(ageInTicks + 2.0F) * 0.15000000596046448),
               (float)(1.0 + Math.sin(ageInTicks) * 0.15000000596046448),
               (float)(0.8500000238418579 + Math.sin(ageInTicks + 2.0F) * 0.15000000596046448)
            );
      ...
      if (look != null) {
         ...
         this.eye.rotateAngleX = (float)(
            this.eye.rotateAngleX + (-Mth.clamp(vector3d2.y * 0.5, -1.5707963267948966, 1.5707963267948966) + phagePitch * flyProgress * 0.2F)
         );
      }
   }
