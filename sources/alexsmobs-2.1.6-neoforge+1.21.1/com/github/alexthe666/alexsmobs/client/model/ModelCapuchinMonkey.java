...
public class ModelCapuchinMonkey extends AdvancedEntityModel<EntityCapuchinMonkey> {
   ...
   public void setupAnim(EntityCapuchinMonkey entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float sitProgress = entity.isPassenger() ? 0.0F : entity.prevSitProgress + (entity.sitProgress - entity.prevSitProgress) * partialTick;
      float rideProgress = entity.isPassenger() && entity.getVehicle() instanceof LivingEntity && entity.isOwnedBy((LivingEntity)entity.getVehicle())
         ? 10.0F
         : 0.0F;
