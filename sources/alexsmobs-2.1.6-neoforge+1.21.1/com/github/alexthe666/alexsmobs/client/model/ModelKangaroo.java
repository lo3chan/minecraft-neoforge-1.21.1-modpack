...
public class ModelKangaroo extends AdvancedEntityModel<EntityKangaroo> {
   ...
   public void animate(IAnimatedEntity entity, float f, float f1, float f2, float f3, float f4) {
      ...
      this.animator.endKeyframe();
      this.animator.resetKeyframe(5);
      this.animator.setAnimation(EntityKangaroo.ANIMATION_STAB_R);
      this.animator.startKeyframe(5);
      this.animator.rotate(this.chest, Maths.rad(-15.0), Maths.rad(-25.0), 0.0F);
      this.animator.rotate(this.neck, Maths.rad(5.0), Maths.rad(25.0), 0.0F);
      this.animator.rotate(this.head, 0.0F, Maths.rad(10.0), 0.0F);
      this.animator.rotate(this.arm_right, Maths.rad(-145.0), 0.0F, Maths.rad(20.0));
      this.animator.rotate(this.arm_left, Maths.rad(-50.0), 0.0F, Maths.rad(-15.0));
      this.animator.endKeyframe();
      this.animator.setStaticKeyframe(5);
      this.animator.startKeyframe(3);
      this.animator.move(this.chest, 0.0F, 0.0F, -2.0F);
      this.animator.rotate(this.chest, Maths.rad(20.0), Maths.rad(10.0), 0.0F);
      this.animator.rotate(this.neck, Maths.rad(-15.0), Maths.rad(-10.0), 0.0F);
      this.animator.rotate(this.arm_right, Maths.rad(-100.0), 0.0F, Maths.rad(5.0));
      this.animator.rotate(this.arm_left, Maths.rad(-20.0), 0.0F, 0.0F);
      this.animator.endKeyframe();
      this.animator.setStaticKeyframe(2);
      this.animator.resetKeyframe(6);
      this.animator.setAnimation(EntityKangaroo.ANIMATION_STAB_L);
      this.animator.startKeyframe(5);
      this.animator.rotate(this.chest, Maths.rad(-15.0), Maths.rad(25.0), 0.0F);
      this.animator.rotate(this.neck, Maths.rad(5.0), Maths.rad(-25.0), 0.0F);
      this.animator.rotate(this.head, 0.0F, Maths.rad(-10.0), 0.0F);
      this.animator.rotate(this.arm_left, Maths.rad(-145.0), 0.0F, Maths.rad(-20.0));
      ...
      this.animator.rotate(this.chest, Maths.rad(20.0), Maths.rad(-10.0), 0.0F);
      this.animator.rotate(this.neck, Maths.rad(-15.0), Maths.rad(10.0), 0.0F);
      this.animator.rotate(this.arm_left, Maths.rad(-100.0), 0.0F, Maths.rad(-5.0));
      this.animator.rotate(this.arm_right, Maths.rad(-20.0), 0.0F, 0.0F);
      this.animator.endKeyframe();
      this.animator.setStaticKeyframe(2);
      this.animator.resetKeyframe(6);
   ...
   public void setupAnim(EntityKangaroo entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.foot_left.rotateAngleX = this.foot_left.rotateAngleX + Math.max(0.0F, jumpRotation - 0.5F) * 25.0F * 0.017453292F;
      this.foot_right.rotateAngleX = this.foot_right.rotateAngleX + Math.max(0.0F, jumpRotation - 0.5F) * 25.0F * 0.017453292F;
      ...
      this.head.rotateAngleY += netHeadYaw * 0.35F * 0.017453292F;
      this.head.rotateAngleX += headPitch * 0.65F * 0.017453292F;
      this.neck.rotateAngleY += netHeadYaw * 0.15F * 0.017453292F;
