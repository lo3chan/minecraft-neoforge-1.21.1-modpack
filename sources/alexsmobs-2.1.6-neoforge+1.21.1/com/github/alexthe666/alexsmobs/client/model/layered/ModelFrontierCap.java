...
public class ModelFrontierCap extends HumanoidModel {
   ...
   public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
      ...
      PartDefinition front = head.addOrReplaceChild(
         "frontierhat", CubeListBuilder.create().texOffs(32, 32).addBox(-4.0F, -10.5F, -4.0F, 8.0F, 4.0F, 8.0F, deformation), PartPose.offset(0.0F, 0.0F, 0.0F)
      );
      front.addOrReplaceChild(
         "tail",
         CubeListBuilder.create().texOffs(36, 46).addBox(-1.5F, -0.3F, -1.5F, 3.0F, 13.0F, 3.0F, deformation),
         PartPose.offsetAndRotation(4.4F, -7.5F, 4.5F, 0.19565141F, -0.039095376F, -0.11728612F)
      );
   ...
   public ModelFrontierCap withAnimations(LivingEntity entity) {
      if (entity != null) {
         ...
         this.amAnimateTail(entity.walkAnimation.position() + partialTick, entity.walkAnimation.speed(partialTick));
      }
