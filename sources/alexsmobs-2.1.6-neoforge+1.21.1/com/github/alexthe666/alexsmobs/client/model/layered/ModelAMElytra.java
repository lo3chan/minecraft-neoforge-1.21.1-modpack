...
public class ModelAMElytra extends HumanoidModel {
   ...
   public static LayerDefinition createLayer(CubeDeformation deformation) {
      ...
      partdefinition.addOrReplaceChild(
         "left_wing",
         CubeListBuilder.create().texOffs(32, 32).addBox(-10.0F, 0.0F, 0.0F, 10.0F, 20.0F, 2.0F, cubedeformation),
         PartPose.offsetAndRotation(5.0F, 0.0F, 0.0F, 0.2617994F, 0.0F, -0.2617994F)
      );
      partdefinition.addOrReplaceChild(
         "right_wing",
         CubeListBuilder.create().texOffs(32, 32).mirror().addBox(0.0F, 0.0F, 0.0F, 10.0F, 20.0F, 2.0F, cubedeformation),
         PartPose.offsetAndRotation(-5.0F, 0.0F, 0.0F, 0.2617994F, 0.0F, 0.2617994F)
      );
   ...
   public ModelAMElytra withAnimations(LivingEntity entity) {
      if (entity != null) {
         ...
         this.setupAnim(entity, limbSwing, limbSwingAmount, entity.tickCount + partialTick, 0.0F, 0.0F);
      }
   ...
   public void setupAnim(LivingEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      if (entityIn instanceof AbstractClientPlayer abstractclientplayerentity) {
         abstractclientplayerentity.elytraRotX = (float)(abstractclientplayerentity.elytraRotX + (f - abstractclientplayerentity.elytraRotX) * 0.1);
         abstractclientplayerentity.elytraRotY = (float)(abstractclientplayerentity.elytraRotY + (f3 - abstractclientplayerentity.elytraRotY) * 0.1);
         abstractclientplayerentity.elytraRotZ = (float)(abstractclientplayerentity.elytraRotZ + (f1 - abstractclientplayerentity.elytraRotZ) * 0.1);
