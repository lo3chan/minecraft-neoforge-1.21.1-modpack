...
public class ModelMysteriousWorm extends AdvancedEntityModel<Entity> {
   ...
   public void animateStack(ItemStack itemStackIn) {
      ...
      float tick = Minecraft.getInstance().player == null ? 0.0F : partialTick + Minecraft.getInstance().player.tickCount;
      ...
      this.chainWave(tail, 0.7F, 0.2F, -3.0, tick, Mth.clamp((float)(1.0 + Math.sin(tick * 0.04)), 0.0F, 0.5F) * 2.0F);
   }
}
