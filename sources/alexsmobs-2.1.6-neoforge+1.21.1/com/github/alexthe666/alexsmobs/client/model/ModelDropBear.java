...
public class ModelDropBear extends AdvancedEntityModel<EntityDropBear> {
   ...
   public void setupAnim(EntityDropBear entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      float upsideDownProgress = entityIn.prevUpsideDownProgress
         + (entityIn.upsideDownProgress - entityIn.prevUpsideDownProgress) * (ageInTicks - entityIn.tickCount);
      ...
      this.head.rotateAngleY += netHeadYaw * 0.9F * invert * 0.017453292F;
      this.head.rotateAngleX += headPitch * 0.9F * invert * 0.017453292F;
   }
