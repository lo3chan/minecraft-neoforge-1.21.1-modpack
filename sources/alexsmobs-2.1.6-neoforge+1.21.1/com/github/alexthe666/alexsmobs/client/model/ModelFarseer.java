...
public class ModelFarseer extends AdvancedEntityModel<EntityFarseer> {
   ...
   public void setupAnim(EntityFarseer entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.leftArm.rotationPointX = (float)(this.leftArm.rotationPointX + (topArmOffset.x + Math.sin(ageInTicks * idleSpeed + 1.3F)) * invPortalDegree);
      this.leftArm.rotationPointY = (float)(this.leftArm.rotationPointY + (topArmOffset.y + Math.sin(ageInTicks * idleSpeed + 1.6F)) * invPortalDegree);
      this.leftArm.rotationPointZ = (float)(this.leftArm.rotationPointZ + (topArmOffset.z + Math.cos(ageInTicks * idleSpeed + 1.9F)) * invPortalDegree);
      this.leftArm.rotateAngleY += armYaw;
      this.leftArm2.rotationPointX = (float)(this.leftArm2.rotationPointX + (bottomArmOffset.x + Math.sin(ageInTicks * idleSpeed + 2.3F)) * invPortalDegree);
      this.leftArm2.rotationPointY = (float)(this.leftArm2.rotationPointY + (bottomArmOffset.y + Math.sin(ageInTicks * idleSpeed + 2.6F)) * invPortalDegree);
      this.leftArm2.rotationPointZ = (float)(this.leftArm2.rotationPointZ + (bottomArmOffset.z + Math.cos(ageInTicks * idleSpeed + 2.9F)) * invPortalDegree);
      this.leftArm2.rotateAngleY += armYaw;
      this.rightArm.rotationPointX = (float)(this.rightArm.rotationPointX + (topArmOffset.x + Math.sin(ageInTicks * idleSpeed + 3.3F)) * invPortalDegree);
      this.rightArm.rotationPointY = (float)(this.rightArm.rotationPointY + (topArmOffset.y + Math.sin(ageInTicks * idleSpeed + 3.6F)) * invPortalDegree);
      this.rightArm.rotationPointZ = (float)(this.rightArm.rotationPointZ + (topArmOffset.z + Math.cos(ageInTicks * idleSpeed + 3.9F)) * invPortalDegree);
      this.rightArm.rotateAngleY += armYaw;
      this.rightArm2.rotationPointX = (float)(this.rightArm2.rotationPointX + (bottomArmOffset.x + Math.sin(ageInTicks * idleSpeed + 4.3F)) * invPortalDegree);
      this.rightArm2.rotationPointY = (float)(this.rightArm2.rotationPointY + (bottomArmOffset.y + Math.sin(ageInTicks * idleSpeed + 4.6F)) * invPortalDegree);
      this.rightArm2.rotationPointZ = (float)(this.rightArm2.rotationPointZ + (bottomArmOffset.z + Math.cos(ageInTicks * idleSpeed + 4.9F)) * invPortalDegree);
      this.rightArm2.rotateAngleY += armYaw;
      this.bodyCube1.rotationPointX = (float)(this.bodyCube1.rotationPointX + (body1Offset.x + Math.sin(ageInTicks * idleSpeed + 7.3F)) * invPortalDegree);
      this.bodyCube1.rotationPointY = (float)(this.bodyCube1.rotationPointY + (body1Offset.y + Math.sin(ageInTicks * idleSpeed + 7.6F)) * invPortalDegree);
      this.bodyCube1.rotationPointZ = (float)(this.bodyCube1.rotationPointZ + (body1Offset.z + Math.cos(ageInTicks * idleSpeed + 7.9F)) * invPortalDegree);
      this.bodyCube2.rotationPointX = (float)(this.bodyCube2.rotationPointX + (body2Offset.x + Math.sin(ageInTicks * idleSpeed + 5.3F)) * invPortalDegree);
      this.bodyCube2.rotationPointY = (float)(this.bodyCube2.rotationPointY + (body2Offset.y + Math.sin(ageInTicks * idleSpeed + 5.6F)) * invPortalDegree);
      this.bodyCube2.rotationPointZ = (float)(this.bodyCube2.rotationPointZ + (body2Offset.z + Math.cos(ageInTicks * idleSpeed + 5.9F)) * invPortalDegree);
      ...
      float headY = netHeadYaw * invPortalDegree * 0.017453292F;
      float headZ = headPitch * invPortalDegree * 0.017453292F;
