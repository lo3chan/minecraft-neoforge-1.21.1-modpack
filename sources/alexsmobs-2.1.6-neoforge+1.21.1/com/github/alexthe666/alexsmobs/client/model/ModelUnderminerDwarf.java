...
public class ModelUnderminerDwarf extends AdvancedEntityModel<EntityUnderminer> {
   ...
   public void setupHumanoidAnims(EntityUnderminer entityIn, float p_102867_, float p_102868_, float p_102869_, float p_102870_, float p_102871_) {
      ...
      this.head.rotateAngleY = p_102870_ * 0.017453292F;
      if (flag) {
         this.head.rotateAngleX = -0.7853982F;
      } else if (this.swimAmount > 0.0F) {
         if (flag1) {
            this.head.rotateAngleX = this.rotlerpRad(this.swimAmount, this.head.rotateAngleX, -0.7853982F);
         } else {
            this.head.rotateAngleX = this.rotlerpRad(this.swimAmount, this.head.rotateAngleX, p_102871_ * 0.017453292F);
         }
      } else {
         this.head.rotateAngleX = p_102871_ * 0.017453292F;
      }
      ...
      this.rightArm.rotateAngleX = Mth.cos(p_102867_ * 0.6662F + 3.1415927F) * 2.0F * p_102868_ * 0.5F / f;
      ...
      this.leftLeg.rotateAngleX = Mth.cos(p_102867_ * 0.6662F + 3.1415927F) * 1.4F * p_102868_ / f;
      ...
      if (this.rightArmPose != ArmPose.SPYGLASS) {
         this.rightArm.rotateAngleZ = this.rightArm.rotateAngleZ + 1.0F * (Mth.cos(p_102869_ * 0.09F) * 0.05F + 0.05F);
         this.rightArm.rotateAngleX = this.rightArm.rotateAngleX + 1.0F * Mth.sin(p_102869_ * 0.067F) * 0.05F;
      }

      if (this.leftArmPose != ArmPose.SPYGLASS) {
         this.leftArm.rotateAngleZ = this.leftArm.rotateAngleZ + -1.0F * (Mth.cos(p_102869_ * 0.09F) * 0.05F + 0.05F);
         this.leftArm.rotateAngleX = this.leftArm.rotateAngleX + -1.0F * Mth.sin(p_102869_ * 0.067F) * 0.05F;
      }
      ...
      if (this.swimAmount > 0.0F) {
         ...
         if (!entityIn.isUsingItem()) {
            if (f5 < 14.0F) {
               ...
               this.leftArm.rotateAngleY = this.rotlerpRad(f2, this.leftArm.rotateAngleY, 3.1415927F);
               this.rightArm.rotateAngleY = Mth.lerp(f1, this.rightArm.rotateAngleY, 3.1415927F);
               this.leftArm.rotateAngleZ = this.rotlerpRad(
                  f2, this.leftArm.rotateAngleZ, 3.1415927F + 1.8707964F * this.quadraticArmUpdate(f5) / this.quadraticArmUpdate(14.0F)
               );
               this.rightArm.rotateAngleZ = Mth.lerp(
                  f1, this.rightArm.rotateAngleZ, 3.1415927F - 1.8707964F * this.quadraticArmUpdate(f5) / this.quadraticArmUpdate(14.0F)
               );
            } else if (f5 >= 14.0F && f5 < 22.0F) {
               float f6 = (f5 - 14.0F) / 8.0F;
               this.leftArm.rotateAngleX = this.rotlerpRad(f2, this.leftArm.rotateAngleX, 1.5707964F * f6);
               this.rightArm.rotateAngleX = Mth.lerp(f1, this.rightArm.rotateAngleX, 1.5707964F * f6);
               this.leftArm.rotateAngleY = this.rotlerpRad(f2, this.leftArm.rotateAngleY, 3.1415927F);
               this.rightArm.rotateAngleY = Mth.lerp(f1, this.rightArm.rotateAngleY, 3.1415927F);
               ...
               this.leftArm.rotateAngleX = this.rotlerpRad(f2, this.leftArm.rotateAngleX, 1.5707964F - 1.5707964F * f3);
               this.rightArm.rotateAngleX = Mth.lerp(f1, this.rightArm.rotateAngleX, 1.5707964F - 1.5707964F * f3);
               this.leftArm.rotateAngleY = this.rotlerpRad(f2, this.leftArm.rotateAngleY, 3.1415927F);
               this.rightArm.rotateAngleY = Mth.lerp(f1, this.rightArm.rotateAngleY, 3.1415927F);
               this.leftArm.rotateAngleZ = this.rotlerpRad(f2, this.leftArm.rotateAngleZ, 3.1415927F);
               this.rightArm.rotateAngleZ = Mth.lerp(f1, this.rightArm.rotateAngleZ, 3.1415927F);
            }
         }

         this.leftLeg.rotateAngleX = Mth.lerp(this.swimAmount, this.leftLeg.rotateAngleX, 0.3F * Mth.cos(p_102867_ * 0.33333334F + 3.1415927F));
   ...
   protected void setupAttackAnimation(EntityUnderminer p_102858_, float p_102859_) {
      if (!(this.attackTime <= 0.0F)) {
         ...
         this.body.rotateAngleY = Mth.sin(Mth.sqrt(f) * 6.2831855F) * 0.2F;
         ...
         float f2 = Mth.sin(this.attackTime * 3.1415927F) * -(this.head.rotateAngleX - 0.7F) * 0.75F;
         modelpart.rotateAngleX -= f1 * 1.2F + f2;
         modelpart.rotateAngleY = modelpart.rotateAngleY + this.body.rotateAngleY * 2.0F;
         modelpart.rotateAngleZ = modelpart.rotateAngleZ + Mth.sin(this.attackTime * 3.1415927F) * -0.4F;
      }
   }
