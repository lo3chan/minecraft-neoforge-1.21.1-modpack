...
public class ModelBananaSlug extends AdvancedEntityModel<EntityBananaSlug> {
   ...
   public void setupAnim(EntityBananaSlug entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.leftAntenna.rotateAngleY += netHeadYaw * 0.6F * 0.017453292F;
      this.leftAntenna.rotateAngleX += headPitch * 0.3F * 0.017453292F;
      this.rightAntenna.rotateAngleY += netHeadYaw * 0.6F * 0.017453292F;
      this.rightAntenna.rotateAngleX += headPitch * 0.3F * 0.017453292F;
