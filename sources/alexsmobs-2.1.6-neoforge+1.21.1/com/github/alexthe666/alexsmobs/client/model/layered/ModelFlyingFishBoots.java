...
public class ModelFlyingFishBoots extends HumanoidModel {
   ...
   public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
      ...
      PartDefinition RBoot = rightleg.addOrReplaceChild(
         "RBoot",
         CubeListBuilder.create()
            .texOffs(18, 12)
            .mirror()
            .addBox(-1.9F, -3.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.3F))
            .mirror(false)
            .texOffs(0, 25)
            .mirror()
            .addBox(0.0F, -2.0F, 2.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(0, 0)
            .mirror()
            .addBox(-2.5F, 0.0F, -5.0F, 5.0F, 2.0F, 9.0F, new CubeDeformation(0.0F))
            .mirror(false),
         PartPose.offset(-0.1F, 10.0F, 0.0F)
      );
      RBoot.addOrReplaceChild(
         "RwingR",
         CubeListBuilder.create().texOffs(9, 47).mirror().addBox(0.0F, -3.0F, 0.0F, 0.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offsetAndRotation(-2.5F, 1.0F, -3.0F, 0.0F, -0.5672F, 0.0F)
      );
      RBoot.addOrReplaceChild(
         "RwingL",
         CubeListBuilder.create().texOffs(0, 42).mirror().addBox(0.0F, -3.0F, 0.0F, 0.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false),
         PartPose.offsetAndRotation(2.5F, 1.0F, -3.0F, 0.0F, 0.5672F, 0.0F)
      );
      PartDefinition LBoot = leftleg.addOrReplaceChild(
         "LBoot",
         CubeListBuilder.create()
            .texOffs(18, 12)
            .addBox(-2.1F, -3.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.3F))
            .texOffs(0, 25)
            .addBox(0.0F, -2.0F, 2.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
            .texOffs(0, 0)
            .addBox(-2.5F, 0.0F, -5.0F, 5.0F, 2.0F, 9.0F, new CubeDeformation(0.0F)),
      ...
      LBoot.addOrReplaceChild(
         "LwingL",
         CubeListBuilder.create().texOffs(9, 47).addBox(0.0F, -3.0F, 0.0F, 0.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(2.5F, 1.0F, -3.0F, 0.0F, 0.5672F, 0.0F)
      );
      LBoot.addOrReplaceChild(
         "LwingR",
         CubeListBuilder.create().texOffs(0, 42).addBox(0.0F, -3.0F, 0.0F, 0.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-2.5F, 1.0F, -3.0F, 0.0F, -0.5672F, 0.0F)
      );
