...
public class ModelMantisShrimp extends AdvancedEntityModel<EntityMantisShrimp> {
   ...
   public void setupAnim(EntityMantisShrimp entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.eye_left.rotateAngleX += leftEyePitch * 0.017453292F;
      this.eye_left.rotateAngleY += leftEyeYaw * 0.017453292F;
      this.eye_right.rotateAngleX += rightEyePitch * 0.017453292F;
      this.eye_right.rotateAngleY += rightEyeYaw * 0.017453292F;
      this.head.rotateAngleY += netHeadYaw * 0.5F * 0.017453292F;
      this.head.rotateAngleX += headPitch * 0.8F * 0.017453292F;
