...
public class ModelRoadrunnerBoots extends HumanoidModel {
   ...
   public static LayerDefinition createArmorLayer(CubeDeformation deformation) {
      ...
      rightleg.addOrReplaceChild(
         "featherr",
         CubeListBuilder.create().texOffs(20, 22).addBox(-3.0F, -7.5F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-1.5F, 9.5F, 0.4F, 0.0F, 0.9773844F, -0.312763F)
      );
      leftleg.addOrReplaceChild(
         "featherl",
         CubeListBuilder.create().texOffs(20, 22).mirror().addBox(0.0F, -7.4F, 0.0F, 3.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(1.5F, 9.5F, -0.4F, 0.0F, -0.9773844F, 0.312763F)
      );
