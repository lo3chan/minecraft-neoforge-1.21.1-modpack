...
public class ModelCachalotWhale extends AdvancedEntityModel<EntityCachalotWhale> {
   ...
   public void setupAnim(EntityCachalotWhale entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
      ...
      this.tail1.rotateAngleY = this.tail1.rotateAngleY
         + Mth.clamp((float)entity.getMovementOffsets(15, partialTicks)[0] - renderYaw, -50.0F, 50.0F) * 0.017453292F;
      this.tail2.rotateAngleY = this.tail2.rotateAngleY
         + Mth.clamp((float)entity.getMovementOffsets(17, partialTicks)[0] - renderYaw, -50.0F, 50.0F) * 0.017453292F;
      this.body.rotateAngleX = this.body.rotateAngleX + Math.min(properPitch, sleepProgress * -9.0F) * 0.017453292F;
      this.body.rotateAngleZ += f * 0.017453292F;
      this.head.rotateAngleY = (float)(this.head.rotateAngleY + Math.sin((entity.grabTime + partialTicks) * 0.3F) * 0.10000000149011612 * grabProgress);
