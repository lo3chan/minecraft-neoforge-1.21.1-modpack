...
public class RenderEndPirateFlag<T extends TileEntityEndPirateFlag> implements BlockEntityRenderer<T> {
   ...
   public void render(T tileEntityIn, float partialTicks, PoseStack matrixStackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
      ...
      Direction dir = (Direction)tileEntityIn.getBlockState().getValue(BlockEndPirateFlag.FACING);
      switch (dir) {
         case NORTH:
      ...
      matrixStackIn.mulPose(Axis.YN.rotationDegrees(dir.getAxis() == net.minecraft.core.Direction.Axis.Y ? -90.0F : 90.0F));
      matrixStackIn.pushPose();
      FLAG_MODEL.renderFlag(tileEntityIn, partialTicks);
      FLAG_MODEL.renderToBuffer(
