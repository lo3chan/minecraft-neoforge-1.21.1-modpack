...
public class LayerGrizzlyItem extends RenderLayer<EntityGrizzlyBear, ModelGrizzlyBear> {
   ...
   protected void translateToHand(boolean left, PoseStack matrixStack) {
      ((ModelGrizzlyBear)this.getParentModel()).root.translateAndRotate(matrixStack);
      ((ModelGrizzlyBear)this.getParentModel()).midbody.translateAndRotate(matrixStack);
      ((ModelGrizzlyBear)this.getParentModel()).body.translateAndRotate(matrixStack);
      ((ModelGrizzlyBear)this.getParentModel()).right_arm.translateAndRotate(matrixStack);
   }
}
