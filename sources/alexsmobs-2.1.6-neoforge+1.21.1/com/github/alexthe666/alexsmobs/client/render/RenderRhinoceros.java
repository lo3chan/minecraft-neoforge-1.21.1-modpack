...
public class RenderRhinoceros extends MobRenderer<EntityRhinoceros, ModelRhinoceros> {
   ...
   public RenderRhinoceros(Context renderManagerIn) {
      ...
      this.addLayer(new RenderRhinoceros.PotionLayer(this));
   }
   ...
   private static class PotionLayer extends RenderLayer<EntityRhinoceros, ModelRhinoceros> {
      ...
      public void render(
         ...
         if (color != -1 && !rhino.isInvisible()) {
            ...
            ((ModelRhinoceros)this.getParentModel())
               .renderToBuffer(
                  p_225628_1_,
                  p_225628_2_.getBuffer(AMRenderTypes.entityCutoutNoCull(RenderRhinoceros.TEXTURE_POTION)),
                  p_225628_3_,
