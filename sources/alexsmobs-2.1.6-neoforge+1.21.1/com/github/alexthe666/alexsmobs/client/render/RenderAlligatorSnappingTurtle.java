...
public class RenderAlligatorSnappingTurtle extends MobRenderer<EntityAlligatorSnappingTurtle, ModelAlligatorSnappingTurtle> {
   ...
   public RenderAlligatorSnappingTurtle(Context renderManagerIn) {
      ...
      this.addLayer(new RenderAlligatorSnappingTurtle.AlligatorSnappingTurtleMossLayer(this));
   }
   ...
   static class AlligatorSnappingTurtleMossLayer extends RenderLayer<EntityAlligatorSnappingTurtle, ModelAlligatorSnappingTurtle> {
      ...
      public void render(
         ...
         if (entitylivingbaseIn.getMoss() > 0) {
            ...
            VertexConsumer mossbuffer = bufferIn.getBuffer(AMRenderTypes.entityTranslucent(RenderAlligatorSnappingTurtle.TEXTURE_MOSS));
            ((ModelAlligatorSnappingTurtle)this.getParentModel())
               .renderToBuffer(
                  matrixStackIn,
                  mossbuffer,
                  packedLightIn,
