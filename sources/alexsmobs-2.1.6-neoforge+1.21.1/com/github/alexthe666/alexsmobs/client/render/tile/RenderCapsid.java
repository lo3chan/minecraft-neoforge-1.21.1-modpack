      ...
      if (!stack.isEmpty()) {
         ...
         if (entity.vibratingThisTick && entity.getLevel() != null) {
            ...
            matrixStackIn.translate(
               (entity.getLevel().getRandom().nextFloat() - 0.5F) * vibrate,
               (entity.getLevel().getRandom().nextFloat() - 0.5F) * vibrate,
               (entity.getLevel().getRandom().nextFloat() - 0.5F) * vibrate
            );
         }
         ...
         for (int k = 0; k < j; k++) {
            ...
            Minecraft.getInstance()
               .getItemRenderer()
               .render(stack, ItemDisplayContext.GROUND, false, matrixStackIn, bufferIn, combinedLightIn, OverlayTexture.NO_OVERLAY, ibakedmodel);
