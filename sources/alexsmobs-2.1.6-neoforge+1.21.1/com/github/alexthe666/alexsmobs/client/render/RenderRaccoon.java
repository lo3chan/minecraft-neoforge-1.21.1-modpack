...
public class RenderRaccoon extends MobRenderer<EntityRaccoon, ModelRaccoon> {
   ...
   public RenderRaccoon(Context renderManagerIn) {
      ...
      this.addLayer(new RenderRaccoon.BandanaLayer(this));
   }
      ...
      public void render(
         ...
         if (raccoon.getColor() != null && !raccoon.isInvisible()) {
            ...
            if (raccoon.hasCustomName() && "jeb_".equals(raccoon.getName().getContents())) {
               ...
               float lvt_19_1_ = (raccoon.tickCount % 25 + p_225628_7_) / 25.0F;
            ...
            ((ModelRaccoon)this.getParentModel())
               .renderToBuffer(
                  p_225628_1_,
                  p_225628_2_.getBuffer(AMRenderTypes.entityCutoutNoCull(RenderRaccoon.TEXTURE_BANDANA)),
                  p_225628_3_,
