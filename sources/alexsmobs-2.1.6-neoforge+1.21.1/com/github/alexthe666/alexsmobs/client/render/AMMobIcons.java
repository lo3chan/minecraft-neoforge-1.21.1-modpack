...
public class AMMobIcons {
   private static final List<Pair<EntityType, Float>> MOB_ICONS = List.of(
      ...
      new Pair(AMEntityRegistry.BLOBFISH.get(), 1.0F),
      new Pair(AMEntityRegistry.SEAL.get(), 0.5F),
      new Pair(AMEntityRegistry.COCKROACH.get(), 1.0F),
      ...
      new Pair(AMEntityRegistry.PLATYPUS.get(), 1.0F),
      ...
      new Pair(AMEntityRegistry.SKUNK.get(), 1.0F),
