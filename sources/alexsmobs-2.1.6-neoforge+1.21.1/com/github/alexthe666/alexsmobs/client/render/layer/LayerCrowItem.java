...
public class LayerCrowItem extends RenderLayer<EntityCrow, ModelCrow> {
   ...
   protected void translateToHand(PoseStack matrixStack) {
      ((ModelCrow)this.getParentModel()).root.translateAndRotate(matrixStack);
      ((ModelCrow)this.getParentModel()).body.translateAndRotate(matrixStack);
      ((ModelCrow)this.getParentModel()).head.translateAndRotate(matrixStack);
   }
}
