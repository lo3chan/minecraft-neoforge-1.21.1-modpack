...
public class LayerRaccoonEyes extends RenderLayer<EntityRaccoon, ModelRaccoon> {
   ...
   public void render(
      ...
      long roundedTime = raccoon.level().getDayTime() % 24000L;
      ...
      if (brightness < 7 && !raccoon.isRigby()) {
         ...
         ((ModelRaccoon)this.getParentModel())
            .renderToBuffer(matrixStackIn, ivertexbuilder, packedLightIn, LivingEntityRenderer.getOverlayCoords(raccoon, 0.0F), 1.0F, 1.0F, 1.0F, 1.0F);
      }
   }
}
