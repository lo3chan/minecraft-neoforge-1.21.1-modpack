...
public class RenderGiantSquid extends MobRenderer<EntityGiantSquid, ModelGiantSquid> {
   ...
   public RenderGiantSquid(Context renderManagerIn) {
      ...
      this.addLayer(new RenderGiantSquid.LayerDepressurization(this));
   }
   ...
   static class LayerDepressurization extends RenderLayer<EntityGiantSquid, ModelGiantSquid> {
      ...
      public void render(
         ...
         ((ModelGiantSquid)this.getParentModel())
            .renderToBuffer(matrixStackIn, ivertexbuilder, packedLightIn, LivingEntityRenderer.getOverlayCoords(squid, 0.0F), 1.0F, 1.0F, 1.0F, alpha);
      }
   }
}
