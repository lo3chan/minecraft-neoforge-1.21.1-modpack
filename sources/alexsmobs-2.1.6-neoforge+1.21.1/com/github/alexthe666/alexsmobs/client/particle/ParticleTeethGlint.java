...
public class ParticleTeethGlint extends AMQuadParticle {
   ...
   private ParticleTeethGlint(
      ...
      this.quadSize = this.initScale = 0.1F * (this.random.nextFloat() * 0.3F + 0.5F);
      ...
      this.setAlpha(1.0F - (float)this.age / this.lifetime * 0.5F);
   }
   ...
   public void tick() {
      ...
      this.roll = (float)(this.roll + 0.25 * Math.sin(this.age * 2));
      this.quadSize = this.initScale * (1.0F - (float)this.age / this.lifetime * 0.5F);
   }
