...
public class EntityWarpedToad extends TamableAnimal implements ITargetsDroppedItems, IFollower, ISemiAquatic {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new EntityWarpedToad.FollowOwner(this, 1.3, 4.0F, 2.0F, false));
      ...
      this.goalSelector.addGoal(4, new TemptGoal(this, 1.0, AMCompat.ingredientOf(AMTagRegistry.WARPED_TOAD_FOODSTUFFS), false));
      this.goalSelector.addGoal(5, new WarpedToadAIRandomSwimming(this, 1.0, 7));
      ...
      this.goalSelector.addGoal(7, new AnimalAIWanderRanged(this, 60, 1.0, 5, 4));
   ...
   public InteractionResult mobInteract(Player player, InteractionHand hand) {
      ...
      } else if (this.isTame() && itemstack.is(AMTagRegistry.WARPED_TOAD_FOODSTUFFS)) {
   ...
   protected void defineSynchedData(net.minecraft.network.syncher.SynchedEntityData.Builder builder) {
      ...
      builder.define(TONGUE_LENGTH, 1.0F);
   ...
   public void tick() {
      ...
      if (entityIn != null && this.attackProgress > 0.0F) {
         if (this.isTongueOut()) {
            ...
            Vec3 minus = new Vec3(
               this.getX() + extraX - this.getTarget().getX(),
               this.getEyeHeight() - yHelp - this.getTarget().getY(),
               this.getZ() + extraZ - this.getTarget().getZ()
            );
   ...
   public float getTongueLength() {
      return (Float)this.entityData.get(TONGUE_LENGTH);
   }

   public void setTongueLength(float length) {
      this.entityData.set(TONGUE_LENGTH, length);
   }
   ...
   public static class FollowOwner extends Goal {
      ...
      public boolean canContinueToUse() {
         if (this.tameable.getNavigation().isDone()) {
            ...
            return !this.tameable.isOrderedToSit() && this.tameable.getCommand() == 1
   ...
   public static class TongueAttack extends Goal {
      ...
      public void tick() {
         ...
         Entity entityIn = this.parentEntity.getTarget();
         if (entityIn != null) {
            double dist = this.parentEntity.distanceTo(entityIn);
            if (dist < 8.0
               && this.parentEntity.hasLineOfSight(entityIn)
            ...
            this.parentEntity.getNavigation().moveTo(entityIn, 1.399999976158142);
         }
      }
   }
}
