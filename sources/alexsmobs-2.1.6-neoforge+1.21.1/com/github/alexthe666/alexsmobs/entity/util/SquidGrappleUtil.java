...
public class SquidGrappleUtil {
   ...
   public static int getFirstAvailableHookIndex(LivingEntity entity) {
      ...
      if (nulls != -1) {
         ...
         if (i < 4) {
            ...
            CompoundTag tag = CitadelEntityData.getOrCreateCitadelTag(entity);
            int j = AMCompat.getInt(tag, "LastSquidGrappleHookAlexsMobs");
   ...
   public static int getAnyNullHooks(LivingEntity entity) {
      CompoundTag tag = CitadelEntityData.getOrCreateCitadelTag(entity);
      if (!tag.contains("SquidGrappleHook1AlexsMobs") || getHookEntity(entity.level(), AMCompat.getUUID(tag, "SquidGrappleHook1AlexsMobs")) == null) {
         return 0;
      } else if (!tag.contains("SquidGrappleHook2AlexsMobs") || getHookEntity(entity.level(), AMCompat.getUUID(tag, "SquidGrappleHook2AlexsMobs")) == null) {
         return 1;
      } else if (!tag.contains("SquidGrappleHook3AlexsMobs") || getHookEntity(entity.level(), AMCompat.getUUID(tag, "SquidGrappleHook3AlexsMobs")) == null) {
         return 2;
      } else {
         return tag.contains("SquidGrappleHook4AlexsMobs") && getHookEntity(entity.level(), AMCompat.getUUID(tag, "SquidGrappleHook4AlexsMobs")) != null
            ? -1
            : 3;
      }
   }
   ...
   public static int getHookCount(LivingEntity entity) {
      ...
      if (tag.contains("SquidGrappleHook2AlexsMobs") && getHookEntity(entity.level(), AMCompat.getUUID(tag, "SquidGrappleHook2AlexsMobs")) != null) {
         count++;
      }

      if (tag.contains("SquidGrappleHook3AlexsMobs") && getHookEntity(entity.level(), AMCompat.getUUID(tag, "SquidGrappleHook3AlexsMobs")) != null) {
         count++;
      }

      if (tag.contains("SquidGrappleHook4AlexsMobs") && getHookEntity(entity.level(), AMCompat.getUUID(tag, "SquidGrappleHook4AlexsMobs")) != null) {
         count++;
      }
