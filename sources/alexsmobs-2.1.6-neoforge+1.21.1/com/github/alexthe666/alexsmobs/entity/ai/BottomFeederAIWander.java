...
public class BottomFeederAIWander extends RandomStrollGoal {
   ...
   public boolean canUse() {
      if (this.mob instanceof ISemiAquatic && ((ISemiAquatic)this.mob).shouldStopMoving()) {
         ...
         this.interval = this.mob.isInWater() ? this.waterChance : this.landChance;
         return super.canUse();
      }
   }

   public boolean canContinueToUse() {
      return this.mob instanceof ISemiAquatic && ((ISemiAquatic)this.mob).shouldStopMoving() ? false : super.canContinueToUse();
   }
