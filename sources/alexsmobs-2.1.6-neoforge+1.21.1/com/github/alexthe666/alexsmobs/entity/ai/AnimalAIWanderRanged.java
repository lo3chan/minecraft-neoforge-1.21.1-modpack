...
public class AnimalAIWanderRanged extends RandomStrollGoal {
   ...
   protected Vec3 getPosition() {
      if (this.mob.isInWaterOrBubble()) {
         Vec3 vector3d = LandRandomPos.getPos(this.mob, this.xzRange, this.yRange);
         return vector3d == null ? super.getPosition() : vector3d;
      } else {
         return this.mob.getRandom().nextFloat() >= this.probability ? LandRandomPos.getPos(this.mob, this.xzRange, this.yRange) : super.getPosition();
      }
   }
}
