...
public class OrcaAIJump extends JumpGoal {
   ...
   public boolean canUse() {
      if (this.dolphin.getRandom().nextInt(this.interval) == 0 && this.dolphin.getTarget() == null && this.dolphin.jumpCooldown == 0) {
   ...
   public void start() {
      ...
      this.dolphin.jumpCooldown = this.dolphin.getRandom().nextInt(256) + 256;
   }
