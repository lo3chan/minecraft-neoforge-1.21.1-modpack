...
public class CapuchinAITargetBalloons extends Goal {
   ...
   public static final Predicate<Entity> TARGET_BLOON = balloon -> balloon.getEncodeId() != null
      && (balloon.getType().builtInRegistryHolder().is(AMTagRegistry.MONKEY_TARGET_WITH_DART) || balloon.getEncodeId().contains("balloom"));
