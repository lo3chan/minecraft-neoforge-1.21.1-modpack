...
public class TameableAIFollowOwnerWater extends Goal {
   ...
   public boolean canUse() {
      ...
      if (lvt_1_1_ == null) {
         ...
         if (this.tameable.distanceToSqr(lvt_1_1_) < this.minDist * this.minDist) {
            return false;
   ...
   private boolean isTeleportFriendlyBlock(BlockPos pos) {
      PathType blockPathType = AMCompat.pathTypeStatic(this.tameable, pos);
      if (!this.world.getFluidState(pos).is(FluidTags.WATER)
         && (this.world.getFluidState(pos).is(FluidTags.WATER) || !this.world.getFluidState(pos.below()).is(FluidTags.WATER))) {
