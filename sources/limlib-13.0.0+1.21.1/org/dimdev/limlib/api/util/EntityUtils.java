   ...
   public static Entity getOwner(Entity entity) {
      if (entity instanceof Player) {
         ...
         if (!entity.getPassengers().isEmpty()) {
            topmostEntity = (Entity)entity.getPassengers().get(0);
         }
         ...
         return topmostEntity != null ? getOwner(topmostEntity) : entity;
      }
   }

   public static Player getOwnerPlayer(Entity entity) {
      return getOwner(entity) instanceof Player player ? player : null;
   }
