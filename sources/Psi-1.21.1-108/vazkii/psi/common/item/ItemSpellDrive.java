...
public class ItemSpellDrive extends Item {
   public ItemSpellDrive(Properties properties) {
   ...
   public Component getName(@NotNull ItemStack stack) {
      ...
      if (cmp == null) {
         ...
         return spellName.isEmpty() ? Component.literal(name) : Component.literal(name + " (" + ChatFormatting.GREEN + spellName + ChatFormatting.RESET + ")");
      }
   }
         ...
         if (worldIn.getBlockEntity(pos) instanceof TileProgrammer programmer) {
            ...
            if (spell == null && programmer.canCompile()) {
               ...
               if (!worldIn.isClientSide) {
                  worldIn.playSound(null, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, PsiSoundHandler.bulletCreate, SoundSource.PLAYERS, 0.5F, 1.0F);
               }
