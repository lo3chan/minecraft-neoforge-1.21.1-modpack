...
public class SlotCADOutput extends Slot {
   ...
   public boolean mayPickup(@NotNull Player playerIn) {
      ...
      if (((CADTakeEvent)NeoForge.EVENT_BUS.post(event)).isCanceled()) {
         ...
         if (!playerIn.level().isClientSide) {
            ...
            playerIn.level()
               .playSound(null, assemblerPos.getX(), assemblerPos.getY(), assemblerPos.getZ(), PsiSoundHandler.compileError, SoundSource.BLOCKS, sound, 1.0F);
         }
