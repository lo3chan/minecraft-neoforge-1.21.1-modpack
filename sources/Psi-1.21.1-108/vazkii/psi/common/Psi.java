...
public class Psi {
   ...
   public Psi(IEventBus bus, Dist dist, ModContainer container) {
      ...
      container.registerConfig(Type.CLIENT, ConfigHandler.CLIENT_SPEC);
      container.registerConfig(Type.COMMON, ConfigHandler.COMMON_SPEC);
      proxy = (IProxy)(dist.isClient() ? new ClientProxy() : new ServerProxy());
