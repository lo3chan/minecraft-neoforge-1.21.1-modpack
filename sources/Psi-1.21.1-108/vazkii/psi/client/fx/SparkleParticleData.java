...
public record SparkleParticleData(float size, float r, float g, float b, int m, double mx, double my, double mz) implements ParticleOptions {
   ...
   public static final StreamCodec<? super RegistryFriendlyByteBuf, SparkleParticleData> STREAM_CODEC = new StreamCodec<RegistryFriendlyByteBuf, SparkleParticleData>() {
      @NotNull
   ...
   public ParticleType<SparkleParticleData> getType() {
      return (ParticleType<SparkleParticleData>)ModParticles.SPARKLE.get();
   }
