...
public abstract class MixinBeaconRenderer {
   ...
   @Redirect(
      ...
      at = @At(
         value = "INVOKE",
         target = "Lnet/minecraft/client/renderer/blockentity/BeaconRenderer;renderBeaconBeam(Lcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;FJIII)V"
      )
   )
   @Coerce
   private void modifyMaxY(
      PoseStack matrices,
