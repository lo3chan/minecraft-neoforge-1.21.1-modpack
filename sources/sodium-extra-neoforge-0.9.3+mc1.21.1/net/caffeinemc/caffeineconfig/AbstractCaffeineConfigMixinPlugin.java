...
public abstract class AbstractCaffeineConfigMixinPlugin implements IMixinConfigPlugin {
   ...
   public void onLoad(String mixinPackage) {
      ...
      this.logger()
         .info(
            "Loaded configuration file for {}: {} options available, {} override(s) found",
            new Object[]{this.config.getModName(), this.config.getOptionCount(), this.config.getOptionOverrideCount()}
         );
   }
         ...
         if (option == null) {
            ...
            if (option.isOverridden()) {
               ...
               if (option.isEnabled()) {
                  ...
                  this.logger()
                     .warn("Force-disabling mixin '{}' as option '{}' (added by {}) disables it and children", new Object[]{mixin, option.getName(), source});
               }
            }
