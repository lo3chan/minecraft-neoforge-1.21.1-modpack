...
public class WarpedEndermanModel extends EndermanModel<WarpedEnderMan> {
   private final ModelPart stemBody = this.body.getChild("stem_body");
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      stemBody.addOrReplaceChild(
         "stem_body_r1",
         CubeListBuilder.create().texOffs(42, 0).addBox(-6.0F, -14.0F, -0.5F, 6.0F, 15.0F, 1.0F, CubeDeformation.NONE),
      ...
      leftArm.addOrReplaceChild(
         "stem_arm",
         CubeListBuilder.create().texOffs(35, 0).addBox(-4.0F, -38.0F, -0.5F, 6.0F, 15.0F, 1.0F, CubeDeformation.NONE),
