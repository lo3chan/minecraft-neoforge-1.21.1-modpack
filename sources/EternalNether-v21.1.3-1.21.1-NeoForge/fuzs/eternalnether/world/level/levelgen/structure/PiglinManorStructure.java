...
public class PiglinManorStructure extends Structure {
   public static final MapCodec<PiglinManorStructure> CODEC = RecordCodecBuilder.mapCodec(
   ...
   private static boolean checkLocation(GenerationContext context) {
      ...
      return checkChunk(context)
         ...
         && ModStructureUtils.verticalSpace(blockReader, 34, ModStructureUtils.getScaledNetherHeight(context, 72), 24);
   }
   ...
   public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
      if (checkLocation(context)) {
         BlockPos blockPos = ModStructureUtils.getElevation(context, 34, ModStructureUtils.getScaledNetherHeight(context, 72));
   ...
   public StructureType<?> type() {
      return (StructureType<?>)ModStructures.PIGLIN_MANOR_STRUCTURE_TYPE.value();
   }
}
