...
import net.mcreator.borninchaosv.procedures.CarrotSwordPriUdariePoSushchnostiInstrumientomProcedure;
...
public class CarrotSwordItem extends SwordItem {
   private static final Tier TOOL_TIER = new Tier() {
      ...
      public Ingredient getRepairIngredient() {
         return Ingredient.of(new ItemStack[]{new ItemStack(Items.CARROT)});
      }
   };
   ...
   public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
      ...
      CarrotSwordPriUdariePoSushchnostiInstrumientomProcedure.execute(entity.level(), entity);
      return retval;
   }
