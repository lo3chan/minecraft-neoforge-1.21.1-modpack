...
import net.mcreator.borninchaosv.procedures.RidingFelsteedPriNazhatiiPravoiKnopkiNaSushchnostProcedure;
...
public class RidingFelsteedEntity extends Animal implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(RidingFelsteedEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(RidingFelsteedEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(RidingFelsteedEntity.class, EntityDataSerializers.STRING);
   ...
   public RidingFelsteedEntity(EntityType<RidingFelsteedEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
      ...
      RidingFelsteedPriNazhatiiPravoiKnopkiNaSushchnostProcedure.execute(world, x, y, z, this, sourceentity);
      return retval;
   }
   ...
   public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
      RidingFelsteedEntity retval = (RidingFelsteedEntity)((EntityType)BornInChaosV1ModEntities.RIDING_FELSTEED.get()).create(serverWorld);
