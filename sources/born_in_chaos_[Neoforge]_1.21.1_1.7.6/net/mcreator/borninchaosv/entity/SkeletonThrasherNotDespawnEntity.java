...
public class SkeletonThrasherNotDespawnEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SkeletonThrasherNotDespawnEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SkeletonThrasherNotDespawnEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SkeletonThrasherNotDespawnEntity.class, EntityDataSerializers.STRING);
   ...
   public SkeletonThrasherNotDespawnEntity(EntityType<SkeletonThrasherNotDespawnEntity> type, Level world) {
      super(type, world);
      this.xpReward = 24;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = SkeletonThrasherNotDespawnEntity.this.getX();
            double y = SkeletonThrasherNotDespawnEntity.this.getY();
            double z = SkeletonThrasherNotDespawnEntity.this.getZ();
            Entity entity = SkeletonThrasherNotDespawnEntity.this;
            Level world = SkeletonThrasherNotDespawnEntity.this.level();
