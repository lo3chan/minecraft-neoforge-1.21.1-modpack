...
public class DoorKnightNotDespawnEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DoorKnightNotDespawnEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DoorKnightNotDespawnEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DoorKnightNotDespawnEntity.class, EntityDataSerializers.STRING);
   ...
   public DoorKnightNotDespawnEntity(EntityType<DoorKnightNotDespawnEntity> type, Level world) {
      super(type, world);
      this.xpReward = 15;
      this.setNoAi(false);
