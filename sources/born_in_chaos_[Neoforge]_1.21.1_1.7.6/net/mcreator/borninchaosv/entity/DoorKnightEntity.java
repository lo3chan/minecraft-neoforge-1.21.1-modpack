...
import net.mcreator.borninchaosv.procedures.ZombieswithDoorKoghdaSushchnostRanienaProcedure;
...
public class DoorKnightEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DoorKnightEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DoorKnightEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DoorKnightEntity.class, EntityDataSerializers.STRING);
   ...
   public DoorKnightEntity(EntityType<DoorKnightEntity> type, Level world) {
      super(type, world);
      this.xpReward = 10;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "doorknight");
   }
   ...
   public boolean hurt(DamageSource source, float amount) {
      ZombieswithDoorKoghdaSushchnostRanienaProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this, source.getEntity());
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.DOOR_KNIGHT.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return ZombieswithDoorNaturalnoieUsloviiePoiavlieniiaSushchnostiProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
