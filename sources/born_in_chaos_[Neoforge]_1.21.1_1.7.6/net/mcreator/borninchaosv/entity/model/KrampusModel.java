...
public class KrampusModel extends GeoModel<KrampusEntity> {
   public ResourceLocation getAnimationResource(KrampusEntity entity) {
      return ResourceLocation.parse("born_in_chaos_v1:animations/krampus.animation.json");
   }

   public ResourceLocation getModelResource(KrampusEntity entity) {
      return ResourceLocation.parse("born_in_chaos_v1:geo/krampus.geo.json");
   }
   ...
   public void setCustomAnimations(KrampusEntity animatable, long instanceId, AnimationState animationState) {
