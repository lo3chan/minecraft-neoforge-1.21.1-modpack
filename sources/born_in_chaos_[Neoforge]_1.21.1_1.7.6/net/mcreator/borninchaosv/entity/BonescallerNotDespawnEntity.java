...
public class BonescallerNotDespawnEntity extends Monster implements RangedAttackMob, GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BonescallerNotDespawnEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BonescallerNotDespawnEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BonescallerNotDespawnEntity.class, EntityDataSerializers.STRING);
   ...
   public BonescallerNotDespawnEntity(EntityType<BonescallerNotDespawnEntity> type, Level world) {
      super(type, world);
      this.xpReward = 20;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(2, new AvoidEntityGoal(this, Wolf.class, 6.0F, 1.0, 1.0));
      this.goalSelector.addGoal(3, new AvoidEntityGoal(this, DreadHoundEntity.class, 6.0F, 1.0, 1.0));
      this.goalSelector.addGoal(4, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = BonescallerNotDespawnEntity.this.getX();
            double y = BonescallerNotDespawnEntity.this.getY();
            double z = BonescallerNotDespawnEntity.this.getZ();
            Entity entity = BonescallerNotDespawnEntity.this;
            Level world = BonescallerNotDespawnEntity.this.level();
      ...
      this.goalSelector.addGoal(1, new BonescallerNotDespawnEntity.RangedAttackGoal(this, 1.25, 45, 10.0F) {
         @Override
         public boolean canContinueToUse() {
            return this.canUse();
         }
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void stop() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((BonescallerNotDespawnEntity)this.rangedAttackMob).entityData.set(BonescallerNotDespawnEntity.SHOOT, false);
      }
      ...
      public void tick() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((BonescallerNotDespawnEntity)this.rangedAttackMob).entityData.set(BonescallerNotDespawnEntity.SHOOT, true);
