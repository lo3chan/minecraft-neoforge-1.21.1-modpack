...
public class DecayingZombieEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DecayingZombieEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DecayingZombieEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DecayingZombieEntity.class, EntityDataSerializers.STRING);
   ...
   public DecayingZombieEntity(EntityType<DecayingZombieEntity> type, Level world) {
      super(type, world);
      this.xpReward = 5;
      this.setNoAi(false);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(5, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = DecayingZombieEntity.this.getX();
            double y = DecayingZombieEntity.this.getY();
            double z = DecayingZombieEntity.this.getZ();
            Entity entity = DecayingZombieEntity.this;
            Level world = DecayingZombieEntity.this.level();
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.DECAYING_ZOMBIE.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return DecayingZombieNaturalnoieUsloviiePoiavlieniiaSushchnostiProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
