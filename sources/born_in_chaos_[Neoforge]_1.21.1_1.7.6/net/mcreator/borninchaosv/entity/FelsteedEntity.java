...
public class FelsteedEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(FelsteedEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(FelsteedEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(FelsteedEntity.class, EntityDataSerializers.STRING);
   ...
   public FelsteedEntity(EntityType<FelsteedEntity> type, Level world) {
      super(type, world);
      this.xpReward = 30;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, ControlledBabySkeletonEntity.class, false, false));
      this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, MrPumpkinControlledEntity.class, false, false));
