...
public class SupremeBonescallerEntity extends Monster implements RangedAttackMob, GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SupremeBonescallerEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SupremeBonescallerEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SupremeBonescallerEntity.class, EntityDataSerializers.STRING);
   ...
   public SupremeBonescallerEntity(EntityType<SupremeBonescallerEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new SupremeBonescallerEntity.RangedAttackGoal(this, 1.25, 45, 10.0F) {
         @Override
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.SUPREME_BONESCALLER.get(),
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void stop() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((SupremeBonescallerEntity)this.rangedAttackMob).entityData.set(SupremeBonescallerEntity.SHOOT, false);
      }
      ...
      public void tick() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((SupremeBonescallerEntity)this.rangedAttackMob).entityData.set(SupremeBonescallerEntity.SHOOT, true);
