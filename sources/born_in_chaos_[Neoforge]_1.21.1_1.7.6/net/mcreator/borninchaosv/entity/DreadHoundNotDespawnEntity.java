...
public class DreadHoundNotDespawnEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DreadHoundNotDespawnEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DreadHoundNotDespawnEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DreadHoundNotDespawnEntity.class, EntityDataSerializers.STRING);
   ...
   public DreadHoundNotDespawnEntity(EntityType<DreadHoundNotDespawnEntity> type, Level world) {
      super(type, world);
      this.xpReward = 8;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(2, new NearestAttackableTargetGoal(this, Player.class, false, false) {
         public boolean canUse() {
            double x = DreadHoundNotDespawnEntity.this.getX();
            double y = DreadHoundNotDespawnEntity.this.getY();
            double z = DreadHoundNotDespawnEntity.this.getZ();
            Entity entity = DreadHoundNotDespawnEntity.this;
            Level world = DreadHoundNotDespawnEntity.this.level();
