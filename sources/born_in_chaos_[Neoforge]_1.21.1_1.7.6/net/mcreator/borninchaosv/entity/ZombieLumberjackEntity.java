...
public class ZombieLumberjackEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ZombieLumberjackEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ZombieLumberjackEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ZombieLumberjackEntity.class, EntityDataSerializers.STRING);
   ...
   public ZombieLumberjackEntity(EntityType<ZombieLumberjackEntity> type, Level world) {
      super(type, world);
      this.xpReward = 9;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "zombielumberjack");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(5, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = ZombieLumberjackEntity.this.getX();
            double y = ZombieLumberjackEntity.this.getY();
            double z = ZombieLumberjackEntity.this.getZ();
            Entity entity = ZombieLumberjackEntity.this;
            Level world = ZombieLumberjackEntity.this.level();
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.ZOMBIE_LUMBERJACK.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return ZombielumberjackpriProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
