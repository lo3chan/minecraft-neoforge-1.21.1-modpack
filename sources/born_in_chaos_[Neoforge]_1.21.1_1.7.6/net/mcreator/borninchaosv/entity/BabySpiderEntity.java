...
import net.mcreator.borninchaosv.procedures.BabySpiderPriObnovlieniiTikaSushchnostiProcedure;
import net.mcreator.borninchaosv.procedures.BabySpiderSpawnProProcedure;
...
public class BabySpiderEntity extends Spider implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BabySpiderEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BabySpiderEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BabySpiderEntity.class, EntityDataSerializers.STRING);
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "babyspider");
   }
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, Player.class, false, false) {
         public boolean canUse() {
            double x = BabySpiderEntity.this.getX();
            double y = BabySpiderEntity.this.getY();
            double z = BabySpiderEntity.this.getZ();
            Entity entity = BabySpiderEntity.this;
            Level world = BabySpiderEntity.this.level();
            return super.canUse() && SpidersMotherAtackCodisionProcedure.execute(world, x, y, z);
         }
      });
      this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, CorpseFlyEntity.class, false, false));
      this.targetSelector.addGoal(8, new NearestAttackableTargetGoal(this, MaggotEntity.class, false, false));
   }
   ...
   public void baseTick() {
      super.baseTick();
      BabySpiderPriObnovlieniiTikaSushchnostiProcedure.execute(this.level(), this);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.BABY_SPIDER.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return BabySpiderSpawnProProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
