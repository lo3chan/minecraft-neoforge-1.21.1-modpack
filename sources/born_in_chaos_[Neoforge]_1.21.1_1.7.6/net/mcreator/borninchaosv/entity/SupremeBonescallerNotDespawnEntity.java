...
import net.mcreator.borninchaosv.procedures.BonecallerSupRanProcedure;
import net.mcreator.borninchaosv.procedures.SupremeBonecallerPriObnovlieniiTaktaSushchnostiProcedure;
...
public class SupremeBonescallerNotDespawnEntity extends Monster implements RangedAttackMob, GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SupremeBonescallerNotDespawnEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SupremeBonescallerNotDespawnEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SupremeBonescallerNotDespawnEntity.class, EntityDataSerializers.STRING);
   ...
   public SupremeBonescallerNotDespawnEntity(EntityType<SupremeBonescallerNotDespawnEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "supremebonescaller");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new SupremeBonescallerNotDespawnEntity.RangedAttackGoal(this, 1.25, 45, 10.0F) {
         @Override
   ...
   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound((SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.wither_skeleton.step")), 0.15F, 1.0F);
   }
   ...
   public boolean hurt(DamageSource source, float amount) {
      BonecallerSupRanProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public void baseTick() {
      super.baseTick();
      SupremeBonecallerPriObnovlieniiTaktaSushchnostiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void stop() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((SupremeBonescallerNotDespawnEntity)this.rangedAttackMob).entityData.set(SupremeBonescallerNotDespawnEntity.SHOOT, false);
      }
      ...
      public void tick() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((SupremeBonescallerNotDespawnEntity)this.rangedAttackMob).entityData.set(SupremeBonescallerNotDespawnEntity.SHOOT, true);
