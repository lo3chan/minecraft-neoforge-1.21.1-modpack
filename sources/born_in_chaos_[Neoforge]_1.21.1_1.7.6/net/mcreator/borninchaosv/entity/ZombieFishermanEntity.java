...
import net.mcreator.borninchaosv.procedures.ZombieFishermandeathProcedure;
...
public class ZombieFishermanEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ZombieFishermanEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ZombieFishermanEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ZombieFishermanEntity.class, EntityDataSerializers.STRING);
   ...
   public ZombieFishermanEntity(EntityType<ZombieFishermanEntity> type, Level world) {
      super(type, world);
      this.xpReward = 6;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "zombiefisherman");
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.ZOMBIE_FISHERMAN.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return ZombieFishermanPriProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
   ...
   protected void tickDeath() {
      ...
      if (this.deathTime == 20) {
         ...
         ZombieFishermandeathProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
      }
   }
