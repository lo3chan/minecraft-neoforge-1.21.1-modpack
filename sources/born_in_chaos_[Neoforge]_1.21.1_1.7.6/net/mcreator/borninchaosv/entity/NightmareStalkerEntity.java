...
import net.mcreator.borninchaosv.procedures.NightmareStalkerPriGibieliSushchnostiProcedure;
...
public class NightmareStalkerEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(NightmareStalkerEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(NightmareStalkerEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(NightmareStalkerEntity.class, EntityDataSerializers.STRING);
   ...
   public NightmareStalkerEntity(EntityType<NightmareStalkerEntity> type, Level world) {
      super(type, world);
      this.xpReward = 40;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "nightmarestalker");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(5, new LookAtPlayerGoal(this, Player.class, 170.0F));
      this.goalSelector.addGoal(6, new RandomStrollGoal(this, 0.8));
      this.goalSelector.addGoal(7, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = NightmareStalkerEntity.this.getX();
            double y = NightmareStalkerEntity.this.getY();
            double z = NightmareStalkerEntity.this.getZ();
            Entity entity = NightmareStalkerEntity.this;
            Level world = NightmareStalkerEntity.this.level();
      ...
      this.targetSelector.addGoal(11, new NearestAttackableTargetGoal(this, Sheep.class, true, false));
   }

   public void playStepSound(BlockPos pos, BlockState blockIn) {
      this.playSound((SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("born_in_chaos_v1:step_st")), 0.15F, 1.0F);
   }

   public SoundEvent getHurtSound(DamageSource ds) {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("born_in_chaos_v1:stalker_hurt"));
   }

   public SoundEvent getDeathSound() {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("born_in_chaos_v1:stalker_dead"));
   }
   ...
   public void die(DamageSource source) {
      super.die(source);
      NightmareStalkerPriGibieliSushchnostiProcedure.execute(this.level(), this, source.getEntity());
   }
   ...
   public void baseTick() {
      super.baseTick();
      NightmareStalkerGonProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.NIGHTMARE_STALKER.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return NightmareStalkerNaturalnoieUsloviiePoiavlieniiaSushchnostiProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
   ...
   public static net.minecraft.world.entity.ai.attributes.AttributeSupplier.Builder createAttributes() {
      ...
      return builder.add(Attributes.ATTACK_KNOCKBACK, 1.7);
   }
