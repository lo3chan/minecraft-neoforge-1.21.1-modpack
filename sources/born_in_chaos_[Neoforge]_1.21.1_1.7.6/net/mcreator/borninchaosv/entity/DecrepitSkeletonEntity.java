...
public class DecrepitSkeletonEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(DecrepitSkeletonEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(DecrepitSkeletonEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(DecrepitSkeletonEntity.class, EntityDataSerializers.STRING);
   ...
   public DecrepitSkeletonEntity(EntityType<DecrepitSkeletonEntity> type, Level world) {
      super(type, world);
      this.xpReward = 5;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "decrepit_skeleton");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(8, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = DecrepitSkeletonEntity.this.getX();
            double y = DecrepitSkeletonEntity.this.getY();
            double z = DecrepitSkeletonEntity.this.getZ();
            Entity entity = DecrepitSkeletonEntity.this;
            Level world = DecrepitSkeletonEntity.this.level();
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.DECREPIT_SKELETON.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return DecrepitSkeletonNaturalnoieUsloviiePoiavlieniiaSushchnostiProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
