...
import net.mcreator.borninchaosv.procedures.SpiritofChaosPriNachalnomPrizyvieSushchnostiProcedure;
import net.mcreator.borninchaosv.procedures.SpiritofChaosSpawnProProcedure;
import net.mcreator.borninchaosv.procedures.SpiritofChaosticProcedure;
...
public class SpiritofChaosEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SpiritofChaosEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SpiritofChaosEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SpiritofChaosEntity.class, EntityDataSerializers.STRING);
   ...
   public SpiritofChaosEntity(EntityType<SpiritofChaosEntity> type, Level world) {
      super(type, world);
      this.xpReward = 10;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "spiritofchaos");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new AvoidEntityGoal(this, Player.class, 15.0F, 1.0, 1.2));
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
      ...
      SpiritofChaosPriNachalnomPrizyvieSushchnostiProcedure.execute(this);
      return retval;
   }
   ...
   public void baseTick() {
      super.baseTick();
      SpiritofChaosticProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.SPIRITOF_CHAOS.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return SpiritofChaosSpawnProProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
