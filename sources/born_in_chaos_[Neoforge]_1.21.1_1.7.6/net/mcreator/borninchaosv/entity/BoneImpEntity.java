...
public class BoneImpEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(BoneImpEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(BoneImpEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(BoneImpEntity.class, EntityDataSerializers.STRING);
   ...
   public BoneImpEntity(EntityType<BoneImpEntity> type, Level world) {
      super(type, world);
      this.xpReward = 5;
      this.setNoAi(false);
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.BONE_IMP.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return BoneImpNaturalnoieUsloviiePoiavlieniiaSushchnostiProcedure.execute(world);
         },
         Operation.REPLACE
      );
   }
