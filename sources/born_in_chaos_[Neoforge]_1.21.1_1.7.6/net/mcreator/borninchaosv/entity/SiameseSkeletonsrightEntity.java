...
public class SiameseSkeletonsrightEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SiameseSkeletonsrightEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SiameseSkeletonsrightEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SiameseSkeletonsrightEntity.class, EntityDataSerializers.STRING);
   ...
   public SiameseSkeletonsrightEntity(EntityType<SiameseSkeletonsrightEntity> type, Level world) {
      super(type, world);
      this.xpReward = 6;
      this.setNoAi(false);
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(3, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = SiameseSkeletonsrightEntity.this.getX();
            double y = SiameseSkeletonsrightEntity.this.getY();
            double z = SiameseSkeletonsrightEntity.this.getZ();
            Entity entity = SiameseSkeletonsrightEntity.this;
            Level world = SiameseSkeletonsrightEntity.this.level();
      ...
      this.goalSelector.addGoal(4, new AvoidEntityGoal(this, DreadHoundEntity.class, 6.0F, 1.0, 1.2));
      this.goalSelector.addGoal(5, new AvoidEntityGoal(this, DreadHoundNotDespawnEntity.class, 6.0F, 1.0, 1.2));
      this.goalSelector.addGoal(6, new AvoidEntityGoal(this, DireHoundLeaderEntity.class, 6.0F, 1.0, 1.2));
