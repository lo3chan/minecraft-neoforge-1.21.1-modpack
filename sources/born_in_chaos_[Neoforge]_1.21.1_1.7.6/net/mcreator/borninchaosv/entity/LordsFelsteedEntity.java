...
import net.mcreator.borninchaosv.procedures.LordsFelsteedPriRanieniiSushchnostiProcedure;
...
public class LordsFelsteedEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(LordsFelsteedEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(LordsFelsteedEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(LordsFelsteedEntity.class, EntityDataSerializers.STRING);
   ...
   public LordsFelsteedEntity(EntityType<LordsFelsteedEntity> type, Level world) {
      super(type, world);
      this.xpReward = 90;
      this.setNoAi(false);
   ...
   public boolean hurt(DamageSource source, float amount) {
      LordsFelsteedPriRanieniiSushchnostiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
