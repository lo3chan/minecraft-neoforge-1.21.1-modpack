...
public class ZombieClownNotDespawnEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ZombieClownNotDespawnEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ZombieClownNotDespawnEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ZombieClownNotDespawnEntity.class, EntityDataSerializers.STRING);
   ...
   public ZombieClownNotDespawnEntity(EntityType<ZombieClownNotDespawnEntity> type, Level world) {
      super(type, world);
      this.xpReward = 20;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = ZombieClownNotDespawnEntity.this.getX();
            double y = ZombieClownNotDespawnEntity.this.getY();
            double z = ZombieClownNotDespawnEntity.this.getZ();
            Entity entity = ZombieClownNotDespawnEntity.this;
            Level world = ZombieClownNotDespawnEntity.this.level();
