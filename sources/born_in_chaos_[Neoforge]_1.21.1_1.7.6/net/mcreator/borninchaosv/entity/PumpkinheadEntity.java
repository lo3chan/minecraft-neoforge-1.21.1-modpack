...
import net.mcreator.borninchaosv.procedures.PumpkinheadKoghdaSushchnostUmiraietProcedure;
import net.mcreator.borninchaosv.procedures.PumpkinheadPriObnovlieniiTaktaSushchnostiProcedure;
import net.mcreator.borninchaosv.procedures.PumpkinheadTelProcedure;
...
public class PumpkinheadEntity extends Monster implements RangedAttackMob, GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(PumpkinheadEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(PumpkinheadEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(PumpkinheadEntity.class, EntityDataSerializers.STRING);
   ...
   public PumpkinheadEntity(EntityType<PumpkinheadEntity> type, Level world) {
      super(type, world);
      this.xpReward = 360;
      this.setNoAi(false);
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(1, new PumpkinheadEntity.RangedAttackGoal(this, 1.25, 25, 10.0F) {
         @Override
   ...
   public SoundEvent getHurtSound(DamageSource ds) {
      return (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.phantom.hurt"));
   }

   public boolean hurt(DamageSource source, float amount) {
      PumpkinheadTelProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public void die(DamageSource source) {
      super.die(source);
      PumpkinheadKoghdaSushchnostUmiraietProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), source.getEntity());
   }
   ...
   public void baseTick() {
      super.baseTick();
      PumpkinheadPriObnovlieniiTaktaSushchnostiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public class RangedAttackGoal extends Goal {
      ...
      public void stop() {
         ...
         this.seeTime = 0;
         this.attackTime = -1;
         ((PumpkinheadEntity)this.rangedAttackMob).entityData.set(PumpkinheadEntity.SHOOT, false);
      }
      ...
      public void tick() {
         ...
         if (--this.attackTime == 0) {
            ...
            ((PumpkinheadEntity)this.rangedAttackMob).entityData.set(PumpkinheadEntity.SHOOT, true);
