...
public class SiameseSkeletonsEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SiameseSkeletonsEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SiameseSkeletonsEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SiameseSkeletonsEntity.class, EntityDataSerializers.STRING);
   ...
   public SiameseSkeletonsEntity(EntityType<SiameseSkeletonsEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "siameseskeletons");
   }
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(4, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = SiameseSkeletonsEntity.this.getX();
            double y = SiameseSkeletonsEntity.this.getY();
            double z = SiameseSkeletonsEntity.this.getZ();
            Entity entity = SiameseSkeletonsEntity.this;
            Level world = SiameseSkeletonsEntity.this.level();
      ...
      this.goalSelector.addGoal(6, new AvoidEntityGoal(this, DreadHoundEntity.class, 6.0F, 1.0, 1.2));
      this.goalSelector.addGoal(7, new AvoidEntityGoal(this, DreadHoundNotDespawnEntity.class, 6.0F, 1.0, 1.2));
      this.goalSelector.addGoal(8, new AvoidEntityGoal(this, DireHoundLeaderEntity.class, 6.0F, 1.0, 1.2));
   ...
   public void baseTick() {
      super.baseTick();
      SiameseskeletonsticProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.SIAMESE_SKELETONS.get(),
         ...
         (entityType, world, reason, pos, random) -> {
            ...
            int y = pos.getY();
            int z = pos.getZ();
            return BabySkeletonNaturalnoieUsloviiePoiavlieniiaSushchnostiProcedure.execute(world, x, y, z);
         },
         Operation.REPLACE
      );
   }
