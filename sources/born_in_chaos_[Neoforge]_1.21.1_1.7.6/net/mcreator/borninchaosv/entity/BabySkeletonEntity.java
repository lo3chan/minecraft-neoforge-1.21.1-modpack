...
import net.mcreator.borninchaosv.procedures.BabySkeletonPriNachalnomPrizyvieSushchnostiProcedure;
...
public class BabySkeletonEntity extends Monster implements GeoEntity {
   ...
   protected void registerGoals() {
      ...
      this.goalSelector.addGoal(6, new AvoidEntityGoal(this, DireHoundLeaderEntity.class, 6.0F, 1.0, 1.0));
      this.goalSelector.addGoal(7, new RestrictSunGoal(this) {
         public boolean canUse() {
            double x = BabySkeletonEntity.this.getX();
            double y = BabySkeletonEntity.this.getY();
            double z = BabySkeletonEntity.this.getZ();
            Entity entity = BabySkeletonEntity.this;
            Level world = BabySkeletonEntity.this.level();
   ...
   public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata) {
      ...
      BabySkeletonPriNachalnomPrizyvieSushchnostiProcedure.execute(this);
      return retval;
   }
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.BABY_SKELETON.get(),
