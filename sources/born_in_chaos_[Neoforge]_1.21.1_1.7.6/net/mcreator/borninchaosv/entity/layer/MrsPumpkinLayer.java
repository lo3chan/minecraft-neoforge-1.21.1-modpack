...
public class MrsPumpkinLayer extends GeoRenderLayer<MrsPumpkinEntity> {
   private static final ResourceLocation LAYER = ResourceLocation.parse("born_in_chaos_v1:textures/entities/senorpumpkin_e.png");

   public MrsPumpkinLayer(GeoRenderer<MrsPumpkinEntity> entityRenderer) {
      super(entityRenderer);
   }

   public void render(
      PoseStack poseStack,
      MrsPumpkinEntity animatable,
