...
public class SirPumpkinheadEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SirPumpkinheadEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SirPumpkinheadEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SirPumpkinheadEntity.class, EntityDataSerializers.STRING);
   ...
   public SirPumpkinheadEntity(EntityType<SirPumpkinheadEntity> type, Level world) {
      super(type, world);
      this.xpReward = 0;
      this.setNoAi(false);
   }
   ...
   public boolean hurt(DamageSource source, float amount) {
      SerPumpkinheadPiProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public void baseTick() {
      super.baseTick();
      SerPumpkinheadGProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)BornInChaosV1ModEntities.SIR_PUMPKINHEAD.get(),
   ...
   public static net.minecraft.world.entity.ai.attributes.AttributeSupplier.Builder createAttributes() {
      ...
      return builder.add(Attributes.ATTACK_KNOCKBACK, 1.2);
   }
