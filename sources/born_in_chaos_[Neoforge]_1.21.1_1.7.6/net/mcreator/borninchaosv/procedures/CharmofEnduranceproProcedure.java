...
public class CharmofEnduranceproProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
      if (entity != null) {
         if (entity instanceof Player _playerHasItem
            ...
            if (entity instanceof Player _player) {
               _player.getFoodData().setSaturation(20.0F);
            }
            ...
            if (world instanceof Level _level) {
               if (!_level.isClientSide()) {
                  _level.playSound(
                     ...
                     (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("born_in_chaos_v1:charm_of_endurance_use")),
                     SoundSource.NEUTRAL,
                     0.8F,
                     1.0F
                  );
            ...
            if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
               == BornInChaosV1ModItems.CHARMOF_ENDURANCE.get()) {
