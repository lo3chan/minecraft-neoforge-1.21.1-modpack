...
public class PumpkinLordPistolBlockHitProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      for (Entity entityiterator : world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(2.5), e -> true)
         ...
         if ((entityiterator instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem()
            ...
            entityiterator.hurt(new DamageSource(world.holderOrThrow(DamageTypes.EXPLOSION)), 5.0F);
      ...
      if (world instanceof ServerLevel _levelx) {
         _levelx.sendParticles((SimpleParticleType)BornInChaosV1ModParticleTypes.PUMPKIN_EXPLOSION.get(), x, y + 1.0, z, 4, 0.6, 0.6, 0.6, 0.1);
      }
   }
}
