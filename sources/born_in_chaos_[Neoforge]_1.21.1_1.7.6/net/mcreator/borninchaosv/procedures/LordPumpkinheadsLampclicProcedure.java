   ...
   public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
      if (entity != null) {
         if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
            ...
            if (entity instanceof LivingEntity _entity) {
               ItemStack _setstack = new ItemStack((ItemLike)BornInChaosV1ModItems.LORD_PUMPKINHEADS_EMPTY_LAMP.get()).copy();
            ...
            if (world instanceof ServerLevel _level) {
               Entity entityToSpawn = ((EntityType)BornInChaosV1ModEntities.RIDING_LORDS_FELSTEED.get())
            ...
            if (entity instanceof Player _player) {
               _player.getCooldowns().addCooldown((Item)BornInChaosV1ModItems.LORD_PUMPKINHEADS_EMPTY_LAMP.get(), 30);
            }
         }
      }
   }
