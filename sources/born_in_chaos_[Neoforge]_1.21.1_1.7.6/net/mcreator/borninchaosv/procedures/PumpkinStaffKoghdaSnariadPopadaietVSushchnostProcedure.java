...
public class PumpkinStaffKoghdaSnariadPopadaietVSushchnostProcedure {
            ...
            for (Entity entityiteratorx : world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(2.0), e -> true)
               ...
               if ((entityiteratorx instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem()
                  ...
                  if (entityiteratorx instanceof Player) {
                     ...
                     entityiteratorx.hurt(new DamageSource(world.holderOrThrow(DamageTypes.EXPLOSION)), 3.0F);
                  }
               }
            }
