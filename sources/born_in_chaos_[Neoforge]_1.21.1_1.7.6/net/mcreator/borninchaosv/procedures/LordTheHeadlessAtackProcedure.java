...
@EventBusSubscriber
public class LordTheHeadlessAtackProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if (sourceentity instanceof LordTheHeadlessEntity && (entity instanceof Mob || entity instanceof Monster || entity instanceof Player)) {
            if (!(
               ...
               if ((sourceentity instanceof LivingEntity _livEntxxx ? _livEntxxx.getHealth() : -1.0F)
                  ...
                  && !(entity instanceof LivingEntity _livEnt12 && _livEnt12.hasEffect(BornInChaosV1ModMobEffects.LIVING_BOMB))) {
                  if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide()) {
                     _entity.addEffect(new MobEffectInstance(BornInChaosV1ModMobEffects.LIVING_BOMB, 260, 0));
                  }
