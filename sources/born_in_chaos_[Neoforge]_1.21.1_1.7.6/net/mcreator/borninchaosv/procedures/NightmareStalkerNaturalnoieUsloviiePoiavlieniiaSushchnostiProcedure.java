...
public class NightmareStalkerNaturalnoieUsloviiePoiavlieniiaSushchnostiProcedure {
   public static boolean execute(LevelAccessor world, double x, double y, double z) {
      return world.dayTime() >= 61000L
         && (
         ...
         && world.getLevelData().getGameRules().getBoolean(BornInChaosV1ModGameRules.THEAPPEARANCEOFTHENIGHTMARESTALKER)
