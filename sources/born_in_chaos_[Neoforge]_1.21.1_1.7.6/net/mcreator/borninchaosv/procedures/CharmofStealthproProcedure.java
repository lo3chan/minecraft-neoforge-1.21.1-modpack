...
public class CharmofStealthproProcedure {
      ...
      if (entity != null) {
         if (entity instanceof Player _playerHasItem
            ...
            if (world instanceof Level _level) {
               if (!_level.isClientSide()) {
                  _level.playSound(
                     ...
                     (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("born_in_chaos_v1:charm_of_stealth_use")),
                     SoundSource.NEUTRAL,
                     0.8F,
                     1.0F
                  );
            ...
            if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide()) {
               _entity.addEffect(new MobEffectInstance(MobEffects.INVISIBILITY, 1800, 2));
            }

            if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BornInChaosV1ModItems.CHARMOF_STEALTH.get()
               )
             {
               if (entity instanceof LivingEntity _entity) {
                  ...
                  == BornInChaosV1ModItems.CHARMOF_STEALTH.get()
