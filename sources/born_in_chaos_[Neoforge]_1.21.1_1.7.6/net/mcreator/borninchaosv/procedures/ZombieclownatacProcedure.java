...
@EventBusSubscriber
public class ZombieclownatacProcedure {
   @SubscribeEvent
   ...
   private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
      if (entity != null && sourceentity != null) {
         if ((sourceentity instanceof ZombieClownEntity || sourceentity instanceof ZombieClownNotDespawnEntity)
            ...
            && !(entity instanceof LivingEntity _livEnt6 && _livEnt6.hasEffect(BornInChaosV1ModMobEffects.INTOXICATION))) {
