...
public class PuddleofintoxicationObnovlieniieTikaProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      if (world instanceof ServerLevel _level) {
         _level.sendParticles((SimpleParticleType)BornInChaosV1ModParticleTypes.INTOXICATIND_BOMB_PART.get(), x + 0.5, y, z + 0.5, 1, 0.2, 0.2, 0.2, 0.2);
      }
