...
public class CharmofFuryproProcedure {
      ...
      if (entity != null) {
         if (entity instanceof Player _playerHasItem
            ...
            if (world instanceof Level _level) {
               if (!_level.isClientSide()) {
                  _level.playSound(
                     ...
                     (SoundEvent)BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("born_in_chaos_v1:charm_of_rage_use")),
                     SoundSource.NEUTRAL,
                     0.6F,
                     1.0F
                  );
            ...
            if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide()) {
               _entity.addEffect(new MobEffectInstance(BornInChaosV1ModMobEffects.MEDIUM_RAMPAGE, 1800, 0));
            }
            ...
            if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BornInChaosV1ModItems.CHARMOF_FURY.get()) {
               if (entity instanceof LivingEntity _entity) {
                  _entity.swing(InteractionHand.MAIN_HAND, true);
               }
            } else if ((entity instanceof LivingEntity _livEntx ? _livEntx.getOffhandItem() : ItemStack.EMPTY).getItem()
                  == BornInChaosV1ModItems.CHARMOF_FURY.get()
