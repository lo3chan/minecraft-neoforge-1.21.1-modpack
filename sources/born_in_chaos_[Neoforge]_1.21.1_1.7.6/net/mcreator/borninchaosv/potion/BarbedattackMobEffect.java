...
public class BarbedattackMobEffect extends MobEffect {
   public BarbedattackMobEffect() {
      super(MobEffectCategory.NEUTRAL, -9272941);
   }
   ...
   public static void registerMobEffectExtensions(RegisterClientExtensionsEvent event) {
      event.registerMobEffect(
         ...
         new MobEffect[]{(MobEffect)BornInChaosV1ModMobEffects.BARBEDATTACK.get()}
      );
   }
}
