...
public class FishBreathMobEffect extends MobEffect {
   public FishBreathMobEffect() {
      super(MobEffectCategory.NEUTRAL, -11576741);
   }
   ...
   public static void registerMobEffectExtensions(RegisterClientExtensionsEvent event) {
      event.registerMobEffect(
         ...
         new MobEffect[]{(MobEffect)BornInChaosV1ModMobEffects.FISH_BREATH.get()}
      );
   }
}
