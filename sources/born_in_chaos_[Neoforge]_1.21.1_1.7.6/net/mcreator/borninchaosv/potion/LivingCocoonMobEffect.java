...
public class LivingCocoonMobEffect extends MobEffect {
   public LivingCocoonMobEffect() {
      super(MobEffectCategory.HARMFUL, -11706311);
      this.addAttributeModifier(
         Attributes.MOVEMENT_SPEED, ResourceLocation.fromNamespaceAndPath("born_in_chaos_v1", "effect.living_cocoon_0"), -0.16, Operation.ADD_MULTIPLIED_TOTAL
      );
   }
