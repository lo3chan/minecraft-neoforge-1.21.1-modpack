...
public class BlockBreakMobEffect extends MobEffect {
   public BlockBreakMobEffect() {
      super(MobEffectCategory.HARMFUL, -11123149);
   }

   public void onEffectStarted(LivingEntity entity, int amplifier) {
      BlockBreakKoghdaEffiektNachatprimienienProcedure.execute(entity);
   }
   ...
   public static void registerMobEffectExtensions(RegisterClientExtensionsEvent event) {
      event.registerMobEffect(
         ...
         new MobEffect[]{(MobEffect)BornInChaosV1ModMobEffects.BLOCK_BREAK.get()}
      );
   }
}
