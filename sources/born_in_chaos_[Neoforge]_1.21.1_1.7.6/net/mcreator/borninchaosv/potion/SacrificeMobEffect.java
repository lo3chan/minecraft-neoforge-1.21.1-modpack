...
public class SacrificeMobEffect extends MobEffect {
   public SacrificeMobEffect() {
      super(MobEffectCategory.HARMFUL, -13882063);
   }
   ...
   public static void registerMobEffectExtensions(RegisterClientExtensionsEvent event) {
      event.registerMobEffect(
         ...
         new MobEffect[]{(MobEffect)BornInChaosV1ModMobEffects.SACRIFICE.get()}
      );
   }
}
