...
public class UndeadSummonunMobEffect extends MobEffect {
   public UndeadSummonunMobEffect() {
      super(MobEffectCategory.NEUTRAL, -13283794);
   }
   ...
   public static void registerMobEffectExtensions(RegisterClientExtensionsEvent event) {
      event.registerMobEffect(
         ...
         new MobEffect[]{(MobEffect)BornInChaosV1ModMobEffects.UNDEAD_SUMMONUN.get()}
      );
   }
}
