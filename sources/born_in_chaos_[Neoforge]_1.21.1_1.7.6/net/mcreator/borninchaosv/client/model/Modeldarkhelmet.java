...
public class Modeldarkhelmet<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
      ResourceLocation.fromNamespaceAndPath("born_in_chaos_v1", "modeldarkhelmet"), "main"
   );
   public final ModelPart Head;

   public Modeldarkhelmet(ModelPart root) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition Helmet_r1 = Head.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(44, 105)
            .mirror()
            .addBox(-1.2F, -3.15F, 2.8F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
            .mirror(false)
            .texOffs(0, 94)
            .mirror()
      ...
      PartDefinition Helmet_r2 = Head.addOrReplaceChild(
         ...
         CubeListBuilder.create()
            ...
            .texOffs(44, 105)
            .addBox(-2.8F, -3.15F, 2.8F, 4.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(6.2746F, -8.4704F, -0.0786F, -2.7592F, -0.4708F, -1.9927F)
      );
