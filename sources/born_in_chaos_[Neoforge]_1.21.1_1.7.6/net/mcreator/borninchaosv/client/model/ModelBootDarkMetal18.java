...
public class ModelBootDarkMetal18<T extends Entity> extends EntityModel<T> {
   public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
      ResourceLocation.fromNamespaceAndPath("born_in_chaos_v1", "model_boot_dark_metal_18"), "main"
   );
   public final ModelPart RightBoot;
   public final ModelPart LeftBoot;

   public ModelBootDarkMetal18(ModelPart root) {
