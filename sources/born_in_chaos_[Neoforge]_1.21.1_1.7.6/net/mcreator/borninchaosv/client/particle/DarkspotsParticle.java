...
public class DarkspotsParticle extends TextureSheetParticle {
   ...
   public static DarkspotsParticle.DarkspotsParticleProvider provider(SpriteSet spriteSet) {
      return new DarkspotsParticle.DarkspotsParticleProvider(spriteSet);
   }
   ...
   public static class DarkspotsParticleProvider implements ParticleProvider<SimpleParticleType> {
      private final SpriteSet spriteSet;

      public DarkspotsParticleProvider(SpriteSet spriteSet) {
         this.spriteSet = spriteSet;
      }
