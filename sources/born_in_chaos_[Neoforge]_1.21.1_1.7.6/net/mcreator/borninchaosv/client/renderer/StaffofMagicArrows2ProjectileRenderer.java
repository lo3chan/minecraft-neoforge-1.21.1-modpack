...
public class StaffofMagicArrows2ProjectileRenderer extends EntityRenderer<StaffofMagicArrows2ProjectileEntity> {
   ...
   public StaffofMagicArrows2ProjectileRenderer(Context context) {
      super(context);
      this.model = new Modelmagic_arrow18(context.bakeLayer(Modelmagic_arrow18.LAYER_LOCATION));
   }

   public void render(
      StaffofMagicArrows2ProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn
   ) {
   ...
   public ResourceLocation getTextureLocation(StaffofMagicArrows2ProjectileEntity entity) {
      return texture;
   }
}
