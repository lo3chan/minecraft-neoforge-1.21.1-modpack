...
public class MissionaryChargeRenderer extends EntityRenderer<MissionaryChargeEntity> {
   ...
   public MissionaryChargeRenderer(Context context) {
      super(context);
      this.model = new ModelDarcFar18(context.bakeLayer(ModelDarcFar18.LAYER_LOCATION));
   }

   public void render(MissionaryChargeEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
   ...
   public ResourceLocation getTextureLocation(MissionaryChargeEntity entity) {
      return texture;
   }
}
