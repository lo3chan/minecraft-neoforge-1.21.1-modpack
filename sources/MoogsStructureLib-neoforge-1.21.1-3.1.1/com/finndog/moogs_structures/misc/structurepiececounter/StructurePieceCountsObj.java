...
public class StructurePieceCountsObj {
   ...
   public StructurePieceCountsObj(
      String nbtPieceName, Integer alwaysSpawnThisMany, Integer neverSpawnMoreThanThisMany, Integer minimumDistanceFromCenterPiece, String condition
   ) {
