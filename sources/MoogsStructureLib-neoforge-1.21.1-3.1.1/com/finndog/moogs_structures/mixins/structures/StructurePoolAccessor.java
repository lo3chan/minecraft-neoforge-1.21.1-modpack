...
public interface StructurePoolAccessor {
   ...
   @Mutable
   @Accessor("rawTemplates")
   void moogs_structures_setRawTemplates(List<Pair<StructurePoolElement, Integer>> var1);
   ...
   @Mutable
   @Accessor("templates")
   void moogs_structures_setTemplates(ObjectArrayList<StructurePoolElement> var1);
}
