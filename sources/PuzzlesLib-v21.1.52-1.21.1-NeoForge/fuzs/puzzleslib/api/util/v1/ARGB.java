...
public final class ARGB {
   ...
   public static int alpha(int color) {
      return ARGB32.alpha(color);
   }

   public static int red(int color) {
      return ARGB32.red(color);
   }

   public static int green(int color) {
      return ARGB32.green(color);
   }

   public static int blue(int color) {
      return ARGB32.blue(color);
   }
   ...
   public static int color(int red, int green, int blue) {
      return ARGB32.color(red, green, blue);
   }
   ...
   public static int multiply(int color1, int color2) {
      if (color1 == -1) {
         ...
         return color2 == -1 ? color1 : ARGB32.multiply(color1, color2);
      }
   }
   ...
   public static int lerp(float delta, int color1, int color2) {
      return ARGB32.lerp(delta, color1, color2);
   }

   public static int opaque(int color) {
      return ARGB32.opaque(color);
   }
   ...
   public static int color(int alpha, int color) {
      return ARGB32.color(alpha, color);
   }
   ...
   public static int colorFromFloat(float alpha, float red, float green, float blue) {
      return ARGB32.colorFromFloat(alpha, red, green, blue);
   }
   ...
   public static int average(int color1, int color2) {
      return ARGB32.average(color1, color2);
   }
