...
public final class ModelTemplateHelper {
   ...
   public static ResourceLocation generateFlatItem(Item item, Item layerItem, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput) {
      return generateFlatItem(ModelLocationHelper.getItemLocation(item), ModelLocationHelper.getItemLocation(layerItem), modelOutput);
   }

   public static ResourceLocation generateFlatItem(
      Item item, Item layerItem, ModelTemplate modelTemplate, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput
   ) {
      return generateFlatItem(ModelLocationHelper.getItemLocation(item), ModelLocationHelper.getItemLocation(layerItem), modelTemplate, modelOutput);
   }

   public static ResourceLocation generateFlatItem(
      Item item, Item layerItem, ModelTemplate modelTemplate, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput, JsonFactory factory
   ) {
      return generateFlatItem(ModelLocationHelper.getItemLocation(item), ModelLocationHelper.getItemLocation(layerItem), modelTemplate, modelOutput, factory);
   }
   ...
   public static ResourceLocation generateFlatItem(
      ResourceLocation resourceLocation, ModelTemplate modelTemplate, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput, JsonFactory factory
   ) {
      return generateFlatItem(resourceLocation, resourceLocation, modelTemplate, modelOutput, factory);
   }

   public static ResourceLocation generateFlatItem(
      ResourceLocation resourceLocation, ResourceLocation layer0, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput
   ) {
      return generateFlatItem(resourceLocation, layer0, ModelTemplates.FLAT_ITEM, modelOutput);
   }

   public static ResourceLocation generateFlatItem(
      ResourceLocation resourceLocation, ResourceLocation layer0, ModelTemplate modelTemplate, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput
   ) {
      return generateFlatItem(resourceLocation, layer0, modelTemplate, modelOutput, modelTemplate::createBaseTemplate);
   }
   ...
   public static ResourceLocation generateFlatItem(
      ...
      return modelTemplate.create(
         ModelLocationHelper.getItemModel(resourceLocation), TextureMapping.layer0(ModelLocationHelper.getItemTexture(layer0)), modelOutput, factory
      );
   }

   public static ResourceLocation generateLayeredItem(
      Item item, ResourceLocation layer0, ResourceLocation layer1, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput
   ) {
      return generateLayeredItem(ModelLocationHelper.getItemLocation(item), layer0, layer1, modelOutput);
   }

   public static ResourceLocation generateLayeredItem(
      Item item, ResourceLocation layer0, ResourceLocation layer1, ModelTemplate modelTemplate, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput
   ) {
      return generateLayeredItem(ModelLocationHelper.getItemLocation(item), layer0, layer1, modelTemplate, modelOutput);
   }
   ...
   public static ResourceLocation generateLayeredItem(
      ...
      return generateLayeredItem(ModelLocationHelper.getItemLocation(item), layer0, layer1, modelTemplate, modelOutput, factory);
   }

   public static ResourceLocation generateLayeredItem(
      ResourceLocation resourceLocation, ResourceLocation layer0, ResourceLocation layer1, BiConsumer<ResourceLocation, Supplier<JsonElement>> modelOutput
   ) {
   ...
   public static ResourceLocation generateLayeredItem(
      ...
      return generateLayeredItem(resourceLocation, layer0, layer1, modelTemplate, modelOutput, modelTemplate::createBaseTemplate);
   }
   ...
   public static ResourceLocation generateLayeredItem(
      ...
      return modelTemplate.create(
         ...
         TextureMapping.layered(ModelLocationHelper.getItemTexture(layer0), ModelLocationHelper.getItemTexture(layer1)),
         modelOutput,
         factory
      );
   }
