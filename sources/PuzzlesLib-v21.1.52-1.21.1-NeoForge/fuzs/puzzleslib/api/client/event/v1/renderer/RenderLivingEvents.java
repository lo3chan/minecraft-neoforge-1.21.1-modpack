...
public final class RenderLivingEvents {
   ...
   public interface After {
      <T extends LivingEntity, M extends EntityModel<T>> void onAfterRenderEntity(
         T var1, LivingEntityRenderer<T, M> var2, float var3, PoseStack var4, MultiBufferSource var5, int var6
      );
   }

   @FunctionalInterface
   public interface Before {
      <T extends LivingEntity, M extends EntityModel<T>> EventResult onBeforeRenderEntity(
         T var1, LivingEntityRenderer<T, M> var2, float var3, PoseStack var4, MultiBufferSource var5, int var6
      );
   }
}
