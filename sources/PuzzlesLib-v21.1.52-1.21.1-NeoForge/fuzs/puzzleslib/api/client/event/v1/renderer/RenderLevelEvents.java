...
public final class RenderLevelEvents {
   ...
   public interface AfterEntities {
      void onRenderLevelAfterEntities(
         LevelRenderer var1, Camera var2, GameRenderer var3, DeltaTracker var4, PoseStack var5, Matrix4f var6, Frustum var7, ClientLevel var8
      );
   }

   @FunctionalInterface
   public interface AfterLevel {
      void onRenderLevelAfterLevel(
         LevelRenderer var1, Camera var2, GameRenderer var3, DeltaTracker var4, PoseStack var5, Matrix4f var6, Frustum var7, ClientLevel var8
      );
   }
   ...
   public interface AfterTerrain {
      void onRenderLevelAfterTerrain(
         LevelRenderer var1, Camera var2, GameRenderer var3, DeltaTracker var4, PoseStack var5, Matrix4f var6, Frustum var7, ClientLevel var8
      );
   }
   ...
   public interface AfterTranslucent {
      void onRenderLevelAfterTranslucent(
         LevelRenderer var1, Camera var2, GameRenderer var3, DeltaTracker var4, PoseStack var5, Matrix4f var6, Frustum var7, ClientLevel var8
      );
   }
}
