...
public class PartPose extends net.minecraft.client.model.geom.PartPose {
   ...
   public PartPose(net.minecraft.client.model.geom.PartPose partPose) {
      this(
         ...
         partPose.yRot,
         partPose.zRot,
         partPose instanceof PartPose posexx ? posexx.xScale : 1.0F,
         partPose instanceof PartPose posex ? posex.yScale : 1.0F,
   ...
   public PartPose scaled(float x, float y, float z) {
      return new PartPose(this.x * x, this.y * y, this.z * z, this.xRot, this.yRot, this.zRot, this.xScale * x, this.yScale * y, this.zScale * z);
   }
}
