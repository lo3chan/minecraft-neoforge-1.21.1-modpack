...
public final class EventResultHolder<T> {
   ...
   public Optional<T> getInterrupt() {
      return !this.isInterrupt() ? Optional.empty() : Optional.ofNullable(this.value);
   }

   public Optional<T> getAllow() {
      return this.isInterrupt() && this.result.getAsBoolean() ? Optional.ofNullable(this.value) : Optional.empty();
   }
