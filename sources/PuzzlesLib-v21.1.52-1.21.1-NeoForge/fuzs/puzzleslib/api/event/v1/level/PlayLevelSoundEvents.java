...
public final class PlayLevelSoundEvents {
   ...
   public interface AtEntity {
      EventResult onPlaySoundAtEntity(
         Level var1, Entity var2, MutableValue<Holder<SoundEvent>> var3, MutableValue<SoundSource> var4, DefaultedFloat var5, DefaultedFloat var6
      );
   }

   @FunctionalInterface
   public interface AtPosition {
      EventResult onPlaySoundAtPosition(
         Level var1, Vec3 var2, MutableValue<Holder<SoundEvent>> var3, MutableValue<SoundSource> var4, DefaultedFloat var5, DefaultedFloat var6
      );
   }
}
