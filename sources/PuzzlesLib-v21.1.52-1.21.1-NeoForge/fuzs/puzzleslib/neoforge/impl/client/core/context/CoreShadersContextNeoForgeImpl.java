...
public record CoreShadersContextNeoForgeImpl(BiConsumer<ShaderInstance, Consumer<ShaderInstance>> consumer, ResourceProvider resourceManager)
   implements CoreShadersContext {
   @Override
