...
public class NeoForgeBlockEntityCapabilityKey<T extends BlockEntity, C extends CapabilityComponent<T>>
   extends NeoForgeCapabilityKey<T, C>
   implements BlockEntityCapabilityKey<T, C> {
