...
public record DataPackSourcesContextNeoForgeImpl(AddPackFindersEvent event) implements PackRepositorySourcesContext {
   ...
   public static void registerBuiltInPack(
      AddPackFindersEvent event, ResourceLocation resourceLocation, Component displayName, boolean shouldAddAutomatically, PackType packType
   ) {
      event.addPackFinders(
         PackResourcesHelper.getBuiltInPack(resourceLocation, packType),
         packType,
         displayName,
