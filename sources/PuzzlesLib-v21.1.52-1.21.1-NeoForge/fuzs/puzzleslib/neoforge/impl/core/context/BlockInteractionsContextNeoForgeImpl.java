...
public final class BlockInteractionsContextNeoForgeImpl implements BlockInteractionsContext {
   private final Map<ItemAbility, Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction>> abilities = new IdentityHashMap<>();
   ...
   public void registerStrippable(Block strippedBlock, Block... unstrippedBlocks) {
      ...
      BlockInteractionsContextNeoForgeImpl.BlockInteraction interaction = new BlockInteractionsContextNeoForgeImpl.BlockInteraction(strippedBlock);
      Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction> interactions = this.getAbilitiesMap(ItemAbilities.AXE_STRIP);
   ...
   public void registerScrapeable(Block scrapedBlock, Block... unscrapedBlocks) {
      ...
      BlockInteractionsContextNeoForgeImpl.BlockInteraction interaction = new BlockInteractionsContextNeoForgeImpl.BlockInteraction(scrapedBlock);
      Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction> interactions = this.getAbilitiesMap(ItemAbilities.AXE_SCRAPE);
   ...
   public void registerWaxable(Block unwaxedBlock, Block... waxedBlocks) {
      ...
      BlockInteractionsContextNeoForgeImpl.BlockInteraction interaction = new BlockInteractionsContextNeoForgeImpl.BlockInteraction(unwaxedBlock);
      Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction> interactions = this.getAbilitiesMap(ItemAbilities.AXE_WAX_OFF);
   ...
   public void registerFlattenable(BlockState flattenedBlock, Block... unflattenedBlocks) {
      ...
      BlockInteractionsContextNeoForgeImpl.BlockInteraction interaction = new BlockInteractionsContextNeoForgeImpl.BlockInteraction(
         (UnaryOperator<BlockState>)($ -> flattenedBlock)
      );
      Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction> interactions = this.getAbilitiesMap(ItemAbilities.SHOVEL_FLATTEN);
   ...
   public void registerTillable(BlockState tilledBlock, @Nullable ItemLike droppedItem, boolean onlyIfAirAbove, Block... untilledBlocks) {
      ...
      Consumer<UseOnContext> tillingAction = droppedItem != null
         ? HoeItem.changeIntoStateAndDropItem(tilledBlock, droppedItem)
         : HoeItem.changeIntoState(tilledBlock);
      BlockInteractionsContextNeoForgeImpl.BlockInteraction interaction = new BlockInteractionsContextNeoForgeImpl.BlockInteraction(
         usagePredicate, tillingAction, $ -> tilledBlock
      );
      Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction> interactions = this.getAbilitiesMap(ItemAbilities.HOE_TILL);
   ...
   private Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction> getAbilitiesMap(ItemAbility itemAbility) {
   ...
   private void onBlockToolModification(BlockToolModificationEvent evt) {
      Map<Block, BlockInteractionsContextNeoForgeImpl.BlockInteraction> interactions = this.abilities.get(evt.getItemAbility());
      if (interactions != null) {
         BlockState state = evt.getState();
         BlockInteractionsContextNeoForgeImpl.BlockInteraction interaction = interactions.get(state.getBlock());
   ...
   private record BlockInteraction(Predicate<UseOnContext> predicate, Consumer<UseOnContext> consumer, UnaryOperator<BlockState> operator) {
