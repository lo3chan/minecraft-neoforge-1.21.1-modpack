...
public record CreativeModeTabContextNeoForgeImpl(IEventBus modEventBus) implements CreativeModeTabContext {
   ...
   public void registerCreativeModeTab(CreativeModeTabConfigurator configurator) {
      ...
      DeferredRegister<CreativeModeTab> deferredRegister = DeferredRegister.create(
         Registries.CREATIVE_MODE_TAB, configuratorImpl.getResourceLocation().getNamespace()
      );
   ...
   private void finalizeCreativeModeTabBuilder(Builder builder, CreativeModeTabConfiguratorImpl configuratorImpl) {
