   ...
   public static void printClazzComponentsWithoutAccess(Class<?> clazz) {
      for (Field field : clazz.getDeclaredFields()) {
         if (!Modifier.isPublic(field.getModifiers()) && !field.isSynthetic()) {
            LOGGER.info(
               "transitive-accessible\tfield\t{}\t{}\t{}",
               new Object[]{Type.getInternalName(field.getDeclaringClass()), field.getName(), Type.getDescriptor(field.getType())}
            );
         }
      }
      ...
      for (Method method : clazz.getDeclaredMethods()) {
         if (!Modifier.isPublic(method.getModifiers()) && !method.isSynthetic()) {
            LOGGER.info(
               "transitive-accessible\tmethod\t{}\t{}\t{}",
               new Object[]{Type.getInternalName(method.getDeclaringClass()), method.getName(), Type.getMethodDescriptor(method)}
            );
         }
      }
   }
