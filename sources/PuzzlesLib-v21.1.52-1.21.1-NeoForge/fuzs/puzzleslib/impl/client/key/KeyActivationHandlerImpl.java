...
public record KeyActivationHandlerImpl(
   @Nullable Consumer<Minecraft> gameHandler, @Nullable Class<? extends Screen> screenType, @Nullable Consumer<? extends Screen> screenHandler
) implements KeyActivationHandler {
   @Override
