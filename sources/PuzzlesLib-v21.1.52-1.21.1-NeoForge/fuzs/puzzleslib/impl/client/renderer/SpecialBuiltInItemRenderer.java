...
public class SpecialBuiltInItemRenderer<T> implements ReloadingBuiltInItemRenderer {
   ...
   public void renderByItem(
      ItemStack itemStack, ItemDisplayContext context, PoseStack poseStack, MultiBufferSource bufferSource, int lightCoords, int overlayCoords
   ) {
      Objects.requireNonNull(this.modelRenderer, "model renderer is null");
      this.modelRenderer.render(this.modelRenderer.extractArgument(itemStack), poseStack, bufferSource, lightCoords, overlayCoords, itemStack.hasFoil());
   }
