...
public record ClientboundEntityCapabilityMessage(ResourceLocation identifier, int entityId, CompoundTag tag)
   implements ClientboundMessage<ClientboundEntityCapabilityMessage> {
   public ClientMessageListener<ClientboundEntityCapabilityMessage> getHandler() {
      return new ClientMessageListener<ClientboundEntityCapabilityMessage>() {
         public void handle(
            ClientboundEntityCapabilityMessage message, Minecraft minecraft, ClientPacketListener handler, LocalPlayer player, ClientLevel level
         ) {
