...
public abstract class DataAttachmentBuilder<T, A> implements DataAttachmentRegistry.Builder<T, A> {
   ...
   @Override
   public DataAttachmentRegistry.Builder<T, A> networkSynchronized(
      StreamCodec<? super RegistryFriendlyByteBuf, A> streamCodec, Function<T, PlayerSet> targetSelector
   ) {
