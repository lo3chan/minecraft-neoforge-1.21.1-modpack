...
public class GuiButtonBookBookmark extends GuiButtonBook {
   ...
   public void renderWidget(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookmark != null && entry != null) {
         ...
         if (this.multiblock) {
            s = I18n.get("patchouli.gui.lexicon.visualize_letter", new Object[0]);
         }
   ...
   private static Component[] getTooltip(Book book, PersistentData.Bookmark bookmark, boolean multiblock) {
      ...
      return bookmark != null && entry != null
         ? new Component[]{
            entry.getName(),
            Component.translatable(multiblock ? "patchouli.gui.lexicon.multiblock_bookmark" : "patchouli.gui.lexicon.remove_bookmark")
               .withStyle(ChatFormatting.GRAY)
         }
         : new Component[]{Component.translatable("patchouli.gui.lexicon.add_bookmark")};
   }
}
