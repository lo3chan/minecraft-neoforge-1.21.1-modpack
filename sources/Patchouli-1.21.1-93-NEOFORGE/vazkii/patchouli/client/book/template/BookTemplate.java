...
public class BookTemplate {
   ...
   static {
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "text"), ComponentText.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "item"), ComponentItemStack.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "image"), ComponentImage.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "header"), ComponentHeader.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "separator"), ComponentSeparator.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "frame"), ComponentFrame.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "entity"), ComponentEntity.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "tooltip"), ComponentTooltip.class);
      registerComponent(ResourceLocation.fromNamespaceAndPath("patchouli", "custom"), ComponentCustom.class);
   }
}
