...
public class ComponentImage extends TemplateComponent {
   ...
   public void onVariablesAvailable(UnaryOperator<IVariable> lookup, Provider registries) {
      ...
      this.image = lookup.apply(IVariable.wrap(this.image, registries)).asString();
   }
   ...
   public void render(GuiGraphics graphics, BookPage page, int mouseX, int mouseY, float pticks) {
      if (this.scale != 0.0F) {
         ...
         graphics.blit(this.resource, 0, 0, this.u, this.v, this.width, this.height, this.textureWidth, this.textureHeight);
