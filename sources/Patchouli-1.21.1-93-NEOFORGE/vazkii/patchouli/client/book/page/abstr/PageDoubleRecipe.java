...
public abstract class PageDoubleRecipe<T> extends PageWithText {
   ...
   public void build(Level level, BookEntry entry, BookContentsBuilder builder, int pageNum) {
      ...
      this.recipe1 = this.loadRecipe(level, builder, entry, this.recipeId, this.linkRecipe);
      this.recipe2 = this.loadRecipe(level, builder, entry, this.recipe2Id, this.linkRecipe2);
   ...
   public void render(GuiGraphics graphics, int mouseX, int mouseY, float pticks) {
      if (this.recipe1 != null) {
         ...
         if (this.recipe2 != null) {
            this.drawRecipe(
               graphics, this.recipe2, recipeX, recipeY + this.getRecipeHeight() - (this.title2.getString().isEmpty() ? 10 : 0), mouseX, mouseY, true
            );
         }
      }
   ...
   protected abstract T loadRecipe(Level var1, BookContentsBuilder var2, BookEntry var3, ResourceLocation var4, boolean var5);
