   ...
   public void render(GuiGraphics graphics, int mouseX, int mouseY, float pticks) {
      ...
      if (this.pageNum == 0) {
         ...
         if (this.mc.options.advancedItemTooltips) {
            ...
            smolText = I18n.get("patchouli.gui.lexicon.added_by", new Object[]{this.entry.getAddedBy()});
         }
         ...
         this.parent
            .drawCenteredStringNoShadow(graphics, this.parent.getEntry().getName().getVisualOrderText(), 58, renderedSmol ? -3 : 0, this.book.headerColor);
