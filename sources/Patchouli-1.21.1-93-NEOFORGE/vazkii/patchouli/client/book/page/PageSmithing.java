...
public class PageSmithing extends PageDoubleRecipeRegistry<SmithingRecipe> {
   ...
   protected void drawRecipe(GuiGraphics graphics, SmithingRecipe recipe, int recipeX, int recipeY, int mouseX, int mouseY, boolean second) {
      ...
      if (level != null) {
         ...
         this.parent.renderIngredient(graphics, recipeX + 40, recipeY + 4, mouseX, mouseY, this.getTemplate(recipe));
         this.parent.renderItemStack(graphics, recipeX + 40, recipeY + 20, mouseX, mouseY, recipe.getToastSymbol());
