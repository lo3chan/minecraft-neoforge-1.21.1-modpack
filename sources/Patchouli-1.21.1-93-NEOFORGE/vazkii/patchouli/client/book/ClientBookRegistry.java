...
public class ClientBookRegistry {
   ...
   public final Gson gson = new GsonBuilder()
      ...
      .registerTypeHierarchyAdapter(TemplateComponent.class, new ClientBookRegistry.TemplateComponentAdapter())
      .create();
   ...
   private void addPageTypes() {
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "text"), PageText.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "crafting"), PageCrafting.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "smelting"), PageSmelting.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "blasting"), PageBlasting.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "smoking"), PageSmoking.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "campfire"), PageCampfireCooking.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "smithing"), PageSmithing.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "stonecutting"), PageStonecutting.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "image"), PageImage.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "spotlight"), PageSpotlight.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "empty"), PageEmpty.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "multiblock"), PageMultiblock.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "link"), PageLink.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "relations"), PageRelations.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "entity"), PageEntity.class);
      this.pageTypes.put(ResourceLocation.fromNamespaceAndPath("patchouli", "quest"), PageQuest.class);
   }
