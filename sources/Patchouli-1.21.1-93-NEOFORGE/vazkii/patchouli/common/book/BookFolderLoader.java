   ...
   private static void setup() {
      ...
      if (!loadDir.exists()) {
         ...
         throw new RuntimeException(
            loadDir.getAbsolutePath() + " is a file, not a folder, aborting. Please delete this file or move it elsewhere if it has important contents."
         );
      }
   }
   ...
   public static void findBooks() {
      ...
      if (subdirs == null) {
         ...
         for (File dir : subdirs) {
            ...
            try {
               res = ResourceLocation.fromNamespaceAndPath("patchouli", dir.getName());
