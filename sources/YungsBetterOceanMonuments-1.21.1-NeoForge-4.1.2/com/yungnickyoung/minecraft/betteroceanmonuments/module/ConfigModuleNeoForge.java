...
public class ConfigModuleNeoForge {
   public static void init(ModContainer container) {
      container.registerConfig(Type.COMMON, BOMConfigForge.SPEC, "betteroceanmonuments-neoforge-1_21.toml");
   ...
   private static void bakeConfig() {
      BetterOceanMonumentsCommon.CONFIG.general.disableVanillaMonuments = (Boolean)BOMConfigForge.general.disableVanillaMonuments.get();
   }
}
