...
public class SlashParticleEffect implements ParticleOptions {
   ...
   public SlashParticleEffect(
      ParticleType<SlashParticleEffect> type, float scale, float pitch, float yaw, float localYaw, float roll, boolean light, long color_rgba
   ) {
      this.type = type;
      this.scale = scale;
      this.pitch = pitch;
   ...
   public static MapCodec<SlashParticleEffect> createCodec(ParticleType<SlashParticleEffect> particleType) {
      return RecordCodecBuilder.mapCodec(
         instance -> instance.group(
            ...
            .apply(
               instance,
               (scale, pitch, yaw, localYaw, roll, light, color_rgba) -> new SlashParticleEffect(
                  particleType, scale, pitch, yaw, localYaw, roll, light, color_rgba
               )
            )
      );
   }

   public static StreamCodec<? super RegistryFriendlyByteBuf, SlashParticleEffect> createPacketCodec(ParticleType<SlashParticleEffect> particleType) {
