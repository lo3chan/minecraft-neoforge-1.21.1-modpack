...
public class GuiHelper implements IGuiHelper {
   ...
   @Override
   public IDrawableAnimated createAnimatedDrawable(
      IDrawableStatic drawable, int ticksPerCycle, IDrawableAnimated.StartDirection startDirection, boolean inverted
   ) {
   ...
   public IDrawableAnimated createAnimatedRecipeArrow(int ticksPerCycle) {
      ...
      return new DrawableCombined(this.getRecipeArrow(), animatedFill);
   }
   ...
   public IDrawableAnimated createAnimatedRecipeFlame(int ticksPerCycle) {
      ...
      return new DrawableCombined(this.getRecipeFlameEmpty(), animatedFill);
   }
   ...
   public <V> IDrawable createDrawableIngredient(IIngredientType<V> type, V ingredient) {
      ...
      ITypedIngredient<V> typedIngredient = this.ingredientManager.createTypedIngredient(type, ingredient, false).orElseThrow(() -> {
   ...
   public IScrollBoxWidget createScrollBoxWidget(IDrawable contents, int visibleHeight, int xPos, int yPos) {
      ScrollBoxRecipeWidget widget = new ScrollBoxRecipeWidget(contents.getWidth() + this.getScrollBoxScrollbarExtraWidth(), visibleHeight, xPos, yPos);
