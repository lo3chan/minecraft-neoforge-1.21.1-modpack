...
public class RecipeTransferHandlerHelper implements IRecipeTransferHandlerHelper {
   ...
   @Override
   public <C extends AbstractContainerMenu, R> IRecipeTransferHandler<C, R> createUnregisteredRecipeTransferHandler(
      IRecipeTransferInfo<C, R> recipeTransferInfo
   ) {
      ErrorUtil.checkNotNull(recipeTransferInfo, "recipeTransferInfo");
      return new BasicRecipeTransferHandler<>(this.serverConnection, this.stackHelper, this, recipeTransferInfo);
   }
