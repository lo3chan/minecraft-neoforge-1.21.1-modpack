...
public class PlayerRecipeTransferHandler implements IRecipeTransferHandler<InventoryMenu, RecipeHolder<CraftingRecipe>> {
   ...
   public PlayerRecipeTransferHandler(IRecipeTransferHandlerHelper handlerHelper) {
      ...
      IRecipeTransferInfo<InventoryMenu, RecipeHolder<CraftingRecipe>> basicRecipeTransferInfo = handlerHelper.createBasicRecipeTransferInfo(
   ...
   public IRecipeTransferError transferRecipe(
      InventoryMenu container, RecipeHolder<CraftingRecipe> recipe, IRecipeSlotsView recipeSlotsView, Player player, boolean maxTransfer, boolean doTransfer
   ) {
