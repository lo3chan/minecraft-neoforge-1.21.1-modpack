...
public final class ColorUtil {
   ...
   public static double slowPerceptualColorDistanceSquared(int color1, int color2) {
      ...
      int g = green1 - green2;
      int b = blue1 - blue2;
      double colorDistanceSquared = ((512 + redMean) * r * r >> 8) + 4 * g * g + ((767 - redMean) * b * b >> 8);
      double grey1 = (red1 + green1 + blue1) / 3.0;
      double grey2 = (red2 + green2 + blue2) / 3.0;
      double greyDistance1 = Math.abs(grey1 - red1) + Math.abs(grey1 - green1) + Math.abs(grey1 - blue1);
      double greyDistance2 = Math.abs(grey2 - red2) + Math.abs(grey2 - green2) + Math.abs(grey2 - blue2);
