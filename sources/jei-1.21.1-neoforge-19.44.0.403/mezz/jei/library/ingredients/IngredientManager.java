...
public class IngredientManager implements IIngredientManager {
   ...
   private final List<IIngredientManager.IIngredientListener> listeners = new ArrayList<>();
   ...
   public <V> IIngredientHelper<V> getIngredientHelper(V ingredient) {
      return this.<V>getIngredientTypeChecked(ingredient)
   ...
   public <V> Optional<ITypedIngredient<V>> getTypedIngredientByUid(IIngredientType<V> ingredientType, String ingredientUuid) {
      return this.registeredIngredients.getIngredientInfo(ingredientType).getIngredientByLegacyUid(ingredientUuid).flatMap(i -> {
         ITypedIngredient<V> typedIngredient = TypedIngredient.createAndFilterInvalid(this, ingredientType, (V)i, true);
