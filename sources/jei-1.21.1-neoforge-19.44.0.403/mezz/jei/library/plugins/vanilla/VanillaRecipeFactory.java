...
public class VanillaRecipeFactory implements IVanillaRecipeFactory {
   ...
   public GrindstoneRecipe createGrindstoneRecipe(
      List<ItemStack> topInputs, List<ItemStack> bottomInputs, List<ItemStack> outputs, int minXp, int maxXp, @Nullable ResourceLocation uid
   ) {
