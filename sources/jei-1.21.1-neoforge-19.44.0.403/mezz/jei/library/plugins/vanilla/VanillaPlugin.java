...
public class VanillaPlugin implements IModPlugin {
   ...
   public void registerRecipes(IRecipeRegistration registration) {
      ...
      List<RecipeHolder<CraftingRecipe>> specialCraftingRecipes = replaceSpecialCraftingRecipes(unhandledCraftingRecipes, jeiHelpers);
      ...
      List<IJeiBrewingRecipe> brewingRecipes = brewingHelper.getBrewingRecipes(
         ingredientManager, vanillaRecipeFactory, potionBrewing, this.brewingExtensionHelper
      );
   ...
   public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
      registration.addRecipeCatalysts(RecipeTypes.CRAFTING, Blocks.CRAFTING_TABLE, Blocks.CRAFTER);
      registration.addRecipeCatalysts(RecipeTypes.FUELING, Blocks.FURNACE, Blocks.SMOKER, Blocks.BLAST_FURNACE);
      registration.addRecipeCatalysts(RecipeTypes.CAMPFIRE_COOKING, Blocks.CAMPFIRE, Blocks.SOUL_CAMPFIRE);
   ...
   private static List<RecipeHolder<CraftingRecipe>> replaceSpecialCraftingRecipes(
      List<RecipeHolder<CraftingRecipe>> unhandledCraftingRecipes, IJeiHelpers jeiHelpers
   ) {
      ...
      for (RecipeHolder<CraftingRecipe> recipeHolder : unhandledCraftingRecipes) {
         ...
         if (recipe instanceof TippedArrowRecipe && !tippedArrowRecipesAdded) {
            try {
               ...
               LOGGER.error("Failed to create JEI recipes for {}", recipe.getClass(), var11);
            }
            ...
            try {
               ...
               LOGGER.error("Failed to create JEI recipes for {}", recipe.getClass(), var14);
            }
            ...
            try {
               ...
               LOGGER.error("Failed to create JEI recipes for {}", recipe.getClass(), var13);
            }
            ...
            try {
               ...
               LOGGER.error("Failed to create JEI recipes for {}", recipe.getClass(), var12);
            }
         }
      }
