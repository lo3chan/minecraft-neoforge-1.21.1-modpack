...
public class PluginAwareJeiFeatures implements IJeiFeatures {
   ...
   public void disableJeiGui() {
      LOGGER.info("JEI GUI is being disabled by {}", this.modPlugin.getPluginUid());
   ...
   public void disableInventoryEffectRendererGuiHandler() {
      LOGGER.info("JEI inventory effect renderer GUI handler is being disabled by {}", this.modPlugin.getPluginUid());
