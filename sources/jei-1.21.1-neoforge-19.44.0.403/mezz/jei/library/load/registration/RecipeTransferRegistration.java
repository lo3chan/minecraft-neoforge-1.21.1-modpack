...
public class RecipeTransferRegistration implements IRecipeTransferRegistration {
   ...
   public RecipeTransferRegistration(
      IStackHelper stackHelper, IRecipeTransferHandlerHelper handlerHelper, IJeiHelpers jeiHelpers, IConnectionToServer serverConnection
   ) {
   ...
   public <C extends AbstractContainerMenu, R> void addRecipeTransferHandler(
      ...
      IRecipeTransferInfo<C, R> recipeTransferInfo = new BasicRecipeTransferInfo<>(
         containerClass, menuType, recipeType, recipeSlotStart, recipeSlotCount, inventorySlotStart, inventorySlotCount
      );
   ...
   public <C extends AbstractContainerMenu, R> void addRecipeTransferHandler(IRecipeTransferInfo<C, R> recipeTransferInfo) {
      ...
      IRecipeTransferHandler<C, R> recipeTransferHandler = new BasicRecipeTransferHandler<>(
         this.serverConnection, this.stackHelper, this.handlerHelper, recipeTransferInfo
      );
