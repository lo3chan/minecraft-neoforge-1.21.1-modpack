...
public class JustEnoughItemsClient {
   ...
   public void register() {
      ...
      DeferredRegister<RecipeSerializer<?>> deferredRegister = DeferredRegister.create(BuiltInRegistries.RECIPE_SERIALIZER, "jei");
   ...
   private void onRegisterReloadListenerEvent(RegisterClientReloadListenersEvent event) {
      ...
      event.registerReloadListener(this.createReloadListener());
   }
