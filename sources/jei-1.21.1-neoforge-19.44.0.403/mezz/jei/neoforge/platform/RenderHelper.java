...
public class RenderHelper implements IPlatformRenderHelper {
   ...
   public Font getFontRenderer(Minecraft minecraft, ItemStack itemStack) {
      ...
      Font fontRenderer = renderProperties.getFont(itemStack, FontContext.TOOLTIP);
   ...
   @Override
   public void blitNineSlicedSprite(GuiGraphics guiGraphics, TextureAtlasSprite sprite, NineSlice scaling, int xOffset, int yOffset, int width, int height) {
