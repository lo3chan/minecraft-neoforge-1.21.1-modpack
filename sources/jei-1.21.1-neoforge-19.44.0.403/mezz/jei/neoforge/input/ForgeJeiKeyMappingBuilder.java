...
public class ForgeJeiKeyMappingBuilder extends AbstractJeiKeyMappingBuilder {
   ...
   protected IJeiKeyMappingInternal buildMouse(int mouseButton) {
      KeyMapping keyMapping = new KeyMapping(this.description, this.keyConflictContext, this.keyModifier, Type.MOUSE, mouseButton, this.category);
      return new NeoForgeJeiKeyMapping(keyMapping);
   }

   @Override
   public IJeiKeyMappingInternal buildKeyboardKey(int key) {
      KeyMapping keyMapping = new KeyMapping(this.description, this.keyConflictContext, this.keyModifier, Type.KEYSYM, key, this.category);
      return new NeoForgeJeiKeyMapping(keyMapping);
   }
}
