...
class Node<T> extends SubString {
   ...
   Node<T> getEdge(char ch) {
      return (Node<T>)this.edges.get(ch);
   }
   ...
   public String toString() {
      return "Node: edge: " + super.toString() + " size:" + this.data.size() + " Edges: " + this.edges;
   }
