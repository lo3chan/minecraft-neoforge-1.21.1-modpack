...
public interface ICraftingGridHelper {
   List<IRecipeSlotBuilder> createAndSetNamedIngredients(IRecipeLayoutBuilder var1, List<Pair<String, Ingredient>> var2, int var3, int var4);

   void createAndSetIngredients(IRecipeLayoutBuilder var1, List<Ingredient> var2, int var3, int var4);

   default List<IRecipeSlotBuilder> createAndSetNamedInputs(
      IRecipeLayoutBuilder builder, List<Pair<String, List<ItemStack>>> namedInputs, int width, int height
   ) {
      return this.createAndSetNamedInputs(builder, VanillaTypes.ITEM_STACK, namedInputs, width, height);
   }

   <T> List<IRecipeSlotBuilder> createAndSetNamedInputs(
      IRecipeLayoutBuilder var1, IIngredientType<T> var2, List<Pair<String, List<T>>> var3, int var4, int var5
   );
