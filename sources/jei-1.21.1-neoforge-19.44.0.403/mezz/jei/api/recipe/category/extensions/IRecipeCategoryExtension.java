...
public interface IRecipeCategoryExtension<T> {
   ...
   default void createRecipeExtras(
      T recipe, IRecipeExtrasBuilder builder, IRecipeSlotsView recipeSlotsView, ICraftingGridHelper craftingGridHelper, IFocusGroup focuses
   ) {
   }
   ...
   default boolean handleInput(double mouseX, double mouseY, Key input) {
      return false;
   }
}
