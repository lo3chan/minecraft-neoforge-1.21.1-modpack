...
public interface IRecipeTransferRegistration {
   ...
   <C extends AbstractContainerMenu, R> void addRecipeTransferHandler(
      Class<? extends C> var1, @Nullable MenuType<C> var2, RecipeType<R> var3, int var4, int var5, int var6, int var7
   );
   ...
   <C extends AbstractContainerMenu> void addUniversalRecipeTransferHandler(IUniversalRecipeTransferHandler<C> var1);
