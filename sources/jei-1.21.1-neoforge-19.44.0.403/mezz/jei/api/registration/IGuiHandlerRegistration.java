...
public interface IGuiHandlerRegistration {
   ...
   default <T extends AbstractContainerScreen<?>> void addRecipeClickArea(
      Class<? extends T> containerScreenClass, final int xPos, final int yPos, final int width, final int height, final RecipeType<?>... recipeTypes
   ) {
