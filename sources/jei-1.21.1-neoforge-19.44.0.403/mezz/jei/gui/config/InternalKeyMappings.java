...
public final class InternalKeyMappings implements IInternalKeyMappings {
   ...
   private static int getDefaultBookmarkTooltipFeaturesKey() {
      return Minecraft.ON_OSX ? 343 : 341;
   }
   ...
   public InternalKeyMappings(Consumer<KeyMapping> registerMethod) {
      ...
      this.toggleOverlay = overlay.createMapping("key.jei.toggleOverlay")
         .setContext(JeiKeyConflictContext.GUI)
         .setModifier(JeiKeyModifier.CONTROL_OR_COMMAND)
         .buildKeyboardKey(79)
         .register(registerMethod);
      this.focusSearch = overlay.createMapping("key.jei.focusSearch")
         .setContext(JeiKeyConflictContext.GUI)
         .setModifier(JeiKeyModifier.CONTROL_OR_COMMAND)
         .buildKeyboardKey(70)
         .register(registerMethod);
      ...
      this.toggleBookmarkOverlay = overlay.createMapping("key.jei.toggleBookmarkOverlay")
         .setContext(JeiKeyConflictContext.GUI)
         .buildUnbound()
         .register(registerMethod);
      this.bookmark = mouseHover.createMapping("key.jei.bookmark")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .buildKeyboardKey(65)
         .register(registerMethod);
      IJeiKeyMapping showRecipe1 = mouseHover.createMapping("key.jei.showRecipe")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .buildKeyboardKey(82)
         .register(registerMethod);
      IJeiKeyMapping showRecipe2 = mouseHover.createMapping("key.jei.showRecipe2")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .buildMouseLeft()
         .register(registerMethod);
      IJeiKeyMapping showUses1 = mouseHover.createMapping("key.jei.showUses")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .buildKeyboardKey(85)
         .register(registerMethod);
      IJeiKeyMapping showUses2 = mouseHover.createMapping("key.jei.showUses2")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .buildMouseRight()
         .register(registerMethod);
      this.transferRecipeBookmark = mouseHover.createMapping("key.jei.transferRecipeBookmark")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .setModifier(JeiKeyModifier.SHIFT)
         .buildMouseLeft()
         .register(registerMethod);
      this.maxTransferRecipeBookmark = mouseHover.createMapping("key.jei.maxTransferRecipeBookmark")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .setModifier(JeiKeyModifier.CONTROL_OR_COMMAND)
         .buildMouseLeft()
         .register(registerMethod);
      this.showBookmarkTooltipFeatures = mouseHover.createMapping("key.jei.showBookmarkTooltipFeatures")
         .setContext(JeiKeyConflictContext.GUI)
         .buildKeyboardKey(getDefaultBookmarkTooltipFeaturesKey())
         .register(registerMethod);
      this.quickMove = mouseHover.createMapping("key.jei.quickMove")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .setModifier(JeiKeyModifier.SHIFT)
         .buildMouseLeft()
         .register(registerMethod);
      this.shareToChat = mouseHover.createMapping("key.jei.shareToChat")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .buildUnbound()
         .register(registerMethod);
      this.hoveredClearSearchBar = search.createMapping("key.jei.clearSearchBar")
      ...
      IJeiKeyMapping cheatOneItem1 = cheat.createMapping("key.jei.cheatOneItem")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE)
         .buildMouseLeft()
         .register(registerMethod);
      IJeiKeyMapping cheatOneItem2 = cheat.createMapping("key.jei.cheatOneItem2")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE)
         .buildMouseRight()
         .register(registerMethod);
      IJeiKeyMapping cheatItemStack1 = cheat.createMapping("key.jei.cheatItemStack")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE)
         .setModifier(JeiKeyModifier.SHIFT)
         .buildMouseLeft()
         .register(registerMethod);
      IJeiKeyMapping cheatItemStack2 = cheat.createMapping("key.jei.cheatItemStack2")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE)
         .buildMouseMiddle()
         .register(registerMethod);
      this.toggleCheatModeConfigButton = hoverConfig.createMapping("key.jei.toggleCheatModeConfigButton")
      ...
      this.toggleHideIngredient = editMode.createMapping("key.jei.toggleHideIngredient")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .setModifier(JeiKeyModifier.CONTROL_OR_COMMAND)
         .buildMouseLeft()
         .register(registerMethod);
      this.toggleWildcardHideIngredient = editMode.createMapping("key.jei.toggleWildcardHideIngredient")
         .setContext(JeiKeyConflictContext.JEI_GUI_HOVER)
         .setModifier(JeiKeyModifier.CONTROL_OR_COMMAND)
         .buildMouseRight()
         .register(registerMethod);
      ...
      this.previousRecipePage = recipeCategory.createMapping("key.jei.previousRecipePage")
         .setContext(JeiKeyConflictContext.GUI)
         .buildKeyboardKey(266)
         .register(registerMethod);
      this.nextRecipePage = recipeCategory.createMapping("key.jei.nextRecipePage")
         .setContext(JeiKeyConflictContext.GUI)
         .buildKeyboardKey(267)
         .register(registerMethod);
      this.pauseRecipeCycling = recipeCategory.createMapping("key.jei.pauseRecipeCycling")
         .setContext(JeiKeyConflictContext.GUI)
         .buildKeyboardKey(340)
         .register(registerMethod);
      this.previousCategory = recipeCategory.createMapping("key.jei.previousCategory")
         .setContext(JeiKeyConflictContext.GUI)
         .setModifier(JeiKeyModifier.SHIFT)
         .buildKeyboardKey(266)
         .register(registerMethod);
      this.nextCategory = recipeCategory.createMapping("key.jei.nextCategory")
         .setContext(JeiKeyConflictContext.GUI)
         .setModifier(JeiKeyModifier.SHIFT)
         .buildKeyboardKey(267)
         .register(registerMethod);
      this.closeRecipeGui = recipeCategory.createMapping("key.jei.closeRecipeGui")
         .setContext(JeiKeyConflictContext.GUI)
         .buildKeyboardKey(256)
         .register(registerMethod);
      ...
      this.enterKey = new JeiMultiKeyMapping(
         jeiHidden.createMapping("key.jei.internal.enter.key").setContext(JeiKeyConflictContext.GUI).buildKeyboardKey(257),
         jeiHidden.createMapping("key.jei.internal.enter.key2").setContext(JeiKeyConflictContext.GUI).buildKeyboardKey(335)
      );
   }
