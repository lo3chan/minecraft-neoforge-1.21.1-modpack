...
public class GuiEventHandler {
   ...
   private void drawPostForeground(Screen screen, @Nullable IGuiProperties guiProperties, GuiGraphics guiGraphics, int mouseX, int mouseY) {
      ...
      if (guiProperties != null && screen instanceof AbstractContainerScreen<?> guiContainer) {
         ...
         this.screenHelper
            .getGuiClickableArea(guiContainer, mouseX - guiLeft, mouseY - guiTop)
   ...
   private void drawDebugInfoForScreen(Screen screen, @Nullable IGuiProperties guiProperties, GuiGraphics guiGraphics) {
      ...
      if (guiProperties != null) {
         Set<Rect2i> guiExclusionAreas = this.screenHelper.getGuiExclusionAreas(screen).collect(Collectors.toUnmodifiableSet());
         ...
         guiGraphics.fill(RenderType.gui(), guiProperties.guiLeft(), guiProperties.guiTop(), guiProperties.guiRight(), guiProperties.guiBottom(), 583846912);
