...
public final class RecipeLayoutWithButtons<R> implements IRecipeLayoutWithButtons<R> {
   ...
   private ImmutableRect2i getAbsoluteButtonArea(int buttonIndex) {
      ...
      return new ImmutableRect2i(
         buttonArea.getX() + recipeLayoutRect.getX(), buttonArea.getY() + recipeLayoutRect.getY(), buttonArea.getWidth(), buttonArea.getHeight()
      );
   }
   ...
   public IUserInputHandler createUserInputHandler() {
      ...
      inputHandlers.add(new RecipeLayoutWithButtons.RecipeLayoutUserInputHandler<>(this.recipeLayout));
      ...
      private boolean handleCopyRecipeId(IRecipeLayoutDrawable<R> recipeLayout, boolean simulate) {
         if (simulate) {
            ...
            if (registryName == null) {
               ...
               MutableComponent message = Component.translatable("jei.message.copy.recipe.id.success", new Object[]{Component.literal(recipeId)});
               if (player != null) {
                  player.displayClientMessage(message, false);
               }
