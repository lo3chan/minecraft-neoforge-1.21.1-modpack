   ...
   public static List<IRecipeCategory<?>> sortRecipeCategories(List<IRecipeCategory<?>> recipeCategories, IRecipeTransferManager recipeTransferManager) {
      ...
      if (player == null) {
         ...
         if (openContainer == null) {
            ...
            Comparator<IRecipeCategory<?>> comparator = Comparator.<IRecipeCategory<?>, Boolean>comparing(
                  r -> {
                     Optional<? extends IRecipeTransferHandler<AbstractContainerMenu, ?>> recipeTransferHandler = recipeTransferManager.getRecipeTransferHandler(
                        openContainer, (IRecipeCategory<?>)r
                     );
