...
public class JeiGuiStarter {
   ...
   public static JeiEventHandlers start(IRuntimeRegistration registration) {
      ...
      Function<List<IListElementInfo<?>>, Comparator<IListElement<?>>> sortIndexUpdater = ingredients -> IngredientSorter.sortIngredients(
         clientConfig, modNameSortingConfig, ingredientTypeSortingConfig, ingredientManager, ingredients
      );
      ...
      LookupHistory lookupHistory = new LookupHistory(
         recipeManager, ingredientManager, registryAccess, codecHelper, clientConfig.maxLookupHistoryIngredients(), lookupHistoryConfig, bookmarkCodec
      );
      ...
      BookmarkList bookmarkList = new BookmarkList(
         recipeManager, focusFactory, ingredientManager, registryAccess, bookmarkConfig, clientConfig, guiHelper, codecHelper, bookmarkFactory, bookmarkCodec
      );
      bookmarkConfig.loadBookmarks(
         recipeManager, focusFactory, guiHelper, ingredientManager, registryAccess, bookmarkList, codecHelper, bookmarkCodec, bookmarkFactory
      );
      ...
      RecipesGui recipesGui = new RecipesGui(
         recipeManager, ingredientManager, recipeTransferManager, keyMappings, focusFactory, bookmarkList, lookupHistory, guiHelper, bookmarkFactory
      );
      registration.setRecipesGui(recipesGui);
      CombinedRecipeFocusSource recipeFocusSource = new CombinedRecipeFocusSource(
         recipesGui, ingredientListOverlay, bookmarkOverlay, new GuiContainerWrapper(screenHelper)
      );
      ...
      ClientInputHandler clientInputHandler = new ClientInputHandler(
         charTypedHandlers, new ChatLinkInputHandler(recipesGui, focusUtil, screenHelper, bookmarkList), userInputRouter, dragRouter, keyMappings, screenHelper
      );
