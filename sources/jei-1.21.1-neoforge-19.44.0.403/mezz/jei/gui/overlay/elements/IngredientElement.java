...
public class IngredientElement<T> implements IElement<T> {
   ...
   public void getTooltip(
      JeiTooltip tooltip, IngredientGridTooltipHelper tooltipHelper, IIngredientRenderer<T> ingredientRenderer, IIngredientHelper<T> ingredientHelper
   ) {
      tooltipHelper.getIngredientTooltip(tooltip, this.ingredient, ingredientRenderer, ingredientHelper);
   }
