...
public class IngredientListSlot {
   ...
   public Optional<IClickableIngredientInternal<?>> getClickableIngredient() {
      return Optional.ofNullable(this.element).map(element -> new ClickableIngredientInternal<>((IElement<?>)element, this::isMouseOver, true, true));
   }

   public Optional<IDraggableIngredientInternal<?>> getDraggableIngredient() {
      return Optional.ofNullable(this.element).map(element -> new DraggableIngredientInternal<>((IElement<?>)element, this.area));
   }
