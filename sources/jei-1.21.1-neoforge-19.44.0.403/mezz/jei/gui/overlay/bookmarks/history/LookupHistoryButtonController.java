...
public class LookupHistoryButtonController implements IIconButtonController {
   ...
   public void getTooltips(ITooltipBuilder tooltip) {
      if (this.clientConfig.lookupHistoryEnabled().getValue()) {
      ...
      tooltip.add(Component.translatable("jei.tooltip.lookupHistory.usage").withStyle(ChatFormatting.ITALIC).withStyle(ChatFormatting.GRAY));
   }
   ...
   public boolean onPress(IJeiUserInput input) {
      if (!input.isSimulate()) {
         this.clientConfig.lookupHistoryEnabled().set(!this.clientConfig.lookupHistoryEnabled().getValue());
      }
