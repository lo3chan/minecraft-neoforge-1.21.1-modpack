   ...
   void sbr_qmf_analysis_32(SBR sbr, float[] input, float[][][] X, int offset, int kx) {
      ...
      for (int l = 0; l < sbr.numTimeSlotsRate; l++) {
         ...
         for (int var14 = 0; var14 < 64; var14++) {
            u[var14] = this.x[this.x_index + var14] * qmf_c[2 * var14]
               + this.x[this.x_index + var14 + 64] * qmf_c[2 * (var14 + 64)]
               + this.x[this.x_index + var14 + 128] * qmf_c[2 * (var14 + 128)]
               + this.x[this.x_index + var14 + 192] * qmf_c[2 * (var14 + 192)]
               + this.x[this.x_index + var14 + 256] * qmf_c[2 * (var14 + 256)];
         }
