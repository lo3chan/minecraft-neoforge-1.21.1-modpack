   ...
   void sbr_qmf_synthesis_32(SBR sbr, float[][][] X, float[] output) {
      ...
      for (int l = 0; l < sbr.numTimeSlotsRate; l++) {
         ...
         for (int var11 = 0; var11 < 32; var11++) {
            output[out++] = this.v[this.v_index + var11] * qmf_c[2 * var11]
               + this.v[this.v_index + 96 + var11] * qmf_c[64 + 2 * var11]
               + this.v[this.v_index + 128 + var11] * qmf_c[128 + 2 * var11]
               + this.v[this.v_index + 224 + var11] * qmf_c[192 + 2 * var11]
               + this.v[this.v_index + 256 + var11] * qmf_c[256 + 2 * var11]
               + this.v[this.v_index + 352 + var11] * qmf_c[320 + 2 * var11]
               + this.v[this.v_index + 384 + var11] * qmf_c[384 + 2 * var11]
               + this.v[this.v_index + 480 + var11] * qmf_c[448 + 2 * var11]
               + this.v[this.v_index + 512 + var11] * qmf_c[512 + 2 * var11]
               + this.v[this.v_index + 608 + var11] * qmf_c[576 + 2 * var11];
         }
   ...
   void sbr_qmf_synthesis_64(SBR sbr, float[][][] X, float[] output) {
      ...
      for (int l = 0; l < sbr.numTimeSlotsRate; l++) {
         ...
         for (int var20 = 0; var20 < 64; var20++) {
            output[out++] = this.v[pring_buffer_1 + var20 + 0] * qmf_c[var20 + 0]
               + this.v[pring_buffer_1 + var20 + 192] * qmf_c[var20 + 64]
               + this.v[pring_buffer_1 + var20 + 256] * qmf_c[var20 + 128]
               + this.v[pring_buffer_1 + var20 + 448] * qmf_c[var20 + 192]
               + this.v[pring_buffer_1 + var20 + 512] * qmf_c[var20 + 256]
               + this.v[pring_buffer_1 + var20 + 704] * qmf_c[var20 + 320]
               + this.v[pring_buffer_1 + var20 + 768] * qmf_c[var20 + 384]
               + this.v[pring_buffer_1 + var20 + 960] * qmf_c[var20 + 448]
               + this.v[pring_buffer_1 + var20 + 1024] * qmf_c[var20 + 512]
               + this.v[pring_buffer_1 + var20 + 1216] * qmf_c[var20 + 576];
         }
