   ...
   private void ps_data_decode() {
      ...
      for (int env = 0; env < this.num_env; env++) {
         ...
         this.delta_decode(
            ...
            this.iid_dt[env],
            this.nr_iid_par,
            this.iid_mode != 0 && this.iid_mode != 3 ? 1 : 2,
            -num_iid_steps,
            num_iid_steps
         );
         this.delta_decode(
            this.enable_icc, this.icc_index[env], icc_index_prev, this.icc_dt[env], this.nr_icc_par, this.icc_mode != 0 && this.icc_mode != 3 ? 1 : 2, 0, 7
         );
