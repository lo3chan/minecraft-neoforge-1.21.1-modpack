...
class MDCT implements MDCTTables {
   ...
   void processForward(float[] in, float[] out) {
      for (int k = 0; k < this.N8; k++) {
         ...
         this.buf[k][0] = this.buf[k][0] * this.N;
         this.buf[k][1] = this.buf[k][1] * this.N;
         ...
         this.buf[k + this.N8][0] = this.buf[k + this.N8][0] * this.N;
         this.buf[k + this.N8][1] = this.buf[k + this.N8][1] * this.N;
      }
