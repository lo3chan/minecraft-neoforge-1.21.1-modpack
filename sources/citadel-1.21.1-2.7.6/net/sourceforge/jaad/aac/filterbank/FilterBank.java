      ...
      switch (windowSequence) {
         ...
         case EIGHT_SHORT_SEQUENCE:
            ...
            for (int var14 = 0; var14 < this.shortLen; var14++) {
               ...
               out[this.mid + 1 * this.shortLen + var14] = overlap[this.mid + this.shortLen * 1 + var14]
                  + this.buf[this.shortLen * 1 + var14] * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var14]
                  + this.buf[this.shortLen * 2 + var14] * this.SHORT_WINDOWS[windowShape][var14];
               out[this.mid + 2 * this.shortLen + var14] = overlap[this.mid + this.shortLen * 2 + var14]
                  + this.buf[this.shortLen * 3 + var14] * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var14]
                  + this.buf[this.shortLen * 4 + var14] * this.SHORT_WINDOWS[windowShape][var14];
               out[this.mid + 3 * this.shortLen + var14] = overlap[this.mid + this.shortLen * 3 + var14]
                  + this.buf[this.shortLen * 5 + var14] * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var14]
                  + this.buf[this.shortLen * 6 + var14] * this.SHORT_WINDOWS[windowShape][var14];
               if (var14 < this.trans) {
                  out[this.mid + 4 * this.shortLen + var14] = overlap[this.mid + this.shortLen * 4 + var14]
                     + this.buf[this.shortLen * 7 + var14] * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var14]
                     + this.buf[this.shortLen * 8 + var14] * this.SHORT_WINDOWS[windowShape][var14];
               }
            }

            for (int var15 = 0; var15 < this.shortLen; var15++) {
               if (var15 >= this.trans) {
                  overlap[this.mid + 4 * this.shortLen + var15 - this.length] = this.buf[this.shortLen * 7 + var15]
                        * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var15]
                     + this.buf[this.shortLen * 8 + var15] * this.SHORT_WINDOWS[windowShape][var15];
               }

               overlap[this.mid + 5 * this.shortLen + var15 - this.length] = this.buf[this.shortLen * 9 + var15]
                     * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var15]
                  + this.buf[this.shortLen * 10 + var15] * this.SHORT_WINDOWS[windowShape][var15];
               overlap[this.mid + 6 * this.shortLen + var15 - this.length] = this.buf[this.shortLen * 11 + var15]
                     * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var15]
                  + this.buf[this.shortLen * 12 + var15] * this.SHORT_WINDOWS[windowShape][var15];
               overlap[this.mid + 7 * this.shortLen + var15 - this.length] = this.buf[this.shortLen * 13 + var15]
                     * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var15]
                  + this.buf[this.shortLen * 14 + var15] * this.SHORT_WINDOWS[windowShape][var15];
               overlap[this.mid + 8 * this.shortLen + var15 - this.length] = this.buf[this.shortLen * 15 + var15]
                  * this.SHORT_WINDOWS[windowShape][this.shortLen - 1 - var15];
            }
