...
class IMDCT implements GCConstants, IMDCTTables, Windows {
   ...
   private void imdct(float[] in, float[] out, float[] window, int n) throws AACException {
      ...
      for (int var13 = 0; var13 < n2; var13++) {
         tmp[var13] = table2[var13][0] * buf[var13][0]
            + table2[var13][1] * buf[n2 - 1 - var13][0]
            + table2[var13][2] * buf[var13][1]
            + table2[var13][3] * buf[n2 - 1 - var13][1];
         tmp[n - 1 - var13] = table2[var13][2] * buf[var13][0]
            - table2[var13][3] * buf[n2 - 1 - var13][0]
            - table2[var13][0] * buf[var13][1]
            + table2[var13][1] * buf[n2 - 1 - var13][1];
      }
