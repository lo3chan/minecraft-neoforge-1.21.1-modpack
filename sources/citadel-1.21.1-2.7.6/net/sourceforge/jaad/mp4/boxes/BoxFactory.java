...
public class BoxFactory implements BoxTypes {
      ...
      if (BOX_CLASSES.containsKey(l)) {
         ...
         if (PARAMETER.containsKey(l)) {
            ...
            try {
               ...
               LOGGER.log(Level.SEVERE, "BoxFactory: could not call constructor for " + typeToString(type), (Throwable)var10);
               box = new UnknownBox();
            }
         } else {
            try {
               ...
               LOGGER.log(Level.SEVERE, "BoxFactory: could not instantiate box " + typeToString(type), (Throwable)var9);
            }
         }
      }
   ...
   public static String typeToString(long l) {
      byte[] b = new byte[]{(byte)(l >> 24 & 255L), (byte)(l >> 16 & 255L), (byte)(l >> 8 & 255L), (byte)(l & 255L)};
      return new String(b);
   }
