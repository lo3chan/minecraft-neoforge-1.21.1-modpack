...
public class ProresConsts {
   ...
   public static final int[] QMAT_LUMA_APCH = new int[]{
      4,
      4,
      4,
      4,
   ...
   public static final int[] QMAT_CHROMA_APCH = new int[]{
      4,
      4,
      4,
      4,
   ...
   public static final int[] QMAT_LUMA_APCO = new int[]{
      4,
      7,
      9,
      11,
   ...
   public static final int[] QMAT_CHROMA_APCO = new int[]{
      4,
      7,
      9,
      11,
   ...
   public static final int[] QMAT_LUMA_APCN = new int[]{
      4,
      4,
      5,
      5,
   ...
   public static final int[] QMAT_CHROMA_APCN = new int[]{
      4,
      4,
      5,
      5,
   ...
   public static final int[] QMAT_LUMA_APCS = new int[]{
      4,
      5,
      6,
      7,
   ...
   public static final int[] QMAT_CHROMA_APCS = new int[]{
      4,
      5,
      6,
      7,
   ...
   public static class FrameHeader {
      ...
      public FrameHeader(
         int frameSize, int width, int height, int frameType, boolean topFieldFirst, int[] scan, int[] qMatLuma, int[] qMatChroma, int chromaType
      ) {
