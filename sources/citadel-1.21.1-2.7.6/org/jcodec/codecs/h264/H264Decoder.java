...
public class H264Decoder extends VideoDecoder {
   ...
   public static Frame createFrame(
      SeqParameterSet sps, byte[][] buffer, int frameNum, SliceType frameType, H264Utils.MvList2D mvs, Frame[][][] refsUsed, int POC
   ) {
   ...
   static class FrameDecoder {
      ...
      private Frame init(SliceReader sliceReader, byte[][] buffer) {
         ...
         Frame result = H264Decoder.createFrame(
            this.activeSps,
            buffer,
            this.firstSliceHeader.frameNum,
            this.firstSliceHeader.sliceType,
            this.di.mvs,
            this.di.refsUsed,
