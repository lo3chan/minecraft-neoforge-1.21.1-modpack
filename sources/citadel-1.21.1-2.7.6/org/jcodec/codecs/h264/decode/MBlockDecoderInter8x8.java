...
public class MBlockDecoderInter8x8 extends MBlockDecoderBase {
   ...
   public void decode(MBlock mBlock, Frame[][] references, Picture mb, SliceType sliceType, boolean ref0) {
      ...
      if (sliceType == SliceType.P) {
         this.predict8x8P(
            mBlock, references[0], mb, ref0, mbX, mbY, leftAvailable, topAvailable, topLeftAvailable, topRightAvailable, mBlock.x, mBlock.partPreds
         );
      } else {
      ...
      MBlockDecoderUtils.mergeResidual(
         mb,
         mBlock.ac,
         mBlock.transform8x8Used ? H264Const.COMP_BLOCK_8x8_LUT : H264Const.COMP_BLOCK_4x4_LUT,
   ...
   private void predict8x8P(
      ...
      this.decodeSubMb8x8(
         ...
         mbX << 6,
         mbY << 6,
         this.s.mvTopLeft.getMv(0, 0),
         this.s.mvTop.getMv(mbX << 2, 0),
         this.s.mvTop.getMv((mbX << 2) + 1, 0),
         this.s.mvTop.getMv((mbX << 2) + 2, 0),
         this.s.mvLeft.getMv(0, 0),
         this.s.mvLeft.getMv(1, 0),
         tlAvailable,
         topAvailable,
         topAvailable,
         leftAvailable,
      ...
      this.decodeSubMb8x8(
         ...
         this.s.mvTop.getMv((mbX << 2) + 1, 0),
         this.s.mvTop.getMv((mbX << 2) + 2, 0),
         this.s.mvTop.getMv((mbX << 2) + 3, 0),
         this.s.mvTop.getMv((mbX << 2) + 4, 0),
         x.getMv(1, 0),
         x.getMv(5, 0),
         topAvailable,
         topAvailable,
      ...
      this.decodeSubMb8x8(
         ...
         x.getMv(5, 0),
         x.getMv(6, 0),
         this.s.mvLeft.getMv(2, 0),
         this.s.mvLeft.getMv(3, 0),
         leftAvailable,
         true,
         true,
         leftAvailable,
      ...
      this.decodeSubMb8x8(
         ...
         x.getMv(6, 0),
         x.getMv(7, 0),
         MBlockDecoderUtils.NULL_VECTOR,
         x.getMv(9, 0),
         x.getMv(13, 0),
         true,
         true,
   ...
   private void predict8x8B(
      ...
      for (int list = 0; list < 2; list++) {
         if (H264Const.usesList(H264Const.bPartPredModes[mBlock.pb8x8.subMbTypes[0]], list)) {
            this.decodeSubMb8x8(
               ...
               mbX << 6,
               mbY << 6,
               this.s.mvTopLeft.getMv(0, list),
               this.s.mvTop.getMv(mbX << 2, list),
               this.s.mvTop.getMv((mbX << 2) + 1, list),
               this.s.mvTop.getMv((mbX << 2) + 2, list),
               this.s.mvLeft.getMv(0, list),
               this.s.mvLeft.getMv(1, list),
               tlAvailable,
               topAvailable,
               topAvailable,
               leftAvailable,
         ...
         if (H264Const.usesList(H264Const.bPartPredModes[mBlock.pb8x8.subMbTypes[1]], list)) {
            this.decodeSubMb8x8(
               ...
               this.s.mvTop.getMv((mbX << 2) + 1, list),
               this.s.mvTop.getMv((mbX << 2) + 2, list),
               this.s.mvTop.getMv((mbX << 2) + 3, list),
               this.s.mvTop.getMv((mbX << 2) + 4, list),
               x.getMv(1, list),
               x.getMv(5, list),
               topAvailable,
               topAvailable,
         ...
         if (H264Const.usesList(H264Const.bPartPredModes[mBlock.pb8x8.subMbTypes[2]], list)) {
            this.decodeSubMb8x8(
               ...
               x.getMv(5, list),
               x.getMv(6, list),
               this.s.mvLeft.getMv(2, list),
               this.s.mvLeft.getMv(3, list),
               leftAvailable,
               true,
               true,
               leftAvailable,
      ...
      for (int ix = 0; ix < 4; ix++) {
         ...
         PredictionMerger.mergePrediction(
            this.sh,
            x.mv0R(blk4x4),
            x.mv1R(blk4x4),
            H264Const.bPartPredModes[mBlock.pb8x8.subMbTypes[ix]],
            0,
            this.mbb[0].getPlaneData(0),
            this.mbb[1].getPlaneData(0),
            H264Const.BLK_8x8_MB_OFF_LUMA[ix],
            16,
            8,
            8,
            mb.getPlaneData(0),
   ...
   private void decodeSubMb8x8(
      ...
      switch (subMbType) {
         ...
         case 1:
            this.decodeSub8x4(
               mBlock, partNo, references, offX, offY, tl, t0, tr, l0, l1, tlAvb, tAvb, trAvb, lAvb, x, i00, i01, i10, i11, refIdx, mb, off, list
            );
            break;
         case 2:
            this.decodeSub4x8(
               mBlock, partNo, references, offX, offY, tl, t0, t1, tr, l0, tlAvb, tAvb, trAvb, lAvb, x, i00, i01, i10, i11, refIdx, mb, off, list
            );
            break;
         case 3:
            this.decodeSub4x4(
               mBlock, partNo, references, offX, offY, tl, t0, t1, tr, l0, l1, tlAvb, tAvb, trAvb, lAvb, x, i00, i01, i10, i11, refIdx, mb, off, list
            );
      }
   }

   private void decodeSub8x8(
      MBlock mBlock,
      int partNo,
      Picture[] references,
      int offX,
      ...
      MBlockDecoderUtils.debugPrint(
         ...
         mvpX,
         mvpY,
         mBlock.pb8x8.mvdX1[list][partNo],
         mBlock.pb8x8.mvdY1[list][partNo],
         H264Utils.Mv.mvX(mv),
         H264Utils.Mv.mvY(mv),
         refIdx
      );
   ...
   private void decodeSub8x4(
      ...
      MBlockDecoderUtils.debugPrint(
         ...
         mBlock.pb8x8.mvdX1[list][partNo],
         mBlock.pb8x8.mvdY1[list][partNo],
         H264Utils.Mv.mvX(mv1),
         H264Utils.Mv.mvY(mv1),
         refIdx
      );
      ...
      MBlockDecoderUtils.debugPrint(
         ...
         mvpX2,
         mvpY2,
         mBlock.pb8x8.mvdX2[list][partNo],
         mBlock.pb8x8.mvdY2[list][partNo],
         H264Utils.Mv.mvX(mv2),
         H264Utils.Mv.mvY(mv2),
         refIdx
      );
   ...
   private void decodeSub4x4(
      ...
      MBlockDecoderUtils.debugPrint(
         ...
         mvpX3,
         mvpY3,
         mBlock.pb8x8.mvdX3[list][partNo],
         mBlock.pb8x8.mvdY3[list][partNo],
         H264Utils.Mv.mvX(mv3),
         H264Utils.Mv.mvY(mv3),
         refIdx
      );
      ...
      MBlockDecoderUtils.debugPrint(
         ...
         mvpX4,
         mvpY4,
         mBlock.pb8x8.mvdX4[list][partNo],
         mBlock.pb8x8.mvdY4[list][partNo],
         H264Utils.Mv.mvX(mv4),
         H264Utils.Mv.mvY(mv4),
         refIdx
      );
      ...
      this.interpolator
         .getBlockLuma(references[refIdx], mb, off + mb.getWidth() * 4 + 4, offX + H264Utils.Mv.mvX(mv4) + 16, offY + H264Utils.Mv.mvY(mv4) + 16, 4, 4);
   }
}
