...
public class MBlockDecoderInter extends MBlockDecoderBase {
   ...
   public void decode16x16(MBlock mBlock, Picture mb, Frame[][] refs, H264Const.PartPred p0) {
      ...
      for (int list = 0; list < 2; list++) {
         this.predictInter16x16(
            mBlock, this.mbb[list], refs, mbX, mbY, leftAvailable, topAvailable, topLeftAvailable, topRightAvailable, mBlock.x, xx, list, p0
         );
      }
   ...
   private void predictInter8x16(
      ...
      if (H264Const.usesList(p0, list)) {
         int mvpX1 = this.calcMVPrediction8x16Left(
         ...
         int mvpY1 = this.calcMVPrediction8x16Left(
            this.s.mvLeft.getMv(0, list),
            this.s.mvTop.getMv(mbX << 2, list),
            this.s.mvTop.getMv((mbX << 2) + 2, list),
            this.s.mvTopLeft.getMv(0, list),
      ...
      if (H264Const.usesList(p1, list)) {
         int mvpX2 = this.calcMVPrediction8x16Right(
            v1,
            this.s.mvTop.getMv((mbX << 2) + 2, list),
         ...
         int mvpY2 = this.calcMVPrediction8x16Right(
            v1,
            this.s.mvTop.getMv((mbX << 2) + 2, list),
            this.s.mvTop.getMv((mbX << 2) + 4, list),
            this.s.mvTop.getMv((mbX << 2) + 1, list),
   ...
   private void predictInter16x8(
      ...
      int r2 = -1;
      if (H264Const.usesList(p0, list)) {
         int mvpX1 = this.calcMVPrediction16x8Top(
            this.s.mvLeft.getMv(0, list),
            this.s.mvTop.getMv(mbX << 2, list),
            this.s.mvTop.getMv((mbX << 2) + 4, list),
            this.s.mvTopLeft.getMv(0, list),
         ...
         int mvpY1 = this.calcMVPrediction16x8Top(
            this.s.mvLeft.getMv(0, list),
            this.s.mvTop.getMv(mbX << 2, list),
            this.s.mvTop.getMv((mbX << 2) + 4, list),
            this.s.mvTopLeft.getMv(0, list),
      ...
      int v1 = H264Utils.Mv.packMv(mvX1, mvY1, r1);
      if (H264Const.usesList(p1, list)) {
         int mvpX2 = this.calcMVPrediction16x8Bottom(
         ...
         int mvpY2 = this.calcMVPrediction16x8Bottom(
            this.s.mvLeft.getMv(2, list),
            v1,
            MBlockDecoderUtils.NULL_VECTOR,
            this.s.mvLeft.getMv(1, list),
   ...
   public void decode16x8(MBlock mBlock, Picture mb, Frame[][] refs, H264Const.PartPred p0, H264Const.PartPred p1) {
      ...
      for (int list = 0; list < 2; list++) {
         this.predictInter16x8(
            mBlock, this.mbb[list], refs, mbX, mbY, leftAvailable, topAvailable, topLeftAvailable, topRightAvailable, xx, mBlock.x, p0, p1, list
         );
      }
   ...
   void predictInter16x16(
      ...
      if (H264Const.usesList(curPred, list)) {
         int mvpX = MBlockDecoderUtils.calcMVPredictionMedian(
            this.s.mvLeft.getMv(0, list),
            this.s.mvTop.getMv(mbX << 2, list),
            this.s.mvTop.getMv((mbX << 2) + 4, list),
            this.s.mvTopLeft.getMv(0, list),
         ...
         int mvpY = MBlockDecoderUtils.calcMVPredictionMedian(
            this.s.mvLeft.getMv(0, list),
            this.s.mvTop.getMv(mbX << 2, list),
            this.s.mvTop.getMv((mbX << 2) + 4, list),
            this.s.mvTopLeft.getMv(0, list),
   ...
   public int calcMVPrediction16x8Top(int a, int b, int c, int d, boolean aAvb, boolean bAvb, boolean cAvb, boolean dAvb, int refIdx, int comp) {
      return bAvb && H264Utils.Mv.mvRef(b) == refIdx
         ? H264Utils.Mv.mvC(b, comp)
         : MBlockDecoderUtils.calcMVPredictionMedian(a, b, c, d, aAvb, bAvb, cAvb, dAvb, refIdx, comp);
   }
   ...
   public int calcMVPrediction16x8Bottom(int a, int b, int c, int d, boolean aAvb, boolean bAvb, boolean cAvb, boolean dAvb, int refIdx, int comp) {
      return aAvb && H264Utils.Mv.mvRef(a) == refIdx
         ? H264Utils.Mv.mvC(a, comp)
         : MBlockDecoderUtils.calcMVPredictionMedian(a, b, c, d, aAvb, bAvb, cAvb, dAvb, refIdx, comp);
   }
   ...
   public int calcMVPrediction8x16Right(int a, int b, int c, int d, boolean aAvb, boolean bAvb, boolean cAvb, boolean dAvb, int refIdx, int comp) {
      ...
      return H264Utils.Mv.mvRef(lc) == refIdx
         ? H264Utils.Mv.mvC(lc, comp)
         : MBlockDecoderUtils.calcMVPredictionMedian(a, b, c, d, aAvb, bAvb, cAvb, dAvb, refIdx, comp);
   }
}
