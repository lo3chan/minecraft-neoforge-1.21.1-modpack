...
public class Intra8x8PredictionBuilder {
   ...
   public void predictVertical(
      int[] residual, boolean topLeftAvailable, boolean topRightAvailable, byte[] topLeft, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
   ...
   public void predictDiagonalDownRight(
      int[] residual, boolean topRightAvailable, byte[] topLeft, byte[] leftRow, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
   ...
   public void predictVerticalRight(
      int[] residual, boolean topRightAvailable, byte[] topLeft, byte[] leftRow, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
      this.interpolateTop(true, topRightAvailable, topLeft, topLine, mbOffX + blkX, blkY, this.topBuf);
      this.interpolateLeft(true, topLeft, leftRow, blkY, this.leftBuf);
   ...
   public void predictHorizontalDown(
      int[] residual, boolean topRightAvailable, byte[] topLeft, byte[] leftRow, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
      this.interpolateTop(true, topRightAvailable, topLeft, topLine, mbOffX + blkX, blkY, this.topBuf);
      this.interpolateLeft(true, topLeft, leftRow, blkY, this.leftBuf);
   ...
   public void predictVerticalLeft(
      int[] residual, boolean topLeftAvailable, boolean topRightAvailable, byte[] topLeft, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
      this.interpolateTop(topLeftAvailable, topRightAvailable, topLeft, topLine, mbOffX + blkX, blkY, this.topBuf);
