...
public class Intra4x4PredictionBuilder {
   ...
   public static void predictDC(
      int[] residual, boolean leftAvailable, boolean topAvailable, byte[] leftRow, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
      int val;
      if (leftAvailable && topAvailable) {
         val = leftRow[blkY]
               ...
               + leftRow[blkY + 3]
               + topLine[mbOffX + blkX]
               + topLine[mbOffX + blkX + 1]
               + topLine[mbOffX + blkX + 2]
               + topLine[mbOffX + blkX + 3]
               + 4
            >> 3;
   ...
   public static void predictDiagonalDownLeft(
      int[] residual, boolean topAvailable, boolean topRightAvailable, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
      int to = mbOffX + blkX;
   ...
   public static void predictVerticalRight(
      int[] residual,
      boolean leftAvailable,
      boolean topAvailable,
      byte[] leftRow,
   ...
   public static void predictHorizontalDown(
      int[] residual,
      boolean leftAvailable,
      boolean topAvailable,
      byte[] leftRow,
   ...
   public static void predictVerticalLeft(
      int[] residual, boolean topAvailable, boolean topRightAvailable, byte[] topLine, int mbOffX, int blkX, int blkY, byte[] pixOut
   ) {
      int to = mbOffX + blkX;
      int tr0 = topLine[to + 3];
