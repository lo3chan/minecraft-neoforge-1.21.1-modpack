...
public class MapManager {
   ...
   public Mapper getMapper(SliceHeader sh) {
      ...
      return (Mapper)(this.pps.numSliceGroupsMinus1 > 0
         ? new PrebuiltMBlockMapper(this.mbToSliceGroupMap, firstMBInSlice, this.sps.picWidthInMbsMinus1 + 1)
         : new FlatMBlockMapper(this.sps.picWidthInMbsMinus1 + 1, firstMBInSlice));
   }
}
