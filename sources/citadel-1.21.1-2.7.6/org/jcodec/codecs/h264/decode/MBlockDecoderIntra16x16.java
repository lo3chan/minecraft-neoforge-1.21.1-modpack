...
public class MBlockDecoderIntra16x16 extends MBlockDecoderBase {
   ...
   public void decode(MBlock mBlock, Picture mb) {
      ...
      Intra16x16PredictionBuilder.predictWithMode(
         mBlock.luma16x16Mode, mBlock.ac[0], leftAvailable, topAvailable, this.s.leftRow[0], this.s.topLine[0], this.s.topLeft[0], mbX << 4, mb.getPlaneData(0)
      );
