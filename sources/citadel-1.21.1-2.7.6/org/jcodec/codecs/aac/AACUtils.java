...
public class AACUtils {
   private static ChannelLabel[][] AAC_DEFAULT_CONFIGS = new ChannelLabel[][]{
      null,
      {ChannelLabel.MONO},
      ...
      {ChannelLabel.CENTER, ChannelLabel.FRONT_LEFT, ChannelLabel.FRONT_RIGHT, ChannelLabel.REAR_LEFT, ChannelLabel.REAR_RIGHT},
      {ChannelLabel.CENTER, ChannelLabel.FRONT_LEFT, ChannelLabel.FRONT_RIGHT, ChannelLabel.REAR_LEFT, ChannelLabel.REAR_RIGHT, ChannelLabel.LFE},
      {
            ChannelLabel.CENTER,
