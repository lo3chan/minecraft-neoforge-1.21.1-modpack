...
class MPEG4Bitstream {
   ...
   static int readVideoPacketHeader(
      BitReader br, MPEG4DecodingContext ctx, int addBits, boolean fcodeForwardEnabled, boolean fcodeBackwardEnabled, boolean intraDCThresholdEnabled
   ) {
   ...
   static void readInterModeCoeffs(
      BitReader br, MPEG4DecodingContext ctx, int fcode, Macroblock mb, Macroblock aboveMb, Macroblock leftMb, Macroblock aboveLeftMb, Macroblock aboveRightMb
   ) {
      if (!br.readBool()) {
         mb.coded = true;
         boolean intra = false;
   ...
   private static void readMV(
      ...
      int y,
      int k,
      Macroblock.Vector retMV,
      int fcode,
      int bound,
      Macroblock mb,
      Macroblock aboveMb,
      Macroblock leftMb,
      Macroblock aboveRightMb
   ) {
      int scaleFac = 1 << fcode - 1;
   ...
   private static void readMVInterlaced(
      BitReader br,
      MPEG4DecodingContext ctx,
      int x,
      int y,
   ...
   private static Macroblock.Vector getPMV2Interlaced(
      MPEG4DecodingContext ctx, int bound, Macroblock mb, Macroblock aboveMb, Macroblock leftMb, Macroblock aboveRightMb
   ) {
      int num_cand = 0;
      int last_cand = 1;
   ...
   private static void predictAcdc(
      MPEG4DecodingContext ctx,
      int x,
      int y,
      int block,
   ...
   private static Macroblock.Vector getPMV2(
      MPEG4DecodingContext ctx, int bound, int x, int y, int block, Macroblock mb, Macroblock aboveMb, Macroblock leftMb, Macroblock aboveRightMb
   ) {
      int num_cand = 0;
      int last_cand = 1;
      Macroblock.Vector[] pmv = new Macroblock.Vector[4];
   ...
   static void readBi(
      ...
      Macroblock mb,
      Macroblock lastMB,
      Macroblock.Vector pFMV,
      Macroblock.Vector pBMV
   ) {
      if (!br.readBool()) {
