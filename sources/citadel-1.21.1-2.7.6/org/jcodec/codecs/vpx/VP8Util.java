...
public class VP8Util {
   ...
   public static int[] pickDefaultPrediction(int intra_bmode) {
      return intra_bmode != 1 && intra_bmode != 0 && intra_bmode != 2 && intra_bmode != 3 && intra_bmode != 6 && intra_bmode != 5 && intra_bmode != 8
         ? PRED_BLOCK_127
         : PRED_BLOCK_129;
   }
   ...
   public static class QuantizationParams {
      ...
      int chromaDC;
      int chromaAC;
      public static final int[] dcQLookup = new int[]{
         4,
         5,
         6,
         7,
      ...
      public static final int[] acQLookup = new int[]{
         4,
         5,
         6,
         7,
   ...
   public static class SubblockConstants {
      ...
      public static int[][][] keyFrameSubblockModeProb = new int[][][]{
         {
