...
public class Probabilities {
   ...
   private static final int[][][] default_tx_probs = new int[][][]{
      {{0, 0, 0}, {0, 0, 0}}, {{100, 0, 0}, {66, 0, 0}}, {{20, 152, 0}, {15, 101, 0}}, {{3, 136, 37}, {5, 52, 13}}
   };
   public static final int[] default_is_inter_probs = new int[]{9, 102, 187, 225};
   public static final int[][][] kf_y_mode_probs = new int[][][]{
      {
   ...
   public static final int[][] kf_uv_mode_probs = new int[][]{
   ...
   public static final int[][] default_inter_mode_probs = new int[][]{
