...
public class WavHeader {
   static ChannelLabel[] mapping = new ChannelLabel[]{
      ...
      ChannelLabel.FRONT_CENTER_LEFT,
      ChannelLabel.FRONT_CENTER_RIGHT,
      ChannelLabel.REAR_CENTER,
      ChannelLabel.SIDE_LEFT,
      ChannelLabel.SIDE_RIGHT,
      ChannelLabel.CENTER,
      ChannelLabel.FRONT_LEFT,
      ChannelLabel.CENTER,
      ChannelLabel.FRONT_RIGHT,
      ...
      ChannelLabel.REAR_CENTER,
      ChannelLabel.REAR_RIGHT,
      ChannelLabel.STEREO_LEFT,
      ChannelLabel.STEREO_RIGHT
   };
         ...
         switch (this.fmt.numChannels) {
            ...
            case 5:
               return new ChannelLabel[]{
                  ChannelLabel.FRONT_LEFT, ChannelLabel.FRONT_RIGHT, ChannelLabel.CENTER, ChannelLabel.REAR_LEFT, ChannelLabel.REAR_RIGHT
               };
            case 6:
               return new ChannelLabel[]{
                  ChannelLabel.FRONT_LEFT, ChannelLabel.FRONT_RIGHT, ChannelLabel.CENTER, ChannelLabel.LFE, ChannelLabel.REAR_LEFT, ChannelLabel.REAR_RIGHT
               };
            case 7:
               return new ChannelLabel[]{
                  ChannelLabel.FRONT_LEFT,
   ...
   public static class FmtChunk {
      ...
      public FmtChunk(short param1, short param2, int param3, int param4, short param5, short param6) {
         ...
         // 04: aload 0
         // 05: iload 1
         // 06: putfield org/jcodec/codecs/wav/WavHeader$FmtChunk.audioFormat S
         // 09: aload 0
         // 0a: iload 2
         // 0b: putfield org/jcodec/codecs/wav/WavHeader$FmtChunk.numChannels S
         // 0e: aload 0
         // 0f: iload 3
         // 10: putfield org/jcodec/codecs/wav/WavHeader$FmtChunk.sampleRate I
         // 13: aload 0
         // 14: iload 4
         // 16: putfield org/jcodec/codecs/wav/WavHeader$FmtChunk.byteRate I
         // 19: aload 0
         // 1a: iload 5
         // 1c: putfield org/jcodec/codecs/wav/WavHeader$FmtChunk.blockAlign S
         // 1f: aload 0
         // 20: iload 6
         // 22: putfield org/jcodec/codecs/wav/WavHeader$FmtChunk.bitsPerSample S
         // 25: return
      }
