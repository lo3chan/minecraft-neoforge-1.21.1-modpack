...
public class MpaPqmf {
   ...
   private static final float[] bf32 = new float[]{
      cos1_64, cos3_64, cos5_64, cos7_64, cos9_64, cos11_64, cos13_64, cos15_64, cos17_64, cos19_64, cos21_64, cos23_64, cos25_64, cos27_64, cos29_64, cos31_64
   };
   ...
   static void computeFilter(int sampleOff, float[] samples, short[] out, int outOff, float scalefactor) {
      ...
      for (int i = 0; i < 32; i++) {
         int b = i << 4;
         float pcm_sample = (
               samples[(16 + sampleOff & 15) + dvp] * MpaConst.dp[b + 0]
                  + samples[(15 + sampleOff & 15) + dvp] * MpaConst.dp[b + 1]
                  + samples[(14 + sampleOff & 15) + dvp] * MpaConst.dp[b + 2]
                  + samples[(13 + sampleOff & 15) + dvp] * MpaConst.dp[b + 3]
                  + samples[(12 + sampleOff & 15) + dvp] * MpaConst.dp[b + 4]
                  + samples[(11 + sampleOff & 15) + dvp] * MpaConst.dp[b + 5]
                  + samples[(10 + sampleOff & 15) + dvp] * MpaConst.dp[b + 6]
                  + samples[(9 + sampleOff & 15) + dvp] * MpaConst.dp[b + 7]
                  + samples[(8 + sampleOff & 15) + dvp] * MpaConst.dp[b + 8]
                  + samples[(7 + sampleOff & 15) + dvp] * MpaConst.dp[b + 9]
                  + samples[(6 + sampleOff & 15) + dvp] * MpaConst.dp[b + 10]
                  + samples[(5 + sampleOff & 15) + dvp] * MpaConst.dp[b + 11]
                  + samples[(4 + sampleOff & 15) + dvp] * MpaConst.dp[b + 12]
                  + samples[(3 + sampleOff & 15) + dvp] * MpaConst.dp[b + 13]
                  + samples[(2 + sampleOff & 15) + dvp] * MpaConst.dp[b + 14]
                  + samples[(1 + sampleOff & 15) + dvp] * MpaConst.dp[b + 15]
            )
            * scalefactor;
