...
public class Mp3Bitstream {
   ...
   static class MP3SideInfo {
      ...
      Mp3Bitstream.Granule[][] granule = new Mp3Bitstream.Granule[][]{
         {new Mp3Bitstream.Granule(), new Mp3Bitstream.Granule()}, {new Mp3Bitstream.Granule(), new Mp3Bitstream.Granule()}
      };
   }
