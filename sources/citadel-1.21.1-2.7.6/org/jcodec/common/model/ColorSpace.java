...
public final class ColorSpace {
   ...
   public boolean matches(ColorSpace inputColor) {
      if (inputColor == this) {
         ...
         return inputColor != ANY && this != ANY
            ? (inputColor == ANY_INTERLEAVED || this == ANY_INTERLEAVED || inputColor == ANY_PLANAR || this == ANY_PLANAR) && inputColor.planar == this.planar
            : true;
      }
   }

   public Size compSize(Size size, int comp) {
      return this.compWidth[comp] == 0 && this.compHeight[comp] == 0
         ? size
         : new Size(size.getWidth() >> this.compWidth[comp], size.getHeight() >> this.compHeight[comp]);
   }
}
