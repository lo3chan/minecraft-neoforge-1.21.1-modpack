...
public class Packet {
   ...
   public static Packet createPacket(
      ByteBuffer data, long pts, int timescale, long duration, long frameNo, Packet.FrameType frameType, TapeTimecode tapeTimecode
   ) {
   ...
   public double getPtsD() {
      return (double)this.pts / this.timescale;
   }
