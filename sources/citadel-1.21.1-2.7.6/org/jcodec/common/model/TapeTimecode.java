...
public class TapeTimecode {
   ...
   public String toString() {
      return StringUtils.zeroPad2(this.hour)
         + ":"
         + StringUtils.zeroPad2(this.minute)
         + ":"
         + StringUtils.zeroPad2(this.second)
         + (this.dropFrame ? ";" : ":")
         + StringUtils.zeroPad2(this.frame);
   }
   ...
   public static TapeTimecode tapeTimecode(long frame, boolean dropFrame, int tapeFps) {
      ...
      return new TapeTimecode((short)(sec / 3600L), (byte)(sec / 60L % 60L), (byte)(sec % 60L), (byte)(frame % tapeFps), dropFrame, tapeFps);
   }
}
