...
public class BitReader {
   ...
   public int skip(int bits) {
      ...
      if (bits + this.deficit > 31) {
         ...
         if (left > 31) {
            ...
            ((Buffer)this.bb).position(this.bb.position() + skip);
            left -= skip << 3;
         }
   ...
   public void terminate() {
      ...
      ((Buffer)this.bb).position(this.bb.position() - putBack);
   }
   ...
   public void stop() {
      ((Buffer)this.bb).position(this.bb.position() - (32 - this.deficit >> 3));
   }
