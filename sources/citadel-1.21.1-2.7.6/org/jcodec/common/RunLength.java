...
public abstract class RunLength {
   ...
   public static class Integer extends RunLength {
      ...
      public Integer() {
         this.lastValue = -2147483648;
         this.values = IntArrayList.createIntArrayList();
      }

      public void add(int value) {
         if (this.lastValue == -2147483648 || this.lastValue != value) {
            if (this.lastValue != -2147483648) {
   ...
   public static class Long extends RunLength {
      ...
      public Long() {
         this.lastValue = -9223372036854775808L;
         this.values = LongArrayList.createLongArrayList();
      }

      public void add(long value) {
         if (this.lastValue == -9223372036854775808L || this.lastValue != value) {
            if (this.lastValue != -9223372036854775808L) {
               this.values.add(this.lastValue);
               this.counts.add(this.count);
               this.count = 0;
            }
