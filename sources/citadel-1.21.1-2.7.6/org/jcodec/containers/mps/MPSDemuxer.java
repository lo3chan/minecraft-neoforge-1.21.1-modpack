...
public class MPSDemuxer extends SegmentReader implements MPEGDemuxer {
   ...
   private void addToStream(PESPacket pkt) throws IOException {
      MPSDemuxer.BaseTrack pes = this.streams.get(pkt.streamId);
      if (pes == null) {
         Object var3;
         ...
         this.streams.put(pkt.streamId, (MPSDemuxer.BaseTrack)var3);
      } else {
         pes.pending(pkt);
      }
   }
   ...
   public PESPacket nextPacket(ByteBuffer out) throws IOException {
      ...
      ((Buffer)fork).limit(dup.position());
      pkt.data = fork;
      return pkt;
   }
   ...
   public static class AACTrack extends MPSDemuxer.PlainTrack {
      ...
      public Packet nextFrame() throws IOException {
         ...
         return this.audioStash.size() == 0 ? null : this.audioStash.remove(0);
      }
   }
   ...
   public static class MPEGTrack extends MPSDemuxer.BaseTrack implements ReadableByteChannel {
      ...
      private int lastSeq = -2147483648;
      ...
      public int read(ByteBuffer arg0) throws IOException {
         PESPacket pes = this._pending.size() > 0 ? this._pending.remove(0) : this.getPacket();
