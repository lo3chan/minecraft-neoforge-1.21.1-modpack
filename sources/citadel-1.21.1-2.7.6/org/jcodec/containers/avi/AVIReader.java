...
public class AVIReader {
   ...
   static class AVIChunk {
      ...
      public long getEndOfChunk() {
         return this.startOfChunk + 8L + this.getChunkSize();
      }
   ...
   static class AVITag_AVIH extends AVIReader.AVIChunk {
      ...
      public String toString() {
         ...
         return "AVIH Resolution ["
            ...
            + this.dwTotalFrames
            + "], Flags ["
            + Integer.toHexString(this.dwFlags)
            + "] - ["
            + sb.toString().trim()
            + "]";
      }
   ...
   static class AVITag_AviDmlStandardIndex extends AVIReader.AVIChunk {
      ...
      public String toString() {
         return String.format(
            ...
            this.bIndexType,
            this.bIndexSubType,
            AVIReader.toFourCC(this.dwChunkId),
            this.getStartOfChunk(),
            this.nEntriesInUse,
            this.wLongsPerEntry,
            this.getChunkSize(),
            this.dwOffset[0],
   ...
   static class AVITag_AviIndex extends AVIReader.AVIChunk {
      ...
      public String toString() {
         return String.format(
            "\tAvi Index List, StartOfChunk [%d], ChunkSize [%d], NumIndexes [%d]", this.getStartOfChunk(), this.dwChunkSize, this.getChunkSize() >> 4
         );
      }
   }
   ...
   static class AVITag_BitmapInfoHeader extends AVIReader.AVIChunk {
      ...
      public String toString() {
         return "\tCHUNK ["
            + AVIReader.toFourCC(this.dwFourCC)
            + "], BitsPerPixel ["
            + this.biBitCount
            + "], Resolution ["
            + (this.biWidth & 4294967295L)
            + " x "
            + (this.biHeight & 4294967295L)
            + "], Planes ["
            + this.biPlanes
            + "]";
      }
   ...
   static class AVITag_STRH extends AVIReader.AVIChunk {
      ...
      public String toString() {
         return "\tCHUNK ["
            + AVIReader.toFourCC(this.dwFourCC)
            + "], Type["
            + (this.fccType > 0 ? AVIReader.toFourCC(this.fccType) : "    ")
            + "], Handler ["
            + (this.fccCodecHandler > 0 ? AVIReader.toFourCC(this.fccCodecHandler) : "    ")
            + "]";
      }
   }
   ...
   static class AVITag_WaveFormatEx extends AVIReader.AVIChunk {
      ...
      public String toString() {
         return String.format(
            ...
            this.audioFormat,
            this.channels,
            Integer.toHexString(this.channelMask),
            this.mp3Flag,
            this.nSamplesPerSec,
            this.getStartOfChunk(),
            this.nBlockAlign
