...
public class FLVTag {
   ...
   public FLVTag(
      FLVTag.Type type, long position, FLVTag.TagHeader tagHeader, int pts, ByteBuffer data, boolean keyFrame, long frameNo, int streamId, int prevPacketSize
   ) {
      this.type = type;
