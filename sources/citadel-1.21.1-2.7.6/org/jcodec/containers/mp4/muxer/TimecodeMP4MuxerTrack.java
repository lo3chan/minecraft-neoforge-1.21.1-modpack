...
public class TimecodeMP4MuxerTrack extends CodecMP4MuxerTrack {
   ...
   private void outTimecodeSample() throws IOException {
      if (this.sampleDuration > 0L) {
         if (this.firstTimecode != null) {
            ...
            TimecodeSampleEntry tmcd = TimecodeSampleEntry.createTimecodeSampleEntry(
               this.firstTimecode.isDropFrame() ? 1 : 0, this._timescale, (int)(this.sampleDuration / this.tcFrames), this.fpsEstimate
            );
   ...
   private int toCounter(TapeTimecode tc, int fps) {
      ...
      if (tc.isDropFrame()) {
         long D = frames / 18000;
         long M = frames % 18000;
         frames = (int)(frames - (18L * D + 2L * ((M - 2L) / 1800L)));
      }
