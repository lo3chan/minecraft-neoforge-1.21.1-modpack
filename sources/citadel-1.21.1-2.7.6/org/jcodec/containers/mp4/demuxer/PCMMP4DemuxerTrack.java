...
public class PCMMP4DemuxerTrack extends AbstractMP4DemuxerTrack {
   ...
   public synchronized MP4Packet getNextFrame(ByteBuffer buffer) throws IOException {
      if (this.stcoInd >= this.chunkOffsets.length) {
         ...
         MP4Packet pkt = new MP4Packet(
            result,
            QTTimeUtil.mediaToEdited(this.box, ptsRem, this.movie.getTimescale()),
            this.timescale,
            (int)(this.pts - ptsRem),
            this.curFrame,
   ...
   protected void seekPointer(long frameNo) {
      ...
      while (true) {
         ...
         if (nextFrame > frameNo) {
            this.posShift = (int)((frameNo - this.curFrame) * this.getFrameSize());
   ...
   public DemuxerTrackMeta getMeta() {
      ...
      return new DemuxerTrackMeta(
         TrackType.AUDIO, Codec.codecByFourcc(this.getFourcc()), (double)this.duration / this.timescale, null, this.totalFrames, null, null, audioCodecMeta
      );
   }
}
