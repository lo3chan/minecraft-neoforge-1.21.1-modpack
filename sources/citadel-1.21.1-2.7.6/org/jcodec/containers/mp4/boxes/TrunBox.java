...
public class TrunBox extends FullBox {
   ...
   public static TrunBox.Factory copy(TrunBox other) {
      TrunBox box = createTrunBox2(
         other.sampleCount, other.dataOffset, other.firstSampleFlags, other.sampleDuration, other.sampleSize, other.sampleFlags, other.sampleCompositionOffset
      );
   ...
   public static TrunBox createTrunBox2(
      int sampleCount, int dataOffset, int firstSampleFlags, int[] sampleDuration, int[] sampleSize, int[] sampleFlags, int[] sampleCompositionOffset
   ) {
      TrunBox trun = new TrunBox(new Header(fourcc()));
      trun.sampleCount = sampleCount;
