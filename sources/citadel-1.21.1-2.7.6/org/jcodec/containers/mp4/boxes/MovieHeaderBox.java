...
public class MovieHeaderBox extends FullBox {
   ...
   public static MovieHeaderBox createMovieHeaderBox(
      int timescale, long duration, float rate, float volume, long created, long modified, int[] matrix, int nextTrackId
   ) {
   ...
   private void writeFixed88(ByteBuffer out, float volume) {
      out.putShort((short)(volume * 256.0));
   }

   private void writeFixed1616(ByteBuffer out, float rate) {
      out.putInt((int)(rate * 65536.0));
   }
}
