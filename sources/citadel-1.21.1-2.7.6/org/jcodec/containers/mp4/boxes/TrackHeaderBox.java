...
public class TrackHeaderBox extends FullBox {
   ...
   public static TrackHeaderBox createTrackHeaderBox(
      int trackId, long duration, float width, float height, long created, long modified, float volume, short layer, long altGroup, int[] matrix
   ) {
   ...
   private float readVolume(ByteBuffer input) {
      return (float)(input.getShort() / 256.0);
   }
   ...
   private void writeVolume(ByteBuffer out) {
      out.putShort((short)(this.volume * 256.0));
   }
