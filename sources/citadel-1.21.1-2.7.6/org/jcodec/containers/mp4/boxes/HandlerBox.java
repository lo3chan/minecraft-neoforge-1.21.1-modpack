...
public class HandlerBox extends FullBox {
   ...
   public static HandlerBox createHandlerBox(
      String componentType, String componentSubType, String componentManufacturer, int componentFlags, int componentFlagsMask
   ) {
   ...
   public int estimateSize() {
      return 12
         + JCodecUtil2.asciiString(this.componentType).length
         + JCodecUtil2.asciiString(this.componentSubType).length
         + JCodecUtil2.asciiString(this.componentManufacturer).length
         + 9;
   }
