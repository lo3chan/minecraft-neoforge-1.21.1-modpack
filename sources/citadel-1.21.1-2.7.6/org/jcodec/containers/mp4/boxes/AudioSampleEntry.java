...
public class AudioSampleEntry extends SampleEntry {
   ...
   protected void doWrite(ByteBuffer out) {
      ...
      if (this.version < 2) {
         ...
         out.putInt((int)Math.round(this.sampleRate * 65536.0));
         if (this.version == 1) {
   ...
   public boolean isFloat() {
      return "fl32".equals(this.header.getFourcc())
         || "fl64".equals(this.header.getFourcc())
         || "lpcm".equals(this.header.getFourcc()) && (this.lpcmFlags & kAudioFormatFlagIsFloat) != 0;
   }
   ...
   public static AudioSampleEntry compressedAudioSampleEntry(
      String fourcc, int drefId, int sampleSize, int channels, int sampleRate, int samplesPerPacket, int bytesPerPacket, int bytesPerFrame
   ) {
      return createAudioSampleEntry(
         Header.createHeader(fourcc, 0L),
         (short)drefId,
         (short)channels,
         (short)16,
         sampleRate,
