...
public class SegmentIndexBox extends FullBox {
   ...
   protected void doWrite(ByteBuffer out) {
      ...
      for (int i = 0; i < this.reference_count; i++) {
         ...
         i2 = (int)(i2 | ref.SAP_delta_time & 268435455L);
         out.putInt(i0);
         out.putInt(i1);
         out.putInt(i2);
      }
   ...
   public String toString() {
      return "SegmentIndexBox [reference_ID="
         + this.reference_ID
         + ", timescale="
         + this.timescale
         ...
         + ", references="
         + Platform.arrayToString(this.references)
         + ", version="
         + this.version
         + ", flags="
         + this.flags
   ...
   public static class Reference {
      ...
      public String toString() {
         return "Reference [reference_type="
            + this.reference_type
            + ", referenced_size="
            + this.referenced_size
            + ", subsegment_duration="
            + this.subsegment_duration
            + ", starts_with_SAP="
            + this.starts_with_SAP
            + ", SAP_type="
            + this.SAP_type
            + ", SAP_delta_time="
            + this.SAP_delta_time
