...
public class TrackFragmentHeaderBox extends FullBox {
   ...
   public static TrackFragmentHeaderBox tfhd(
      int trackId, long baseDataOffset, int sampleDescriptionIndex, int defaultSampleDuration, int defaultSampleSize, int defaultSampleFlags
   ) {
   ...
   public static TrackFragmentHeaderBox.Factory copy(TrackFragmentHeaderBox other) {
      TrackFragmentHeaderBox box = tfhd(
         other.trackId, other.baseDataOffset, other.sampleDescriptionIndex, other.defaultSampleDuration, other.defaultSampleSize, other.defaultSampleFlags
      );
