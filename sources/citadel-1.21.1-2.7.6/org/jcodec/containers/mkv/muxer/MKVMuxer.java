...
public class MKVMuxer implements Muxer {
   ...
   private EbmlMaster muxInfo() {
      ...
      createLong(master, MKVType.TimecodeScale, frameDurationInNanoseconds);
      ...
      createDouble(master, MKVType.Duration, (max + 1L) * frameDurationInNanoseconds * 1.0);
   ...
   private EbmlMaster muxTracks() {
      ...
      for (int i = 0; i < this.tracks.size(); i++) {
         ...
         createLong(trackEntryElem, MKVType.TrackNumber, track.trackNo);
         createLong(trackEntryElem, MKVType.TrackUID, track.trackNo);
         if (MKVMuxerTrack.MKVMuxerTrackType.VIDEO.equals(track.type)) {
            ...
            createLong(trackVideoElem, MKVType.PixelWidth, track.videoMeta.getSize().getWidth());
            createLong(trackVideoElem, MKVType.PixelHeight, track.videoMeta.getSize().getHeight());
