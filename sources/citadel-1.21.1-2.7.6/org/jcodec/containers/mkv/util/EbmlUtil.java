...
public class EbmlUtil {
   ...
   public static final long[] ebmlLengthMasks = new long[]{
      0L, 127L, 16256L, 2080768L, 266338304L, 34091302912L, 4363686772736L, 558551906910208L, 71494644084506624L
   };
   ...
   public static byte[] ebmlEncodeLen(long value, int length) {
      ...
      for (int idx = 0; idx < length; idx++) {
         b[length - idx - 1] = (byte)(value >>> 8 * idx & 255L);
      }
