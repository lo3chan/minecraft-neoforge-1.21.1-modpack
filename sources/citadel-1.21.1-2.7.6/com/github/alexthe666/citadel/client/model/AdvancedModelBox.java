...
public class AdvancedModelBox extends BasicModelPart {
   ...
   private void doRender(Pose p_228306_1_, VertexConsumer p_228306_2_, int p_228306_3_, int p_228306_4_, int color) {
      Matrix4f lvt_9_1_ = p_228306_1_.pose();
      Matrix3f lvt_10_1_ = p_228306_1_.normal();
      ObjectListIterator var8 = this.cubeList.iterator();

      while (var8.hasNext()) {
         TabulaModelRenderUtils.ModelBox lvt_12_1_ = (TabulaModelRenderUtils.ModelBox)var8.next();
