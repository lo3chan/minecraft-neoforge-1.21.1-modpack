...
public class CitadelShaderRenderTypes extends RenderType {
   protected static final ShaderStateShard RENDERTYPE_RAINBOW_AURA_SHADER = new ShaderStateShard(CitadelInternalShaders::getRenderTypeRainbowAura);
   protected static final OutputStateShard RAINBOW_AURA_OUTPUT = new OutputStateShard("rainbow_aura_target", () -> {
   ...
   private CitadelShaderRenderTypes(String s, VertexFormat format, Mode mode, int i, boolean b1, boolean b2, Runnable runnable1, Runnable runnable2) {
