...
public class LightningBoltData {
   ...
   public interface SegmentSpreader {
      LightningBoltData.SegmentSpreader NO_MEMORY = (perpendicularDist, randVec, maxDiff, scale, progress) -> randVec.scale(maxDiff);
   ...
   public interface SpreadFunction {
      ...
      LightningBoltData.SpreadFunction SINE = progress -> (float)Math.sin(3.141592653589793 * progress);
