   ...
   private final Container bookAccess = new Container() {
      ...
      public boolean stillValid(Player p_59588_) {
         if (CitadelLecternBlockEntity.this.level.getBlockEntity(CitadelLecternBlockEntity.this.worldPosition) != CitadelLecternBlockEntity.this) {
            ...
            return p_59588_.distanceToSqr(
                     CitadelLecternBlockEntity.this.worldPosition.getX() + 0.5,
                     CitadelLecternBlockEntity.this.worldPosition.getY() + 0.5,
                     CitadelLecternBlockEntity.this.worldPosition.getZ() + 0.5
                  )
                  > 64.0
               ? false
               : CitadelLecternBlockEntity.this.hasBook();
         }
      }
