...
public abstract class LocalTickRateModifier extends TickRateModifier {
   ...
   public LocalTickRateModifier(
      TickRateModifierType localPosition, double range, ResourceKey<Level> dimension, int durationInMasterTicks, float tickRateMultiplier
   ) {
