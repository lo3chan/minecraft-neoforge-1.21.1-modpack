...
public class LocalEntityTickRateModifier extends LocalTickRateModifier {
   ...
   public LocalEntityTickRateModifier(
      int entityId, EntityType expectedEntityType, double range, ResourceKey<Level> dimension, int durationInMasterTicks, float tickRateMultiplier
   ) {
   ...
   public LocalEntityTickRateModifier(CompoundTag tag) {
      ...
      this.expectedEntityType = (EntityType)BuiltInRegistries.ENTITY_TYPE.get(ResourceLocation.parse(tag.getString("EntityType")));
   }
   ...
   public boolean isEntityValid(Level level) {
      ...
      return entity != null
         ...
         && entity.getType().equals(this.expectedEntityType)
         && entity.isAlive()
         && (!(entity instanceof IModifiesTime) || ((IModifiesTime)entity).isTimeModificationValid(this));
   }
