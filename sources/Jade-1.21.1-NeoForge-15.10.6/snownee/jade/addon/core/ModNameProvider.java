...
public abstract class ModNameProvider implements IToggleableProvider {
   public static ModNameProvider.ForBlock getBlock() {
      return ModNameProvider.ForBlock.INSTANCE;
   }

   public static ModNameProvider.ForEntity getEntity() {
      return ModNameProvider.ForEntity.INSTANCE;
   }
   ...
   public static class ForBlock extends ModNameProvider implements IBlockComponentProvider {
      private static final ModNameProvider.ForBlock INSTANCE = new ModNameProvider.ForBlock();
   ...
   public static class ForEntity extends ModNameProvider implements IEntityComponentProvider {
      private static final ModNameProvider.ForEntity INSTANCE = new ModNameProvider.ForEntity();
