...
public enum HorseStatsProvider implements IEntityComponentProvider {
   ...
   private static Component switchText(String key, boolean showMax, double value, double max) {
      ...
      return showMax
         ? Component.translatable(key, new Object[]{Component.translatable("jade.fraction", new Object[]{valueText, DisplayHelper.dfCommas.format(max)})})
         : Component.translatable(key, new Object[]{valueText});
   }
   ...
   public void appendTooltip(ITooltip tooltip, EntityAccessor accessor, IPluginConfig config) {
      ...
      if (horse instanceof Llama llama) {
         tooltip.add(switchText("jade.llamaStrength", showMax, llama.getStrength(), 5.0));
