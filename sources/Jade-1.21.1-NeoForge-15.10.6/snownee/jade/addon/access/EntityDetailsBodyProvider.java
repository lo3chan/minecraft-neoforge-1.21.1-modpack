   ...
   public void appendTooltip(ITooltip tooltip, EntityAccessor accessor, IPluginConfig config) {
      if (config.get(JadeIds.ACCESS_ENTITY_DETAILS)) {
         ...
         if (entity instanceof TamableAnimal animal && animal.isInSittingPose()) {
            ...
            poseId = 1000;
         } else if (entity instanceof Armadillo armadillo && armadillo.getState() == ArmadilloState.ROLLING) {
            poseId = 1001;
         }
         ...
         if (poseId != Pose.STANDING.id()) {
            ...
            if (I18n.exists(key)) {
               tooltip.add(Component.translatable("jade.access.entity.pose", new Object[]{Component.translatable(key)}));
            }
         }
         ...
         if (entity instanceof Leashable leashable && leashable.isLeashed()) {
            ...
            if (holder instanceof LeashFenceKnotEntity knot) {
               ...
               tooltip.add(Component.translatable("jade.access.entity.leashed_to", new Object[]{blockState.getBlock().getName()}));
            } else if (holder != null) {
               tooltip.add(Component.translatable("jade.access.entity.leashed_to", new Object[]{holder.getName()}));
            }
         }
      }
   }
