...
public class Color {
   ...
   private static double toDegrees(String value) {
      ...
      if (value.contains("deg")) {
         ...
         return Double.parseDouble(value.replace("rad", "").trim()) * 57.29577951308232;
      } else {
         return value.contains("turn") ? Double.parseDouble(value.replace("turn", "").trim()) * 360.0 : parseDouble(value, 360.0);
      }
   }
   ...
   public boolean equals(Object o) {
      if (this == o) {
         ...
         return this.red == color.red
            ...
            && Double.compare(color.hue, this.hue) == 0
            && Double.compare(color.saturation, this.saturation) == 0
            && Double.compare(color.lightness, this.lightness) == 0
            && Double.compare(color.opacity, this.opacity) == 0;
      } else {
         return false;
      }
   }
   ...
   @Override
   public int hashCode() {
      return Objects.hash(this.red, this.green, this.blue, this.hue, this.saturation, this.lightness, this.opacity);
   }
