...
public interface IWailaClientRegistration extends PlatformWailaClientRegistration {
   ...
   <T extends Enum<T>> void addConfig(ResourceLocation var1, T var2);
   ...
   @Experimental
   void setConfigCategoryOverride(ResourceLocation var1, Component var2);

   @Experimental
   void setConfigCategoryOverride(ResourceLocation var1, List<Component> var2);

   void registerBlockIcon(IComponentProvider<BlockAccessor> var1, Class<? extends Block> var2);

   void registerBlockComponent(IComponentProvider<BlockAccessor> var1, Class<? extends Block> var2);

   void registerEntityIcon(IComponentProvider<EntityAccessor> var1, Class<? extends Entity> var2);

   void registerEntityComponent(IComponentProvider<EntityAccessor> var1, Class<? extends Entity> var2);
   ...
   default void addBeforeTooltipCollectCallback(JadeBeforeTooltipCollectCallback callback) {
      this.addBeforeTooltipCollectCallback(0, callback);
   }

   void addBeforeTooltipCollectCallback(int var1, JadeBeforeTooltipCollectCallback var2);

   Screen createPluginConfigScreen(@Nullable Screen var1, @Nullable Component var2);
   ...
   <T extends Accessor<?>> void registerAccessorHandler(Class<T> var1, AccessorClientHandler<T> var2);

   AccessorClientHandler<Accessor<?>> getAccessorHandler(Class<? extends Accessor<?>> var1);
}
