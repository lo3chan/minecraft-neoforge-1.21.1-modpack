...
public class ReplaceAquiferOverride extends AquiferOverride {
   public static final MapCodec<ReplaceAquiferOverride> CODEC = RecordCodecBuilder.mapCodec(
      builder -> builder.group(BlockState.CODEC.fieldOf("block_state").forGetter(aquiferOverride -> aquiferOverride.replaceBlockState))
