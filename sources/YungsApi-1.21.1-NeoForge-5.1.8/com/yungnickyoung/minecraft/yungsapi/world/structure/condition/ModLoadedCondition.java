...
public class ModLoadedCondition extends StructureCondition {
   public static final MapCodec<ModLoadedCondition> CODEC = RecordCodecBuilder.mapCodec(
      builder -> builder.group(Codec.STRING.fieldOf("modid").forGetter(conditon -> conditon.modId)).apply(builder, ModLoadedCondition::new)
   );
