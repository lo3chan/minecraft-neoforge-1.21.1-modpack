...
public class ModLoaderCondition extends StructureCondition {
   public static final MapCodec<ModLoaderCondition> CODEC = RecordCodecBuilder.mapCodec(
      builder -> builder.group(Codec.STRING.listOf().fieldOf("loaders").forGetter(conditon -> conditon.validLoaders)).apply(builder, ModLoaderCondition::new)
   );
