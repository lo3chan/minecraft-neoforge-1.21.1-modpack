...
public class PieceInHorizontalDirectionCondition extends StructureCondition {
   private static final ResourceLocation ALL = ResourceLocation.fromNamespaceAndPath("yungsapi", "all");
   public static final MapCodec<PieceInHorizontalDirectionCondition> CODEC = RecordCodecBuilder.mapCodec(
