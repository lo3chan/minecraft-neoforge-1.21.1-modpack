...
public class RotationCondition extends StructureCondition {
   public static final MapCodec<RotationCondition> CODEC = RecordCodecBuilder.mapCodec(
      builder -> builder.group(Rotation.CODEC.listOf().fieldOf("rotations").forGetter(conditon -> conditon.validRotations))
