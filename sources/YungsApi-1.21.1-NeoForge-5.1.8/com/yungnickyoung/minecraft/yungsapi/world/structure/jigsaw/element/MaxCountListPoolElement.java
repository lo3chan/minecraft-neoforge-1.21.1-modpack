...
public class MaxCountListPoolElement extends ListPoolElement implements IMaxCountJigsawPoolElement {
   public static final MapCodec<MaxCountListPoolElement> CODEC = RecordCodecBuilder.mapCodec(
   ...
   public MaxCountListPoolElement(List<StructurePoolElement> elements, Projection projection, String name, int maxCount) {
   ...
   public String toString() {
      return "MaxCountList["
         + this.name
         + "]["
         + ((ListPoolElementAccessor)this).getElements().stream().map(Object::toString).collect(Collectors.joining(", "))
         + "]["
         + this.maxCount
         + "]";
   }
