...
public class AltitudeCondition extends StructureCondition {
   public static final MapCodec<AltitudeCondition> CODEC = RecordCodecBuilder.mapCodec(
   ...
   public boolean passes(StructureContext ctx) {
      return this.bottomCutoffY.isPresent() && ctx.pieceMinY() < this.bottomCutoffY.get()
         ? false
         : !this.topCutoffY.isPresent() || !(ctx.pieceMaxY() > this.topCutoffY.get());
   }
}
