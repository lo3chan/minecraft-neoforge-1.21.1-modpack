...
public interface StructureConditionType<C extends StructureCondition> {
   ...
   StructureConditionType<PieceInHorizontalDirectionCondition> PIECE_IN_HORIZONTAL_DIRECTION = register(
      "piece_in_horizontal_direction", PieceInHorizontalDirectionCondition.CODEC
   );
