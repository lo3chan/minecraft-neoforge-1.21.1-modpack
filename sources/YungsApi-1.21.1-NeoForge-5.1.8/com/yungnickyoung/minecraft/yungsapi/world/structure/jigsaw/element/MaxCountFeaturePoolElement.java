...
public class MaxCountFeaturePoolElement extends FeaturePoolElement implements IMaxCountJigsawPoolElement {
   public static final MapCodec<MaxCountFeaturePoolElement> CODEC = RecordCodecBuilder.mapCodec(
   ...
   public MaxCountFeaturePoolElement(Holder<PlacedFeature> feature, Projection projection, String name, int maxCount) {
   ...
   public String toString() {
      return "MaxCountFeature["
         + this.name
         + "]["
         + BuiltInRegistries.FEATURE
            .getKey(((ConfiguredFeature)((PlacedFeature)((FeaturePoolElementAccessor)this).getFeature().value()).feature().value()).feature())
         + "]["
         + this.maxCount
         + "]";
   }
