...
public class AutoRegisterBlock extends AutoRegisterEntry<Block> {
   private Supplier<Properties> itemProperties;
   ...
   public AutoRegisterBlock withItem(Supplier<Properties> itemProperties) {
      this.itemProperties = itemProperties;
      return this;
   }

   public Supplier<Properties> getItemProperties() {
