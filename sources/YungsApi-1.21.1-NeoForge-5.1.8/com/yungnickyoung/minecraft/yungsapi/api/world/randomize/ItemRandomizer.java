...
public class ItemRandomizer {
   public static final Codec<ItemRandomizer> CODEC = RecordCodecBuilder.create(
      instance -> instance.group(
            ItemRandomizer.Entry.CODEC.listOf().fieldOf("entries").forGetter(randomizer -> randomizer.entries),
   ...
   public static ItemRandomizer from(Item... items) {
      ...
      float chance = 1.0F / items.length;
   ...
   public static class Entry {
      public static Codec<ItemRandomizer.Entry> CODEC = RecordCodecBuilder.create(
         instance -> instance.group(
            ...
            .apply(instance, ItemRandomizer.Entry::new)
      );
      public Item item;
