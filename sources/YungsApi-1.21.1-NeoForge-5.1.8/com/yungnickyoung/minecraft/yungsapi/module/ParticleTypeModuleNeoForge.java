...
public class ParticleTypeModuleNeoForge {
   public static void processEntries() {
      YungsApiNeoForge.loadingContextEventBus
         .addListener(
            YungsApiNeoForge.buildAutoRegistrar(Registries.PARTICLE_TYPE, AutoRegistrationManager.PARTICLE_TYPES, ParticleTypeModuleNeoForge::buildParticleType)
         );
   }

   private static ParticleType<?> buildParticleType(AutoRegisterField data) {
      return (ParticleType<?>)((AutoRegisterParticleType)data.object()).get();
   }
}
