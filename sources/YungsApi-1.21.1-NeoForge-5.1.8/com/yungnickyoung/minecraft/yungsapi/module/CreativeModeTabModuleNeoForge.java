...
public class CreativeModeTabModuleNeoForge {
      ...
      YungsApiNeoForge.loadingContextEventBus
         .addListener(
            YungsApiNeoForge.buildAutoRegistrar(
               Registries.CREATIVE_MODE_TAB, AutoRegistrationManager.CREATIVE_MODE_TABS, CreativeModeTabModuleNeoForge::buildCreativeTab
            )
         );
   }
   ...
   private static CreativeModeTab buildCreativeTab(AutoRegisterField data) {
      ...
      Builder creativeModeTabBuilder = CreativeModeTab.builder()
