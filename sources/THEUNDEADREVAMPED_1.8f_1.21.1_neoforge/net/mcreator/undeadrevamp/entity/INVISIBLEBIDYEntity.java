...
import net.mcreator.undeadrevamp.procedures.InvisicloogertickingProcedure;
...
public class INVISIBLEBIDYEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(INVISIBLEBIDYEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(INVISIBLEBIDYEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(INVISIBLEBIDYEntity.class, EntityDataSerializers.STRING);
   ...
   public INVISIBLEBIDYEntity(EntityType<INVISIBLEBIDYEntity> type, Level world) {
      super(type, world);
      this.xpReward = 2;
      this.setNoAi(false);
   }
   ...
   public void baseTick() {
      super.baseTick();
      InvisicloogertickingProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
   ...
   public static void init(RegisterSpawnPlacementsEvent event) {
      event.register(
         (EntityType)UndeadRevamp2ModEntities.INVISIBLEBIDY.get(),
