...
import net.mcreator.undeadrevamp.procedures.ThebeartikingProcedure;
...
public class ThebeartamerEntity extends Monster implements GeoEntity {
   public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(ThebeartamerEntity.class, EntityDataSerializers.BOOLEAN);
   public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(ThebeartamerEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(ThebeartamerEntity.class, EntityDataSerializers.STRING);
   public static final EntityDataAccessor<Integer> DATA_passorsmash = SynchedEntityData.defineId(ThebeartamerEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_pokemode = SynchedEntityData.defineId(ThebeartamerEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_pastat = SynchedEntityData.defineId(ThebeartamerEntity.class, EntityDataSerializers.INT);
   public static final EntityDataAccessor<Integer> DATA_rage = SynchedEntityData.defineId(ThebeartamerEntity.class, EntityDataSerializers.INT);
   ...
   public ThebeartamerEntity(EntityType<ThebeartamerEntity> type, Level world) {
      super(type, world);
      this.xpReward = 9;
      this.setNoAi(false);
   }
   ...
   protected void defineSynchedData(Builder builder) {
      ...
      builder.define(TEXTURE, "thebear");
   ...
   protected void registerGoals() {
      ...
      this.targetSelector.addGoal(1, (new HurtByTargetGoal(this) {
         public boolean canUse() {
            double x = ThebeartamerEntity.this.getX();
            double y = ThebeartamerEntity.this.getY();
            double z = ThebeartamerEntity.this.getZ();
            Entity entity = ThebeartamerEntity.this;
            Level world = ThebeartamerEntity.this.level();
   ...
   public void baseTick() {
      super.baseTick();
      ThebeartikingProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
      ...
      if (this.animationprocedure.equals("empty")) {
         if (event.isMoving() || !(event.getLimbSwingAmount() > -0.15F) || !(event.getLimbSwingAmount() < 0.15F)) {
            ...
            return this.isShiftKeyDown()
               ? event.setAndContinue(RawAnimation.begin().thenLoop("smash"))
