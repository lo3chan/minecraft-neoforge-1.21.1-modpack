...
public class FlightsackrightclickedProcedure {
      ...
      if (entity != null) {
         if (entity.isShiftKeyDown() && (entity instanceof Player _plr ? _plr.experienceLevel : 0) >= 4) {
            ...
            if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide()) {
               _entity.addEffect(new MobEffectInstance(MobEffects.JUMP, 250, 4));
            }

            if (entity instanceof LivingEntity _entity && !_entity.level().isClientSide()) {
               _entity.addEffect(new MobEffectInstance(MobEffects.SLOW_FALLING, 250, 0));
            }
