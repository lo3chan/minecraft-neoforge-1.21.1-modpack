...
public class FlamesackhitentityProcedure {
   public static void execute(LevelAccessor world, double x, double y, double z) {
      ...
      if (world instanceof ServerLevel _levelx) {
         Entity entityToSpawn = ((EntityType)UndeadRevamp2ModEntities.FLAME.get()).spawn(_levelx, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
