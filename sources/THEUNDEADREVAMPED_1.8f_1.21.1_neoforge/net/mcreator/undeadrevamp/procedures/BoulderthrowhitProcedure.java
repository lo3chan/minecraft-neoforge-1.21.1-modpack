...
public class BoulderthrowhitProcedure {
      ...
      if (entity != null && sourceentity != null) {
         if (sourceentity != entity) {
            ...
            if (world instanceof ServerLevel _levelx) {
               _levelx.sendParticles(ParticleTypes.LAVA, x, y, z, 25, 1.0, 2.0, 1.0, 1.0);
            }
            ...
            for (Entity entityiterator : world.getEntitiesOfClass(Entity.class, new AABB(_center, _center).inflate(3.0), e -> true)
               ...
               .toList()) {
               if (!entityiterator.getType().is(EntityTypeTags.UNDEAD) && !(entityiterator instanceof LivingEntity _livEnt4 && _livEnt4.isBlocking())) {
