...
public class SpiiterfriedeggItem extends Item {
   public SpiiterfriedeggItem() {
      super(new Properties().stacksTo(1).rarity(Rarity.COMMON).food(new Builder().nutrition(6).saturationModifier(0.7F).alwaysEdible().build()));
   }
   ...
   public void appendHoverText(ItemStack itemstack, TooltipContext context, List<Component> list, TooltipFlag flag) {
      ...
      list.add(Component.translatable("item.undead_revamp2.spiiterfriedegg.description_0"));
   }
