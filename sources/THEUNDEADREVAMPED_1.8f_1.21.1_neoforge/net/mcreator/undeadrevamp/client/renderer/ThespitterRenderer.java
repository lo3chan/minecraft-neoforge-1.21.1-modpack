...
import net.mcreator.undeadrevamp.entity.model.ThespitterModel;
...
public class ThespitterRenderer extends GeoEntityRenderer<ThespitterEntity> {
   public ThespitterRenderer(Context renderManager) {
   ...
   protected float getDeathMaxRotation(ThespitterEntity entityLivingBaseIn) {
      return 0.0F;
   }
}
