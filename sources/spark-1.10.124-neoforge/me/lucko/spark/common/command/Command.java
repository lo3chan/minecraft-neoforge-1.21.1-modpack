...
public class Command {
   ...
   private Command(
      List<String> aliases, List<Command.ArgumentInfo> arguments, Command.Executor executor, Command.TabCompleter tabCompleter, boolean allowSubCommand
   ) {
      ...
      public Component toComponent(String padding) {
         return this.requiresParameter()
            ? Component.text()
               ...
               .append(Component.text("--" + this.argumentName(), NamedTextColor.GRAY))
               .append(Component.space())
               .append(Component.text("<" + this.parameterDescription() + ">", NamedTextColor.DARK_GRAY))
               .append(Component.text("]", NamedTextColor.DARK_GRAY))
               .build()
            : Component.text()
               .content(padding)
