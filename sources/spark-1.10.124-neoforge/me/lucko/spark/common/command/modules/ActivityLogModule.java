   ...
   public Collection<Component> renderRow(Activity activity, int index) {
      ...
      reply.add(
         Component.text()
            ...
            .append(Component.text("#" + (index + 1), NamedTextColor.WHITE))
            .append(Component.text(" - ", NamedTextColor.DARK_GRAY))
            .append(Component.text(activity.getType(), NamedTextColor.YELLOW))
            .append(Component.text(" - ", NamedTextColor.DARK_GRAY))
            .append(Component.text(formatDateDiff(activity.getTime()), NamedTextColor.GRAY))
            .build()
      );
      reply.add(
         Component.text()
            ...
            .append(Component.text(activity.getUser().getName(), NamedTextColor.WHITE))
            .build()
      );
      ...
      reply.add(
         Component.text()
            .content("  ")
            .append(Component.text(Character.toUpperCase(activity.getDataType().charAt(0)) + activity.getDataType().substring(1) + ": ", NamedTextColor.GRAY))
            ...
            .executor(
               (platform, sender, resp, arguments) -> {
                  ...
                  if (log.isEmpty()) {
                     ...
                     Pagination<Activity> activityPagination = this.pagination
                        .build(
                           Component.text("Recent spark activity", NamedTextColor.GOLD),
                           this,
