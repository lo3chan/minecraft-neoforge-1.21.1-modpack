...
public class HealthModule implements CommandModule {
   ...
   private static void tps(SparkPlatform platform, CommandSender sender, CommandResponseHandler resp, Arguments arguments) {
      ...
      if (tickStatistics != null) {
         ...
         resp.replyPrefixed(
            Component.text()
               .content(" ")
               .append(StatisticFormatter.formatTps(tickStatistics.tps5Sec()))
               .append(Component.text(", "))
               .append(StatisticFormatter.formatTps(tickStatistics.tps10Sec()))
               .append(Component.text(", "))
               .append(StatisticFormatter.formatTps(tickStatistics.tps1Min()))
               .append(Component.text(", "))
               .append(StatisticFormatter.formatTps(tickStatistics.tps5Min()))
               .append(Component.text(", "))
         ...
         if (tickStatistics.isDurationSupported()) {
            ...
            resp.replyPrefixed(
               Component.text()
                  .content(" ")
                  .append(StatisticFormatter.formatTickDurations(tickStatistics.duration10Sec()))
                  .append(Component.text(";  "))
      ...
      resp.replyPrefixed(
         Component.text()
            .content(" ")
            .append(StatisticFormatter.formatCpuUsage(CpuMonitor.systemLoad10SecAvg()))
            .append(Component.text(", "))
            .append(StatisticFormatter.formatCpuUsage(CpuMonitor.systemLoad1MinAvg()))
            .append(Component.text(", "))
            .append(StatisticFormatter.formatCpuUsage(CpuMonitor.systemLoad15MinAvg()))
            .append(Component.text("  (system)", NamedTextColor.DARK_GRAY))
            .build()
      );
      resp.replyPrefixed(
         Component.text()
            ...
            .append(Component.text(", "))
            .append(StatisticFormatter.formatCpuUsage(CpuMonitor.processLoad1MinAvg()))
            .append(Component.text(", "))
            .append(StatisticFormatter.formatCpuUsage(CpuMonitor.processLoad15MinAvg()))
            .append(Component.text("  (process)", NamedTextColor.DARK_GRAY))
            .build()
      );
   }
         ...
         if (!players.isEmpty()) {
            for (String player : players) {
               ...
               if (playerPing == null) {
                  ...
                  resp.replyPrefixed(
                     Component.text()
                        .content("Player ")
                        .append(Component.text(playerPing.name(), NamedTextColor.WHITE))
                        .append(Component.text(" has "))
                        .append(StatisticFormatter.formatPingRtt(playerPing.ping()))
                        .append(Component.text(" ms ping."))
                        .build()
                  );
               }
            }
            ...
            if (summary.total() == 0 && average.getSamples() == 0) {
               ...
               resp.replyPrefixed(
                  Component.text()
                     .content(" ")
                     .append(StatisticFormatter.formatPingRtts(summary.min(), summary.median(), summary.percentile95th(), summary.max()))
                     .append(Component.text(";  "))
   ...
   private static void uploadHealthReport(SparkPlatform platform, CommandSender sender, CommandResponseHandler resp, Arguments arguments) {
      ...
      SparkProtos.HealthData.Builder data = SparkProtos.HealthData.newBuilder().setMetadata(metadata);
      ...
      try {
         String key = platform.getBytebinClient().postContent(data.build(), "application/x-spark-health").key();
         String url = platform.getViewerUrl() + key;
         resp.broadcastPrefixed(Component.text("Health report:", NamedTextColor.GOLD));
         ...
         resp.broadcastPrefixed(Component.text("An error occurred whilst uploading the data.", NamedTextColor.RED));
         platform.getPlugin().log(Level.SEVERE, "An error occurred whilst uploading data", var9);
      }
   }
   ...
   private static void addTickStats(List<Component> report, TickStatistics tickStatistics) {
      report.add(
         Component.text()
            ...
            .append(Component.text("TPS from last 5s, 10s, 1m, 5m, 15m:", NamedTextColor.GOLD))
            .build()
      );
      report.add(
         Component.text()
      ...
      if (tickStatistics.isDurationSupported()) {
         report.add(
            Component.text()
               .append(Component.text(">", NamedTextColor.DARK_GRAY, TextDecoration.BOLD))
               .append(Component.space())
               .append(Component.text("Tick durations (min/med/95%ile/max ms) from last 10s, 1m:", NamedTextColor.GOLD))
               .build()
         );
         report.add(
            Component.text()
   ...
   private static void addCpuStats(List<Component> report) {
      report.add(
         Component.text()
            .append(Component.text(">", NamedTextColor.DARK_GRAY, TextDecoration.BOLD))
            .append(Component.space())
            .append(Component.text("CPU usage from last 10s, 1m, 15m:", NamedTextColor.GOLD))
            .build()
      );
      report.add(
         Component.text()
   ...
   private static void addBasicMemoryStats(List<Component> report, MemoryMXBean memoryMXBean) {
      ...
      report.add(
         Component.text()
            .append(Component.text(">", NamedTextColor.DARK_GRAY, TextDecoration.BOLD))
            .append(Component.space())
            .append(Component.text("Memory usage:", NamedTextColor.GOLD))
            .build()
      );
      report.add(
         Component.text()
            .content("    ")
            .append(Component.text(FormatUtil.formatBytes(heapUsage.getUsed()), NamedTextColor.WHITE))
            .append(Component.space())
            .append(Component.text("/", NamedTextColor.GRAY))
            .append(Component.space())
            .append(Component.text(FormatUtil.formatBytes(heapUsage.getMax()), NamedTextColor.WHITE))
            .append(Component.text("   "))
            .append(Component.text("(", NamedTextColor.GRAY))
            .append(Component.text(FormatUtil.percent(heapUsage.getUsed(), heapUsage.getMax()), NamedTextColor.GREEN))
            .append(Component.text(")", NamedTextColor.GRAY))
            .build()
      );
   ...
   private static void addDetailedMemoryStats(List<Component> report, MemoryMXBean memoryMXBean) {
      ...
      report.add(
         Component.text()
            .append(Component.text(">", NamedTextColor.DARK_GRAY, TextDecoration.BOLD))
            .append(Component.space())
            .append(Component.text("Non-heap memory usage:", NamedTextColor.GOLD))
            .build()
      );
         ...
         if (memoryPool.getType() == MemoryType.HEAP) {
            ...
            report.add(
               Component.text()
                  .append(Component.text(">", NamedTextColor.DARK_GRAY, TextDecoration.BOLD))
                  .append(Component.space())
                  .append(Component.text(memoryPool.getName() + " pool usage:", NamedTextColor.GOLD))
                  .build()
            );
            report.add(
               Component.text()
                  .content("    ")
                  .append(Component.text(FormatUtil.formatBytes(usage.getUsed()), NamedTextColor.WHITE))
                  .append(Component.space())
                  .append(Component.text("/", NamedTextColor.GRAY))
                  .append(Component.space())
                  .append(Component.text(FormatUtil.formatBytes(usage.getMax()), NamedTextColor.WHITE))
                  .append(Component.text("   "))
                  .append(Component.text("(", NamedTextColor.GRAY))
                  .append(Component.text(FormatUtil.percent(usage.getUsed(), usage.getMax()), NamedTextColor.GREEN))
                  .append(Component.text(")", NamedTextColor.GRAY))
                  .build()
            );
            ...
            if (collectionUsage != null) {
               report.add(
                  Component.text()
                     ...
                     .append(Component.space())
                     .append(Component.text("Usage at last GC:", NamedTextColor.GRAY))
                     .append(Component.space())
                     .append(Component.text(FormatUtil.formatBytes(collectionUsage.getUsed()), NamedTextColor.WHITE))
                     .build()
               );
            }
            ...
            if (detailed || bytesPerSec > 0L || packetsPerSec > 0L) {
               averagesReport.add(
                  Component.text()
                     ...
                     .content("    ")
                     .append(FormatUtil.formatBytes(bytesPerSec, NamedTextColor.GREEN, "/s"))
                     .append(Component.text(" / "))
                     .append(Component.text(String.format(Locale.ENGLISH, "%,d", packetsPerSec), NamedTextColor.WHITE))
                     .append(Component.text(" pps "))
                     .append(
                        Component.text()
                           .color(NamedTextColor.DARK_GRAY)
                           .append(Component.text('('))
                           .append(Component.text(interfaceName + " " + direction.abbrev(), NamedTextColor.WHITE))
                           .append(Component.text(')'))
                     )
                     .build()
               );
      ...
      if (!averagesReport.isEmpty()) {
         report.add(
            Component.text()
               .append(Component.text(">", NamedTextColor.DARK_GRAY, TextDecoration.BOLD))
               .append(Component.space())
               .append(Component.text("Network usage: (system, last 15m)", NamedTextColor.GOLD))
               .build()
         );
      ...
      if (total != 0L && used != 0L) {
         report.add(
            Component.text()
               .append(Component.text(">", NamedTextColor.DARK_GRAY, TextDecoration.BOLD))
               .append(Component.space())
               .append(Component.text("Disk usage:", NamedTextColor.GOLD))
               .build()
         );
         report.add(
            Component.text()
               .content("    ")
               .append(Component.text(FormatUtil.formatBytes(used), NamedTextColor.WHITE))
               .append(Component.space())
               .append(Component.text("/", NamedTextColor.GRAY))
               .append(Component.space())
               .append(Component.text(FormatUtil.formatBytes(total), NamedTextColor.WHITE))
               .append(Component.text("   "))
               .append(Component.text("(", NamedTextColor.GRAY))
               .append(Component.text(FormatUtil.percent(used, total), NamedTextColor.GREEN))
               .append(Component.text(")", NamedTextColor.GRAY))
               .build()
         );
         report.add(Component.text().content("    ").append(StatisticFormatter.generateDiskUsageDiagram(used, total, 60)).build());
         report.add(Component.empty());
      }
   }
}
