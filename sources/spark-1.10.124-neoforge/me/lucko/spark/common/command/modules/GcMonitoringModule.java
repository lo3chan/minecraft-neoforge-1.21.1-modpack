   ...
   public void registerCommands(Consumer<Command> consumer) {
      consumer.accept(
         Command.builder()
            .aliases("gc")
            .executor(
               (platform, sender, resp, arguments) -> {
                  ...
                  report.add(
                     Component.text()
                        ...
                        .append(Component.text("Garbage Collector statistics", NamedTextColor.GOLD))
                        .build()
                  );
                  long serverUptime = System.currentTimeMillis() - platform.getServerNormalOperationStartTime();
                  Map<String, GarbageCollectorStatistics> collectorStats = GarbageCollectorStatistics.pollStatsSubtractInitial(
                     platform.getStartupGcStatistics()
                  );
                     ...
                     if (collectionCount == 0L) {
                        ...
                        report.add(
                           Component.text()
                              ...
                              .append(Component.text(" collections", NamedTextColor.GRAY))
                              .build()
                        );
                     } else {
                        ...
                        report.add(
                           Component.text()
                              .content("      ")
                              .append(Component.text(DF.format(averageCollectionTime), NamedTextColor.GOLD))
                              .append(Component.text(" ms avg", NamedTextColor.GRAY))
                              .append(Component.text(", ", NamedTextColor.DARK_GRAY))
                              .append(Component.text(collectionCount, NamedTextColor.WHITE))
                              .append(Component.text(" total collections", NamedTextColor.GRAY))
                              .build()
                        );
                        report.add(
                           Component.text()
                              .content("      ")
                              .append(Component.text(FormatUtil.formatSeconds((long)averageFrequency / 1000L), NamedTextColor.WHITE))
                              .append(Component.text(" avg frequency", NamedTextColor.GRAY))
                              .build()
                        );
                     }
                  }
         ...
         this.platform
            ...
            .executeAsync(
               () -> {
                  List<Component> report = new LinkedList<>();
                  report.add(
                     CommandResponseHandler.applyPrefix(
                        Component.text()
                           .color(NamedTextColor.GRAY)
                           .append(Component.text(gcType + " "))
                           .append(Component.text("GC", NamedTextColor.RED))
                           .append(Component.text(" lasting "))
                           .append(Component.text(GcMonitoringModule.DF.format(data.getGcInfo().getDuration()), NamedTextColor.GOLD))
                           .append(Component.text(" ms." + gcCause))
                           .build()
                     )
                  );
                        ...
                        if (diff != 0L) {
                           if (diff > 0L) {
                              report.add(
                                 Component.text()
                                    .content("  ")
                                    .append(Component.text(FormatUtil.formatBytes(diff), NamedTextColor.GOLD))
                                    .append(Component.text(" freed from ", NamedTextColor.DARK_GRAY))
                              ...
                              report.add(
                                 Component.text()
                                    .content("    ")
                                    .append(Component.text(FormatUtil.formatBytes(before.getUsed()), NamedTextColor.GRAY))
                                    .append(Component.text(" → ", NamedTextColor.DARK_GRAY))
                                    .append(Component.text(FormatUtil.formatBytes(after.getUsed()), NamedTextColor.GRAY))
                                    .append(Component.space())
                                    .append(Component.text("(", NamedTextColor.DARK_GRAY))
                                    .append(Component.text(FormatUtil.percent(diff, before.getUsed()), NamedTextColor.WHITE))
                                    .append(Component.text(")", NamedTextColor.DARK_GRAY))
                                    .build()
                              );
                           } else {
                              report.add(
                                 Component.text()
                                    .content("  ")
                                    .append(Component.text(FormatUtil.formatBytes(-diff), NamedTextColor.GOLD))
                                    .append(Component.text(" moved to ", NamedTextColor.DARK_GRAY))
                                    .append(Component.text(type, NamedTextColor.GRAY))
                                    .build()
                              );
                              report.add(
