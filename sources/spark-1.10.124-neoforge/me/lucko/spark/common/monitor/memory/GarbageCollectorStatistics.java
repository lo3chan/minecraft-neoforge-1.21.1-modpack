...
public class GarbageCollectorStatistics {
   ...
   public double getAverageCollectionTime() {
      return this.collectionCount == 0L ? 0.0 : (double)this.collectionTime / this.collectionCount;
   }

   public long getAverageCollectionFrequency(long serverUptime) {
      return this.collectionCount == 0L ? 0L : (long)(((double)serverUptime - this.collectionTime) / this.collectionCount);
   }

   public GarbageCollectorStatistics subtract(GarbageCollectorStatistics other) {
      return other != ZERO && (other.collectionCount != 0L || other.collectionTime != 0L)
         ? new GarbageCollectorStatistics(this.collectionCount - other.collectionCount, this.collectionTime - other.collectionTime)
         : this;
   }
}
