...
public class SparkTickStatistics implements TickHook.Callback, TickReporter.Callback, TickStatistics {
   ...
   private final SparkTickStatistics.TpsRollingAverage[] tpsAverages = new SparkTickStatistics.TpsRollingAverage[]{
      this.tps5Sec, this.tps10Sec, this.tps1Min, this.tps5Min, this.tps15Min
   };
   ...
   public static final class TpsRollingAverage {
      ...
      TpsRollingAverage(int size) {
         this.size = size;
         this.time = size * SparkTickStatistics.SEC_IN_NANO;
