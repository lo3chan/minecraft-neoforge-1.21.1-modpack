                        ...
                        () -> {
                           ...
                           this.sendMessage(
                              Component.text()
                                 ...
                                 .append(Component.text(DF.format(this.averageTickTimeCalc.getMax())))
                           ...
                           this.sendMessage(
                              Component.text()
                                 ...
                                 .append(Component.text(DF.format(this.averageTickTimeCalc.getMin())))
                                 .append(Component.text("ms"))
                                 .build()
                           );
                           this.sendMessage(
                              Component.text()
                                 ...
                                 .append(Component.text(DF.format(this.averageTickTimeCalc.getAverage())))
                                 .append(Component.text("ms"))
                                 .build()
                           );
                     ...
                     .executeAsync(
                        () -> this.sendMessage(
                           Component.text()
                              ...
                              .append(Component.text("#" + this.getCurrentTick(), NamedTextColor.DARK_GRAY))
            ...
            .executeAsync(
               () -> this.sendMessage(
                  Component.text()
                     ...
                     .append(Component.text(" ms. (type = " + GarbageCollectionMonitor.getGcType(data) + ")"))
                     .build()
               )
            );
      }
