...
public enum SamplerMode {
   EXECUTION(value -> value / 1000.0, 4, SparkSamplerProtos.SamplerMetadata.SamplerMode.EXECUTION),
   ALLOCATION(value -> value, 524287, SparkSamplerProtos.SamplerMetadata.SamplerMode.ALLOCATION);
