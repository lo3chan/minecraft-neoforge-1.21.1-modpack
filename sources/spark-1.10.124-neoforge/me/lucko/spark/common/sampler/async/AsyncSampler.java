      ...
      try {
         synchronized (this.currentJobMutex) {
            ...
            try {
               ...
               this.platform.getPlugin().log(Level.WARNING, "Failed to stop previous profiler job", var8);
            }
            ...
            try {
               ...
               this.platform.getPlugin().log(Level.WARNING, "Failed to measure window statistics", var7);
            }
         ...
         this.platform.getPlugin().log(Level.WARNING, "Exception occurred while rotating profiler job", var10);
      }
   }
