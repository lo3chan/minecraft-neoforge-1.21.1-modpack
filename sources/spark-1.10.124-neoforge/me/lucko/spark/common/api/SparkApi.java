...
public class SparkApi implements Spark {
   ...
   public GenericStatistic<DoubleAverageInfo, StatisticWindow.MillisPerTick> mspt() {
      final TickStatistics stats = this.platform.getTickStatistics();
      return stats != null && stats.isDurationSupported()
         ? new AbstractStatistic.Generic<DoubleAverageInfo, StatisticWindow.MillisPerTick>(
   ...
   public PlaceholderResolver placeholders() {
      return new PlaceholderResolver() {
         @Nullable
         @Override
         public String resolveLegacyFormatting(@NonNull String placeholder) {
            return SparkPlaceholder.resolveFormattingCode(SparkApi.this.platform, placeholder);
         }

         @Nullable
         @Override
         public String resolveComponentJson(@NonNull String placeholder) {
