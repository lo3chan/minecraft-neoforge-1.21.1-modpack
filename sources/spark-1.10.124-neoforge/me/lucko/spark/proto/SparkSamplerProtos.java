...
public final class SparkSamplerProtos {
   ...
   public static final class SamplerData
      extends GeneratedMessageLite<SparkSamplerProtos.SamplerData, SparkSamplerProtos.SamplerData.Builder>
      implements SparkSamplerProtos.SamplerDataOrBuilder {
      ...
      public SparkSamplerProtos.ThreadNode getThreads(int index) {
         return this.threads_.get(index);
      }
         ...
         switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{
                  ...
                  "metadata_",
                  "threads_",
                  SparkSamplerProtos.ThreadNode.class,
                  "classSources_",
                  SparkSamplerProtos.SamplerData.ClassSourcesDefaultEntryHolder.defaultEntry,
                  "methodSources_",
                  SparkSamplerProtos.SamplerData.MethodSourcesDefaultEntryHolder.defaultEntry,
                  "lineSources_",
                  SparkSamplerProtos.SamplerData.LineSourcesDefaultEntryHolder.defaultEntry,
                  "timeWindows_",
                  "timeWindowStatistics_",
                  SparkSamplerProtos.SamplerData.TimeWindowStatisticsDefaultEntryHolder.defaultEntry,
                  "channelInfo_"
               };
               String info = "\u0000\b\u0000\u0001\u0001\b\b\u0004\u0002\u0000\u0001ဉ\u0000\u0002\u001b\u00032\u00042\u00052\u0006'\u00072\bဉ\u0001";
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkSamplerProtos.SamplerData, SparkSamplerProtos.SamplerData.Builder>
         implements SparkSamplerProtos.SamplerDataOrBuilder {
         private Builder() {
   ...
   public static final class SamplerMetadata
      extends GeneratedMessageLite<SparkSamplerProtos.SamplerMetadata, SparkSamplerProtos.SamplerMetadata.Builder>
      implements SparkSamplerProtos.SamplerMetadataOrBuilder {
      private int bitField0_;
      ...
      @Override
      public SparkSamplerProtos.SamplerMetadata.SamplerEngine getSamplerEngine() {
         SparkSamplerProtos.SamplerMetadata.SamplerEngine result = SparkSamplerProtos.SamplerMetadata.SamplerEngine.forNumber(this.samplerEngine_);
         return result == null ? SparkSamplerProtos.SamplerMetadata.SamplerEngine.UNRECOGNIZED : result;
      }

      private void setSamplerEngineValue(int value) {
         this.samplerEngine_ = value;
      }

      private void setSamplerEngine(SparkSamplerProtos.SamplerMetadata.SamplerEngine value) {
         this.samplerEngine_ = value.getNumber();
      }

      private void clearSamplerEngine() {
         ...
         switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{
                  ...
                  SparkSamplerProtos.SamplerMetadata.ServerConfigurationsDefaultEntryHolder.defaultEntry,
                  "endTime_",
                  "numberOfTicks_",
                  "sources_",
                  SparkSamplerProtos.SamplerMetadata.SourcesDefaultEntryHolder.defaultEntry,
                  "extraPlatformMetadata_",
                  SparkSamplerProtos.SamplerMetadata.ExtraPlatformMetadataDefaultEntryHolder.defaultEntry,
                  "samplerMode_",
                  "samplerEngine_"
               };
               String info = "\u0000\u0010\u0000\u0001\u0001\u0010\u0010\u0003\u0000\u0000\u0001ဉ\u0000\u0002\u0002\u0003\u0004\u0004ဉ\u0001\u0005ဉ\u0002\u0006Ȉ\u0007ဉ\u0003\bဉ\u0004\tဉ\u0005\n2\u000b\u0002\f\u0004\r2\u000e2\u000f\f\u0010\f";
               return newMessageInfo(DEFAULT_INSTANCE, info, objects);
            case GET_DEFAULT_INSTANCE:
               return DEFAULT_INSTANCE;
            case GET_PARSER:
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkSamplerProtos.SamplerMetadata, SparkSamplerProtos.SamplerMetadata.Builder>
         implements SparkSamplerProtos.SamplerMetadataOrBuilder {
         private Builder() {
         ...
         public SparkSamplerProtos.SamplerMetadata.Builder putSources(String key, SparkProtos.PluginOrModMetadata value) {
            Class<?> keyClass = key.getClass();
            Class<?> valueClass = value.getClass();
            this.copyOnWrite();
         ...
         public SparkSamplerProtos.SamplerMetadata.Builder putAllSources(Map<String, SparkProtos.PluginOrModMetadata> values) {
            this.copyOnWrite();
         ...
         @Override
         public int getSamplerEngineValue() {
            return this.instance.getSamplerEngineValue();
         }

         public SparkSamplerProtos.SamplerMetadata.Builder setSamplerEngineValue(int value) {
            this.copyOnWrite();
            this.instance.setSamplerEngineValue(value);
            return this;
         }

         @Override
         public SparkSamplerProtos.SamplerMetadata.SamplerEngine getSamplerEngine() {
            return this.instance.getSamplerEngine();
         }

         public SparkSamplerProtos.SamplerMetadata.Builder setSamplerEngine(SparkSamplerProtos.SamplerMetadata.SamplerEngine value) {
            this.copyOnWrite();
            this.instance.setSamplerEngine(value);
            return this;
         }

         public SparkSamplerProtos.SamplerMetadata.Builder clearSamplerEngine() {
            this.copyOnWrite();
            this.instance.clearSamplerEngine();
            return this;
         }
      }

      public static final class DataAggregator
         extends GeneratedMessageLite<SparkSamplerProtos.SamplerMetadata.DataAggregator, SparkSamplerProtos.SamplerMetadata.DataAggregator.Builder>
         implements SparkSamplerProtos.SamplerMetadata.DataAggregatorOrBuilder {
         ...
         public SparkSamplerProtos.SamplerMetadata.DataAggregator.ThreadGrouper getThreadGrouper() {
            SparkSamplerProtos.SamplerMetadata.DataAggregator.ThreadGrouper result = SparkSamplerProtos.SamplerMetadata.DataAggregator.ThreadGrouper.forNumber(
               this.threadGrouper_
            );
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkSamplerProtos.SamplerMetadata.DataAggregator, SparkSamplerProtos.SamplerMetadata.DataAggregator.Builder>
            implements SparkSamplerProtos.SamplerMetadata.DataAggregatorOrBuilder {
            private Builder() {
            ...
            public SparkSamplerProtos.SamplerMetadata.DataAggregator.Builder setThreadGrouper(
               SparkSamplerProtos.SamplerMetadata.DataAggregator.ThreadGrouper value
            ) {
               this.copyOnWrite();
      ...
      public static enum SamplerEngine implements Internal.EnumLite {
         JAVA(0),
         ASYNC(1),
         UNRECOGNIZED(-1);
         ...
         private static final Internal.EnumLiteMap<SparkSamplerProtos.SamplerMetadata.SamplerEngine> internalValueMap = new Internal.EnumLiteMap<SparkSamplerProtos.SamplerMetadata.SamplerEngine>() {
            public SparkSamplerProtos.SamplerMetadata.SamplerEngine findValueByNumber(int number) {
               return SparkSamplerProtos.SamplerMetadata.SamplerEngine.forNumber(number);
            }
         };
         private final int value;
         ...
         @Deprecated
         public static SparkSamplerProtos.SamplerMetadata.SamplerEngine valueOf(int value) {
            return forNumber(value);
         }

         public static SparkSamplerProtos.SamplerMetadata.SamplerEngine forNumber(int value) {
            switch (value) {
               case 0:
                  return JAVA;
               case 1:
         ...
         public static Internal.EnumLiteMap<SparkSamplerProtos.SamplerMetadata.SamplerEngine> internalGetValueMap() {
            return internalValueMap;
         }

         public static Internal.EnumVerifier internalGetVerifier() {
            return SparkSamplerProtos.SamplerMetadata.SamplerEngine.SamplerEngineVerifier.INSTANCE;
         }
         ...
         private static final class SamplerEngineVerifier implements Internal.EnumVerifier {
            static final Internal.EnumVerifier INSTANCE = new SparkSamplerProtos.SamplerMetadata.SamplerEngine.SamplerEngineVerifier();

            @Override
            public boolean isInRange(int number) {
               return SparkSamplerProtos.SamplerMetadata.SamplerEngine.forNumber(number) != null;
            }
         }
      }
      ...
      public static final class ThreadDumper
         extends GeneratedMessageLite<SparkSamplerProtos.SamplerMetadata.ThreadDumper, SparkSamplerProtos.SamplerMetadata.ThreadDumper.Builder>
         implements SparkSamplerProtos.SamplerMetadata.ThreadDumperOrBuilder {
         public static final int TYPE_FIELD_NUMBER = 1;
         private int type_;
         ...
         public String getPatterns(int index) {
            return this.patterns_.get(index);
         }

         @Override
         public ByteString getPatternsBytes(int index) {
            return ByteString.copyFromUtf8(this.patterns_.get(index));
         }
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkSamplerProtos.SamplerMetadata.ThreadDumper, SparkSamplerProtos.SamplerMetadata.ThreadDumper.Builder>
            implements SparkSamplerProtos.SamplerMetadata.ThreadDumperOrBuilder {
            private Builder() {
   ...
   public interface SamplerMetadataOrBuilder extends MessageLiteOrBuilder {
      ...
      SparkSamplerProtos.SamplerMetadata.SamplerEngine getSamplerEngine();
   }

   public static final class SocketChannelInfo
      extends GeneratedMessageLite<SparkSamplerProtos.SocketChannelInfo, SparkSamplerProtos.SocketChannelInfo.Builder>
      implements SparkSamplerProtos.SocketChannelInfoOrBuilder {
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkSamplerProtos.SocketChannelInfo, SparkSamplerProtos.SocketChannelInfo.Builder>
         implements SparkSamplerProtos.SocketChannelInfoOrBuilder {
         private Builder() {
   ...
   public static final class StackTraceNode
      extends GeneratedMessageLite<SparkSamplerProtos.StackTraceNode, SparkSamplerProtos.StackTraceNode.Builder>
      implements SparkSamplerProtos.StackTraceNodeOrBuilder {
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkSamplerProtos.StackTraceNode, SparkSamplerProtos.StackTraceNode.Builder>
         implements SparkSamplerProtos.StackTraceNodeOrBuilder {
         private Builder() {
   ...
   public static final class ThreadNode
      extends GeneratedMessageLite<SparkSamplerProtos.ThreadNode, SparkSamplerProtos.ThreadNode.Builder>
      implements SparkSamplerProtos.ThreadNodeOrBuilder {
      ...
      public static SparkSamplerProtos.ThreadNode.Builder newBuilder(SparkSamplerProtos.ThreadNode prototype) {
         ...
         // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
         // java.lang.StackOverflowError
         //   at java.base/java.util.Collections$2.tryAdvance(Collections.java:4854)
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkSamplerProtos.ThreadNode, SparkSamplerProtos.ThreadNode.Builder>
         implements SparkSamplerProtos.ThreadNodeOrBuilder {
         private Builder() {
