...
public final class SparkProtos {
   ...
   public static final class CommandSenderMetadata
      extends GeneratedMessageLite<SparkProtos.CommandSenderMetadata, SparkProtos.CommandSenderMetadata.Builder>
      implements SparkProtos.CommandSenderMetadataOrBuilder {
      ...
      public static SparkProtos.CommandSenderMetadata.Builder newBuilder(SparkProtos.CommandSenderMetadata prototype) {
         ...
         //   at org.jetbrains.java.decompiler.struct.gen.VarType.hashCode(VarType.java:273)
         //
         // Bytecode:
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.CommandSenderMetadata, SparkProtos.CommandSenderMetadata.Builder>
         implements SparkProtos.CommandSenderMetadataOrBuilder {
         private Builder() {
   ...
   public static final class HealthData
      extends GeneratedMessageLite<SparkProtos.HealthData, SparkProtos.HealthData.Builder>
      implements SparkProtos.HealthDataOrBuilder {
      private int bitField0_;
      public static final int METADATA_FIELD_NUMBER = 1;
      private SparkProtos.HealthMetadata metadata_;
      ...
      private static final SparkProtos.HealthData DEFAULT_INSTANCE;
      private static volatile Parser<SparkProtos.HealthData> PARSER;
      ...
      @Override
      public SparkProtos.HealthMetadata getMetadata() {
         return this.metadata_ == null ? SparkProtos.HealthMetadata.getDefaultInstance() : this.metadata_;
      }

      private void setMetadata(SparkProtos.HealthMetadata value) {
         value.getClass();
         this.metadata_ = value;
         this.bitField0_ |= 1;
      }

      private void mergeMetadata(SparkProtos.HealthMetadata value) {
         value.getClass();
         if (this.metadata_ != null && this.metadata_ != SparkProtos.HealthMetadata.getDefaultInstance()) {
            this.metadata_ = SparkProtos.HealthMetadata.newBuilder(this.metadata_).mergeFrom(value).buildPartial();
         } else {
            this.metadata_ = value;
         }
      ...
      public static SparkProtos.HealthData parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.HealthData parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.HealthData parseFrom(ByteString data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.HealthData parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.HealthData parseFrom(byte[] data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.HealthData parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.HealthData parseFrom(InputStream input) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.HealthData parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.HealthData parseDelimitedFrom(InputStream input) throws IOException {
         return parseDelimitedFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.HealthData parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.HealthData parseFrom(CodedInputStream input) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.HealthData parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.HealthData.Builder newBuilder() {
         return DEFAULT_INSTANCE.createBuilder();
      }

      public static SparkProtos.HealthData.Builder newBuilder(SparkProtos.HealthData prototype) {
         // $VF: Couldn't be decompiled
         // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
         // java.lang.StackOverflowError
         ...
         //
         // Bytecode:
         // 0: getstatic me/lucko/spark/proto/SparkProtos$HealthData.DEFAULT_INSTANCE Lme/lucko/spark/proto/SparkProtos$HealthData;
         // 3: aload 0
         // 4: invokevirtual me/lucko/spark/proto/SparkProtos$HealthData.createBuilder (Lme/lucko/spark/lib/protobuf/GeneratedMessageLite;)Lme/lucko/spark/lib/protobuf/GeneratedMessageLite$Builder;
         // 7: checkcast me/lucko/spark/proto/SparkProtos$HealthData$Builder
         // a: areturn
      }
      ...
      protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
         switch (method) {
            case NEW_MUTABLE_INSTANCE:
               return new SparkProtos.HealthData();
            case NEW_BUILDER:
               return new SparkProtos.HealthData.Builder();
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{
                  "bitField0_", "metadata_", "timeWindowStatistics_", SparkProtos.HealthData.TimeWindowStatisticsDefaultEntryHolder.defaultEntry
               };
               String info = "\u0000\u0002\u0000\u0001\u0001\u0002\u0002\u0001\u0000\u0000\u0001ဉ\u0000\u00022";
               return newMessageInfo(DEFAULT_INSTANCE, info, objects);
            case GET_DEFAULT_INSTANCE:
               return DEFAULT_INSTANCE;
            case GET_PARSER:
               Parser<SparkProtos.HealthData> parser = PARSER;
               if (parser == null) {
                  synchronized (SparkProtos.HealthData.class) {
                     parser = PARSER;
                     if (parser == null) {
                        parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                        PARSER = parser;
      ...
      public static SparkProtos.HealthData getDefaultInstance() {
         return DEFAULT_INSTANCE;
      }

      public static Parser<SparkProtos.HealthData> parser() {
         return DEFAULT_INSTANCE.getParserForType();
      }

      static {
         SparkProtos.HealthData defaultInstance = new SparkProtos.HealthData();
         DEFAULT_INSTANCE = defaultInstance;
         GeneratedMessageLite.registerDefaultInstance(SparkProtos.HealthData.class, defaultInstance);
      }

      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.HealthData, SparkProtos.HealthData.Builder>
         implements SparkProtos.HealthDataOrBuilder {
         private Builder() {
            super(SparkProtos.HealthData.DEFAULT_INSTANCE);
         }
         ...
         public SparkProtos.HealthData.Builder setMetadata(SparkProtos.HealthMetadata value) {
            this.copyOnWrite();
            this.instance.setMetadata(value);
            return this;
         }

         public SparkProtos.HealthData.Builder setMetadata(SparkProtos.HealthMetadata.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setMetadata(builderForValue.build());
            return this;
         }

         public SparkProtos.HealthData.Builder mergeMetadata(SparkProtos.HealthMetadata value) {
            this.copyOnWrite();
            this.instance.mergeMetadata(value);
            return this;
         }

         public SparkProtos.HealthData.Builder clearMetadata() {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthData.Builder clearTimeWindowStatistics() {
            this.copyOnWrite();
            this.instance.getMutableTimeWindowStatisticsMap().clear();
            return this;
         }

         public SparkProtos.HealthData.Builder removeTimeWindowStatistics(int key) {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthData.Builder putTimeWindowStatistics(int key, SparkProtos.WindowStatistics value) {
            Class<?> valueClass = value.getClass();
            this.copyOnWrite();
         ...
         public SparkProtos.HealthData.Builder putAllTimeWindowStatistics(Map<Integer, SparkProtos.WindowStatistics> values) {
            this.copyOnWrite();
      ...
      private static final class TimeWindowStatisticsDefaultEntryHolder {
         static final MapEntryLite<Integer, SparkProtos.WindowStatistics> defaultEntry = MapEntryLite.newDefaultInstance(
            WireFormat.FieldType.INT32, 0, WireFormat.FieldType.MESSAGE, SparkProtos.WindowStatistics.getDefaultInstance()
         );
      }
   }
   ...
   public interface HealthDataOrBuilder extends MessageLiteOrBuilder {
      ...
      SparkProtos.HealthMetadata getMetadata();
   ...
   public static final class HealthMetadata
      extends GeneratedMessageLite<SparkProtos.HealthMetadata, SparkProtos.HealthMetadata.Builder>
      implements SparkProtos.HealthMetadataOrBuilder {
      private int bitField0_;
      ...
      private static final SparkProtos.HealthMetadata DEFAULT_INSTANCE;
      private static volatile Parser<SparkProtos.HealthMetadata> PARSER;
      ...
      public static SparkProtos.HealthMetadata parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.HealthMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.HealthMetadata parseFrom(ByteString data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.HealthMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.HealthMetadata parseFrom(byte[] data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.HealthMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.HealthMetadata parseFrom(InputStream input) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.HealthMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.HealthMetadata parseDelimitedFrom(InputStream input) throws IOException {
         return parseDelimitedFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.HealthMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.HealthMetadata parseFrom(CodedInputStream input) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.HealthMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.HealthMetadata.Builder newBuilder() {
         return DEFAULT_INSTANCE.createBuilder();
      }

      public static SparkProtos.HealthMetadata.Builder newBuilder(SparkProtos.HealthMetadata prototype) {
         // $VF: Couldn't be decompiled
         // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
         // java.lang.StackOverflowError
         ...
         //
         // Bytecode:
         // 0: getstatic me/lucko/spark/proto/SparkProtos$HealthMetadata.DEFAULT_INSTANCE Lme/lucko/spark/proto/SparkProtos$HealthMetadata;
         // 3: aload 0
         // 4: invokevirtual me/lucko/spark/proto/SparkProtos$HealthMetadata.createBuilder (Lme/lucko/spark/lib/protobuf/GeneratedMessageLite;)Lme/lucko/spark/lib/protobuf/GeneratedMessageLite$Builder;
         // 7: checkcast me/lucko/spark/proto/SparkProtos$HealthMetadata$Builder
         // a: areturn
      }
      ...
      protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
         switch (method) {
            case NEW_MUTABLE_INSTANCE:
               return new SparkProtos.HealthMetadata();
            case NEW_BUILDER:
               return new SparkProtos.HealthMetadata.Builder();
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{
                  "bitField0_",
                  "creator_",
                  ...
                  SparkProtos.HealthMetadata.ServerConfigurationsDefaultEntryHolder.defaultEntry,
                  "sources_",
                  SparkProtos.HealthMetadata.SourcesDefaultEntryHolder.defaultEntry,
                  "extraPlatformMetadata_",
                  SparkProtos.HealthMetadata.ExtraPlatformMetadataDefaultEntryHolder.defaultEntry
               };
            ...
            case GET_DEFAULT_INSTANCE:
               return DEFAULT_INSTANCE;
            case GET_PARSER:
               Parser<SparkProtos.HealthMetadata> parser = PARSER;
               if (parser == null) {
                  synchronized (SparkProtos.HealthMetadata.class) {
                     parser = PARSER;
                     if (parser == null) {
                        parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                        PARSER = parser;
      ...
      public static SparkProtos.HealthMetadata getDefaultInstance() {
         return DEFAULT_INSTANCE;
      }

      public static Parser<SparkProtos.HealthMetadata> parser() {
         return DEFAULT_INSTANCE.getParserForType();
      }

      static {
         SparkProtos.HealthMetadata defaultInstance = new SparkProtos.HealthMetadata();
         DEFAULT_INSTANCE = defaultInstance;
         GeneratedMessageLite.registerDefaultInstance(SparkProtos.HealthMetadata.class, defaultInstance);
      }

      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.HealthMetadata, SparkProtos.HealthMetadata.Builder>
         implements SparkProtos.HealthMetadataOrBuilder {
         private Builder() {
            super(SparkProtos.HealthMetadata.DEFAULT_INSTANCE);
         }
         ...
         public SparkProtos.HealthMetadata.Builder setCreator(SparkProtos.CommandSenderMetadata value) {
            this.copyOnWrite();
            this.instance.setCreator(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder setCreator(SparkProtos.CommandSenderMetadata.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setCreator(builderForValue.build());
            return this;
         }

         public SparkProtos.HealthMetadata.Builder mergeCreator(SparkProtos.CommandSenderMetadata value) {
            this.copyOnWrite();
            this.instance.mergeCreator(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder clearCreator() {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder setPlatformMetadata(SparkProtos.PlatformMetadata value) {
            this.copyOnWrite();
            this.instance.setPlatformMetadata(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder setPlatformMetadata(SparkProtos.PlatformMetadata.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setPlatformMetadata(builderForValue.build());
            return this;
         }

         public SparkProtos.HealthMetadata.Builder mergePlatformMetadata(SparkProtos.PlatformMetadata value) {
            this.copyOnWrite();
            this.instance.mergePlatformMetadata(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder clearPlatformMetadata() {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder setPlatformStatistics(SparkProtos.PlatformStatistics value) {
            this.copyOnWrite();
            this.instance.setPlatformStatistics(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder setPlatformStatistics(SparkProtos.PlatformStatistics.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setPlatformStatistics(builderForValue.build());
            return this;
         }

         public SparkProtos.HealthMetadata.Builder mergePlatformStatistics(SparkProtos.PlatformStatistics value) {
            this.copyOnWrite();
            this.instance.mergePlatformStatistics(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder clearPlatformStatistics() {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder setSystemStatistics(SparkProtos.SystemStatistics value) {
            this.copyOnWrite();
            this.instance.setSystemStatistics(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder setSystemStatistics(SparkProtos.SystemStatistics.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setSystemStatistics(builderForValue.build());
            return this;
         }

         public SparkProtos.HealthMetadata.Builder mergeSystemStatistics(SparkProtos.SystemStatistics value) {
            this.copyOnWrite();
            this.instance.mergeSystemStatistics(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder clearSystemStatistics() {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder setGeneratedTime(long value) {
            this.copyOnWrite();
            this.instance.setGeneratedTime(value);
            return this;
         }

         public SparkProtos.HealthMetadata.Builder clearGeneratedTime() {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder clearServerConfigurations() {
            this.copyOnWrite();
            this.instance.getMutableServerConfigurationsMap().clear();
            return this;
         }

         public SparkProtos.HealthMetadata.Builder removeServerConfigurations(String key) {
            Class<?> keyClass = key.getClass();
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder putServerConfigurations(String key, String value) {
            Class<?> keyClass = key.getClass();
            Class<?> valueClass = value.getClass();
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder putAllServerConfigurations(Map<String, String> values) {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder clearSources() {
            this.copyOnWrite();
            this.instance.getMutableSourcesMap().clear();
            return this;
         }

         public SparkProtos.HealthMetadata.Builder removeSources(String key) {
            Class<?> keyClass = key.getClass();
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder putSources(String key, SparkProtos.PluginOrModMetadata value) {
            Class<?> keyClass = key.getClass();
            Class<?> valueClass = value.getClass();
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder putAllSources(Map<String, SparkProtos.PluginOrModMetadata> values) {
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder clearExtraPlatformMetadata() {
            this.copyOnWrite();
            this.instance.getMutableExtraPlatformMetadataMap().clear();
            return this;
         }

         public SparkProtos.HealthMetadata.Builder removeExtraPlatformMetadata(String key) {
            Class<?> keyClass = key.getClass();
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder putExtraPlatformMetadata(String key, String value) {
            Class<?> keyClass = key.getClass();
            Class<?> valueClass = value.getClass();
            this.copyOnWrite();
         ...
         public SparkProtos.HealthMetadata.Builder putAllExtraPlatformMetadata(Map<String, String> values) {
            this.copyOnWrite();
   ...
   public static final class PlatformMetadata
      extends GeneratedMessageLite<SparkProtos.PlatformMetadata, SparkProtos.PlatformMetadata.Builder>
      implements SparkProtos.PlatformMetadataOrBuilder {
      public static final int TYPE_FIELD_NUMBER = 1;
      private int type_;
      public static final int NAME_FIELD_NUMBER = 2;
      private String name_ = "";
      ...
      private void setBrandBytes(ByteString value) {
         checkByteStringIsUtf8(value);
         this.brand_ = value.toStringUtf8();
      }
      ...
      protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
         switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{"type_", "name_", "version_", "minecraftVersion_", "sparkVersion_", "brand_"};
               String info = "\u0000\u0006\u0000\u0000\u0001\b\u0006\u0000\u0000\u0000\u0001\f\u0002Ȉ\u0003Ȉ\u0004Ȉ\u0007\u0004\bȈ";
               return newMessageInfo(DEFAULT_INSTANCE, info, objects);
            case GET_DEFAULT_INSTANCE:
               return DEFAULT_INSTANCE;
            case GET_PARSER:
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.PlatformMetadata, SparkProtos.PlatformMetadata.Builder>
         implements SparkProtos.PlatformMetadataOrBuilder {
         private Builder() {
         ...
         @Override
         public String getBrand() {
            return this.instance.getBrand();
         }

         @Override
         public ByteString getBrandBytes() {
            return this.instance.getBrandBytes();
         }

         public SparkProtos.PlatformMetadata.Builder setBrand(String value) {
            this.copyOnWrite();
            this.instance.setBrand(value);
            return this;
         }

         public SparkProtos.PlatformMetadata.Builder clearBrand() {
            this.copyOnWrite();
            this.instance.clearBrand();
            return this;
         }

         public SparkProtos.PlatformMetadata.Builder setBrandBytes(ByteString value) {
            this.copyOnWrite();
            this.instance.setBrandBytes(value);
            return this;
         }
      }
   ...
   public static final class PlatformStatistics
      extends GeneratedMessageLite<SparkProtos.PlatformStatistics, SparkProtos.PlatformStatistics.Builder>
      implements SparkProtos.PlatformStatisticsOrBuilder {
      private int bitField0_;
      ...
      @Override
      public SparkProtos.PlatformStatistics.OnlineMode getOnlineMode() {
         SparkProtos.PlatformStatistics.OnlineMode result = SparkProtos.PlatformStatistics.OnlineMode.forNumber(this.onlineMode_);
         return result == null ? SparkProtos.PlatformStatistics.OnlineMode.UNRECOGNIZED : result;
      }

      private void setOnlineModeValue(int value) {
         this.onlineMode_ = value;
      }

      private void setOnlineMode(SparkProtos.PlatformStatistics.OnlineMode value) {
         this.onlineMode_ = value.getNumber();
      }

      private void clearOnlineMode() {
         this.onlineMode_ = 0;
      }
         ...
         switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{
                  ...
                  "memory_",
                  "gc_",
                  SparkProtos.PlatformStatistics.GcDefaultEntryHolder.defaultEntry,
                  "uptime_",
                  "tps_",
                  "mspt_",
                  "ping_",
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics, SparkProtos.PlatformStatistics.Builder>
         implements SparkProtos.PlatformStatisticsOrBuilder {
         private Builder() {
         ...
         @Override
         public int getOnlineModeValue() {
            return this.instance.getOnlineModeValue();
         }

         public SparkProtos.PlatformStatistics.Builder setOnlineModeValue(int value) {
            this.copyOnWrite();
            this.instance.setOnlineModeValue(value);
            return this;
         }

         @Override
         public SparkProtos.PlatformStatistics.OnlineMode getOnlineMode() {
            return this.instance.getOnlineMode();
         }

         public SparkProtos.PlatformStatistics.Builder setOnlineMode(SparkProtos.PlatformStatistics.OnlineMode value) {
            this.copyOnWrite();
            this.instance.setOnlineMode(value);
            return this;
         }

         public SparkProtos.PlatformStatistics.Builder clearOnlineMode() {
            this.copyOnWrite();
            this.instance.clearOnlineMode();
            return this;
         }
      }

      public static final class Gc
         extends GeneratedMessageLite<SparkProtos.PlatformStatistics.Gc, SparkProtos.PlatformStatistics.Gc.Builder>
         implements SparkProtos.PlatformStatistics.GcOrBuilder {
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics.Gc, SparkProtos.PlatformStatistics.Gc.Builder>
            implements SparkProtos.PlatformStatistics.GcOrBuilder {
            private Builder() {
      ...
      private static final class GcDefaultEntryHolder {
         static final MapEntryLite<String, SparkProtos.PlatformStatistics.Gc> defaultEntry = MapEntryLite.newDefaultInstance(
            WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, SparkProtos.PlatformStatistics.Gc.getDefaultInstance()
         );
      }
      ...
      public static final class Memory
         extends GeneratedMessageLite<SparkProtos.PlatformStatistics.Memory, SparkProtos.PlatformStatistics.Memory.Builder>
         implements SparkProtos.PlatformStatistics.MemoryOrBuilder {
         private int bitField0_;
         public static final int HEAP_FIELD_NUMBER = 1;
         private SparkProtos.PlatformStatistics.Memory.MemoryUsage heap_;
         public static final int NON_HEAP_FIELD_NUMBER = 2;
         private SparkProtos.PlatformStatistics.Memory.MemoryUsage nonHeap_;
         public static final int POOLS_FIELD_NUMBER = 3;
         private Internal.ProtobufList<SparkProtos.PlatformStatistics.Memory.MemoryPool> pools_ = emptyProtobufList();
         ...
         @Override
         public SparkProtos.PlatformStatistics.Memory.MemoryUsage getHeap() {
            return this.heap_ == null ? SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance() : this.heap_;
         }

         private void setHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
            value.getClass();
            this.heap_ = value;
            this.bitField0_ |= 1;
         }

         private void mergeHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
            value.getClass();
            if (this.heap_ != null && this.heap_ != SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance()) {
               this.heap_ = SparkProtos.PlatformStatistics.Memory.MemoryUsage.newBuilder(this.heap_).mergeFrom(value).buildPartial();
            } else {
               this.heap_ = value;
            }
         ...
         @Override
         public SparkProtos.PlatformStatistics.Memory.MemoryUsage getNonHeap() {
            return this.nonHeap_ == null ? SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance() : this.nonHeap_;
         }

         private void setNonHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
            value.getClass();
            this.nonHeap_ = value;
            this.bitField0_ |= 2;
         }

         private void mergeNonHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
            value.getClass();
            if (this.nonHeap_ != null && this.nonHeap_ != SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance()) {
               this.nonHeap_ = SparkProtos.PlatformStatistics.Memory.MemoryUsage.newBuilder(this.nonHeap_).mergeFrom(value).buildPartial();
            } else {
               this.nonHeap_ = value;
            }
         ...
         private void clearNonHeap() {
            this.nonHeap_ = null;
            this.bitField0_ &= -3;
         }

         @Override
         public List<SparkProtos.PlatformStatistics.Memory.MemoryPool> getPoolsList() {
            return this.pools_;
         }

         public List<? extends SparkProtos.PlatformStatistics.Memory.MemoryPoolOrBuilder> getPoolsOrBuilderList() {
            return this.pools_;
         }
         ...
         @Override
         public SparkProtos.PlatformStatistics.Memory.MemoryPool getPools(int index) {
            return this.pools_.get(index);
         }

         public SparkProtos.PlatformStatistics.Memory.MemoryPoolOrBuilder getPoolsOrBuilder(int index) {
            return this.pools_.get(index);
         }

         private void ensurePoolsIsMutable() {
            Internal.ProtobufList<SparkProtos.PlatformStatistics.Memory.MemoryPool> tmp = this.pools_;
            if (!tmp.isModifiable()) {
               this.pools_ = GeneratedMessageLite.mutableCopy(tmp);
            }
         }

         private void setPools(int index, SparkProtos.PlatformStatistics.Memory.MemoryPool value) {
            value.getClass();
            this.ensurePoolsIsMutable();
            this.pools_.set(index, value);
         }

         private void addPools(SparkProtos.PlatformStatistics.Memory.MemoryPool value) {
            value.getClass();
            this.ensurePoolsIsMutable();
            this.pools_.add(value);
         }

         private void addPools(int index, SparkProtos.PlatformStatistics.Memory.MemoryPool value) {
            value.getClass();
            this.ensurePoolsIsMutable();
            this.pools_.add(index, value);
         }

         private void addAllPools(Iterable<? extends SparkProtos.PlatformStatistics.Memory.MemoryPool> values) {
            this.ensurePoolsIsMutable();
            AbstractMessageLite.addAll(values, this.pools_);
         }
         ...
         private void removePools(int index) {
            this.ensurePoolsIsMutable();
            this.pools_.remove(index);
         }
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               ...
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"bitField0_", "heap_", "nonHeap_", "pools_", SparkProtos.PlatformStatistics.Memory.MemoryPool.class};
                  String info = "\u0000\u0003\u0000\u0001\u0001\u0003\u0003\u0000\u0001\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u0003\u001b";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics.Memory, SparkProtos.PlatformStatistics.Memory.Builder>
            implements SparkProtos.PlatformStatistics.MemoryOrBuilder {
            private Builder() {
            ...
            public SparkProtos.PlatformStatistics.Memory.Builder setHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               this.copyOnWrite();
               this.instance.setHeap(value);
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder setHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder builderForValue) {
               this.copyOnWrite();
               this.instance.setHeap(builderForValue.build());
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder mergeHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               this.copyOnWrite();
            ...
            @Override
            public boolean hasNonHeap() {
               return this.instance.hasNonHeap();
            }

            @Override
            public SparkProtos.PlatformStatistics.Memory.MemoryUsage getNonHeap() {
               return this.instance.getNonHeap();
            }

            public SparkProtos.PlatformStatistics.Memory.Builder setNonHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               this.copyOnWrite();
               this.instance.setNonHeap(value);
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder setNonHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder builderForValue) {
               this.copyOnWrite();
               this.instance.setNonHeap(builderForValue.build());
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder mergeNonHeap(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               this.copyOnWrite();
               this.instance.mergeNonHeap(value);
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder clearNonHeap() {
               this.copyOnWrite();
               this.instance.clearNonHeap();
               return this;
            }

            @Override
            public List<SparkProtos.PlatformStatistics.Memory.MemoryPool> getPoolsList() {
               return Collections.unmodifiableList(this.instance.getPoolsList());
            }

            @Override
            public int getPoolsCount() {
               return this.instance.getPoolsCount();
            }

            @Override
            public SparkProtos.PlatformStatistics.Memory.MemoryPool getPools(int index) {
               return this.instance.getPools(index);
            }

            public SparkProtos.PlatformStatistics.Memory.Builder setPools(int index, SparkProtos.PlatformStatistics.Memory.MemoryPool value) {
               this.copyOnWrite();
               this.instance.setPools(index, value);
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder setPools(int index, SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder builderForValue) {
               this.copyOnWrite();
               this.instance.setPools(index, builderForValue.build());
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder addPools(SparkProtos.PlatformStatistics.Memory.MemoryPool value) {
               this.copyOnWrite();
               this.instance.addPools(value);
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder addPools(int index, SparkProtos.PlatformStatistics.Memory.MemoryPool value) {
               this.copyOnWrite();
               this.instance.addPools(index, value);
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder addPools(SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder builderForValue) {
               this.copyOnWrite();
               this.instance.addPools(builderForValue.build());
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder addPools(int index, SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder builderForValue) {
               this.copyOnWrite();
               this.instance.addPools(index, builderForValue.build());
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder addAllPools(Iterable<? extends SparkProtos.PlatformStatistics.Memory.MemoryPool> values) {
               this.copyOnWrite();
               this.instance.addAllPools(values);
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder clearPools() {
               this.copyOnWrite();
               this.instance.clearPools();
               return this;
            }

            public SparkProtos.PlatformStatistics.Memory.Builder removePools(int index) {
               this.copyOnWrite();
               this.instance.removePools(index);
               return this;
            }
         }

         public static final class MemoryPool
            extends GeneratedMessageLite<SparkProtos.PlatformStatistics.Memory.MemoryPool, SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder>
            implements SparkProtos.PlatformStatistics.Memory.MemoryPoolOrBuilder {
            private int bitField0_;
            public static final int NAME_FIELD_NUMBER = 1;
            private String name_ = "";
            public static final int USAGE_FIELD_NUMBER = 2;
            private SparkProtos.PlatformStatistics.Memory.MemoryUsage usage_;
            public static final int COLLECTION_USAGE_FIELD_NUMBER = 3;
            private SparkProtos.PlatformStatistics.Memory.MemoryUsage collectionUsage_;
            ...
            @Override
            public SparkProtos.PlatformStatistics.Memory.MemoryUsage getUsage() {
               return this.usage_ == null ? SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance() : this.usage_;
            }

            private void setUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               value.getClass();
               this.usage_ = value;
               this.bitField0_ |= 1;
            }

            private void mergeUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               value.getClass();
               if (this.usage_ != null && this.usage_ != SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance()) {
                  this.usage_ = SparkProtos.PlatformStatistics.Memory.MemoryUsage.newBuilder(this.usage_).mergeFrom(value).buildPartial();
               } else {
                  this.usage_ = value;
               }
            ...
            @Override
            public SparkProtos.PlatformStatistics.Memory.MemoryUsage getCollectionUsage() {
               return this.collectionUsage_ == null ? SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance() : this.collectionUsage_;
            }

            private void setCollectionUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               value.getClass();
               this.collectionUsage_ = value;
               this.bitField0_ |= 2;
            }

            private void mergeCollectionUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
               value.getClass();
               if (this.collectionUsage_ != null && this.collectionUsage_ != SparkProtos.PlatformStatistics.Memory.MemoryUsage.getDefaultInstance()) {
                  this.collectionUsage_ = SparkProtos.PlatformStatistics.Memory.MemoryUsage.newBuilder(this.collectionUsage_).mergeFrom(value).buildPartial();
               } else {
                  this.collectionUsage_ = value;
               }
            ...
            private void clearCollectionUsage() {
            ...
            protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
               switch (method) {
                  ...
                  case BUILD_MESSAGE_INFO:
                     Object[] objects = new Object[]{"bitField0_", "name_", "usage_", "collectionUsage_"};
                     String info = "\u0000\u0003\u0000\u0001\u0001\u0003\u0003\u0000\u0000\u0000\u0001Ȉ\u0002ဉ\u0000\u0003ဉ\u0001";
                     return newMessageInfo(DEFAULT_INSTANCE, info, objects);
                  case GET_DEFAULT_INSTANCE:
                     return DEFAULT_INSTANCE;
            ...
            public static final class Builder
               extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics.Memory.MemoryPool, SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder>
               implements SparkProtos.PlatformStatistics.Memory.MemoryPoolOrBuilder {
               private Builder() {
               ...
               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder setName(String value) {
                  this.copyOnWrite();
                  this.instance.setName(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder clearName() {
                  this.copyOnWrite();
                  this.instance.clearName();
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder setNameBytes(ByteString value) {
                  this.copyOnWrite();
                  this.instance.setNameBytes(value);
                  return this;
               }
               ...
               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder setUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
                  this.copyOnWrite();
                  this.instance.setUsage(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder setUsage(
                  SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder builderForValue
               ) {
                  this.copyOnWrite();
                  this.instance.setUsage(builderForValue.build());
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder mergeUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
                  this.copyOnWrite();
                  this.instance.mergeUsage(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder clearUsage() {
                  this.copyOnWrite();
               ...
               @Override
               public boolean hasCollectionUsage() {
                  return this.instance.hasCollectionUsage();
               }

               @Override
               public SparkProtos.PlatformStatistics.Memory.MemoryUsage getCollectionUsage() {
                  return this.instance.getCollectionUsage();
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder setCollectionUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
                  this.copyOnWrite();
                  this.instance.setCollectionUsage(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder setCollectionUsage(
                  SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder builderForValue
               ) {
                  this.copyOnWrite();
                  this.instance.setCollectionUsage(builderForValue.build());
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder mergeCollectionUsage(SparkProtos.PlatformStatistics.Memory.MemoryUsage value) {
                  this.copyOnWrite();
                  this.instance.mergeCollectionUsage(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryPool.Builder clearCollectionUsage() {
                  this.copyOnWrite();
                  this.instance.clearCollectionUsage();
                  return this;
               }
            }
         }
         ...
         public interface MemoryPoolOrBuilder extends MessageLiteOrBuilder {
            ...
            SparkProtos.PlatformStatistics.Memory.MemoryUsage getUsage();

            boolean hasCollectionUsage();

            SparkProtos.PlatformStatistics.Memory.MemoryUsage getCollectionUsage();
         }

         public static final class MemoryUsage
            extends GeneratedMessageLite<SparkProtos.PlatformStatistics.Memory.MemoryUsage, SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder>
            implements SparkProtos.PlatformStatistics.Memory.MemoryUsageOrBuilder {
            ...
            private long max_;
            private static final SparkProtos.PlatformStatistics.Memory.MemoryUsage DEFAULT_INSTANCE;
            private static volatile Parser<SparkProtos.PlatformStatistics.Memory.MemoryUsage> PARSER;
            ...
            private void setCommitted(long value) {
               this.committed_ = value;
            }
            ...
            private void setInit(long value) {
               this.init_ = value;
            }
            ...
            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(ByteString data) throws InvalidProtocolBufferException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(byte[] data) throws InvalidProtocolBufferException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(InputStream input) throws IOException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseDelimitedFrom(InputStream input) throws IOException {
               return parseDelimitedFrom(DEFAULT_INSTANCE, input);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
               return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(CodedInputStream input) throws IOException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
               return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder newBuilder() {
               return DEFAULT_INSTANCE.createBuilder();
            }

            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder newBuilder(SparkProtos.PlatformStatistics.Memory.MemoryUsage prototype) {
               // $VF: Couldn't be decompiled
               // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
               // java.lang.StackOverflowError
               //   at org.jetbrains.java.decompiler.main.DecompilerContext.getCurrentContext(DecompilerContext.java:67)
               ...
               //
               // Bytecode:
               // 0: getstatic me/lucko/spark/proto/SparkProtos$PlatformStatistics$Memory$MemoryUsage.DEFAULT_INSTANCE Lme/lucko/spark/proto/SparkProtos$PlatformStatistics$Memory$MemoryUsage;
               // 3: aload 0
               // 4: invokevirtual me/lucko/spark/proto/SparkProtos$PlatformStatistics$Memory$MemoryUsage.createBuilder (Lme/lucko/spark/lib/protobuf/GeneratedMessageLite;)Lme/lucko/spark/lib/protobuf/GeneratedMessageLite$Builder;
               // 7: checkcast me/lucko/spark/proto/SparkProtos$PlatformStatistics$Memory$MemoryUsage$Builder
               // a: areturn
            }
            ...
            protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
               switch (method) {
                  case NEW_MUTABLE_INSTANCE:
                     return new SparkProtos.PlatformStatistics.Memory.MemoryUsage();
                  case NEW_BUILDER:
                     return new SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder();
                  case BUILD_MESSAGE_INFO:
                     Object[] objects = new Object[]{"used_", "committed_", "init_", "max_"};
                     String info = "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0000\u0000\u0001\u0002\u0002\u0002\u0003\u0002\u0004\u0002";
                     return newMessageInfo(DEFAULT_INSTANCE, info, objects);
                  case GET_DEFAULT_INSTANCE:
                     return DEFAULT_INSTANCE;
                  case GET_PARSER:
                     Parser<SparkProtos.PlatformStatistics.Memory.MemoryUsage> parser = PARSER;
                     if (parser == null) {
                        synchronized (SparkProtos.PlatformStatistics.Memory.MemoryUsage.class) {
                           parser = PARSER;
                           if (parser == null) {
                              parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                              PARSER = parser;
            ...
            public static SparkProtos.PlatformStatistics.Memory.MemoryUsage getDefaultInstance() {
               return DEFAULT_INSTANCE;
            }

            public static Parser<SparkProtos.PlatformStatistics.Memory.MemoryUsage> parser() {
               return DEFAULT_INSTANCE.getParserForType();
            }

            static {
               SparkProtos.PlatformStatistics.Memory.MemoryUsage defaultInstance = new SparkProtos.PlatformStatistics.Memory.MemoryUsage();
               DEFAULT_INSTANCE = defaultInstance;
               GeneratedMessageLite.registerDefaultInstance(SparkProtos.PlatformStatistics.Memory.MemoryUsage.class, defaultInstance);
            }

            public static final class Builder
               extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics.Memory.MemoryUsage, SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder>
               implements SparkProtos.PlatformStatistics.Memory.MemoryUsageOrBuilder {
               private Builder() {
                  super(SparkProtos.PlatformStatistics.Memory.MemoryUsage.DEFAULT_INSTANCE);
               }
               ...
               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder setUsed(long value) {
                  this.copyOnWrite();
                  this.instance.setUsed(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder clearUsed() {
                  this.copyOnWrite();
               ...
               @Override
               public long getCommitted() {
                  return this.instance.getCommitted();
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder setCommitted(long value) {
                  this.copyOnWrite();
                  this.instance.setCommitted(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder clearCommitted() {
                  this.copyOnWrite();
                  this.instance.clearCommitted();
                  return this;
               }
               ...
               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder setInit(long value) {
                  this.copyOnWrite();
                  this.instance.setInit(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder clearInit() {
                  this.copyOnWrite();
                  this.instance.clearInit();
                  return this;
               }
               ...
               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder setMax(long value) {
                  this.copyOnWrite();
                  this.instance.setMax(value);
                  return this;
               }

               public SparkProtos.PlatformStatistics.Memory.MemoryUsage.Builder clearMax() {
                  this.copyOnWrite();
      ...
      public interface MemoryOrBuilder extends MessageLiteOrBuilder {
         ...
         SparkProtos.PlatformStatistics.Memory.MemoryUsage getHeap();

         boolean hasNonHeap();

         SparkProtos.PlatformStatistics.Memory.MemoryUsage getNonHeap();

         List<SparkProtos.PlatformStatistics.Memory.MemoryPool> getPoolsList();

         SparkProtos.PlatformStatistics.Memory.MemoryPool getPools(int var1);

         int getPoolsCount();
      }

      public static final class Mspt
         extends GeneratedMessageLite<SparkProtos.PlatformStatistics.Mspt, SparkProtos.PlatformStatistics.Mspt.Builder>
         implements SparkProtos.PlatformStatistics.MsptOrBuilder {
         private int bitField0_;
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               ...
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"bitField0_", "last1M_", "last5M_"};
                  String info = "\u0000\u0002\u0000\u0001\u0001\u0002\u0002\u0000\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics.Mspt, SparkProtos.PlatformStatistics.Mspt.Builder>
            implements SparkProtos.PlatformStatistics.MsptOrBuilder {
            private Builder() {
      ...
      public static enum OnlineMode implements Internal.EnumLite {
         UNKNOWN(0),
         OFFLINE(1),
         ONLINE(2),
         UNRECOGNIZED(-1);
         ...
         private static final Internal.EnumLiteMap<SparkProtos.PlatformStatistics.OnlineMode> internalValueMap = new Internal.EnumLiteMap<SparkProtos.PlatformStatistics.OnlineMode>() {
            public SparkProtos.PlatformStatistics.OnlineMode findValueByNumber(int number) {
               return SparkProtos.PlatformStatistics.OnlineMode.forNumber(number);
            }
         };
         private final int value;
         ...
         @Deprecated
         public static SparkProtos.PlatformStatistics.OnlineMode valueOf(int value) {
            return forNumber(value);
         }

         public static SparkProtos.PlatformStatistics.OnlineMode forNumber(int value) {
            switch (value) {
               case 0:
                  return UNKNOWN;
               case 1:
         ...
         public static Internal.EnumLiteMap<SparkProtos.PlatformStatistics.OnlineMode> internalGetValueMap() {
            return internalValueMap;
         }

         public static Internal.EnumVerifier internalGetVerifier() {
            return SparkProtos.PlatformStatistics.OnlineMode.OnlineModeVerifier.INSTANCE;
         }
         ...
         private static final class OnlineModeVerifier implements Internal.EnumVerifier {
            static final Internal.EnumVerifier INSTANCE = new SparkProtos.PlatformStatistics.OnlineMode.OnlineModeVerifier();

            @Override
            public boolean isInRange(int number) {
               return SparkProtos.PlatformStatistics.OnlineMode.forNumber(number) != null;
            }
         }
      }

      public static final class Ping
         extends GeneratedMessageLite<SparkProtos.PlatformStatistics.Ping, SparkProtos.PlatformStatistics.Ping.Builder>
         implements SparkProtos.PlatformStatistics.PingOrBuilder {
         private int bitField0_;
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               ...
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"bitField0_", "last15M_"};
                  String info = "\u0000\u0001\u0000\u0001\u0001\u0001\u0001\u0000\u0000\u0000\u0001ဉ\u0000";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics.Ping, SparkProtos.PlatformStatistics.Ping.Builder>
            implements SparkProtos.PlatformStatistics.PingOrBuilder {
            private Builder() {
      ...
      public static final class Tps
         extends GeneratedMessageLite<SparkProtos.PlatformStatistics.Tps, SparkProtos.PlatformStatistics.Tps.Builder>
         implements SparkProtos.PlatformStatistics.TpsOrBuilder {
         public static final int LAST1M_FIELD_NUMBER = 1;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.PlatformStatistics.Tps, SparkProtos.PlatformStatistics.Tps.Builder>
            implements SparkProtos.PlatformStatistics.TpsOrBuilder {
            private Builder() {
   ...
   public interface PlatformStatisticsOrBuilder extends MessageLiteOrBuilder {
      ...
      SparkProtos.PlatformStatistics.OnlineMode getOnlineMode();
   }

   public static final class PluginOrModMetadata
      extends GeneratedMessageLite<SparkProtos.PluginOrModMetadata, SparkProtos.PluginOrModMetadata.Builder>
      implements SparkProtos.PluginOrModMetadataOrBuilder {
      public static final int NAME_FIELD_NUMBER = 1;
      private String name_ = "";
      ...
      private static final SparkProtos.PluginOrModMetadata DEFAULT_INSTANCE;
      private static volatile Parser<SparkProtos.PluginOrModMetadata> PARSER;
      ...
      private void setAuthorBytes(ByteString value) {
         checkByteStringIsUtf8(value);
         this.author_ = value.toStringUtf8();
      }
      ...
      public static SparkProtos.PluginOrModMetadata parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(ByteString data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(byte[] data) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(InputStream input) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.PluginOrModMetadata parseDelimitedFrom(InputStream input) throws IOException {
         return parseDelimitedFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.PluginOrModMetadata parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(CodedInputStream input) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
      }

      public static SparkProtos.PluginOrModMetadata parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
         return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
      }

      public static SparkProtos.PluginOrModMetadata.Builder newBuilder() {
         return DEFAULT_INSTANCE.createBuilder();
      }

      public static SparkProtos.PluginOrModMetadata.Builder newBuilder(SparkProtos.PluginOrModMetadata prototype) {
         // $VF: Couldn't be decompiled
         // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
         // java.lang.StackOverflowError
         //   at java.base/java.util.concurrent.ConcurrentHashMap.computeIfAbsent(ConcurrentHashMap.java:1721)
         ...
         //
         // Bytecode:
         // 0: getstatic me/lucko/spark/proto/SparkProtos$PluginOrModMetadata.DEFAULT_INSTANCE Lme/lucko/spark/proto/SparkProtos$PluginOrModMetadata;
         // 3: aload 0
         // 4: invokevirtual me/lucko/spark/proto/SparkProtos$PluginOrModMetadata.createBuilder (Lme/lucko/spark/lib/protobuf/GeneratedMessageLite;)Lme/lucko/spark/lib/protobuf/GeneratedMessageLite$Builder;
         // 7: checkcast me/lucko/spark/proto/SparkProtos$PluginOrModMetadata$Builder
         // a: areturn
      }
      ...
      protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
         switch (method) {
            case NEW_MUTABLE_INSTANCE:
               return new SparkProtos.PluginOrModMetadata();
            case NEW_BUILDER:
               return new SparkProtos.PluginOrModMetadata.Builder();
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{"name_", "version_", "author_", "description_"};
               String info = "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ\u0003Ȉ\u0004Ȉ";
               return newMessageInfo(DEFAULT_INSTANCE, info, objects);
            case GET_DEFAULT_INSTANCE:
               return DEFAULT_INSTANCE;
            case GET_PARSER:
               Parser<SparkProtos.PluginOrModMetadata> parser = PARSER;
               if (parser == null) {
                  synchronized (SparkProtos.PluginOrModMetadata.class) {
                     parser = PARSER;
                     if (parser == null) {
                        parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                        PARSER = parser;
      ...
      public static SparkProtos.PluginOrModMetadata getDefaultInstance() {
         return DEFAULT_INSTANCE;
      }

      public static Parser<SparkProtos.PluginOrModMetadata> parser() {
         return DEFAULT_INSTANCE.getParserForType();
      }

      static {
         SparkProtos.PluginOrModMetadata defaultInstance = new SparkProtos.PluginOrModMetadata();
         DEFAULT_INSTANCE = defaultInstance;
         GeneratedMessageLite.registerDefaultInstance(SparkProtos.PluginOrModMetadata.class, defaultInstance);
      }

      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.PluginOrModMetadata, SparkProtos.PluginOrModMetadata.Builder>
         implements SparkProtos.PluginOrModMetadataOrBuilder {
         private Builder() {
            super(SparkProtos.PluginOrModMetadata.DEFAULT_INSTANCE);
         }
         ...
         public SparkProtos.PluginOrModMetadata.Builder setName(String value) {
            this.copyOnWrite();
            this.instance.setName(value);
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder clearName() {
            this.copyOnWrite();
            this.instance.clearName();
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder setNameBytes(ByteString value) {
            this.copyOnWrite();
            this.instance.setNameBytes(value);
            return this;
         }
         ...
         public SparkProtos.PluginOrModMetadata.Builder setVersion(String value) {
            this.copyOnWrite();
            this.instance.setVersion(value);
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder clearVersion() {
            this.copyOnWrite();
            this.instance.clearVersion();
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder setVersionBytes(ByteString value) {
            this.copyOnWrite();
            this.instance.setVersionBytes(value);
            return this;
         }
         ...
         @Override
         public ByteString getAuthorBytes() {
            return this.instance.getAuthorBytes();
         }

         public SparkProtos.PluginOrModMetadata.Builder setAuthor(String value) {
            this.copyOnWrite();
            this.instance.setAuthor(value);
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder clearAuthor() {
            this.copyOnWrite();
            this.instance.clearAuthor();
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder setAuthorBytes(ByteString value) {
            this.copyOnWrite();
            this.instance.setAuthorBytes(value);
            return this;
         }
         ...
         public SparkProtos.PluginOrModMetadata.Builder setDescription(String value) {
            this.copyOnWrite();
            this.instance.setDescription(value);
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder clearDescription() {
            this.copyOnWrite();
            this.instance.clearDescription();
            return this;
         }

         public SparkProtos.PluginOrModMetadata.Builder setDescriptionBytes(ByteString value) {
            this.copyOnWrite();
   ...
   public static final class RollingAverageValues
      extends GeneratedMessageLite<SparkProtos.RollingAverageValues, SparkProtos.RollingAverageValues.Builder>
      implements SparkProtos.RollingAverageValuesOrBuilder {
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.RollingAverageValues, SparkProtos.RollingAverageValues.Builder>
         implements SparkProtos.RollingAverageValuesOrBuilder {
         private Builder() {
   ...
   public static final class SystemStatistics
      extends GeneratedMessageLite<SparkProtos.SystemStatistics, SparkProtos.SystemStatistics.Builder>
      implements SparkProtos.SystemStatisticsOrBuilder {
      private int bitField0_;
      ...
      private SparkProtos.SystemStatistics.Jvm jvm_;
      ...
      @Override
      public SparkProtos.SystemStatistics.Jvm getJvm() {
         return this.jvm_ == null ? SparkProtos.SystemStatistics.Jvm.getDefaultInstance() : this.jvm_;
      }

      private void setJvm(SparkProtos.SystemStatistics.Jvm value) {
         value.getClass();
         this.jvm_ = value;
         this.bitField0_ |= 32;
      }

      private void mergeJvm(SparkProtos.SystemStatistics.Jvm value) {
         value.getClass();
         if (this.jvm_ != null && this.jvm_ != SparkProtos.SystemStatistics.Jvm.getDefaultInstance()) {
            this.jvm_ = SparkProtos.SystemStatistics.Jvm.newBuilder(this.jvm_).mergeFrom(value).buildPartial();
         } else {
            this.jvm_ = value;
         }
         ...
         switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{
                  ...
                  "memory_",
                  "gc_",
                  SparkProtos.SystemStatistics.GcDefaultEntryHolder.defaultEntry,
                  "disk_",
                  "os_",
                  "java_",
                  "uptime_",
                  "net_",
                  SparkProtos.SystemStatistics.NetDefaultEntryHolder.defaultEntry,
                  "jvm_"
               };
               String info = "\u0000\t\u0000\u0001\u0001\t\t\u0002\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u00032\u0004ဉ\u0002\u0005ဉ\u0003\u0006ဉ\u0004\u0007\u0002\b2\tဉ\u0005";
               return newMessageInfo(DEFAULT_INSTANCE, info, objects);
            case GET_DEFAULT_INSTANCE:
               return DEFAULT_INSTANCE;
            case GET_PARSER:
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics, SparkProtos.SystemStatistics.Builder>
         implements SparkProtos.SystemStatisticsOrBuilder {
         private Builder() {
         ...
         @Override
         public boolean hasJvm() {
            return this.instance.hasJvm();
         }

         @Override
         public SparkProtos.SystemStatistics.Jvm getJvm() {
            return this.instance.getJvm();
         }

         public SparkProtos.SystemStatistics.Builder setJvm(SparkProtos.SystemStatistics.Jvm value) {
            this.copyOnWrite();
            this.instance.setJvm(value);
            return this;
         }

         public SparkProtos.SystemStatistics.Builder setJvm(SparkProtos.SystemStatistics.Jvm.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setJvm(builderForValue.build());
            return this;
         }

         public SparkProtos.SystemStatistics.Builder mergeJvm(SparkProtos.SystemStatistics.Jvm value) {
            this.copyOnWrite();
            this.instance.mergeJvm(value);
            return this;
         }

         public SparkProtos.SystemStatistics.Builder clearJvm() {
            this.copyOnWrite();
            this.instance.clearJvm();
            return this;
         }
      }

      public static final class Cpu
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.Cpu, SparkProtos.SystemStatistics.Cpu.Builder>
         implements SparkProtos.SystemStatistics.CpuOrBuilder {
         private int bitField0_;
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               ...
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"bitField0_", "threads_", "processUsage_", "systemUsage_", "modelName_"};
                  String info = "\u0000\u0004\u0000\u0001\u0001\u0004\u0004\u0000\u0000\u0000\u0001\u0004\u0002ဉ\u0000\u0003ဉ\u0001\u0004Ȉ";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Cpu, SparkProtos.SystemStatistics.Cpu.Builder>
            implements SparkProtos.SystemStatistics.CpuOrBuilder {
            private Builder() {
         ...
         public static final class Usage
            extends GeneratedMessageLite<SparkProtos.SystemStatistics.Cpu.Usage, SparkProtos.SystemStatistics.Cpu.Usage.Builder>
            implements SparkProtos.SystemStatistics.Cpu.UsageOrBuilder {
            public static final int LAST1M_FIELD_NUMBER = 1;
            private double last1M_;
            ...
            public static final class Builder
               extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Cpu.Usage, SparkProtos.SystemStatistics.Cpu.Usage.Builder>
               implements SparkProtos.SystemStatistics.Cpu.UsageOrBuilder {
               private Builder() {
      ...
      public static final class Disk
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.Disk, SparkProtos.SystemStatistics.Disk.Builder>
         implements SparkProtos.SystemStatistics.DiskOrBuilder {
         public static final int USED_FIELD_NUMBER = 1;
         private long used_;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Disk, SparkProtos.SystemStatistics.Disk.Builder>
            implements SparkProtos.SystemStatistics.DiskOrBuilder {
            private Builder() {
      ...
      public static final class Gc
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.Gc, SparkProtos.SystemStatistics.Gc.Builder>
         implements SparkProtos.SystemStatistics.GcOrBuilder {
         public static final int TOTAL_FIELD_NUMBER = 1;
         private long total_;
         public static final int AVG_TIME_FIELD_NUMBER = 2;
         private double avgTime_;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Gc, SparkProtos.SystemStatistics.Gc.Builder>
            implements SparkProtos.SystemStatistics.GcOrBuilder {
            private Builder() {
      ...
      private static final class GcDefaultEntryHolder {
         static final MapEntryLite<String, SparkProtos.SystemStatistics.Gc> defaultEntry = MapEntryLite.newDefaultInstance(
            WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, SparkProtos.SystemStatistics.Gc.getDefaultInstance()
         );
      }
      ...
      public static final class Java
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.Java, SparkProtos.SystemStatistics.Java.Builder>
         implements SparkProtos.SystemStatistics.JavaOrBuilder {
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Java, SparkProtos.SystemStatistics.Java.Builder>
            implements SparkProtos.SystemStatistics.JavaOrBuilder {
            private Builder() {
      ...
      public static final class Jvm
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.Jvm, SparkProtos.SystemStatistics.Jvm.Builder>
         implements SparkProtos.SystemStatistics.JvmOrBuilder {
         public static final int NAME_FIELD_NUMBER = 1;
         private String name_ = "";
         ...
         public static final int VERSION_FIELD_NUMBER = 3;
         private String version_ = "";
         private static final SparkProtos.SystemStatistics.Jvm DEFAULT_INSTANCE;
         private static volatile Parser<SparkProtos.SystemStatistics.Jvm> PARSER;
         ...
         public static SparkProtos.SystemStatistics.Jvm parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(InputStream input) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.SystemStatistics.Jvm parseDelimitedFrom(InputStream input) throws IOException {
            return parseDelimitedFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.SystemStatistics.Jvm parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(CodedInputStream input) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.SystemStatistics.Jvm parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.SystemStatistics.Jvm.Builder newBuilder() {
            return DEFAULT_INSTANCE.createBuilder();
         }

         public static SparkProtos.SystemStatistics.Jvm.Builder newBuilder(SparkProtos.SystemStatistics.Jvm prototype) {
            // $VF: Couldn't be decompiled
            // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
            // java.lang.StackOverflowError
            //   at org.jetbrains.java.decompiler.main.DecompilerContext.getCurrentContext(DecompilerContext.java:67)
            ...
            //
            // Bytecode:
            // 0: getstatic me/lucko/spark/proto/SparkProtos$SystemStatistics$Jvm.DEFAULT_INSTANCE Lme/lucko/spark/proto/SparkProtos$SystemStatistics$Jvm;
            // 3: aload 0
            // 4: invokevirtual me/lucko/spark/proto/SparkProtos$SystemStatistics$Jvm.createBuilder (Lme/lucko/spark/lib/protobuf/GeneratedMessageLite;)Lme/lucko/spark/lib/protobuf/GeneratedMessageLite$Builder;
            // 7: checkcast me/lucko/spark/proto/SparkProtos$SystemStatistics$Jvm$Builder
            // a: areturn
         }
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               case NEW_MUTABLE_INSTANCE:
                  return new SparkProtos.SystemStatistics.Jvm();
               case NEW_BUILDER:
                  return new SparkProtos.SystemStatistics.Jvm.Builder();
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"name_", "vendor_", "version_"};
                  String info = "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ\u0003Ȉ";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
               case GET_PARSER:
                  Parser<SparkProtos.SystemStatistics.Jvm> parser = PARSER;
                  if (parser == null) {
                     synchronized (SparkProtos.SystemStatistics.Jvm.class) {
                        parser = PARSER;
                        if (parser == null) {
                           parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                           PARSER = parser;
         ...
         public static SparkProtos.SystemStatistics.Jvm getDefaultInstance() {
            return DEFAULT_INSTANCE;
         }

         public static Parser<SparkProtos.SystemStatistics.Jvm> parser() {
            return DEFAULT_INSTANCE.getParserForType();
         }

         static {
            SparkProtos.SystemStatistics.Jvm defaultInstance = new SparkProtos.SystemStatistics.Jvm();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(SparkProtos.SystemStatistics.Jvm.class, defaultInstance);
         }

         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Jvm, SparkProtos.SystemStatistics.Jvm.Builder>
            implements SparkProtos.SystemStatistics.JvmOrBuilder {
            private Builder() {
               super(SparkProtos.SystemStatistics.Jvm.DEFAULT_INSTANCE);
            }
            ...
            public SparkProtos.SystemStatistics.Jvm.Builder setName(String value) {
               this.copyOnWrite();
               this.instance.setName(value);
               return this;
            }

            public SparkProtos.SystemStatistics.Jvm.Builder clearName() {
               this.copyOnWrite();
               this.instance.clearName();
               return this;
            }

            public SparkProtos.SystemStatistics.Jvm.Builder setNameBytes(ByteString value) {
               this.copyOnWrite();
               this.instance.setNameBytes(value);
               return this;
            }
            ...
            public SparkProtos.SystemStatistics.Jvm.Builder setVendor(String value) {
               this.copyOnWrite();
               this.instance.setVendor(value);
               return this;
            }

            public SparkProtos.SystemStatistics.Jvm.Builder clearVendor() {
               this.copyOnWrite();
               this.instance.clearVendor();
               return this;
            }

            public SparkProtos.SystemStatistics.Jvm.Builder setVendorBytes(ByteString value) {
               this.copyOnWrite();
               this.instance.setVendorBytes(value);
               return this;
            }
            ...
            public SparkProtos.SystemStatistics.Jvm.Builder setVersion(String value) {
               this.copyOnWrite();
               this.instance.setVersion(value);
               return this;
            }

            public SparkProtos.SystemStatistics.Jvm.Builder clearVersion() {
               this.copyOnWrite();
               this.instance.clearVersion();
               return this;
            }

            public SparkProtos.SystemStatistics.Jvm.Builder setVersionBytes(ByteString value) {
               this.copyOnWrite();
               this.instance.setVersionBytes(value);
               return this;
            }
      ...
      public static final class Memory
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.Memory, SparkProtos.SystemStatistics.Memory.Builder>
         implements SparkProtos.SystemStatistics.MemoryOrBuilder {
         private int bitField0_;
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               ...
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"bitField0_", "physical_", "swap_"};
                  String info = "\u0000\u0002\u0000\u0001\u0001\u0002\u0002\u0000\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Memory, SparkProtos.SystemStatistics.Memory.Builder>
            implements SparkProtos.SystemStatistics.MemoryOrBuilder {
            private Builder() {
         ...
         public static final class MemoryPool
            extends GeneratedMessageLite<SparkProtos.SystemStatistics.Memory.MemoryPool, SparkProtos.SystemStatistics.Memory.MemoryPool.Builder>
            implements SparkProtos.SystemStatistics.Memory.MemoryPoolOrBuilder {
            public static final int USED_FIELD_NUMBER = 1;
            private long used_;
            public static final int TOTAL_FIELD_NUMBER = 2;
            private long total_;
            ...
            public static final class Builder
               extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Memory.MemoryPool, SparkProtos.SystemStatistics.Memory.MemoryPool.Builder>
               implements SparkProtos.SystemStatistics.Memory.MemoryPoolOrBuilder {
               private Builder() {
      ...
      private static final class NetDefaultEntryHolder {
         static final MapEntryLite<String, SparkProtos.SystemStatistics.NetInterface> defaultEntry = MapEntryLite.newDefaultInstance(
            WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, SparkProtos.SystemStatistics.NetInterface.getDefaultInstance()
         );
      }

      public static final class NetInterface
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.NetInterface, SparkProtos.SystemStatistics.NetInterface.Builder>
         implements SparkProtos.SystemStatistics.NetInterfaceOrBuilder {
         private int bitField0_;
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               ...
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"bitField0_", "rxBytesPerSecond_", "txBytesPerSecond_", "rxPacketsPerSecond_", "txPacketsPerSecond_"};
                  String info = "\u0000\u0004\u0000\u0001\u0001\u0004\u0004\u0000\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u0003ဉ\u0002\u0004ဉ\u0003";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.NetInterface, SparkProtos.SystemStatistics.NetInterface.Builder>
            implements SparkProtos.SystemStatistics.NetInterfaceOrBuilder {
            private Builder() {
      ...
      public static final class Os
         extends GeneratedMessageLite<SparkProtos.SystemStatistics.Os, SparkProtos.SystemStatistics.Os.Builder>
         implements SparkProtos.SystemStatistics.OsOrBuilder {
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.SystemStatistics.Os, SparkProtos.SystemStatistics.Os.Builder>
            implements SparkProtos.SystemStatistics.OsOrBuilder {
            private Builder() {
   ...
   public interface SystemStatisticsOrBuilder extends MessageLiteOrBuilder {
      ...
      SparkProtos.SystemStatistics.Jvm getJvm();
   }

   public static final class WindowStatistics
      extends GeneratedMessageLite<SparkProtos.WindowStatistics, SparkProtos.WindowStatistics.Builder>
      implements SparkProtos.WindowStatisticsOrBuilder {
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.WindowStatistics, SparkProtos.WindowStatistics.Builder>
         implements SparkProtos.WindowStatisticsOrBuilder {
         private Builder() {
   ...
   public static final class WorldStatistics
      extends GeneratedMessageLite<SparkProtos.WorldStatistics, SparkProtos.WorldStatistics.Builder>
      implements SparkProtos.WorldStatisticsOrBuilder {
      ...
      private Internal.ProtobufList<SparkProtos.WorldStatistics.GameRule> gameRules_ = emptyProtobufList();
      public static final int DATA_PACKS_FIELD_NUMBER = 5;
      private Internal.ProtobufList<SparkProtos.WorldStatistics.DataPack> dataPacks_ = emptyProtobufList();
      ...
      @Override
      public List<SparkProtos.WorldStatistics.GameRule> getGameRulesList() {
         return this.gameRules_;
      }

      public List<? extends SparkProtos.WorldStatistics.GameRuleOrBuilder> getGameRulesOrBuilderList() {
         return this.gameRules_;
      }
      ...
      @Override
      public SparkProtos.WorldStatistics.GameRule getGameRules(int index) {
         return this.gameRules_.get(index);
      }

      public SparkProtos.WorldStatistics.GameRuleOrBuilder getGameRulesOrBuilder(int index) {
         return this.gameRules_.get(index);
      }

      private void ensureGameRulesIsMutable() {
         Internal.ProtobufList<SparkProtos.WorldStatistics.GameRule> tmp = this.gameRules_;
         if (!tmp.isModifiable()) {
            this.gameRules_ = GeneratedMessageLite.mutableCopy(tmp);
         }
      }

      private void setGameRules(int index, SparkProtos.WorldStatistics.GameRule value) {
         value.getClass();
         this.ensureGameRulesIsMutable();
         this.gameRules_.set(index, value);
      }

      private void addGameRules(SparkProtos.WorldStatistics.GameRule value) {
         value.getClass();
         this.ensureGameRulesIsMutable();
         this.gameRules_.add(value);
      }

      private void addGameRules(int index, SparkProtos.WorldStatistics.GameRule value) {
         value.getClass();
         this.ensureGameRulesIsMutable();
         this.gameRules_.add(index, value);
      }

      private void addAllGameRules(Iterable<? extends SparkProtos.WorldStatistics.GameRule> values) {
         this.ensureGameRulesIsMutable();
         AbstractMessageLite.addAll(values, this.gameRules_);
      }
      ...
      private void removeGameRules(int index) {
         this.ensureGameRulesIsMutable();
         this.gameRules_.remove(index);
      }

      @Override
      public List<SparkProtos.WorldStatistics.DataPack> getDataPacksList() {
         return this.dataPacks_;
      }

      public List<? extends SparkProtos.WorldStatistics.DataPackOrBuilder> getDataPacksOrBuilderList() {
         return this.dataPacks_;
      }
      ...
      @Override
      public SparkProtos.WorldStatistics.DataPack getDataPacks(int index) {
         return this.dataPacks_.get(index);
      }

      public SparkProtos.WorldStatistics.DataPackOrBuilder getDataPacksOrBuilder(int index) {
         return this.dataPacks_.get(index);
      }

      private void ensureDataPacksIsMutable() {
         Internal.ProtobufList<SparkProtos.WorldStatistics.DataPack> tmp = this.dataPacks_;
         if (!tmp.isModifiable()) {
            this.dataPacks_ = GeneratedMessageLite.mutableCopy(tmp);
         }
      }

      private void setDataPacks(int index, SparkProtos.WorldStatistics.DataPack value) {
         value.getClass();
         this.ensureDataPacksIsMutable();
         this.dataPacks_.set(index, value);
      }

      private void addDataPacks(SparkProtos.WorldStatistics.DataPack value) {
         value.getClass();
         this.ensureDataPacksIsMutable();
         this.dataPacks_.add(value);
      }

      private void addDataPacks(int index, SparkProtos.WorldStatistics.DataPack value) {
         value.getClass();
         this.ensureDataPacksIsMutable();
         this.dataPacks_.add(index, value);
      }

      private void addAllDataPacks(Iterable<? extends SparkProtos.WorldStatistics.DataPack> values) {
         this.ensureDataPacksIsMutable();
         AbstractMessageLite.addAll(values, this.dataPacks_);
      }

      private void clearDataPacks() {
         this.dataPacks_ = emptyProtobufList();
      }

      private void removeDataPacks(int index) {
         this.ensureDataPacksIsMutable();
         this.dataPacks_.remove(index);
      }
         ...
         switch (method) {
            ...
            case BUILD_MESSAGE_INFO:
               Object[] objects = new Object[]{
                  "totalEntities_",
                  "entityCounts_",
                  SparkProtos.WorldStatistics.EntityCountsDefaultEntryHolder.defaultEntry,
                  "worlds_",
                  SparkProtos.WorldStatistics.World.class,
                  "gameRules_",
                  SparkProtos.WorldStatistics.GameRule.class,
                  "dataPacks_",
                  SparkProtos.WorldStatistics.DataPack.class
               };
               String info = "\u0000\u0005\u0000\u0000\u0001\u0005\u0005\u0001\u0003\u0000\u0001\u0004\u00022\u0003\u001b\u0004\u001b\u0005\u001b";
               return newMessageInfo(DEFAULT_INSTANCE, info, objects);
            case GET_DEFAULT_INSTANCE:
      ...
      public static final class Builder
         extends GeneratedMessageLite.Builder<SparkProtos.WorldStatistics, SparkProtos.WorldStatistics.Builder>
         implements SparkProtos.WorldStatisticsOrBuilder {
         private Builder() {
         ...
         @Override
         public List<SparkProtos.WorldStatistics.GameRule> getGameRulesList() {
            return Collections.unmodifiableList(this.instance.getGameRulesList());
         }

         @Override
         public int getGameRulesCount() {
            return this.instance.getGameRulesCount();
         }

         @Override
         public SparkProtos.WorldStatistics.GameRule getGameRules(int index) {
            return this.instance.getGameRules(index);
         }

         public SparkProtos.WorldStatistics.Builder setGameRules(int index, SparkProtos.WorldStatistics.GameRule value) {
            this.copyOnWrite();
            this.instance.setGameRules(index, value);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder setGameRules(int index, SparkProtos.WorldStatistics.GameRule.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setGameRules(index, builderForValue.build());
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addGameRules(SparkProtos.WorldStatistics.GameRule value) {
            this.copyOnWrite();
            this.instance.addGameRules(value);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addGameRules(int index, SparkProtos.WorldStatistics.GameRule value) {
            this.copyOnWrite();
            this.instance.addGameRules(index, value);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addGameRules(SparkProtos.WorldStatistics.GameRule.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.addGameRules(builderForValue.build());
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addGameRules(int index, SparkProtos.WorldStatistics.GameRule.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.addGameRules(index, builderForValue.build());
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addAllGameRules(Iterable<? extends SparkProtos.WorldStatistics.GameRule> values) {
            this.copyOnWrite();
            this.instance.addAllGameRules(values);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder clearGameRules() {
            this.copyOnWrite();
            this.instance.clearGameRules();
            return this;
         }

         public SparkProtos.WorldStatistics.Builder removeGameRules(int index) {
            this.copyOnWrite();
            this.instance.removeGameRules(index);
            return this;
         }

         @Override
         public List<SparkProtos.WorldStatistics.DataPack> getDataPacksList() {
            return Collections.unmodifiableList(this.instance.getDataPacksList());
         }

         @Override
         public int getDataPacksCount() {
            return this.instance.getDataPacksCount();
         }

         @Override
         public SparkProtos.WorldStatistics.DataPack getDataPacks(int index) {
            return this.instance.getDataPacks(index);
         }

         public SparkProtos.WorldStatistics.Builder setDataPacks(int index, SparkProtos.WorldStatistics.DataPack value) {
            this.copyOnWrite();
            this.instance.setDataPacks(index, value);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder setDataPacks(int index, SparkProtos.WorldStatistics.DataPack.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.setDataPacks(index, builderForValue.build());
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addDataPacks(SparkProtos.WorldStatistics.DataPack value) {
            this.copyOnWrite();
            this.instance.addDataPacks(value);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addDataPacks(int index, SparkProtos.WorldStatistics.DataPack value) {
            this.copyOnWrite();
            this.instance.addDataPacks(index, value);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addDataPacks(SparkProtos.WorldStatistics.DataPack.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.addDataPacks(builderForValue.build());
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addDataPacks(int index, SparkProtos.WorldStatistics.DataPack.Builder builderForValue) {
            this.copyOnWrite();
            this.instance.addDataPacks(index, builderForValue.build());
            return this;
         }

         public SparkProtos.WorldStatistics.Builder addAllDataPacks(Iterable<? extends SparkProtos.WorldStatistics.DataPack> values) {
            this.copyOnWrite();
            this.instance.addAllDataPacks(values);
            return this;
         }

         public SparkProtos.WorldStatistics.Builder clearDataPacks() {
            this.copyOnWrite();
            this.instance.clearDataPacks();
            return this;
         }

         public SparkProtos.WorldStatistics.Builder removeDataPacks(int index) {
            this.copyOnWrite();
            this.instance.removeDataPacks(index);
            return this;
         }
      }

      public static final class Chunk
         extends GeneratedMessageLite<SparkProtos.WorldStatistics.Chunk, SparkProtos.WorldStatistics.Chunk.Builder>
         implements SparkProtos.WorldStatistics.ChunkOrBuilder {
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               ...
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{
                     "x_", "z_", "totalEntities_", "entityCounts_", SparkProtos.WorldStatistics.Chunk.EntityCountsDefaultEntryHolder.defaultEntry
                  };
                  String info = "\u0000\u0004\u0000\u0000\u0001\u0004\u0004\u0001\u0000\u0000\u0001\u0004\u0002\u0004\u0003\u0004\u00042";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.WorldStatistics.Chunk, SparkProtos.WorldStatistics.Chunk.Builder>
            implements SparkProtos.WorldStatistics.ChunkOrBuilder {
            private Builder() {
         ...
         private static final class EntityCountsDefaultEntryHolder {
            static final MapEntryLite<String, Integer> defaultEntry = MapEntryLite.newDefaultInstance(
      ...
      public static final class DataPack
         extends GeneratedMessageLite<SparkProtos.WorldStatistics.DataPack, SparkProtos.WorldStatistics.DataPack.Builder>
         implements SparkProtos.WorldStatistics.DataPackOrBuilder {
         public static final int NAME_FIELD_NUMBER = 1;
         private String name_ = "";
         ...
         private static final SparkProtos.WorldStatistics.DataPack DEFAULT_INSTANCE;
         private static volatile Parser<SparkProtos.WorldStatistics.DataPack> PARSER;
         ...
         public static SparkProtos.WorldStatistics.DataPack parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(InputStream input) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.DataPack parseDelimitedFrom(InputStream input) throws IOException {
            return parseDelimitedFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.WorldStatistics.DataPack parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(CodedInputStream input) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.WorldStatistics.DataPack parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.DataPack.Builder newBuilder() {
            return DEFAULT_INSTANCE.createBuilder();
         }

         public static SparkProtos.WorldStatistics.DataPack.Builder newBuilder(SparkProtos.WorldStatistics.DataPack prototype) {
            // $VF: Couldn't be decompiled
            // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
            // java.lang.StackOverflowError
            //   at org.jetbrains.java.decompiler.struct.StructContext.instanceOf(StructContext.java:279)
            ...
            //
            // Bytecode:
            // 0: getstatic me/lucko/spark/proto/SparkProtos$WorldStatistics$DataPack.DEFAULT_INSTANCE Lme/lucko/spark/proto/SparkProtos$WorldStatistics$DataPack;
            // 3: aload 0
            // 4: invokevirtual me/lucko/spark/proto/SparkProtos$WorldStatistics$DataPack.createBuilder (Lme/lucko/spark/lib/protobuf/GeneratedMessageLite;)Lme/lucko/spark/lib/protobuf/GeneratedMessageLite$Builder;
            // 7: checkcast me/lucko/spark/proto/SparkProtos$WorldStatistics$DataPack$Builder
            // a: areturn
         }
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               case NEW_MUTABLE_INSTANCE:
                  return new SparkProtos.WorldStatistics.DataPack();
               case NEW_BUILDER:
                  return new SparkProtos.WorldStatistics.DataPack.Builder();
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{"name_", "description_", "source_"};
                  String info = "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0000\u0000\u0000\u0001Ȉ\u0002Ȉ\u0003Ȉ";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
               case GET_PARSER:
                  Parser<SparkProtos.WorldStatistics.DataPack> parser = PARSER;
                  if (parser == null) {
                     synchronized (SparkProtos.WorldStatistics.DataPack.class) {
                        parser = PARSER;
                        if (parser == null) {
                           parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                           PARSER = parser;
         ...
         public static SparkProtos.WorldStatistics.DataPack getDefaultInstance() {
            return DEFAULT_INSTANCE;
         }

         public static Parser<SparkProtos.WorldStatistics.DataPack> parser() {
            return DEFAULT_INSTANCE.getParserForType();
         }

         static {
            SparkProtos.WorldStatistics.DataPack defaultInstance = new SparkProtos.WorldStatistics.DataPack();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(SparkProtos.WorldStatistics.DataPack.class, defaultInstance);
         }

         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.WorldStatistics.DataPack, SparkProtos.WorldStatistics.DataPack.Builder>
            implements SparkProtos.WorldStatistics.DataPackOrBuilder {
            private Builder() {
               super(SparkProtos.WorldStatistics.DataPack.DEFAULT_INSTANCE);
            }
            ...
            public SparkProtos.WorldStatistics.DataPack.Builder setName(String value) {
               this.copyOnWrite();
               this.instance.setName(value);
               return this;
            }

            public SparkProtos.WorldStatistics.DataPack.Builder clearName() {
               this.copyOnWrite();
               this.instance.clearName();
               return this;
            }

            public SparkProtos.WorldStatistics.DataPack.Builder setNameBytes(ByteString value) {
               this.copyOnWrite();
               this.instance.setNameBytes(value);
               return this;
            }
            ...
            public SparkProtos.WorldStatistics.DataPack.Builder setDescription(String value) {
               this.copyOnWrite();
               this.instance.setDescription(value);
               return this;
            }

            public SparkProtos.WorldStatistics.DataPack.Builder clearDescription() {
               this.copyOnWrite();
               this.instance.clearDescription();
               return this;
            }

            public SparkProtos.WorldStatistics.DataPack.Builder setDescriptionBytes(ByteString value) {
               this.copyOnWrite();
               this.instance.setDescriptionBytes(value);
               return this;
            }
            ...
            public SparkProtos.WorldStatistics.DataPack.Builder setSource(String value) {
               this.copyOnWrite();
               this.instance.setSource(value);
               return this;
            }

            public SparkProtos.WorldStatistics.DataPack.Builder clearSource() {
               this.copyOnWrite();
               this.instance.clearSource();
               return this;
            }

            public SparkProtos.WorldStatistics.DataPack.Builder setSourceBytes(ByteString value) {
               this.copyOnWrite();
               this.instance.setSourceBytes(value);
               return this;
            }
         }
      }
      ...
      public static final class GameRule
         extends GeneratedMessageLite<SparkProtos.WorldStatistics.GameRule, SparkProtos.WorldStatistics.GameRule.Builder>
         implements SparkProtos.WorldStatistics.GameRuleOrBuilder {
         public static final int NAME_FIELD_NUMBER = 1;
         private String name_;
         ...
         private static final SparkProtos.WorldStatistics.GameRule DEFAULT_INSTANCE;
         private static volatile Parser<SparkProtos.WorldStatistics.GameRule> PARSER;
         ...
         public int getWorldValuesCount() {
            return this.internalGetWorldValues().size();
         }

         @Override
         public boolean containsWorldValues(String key) {
            Class<?> keyClass = key.getClass();
            return this.internalGetWorldValues().containsKey(key);
         }

         @Deprecated
         @Override
         public Map<String, String> getWorldValues() {
            return this.getWorldValuesMap();
         }

         @Override
         public Map<String, String> getWorldValuesMap() {
            return Collections.unmodifiableMap(this.internalGetWorldValues());
         }

         @Override
         public String getWorldValuesOrDefault(String key, String defaultValue) {
            Class<?> keyClass = key.getClass();
            Map<String, String> map = this.internalGetWorldValues();
            return map.containsKey(key) ? map.get(key) : defaultValue;
         }

         @Override
         public String getWorldValuesOrThrow(String key) {
            Class<?> keyClass = key.getClass();
            Map<String, String> map = this.internalGetWorldValues();
            if (!map.containsKey(key)) {
               throw new IllegalArgumentException();
         ...
         private Map<String, String> getMutableWorldValuesMap() {
            return this.internalGetMutableWorldValues();
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(ByteBuffer data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(ByteBuffer data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(ByteString data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(ByteString data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(byte[] data) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(byte[] data, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, data, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(InputStream input) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.GameRule parseDelimitedFrom(InputStream input) throws IOException {
            return parseDelimitedFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.WorldStatistics.GameRule parseDelimitedFrom(InputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return parseDelimitedFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(CodedInputStream input) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input);
         }

         public static SparkProtos.WorldStatistics.GameRule parseFrom(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws IOException {
            return GeneratedMessageLite.parseFrom(DEFAULT_INSTANCE, input, extensionRegistry);
         }

         public static SparkProtos.WorldStatistics.GameRule.Builder newBuilder() {
            return DEFAULT_INSTANCE.createBuilder();
         }

         public static SparkProtos.WorldStatistics.GameRule.Builder newBuilder(SparkProtos.WorldStatistics.GameRule prototype) {
            // $VF: Couldn't be decompiled
            // Please report this to the Vineflower issue tracker, at https://github.com/Vineflower/vineflower/issues with a copy of the class file (if you have the rights to distribute it!)
            // java.lang.StackOverflowError
            //   at org.jetbrains.java.decompiler.struct.StructContext.instanceOf(StructContext.java:279)
            ...
            //
            // Bytecode:
            // 0: getstatic me/lucko/spark/proto/SparkProtos$WorldStatistics$GameRule.DEFAULT_INSTANCE Lme/lucko/spark/proto/SparkProtos$WorldStatistics$GameRule;
            // 3: aload 0
            // 4: invokevirtual me/lucko/spark/proto/SparkProtos$WorldStatistics$GameRule.createBuilder (Lme/lucko/spark/lib/protobuf/GeneratedMessageLite;)Lme/lucko/spark/lib/protobuf/GeneratedMessageLite$Builder;
            // 7: checkcast me/lucko/spark/proto/SparkProtos$WorldStatistics$GameRule$Builder
            // a: areturn
         }
         ...
         protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke method, Object arg0, Object arg1) {
            switch (method) {
               case NEW_MUTABLE_INSTANCE:
                  return new SparkProtos.WorldStatistics.GameRule();
               case NEW_BUILDER:
                  return new SparkProtos.WorldStatistics.GameRule.Builder();
               case BUILD_MESSAGE_INFO:
                  Object[] objects = new Object[]{
                     "name_", "defaultValue_", "worldValues_", SparkProtos.WorldStatistics.GameRule.WorldValuesDefaultEntryHolder.defaultEntry
                  };
                  String info = "\u0000\u0003\u0000\u0000\u0001\u0003\u0003\u0001\u0000\u0000\u0001Ȉ\u0002Ȉ\u00032";
                  return newMessageInfo(DEFAULT_INSTANCE, info, objects);
               case GET_DEFAULT_INSTANCE:
                  return DEFAULT_INSTANCE;
               case GET_PARSER:
                  Parser<SparkProtos.WorldStatistics.GameRule> parser = PARSER;
                  if (parser == null) {
                     synchronized (SparkProtos.WorldStatistics.GameRule.class) {
                        parser = PARSER;
                        if (parser == null) {
                           parser = new GeneratedMessageLite.DefaultInstanceBasedParser<>(DEFAULT_INSTANCE);
                           PARSER = parser;
         ...
         public static SparkProtos.WorldStatistics.GameRule getDefaultInstance() {
            return DEFAULT_INSTANCE;
         }

         public static Parser<SparkProtos.WorldStatistics.GameRule> parser() {
            return DEFAULT_INSTANCE.getParserForType();
         }

         static {
            SparkProtos.WorldStatistics.GameRule defaultInstance = new SparkProtos.WorldStatistics.GameRule();
            DEFAULT_INSTANCE = defaultInstance;
            GeneratedMessageLite.registerDefaultInstance(SparkProtos.WorldStatistics.GameRule.class, defaultInstance);
         }

         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.WorldStatistics.GameRule, SparkProtos.WorldStatistics.GameRule.Builder>
            implements SparkProtos.WorldStatistics.GameRuleOrBuilder {
            private Builder() {
               super(SparkProtos.WorldStatistics.GameRule.DEFAULT_INSTANCE);
            }
            ...
            public SparkProtos.WorldStatistics.GameRule.Builder setName(String value) {
               this.copyOnWrite();
               this.instance.setName(value);
               return this;
            }

            public SparkProtos.WorldStatistics.GameRule.Builder clearName() {
               this.copyOnWrite();
               this.instance.clearName();
               return this;
            }

            public SparkProtos.WorldStatistics.GameRule.Builder setNameBytes(ByteString value) {
               this.copyOnWrite();
               this.instance.setNameBytes(value);
               return this;
            }
            ...
            public SparkProtos.WorldStatistics.GameRule.Builder setDefaultValue(String value) {
               this.copyOnWrite();
               this.instance.setDefaultValue(value);
               return this;
            }

            public SparkProtos.WorldStatistics.GameRule.Builder clearDefaultValue() {
               this.copyOnWrite();
               this.instance.clearDefaultValue();
               return this;
            }

            public SparkProtos.WorldStatistics.GameRule.Builder setDefaultValueBytes(ByteString value) {
               this.copyOnWrite();
            ...
            @Override
            public int getWorldValuesCount() {
               return this.instance.getWorldValuesMap().size();
            }

            @Override
            public boolean containsWorldValues(String key) {
               Class<?> keyClass = key.getClass();
               return this.instance.getWorldValuesMap().containsKey(key);
            }

            public SparkProtos.WorldStatistics.GameRule.Builder clearWorldValues() {
               this.copyOnWrite();
               this.instance.getMutableWorldValuesMap().clear();
               return this;
            }

            public SparkProtos.WorldStatistics.GameRule.Builder removeWorldValues(String key) {
               Class<?> keyClass = key.getClass();
               this.copyOnWrite();
               this.instance.getMutableWorldValuesMap().remove(key);
               return this;
            }
            ...
            @Override
            public Map<String, String> getWorldValuesMap() {
               return Collections.unmodifiableMap(this.instance.getWorldValuesMap());
            }

            @Override
            public String getWorldValuesOrDefault(String key, String defaultValue) {
               Class<?> keyClass = key.getClass();
               Map<String, String> map = this.instance.getWorldValuesMap();
               return map.containsKey(key) ? map.get(key) : defaultValue;
            }
            ...
            public SparkProtos.WorldStatistics.GameRule.Builder putWorldValues(String key, String value) {
               Class<?> keyClass = key.getClass();
               Class<?> valueClass = value.getClass();
               this.copyOnWrite();
               this.instance.getMutableWorldValuesMap().put(key, value);
               return this;
            }

            public SparkProtos.WorldStatistics.GameRule.Builder putAllWorldValues(Map<String, String> values) {
               this.copyOnWrite();
               this.instance.getMutableWorldValuesMap().putAll(values);
               return this;
            }
         }
      ...
      public interface GameRuleOrBuilder extends MessageLiteOrBuilder {
         ...
         boolean containsWorldValues(String var1);
         ...
         String getWorldValuesOrDefault(String var1, String var2);

         String getWorldValuesOrThrow(String var1);
      }

      public static final class Region
         extends GeneratedMessageLite<SparkProtos.WorldStatistics.Region, SparkProtos.WorldStatistics.Region.Builder>
         implements SparkProtos.WorldStatistics.RegionOrBuilder {
         public static final int TOTAL_ENTITIES_FIELD_NUMBER = 1;
         private int totalEntities_;
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.WorldStatistics.Region, SparkProtos.WorldStatistics.Region.Builder>
            implements SparkProtos.WorldStatistics.RegionOrBuilder {
            private Builder() {
      ...
      public static final class World
         extends GeneratedMessageLite<SparkProtos.WorldStatistics.World, SparkProtos.WorldStatistics.World.Builder>
         implements SparkProtos.WorldStatistics.WorldOrBuilder {
         public static final int NAME_FIELD_NUMBER = 1;
         private String name_ = "";
         ...
         public SparkProtos.WorldStatistics.Region getRegions(int index) {
            return this.regions_.get(index);
         }
         ...
         public static final class Builder
            extends GeneratedMessageLite.Builder<SparkProtos.WorldStatistics.World, SparkProtos.WorldStatistics.World.Builder>
            implements SparkProtos.WorldStatistics.WorldOrBuilder {
            private Builder() {
   ...
   public interface WorldStatisticsOrBuilder extends MessageLiteOrBuilder {
      ...
      List<SparkProtos.WorldStatistics.GameRule> getGameRulesList();

      SparkProtos.WorldStatistics.GameRule getGameRules(int var1);

      int getGameRulesCount();

      List<SparkProtos.WorldStatistics.DataPack> getDataPacksList();

      SparkProtos.WorldStatistics.DataPack getDataPacks(int var1);
