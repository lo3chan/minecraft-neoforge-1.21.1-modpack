...
final class TextReplacementRenderer implements ComponentRenderer<TextReplacementRenderer.State> {
      ...
      if (!state.running) {
         ...
         if (component instanceof TextComponent) {
            ...
            for (int size = args.size(); i < size; i++) {
               ...
               TranslationArgument replaced = original.value() instanceof Component
            ...
            if (newArgs != null) {
               modified = ((TranslatableComponent)component).arguments(newArgs);
            }
         }
   ...
   static final class State {
      ...
      State(
         ...
         @NotNull final BiFunction<MatchResult, TextComponent.Builder, ComponentLike> replacement,
         @NotNull final TextReplacementConfig.Condition continuer
      ) {
