...
public interface Component extends ComponentBuilderApplicable, ComponentLike, Examinable, HoverEventSource<Component>, StyleGetter, StyleSetter<Component> {
   ...
   @NotNull
   static BlockNBTComponent blockNBT(
      @NotNull final String nbtPath, final boolean interpret, @Nullable final ComponentLike separator, @NotNull final BlockNBTComponent.Pos pos
   ) {
   ...
   static KeybindComponent keybind(@NotNull final KeybindComponent.KeybindLike keybind, @NotNull final Style style) {
      return KeybindComponentImpl.create(
         Collections.emptyList(), Objects.requireNonNull(style, "style"), Objects.requireNonNull(keybind, "keybind").asKeybind()
      );
   }
   ...
   @NotNull
   static KeybindComponent keybind(
      @NotNull final KeybindComponent.KeybindLike keybind, @Nullable final TextColor color, @NotNull final TextDecoration... decorations
   ) {
   ...
   @NotNull
   static KeybindComponent keybind(
      @NotNull final KeybindComponent.KeybindLike keybind, @Nullable final TextColor color, @NotNull final Set<TextDecoration> decorations
   ) {
      return keybind(Objects.requireNonNull(keybind, "keybind").asKeybind(), Style.style(color, decorations));
   }
   ...
   @NotNull
   static StorageNBTComponent storageNBT(
      @NotNull final String nbtPath, final boolean interpret, @Nullable final ComponentLike separator, @NotNull final Key storage
   ) {
   ...
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), fallback, Style.empty());
   }
   ...
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), fallback, style);
   }
   ...
   static TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final StyleBuilderApplicable... style) {
      return translatable(Objects.requireNonNull(key, "key"), fallback, Style.style(style));
   }
   ...
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Iterable<StyleBuilderApplicable> style
   ) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), fallback, Style.style(style));
   }
   ...
   static TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final ComponentLike... args) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), fallback, args);
   }
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final String key, @Nullable final String fallback, @NotNull final Style style, @NotNull final ComponentLike... args
   ) {
      return TranslatableComponentImpl.create(
         Collections.emptyList(), Objects.requireNonNull(style, "style"), key, fallback, Objects.requireNonNull(args, "args")
      );
   }
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style, @NotNull final ComponentLike... args
   ) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), fallback, style, args);
   }
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final String key, @Nullable final String fallback, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args
   ) {
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args
   ) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), fallback, style, args);
   }
   ...
   static TranslatableComponent translatable(
      ...
      @NotNull final Iterable<StyleBuilderApplicable> style
   ) {
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable,
      @Nullable final String fallback,
      @NotNull final List<? extends ComponentLike> args,
      @NotNull final Iterable<StyleBuilderApplicable> style
   ) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), fallback, args, style);
   }
   ...
   static TranslatableComponent translatable(
      ...
      @Nullable final String fallback,
      @NotNull final List<? extends ComponentLike> args,
      @NotNull final StyleBuilderApplicable... style
   ) {
      return TranslatableComponentImpl.create(Collections.emptyList(), Style.style(style), key, fallback, Objects.requireNonNull(args, "args"));
   }
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable, @Nullable final TextColor color, @NotNull final TextDecoration... decorations
   ) {
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable, @Nullable final TextColor color, @NotNull final Set<TextDecoration> decorations
   ) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), color, decorations);
   }
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final String key, @Nullable final TextColor color, @NotNull final Set<TextDecoration> decorations, @NotNull final ComponentLike... args
   ) {
   ...
   static TranslatableComponent translatable(
      ...
      @NotNull final Set<TextDecoration> decorations,
   ...
   @NotNull
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args
   ) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), style, args);
   }
   ...
   static TranslatableComponent translatable(
      @NotNull final Translatable translatable, @Nullable final TextColor color, @NotNull final List<? extends ComponentLike> args
   ) {
      return translatable(Objects.requireNonNull(translatable, "translatable").translationKey(), color, args);
   }
   ...
   default Component replaceText(
      @NotNull final Pattern pattern, @NotNull final Function<TextComponent.Builder, ComponentLike> replacement, final int numberOfReplacements
   ) {
   ...
   @NotNull
   default Component replaceText(
      @NotNull final String search, @Nullable final ComponentLike replacement, @NotNull final IntFunction2<PatternReplacementResult> fn
   ) {
   ...
   default Component replaceText(
      ...
      @NotNull final Function<TextComponent.Builder, ComponentLike> replacement,
      @NotNull final IntFunction2<PatternReplacementResult> fn
   ) {
