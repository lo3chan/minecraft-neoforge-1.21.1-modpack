...
final class EntityNBTComponentImpl extends NBTComponentImpl<EntityNBTComponent, EntityNBTComponent.Builder> implements EntityNBTComponent {
   ...
   public EntityNBTComponent nbtPath(@NotNull final String nbtPath) {
      return (EntityNBTComponent)(Objects.equals(this.nbtPath, nbtPath)
         ? this
         : create(this.children, this.style, nbtPath, this.interpret, this.separator, this.selector));
   }

   @NotNull
   public EntityNBTComponent interpret(final boolean interpret) {
      return (EntityNBTComponent)(this.interpret == interpret
         ? this
         : create(this.children, this.style, this.nbtPath, interpret, this.separator, this.selector));
   }
   ...
   public EntityNBTComponent selector(@NotNull final String selector) {
      return (EntityNBTComponent)(Objects.equals(this.selector, selector)
         ? this
         : create(this.children, this.style, this.nbtPath, this.interpret, this.separator, selector));
   }
