...
final class BlockNBTComponentImpl extends NBTComponentImpl<BlockNBTComponent, BlockNBTComponent.Builder> implements BlockNBTComponent {
   ...
   static BlockNBTComponent create(
      ...
      @NotNull final BlockNBTComponent.Pos pos
   ) {
   ...
   public BlockNBTComponent nbtPath(@NotNull final String nbtPath) {
      return (BlockNBTComponent)(Objects.equals(this.nbtPath, nbtPath)
         ? this
         : create(this.children, this.style, nbtPath, this.interpret, this.separator, this.pos));
   }
