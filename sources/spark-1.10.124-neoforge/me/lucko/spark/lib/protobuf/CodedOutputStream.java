...
public abstract class CodedOutputStream extends ByteOutput {
   ...
   @InlineMe(
      ...
      imports = {"me.lucko.spark.lib.protobuf.CodedOutputStream"}
   )
   ...
   private abstract static class AbstractBufferedEncoder extends CodedOutputStream {
      ...
      final void bufferUInt32NoTag(int value) {
         if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
            ...
            while ((value & -128) != 0) {
               UnsafeUtil.putByte(this.buffer, this.position++, (byte)((value | 128) & 0xFF));
               value >>>= 7;
            }
            ...
            while ((value & -128) != 0) {
               this.buffer[this.position++] = (byte)((value | 128) & 0xFF);
               this.totalBytesWritten++;
               value >>>= 7;
            }
      ...
      final void bufferUInt64NoTag(long value) {
         if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
            ...
            while ((value & -128L) != 0L) {
               UnsafeUtil.putByte(this.buffer, this.position++, (byte)(((int)value | 128) & 0xFF));
               value >>>= 7;
            }
            ...
            while ((value & -128L) != 0L) {
               this.buffer[this.position++] = (byte)(((int)value | 128) & 0xFF);
               this.totalBytesWritten++;
               value >>>= 7;
            }
      ...
      final void bufferFixed64NoTag(long value) {
         this.buffer[this.position++] = (byte)(value & 255L);
         this.buffer[this.position++] = (byte)(value >> 8 & 255L);
         this.buffer[this.position++] = (byte)(value >> 16 & 255L);
         this.buffer[this.position++] = (byte)(value >> 24 & 255L);
   ...
   private static final class SafeDirectNioEncoder extends CodedOutputStream {
      ...
      public void writeUInt32NoTag(int value) throws IOException {
         try {
            while ((value & -128) != 0) {
               this.buffer.put((byte)((value | 128) & 0xFF));
               value >>>= 7;
            }
      ...
      public void writeUInt64NoTag(long value) throws IOException {
         try {
            while ((value & -128L) != 0L) {
               this.buffer.put((byte)(((int)value | 128) & 0xFF));
               value >>>= 7;
            }
      ...
      public void writeUInt32NoTag(int value) throws IOException {
         if (this.position > this.oneVarintLimit) {
            while (this.position < this.limit) {
               ...
               UnsafeUtil.putByte(this.position++, (byte)((value | 128) & 0xFF));
               value >>>= 7;
            }
      ...
      public void writeUInt64NoTag(long value) throws IOException {
         if (this.position > this.oneVarintLimit) {
            while (this.position < this.limit) {
               ...
               UnsafeUtil.putByte(this.position++, (byte)(((int)value | 128) & 0xFF));
               value >>>= 7;
            }
