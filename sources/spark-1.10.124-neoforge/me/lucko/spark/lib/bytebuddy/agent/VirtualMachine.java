...
import me.lucko.spark.lib.bytebuddy.agent.utility.nullability.UnknownNull;
...
public interface VirtualMachine {
   ...
   void loadAgent(String var1, @MaybeNull String var2) throws IOException;

   void loadAgentPath(String var1) throws IOException;

   void loadAgentPath(String var1, @MaybeNull String var2) throws IOException;

   void loadAgentLibrary(String var1) throws IOException;

   void loadAgentLibrary(String var1, @MaybeNull String var2) throws IOException;
   ...
   public static class ForHotSpot extends VirtualMachine.AbstractBase {
      ...
      public static VirtualMachine attach(String processId) throws IOException {
         if (Platform.isWindows()) {
            ...
            return Platform.isSolaris()
               ? attach(processId, new VirtualMachine.ForHotSpot.Connection.ForJnaSolarisDoor.Factory(15, 100L, TimeUnit.MILLISECONDS))
               : attach(processId, VirtualMachine.ForHotSpot.Connection.ForJnaPosixSocket.Factory.withDefaultTemporaryFolder(15, 100L, TimeUnit.MILLISECONDS));
         }
      }
      ...
      protected void load(String file, boolean absolute, @MaybeNull String argument) throws IOException {
         VirtualMachine.ForHotSpot.Connection.Response response = this.connection
            .execute("1", "load", "instrument", Boolean.toString(absolute), argument == null ? file : file + "=" + argument);
      ...
      public interface Connection extends Closeable {
         ...
         public interface Factory {
            ...
            public abstract static class ForSocketFile implements VirtualMachine.ForHotSpot.Connection.Factory {
               ...
               @SuppressFBWarnings(
                  ...
                  justification = "File name convention is specified."
               )
               @Override
         ...
         public static class ForJnaPosixSocket extends VirtualMachine.ForHotSpot.Connection.OnPersistentByteChannel<Integer> {
            ...
            public static class Factory extends VirtualMachine.ForHotSpot.Connection.Factory.ForSocketFile {
               private final VirtualMachine.ForHotSpot.Connection.ForJnaPosixSocket.PosixLibrary library = (VirtualMachine.ForHotSpot.Connection.ForJnaPosixSocket.PosixLibrary)Native.loadLibrary(
                  "c", VirtualMachine.ForHotSpot.Connection.ForJnaPosixSocket.PosixLibrary.class
               );
               ...
               public static VirtualMachine.ForHotSpot.Connection.Factory withDefaultTemporaryFolder(int attempts, long pause, TimeUnit timeUnit) {
                  ...
                  if (Platform.isMac()) {
                     VirtualMachine.ForHotSpot.Connection.ForJnaPosixSocket.Factory.MacLibrary library = (VirtualMachine.ForHotSpot.Connection.ForJnaPosixSocket.Factory.MacLibrary)Native.loadLibrary(
                        "c", VirtualMachine.ForHotSpot.Connection.ForJnaPosixSocket.Factory.MacLibrary.class
                     );
            ...
            protected interface PosixLibrary extends Library {
               ...
               public static class SocketAddress extends Structure {
                  @SuppressFBWarnings(
                     ...
                     justification = "Field required by native implementation."
                  )
         ...
         public static class ForJnaSolarisDoor implements VirtualMachine.ForHotSpot.Connection {
            ...
            @SuppressFBWarnings(
               value = {"UWF_UNWRITTEN_PUBLIC_OR_PROTECTED_FIELD", "URF_UNREAD_PUBLIC_OR_PROTECTED_FIELD"},
               justification = "This pattern is required for use of JNA."
            )
            @Override
            ...
            public static class Factory extends VirtualMachine.ForHotSpot.Connection.Factory.ForSocketFile {
               private final VirtualMachine.ForHotSpot.Connection.ForJnaSolarisDoor.SolarisLibrary library = (VirtualMachine.ForHotSpot.Connection.ForJnaSolarisDoor.SolarisLibrary)Native.loadLibrary(
                  "c", VirtualMachine.ForHotSpot.Connection.ForJnaSolarisDoor.SolarisLibrary.class
               );
         ...
         public static class ForJnaWindowsNamedPipe implements VirtualMachine.ForHotSpot.Connection {
            ...
            protected ForJnaWindowsNamedPipe(
               VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.WindowsLibrary library,
            ...
            public VirtualMachine.ForHotSpot.Connection.Response execute(String protocol, String... argument) {
               if (!"1".equals(protocol)) {
                  ...
                  throw new IllegalArgumentException("Cannot supply more then four arguments to Windows attach mechanism: " + Arrays.<String>asList(argument));
               } else {
                  String name = "\\\\.\\pipe\\javatool" + Math.abs(this.random.nextInt() + 1);
                  SECURITY_ATTRIBUTES sa = this.createSecurityAttributesToAllowMediumIntegrity();
                  HANDLE pipe = Kernel32.INSTANCE.CreateNamedPipe(name, 1, 0, 1, 4096, 8192, 0, sa);
                  if (pipe == null) {
                     throw new Win32Exception(Native.getLastError());
                  } else {
                     try {
                        LPVOID data = this.attachLibrary
                        ...
                        if (data == null) {
                           ...
                           VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.NamedPipeResponse var22;
                           try {
                              ...
                              try {
                                 ...
                                 var22 = new VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.NamedPipeResponse(pipe);
                              } finally {
                        ...
                        if (!Kernel32.INSTANCE.CloseHandle(pipe)) {
                           throw new Win32Exception(Native.getLastError());
                        } else if (var21 instanceof RuntimeException) {
               ...
               if (!Advapi32.INSTANCE.CreateWellKnownSid(1, null, pSidEverybody, new IntByReference(68))) {
                  ...
                  if (!Advapi32.INSTANCE.CreateWellKnownSid(31, null, pSidSystem, new IntByReference(68))) {
                     ...
                     if (!Advapi32.INSTANCE.CreateWellKnownSid(26, null, pSidAdmin, new IntByReference(68))) {
                        ...
                        cbAcl += Native.getNativeSize(ACCESS_ALLOWED_ACE.class, null) * 3;
                        ...
                        if (!Advapi32.INSTANCE.InitializeAcl(pAcl, cbAcl, 2)) {
                           throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                        } else if (!Advapi32.INSTANCE.AddAccessAllowedAce(pAcl, 2, -1073741824, pSidEverybody)) {
                           throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                        } else if (!Advapi32.INSTANCE.AddAccessAllowedAce(pAcl, 2, 268435456, pSidSystem)) {
                           throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                        } else if (!Advapi32.INSTANCE.AddAccessAllowedAce(pAcl, 2, 268435456, pSidAdmin)) {
                           throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                        } else {
                           SECURITY_DESCRIPTOR sd = new SECURITY_DESCRIPTOR(65536);
                           if (!Advapi32.INSTANCE.InitializeSecurityDescriptor(sd, 1)) {
                              throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                           } else if (!Advapi32.INSTANCE.SetSecurityDescriptorDacl(sd, true, pAcl, false)) {
                              throw new Win32Exception(Kernel32.INSTANCE.GetLastError());
                           } else {
            ...
            public static class Factory implements VirtualMachine.ForHotSpot.Connection.Factory {
               ...
               private final VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.WindowsLibrary library = (VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.WindowsLibrary)Native.loadLibrary(
                  "kernel32", VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.WindowsLibrary.class, W32APIOptions.DEFAULT_OPTIONS
               );
               private final VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.WindowsAttachLibrary attachLibrary = (VirtualMachine.ForHotSpot.Connection.ForJnaWindowsNamedPipe.WindowsAttachLibrary)Native.loadLibrary(
                  System.getProperty("me.lucko.spark.lib.bytebuddy.library.name", "attach_hotspot_windows"),
            ...
            protected interface WindowsAttachLibrary extends StdCallLibrary {
               ...
               LPVOID allocate_remote_argument(
                  HANDLE var1, String var2, @MaybeNull String var3, @MaybeNull String var4, @MaybeNull String var5, @MaybeNull String var6
               );
            }
            ...
            protected interface WindowsLibrary extends StdCallLibrary {
               ...
               HANDLE CreateRemoteThread(
                  HANDLE var1, @MaybeNull SECURITY_ATTRIBUTES var2, int var3, Pointer var4, Pointer var5, @MaybeNull DWORD var6, @MaybeNull Pointer var7
               );
   ...
   public static class ForOpenJ9 extends VirtualMachine.AbstractBase {
      ...
      public static VirtualMachine attach(String processId) throws IOException {
         return attach(
            processId,
            5000,
            (VirtualMachine.ForOpenJ9.Dispatcher)(Platform.isWindows()
               ? new VirtualMachine.ForOpenJ9.Dispatcher.ForJnaWindowsEnvironment()
               : new VirtualMachine.ForOpenJ9.Dispatcher.ForJnaPosixEnvironment(15, 100L, TimeUnit.MILLISECONDS))
         );
      }
      ...
      public static VirtualMachine attach(String processId, int timeout, VirtualMachine.ForOpenJ9.Dispatcher dispatcher) throws IOException {
         File directory = new File(System.getProperty("com.ibm.tools.attach.directory", dispatcher.getTemporaryFolder(processId)), ".com_ibm_tools_attach");
         long userId = dispatcher.userId();
         RandomAccessFile attachLock = new RandomAccessFile(new File(directory, "_attachlock"), "rw");

         VirtualMachine.ForOpenJ9 var287;
         try {
            ...
            try {
                     ...
                     for (File aVmFolder : vmFolder) {
                        if (aVmFolder.isDirectory() && (userId == 0L || dispatcher.getOwnerIdOf(aVmFolder) == userId)) {
                           ...
                           if (attachInfo.isFile()) {
                              ...
                              int pid = Integer.parseInt(virtualMachine.getProperty("processId"));

                              long targetUserId;
                              try {
                                 targetUserId = Long.parseLong(virtualMachine.getProperty("userUid"));
                              } catch (NumberFormatException var253) {
                                 targetUserId = 0L;
                              }
                              ...
                              if (pid == 0L || dispatcher.isExistingProcess(pid)) {
               ...
               try {
                  ...
                  File receiver = new File(directory, var263.getProperty("vmId"));
                  String key;
                  ...
                  long targetUserIdx;
                  try {
                     targetUserIdx = Long.parseLong(var263.getProperty("userUid"));
                  } catch (NumberFormatException var251) {
                     targetUserIdx = 0L;
                  }
                  ...
                  try {
                     ...
                     if (userId == 0L && targetUserIdx != 0L) {
                        dispatcher.chownFileToUser(reply, targetUserIdx);
                     }
                     ...
                     try {
                        ...
                        for (Properties virtualMachinex : virtualMachines) {
                           if (!virtualMachinex.getProperty("processId").equalsIgnoreCase(pid)) {
                              ...
                              RandomAccessFile syncFile = new RandomAccessFile(
                                 attachNotificationSync == null ? new File(directory, "attachNotificationSync") : new File(attachNotificationSync), "rw"
                              );

                              try {
                                 var273.put(syncFile, syncFile.getChannel().lock());
                              } catch (IOException var249) {
                                 syncFile.close();
                              }
                           }
                        }
                        ...
                        boolean global = Boolean.parseBoolean(var263.getProperty("globalSemaphore"));
                        ...
                        try {
                           ...
                           var287 = new VirtualMachine.ForOpenJ9(socket);
                        } finally {
                           dispatcher.decrementSemaphore(directory, "_notifier", global, notifications);
                        }
                     } finally {
                        for (Entry<RandomAccessFile, FileLock> entry : var273.entrySet()) {
                           try {
                              try {
      ...
      public interface Dispatcher {
         String getTemporaryFolder(String var1);
         ...
         void chownFileToUser(File var1, long var2);
         ...
         public static class ForJnaPosixEnvironment implements VirtualMachine.ForOpenJ9.Dispatcher {
            ...
            public ForJnaPosixEnvironment(int attempts, long pause, TimeUnit timeUnit) {
               ...
               this.pause = pause;
               this.timeUnit = timeUnit;
               this.library = (VirtualMachine.ForOpenJ9.Dispatcher.ForJnaPosixEnvironment.PosixLibrary)Native.loadLibrary(
                  "c", VirtualMachine.ForOpenJ9.Dispatcher.ForJnaPosixEnvironment.PosixLibrary.class
               );
            }
            ...
            @SuppressFBWarnings(
               ...
               justification = "The stream life-cycle is bound to its process."
            )
            @Override
            public int getOwnerIdOf(File file) {
               try {
                  ...
                  throw new IllegalStateException("Unable to execute stat command", var10);
               }
            }
            ...
            @SuppressFBWarnings(
               ...
               justification = "Modifier is required by JNA."
            )
            ...
            protected interface PosixLibrary extends Library {
               ...
               int chown(String var1, long var2) throws LastErrorException;
         ...
         public static class ForJnaWindowsEnvironment implements VirtualMachine.ForOpenJ9.Dispatcher {
            ...
            private final VirtualMachine.ForOpenJ9.Dispatcher.ForJnaWindowsEnvironment.WindowsLibrary library = (VirtualMachine.ForOpenJ9.Dispatcher.ForJnaWindowsEnvironment.WindowsLibrary)Native.loadLibrary(
               "kernel32", VirtualMachine.ForOpenJ9.Dispatcher.ForJnaWindowsEnvironment.WindowsLibrary.class, W32APIOptions.DEFAULT_OPTIONS
            );
            ...
            private VirtualMachine.ForOpenJ9.Dispatcher.ForJnaWindowsEnvironment.AttachmentHandle openSemaphore(File directory, String name, boolean global) {
               ...
               try {
                  ...
                  try {
                     securityAttributes.length = new DWORD(securityAttributes.size());
            ...
            protected interface WindowsLibrary extends StdCallLibrary {
               ...
               @MaybeNull
               HANDLE CreateSemaphoreW(@MaybeNull SECURITY_ATTRIBUTES var1, long var2, long var4, String var6);

               boolean ReleaseSemaphore(HANDLE var1, long var2, @MaybeNull Long var4);

               @MaybeNull
               HANDLE CreateMutex(
                  VirtualMachine.ForOpenJ9.Dispatcher.ForJnaWindowsEnvironment.WindowsLibrary.SecurityAttributes var1, boolean var2, String var3
               );
