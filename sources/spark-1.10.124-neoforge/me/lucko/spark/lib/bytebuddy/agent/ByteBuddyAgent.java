...
import me.lucko.spark.lib.bytebuddy.agent.utility.nullability.AlwaysNull;
...
public class ByteBuddyAgent {
   ...
   private static final ByteBuddyAgent.AttachmentTypeEvaluator ATTACHMENT_TYPE_EVALUATOR = doPrivileged(
      ByteBuddyAgent.AttachmentTypeEvaluator.InstallationAction.INSTANCE
   );
   ...
   private static <T> T doPrivileged(PrivilegedAction<T> action) {
      try {
         ...
         throw new IllegalStateException("Failed to invoke access controller", var3.getTargetException());
      } catch (IllegalAccessException var4) {
         throw new IllegalStateException("Failed to access access controller", var4);
      } catch (NoSuchMethodException var5) {
         throw new IllegalStateException("Failed to resolve well-known access controller method", var5);
      }
   }
   ...
   public static void attach(
      File agentJar, ByteBuddyAgent.ProcessProvider processProvider, @MaybeNull String argument, ByteBuddyAgent.AttachmentProvider attachmentProvider
   ) {
   ...
   public static void attachNative(
      File agentLibrary, ByteBuddyAgent.ProcessProvider processProvider, @MaybeNull String argument, ByteBuddyAgent.AttachmentProvider attachmentProvider
   ) {
   ...
   private static void installExternal(
      ByteBuddyAgent.AttachmentProvider.Accessor.ExternalAttachment externalAttachment,
      String processId,
      File agent,
      boolean isNative,
      @MaybeNull String argument
      ...
      try {
         ...
         if (new ProcessBuilder(
                  ...
                  "-Dnet.bytebuddy.agent.attacher.dump=" + System.getProperty("me.lucko.spark.lib.bytebuddy.agent.attacher.dump", ""),
                  "-cp",
                  classPath.toString(),
            ...
            throw new IllegalStateException(
               "Could not self-attach to current VM using external process - set a property net.bytebuddy.agent.attacher.dump to dump the process output to a file at the specified location"
            );
         }
      } finally {
               ...
               if (codeSource == null) {
                  ...
                  if (!location.getProtocol().equals("file")) {
                     ...
                     try {
                        ...
                        return file.getPath().contains("=") ? CANNOT_SELF_RESOLVE : file;
                  ...
                  if (!location.getProtocol().equals("file")) {
                     ...
                     if (agentJar.isFile() && agentJar.canRead()) {
                        ...
                        try {
                           ...
                           if (!Installer.class.getName().equals(attributes.getValue("Agent-Class"))
   ...
   public interface AttachmentProvider {
      ...
      public interface Accessor {
         ...
         public abstract static class Simple implements ByteBuddyAgent.AttachmentProvider.Accessor {
            ...
            public static ByteBuddyAgent.AttachmentProvider.Accessor of(@MaybeNull ClassLoader classLoader, File... classPath) {
               try {
                  return new ByteBuddyAgent.AttachmentProvider.Accessor.Simple.WithExternalAttachment(
                     Class.forName("com.sun.tools.attach.VirtualMachine", false, classLoader), Arrays.asList(classPath)
                  );
            ...
            public static ByteBuddyAgent.AttachmentProvider.Accessor ofJ9() {
               try {
                  return new ByteBuddyAgent.AttachmentProvider.Accessor.Simple.WithExternalAttachment(
                     ClassLoader.getSystemClassLoader().loadClass("com.ibm.tools.attach.VirtualMachine"), Collections.emptyList()
                  );
      ...
      public static enum ForEmulatedAttachment implements ByteBuddyAgent.AttachmentProvider {
         ...
         public ByteBuddyAgent.AttachmentProvider.Accessor attempt() {
            try {
               return new ByteBuddyAgent.AttachmentProvider.Accessor.Simple.WithDirectAttachment(ByteBuddyAgent.doPrivileged(VirtualMachine.Resolver.INSTANCE));
      ...
      public static enum ForStandardToolsJarVm implements ByteBuddyAgent.AttachmentProvider {
         ...
         public ByteBuddyAgent.AttachmentProvider.Accessor attempt() {
            ...
            try {
               return (ByteBuddyAgent.AttachmentProvider.Accessor)(toolsJar.isFile() && toolsJar.canRead()
                  ? ByteBuddyAgent.AttachmentProvider.Accessor.Simple.of(
                     new URLClassLoader(new URL[]{toolsJar.toURI().toURL()}, ByteBuddyAgent.BOOTSTRAP_CLASS_LOADER), toolsJar
                  )
                  : ByteBuddyAgent.AttachmentProvider.Accessor.Unavailable.INSTANCE);
      ...
      public static enum ForUserDefinedToolsJar implements ByteBuddyAgent.AttachmentProvider {
         ...
         public ByteBuddyAgent.AttachmentProvider.Accessor attempt() {
            ...
            if (location == null) {
               ...
               try {
                  return ByteBuddyAgent.AttachmentProvider.Accessor.Simple.of(
                     new URLClassLoader(new URL[]{toolsJar.toURI().toURL()}, ByteBuddyAgent.BOOTSTRAP_CLASS_LOADER), toolsJar
                  );
   ...
   protected interface AttachmentTypeEvaluator {
      ...
      public static class ForJava9CapableVm implements ByteBuddyAgent.AttachmentTypeEvaluator {
         ...
         public boolean requiresExternalAttachment(String processId) {
            try {
               return this.pid.invoke(this.current.invoke(null)).toString().equals(processId);
            } catch (IllegalAccessException var3) {
               throw new IllegalStateException("Cannot access Java 9 process API", var3);
            } catch (InvocationTargetException var4) {
               throw new IllegalStateException("Error when accessing Java 9 process API", var4.getTargetException());
            }
         }
      }
      ...
      public static enum InstallationAction implements PrivilegedAction<ByteBuddyAgent.AttachmentTypeEvaluator> {
         ...
         public ByteBuddyAgent.AttachmentTypeEvaluator run() {
            try {
               return (ByteBuddyAgent.AttachmentTypeEvaluator)(Boolean.getBoolean("jdk.attach.allowAttachSelf")
                  ? ByteBuddyAgent.AttachmentTypeEvaluator.Disabled.INSTANCE
                  : new ByteBuddyAgent.AttachmentTypeEvaluator.ForJava9CapableVm(
                     Class.forName("java.lang.ProcessHandle").getMethod("current"), Class.forName("java.lang.ProcessHandle").getMethod("pid")
                  ));
            } catch (Exception var2) {
      ...
      public static enum ForCurrentVm implements ByteBuddyAgent.ProcessProvider {
         ...
         protected static class ForJava9CapableVm implements ByteBuddyAgent.ProcessProvider {
            ...
            public static ByteBuddyAgent.ProcessProvider make() {
               try {
                  return new ByteBuddyAgent.ProcessProvider.ForCurrentVm.ForJava9CapableVm(
                     Class.forName("java.lang.ProcessHandle").getMethod("current"), Class.forName("java.lang.ProcessHandle").getMethod("pid")
                  );
            ...
            public String resolve() {
               try {
                  return this.pid.invoke(this.current.invoke(null)).toString();
               } catch (IllegalAccessException var2) {
                  throw new IllegalStateException("Cannot access Java 9 process API", var2);
               } catch (InvocationTargetException var3) {
                  throw new IllegalStateException("Error when accessing Java 9 process API", var3.getTargetException());
               }
            }
         }
         ...
         protected static enum ForLegacyVm implements ByteBuddyAgent.ProcessProvider {
            ...
            public String resolve() {
               ...
               try {
                  ...
                  throw new IllegalStateException("Failed to access VM name via management factory", var3);
               }
