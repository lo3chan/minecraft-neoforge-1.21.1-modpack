...
public final class SlotType implements ISlotType {
   ...
   public static class Builder {
      ...
      private ResourceLocation icon = ResourceLocation.fromNamespaceAndPath("curios", "slot/empty_curio_slot");
      ...
      public SlotType build() {
         ...
         if (this.validators == null) {
            this.validators = Set.of(ResourceLocation.fromNamespaceAndPath("curios", "tag"));
         }
