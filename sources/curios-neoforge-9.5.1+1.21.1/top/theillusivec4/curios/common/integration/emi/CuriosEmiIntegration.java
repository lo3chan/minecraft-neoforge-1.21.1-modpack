...
public class CuriosEmiIntegration {
   ...
   public static void renderCuriosBg(Background evt) {
      if (evt.getContainerScreen() instanceof CuriosScreen curiosScreen && EmiConfig.leftSidebarTheme != SidebarTheme.TRANSPARENT) {
         SidebarPanel panel = EmiScreenManager.getPanelFor(SidebarSide.LEFT);
         if (panel != null && panel.isVisible()) {
            ...
            if (emiRight > curiosLeft) {
               ...
               curiosScreen.renderBg(evt.getGuiGraphics(), mc.getTimer().getGameTimeDeltaPartialTick(false), evt.getMouseX(), evt.getMouseY());
            }
         }
      }
   }
