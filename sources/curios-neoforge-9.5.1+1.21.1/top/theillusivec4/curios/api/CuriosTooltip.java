...
public class CuriosTooltip {
   ...
   public CuriosTooltip appendSlotHeader(String identifier) {
      return this.append(Component.translatable("curios.modifiers." + identifier).withStyle(ChatFormatting.GOLD));
   }
   ...
   public List<Component> build() {
      ...
      for (String identifier : ids) {
         ...
         result.add(Component.translatable("curios.modifiers." + identifier).withStyle(ChatFormatting.GOLD));
