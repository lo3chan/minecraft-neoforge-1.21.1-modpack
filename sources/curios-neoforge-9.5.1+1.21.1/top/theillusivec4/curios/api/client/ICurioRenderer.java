...
public interface ICurioRenderer {
   ...
   static void rotateIfSneaking(PoseStack matrixStack, LivingEntity livingEntity) {
      if (livingEntity.isCrouching()
         && Minecraft.getInstance().getEntityRenderDispatcher().getRenderer(livingEntity) instanceof LivingEntityRenderer<LivingEntity, EntityModel<LivingEntity>> livingRenderer
         )
       {
