...
import amp_libs.org.antlr.v4.runtime.atn.ActionTransition;
import amp_libs.org.antlr.v4.runtime.atn.AtomTransition;
import amp_libs.org.antlr.v4.runtime.atn.DecisionState;
import amp_libs.org.antlr.v4.runtime.atn.LoopEndState;
import amp_libs.org.antlr.v4.runtime.atn.ParserATNSimulator;
import amp_libs.org.antlr.v4.runtime.atn.PrecedencePredicateTransition;
...
import amp_libs.org.antlr.v4.runtime.atn.RuleStartState;
import amp_libs.org.antlr.v4.runtime.atn.RuleTransition;
import amp_libs.org.antlr.v4.runtime.atn.StarLoopEntryState;
import amp_libs.org.antlr.v4.runtime.atn.Transition;
      ...
      switch (transition.getSerializationType()) {
         case 1:
            if (p.getStateType() == 10 && ((StarLoopEntryState)p).isPrecedenceDecision && !(transition.target instanceof LoopEndState)) {
               InterpreterRuleContext localctx = this.createInterpreterRuleContext(
                  (ParserRuleContext)this._parentContextStack.peek().a, (Integer)this._parentContextStack.peek().b, this._ctx.getRuleIndex()
               );
   ...
   protected void recover(RecognitionException e) {
      ...
      if (this._input.index() == i) {
         if (e instanceof InputMismatchException) {
            ...
            Token errToken = this.getTokenFactory()
               .create(
