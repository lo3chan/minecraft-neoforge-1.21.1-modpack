package amp_libs.org.bouncycastle.jce.provider;
...
import amp_libs.org.bouncycastle.crypto.CryptoServiceConstraintsException;
...
import amp_libs.org.bouncycastle.internal.asn1.isara.IsaraObjectIdentifiers;
import amp_libs.org.bouncycastle.jcajce.provider.asymmetric.mlkem.MLKEMKeyFactorySpi;
import amp_libs.org.bouncycastle.jcajce.provider.config.ConfigurableProvider;
import amp_libs.org.bouncycastle.jcajce.provider.config.ProviderConfiguration;
import amp_libs.org.bouncycastle.jcajce.provider.symmetric.util.ClassUtil;
import amp_libs.org.bouncycastle.jcajce.provider.util.AlgorithmProvider;
import amp_libs.org.bouncycastle.jcajce.provider.util.AsymmetricKeyInfoConverter;
import amp_libs.org.bouncycastle.pqc.asn1.PQCObjectIdentifiers;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.bike.BIKEKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.cmce.CMCEKeyFactorySpi;
...
import amp_libs.org.bouncycastle.pqc.jcajce.provider.hqc.HQCKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.kyber.KyberKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.lms.LMSKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.mayo.MayoKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.newhope.NHKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.ntru.NTRUKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.picnic.PicnicKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.snova.SnovaKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.sphincs.Sphincs256KeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.sphincsplus.SPHINCSPlusKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.xmss.XMSSKeyFactorySpi;
import amp_libs.org.bouncycastle.pqc.jcajce.provider.xmss.XMSSMTKeyFactorySpi;
...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
   ...
   private static final String SYMMETRIC_PACKAGE = "amp_libs.org.bouncycastle.jcajce.provider.symmetric.";
   ...
   private static final String ASYMMETRIC_PACKAGE = "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.";
   ...
   private static final String DIGEST_PACKAGE = "amp_libs.org.bouncycastle.jcajce.provider.digest.";
   ...
   private static final String KEYSTORE_PACKAGE = "amp_libs.org.bouncycastle.jcajce.provider.keystore.";
   private static final String[] KEYSTORES = new String[]{"BC", "BCFKS", "PKCS12"};
   private static final String SECURE_RANDOM_PACKAGE = "amp_libs.org.bouncycastle.jcajce.provider.drbg.";
   private static final String[] SECURE_RANDOMS = new String[]{"DRBG"};
   private static final String KDF_PACKAGE = "amp_libs.org.bouncycastle.jcajce.provider.kdf.";
   ...
   private void setup() {
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.digest.", DIGESTS);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.symmetric.", SYMMETRIC_GENERIC);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.symmetric.", SYMMETRIC_MACS);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.symmetric.", SYMMETRIC_CIPHERS);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.asymmetric.", ASYMMETRIC_GENERIC);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.asymmetric.", ASYMMETRIC_CIPHERS);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.keystore.", KEYSTORES);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.drbg.", SECURE_RANDOMS);
      this.loadAlgorithms("amp_libs.org.bouncycastle.jcajce.provider.kdf.", KDFS);
      this.loadPQCKeys();
      this.put("X509Store.CERTIFICATE/COLLECTION", "amp_libs.org.bouncycastle.jce.provider.X509StoreCertCollection");
      this.put("X509Store.ATTRIBUTECERTIFICATE/COLLECTION", "amp_libs.org.bouncycastle.jce.provider.X509StoreAttrCertCollection");
      this.put("X509Store.CRL/COLLECTION", "amp_libs.org.bouncycastle.jce.provider.X509StoreCRLCollection");
      this.put("X509Store.CERTIFICATEPAIR/COLLECTION", "amp_libs.org.bouncycastle.jce.provider.X509StoreCertPairCollection");
      this.put("X509Store.CERTIFICATE/LDAP", "amp_libs.org.bouncycastle.jce.provider.X509StoreLDAPCerts");
      this.put("X509Store.CRL/LDAP", "amp_libs.org.bouncycastle.jce.provider.X509StoreLDAPCRLs");
      this.put("X509Store.ATTRIBUTECERTIFICATE/LDAP", "amp_libs.org.bouncycastle.jce.provider.X509StoreLDAPAttrCerts");
      this.put("X509Store.CERTIFICATEPAIR/LDAP", "amp_libs.org.bouncycastle.jce.provider.X509StoreLDAPCertPairs");
      this.put("X509StreamParser.CERTIFICATE", "amp_libs.org.bouncycastle.jce.provider.X509CertParser");
      this.put("X509StreamParser.ATTRIBUTECERTIFICATE", "amp_libs.org.bouncycastle.jce.provider.X509AttrCertParser");
      this.put("X509StreamParser.CRL", "amp_libs.org.bouncycastle.jce.provider.X509CRLParser");
      this.put("X509StreamParser.CERTIFICATEPAIR", "amp_libs.org.bouncycastle.jce.provider.X509CertPairParser");
      this.put("Cipher.BROKENPBEWITHMD5ANDDES", "amp_libs.org.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithMD5AndDES");
      this.put("Cipher.BROKENPBEWITHSHA1ANDDES", "amp_libs.org.bouncycastle.jce.provider.BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES");
      this.put("Cipher.OLDPBEWITHSHAANDTWOFISH-CBC", "amp_libs.org.bouncycastle.jce.provider.BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish");
      if (revChkClass != null) {
         this.put("CertPathValidator.RFC3281", "amp_libs.org.bouncycastle.jce.provider.PKIXAttrCertPathValidatorSpi");
         this.put("CertPathBuilder.RFC3281", "amp_libs.org.bouncycastle.jce.provider.PKIXAttrCertPathBuilderSpi");
         this.put("CertPathValidator.RFC3280", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi_8");
         this.put("CertPathBuilder.RFC3280", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi_8");
         this.put("CertPathValidator.PKIX", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi_8");
         this.put("CertPathBuilder.PKIX", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi_8");
      } else {
         this.put("CertPathValidator.RFC3281", "amp_libs.org.bouncycastle.jce.provider.PKIXAttrCertPathValidatorSpi");
         this.put("CertPathBuilder.RFC3281", "amp_libs.org.bouncycastle.jce.provider.PKIXAttrCertPathBuilderSpi");
         this.put("CertPathValidator.RFC3280", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi");
         this.put("CertPathBuilder.RFC3280", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi");
         this.put("CertPathValidator.PKIX", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathValidatorSpi");
         this.put("CertPathBuilder.PKIX", "amp_libs.org.bouncycastle.jce.provider.PKIXCertPathBuilderSpi");
      }

      this.put("CertStore.Collection", "amp_libs.org.bouncycastle.jce.provider.CertStoreCollectionSpi");
      this.put("CertStore.LDAP", "amp_libs.org.bouncycastle.jce.provider.X509LDAPCertStoreSpi");
      this.put("CertStore.Multi", "amp_libs.org.bouncycastle.jce.provider.MultiCertStoreSpi");
