...
public class ECNamedCurveTable {
   public static ECNamedCurveParameterSpec getParameterSpec(String var0) {
      ...
      if (var2 == null) {
         if (var1 != null) {
            var2 = amp_libs.org.bouncycastle.asn1.x9.ECNamedCurveTable.getByOID(var1);
         } else {
            var2 = amp_libs.org.bouncycastle.asn1.x9.ECNamedCurveTable.getByName(var0);
         }
      }
   ...
   public static Enumeration getNames() {
      return amp_libs.org.bouncycastle.asn1.x9.ECNamedCurveTable.getNames();
   }
