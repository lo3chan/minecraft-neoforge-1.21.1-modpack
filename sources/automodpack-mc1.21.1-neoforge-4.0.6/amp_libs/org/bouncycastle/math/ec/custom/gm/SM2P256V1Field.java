package amp_libs.org.bouncycastle.math.ec.custom.gm;

import amp_libs.org.bouncycastle.math.raw.Mod;
...
public class SM2P256V1Field {
   ...
   public static void add(int[] var0, int[] var1, int[] var2) {
      ...
      if (var3 != 0 || var2[7] >>> 1 >= 2147483647 && Nat256.gte(var2, P)) {
         addPInvTo(var2);
      }
   }
   ...
   public static void addExt(int[] var0, int[] var1, int[] var2) {
      ...
      if (var3 != 0 || var2[15] >>> 1 >= 2147483647 && Nat.gte(16, var2, PExt)) {
   ...
   public static void addOne(int[] var0, int[] var1) {
      ...
      if (var2 != 0 || var1[7] >>> 1 >= 2147483647 && Nat256.gte(var1, P)) {
         addPInvTo(var1);
      }
   }
   ...
   public static int[] fromBigInteger(BigInteger var0) {
      ...
      if (var1[7] >>> 1 >= 2147483647 && Nat256.gte(var1, P)) {
   ...
   public static void reduce32(int var0, int[] var1) {
      ...
      if (var2 != 0L || var1[7] >>> 1 >= 2147483647 && Nat256.gte(var1, P)) {
         addPInvTo(var1);
      }
   }
