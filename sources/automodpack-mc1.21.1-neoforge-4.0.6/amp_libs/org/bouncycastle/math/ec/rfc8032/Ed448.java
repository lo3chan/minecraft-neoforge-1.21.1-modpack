...
import amp_libs.org.bouncycastle.math.ec.rfc7748.X448;
import amp_libs.org.bouncycastle.math.ec.rfc7748.X448Field;
   ...
   private static boolean checkPointFullVar(byte[] var0) {
      if ((var0[56] & 127) != 0) {
         ...
         for (int var4 = 12; var4 > 0; var4--) {
            ...
            if (var3 == 0 && var5 + -2147483648 > P[var4] + -2147483648) {
               return false;
            }
         ...
         return var2 == 0 && var6 + -2147483648 <= -2147483647 ? false : var3 != 0 || var6 + -2147483648 < P[0] - 1 + -2147483648;
      }
   }
