package amp_libs.org.bouncycastle.math.ec.rfc8032;

import amp_libs.org.bouncycastle.crypto.Digest;
import amp_libs.org.bouncycastle.crypto.digests.SHA512Digest;
import amp_libs.org.bouncycastle.math.ec.rfc7748.X25519;
import amp_libs.org.bouncycastle.math.ec.rfc7748.X25519Field;
import amp_libs.org.bouncycastle.math.raw.Interleave;
import amp_libs.org.bouncycastle.math.raw.Nat256;
...
public abstract class Ed25519 {
   ...
   private static final int[] P = new int[]{-19, -1, -1, -1, -1, -1, -1, 2147483647};
   ...
   private static boolean checkPointFullVar(byte[] var0) {
      ...
      if (var2 == 0 && var10 + -2147483648 <= -2147483647) {
         return false;
      } else if (var3 == 0 && var10 + -2147483648 >= P[0] - 1 + -2147483648) {
         return false;
      } else {
