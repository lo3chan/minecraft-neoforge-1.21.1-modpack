...
import amp_libs.org.bouncycastle.math.Primes;
import amp_libs.org.bouncycastle.math.ec.endo.ECEndomorphism;
import amp_libs.org.bouncycastle.math.ec.endo.GLVEndomorphism;
import amp_libs.org.bouncycastle.math.field.FiniteField;
import amp_libs.org.bouncycastle.math.field.FiniteFields;
import amp_libs.org.bouncycastle.math.raw.Nat;
...
public abstract class ECCurve {
   ...
   public abstract static class AbstractF2m extends ECCurve {
      ...
      private static FiniteField buildField(int var0, int var1, int var2, int var3) {
         if (var0 > Properties.asInteger("amp_libs.org.bouncycastle.ec.max_f2m_field_size", 1142)) {
      ...
      protected AbstractF2m(int var1, int var2, int var3, int var4) {
         ...
         if (Properties.isOverrideSet("amp_libs.org.bouncycastle.ec.disable")) {
            throw new UnsupportedOperationException("F2M disabled by \"org.bouncycastle.ec.disable\"");
         } else if (Properties.isOverrideSet("amp_libs.org.bouncycastle.ec.disable_f2m")) {
   ...
   public static class Fp extends ECCurve.AbstractFp {
      ...
      public Fp(BigInteger var1, BigInteger var2, BigInteger var3, BigInteger var4, BigInteger var5, boolean var6) {
         ...
         if (var6) {
            ...
            int var7 = Properties.asInteger("amp_libs.org.bouncycastle.ec.fp_max_size", 1042);
            int var8 = Properties.asInteger("amp_libs.org.bouncycastle.ec.fp_certainty", 100);
