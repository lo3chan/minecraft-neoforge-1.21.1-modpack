package amp_libs.org.bouncycastle.cert;
...
import amp_libs.org.bouncycastle.asn1.x509.AttributeCertificate;
import amp_libs.org.bouncycastle.asn1.x509.AttributeCertificateInfo;
...
import amp_libs.org.bouncycastle.asn1.x509.ExtensionsGenerator;
...
class CertUtils {
   ...
   static boolean isAlgIdEqual(AlgorithmIdentifier var0, AlgorithmIdentifier var1) {
      if (!var0.getAlgorithm().equals(var1.getAlgorithm())) {
         ...
         if (Properties.isOverrideSet("amp_libs.org.bouncycastle.x509.allow_absent_equiv_NULL")) {
