...
public class RSAKeyParameters extends AsymmetricKeyParameter {
   ...
   private static BigInteger validate(BigInteger var0, boolean var1) {
      if (var1) {
      ...
      } else if (Properties.isOverrideSet("amp_libs.org.bouncycastle.rsa.allow_unsafe_mod")) {
         return var0;
      } else {
         int var2 = Properties.asInteger("amp_libs.org.bouncycastle.rsa.max_size", 16384);
         if (var2 < var0.bitLength()) {
            ...
            int var4 = Properties.asInteger("amp_libs.org.bouncycastle.rsa.max_mr_tests", getMRIterations(var3));
            if (var4 > 0) {
