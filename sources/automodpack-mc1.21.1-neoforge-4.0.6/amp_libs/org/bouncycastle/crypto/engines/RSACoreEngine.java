...
class RSACoreEngine {
   static final String NO_LENSTRA_CHECK = "amp_libs.org.bouncycastle.rsa.no_lenstra_check";
   ...
   public BigInteger processBlock(BigInteger var1) {
      if (this.key instanceof RSAPrivateCrtKeyParameters) {
         ...
         if (var3 != null || Properties.isOverrideSet("amp_libs.org.bouncycastle.rsa.no_lenstra_check")) {
