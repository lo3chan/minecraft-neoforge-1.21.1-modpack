...
import amp_libs.org.bouncycastle.crypto.util.OpenSSHPrivateKeyUtil;
...
import amp_libs.org.bouncycastle.jcajce.provider.asymmetric.util.ExtendedInvalidKeySpecException;
...
public class KeyFactorySpi extends BaseKeyFactorySpi {
   ...
   protected PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof PKCS8EncodedKeySpec) {
         try {
            ...
            try {
               return new BCRSAPrivateCrtKey(amp_libs.org.bouncycastle.asn1.pkcs.RSAPrivateKey.getInstance(((PKCS8EncodedKeySpec)var1).getEncoded()));
   ...
   public PrivateKey generatePrivate(PrivateKeyInfo var1) throws IOException {
      ...
      if (RSAUtil.isRsaOid(var2)) {
         amp_libs.org.bouncycastle.asn1.pkcs.RSAPrivateKey var3 = amp_libs.org.bouncycastle.asn1.pkcs.RSAPrivateKey.getInstance(var1.parsePrivateKey());
