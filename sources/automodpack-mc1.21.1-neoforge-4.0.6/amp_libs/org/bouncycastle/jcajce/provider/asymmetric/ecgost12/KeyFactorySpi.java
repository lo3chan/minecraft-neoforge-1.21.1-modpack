...
public class KeyFactorySpi extends BaseKeyFactorySpi {
      ...
      if (var2.isAssignableFrom(ECPublicKeySpec.class) && var1 instanceof ECPublicKey) {
         ...
         if (var5.getParams() != null) {
            return new amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec(
               EC5Util.convertPoint(var5.getParams(), var5.getW()), EC5Util.convertSpec(var5.getParams())
            );
         } else {
            ECParameterSpec var8 = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
            return new amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(var5.getParams(), var5.getW()), var8);
         }
         ...
         if (var3.getParams() != null) {
            return new amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec(var3.getS(), EC5Util.convertSpec(var3.getParams()));
         } else {
            ECParameterSpec var4 = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
            return new amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec(var3.getS(), var4);
         }
      } else {
   ...
   protected PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec) {
         return new BCECGOST3410_2012PrivateKey((amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec)var1);
      } else {
   ...
   public PublicKey engineGeneratePublic(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec) {
         return new BCECGOST3410_2012PublicKey((amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec)var1, BouncyCastleProvider.CONFIGURATION);
      } else {
