...
import amp_libs.org.bouncycastle.jcajce.provider.asymmetric.util.PKCS12BagAttributeCarrierImpl;
import amp_libs.org.bouncycastle.jce.interfaces.ECPointEncoder;
import amp_libs.org.bouncycastle.jce.interfaces.PKCS12BagAttributeCarrier;
...
import amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec;
...
public class BCDSTU4145PrivateKey implements ECPrivateKey, amp_libs.org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
   ...
   public BCDSTU4145PrivateKey(String var1, ECPrivateKeyParameters var2, BCDSTU4145PublicKey var3, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var4) {
      ECDomainParameters var5 = var2.getParameters();
      this.algorithm = var1;
      this.d = var2.getD();
      if (var4 == null) {
   ...
   private void populateFromPrivKeyInfo(PrivateKeyInfo var1) throws IOException {
      ...
      if (var2.isNamedCurve()) {
         ...
         if (var11.getObjectAt(0) instanceof ASN1Integer) {
            ...
            if (var14.isNamedCurve()) {
               ...
               var19 = new amp_libs.org.bouncycastle.jce.spec.ECParameterSpec(var9, DSTU4145PointEncoder.decodePoint(var9, var10), var21.getN());
            }

            EllipticCurve var22 = EC5Util.convertCurve(
               ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var19).getCurve(), ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var19).getSeed()
            );
            this.ecSpec = new ECParameterSpec(
               var22,
               EC5Util.convertPoint(((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var19).getG()),
               ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var19).getN(),
               ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var19).getH().intValue()
            );
         }
      }
      ...
      if (var12 instanceof ASN1Integer) {
         ...
         amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var16 = amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(var12);
         this.d = var16.getKey();
   ...
   public byte[] getEncoded() {
      ...
      amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var9;
      if (this.publicKey != null) {
         var9 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var2, this.getS(), this.publicKey, var1);
      } else {
         var9 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var2, this.getS(), var1);
      }
