...
import amp_libs.org.bouncycastle.jcajce.ExternalPublicKey;
...
public class EXTERNAL {
   private static final String PREFIX = "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.EXTERNAL";
   private static final Map<String, String> externalAttributes = new HashMap<>();
   private static AsymmetricKeyInfoConverter baseConverter;

   static {
      externalAttributes.put("SupportedKeyClasses", "amp_libs.org.bouncycastle.jcajce.ExternalPublicKey");
   ...
   public static class Mappings extends AsymmetricAlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("KeyFactory.EXTERNAL", "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.EXTERNAL$KeyFactory");
         var1.addAlgorithm("KeyFactory." + BCObjectIdentifiers.external_value, "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.EXTERNAL$KeyFactory");
         var1.addAlgorithm("KeyFactory.OID." + BCObjectIdentifiers.external_value, "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.EXTERNAL$KeyFactory");
