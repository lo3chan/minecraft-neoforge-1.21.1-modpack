...
import amp_libs.org.bouncycastle.crypto.util.PrivateKeyInfoFactory;
...
import amp_libs.org.bouncycastle.jcajce.interfaces.EdDSAPrivateKey;
...
public class BCEdDSAPrivateKey implements EdDSAPrivateKey, BCKey {
   ...
   public String getAlgorithm() {
      if (Properties.isOverrideSet("amp_libs.org.bouncycastle.emulate.oracle")) {
         return "EdDSA";
      } else {
   ...
   private PrivateKeyInfo getPrivateKeyInfo() {
      try {
         ...
         return this.hasPublicKey && !Properties.isOverrideSet("amp_libs.org.bouncycastle.pkcs8.v1_info_only")
            ? var2
