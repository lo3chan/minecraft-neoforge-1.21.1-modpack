...
import amp_libs.org.bouncycastle.jcajce.interfaces.BCKey;
...
public class BCECPrivateKey implements ECPrivateKey, amp_libs.org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder, BCKey {
   ...
   public BCECPrivateKey(
      String var1, ECPrivateKeyParameters var2, BCECPublicKey var3, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var4, ProviderConfiguration var5
   ) {
      this.algorithm = var1;
      this.d = var2.getD();
      this.configuration = var5;
   ...
   private void populateFromPrivKeyInfo(PrivateKeyInfo var1) throws IOException {
      ...
      if (var4 instanceof ASN1Integer) {
         ...
         amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var6 = amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(var4);
         this.d = var6.getKey();
   ...
   private PrivateKeyInfo getPrivateKeyInfo() {
      if (this.privateKeyInfo == null) {
         ...
         amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var3;
         if (this.publicKey != null) {
            var3 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var2, this.getS(), this.publicKey, var1);
         } else {
            var3 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var2, this.getS(), var1);
         }
   ...
   private static ECPrivateKeyParameters convertToBaseKey(BCECPrivateKey var0) {
      amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var2 = var0.getParameters();
      if (var2 == null) {
