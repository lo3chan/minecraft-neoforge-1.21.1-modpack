...
public class BCRSAPublicKey implements RSAPublicKey, BCKey {
   ...
   private void populateFromPublicKeyInfo(SubjectPublicKeyInfo var1) {
      try {
         amp_libs.org.bouncycastle.asn1.pkcs.RSAPublicKey var2 = amp_libs.org.bouncycastle.asn1.pkcs.RSAPublicKey.getInstance(var1.parsePublicKey());
   ...
   public byte[] getEncoded() {
      return KeyUtil.getEncodedSubjectPublicKeyInfo(
         this.algorithmIdentifier, new amp_libs.org.bouncycastle.asn1.pkcs.RSAPublicKey(this.getModulus(), this.getPublicExponent())
      );
   }
