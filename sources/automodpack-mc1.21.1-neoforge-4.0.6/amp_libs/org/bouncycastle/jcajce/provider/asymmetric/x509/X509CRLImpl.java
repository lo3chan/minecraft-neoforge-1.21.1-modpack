...
import amp_libs.org.bouncycastle.asn1.x509.CRLDistPoint;
import amp_libs.org.bouncycastle.asn1.x509.CRLNumber;
import amp_libs.org.bouncycastle.asn1.x509.CertificateList;
import amp_libs.org.bouncycastle.asn1.x509.Extension;
import amp_libs.org.bouncycastle.asn1.x509.Extensions;
import amp_libs.org.bouncycastle.asn1.x509.GeneralNames;
import amp_libs.org.bouncycastle.asn1.x509.IssuingDistributionPoint;
import amp_libs.org.bouncycastle.asn1.x509.TBSCertList;
import amp_libs.org.bouncycastle.asn1.x509.Time;
            ...
            while (var2.hasMoreElements()) {
               ...
               if (var5.getUserCertificate().hasValue(var4)) {
                  ...
                  if (var1 instanceof X509Certificate) {
                     ...
                     try {
                        var9 = amp_libs.org.bouncycastle.asn1.x509.Certificate.getInstance(var1.getEncoded()).getIssuer();
