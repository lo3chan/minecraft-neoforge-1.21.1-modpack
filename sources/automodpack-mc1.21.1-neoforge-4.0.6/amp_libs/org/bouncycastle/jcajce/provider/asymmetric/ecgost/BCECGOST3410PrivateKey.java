package amp_libs.org.bouncycastle.jcajce.provider.asymmetric.ecgost;
...
import amp_libs.org.bouncycastle.jce.ECGOST3410NamedCurveTable;
...
public class BCECGOST3410PrivateKey implements ECPrivateKey, amp_libs.org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
   ...
   public BCECGOST3410PrivateKey(String var1, ECPrivateKeyParameters var2, BCECGOST3410PublicKey var3, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var4) {
      this.algorithm = var1;
      this.d = var2.getD();
      if (var4 == null) {
         ECDomainParameters var5 = var2.getParameters();
   ...
   private void populateFromPrivKeyInfo(PrivateKeyInfo var1) throws IOException {
      ...
      if (var4 instanceof ASN1Sequence && (ASN1Sequence.getInstance(var4).size() == 2 || ASN1Sequence.getInstance(var4).size() == 3)) {
         ...
         if (var15 instanceof ASN1Integer) {
            ...
            amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var19 = amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(var15);
            this.d = var19.getKey();
   ...
   public byte[] getEncoded() {
      if (this.gostParams != null) {
         ...
         amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var12;
         if (this.publicKey != null) {
            var12 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var2, this.getS(), this.publicKey, var1);
         } else {
            var12 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var2, this.getS(), var1);
         }
