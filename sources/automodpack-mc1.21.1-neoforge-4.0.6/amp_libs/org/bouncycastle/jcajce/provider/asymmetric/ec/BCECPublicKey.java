...
import amp_libs.org.bouncycastle.asn1.x9.X9IntegerConverter;
...
public class BCECPublicKey implements ECPublicKey, amp_libs.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder, BCKey {
   ...
   public BCECPublicKey(String var1, amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec var2, ProviderConfiguration var3) {
      this.algorithm = var1;
      if (var2.getParams() != null) {
         ...
         amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var6 = var3.getEcImplicitlyCa();
   ...
   public BCECPublicKey(String var1, ECPublicKeyParameters var2, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var3, ProviderConfiguration var4) {
      ECDomainParameters var5 = var2.getParameters();
      this.algorithm = var1;
      if (var3 == null) {
         EllipticCurve var6 = EC5Util.convertCurve(var5.getCurve(), var5.getSeed());
   ...
   public byte[] getEncoded() {
      boolean var1 = Properties.isOverrideSet("amp_libs.org.bouncycastle.ec.enable_pc");
