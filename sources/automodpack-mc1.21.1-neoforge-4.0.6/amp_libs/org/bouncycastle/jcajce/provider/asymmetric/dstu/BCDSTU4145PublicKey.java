package amp_libs.org.bouncycastle.jcajce.provider.asymmetric.dstu;
...
import amp_libs.org.bouncycastle.asn1.ua.DSTU4145BinaryField;
import amp_libs.org.bouncycastle.asn1.ua.DSTU4145ECBinary;
import amp_libs.org.bouncycastle.asn1.ua.DSTU4145NamedCurves;
import amp_libs.org.bouncycastle.asn1.ua.DSTU4145Params;
import amp_libs.org.bouncycastle.asn1.ua.DSTU4145PointEncoder;
...
import amp_libs.org.bouncycastle.jcajce.provider.asymmetric.util.EC5Util;
import amp_libs.org.bouncycastle.jcajce.provider.asymmetric.util.ECUtil;
import amp_libs.org.bouncycastle.jcajce.provider.asymmetric.util.KeyUtil;
import amp_libs.org.bouncycastle.jcajce.provider.config.ProviderConfiguration;
import amp_libs.org.bouncycastle.jce.interfaces.ECPointEncoder;
...
import amp_libs.org.bouncycastle.jce.spec.ECNamedCurveSpec;
...
public class BCDSTU4145PublicKey implements ECPublicKey, amp_libs.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
   ...
   public BCDSTU4145PublicKey(amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec var1, ProviderConfiguration var2) {
      if (var1.getParams() != null) {
         ...
         amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var5 = var2.getEcImplicitlyCa();
   ...
   public BCDSTU4145PublicKey(String var1, ECPublicKeyParameters var2, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var3) {
      ECDomainParameters var4 = var2.getParameters();
      this.algorithm = var1;
      if (var3 == null) {
         EllipticCurve var5 = EC5Util.convertCurve(var4.getCurve(), var4.getSeed());
   ...
   private void populateFromPubKeyInfo(SubjectPublicKeyInfo var1) {
      ...
      if (var5.getObjectAt(0) instanceof ASN1Integer) {
         ...
         var6 = new amp_libs.org.bouncycastle.jce.spec.ECParameterSpec(var7.getCurve(), var7.getG(), var7.getN(), var7.getH(), var7.getSeed());
      } else {
         ...
         if (this.dstuParams.isNamedCurve()) {
            ...
            var6 = new amp_libs.org.bouncycastle.jce.spec.ECParameterSpec(var11, DSTU4145PointEncoder.decodePoint(var11, var12), var15.getN());
         }
      }

      ECCurve var16 = ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var6).getCurve();
      EllipticCurve var18 = EC5Util.convertCurve(var16, ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var6).getSeed());
      if (this.dstuParams != null) {
         ECPoint var19 = EC5Util.convertPoint(((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var6).getG());
         if (this.dstuParams.isNamedCurve()) {
            ...
            this.ecSpec = new ECNamedCurveSpec(
               ...
               var18,
               var19,
               ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var6).getN(),
               ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var6).getH()
            );
         } else {
            this.ecSpec = new ECParameterSpec(
               ...
               var19,
               ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var6).getN(),
               ((amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)var6).getH().intValue()
            );
         }
      } else {
   ...
   @Override
   public amp_libs.org.bouncycastle.jce.spec.ECParameterSpec getParameters() {
   ...
   @Override
   public amp_libs.org.bouncycastle.math.ec.ECPoint getQ() {
      amp_libs.org.bouncycastle.math.ec.ECPoint var1 = this.ecPublicKey.getQ();
   ...
   amp_libs.org.bouncycastle.jce.spec.ECParameterSpec engineGetSpec() {
