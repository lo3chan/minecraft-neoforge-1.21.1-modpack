...
import amp_libs.org.bouncycastle.math.field.FiniteField;
import amp_libs.org.bouncycastle.math.field.Polynomial;
import amp_libs.org.bouncycastle.math.field.PolynomialExtensionField;
...
public class EC5Util {
   ...
   public static ECDomainParameters getDomainParameters(ProviderConfiguration var0, ECParameterSpec var1) {
      ...
      if (var1 == null) {
         amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var3 = var0.getEcImplicitlyCa();
   ...
   public static ECParameterSpec convertSpec(EllipticCurve var0, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var1) {
   ...
   public static amp_libs.org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec var0) {
      ECCurve var1 = convertCurve(var0.getCurve());
      amp_libs.org.bouncycastle.math.ec.ECPoint var2 = convertPoint(var1, var0.getGenerator());
      BigInteger var3 = var0.getOrder();
      BigInteger var4 = BigInteger.valueOf(var0.getCofactor());
      byte[] var5 = var0.getCurve().getSeed();
      return (amp_libs.org.bouncycastle.jce.spec.ECParameterSpec)(var0 instanceof ECNamedCurveSpec
         ? new ECNamedCurveParameterSpec(((ECNamedCurveSpec)var0).getName(), var1, var2, var3, var4, var5)
         : new amp_libs.org.bouncycastle.jce.spec.ECParameterSpec(var1, var2, var3, var4, var5));
   }

   public static amp_libs.org.bouncycastle.math.ec.ECPoint convertPoint(ECParameterSpec var0, ECPoint var1) {
      return convertPoint(convertCurve(var0.getCurve()), var1);
   }

   public static amp_libs.org.bouncycastle.math.ec.ECPoint convertPoint(ECCurve var0, ECPoint var1) {
      return var0.createPoint(var1.getAffineX(), var1.getAffineY());
   }

   public static ECPoint convertPoint(amp_libs.org.bouncycastle.math.ec.ECPoint var0) {
      var0 = var0.normalize();
