...
import amp_libs.org.bouncycastle.jcajce.provider.asymmetric.gost.KeyFactorySpi;
...
public class GOST {
   private static final String PREFIX = "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.gost.";

   public static class Mappings extends AsymmetricAlgorithmProvider {
      @Override
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("KeyPairGenerator.GOST3410", "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.gost.KeyPairGeneratorSpi");
         ...
         var1.addAlgorithm("KeyFactory.GOST3410", "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.gost.KeyFactorySpi");
         var1.addAlgorithm("Alg.Alias.KeyFactory.GOST-3410", "GOST3410");
         var1.addAlgorithm("Alg.Alias.KeyFactory.GOST-3410-94", "GOST3410");
         var1.addAlgorithm("AlgorithmParameters.GOST3410", "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.gost.AlgorithmParametersSpi");
         var1.addAlgorithm("AlgorithmParameterGenerator.GOST3410", "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.gost.AlgorithmParameterGeneratorSpi");
         ...
         var1.addAlgorithm("Signature.GOST3410", "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.gost.SignatureSpi");
