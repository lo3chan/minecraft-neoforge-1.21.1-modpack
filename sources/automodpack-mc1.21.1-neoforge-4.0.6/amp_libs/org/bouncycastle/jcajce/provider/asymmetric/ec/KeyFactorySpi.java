package amp_libs.org.bouncycastle.jcajce.provider.asymmetric.ec;
...
import amp_libs.org.bouncycastle.crypto.util.OpenSSHPublicKeyUtil;
...
import amp_libs.org.bouncycastle.jcajce.spec.OpenSSHPrivateKeySpec;
import amp_libs.org.bouncycastle.jcajce.spec.OpenSSHPublicKeySpec;
...
public class KeyFactorySpi extends BaseKeyFactorySpi implements AsymmetricKeyInfoConverter {
   ...
   protected KeySpec engineGetKeySpec(Key var1, Class var2) throws InvalidKeySpecException {
      ...
      } else if (var2.isAssignableFrom(amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec.class) && var1 instanceof ECPublicKey) {
         ECPublicKey var9 = (ECPublicKey)var1;
         if (var9.getParams() != null) {
            return new amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec(
               EC5Util.convertPoint(var9.getParams(), var9.getW()), EC5Util.convertSpec(var9.getParams())
            );
         } else {
            ECParameterSpec var13 = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
            return new amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec(EC5Util.convertPoint(var9.getParams(), var9.getW()), var13);
         }
      } else if (var2.isAssignableFrom(amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec.class) && var1 instanceof ECPrivateKey) {
         ECPrivateKey var8 = (ECPrivateKey)var1;
         if (var8.getParams() != null) {
            return new amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec(var8.getS(), EC5Util.convertSpec(var8.getParams()));
         } else {
            ECParameterSpec var12 = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa();
            return new amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec(var8.getS(), var12);
         }
   ...
   protected PrivateKey engineGeneratePrivate(KeySpec var1) throws InvalidKeySpecException {
      if (var1 instanceof amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec) {
         return new BCECPrivateKey(this.algorithm, (amp_libs.org.bouncycastle.jce.spec.ECPrivateKeySpec)var1, this.configuration);
         ...
         amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var2 = amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(
            ((OpenSSHPrivateKeySpec)var1).getEncoded()
         );
   ...
   protected PublicKey engineGeneratePublic(KeySpec var1) throws InvalidKeySpecException {
      try {
         if (var1 instanceof amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec) {
            return new BCECPublicKey(this.algorithm, (amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec)var1, this.configuration);
         }
         ...
         if (var1 instanceof OpenSSHPublicKeySpec) {
            ...
            if (var2 instanceof ECPublicKeyParameters) {
               ...
               return this.engineGeneratePublic(
                  new amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec(
