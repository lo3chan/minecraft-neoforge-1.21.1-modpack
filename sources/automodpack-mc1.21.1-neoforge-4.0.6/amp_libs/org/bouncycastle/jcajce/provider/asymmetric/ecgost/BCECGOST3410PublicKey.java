...
public class BCECGOST3410PublicKey implements ECPublicKey, amp_libs.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
   ...
   public BCECGOST3410PublicKey(amp_libs.org.bouncycastle.jce.spec.ECPublicKeySpec var1, ProviderConfiguration var2) {
   ...
   public BCECGOST3410PublicKey(String var1, ECPublicKeyParameters var2, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var3) {
      ECDomainParameters var4 = var2.getParameters();
      this.algorithm = var1;
      this.ecPublicKey = var2;
      if (var3 == null) {
