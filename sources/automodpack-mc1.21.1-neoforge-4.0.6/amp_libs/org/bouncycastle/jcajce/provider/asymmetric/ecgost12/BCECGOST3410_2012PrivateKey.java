package amp_libs.org.bouncycastle.jcajce.provider.asymmetric.ecgost12;
...
public class BCECGOST3410_2012PrivateKey
   ...
   amp_libs.org.bouncycastle.jce.interfaces.ECPrivateKey,
   ...
   public BCECGOST3410_2012PrivateKey(
      String var1, ECPrivateKeyParameters var2, BCECGOST3410_2012PublicKey var3, amp_libs.org.bouncycastle.jce.spec.ECParameterSpec var4
   ) {
      ECDomainParameters var5 = var2.getParameters();
      this.algorithm = var1;
      this.d = var2.getD();
   ...
   private void populateFromPrivKeyInfo(PrivateKeyInfo var1) throws IOException {
      ...
      if (var2 instanceof ASN1Sequence && ASN1Sequence.getInstance(var2).size() <= 3) {
         ...
         if (var11 instanceof ASN1Integer) {
            ...
            amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var15 = amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(var11);
            this.d = var15.getKey();
   ...
   public byte[] getEncoded() {
      ...
      if (this.gostParams != null) {
         ...
         amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey var15;
         if (this.publicKey != null) {
            var15 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var5, this.getS(), this.publicKey, var4);
         } else {
            var15 = new amp_libs.org.bouncycastle.asn1.sec.ECPrivateKey(var5, this.getS(), var4);
         }
