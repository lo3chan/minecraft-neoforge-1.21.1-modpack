...
public class CONTEXT {
   private static final String PREFIX = "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.CONTEXT$";
   ...
   public static class Mappings extends AsymmetricAlgorithmProvider {
      ...
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("AlgorithmParameters.CONTEXT", "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.CONTEXT$ContextAlgorithmParametersSpi");
      }
   }
}
