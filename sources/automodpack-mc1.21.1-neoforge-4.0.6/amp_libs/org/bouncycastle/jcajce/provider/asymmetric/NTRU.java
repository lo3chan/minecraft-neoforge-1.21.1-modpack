...
public class NTRU {
   private static final String PREFIX = "amp_libs.org.bouncycastle.pqc.jcajce.provider.ntru.";

   public static class Mappings extends AsymmetricAlgorithmProvider {
      @Override
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("KeyFactory.NTRU", "amp_libs.org.bouncycastle.pqc.jcajce.provider.ntru.NTRUKeyFactorySpi");
         var1.addAlgorithm("KeyPairGenerator.NTRU", "amp_libs.org.bouncycastle.pqc.jcajce.provider.ntru.NTRUKeyPairGeneratorSpi");
         var1.addAlgorithm("KeyGenerator.NTRU", "amp_libs.org.bouncycastle.pqc.jcajce.provider.ntru.NTRUKeyGeneratorSpi");
         ...
         var1.addAlgorithm("Cipher.NTRU", "amp_libs.org.bouncycastle.pqc.jcajce.provider.ntru.NTRUCipherSpi$Base");
