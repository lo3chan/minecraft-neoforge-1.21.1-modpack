...
public class NoSig {
   private static final String PREFIX = "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.NoSig$";

   public static class Mappings extends AsymmetricAlgorithmProvider {
      @Override
      public void configure(ConfigurableProvider var1) {
         var1.addAlgorithm("Signature." + X509ObjectIdentifiers.id_alg_noSignature, "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.NoSig$SigSpi");
         var1.addAlgorithm("Signature." + X509ObjectIdentifiers.id_alg_unsigned, "amp_libs.org.bouncycastle.jcajce.provider.asymmetric.NoSig$SigSpi");
      }
   }
