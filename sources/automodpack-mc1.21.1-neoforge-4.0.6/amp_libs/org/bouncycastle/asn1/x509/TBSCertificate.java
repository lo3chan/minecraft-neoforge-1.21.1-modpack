...
public class TBSCertificate extends ASN1Object {
   ...
   public ASN1Primitive toASN1Primitive() {
      if (this.seq != null) {
         if (Properties.getPropertyValue("amp_libs.org.bouncycastle.x509.allow_non-der_tbscert") == null) {
            return this.seq;
         }

         if (Properties.isOverrideSet("amp_libs.org.bouncycastle.x509.allow_non-der_tbscert")) {
            return this.seq;
         }
      }
