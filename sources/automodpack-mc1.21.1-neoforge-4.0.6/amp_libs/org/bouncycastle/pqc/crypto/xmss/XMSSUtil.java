...
public class XMSSUtil {
   ...
   private static class CheckingStream extends ObjectInputStream {
      ...
      static {
         ...
         components.add("amp_libs.org.bouncycastle.pqc.crypto.xmss.BDS");
         components.add("java.util.ArrayList");
         components.add("amp_libs.org.bouncycastle.pqc.crypto.xmss.XMSSNode");
         components.add("[B");
         ...
         components.add("amp_libs.org.bouncycastle.pqc.crypto.xmss.BDSTreeHash");
      }
   }
}
