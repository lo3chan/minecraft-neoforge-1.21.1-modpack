...
public class HSSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
   ...
   void resetKeyToIndex() {
      ...
      for (int var9 = 1; var9 < var2.length; var9++) {
         ...
         boolean var17 = amp_libs.org.bouncycastle.util.Arrays.areEqual(var12, var19[var9].getI())
            && amp_libs.org.bouncycastle.util.Arrays.areEqual(var13, var19[var9].getMasterSecret());
         if (!var17) {
