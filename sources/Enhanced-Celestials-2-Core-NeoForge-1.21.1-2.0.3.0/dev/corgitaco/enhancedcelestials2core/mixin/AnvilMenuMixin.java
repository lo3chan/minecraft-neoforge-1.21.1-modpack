...
public abstract class AnvilMenuMixin extends ItemCombinerMenu {
   ...
   private Object halfPrice(Object original) {
      ...
      Optional<LunarForecast> enhancedCelestialsLunarForecastWorldData = EnhancedCelestials.lunarForecastWorldData(world);
      if (enhancedCelestialsLunarForecastWorldData.isEmpty()) {
         ...
         return Double.valueOf(((Integer)original).intValue() * data.currentLunarEvent().anvilCostAmplifier()).intValue();
      }
   }
