...
public class BRBTextures {
   private static final String NS = "brbe";
   ...
   public static final ResourceLocation RECIPE_BOOK_PIN_SPRITE = ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/pin");
   public static final ResourceLocation RECIPE_BOOK_OVERLAY_PIN_SPRITE = ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/overlay_pin");
   ...
   public static WidgetSprites RECIPE_BOOK_CRAFTING_OVERLAY_SPRITE = new WidgetSprites(
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/crafting_overlay"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/crafting_overlay_disabled"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/crafting_overlay_highlighted"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/crafting_overlay_disabled_highlighted")
   );
   public static WidgetSprites RECIPE_BOOK_PLAIN_OVERLAY_SPRITE = new WidgetSprites(
      ...
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/plain_overlay_disabled"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/plain_overlay_highlighted"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/plain_overlay_disabled_highlighted")
   );
   public static final WidgetSprites SETTINGS_BUTTON_SPRITES = new WidgetSprites(
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_settings"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_settings_highlighted")
   );
   public static final WidgetSprites RECIPE_BOOK_EXPAND_BUTTON_SPRITES = new WidgetSprites(
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_expand"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_expand_disabled"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_expand_highlighted"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_expand_disabled_highlighted")
   );
   public static final WidgetSprites RECIPE_BOOK_INSTANT_CRAFT_BUTTON_SPRITES = new WidgetSprites(
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_instantcraft"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_instantcraft_disabled"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_instantcraft_highlighted"),
      ResourceLocation.fromNamespaceAndPath("brbe", "recipe_book/button_instantcraft_disabled_highlighted")
   );
}
