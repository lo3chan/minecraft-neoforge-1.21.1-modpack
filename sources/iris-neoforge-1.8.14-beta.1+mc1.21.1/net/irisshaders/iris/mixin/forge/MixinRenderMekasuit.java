...
@Pseudo
@Mixin(
   targets = {"mekanism/client/render/armor/MekaSuitArmor"},
   remap = false
)
public class MixinRenderMekasuit {
   ...
   @Redirect(
      method = {"renderArm", "Lmekanism/client/render/armor/MekaSuitArmor;render(Lnet/minecraft/client/model/HumanoidModel;Lnet/minecraft/client/renderer/MultiBufferSource;Lcom/mojang/blaze3d/vertex/PoseStack;IILmekanism/common/lib/Color;ZLnet/minecraft/world/entity/LivingEntity;Ljava/util/Map;Z)V"},
      at = @At(
         value = "FIELD",
   ...
   private RenderType doNotSwitchShaders() {
      return Iris.isPackInUseQuick() && ImmediateState.isRenderingLevel ? LightningHandler.MEKASUIT : (RenderType)MEKASUIT;
   }
