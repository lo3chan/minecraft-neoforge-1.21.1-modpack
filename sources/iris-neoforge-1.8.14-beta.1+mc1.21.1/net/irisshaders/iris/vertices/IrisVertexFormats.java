...
public class IrisVertexFormats {
   ...
   static {
      ...
      ENTITY_ELEMENT = VertexFormatElement.register(getNextVertexFormatElementId(), 0, Type.SHORT, Usage.GENERIC, 2);
      ENTITY_ID_ELEMENT = VertexFormatElement.register(getNextVertexFormatElementId(), LAST_UV + 1, Type.USHORT, Usage.UV, 3);
      MID_TEXTURE_ELEMENT = VertexFormatElement.register(getNextVertexFormatElementId(), 0, Type.FLOAT, Usage.GENERIC, 2);
      TANGENT_ELEMENT = VertexFormatElement.register(getNextVertexFormatElementId(), 0, Type.BYTE, Usage.GENERIC, 4);
      MID_BLOCK_ELEMENT = VertexFormatElement.register(getNextVertexFormatElementId(), 0, Type.BYTE, Usage.GENERIC, 3);
