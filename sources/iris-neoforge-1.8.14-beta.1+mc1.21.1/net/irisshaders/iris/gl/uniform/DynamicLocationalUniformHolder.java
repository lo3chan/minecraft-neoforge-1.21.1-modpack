...
public interface DynamicLocationalUniformHolder extends LocationalUniformHolder, DynamicUniformHolder {
   DynamicLocationalUniformHolder addDynamicUniform(Uniform var1, ValueUpdateNotifier var2);
   ...
   default DynamicLocationalUniformHolder uniform1f(String name, DoubleSupplier value, ValueUpdateNotifier notifier) {
      this.location(name, UniformType.FLOAT)
         .ifPresent(id -> this.addDynamicUniform(new FloatUniform(id, () -> (float)value.getAsDouble(), notifier), notifier));
      return this;
   }
