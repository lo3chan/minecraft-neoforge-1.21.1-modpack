...
public class IrisGenericRenderProgram implements IDhApiGenericObjectShaderProgram {
   ...
   private IrisGenericRenderProgram(
      ...
      boolean translucent,
      BlendModeOverride override,
      BufferBlendOverride[] bufferBlendOverrides,
      String vertex,
      String tessControl,
      String tessEval,
      String geometry,
   ...
   public static IrisGenericRenderProgram createProgram(
      String name, boolean isShadowPass, boolean translucent, ProgramSource source, CustomUniforms uniforms, IrisRenderingPipeline pipeline
   ) {
      ...
      return new IrisGenericRenderProgram(
         name,
         isShadowPass,
         translucent,
   ...
   public void bind(DhApiRenderParam renderParam) {
      ...
      this.setUniform(
         this.instancedShaderProjectionModelViewMatrixUniform, this.toJOML(renderParam.dhProjectionMatrix).mul(this.toJOML(renderParam.dhModelViewMatrix))
      );
   ...
   public void fillIndirectUniformData(
      DhApiRenderParam dhApiRenderParam, DhApiRenderableBoxGroupShading dhApiRenderableBoxGroupShading, IDhApiRenderableBoxGroup boxGroup, DhApiVec3d camPos
   ) {
      ...
      this.setUniform(
         ...
         new DhApiVec3i(getChunkPosFromDouble(camPos.x), getChunkPosFromDouble(camPos.y), getChunkPosFromDouble(camPos.z))
      );
      this.setUniform(
         this.instancedShaderCameraSubChunkPosUniform,
         new DhApiVec3f(getSubChunkPosFromDouble(camPos.x), getSubChunkPosFromDouble(camPos.y), getSubChunkPosFromDouble(camPos.z))
      );
