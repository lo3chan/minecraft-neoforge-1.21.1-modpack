...
public class MixinSodiumGameOptions {
   ...
   private static int iris$makeColor(
      GuiGraphics graphics, ResourceLocation icon, int color, boolean iconMonochrome, int x, int y, int height, int margin, Operation<Integer> original
   ) {
