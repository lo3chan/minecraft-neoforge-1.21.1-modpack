...
public class IrisInternalUniforms {
   ...
   public static void addFogUniforms(DynamicUniformHolder uniforms, FogMode fogMode) {
      ...
      uniforms.uniform1f(UniformUpdateFrequency.PER_FRAME, "iris_FogStart", RenderSystem::getShaderFogStart)
         .uniform1f(UniformUpdateFrequency.PER_FRAME, "iris_FogEnd", RenderSystem::getShaderFogEnd);
