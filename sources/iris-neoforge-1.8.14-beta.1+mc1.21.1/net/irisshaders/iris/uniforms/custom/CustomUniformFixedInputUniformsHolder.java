...
public class CustomUniformFixedInputUniformsHolder {
   ...
   public Type getType(String name) {
      CachedUniform uniform = (CachedUniform)this.inputVariables.get(name);
      return uniform == null ? null : uniform.getType();
   }
   ...
   public CachedUniform getUniform(String name) {
      return (CachedUniform)this.inputVariables.get(name);
   }

   public void updateAll() {
      UnmodifiableIterator var1 = this.inputVariables.values().iterator();

      while (var1.hasNext()) {
         CachedUniform value = (CachedUniform)var1.next();
         value.update();
      }
   }
   ...
   public static class Builder implements UniformHolder {
      ...
      private CustomUniformFixedInputUniformsHolder.Builder put(String name, CachedUniform uniform) {
      ...
      public CustomUniformFixedInputUniformsHolder.Builder uniform1f(UniformUpdateFrequency updateFrequency, String name, FloatSupplier value) {
         return this.put(name, new FloatCachedUniform(name, updateFrequency, value));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform1f(UniformUpdateFrequency updateFrequency, String name, IntSupplier value) {
         return this.put(name, new FloatCachedUniform(name, updateFrequency, value::getAsInt));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform1f(UniformUpdateFrequency updateFrequency, String name, DoubleSupplier value) {
         return this.put(name, new FloatCachedUniform(name, updateFrequency, () -> (float)value.getAsDouble()));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform1i(UniformUpdateFrequency updateFrequency, String name, IntSupplier value) {
         return this.put(name, new IntCachedUniform(name, updateFrequency, value));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform1b(UniformUpdateFrequency updateFrequency, String name, BooleanSupplier value) {
         return this.put(name, new BooleanCachedUniform(name, updateFrequency, value));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform2f(UniformUpdateFrequency updateFrequency, String name, Supplier<Vector2f> value) {
         return this.put(name, new Float2VectorCachedUniform(name, updateFrequency, value));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform2i(UniformUpdateFrequency updateFrequency, String name, Supplier<Vector2i> value) {
         return this.put(name, new Int2VectorCachedUniform(name, updateFrequency, value));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform3f(UniformUpdateFrequency updateFrequency, String name, Supplier<Vector3f> value) {
         return this.put(name, new Float3VectorCachedUniform(name, updateFrequency, value));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniform3i(UniformUpdateFrequency updateFrequency, String name, Supplier<Vector3i> value) {
         return this.put(name, new Int3VectorCachedUniform(name, updateFrequency, value));
      }

      public CustomUniformFixedInputUniformsHolder.Builder uniformTruncated3f(UniformUpdateFrequency updateFrequency, String name, Supplier<Vector4f> value) {
      ...
      @Override
      public UniformHolder uniformMatrix(UniformUpdateFrequency updateFrequency, String name, Supplier<Matrix4fc> value) {
