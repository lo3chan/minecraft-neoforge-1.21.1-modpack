...
public class VanillaCoreTransformer {
   public static void transform(ASTParser t, TranslationUnit tree, Root root, VanillaParameters parameters) {
      ...
      root.replaceExpressionMatches(
         t,
         CommonTransformer.glTextureMatrix1,
      ...
      root.replaceExpressionMatches(
         t,
         CommonTransformer.glTextureMatrix2,
         "mat4(vec4(0.00390625, 0.0, 0.0, 0.0), vec4(0.0, 0.00390625, 0.0, 0.0), vec4(0.0, 0.0, 0.00390625, 0.0), vec4(0.03125, 0.03125, 0.03125, 1.0))"
      );
      CommonTransformer.addIfNotExists(root, t, tree, "iris_TextureMat", Type.F32MAT4X4, StorageType.UNIFORM);
      CommonTransformer.addIfNotExists(root, t, tree, "iris_ProjMat", Type.F32MAT4X4, StorageType.UNIFORM);
      CommonTransformer.addIfNotExists(root, t, tree, "iris_ProjMatInverse", Type.F32MAT4X4, StorageType.UNIFORM);
      CommonTransformer.addIfNotExists(root, t, tree, "iris_ModelViewMat", Type.F32MAT4X4, StorageType.UNIFORM);
      CommonTransformer.addIfNotExists(root, t, tree, "iris_ModelViewMatInverse", Type.F32MAT4X4, StorageType.UNIFORM);
      root.rename("normalMatrix", "iris_NormalMat");
      root.rename("gl_NormalMatrix", "iris_NormalMat");
      CommonTransformer.addIfNotExists(root, t, tree, "iris_NormalMat", Type.F32MAT3X3, StorageType.UNIFORM);
      root.rename("chunkOffset", "iris_ChunkOffset");
      CommonTransformer.addIfNotExists(root, t, tree, "iris_ChunkOffset", Type.F32VEC3, StorageType.UNIFORM);
      ...
      if (parameters.type == PatchShaderType.VERTEX) {
         ...
         CommonTransformer.addIfNotExists(root, t, tree, "iris_Color", Type.F32VEC4, StorageType.IN);
         CommonTransformer.addIfNotExists(root, t, tree, "iris_ColorModulator", Type.F32VEC4, StorageType.UNIFORM);
         CommonTransformer.addIfNotExists(root, t, tree, "iris_Position", Type.F32VEC3, StorageType.IN);
         CommonTransformer.addIfNotExists(root, t, tree, "iris_Normal", Type.F32VEC3, StorageType.IN);
         CommonTransformer.addIfNotExists(root, t, tree, "iris_UV0", Type.F32VEC2, StorageType.IN);
         CommonTransformer.addIfNotExists(root, t, tree, "iris_UV1", Type.F32VEC2, StorageType.IN);
         CommonTransformer.addIfNotExists(root, t, tree, "iris_UV2", Type.F32VEC2, StorageType.IN);
      }
   }
}
