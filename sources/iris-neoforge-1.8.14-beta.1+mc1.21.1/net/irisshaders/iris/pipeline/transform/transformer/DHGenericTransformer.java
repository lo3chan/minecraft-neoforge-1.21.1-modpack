...
public class DHGenericTransformer {
   public static void transform(ASTParser t, TranslationUnit tree, Root root, Parameters parameters) {
      ...
      if (parameters.type.glShaderType == ShaderType.VERTEX) {
         ...
         tree.parseAndInjectNodes(
            ...
            new String[]{
               "uniform mat4 iris_ProjectionMatrix;", "uniform mat4 iris_ModelViewMatrix;", "vec4 getVertexPosition() { return vec4(_vert_position, 1.0); }"
            }
         );
   ...
   public static void injectVertInit(ASTParser t, TranslationUnit tree, Root root, Parameters parameters) {
      ...
      CommonTransformer.addIfNotExists(root, t, tree, "iris_color", Type.F32VEC4, StorageType.IN, 1);
      CommonTransformer.addIfNotExists(root, t, tree, "aScale", Type.F32VEC3, StorageType.IN, 2);
      CommonTransformer.addIfNotExists(root, t, tree, "aTranslateChunk", Type.I32VEC3, StorageType.IN, 3);
      CommonTransformer.addIfNotExists(root, t, tree, "aTranslateSubChunk", Type.F32VEC3, StorageType.IN, 4);
      CommonTransformer.addIfNotExists(root, t, tree, "aMaterial", Type.INT32, StorageType.IN, 5);
      CommonTransformer.addIfNotExists(root, t, tree, "vPosition", Type.F32VEC3, StorageType.IN, 0);
