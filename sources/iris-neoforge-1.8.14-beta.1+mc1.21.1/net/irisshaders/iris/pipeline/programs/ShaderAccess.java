...
public class ShaderAccess {
   ...
   public static ShaderInstance getMekasuitShader() {
      ...
      return pipeline instanceof ShaderRenderingPipeline
         ? ((ShaderRenderingPipeline)pipeline)
            .getShaderMap()
            .getShader(ShadowRenderingState.areShadowsCurrentlyBeingRendered() ? ShaderKey.SHADOW_ENTITIES_CUTOUT : ShaderKey.ENTITIES_TRANSLUCENT)
   ...
   public static ShaderInstance getSPSShader() {
      ...
      return pipeline instanceof ShaderRenderingPipeline
         ? ((ShaderRenderingPipeline)pipeline)
            .getShaderMap()
            .getShader(ShadowRenderingState.areShadowsCurrentlyBeingRendered() ? ShaderKey.SHADOW_ENTITIES_CUTOUT : ShaderKey.SPS)
         : GameRenderer.getRendertypeEntityCutoutShader();
   }
}
