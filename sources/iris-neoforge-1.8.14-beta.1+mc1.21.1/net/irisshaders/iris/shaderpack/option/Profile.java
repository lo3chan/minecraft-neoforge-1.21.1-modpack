...
public final class Profile {
   ...
   public boolean matches(OptionSet options, OptionValues values) {
      for (Entry<String, String> entry : this.optionValues.entrySet()) {
   ...
   public static class Builder {
      ...
      public Profile.Builder option(String optionId, String value) {
         this.optionValues.put(optionId, value);
         return this;
      }

      public Profile.Builder disableProgram(String programId) {
         this.disabledPrograms.add(programId);
         return this;
      }

      public Profile.Builder addAll(Profile other) {
