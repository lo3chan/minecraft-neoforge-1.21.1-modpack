...
public class OptionMenuStringOptionElement extends OptionMenuOptionElement {
   ...
   public OptionMenuStringOptionElement(
      String elementString, OptionMenuContainer container, ShaderProperties shaderProperties, OptionValues values, StringOption option
   ) {
