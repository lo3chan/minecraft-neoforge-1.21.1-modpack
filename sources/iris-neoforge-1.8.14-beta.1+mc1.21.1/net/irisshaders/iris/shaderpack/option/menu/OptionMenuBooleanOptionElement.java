...
public class OptionMenuBooleanOptionElement extends OptionMenuOptionElement {
   ...
   public OptionMenuBooleanOptionElement(
      String elementString, OptionMenuContainer container, ShaderProperties shaderProperties, OptionValues values, BooleanOption option
   ) {
