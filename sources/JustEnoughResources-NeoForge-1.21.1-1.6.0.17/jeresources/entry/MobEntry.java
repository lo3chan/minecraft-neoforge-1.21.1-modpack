...
public class MobEntry {
   ...
   private MobEntry(
      Supplier<LivingEntity> entitySupplier, @Nullable LightLevel lightLevel, @Nullable ExperienceRange experience, List<String> biomes, List<LootDrop> drops
   ) {
   ...
   public Stream<String> getTranslatedBiomes() {
      return this.biomes.stream().map(x$0 -> TranslationHelper.translateAndFormat(x$0));
   }
