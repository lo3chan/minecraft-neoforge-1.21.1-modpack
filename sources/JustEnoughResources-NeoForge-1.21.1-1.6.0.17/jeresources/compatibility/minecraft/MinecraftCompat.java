...
public class MinecraftCompat extends CompatBase {
   ...
   private void registerVanillaMobs() {
      ...
      LootTableHelper.getAllMobLootTables()
         ...
         .forEach(x$0 -> this.registerMob(x$0));
   ...
   private void registerDungeonLoot() {
      LootTableFetcher lootTableFetcher = LootTableHelper.getLootTableFetcher();
      LootTableHelper.getAllChestLootTablesResourceKeys()
         .stream()
         .map(resourceKey -> new DungeonEntry(resourceKey.location().getPath(), lootTableFetcher.getLootTable((ResourceKey<LootTable>)resourceKey)))
         .forEach(x$0 -> this.registerDungeonEntry(x$0));
   }
   ...
   private void registerOres() {
      this.registerWorldGen(
         new WorldGenEntry(
            ...
            new DistributionSquare(30, 16, 136, 256),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.COAL), 1, 4, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.COAL_ORE),
            new ItemStack(Blocks.DEEPSLATE_COAL_ORE),
            new DistributionTriangular(20, 16, 96, 96),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.COAL), 1, 4, Conditional.affectedByFortune)
         )
      ...
      this.registerWorldGen(
         new WorldGenEntry(
            ...
            new DistributionTriangular(16, 8, 46, 66),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_COPPER), 2, 20, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.COPPER_ORE),
            new ItemStack(Blocks.DEEPSLATE_COPPER_ORE),
            new DistributionTriangular(16, 16, 46, 66),
            new Restriction(BiomeRestriction.DRIPSTONE_CAVES, DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_COPPER), 2, 20, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            ...
            new ItemStack(Blocks.DEEPSLATE_LAPIS_ORE),
            new DistributionSquare(4, 8, -64, 64),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.LAPIS_LAZULI), 4, 36, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.LAPIS_ORE),
            new ItemStack(Blocks.DEEPSLATE_LAPIS_ORE),
            new DistributionTriangular(2, 8, 0, 32),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.LAPIS_LAZULI), 4, 36, Conditional.affectedByFortune)
         )
      ...
      this.registerWorldGen(
         new WorldGenEntry(
            ...
            new ItemStack(Blocks.DEEPSLATE_IRON_ORE),
            new DistributionTriangular(90, 8, 232, 152),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_IRON), 1, 4, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.IRON_ORE),
            new ItemStack(Blocks.DEEPSLATE_IRON_ORE),
            new DistributionTriangular(10, 8, 16, 40),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_IRON), 1, 4, Conditional.affectedByFortune)
         )
      ...
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.IRON_ORE),
            new ItemStack(Blocks.DEEPSLATE_IRON_ORE),
            new DistributionSquare(10, 8, -64, 72),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_IRON), 1, 4, Conditional.affectedByFortune)
         )
      ...
      this.registerWorldGen(
         new WorldGenEntry(
            ...
            new ItemStack(Blocks.DEEPSLATE_GOLD_ORE),
            new DistributionSquare(1, 8, -64, -48),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_GOLD), 1, 4, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.GOLD_ORE),
            new ItemStack(Blocks.DEEPSLATE_GOLD_ORE),
            new DistributionTriangular(4, 8, -16, 48),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_GOLD), 1, 4, Conditional.affectedByFortune)
         )
      ...
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.GOLD_ORE),
            new ItemStack(Blocks.DEEPSLATE_GOLD_ORE),
            new DistributionTriangular(50, 8, -16, 48),
            new Restriction(BiomeRestriction.BADLANDS, DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.RAW_GOLD), 1, 4, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            ...
            new DistributionTriangular(8, 8, -64, 32),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.REDSTONE), 1, 32, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.REDSTONE_ORE),
            new ItemStack(Blocks.DEEPSLATE_REDSTONE_ORE),
            new DistributionSquare(4, 8, -64, 15),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.REDSTONE), 1, 32, Conditional.affectedByFortune)
         )
      ...
      this.registerWorldGen(
         new WorldGenEntry(
            ...
            new ItemStack(Blocks.DEEPSLATE_DIAMOND_ORE),
            new DistributionTriangular(6, 6, -64, 64),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.DIAMOND), 1, 4, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.EMERALD_ORE),
            new ItemStack(Blocks.DEEPSLATE_EMERALD_ORE),
            new DistributionTriangular(100, 4, 202, 218),
            new Restriction(DimensionRestriction.OVERWORLD),
            true,
            new LootDrop(new ItemStack(Items.EMERALD), 1, 4, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.NETHER_QUARTZ_ORE),
            new DistributionSquare(16, 16, 10, 128),
            new Restriction(DimensionRestriction.NETHER),
            true,
            new LootDrop(new ItemStack(Items.QUARTZ), 1, 4, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(
            new ItemStack(Blocks.NETHER_GOLD_ORE),
            new DistributionSquare(8, 16, 15, 117),
            new Restriction(DimensionRestriction.NETHER),
            true,
            new LootDrop(new ItemStack(Items.GOLD_NUGGET), 2, 24, Conditional.affectedByFortune)
         )
      );
      this.registerWorldGen(
         new WorldGenEntry(new ItemStack(Blocks.ANCIENT_DEBRIS), new DistributionTriangular(14, 9, 1.6E-4F), new Restriction(DimensionRestriction.NETHER))
      );
   }
