...
public class Wing extends EntityModel<AbstractClientPlayer> implements IWingModel {
   ...
   public void render(
      ...
      if (!player.isInvisible()) {
         ...
         this.setRotationAngle(this.cube_r1, 0.0F, 0.52365F + 0.17455F * (float)Math.sin(type.flapSpeed * 3.141592653589793 * rotationTime / 20.0), 0.0F);
         this.setRotationAngle(this.cube_r2, 0.0F, -(0.52365F + 0.17455F * (float)Math.sin(type.flapSpeed * 3.141592653589793 * rotationTime / 20.0)), 0.0F);
         this.renderToBuffer(stack, buf.getBuffer(RenderType.entityTranslucent(texture)), packedLightIn, OverlayTexture.NO_OVERLAY, -1);
      }
   }
   ...
   public static LayerDefinition createLayer() {
      ...
      partdefinition.getChild("bb_main")
         .addOrReplaceChild(
            "cube_r1",
            CubeListBuilder.create().texOffs(0, 0).addBox(1.0F, -8.0F, 0.0F, 16.0F, 16.0F, 0.0F, CubeDeformation.NONE.extend(0.001F)),
            PartPose.offsetAndRotation(0.0F, -8.0F, 0.0F, 0.0F, 0.3491F, 0.0F)
         );
      partdefinition.getChild("bb_main")
         .addOrReplaceChild(
            "cube_r2",
