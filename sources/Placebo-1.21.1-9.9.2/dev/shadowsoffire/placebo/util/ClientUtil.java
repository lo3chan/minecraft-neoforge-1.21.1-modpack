...
public class ClientUtil {
   ...
   public static void colorBlit(PoseStack pMatrixStack, int pX, int pY, int pBlitOffset, int pWidth, int pHeight, TextureAtlasSprite pSprite, int color) {
      innerBlit(
         pMatrixStack.last().pose(), pX, pX + pWidth, pY, pY + pHeight, pBlitOffset, pSprite.getU0(), pSprite.getU1(), pSprite.getV0(), pSprite.getV1(), color
      );
   }
   ...
   public static void innerBlit(
      Matrix4f pMatrix, float pX1, float pX2, float pY1, float pY2, int pBlitOffset, float pMinU, float pMaxU, float pMinV, float pMaxV, int color
   ) {
