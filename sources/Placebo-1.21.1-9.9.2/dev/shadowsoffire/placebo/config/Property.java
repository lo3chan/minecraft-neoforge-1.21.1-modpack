...
public class Property {
   ...
   Property(String name, String value, Property.Type type, boolean read, String[] validValues, String langKey) {
      ...
      this.minValue = String.valueOf(-2147483648);
      this.maxValue = String.valueOf(2147483647);
   ...
   public boolean isDefault() {
      if (this.isBooleanList()) {
         ...
         return this.type == Property.Type.DOUBLE && this.isDoubleValue()
            ? Double.parseDouble(this.value) == Double.parseDouble(this.defaultValue)
   ...
   public Property setMaxListLength(int max) {
      ...
      if (this.maxListLength != -1) {
         ...
         if (this.defaultValues != null
            && this.defaultValues.length != this.maxListLength
            && (this.isListLengthFixed || this.defaultValues.length > this.maxListLength)) {
