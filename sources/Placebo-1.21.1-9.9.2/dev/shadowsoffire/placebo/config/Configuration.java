...
public class Configuration {
   ...
   public Configuration(File file) {
      ...
      try {
         ...
         Placebo.LOGGER
            .fatal(
               "An exception occurred while loading config file {}. This file will be renamed to {} and a new config file will be generated.",
               file.getName(),
               fileBak.getName(),
               var4
            );
   ...
   public Property get(String category, String key, int defaultValue) {
      return this.get(category, key, defaultValue, null, -2147483648, 2147483647);
   }

   public Property get(String category, String key, int defaultValue, String comment) {
      return this.get(category, key, defaultValue, comment, -2147483648, 2147483647);
   }
   ...
   public Property get(String category, String key, int[] defaultValues, String comment) {
      return this.get(category, key, defaultValues, comment, -2147483648, 2147483647, false, -1);
   }
   ...
   public Property get(String category, String key, double defaultValue, String comment) {
      return this.get(category, key, defaultValue, comment, -1.7976931348623157E308, 1.7976931348623157E308);
   }
   ...
   public Property get(String category, String key, double[] defaultValues, String comment) {
      return this.get(category, key, defaultValues, comment, -1.7976931348623157E308, 1.7976931348623157E308, false, -1);
   }
