...
public abstract class AbstractCachedDynamicModel implements BakedModel {
   ...
   private final TextureGetter textureGetter;
      ...
      if (state != null) {
         ...
         synchronized (this.cache) {
            ...
            if (bakedModel == null) {
               ...
               UnbakedModel retexturedBaseModel = this.textureMapFunction != null
                  ? models.retexture(this.modelBakery, baseModelLocation, this.textureMapFunction.apply(state))
                  : this.modelResolver.apply(baseModelLocation);
