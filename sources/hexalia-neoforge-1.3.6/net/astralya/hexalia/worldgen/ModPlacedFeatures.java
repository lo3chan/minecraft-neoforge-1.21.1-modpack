...
public final class ModPlacedFeatures {
   ...
   public static void bootstrap(BootstrapContext<PlacedFeature> context) {
      ...
      register(
         context, COTTONWOOD_PLACED, configured.getOrThrow(ModConfiguredFeatures.COTTONWOOD), rareTreePlacement((Block)ModBlocks.COTTONWOOD_SAPLING.get(), 25)
      );
      register(context, WILLOW_PLACED, configured.getOrThrow(ModConfiguredFeatures.WILLOW), rareTreePlacement((Block)ModBlocks.WILLOW_SAPLING.get(), 25));
   ...
   private static ResourceKey<PlacedFeature> registerKey(String name) {
      return ResourceKey.create(Registries.PLACED_FEATURE, ResourceLocation.fromNamespaceAndPath("hexalia", name));
   }
