...
public class PointingChatBubbleOverlay implements Renderable {
   ...
   public PointingChatBubbleOverlay(AbstractWidget target, IntSupplier screenWidth, Supplier<Component> messageSupplier) {
      this(target, screenWidth, messageSupplier, true);
   }

   public PointingChatBubbleOverlay(AbstractWidget target, IntSupplier screenWidth, Supplier<Component> messageSupplier, boolean animated) {
      this.target = target;
