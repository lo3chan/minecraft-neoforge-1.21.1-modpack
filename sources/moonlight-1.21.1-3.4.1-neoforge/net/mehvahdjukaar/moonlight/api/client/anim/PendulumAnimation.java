...
public class PendulumAnimation extends SwingAnimation {
   ...
   public void addPositiveImpulse(float vel) {
      this.addImpulse(Math.abs(vel) * (this.angularVel < 0.0F ? -1 : 1));
   }
   ...
   public static class Config {
      public static final Codec<PendulumAnimation.Config> CODEC = RecordCodecBuilder.create(
         instance -> instance.group(
               Codec.floatRange(0.0F, 360.0F).fieldOf("min_angle").forGetter(c -> 57.295776F * c.minAngle),
               Codec.floatRange(0.0F, 360.0F).fieldOf("max_angle").forGetter(c -> 57.295776F * c.maxAngle),
      ...
      public Config(float minAngle, float maxAngle, float damping, float frequency, boolean collisionHitbox, float collisionMass, float collisionForce) {
         this.minAngle = minAngle * 0.017453292F;
         this.maxAngle = maxAngle * 0.017453292F;
