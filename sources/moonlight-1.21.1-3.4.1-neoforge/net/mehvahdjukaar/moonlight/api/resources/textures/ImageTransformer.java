...
public class ImageTransformer {
   ...
   private record Tpos(int startX, int startY, int width, int height, int targetX, int targetY, int targetW, int targetH) {
      public ImageTransformer.Tpos scaled(int oFrameW, int oFrameH, int tFrameW, int tFrameH, int oW, int oH, int tW, int tH) {
         float scaleOW = (float)oFrameW / oW;
         float scaleOH = (float)oFrameH / oH;
         float scaleTW = (float)tFrameW / tW;
         float scaleTH = (float)tFrameH / tH;
         return new ImageTransformer.Tpos(
            (int)(scaleOW * this.startX),
            (int)(scaleOH * this.startY),
            (int)(scaleOW * this.width),
            (int)(scaleOH * this.height),
            (int)(scaleTW * this.targetX),
            (int)(scaleTH * this.targetY),
            (int)(scaleTW * this.targetW),
            (int)(scaleTH * this.targetH)
         );
      }
