...
public class MLMapDecoration {
   public static final StreamCodec<RegistryFriendlyByteBuf, MLMapDecoration> CODEC = MLMapDecorationType.STREAM_CODEC
      .dispatch(MLMapDecoration::getType, h -> ((MLMapDecorationType)h.value()).getDecorationCodec());
   static final StreamCodec<RegistryFriendlyByteBuf, MLMapDecoration> DIRECT_CODEC = StreamCodec.composite(
      MLMapDecorationType.STREAM_CODEC,
      MLMapDecoration::getType,
      ByteBufCodecs.BYTE,
      MLMapDecoration::getX,
      ByteBufCodecs.BYTE,
      MLMapDecoration::getY,
      ByteBufCodecs.BYTE,
      MLMapDecoration::getRot,
      ComponentSerialization.OPTIONAL_STREAM_CODEC,
      m -> Optional.ofNullable(m.getDisplayName()),
      MLMapDecoration::new
   );
   ...
   public MLMapDecoration(Holder<MLMapDecorationType<?, ?>> type, byte x, byte y, byte rot, Optional<Component> displayName) {
      this.type = type;
      this.x = x;
      this.y = y;
      this.rot = rot;
