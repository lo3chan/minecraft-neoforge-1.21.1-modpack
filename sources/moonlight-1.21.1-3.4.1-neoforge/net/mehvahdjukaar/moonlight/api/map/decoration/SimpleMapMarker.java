...
public class SimpleMapMarker extends MLMapMarker<MLMapDecoration> {
   public static final MapCodec<SimpleMapMarker> DIRECT_CODEC = RecordCodecBuilder.mapCodec(i -> baseCodecGroup(i).apply(i, SimpleMapMarker::new));
   ...
   protected MLMapDecoration doCreateDecoration(byte mapX, byte mapY, byte rot) {
      return new MLMapDecoration(this.getType(), mapX, mapY, rot, this.getDisplayName());
   }
}
