...
public class DebugRenderersCommand {
   ...
   public static final DebugRenderersCommand.DebugConfig<EntityType<?>> DEBUG_PATHFINDING = new DebugRenderersCommand.DebugConfig<>(Registries.ENTITY_TYPE);
   public static final DebugRenderersCommand.DebugConfig<EntityType<?>> DEBUG_GOAL_SELECTOR = new DebugRenderersCommand.DebugConfig<>(Registries.ENTITY_TYPE);
   public static final DebugRenderersCommand.DebugConfig<Structure> DEBUG_STRUCTURES_BB = new DebugRenderersCommand.DebugConfig<>(Registries.STRUCTURE);
   ...
   public static ArgumentBuilder<CommandSourceStack, ?> register(CommandBuildContext context) {
      return ((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)((LiteralArgumentBuilder)Commands.literal(
                                                                     "debug_renderers"
                                                                  )
                                                                  .requires(cs -> cs.hasPermission(2)))
                                                               .then(Commands.literal("neighbors_update").executes(DebugRenderersCommand::neighbors)))
                                                            .then(
                                                               ((LiteralArgumentBuilder)Commands.literal("navigation")
                                                                     .executes(DebugRenderersCommand::navigation))
                                                                  .then(
                                                                     ((RequiredArgumentBuilder)Commands.argument(
                                                                              "entity", ResourceKeyArgument.key(Registries.ENTITY_TYPE)
                                                                           )
                                                                           .executes(DebugRenderersCommand::navigation))
                                                                        .then(
                                                         ...
                                                         .then(
                                                            ((LiteralArgumentBuilder)Commands.literal("goals_selector").executes(DebugRenderersCommand::goals))
                                                               .then(
                                                                  ((RequiredArgumentBuilder)Commands.argument(
                                                                           "entity", ResourceKeyArgument.key(Registries.ENTITY_TYPE)
                                                                        )
                                                      ...
                                                      .then(
                                                         ((LiteralArgumentBuilder)Commands.literal("structures").executes(DebugRenderersCommand::structures))
                                                            .then(
                                                               ((RequiredArgumentBuilder)Commands.argument("structure", STRUCTURE_ARG)
                                                   ...
                                                   .then(Commands.literal("section_path").executes(DebugRenderersCommand::sectionPath)))
                                                .then(Commands.literal("smart_cull").executes(DebugRenderersCommand::smartCull)))
                                             .then(
                                                ((LiteralArgumentBuilder)Commands.literal("frustum")
                                                      .then(Commands.literal("capture").executes(DebugRenderersCommand::captureFrustum)))
                                                   .then(Commands.literal("kill").executes(DebugRenderersCommand::killFrustum))
                                             ))
                                          .then(Commands.literal("section_visibility").executes(DebugRenderersCommand::sectionVisibility)))
                                       .then(Commands.literal("wireframe").executes(DebugRenderersCommand::wireframe)))
                                    .then(Commands.literal("water").executes(DebugRenderersCommand::water)))
                                 .then(Commands.literal("heightmap").executes(DebugRenderersCommand::heightmap)))
                              .then(Commands.literal("collision").executes(DebugRenderersCommand::collision)))
                           .then(Commands.literal("support").executes(DebugRenderersCommand::support)))
                        .then(Commands.literal("light").executes(DebugRenderersCommand::light)))
                     .then(Commands.literal("world_gen_attempts").executes(DebugRenderersCommand::worldGen)))
                  .then(Commands.literal("solid_faces").executes(DebugRenderersCommand::solidFaces)))
               .then(Commands.literal("game_events").executes(DebugRenderersCommand::gameEvents)))
            .then(Commands.literal("sky_light_sections").executes(DebugRenderersCommand::skyLightSections)))
         .then(Commands.literal("breeze").executes(DebugRenderersCommand::breeze));
   }

   private static void sendSuccess(CommandContext<CommandSourceStack> ctx, boolean value, String name) {
      ((CommandSourceStack)ctx.getSource())
         .sendSuccess(() -> Component.translatable(value ? "commands.moonlight." + name + ".on" : "commands.moonlight." + name + ".off"), false);
   }
   ...
   private static int captureFrustum(CommandContext<CommandSourceStack> ctx) {
      ...
      ((CommandSourceStack)ctx.getSource()).sendSuccess(() -> Component.translatable("commands.moonlight.frustum.captured"), false);
      return 1;
   }
   ...
   private static int killFrustum(CommandContext<CommandSourceStack> ctx) {
      ...
      ((CommandSourceStack)ctx.getSource()).sendSuccess(() -> Component.translatable("commands.moonlight.frustum.killed"), false);
      return 1;
   }
   ...
   private static <T> void toggle(CommandContext<CommandSourceStack> ctx, String keyKey, DebugRenderersCommand.DebugConfig<T> config, String translation) {
      Boolean active = getOptArg(ctx, "active", Boolean.class);
      Optional<ResourceKey<T>> key = getResourceKey(ctx, keyKey, config.registryKey);
      Component comp;
      if (key.isPresent()) {
         ResourceLocation location = key.get().location();
         active = active != null ? active : !config.keys.contains(location);
         if (active) {
            comp = Component.translatable("commands.moonlight." + translation + ".add", new Object[]{location.toString()});
         } else {
            comp = Component.translatable("commands.moonlight." + translation + ".remove", new Object[]{location.toString()});
         }
      ...
      ((CommandSourceStack)ctx.getSource()).sendSuccess(() -> comp, false);
   }
   ...
   public static class DebugConfig<T> {
      ...
      public boolean isActive(ResourceLocation key) {
         if (this.allActive) {
            ...
            return this.keys.isEmpty() ? false : this.keys.contains(key);
         }
      }
      ...
      public boolean isActive(T element, RegistryAccess access) {
         if (this.allActive) {
            ...
            return this.keys.isEmpty() ? false : this.isActive(access.registryOrThrow(this.registryKey).getKey(element));
         }
      }
