...
public record ResourceLootItemCondition(LoaderCondition condition) implements LootItemCondition {
   public static final MapCodec<ResourceLootItemCondition> CODEC = RecordCodecBuilder.mapCodec(
      i -> i.group(PlatHelper.getConditionCodec().forGetter(o -> o.condition)).apply(i, ResourceLootItemCondition::new)
   );

   public boolean test(LootContext lootContext) {
      return this.condition.test(lootContext.getLevel().registryAccess());
   }
