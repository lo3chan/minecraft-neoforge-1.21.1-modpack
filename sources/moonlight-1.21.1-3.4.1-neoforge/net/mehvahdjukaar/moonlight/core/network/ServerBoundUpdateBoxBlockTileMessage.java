...
public record ServerBoundUpdateBoxBlockTileMessage(BlockPos tilePos, BlockPos offset, Vec3i size, String name, boolean showBB, String finalState)
   implements Message {
   ...
   public ServerBoundUpdateBoxBlockTileMessage(RegistryFriendlyByteBuf buf) {
      this(
         buf.readBlockPos(),
         buf.readBlockPos(),
         new Vec3i(buf.readVarInt(), buf.readVarInt(), buf.readVarInt()),
         buf.readUtf(32767),
         buf.readBoolean(),
         buf.readUtf(32767)
      );
   ...
   public void handle(Message.Context context) {
      ...
      if (player.canUseGameMasterBlocks() && level.getBlockEntity(this.tilePos) instanceof SpawnBoxBlockEntity boxTile) {
