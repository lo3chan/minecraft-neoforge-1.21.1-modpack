...
public class SpeedProperty extends FloatRangeFromStringArrayProperty {
   protected SpeedProperty(Properties properties, int propertyNum) throws RandomProperty.RandomPropertyException {
      super(readPropertiesOrThrow(properties, propertyNum, new String[]{"speed", "maxSpeed", "speeds"}));
   }
   ...
   protected Float getRangeValueFromEntity(ETFEntityRenderState entity) {
      return entity != null && entity.entity() instanceof LivingEntity alive ? alive.getSpeed() : null;
   }
