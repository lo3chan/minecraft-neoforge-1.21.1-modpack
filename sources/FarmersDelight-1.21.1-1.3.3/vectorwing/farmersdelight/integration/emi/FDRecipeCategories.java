...
public class FDRecipeCategories {
   ...
   public static final EmiRecipeCategory COOKING = new EmiRecipeCategory(
      RecipeUtils.FDLocation("cooking"), FDRecipeWorkstations.COOKING_POT, simplifiedRenderer(0, 0)
   );
   public static final EmiRecipeCategory CUTTING = new EmiRecipeCategory(
      RecipeUtils.FDLocation("cutting"), FDRecipeWorkstations.CUTTING_BOARD, simplifiedRenderer(16, 0)
   );
   public static final EmiRecipeCategory DECOMPOSITION = new EmiRecipeCategory(
      RecipeUtils.FDLocation("decomposition"), FDRecipeWorkstations.ORGANIC_COMPOST, simplifiedRenderer(32, 0)
   );
