...
public class ItemStackWrapper {
   ...
   public static final StreamCodec<RegistryFriendlyByteBuf, ItemStackWrapper> STREAM_CODEC = ItemStack.OPTIONAL_STREAM_CODEC
      .map(ItemStackWrapper::new, itemStackWrapper -> itemStackWrapper.itemStack);
   ...
   public boolean equals(Object object) {
      return object instanceof ItemStackWrapper itemStackWrapper ? ItemStack.matches(this.itemStack, itemStackWrapper.getStack()) : false;
   }
}
