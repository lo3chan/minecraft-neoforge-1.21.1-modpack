...
public class Configuration {
   ...
   public static BooleanValue FARMERS_BUY_FD_CROPS;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue WANDERING_TRADER_SELLS_FD_ITEMS;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue ENABLE_RECIPE_BOOK_COOKING_POT;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue VANILLA_SOUP_EXTRA_EFFECTS;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue RABBIT_STEW_BUFF;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue DISPENSER_TOOLS_CUTTING_BOARD;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue NOURISHMENT_HUNGER_OVERLAY;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue COMFORT_HEALTH_OVERLAY;
   @Deprecated(
      forRemoval = true
   )
   public static BooleanValue FOOD_EFFECT_TOOLTIP;
   ...
   static {
      ...
      ENABLE_WANDERING_TRADER_SELLS_FD_ITEMS = COMMON_BUILDER.comment(
      ...
      ENABLE_ROPE_REELING = COMMON_BUILDER.comment(
      ...
      CANVAS_SIGN_DARK_BACKGROUND_LIST = COMMON_BUILDER.comment(
            new String[]{
      ...
      COMMON_BUILDER.pop();
      COMMON_BUILDER.push("farming");
      RICH_SOIL_BOOST_CHANCE = COMMON_BUILDER.comment(
      ...
      ENABLE_TOMATO_VINE_CLIMBING_TAGGED_ROPES = COMMON_BUILDER.comment(
      ...
      COMMON_BUILDER.pop();
      COMMON_BUILDER.push("crafting");
      ENABLE_COOKING_POT_RECIPE_BOOK = COMMON_BUILDER.comment(
      ...
      ENABLE_VANILLA_CROP_CRATES = COMMON_BUILDER.comment(
      ...
      CUTTING_BOARD_FORTUNE_BONUS = COMMON_BUILDER.comment(
      ...
      COMMON_BUILDER.pop();
      COMMON_BUILDER.push("overrides");
      ENABLE_VANILLA_SOUP_EXTRA_EFFECTS = COMMON_BUILDER.comment(
      ...
      ENABLE_DISPENSER_TOOLS_CUTTING_BOARD = COMMON_BUILDER.comment(
      ...
      COMMON_BUILDER.push("stack_size");
      ENABLE_STACKABLE_SOUP_ITEMS = COMMON_BUILDER.comment(
      ...
      SOUP_ITEM_LIST = COMMON_BUILDER.comment(
      ...
      GENERATE_FD_CHEST_LOOT = COMMON_BUILDER.comment(
      ...
      GENERATE_VILLAGE_COMPOST_HEAPS = COMMON_BUILDER.comment(
      ...
      GENERATE_VILLAGE_FARM_FD_CROPS = COMMON_BUILDER.comment(
      ...
      ENABLE_TOMATO_ROPE_PERMANENCE = COMMON_BUILDER.comment(
      ...
      ENABLE_NOURISHMENT_HUNGER_OVERLAY = CLIENT_BUILDER.comment(
      ...
      ENABLE_COMFORT_HEALTH_OVERLAY = CLIENT_BUILDER.comment(
      ...
      ENABLE_FOOD_EFFECT_TOOLTIP = CLIENT_BUILDER.comment(
      ...
      FARMERS_BUY_FD_CROPS = (BooleanValue)ENABLE_FARMERS_BUY_FD_CROPS;
      WANDERING_TRADER_SELLS_FD_ITEMS = (BooleanValue)ENABLE_WANDERING_TRADER_SELLS_FD_ITEMS;
      ENABLE_RECIPE_BOOK_COOKING_POT = (BooleanValue)ENABLE_COOKING_POT_RECIPE_BOOK;
      VANILLA_SOUP_EXTRA_EFFECTS = (BooleanValue)ENABLE_VANILLA_SOUP_EXTRA_EFFECTS;
      RABBIT_STEW_BUFF = (BooleanValue)ENABLE_RABBIT_STEW_BUFF;
      DISPENSER_TOOLS_CUTTING_BOARD = (BooleanValue)ENABLE_DISPENSER_TOOLS_CUTTING_BOARD;
      NOURISHMENT_HUNGER_OVERLAY = (BooleanValue)ENABLE_NOURISHMENT_HUNGER_OVERLAY;
      COMFORT_HEALTH_OVERLAY = (BooleanValue)ENABLE_COMFORT_HEALTH_OVERLAY;
      FOOD_EFFECT_TOOLTIP = (BooleanValue)ENABLE_FOOD_EFFECT_TOOLTIP;
   }
}
