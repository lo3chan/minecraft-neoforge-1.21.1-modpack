...
public class ConsumeAction implements IngredientAction {
   ...
   public static final IngredientActionType<ConsumeAction> TYPE = new IngredientActionType<>(
      KubeJS.id("consume"), MapCodec.unit(INSTANCE), StreamCodec.unit(INSTANCE)
   );
