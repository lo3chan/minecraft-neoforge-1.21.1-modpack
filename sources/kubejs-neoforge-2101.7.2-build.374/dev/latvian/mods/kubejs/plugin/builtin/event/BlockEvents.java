...
public interface BlockEvents {
   ...
   TargetedEventHandler<ResourceKey<Block>> RIGHT_CLICKED = GROUP.common("rightClicked", () -> BlockRightClickedKubeEvent.class)
      .hasResult()
      .supportsTarget(TARGET);
   TargetedEventHandler<ResourceKey<Block>> LEFT_CLICKED = GROUP.common("leftClicked", () -> BlockLeftClickedKubeEvent.class)
      .hasResult()
      .supportsTarget(TARGET);
   ...
   TargetedEventHandler<String> DETECTOR_UNPOWERED = GROUP.common("detectorUnpowered", () -> DetectorBlockKubeEvent.class)
      .supportsTarget(EventTargetType.STRING);
   TargetedEventHandler<ResourceKey<Block>> FARMLAND_TRAMPLED = GROUP.common("farmlandTrampled", () -> FarmlandTrampledKubeEvent.class)
      .hasResult()
      .supportsTarget(TARGET);
   ...
   TargetedEventHandler<ResourceKey<Block>> STARTED_FALLING = GROUP.common("startedFalling", () -> BlockStartedFallingKubeEvent.class)
      .hasResult()
      .supportsTarget(TARGET);
   ...
   TargetedEventHandler<ResourceKey<Block>> PICKED = GROUP.common("picked", () -> BlockPickedKubeEvent.class)
