...
public interface ServerEvents {
   ...
   TargetedEventHandler<ResourceKey<Registry<?>>> REGISTRY = GROUP.server("registry", () -> ServerRegistryKubeEvent.class)
      .requiredTarget(EventTargetType.REGISTRY);
   TargetedEventHandler<GeneratedDataStage> GENERATE_DATA = GROUP.server("generateData", () -> KubeDataGenerator.class)
      .requiredTarget(GeneratedDataStage.TARGET);
   ...
   TargetedEventHandler<ResourceKey<Registry<?>>> TAGS = GROUP.server("tags", () -> TagKubeEvent.class)
      .exceptionHandler(TagKubeEvent.TAG_EVENT_HANDLER)
      .requiredTarget(EventTargetType.REGISTRY);
   ...
   TargetedEventHandler<String> BASIC_COMMAND = GROUP.server("basicCommand", () -> BasicCommandKubeEvent.class)
      .hasResult()
      .requiredTarget(EventTargetType.STRING);
   TargetedEventHandler<String> BASIC_PUBLIC_COMMAND = GROUP.server("basicPublicCommand", () -> BasicCommandKubeEvent.class)
      .hasResult()
      .requiredTarget(EventTargetType.STRING);
   ...
   TargetedEventHandler<String> MODIFY_RECIPE_RESULT = GROUP.server("modifyRecipeResult", () -> ModifyCraftingItemKubeEvent.class)
      .hasResult(ItemWrapper.TYPE_INFO)
      .requiredTarget(EventTargetType.STRING);
   TargetedEventHandler<String> MODIFY_RECIPE_INGREDIENT = GROUP.server("modifyRecipeIngredient", () -> ModifyCraftingItemKubeEvent.class)
      .hasResult(ItemWrapper.TYPE_INFO)
      .requiredTarget(EventTargetType.STRING);
}
