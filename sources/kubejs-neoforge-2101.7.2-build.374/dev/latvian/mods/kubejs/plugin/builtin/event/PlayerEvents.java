...
public interface PlayerEvents {
   ...
   TargetedEventHandler<ResourceLocation> ADVANCEMENT = GROUP.server("advancement", () -> PlayerAdvancementKubeEvent.class)
      .hasResult()
      .supportsTarget(EventTargetType.ID);
   TargetedEventHandler<ResourceKey<MenuType<?>>> INVENTORY_OPENED = GROUP.common("inventoryOpened", () -> InventoryKubeEvent.class)
      .supportsTarget(MENU_TARGET);
   TargetedEventHandler<ResourceKey<MenuType<?>>> INVENTORY_CLOSED = GROUP.common("inventoryClosed", () -> InventoryKubeEvent.class)
      .supportsTarget(MENU_TARGET);
   TargetedEventHandler<ResourceKey<Item>> INVENTORY_CHANGED = GROUP.common("inventoryChanged", () -> InventoryChangedKubeEvent.class)
