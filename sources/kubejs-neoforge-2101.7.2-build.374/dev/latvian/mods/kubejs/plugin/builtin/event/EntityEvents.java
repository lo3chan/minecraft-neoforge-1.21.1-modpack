...
public interface EntityEvents {
   ...
   TargetedEventHandler<ResourceKey<EntityType<?>>> BEFORE_HURT = GROUP.common("beforeHurt", () -> BeforeLivingEntityHurtKubeEvent.class)
      .hasResult()
   ...
   TargetedEventHandler<ResourceKey<EntityType<?>>> CHECK_SPAWN = GROUP.common("checkSpawn", () -> CheckLivingEntitySpawnKubeEvent.class)
      .hasResult()
      .supportsTarget(TARGET);
   ...
   TargetedEventHandler<ResourceKey<EntityType<?>>> ENTITY_DROPS = GROUP.common("drops", () -> LivingEntityDropsKubeEvent.class)
      .hasResult()
      .supportsTarget(TARGET);
}
