...
public interface RecipeViewerEvents {
   ...
   EventTargetType<RecipeViewerEntryType> TARGET = EventTargetType.create(RecipeViewerEntryType.class)
      .transformer(RecipeViewerEntryType::fromString)
      .identity();
   ...
   TargetedEventHandler<RecipeViewerEntryType> REMOVE_ENTRIES_COMPLETELY = GROUP.common("removeEntriesCompletely", () -> RemoveEntriesKubeEvent.class)
   ...
   TargetedEventHandler<RecipeViewerEntryType> REGISTER_SUBTYPES = GROUP.common("registerSubtypes", () -> RegisterSubtypesKubeEvent.class)
      .requiredTarget(TARGET);
