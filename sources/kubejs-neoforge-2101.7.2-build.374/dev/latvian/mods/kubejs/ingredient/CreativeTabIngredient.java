...
public record CreativeTabIngredient(CreativeModeTab tab) implements KubeJSIngredient {
   public static final MapCodec<CreativeTabIngredient> CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(BuiltInRegistries.CREATIVE_MODE_TAB.byNameCodec().fieldOf("tab").forGetter(CreativeTabIngredient::tab))
