...
public record RegExIngredient(Pattern pattern, String patternString) implements KubeJSIngredient {
   public static final MapCodec<RegExIngredient> CODEC = RecordCodecBuilder.mapCodec(
      instance -> instance.group(RegExpKJS.CODEC.fieldOf("pattern").forGetter(RegExIngredient::pattern)).apply(instance, RegExIngredient::new)
   );
   ...
   public boolean equals(Object o) {
      return o == this || o instanceof RegExIngredient i && this.patternString.equals(i.patternString);
   }
