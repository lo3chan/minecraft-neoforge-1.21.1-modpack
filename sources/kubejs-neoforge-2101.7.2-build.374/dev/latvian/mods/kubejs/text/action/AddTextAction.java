...
public record AddTextAction(List<Component> lines) implements TextAction {
   public static final TooltipActionType<AddTextAction> TYPE = new TooltipActionType<>(
      1, ComponentSerialization.STREAM_CODEC.apply(ByteBufCodecs.list()).map(AddTextAction::new, AddTextAction::lines)
   );
