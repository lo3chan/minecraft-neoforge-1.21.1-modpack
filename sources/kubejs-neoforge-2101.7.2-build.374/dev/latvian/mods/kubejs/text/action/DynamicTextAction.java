...
public record DynamicTextAction(String id) implements TextAction {
   public static final TooltipActionType<DynamicTextAction> TYPE = new TooltipActionType<>(
      0, ByteBufCodecs.STRING_UTF8.map(DynamicTextAction::new, DynamicTextAction::id)
   );
