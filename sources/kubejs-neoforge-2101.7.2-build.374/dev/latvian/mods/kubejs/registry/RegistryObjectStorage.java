...
public final class RegistryObjectStorage<T> implements Iterable<BuilderBase<? extends T>> {
   ...
   public static final Codec<RegistryObjectStorage<?>> CODEC = ResourceLocation.CODEC
      .xmap(rl -> of(ResourceKey.createRegistryKey(rl)), ri -> ri.key.location());
   ...
   public static final RegistryObjectStorage<FluidType> FLUID_TYPE = of(Keys.FLUID_TYPES);
