...
public interface ComponentKJS extends Component, WithCodec, WrappedJS {
      ...
      return new Iterable<Component>() {
         ...
         public Iterator<Component> iterator() {
            if (!ComponentKJS.this.kjs$hasSiblings()) {
               ...
               for (Component child : ComponentKJS.this.getSiblings()) {
   ...
   default boolean kjs$hasStyle() {
      return this.getStyle() != null && !this.getStyle().isEmpty();
   }
   ...
   default MutableComponent kjs$color(@Nullable KubeColor c) {
      TextColor col = c == null ? null : c.kjs$createTextColor();
      return this.kjs$self().setStyle(this.getStyle().withColor(col));
   }
   ...
   default MutableComponent kjs$bold(@Nullable Boolean value) {
      return this.kjs$self().setStyle(this.getStyle().withBold(value));
   }
   ...
   default MutableComponent kjs$italic(@Nullable Boolean value) {
      return this.kjs$self().setStyle(this.getStyle().withItalic(value));
   }
   ...
   default MutableComponent kjs$underlined(@Nullable Boolean value) {
      return this.kjs$self().setStyle(this.getStyle().withUnderlined(value));
   }
   ...
   default MutableComponent kjs$strikethrough(@Nullable Boolean value) {
      return this.kjs$self().setStyle(this.getStyle().withStrikethrough(value));
   }
   ...
   default MutableComponent kjs$obfuscated(@Nullable Boolean value) {
      return this.kjs$self().setStyle(this.getStyle().withObfuscated(value));
   }
   ...
   default MutableComponent kjs$insertion(@Nullable String s) {
      return this.kjs$self().setStyle(this.getStyle().withInsertion(s));
   }

   default MutableComponent kjs$font(@Nullable ResourceLocation s) {
      return this.kjs$self().setStyle(this.getStyle().withFont(s));
   }

   default MutableComponent kjs$click(@Nullable ClickEvent s) {
      return this.kjs$self().setStyle(this.getStyle().withClickEvent(s));
   }
   ...
   default MutableComponent kjs$hover(@Nullable Component s) {
      return this.kjs$self()
         .setStyle(this.getStyle().withHoverEvent(s == null ? null : new HoverEvent(net.minecraft.network.chat.HoverEvent.Action.SHOW_TEXT, s)));
   }
