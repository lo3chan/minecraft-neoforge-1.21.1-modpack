...
public class ScheduledEvents {
   ...
   public ScheduledEvents.ScheduledEvent schedule(TemporalAmount timer, boolean repeating, ScheduledEvents.Callback callback) {
      if (timer instanceof TickDuration(long var8)) {
         return this.schedule(var8, true, repeating, callback);
   ...
   public interface Callback {
      TypeInfo TYPE_INFO = TypeInfo.of(ScheduledEvents.Callback.class);

      void onCallback(ScheduledEvents.ScheduledEvent event);
   }
   ...
   public static class TimeoutJSFunction extends BaseFunction {
      ...
      public Object call(Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
         if (this.clear) {
            ...
            TemporalAmount timer = (TemporalAmount)cx.jsToJava(args[1], TEMPORAL_AMOUNT_TYPE_INFO);
            ScheduledEvents.Callback callback = (ScheduledEvents.Callback)cx.createInterfaceAdapter(
               ScheduledEvents.Callback.TYPE_INFO, (ScriptableObject)args[0]
            );
