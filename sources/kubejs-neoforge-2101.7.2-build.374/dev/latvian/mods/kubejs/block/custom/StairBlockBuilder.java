...
public class StairBlockBuilder extends ShapedBlockBuilder {
   public static final ResourceLocation[] STAIR_TAGS = new ResourceLocation[]{BlockTags.STAIRS.location()};
   ...
   protected void generateBlockState(VariantBlockStateGenerator bs) {
      ResourceLocation mod = this.id.withPath(ID.BLOCK);
      ResourceLocation modInner = this.newID("block/", "_inner");
      ResourceLocation modOuter = this.newID("block/", "_outer");
