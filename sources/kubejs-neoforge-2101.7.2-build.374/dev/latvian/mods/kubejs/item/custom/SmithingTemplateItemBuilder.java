...
public class SmithingTemplateItemBuilder extends ItemBuilder {
   ...
   private static final List<ResourceLocation> TOOL_ICONS = List.of(
   ...
   private static final List<ResourceLocation> CRYSTAL_ICONS = List.of(
   ...
   public Component appliesToText = Component.literal("set with .appliesToDescription(string) on your smithing_template type item")
      .withStyle(ChatFormatting.BLUE);
   public Component ingredientsText = Component.literal("set with .ingredientsDescription(string) on your smithing_template type item")
      .withStyle(ChatFormatting.BLUE);
   ...
   public SmithingTemplateItem createObject() {
      return new SmithingTemplateItem(
         ...
         Objects.requireNonNullElse(this.displayName, Component.translatable(this.getBuilderTranslationKey()).withStyle(SmithingTemplateItem.TITLE_FORMAT)),
         this.appliesToSlotDescriptionText,
         this.ingredientSlotDescriptionText,
         this.appliesToEmptyIcons,
         this.ingredientsSlotEmptyIcons,
         new FeatureFlag[0]
      );
   }
}
