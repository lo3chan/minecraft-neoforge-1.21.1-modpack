...
public class VariantBlockStateGenerator {
   ...
   public static class Model {
      ...
      public VariantBlockStateGenerator.Model x(int x) {
         this.x = x;
         return this;
      }

      public VariantBlockStateGenerator.Model y(int y) {
         this.y = y;
         return this;
      }
   ...
   public static class Variant {
      ...
      public JsonElement toJson() {
         if (this.models.size() == 1) {
            return ((VariantBlockStateGenerator.Model)this.models.getFirst()).toJson();
         } else {
