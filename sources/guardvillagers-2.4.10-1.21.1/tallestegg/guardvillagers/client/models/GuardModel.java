...
public class GuardModel extends HumanoidModel<Guard> {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition head = partdefinition.addOrReplaceChild(
         "head",
         CubeListBuilder.create().texOffs(49, 99).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 1.0F, 0.0F)
      );
      PartDefinition rightArm = partdefinition.addOrReplaceChild(
         "right_arm",
         CubeListBuilder.create().texOffs(32, 75).mirror().addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-5.0F, 2.0F, 0.0F)
      );
      PartDefinition leftArm = partdefinition.addOrReplaceChild(
         "left_arm",
         CubeListBuilder.create().texOffs(33, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(5.0F, 2.0F, 0.0F)
      );
      torso.addOrReplaceChild(
         "quiver",
         CubeListBuilder.create().texOffs(100, 0).addBox(-2.5F, -2.0F, 0.0F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.5F, 3.0F, 2.3F, 0.0F, 0.0F, 0.2617994F)
      );
      head.addOrReplaceChild(
         "nose",
         CubeListBuilder.create().texOffs(54, 0).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, -3.0F, -4.0F)
      );
      partdefinition.addOrReplaceChild(
         "right_leg",
         CubeListBuilder.create().texOffs(16, 48).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(-1.9F, 12.0F, 0.0F)
      );
      partdefinition.addOrReplaceChild(
         "left_leg",
         CubeListBuilder.create().texOffs(16, 28).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
         PartPose.offset(1.9F, 12.0F, 0.0F)
      );
      leftArm.addOrReplaceChild(
         "shoulderPad_right",
         CubeListBuilder.create().texOffs(72, 33).mirror().addBox(0.0F, 0.0F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(-0.5F, -3.5F, 0.0F, 0.0F, 0.0F, 0.34906584F)
      );
      rightArm.addOrReplaceChild(
         "shoulderPad_left",
         CubeListBuilder.create().texOffs(72, 33).addBox(-5.0F, 0.0F, -3.0F, 5.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
         PartPose.offsetAndRotation(0.5F, -3.5F, 0.0F, 0.0F, 0.0F, -0.34906584F)
      );
      partdefinition.addOrReplaceChild(
         "hat",
         CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -11.0F, -4.5F, 9.0F, 11.0F, 9.0F, new CubeDeformation(0.0F)),
         PartPose.offset(0.0F, 0.0F, 0.0F)
      );
   ...
   public void setupAnim(Guard entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netbipedHeadYaw, float bipedHeadPitch) {
      ...
      boolean isHoldingShootable = itemstack.getItem() instanceof ProjectileWeaponItem
         || ModList.get().isLoaded("musketmod") && ModCompat.isHoldingMusket(itemstack);
      ...
      if (entityIn.getKickTicks() > 0) {
         float f1 = 1.0F - Mth.abs(10 - 2 * entityIn.getKickTicks()) / 10.0F;
         this.rightLeg.xRot = Mth.lerp(f1, this.rightLeg.xRot, -1.4F);
      }
      ...
      if (this.attackTime == 0.0F
         ...
         && !isHoldingShootable
         && entityIn.getDeltaMovement().horizontalDistanceSqr() > speed
         && !entityIn.getMainHandItem().isEmpty()
         && !entityIn.isBlocking()) {
