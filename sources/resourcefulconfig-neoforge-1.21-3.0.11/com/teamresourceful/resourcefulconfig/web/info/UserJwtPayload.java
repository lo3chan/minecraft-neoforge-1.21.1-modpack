...
@Internal
public record UserJwtPayload(UUID uuid, String name, String password, long expiration) {
   public static final Codec<UserJwtPayload> CODEC = RecordCodecBuilder.create(
