...
public class Option<T extends Annotation, D> {
   ...
   public static final Option<ConfigOption.Color, ConfigOption.Color> COLOR = of(ConfigOption.Color.class, type -> type == int.class || type == Integer.class);
   public static final Option<ConfigOption.Slider, ConfigOption.Slider> SLIDER = of(ConfigOption.Slider.class);
   public static final Option<ConfigOption.Multiline, ConfigOption.Multiline> MULTILINE = of(ConfigOption.Multiline.class, type -> type == String.class);
   public static final Option<ConfigOption.Hidden, ConfigOption.Hidden> HIDDEN = of(ConfigOption.Hidden.class);
   public static final Option<ConfigOption.Draggable, Enum<?>[]> DRAGGABLE = of(
      ConfigOption.Draggable.class, type -> type.isArray() && type.getComponentType().isEnum(), (type, data) -> {
   ...
   public static final Option<ConfigOption.Select, Component> SELECT = of(
      ConfigOption.Select.class, type -> type.isArray() && type.getComponentType().isEnum(), (type, data) -> Component.translatable(data.value())
   );
   public static final Option<ConfigOption.Separator, ConfigOption.Separator> SEPARATOR = of(ConfigOption.Separator.class);
   public static final Option<ConfigOption.Regex, Pattern> REGEX = of(
      ConfigOption.Regex.class, type -> type == String.class, (type, data) -> Pattern.compile(data.value())
   );
   public static final Option<ConfigOption.Keybind, ConfigOption.Keybind> KEYBIND = of(
      ConfigOption.Keybind.class, type -> type == int.class || type == Integer.class
   );
   public static final Option<ConfigOption.SearchTerm, List<String>> SEARCH_TERM = of(
      ConfigOption.SearchTerm.class, type -> true, (type, data) -> List.of(data.value())
   );
   ...
   public static Map<Option<?, ?>, Object> gatherOptions(AnnotationGetter getter, Class<?> type) {
      ...
      for (Option<?, ?> value : VALUES) {
         Annotation annotation = getter.get((Class<Annotation>)value.annotation);
