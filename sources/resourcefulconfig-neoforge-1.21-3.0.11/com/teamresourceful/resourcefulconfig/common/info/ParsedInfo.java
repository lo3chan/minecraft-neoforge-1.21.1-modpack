...
public record ParsedInfo(
   TranslatableValue title, TranslatableValue description, String icon, ResourcefulConfigColor color, ResourcefulConfigLink[] links, boolean isHidden
