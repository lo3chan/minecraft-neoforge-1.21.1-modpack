...
public record ParsedObjectEntry(EntryType type, Field field, EntryData options, LinkedHashMap<String, ResourcefulConfigEntry> entries)
   ...
   @Override
   public void reset() {
      this.entries.values().forEach(ResourcefulConfigEntry::reset);
   }
