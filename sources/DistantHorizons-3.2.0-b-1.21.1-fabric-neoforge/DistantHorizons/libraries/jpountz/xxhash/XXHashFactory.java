...
import DistantHorizons.libraries.jpountz.util.Utils;
...
public final class XXHashFactory {
   ...
   private XXHashFactory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
      this.impl = impl;
      this.hash32 = classInstance("DistantHorizons.libraries.jpountz.xxhash.XXHash32" + impl);
      this.streamingHash32Factory = classInstance("DistantHorizons.libraries.jpountz.xxhash.StreamingXXHash32" + impl + "$Factory");
      this.hash64 = classInstance("DistantHorizons.libraries.jpountz.xxhash.XXHash64" + impl);
      this.streamingHash64Factory = classInstance("DistantHorizons.libraries.jpountz.xxhash.StreamingXXHash64" + impl + "$Factory");
