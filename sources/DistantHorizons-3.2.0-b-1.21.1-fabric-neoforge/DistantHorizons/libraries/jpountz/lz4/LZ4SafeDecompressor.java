...
public abstract class LZ4SafeDecompressor implements LZ4UnknownSizeDecompressor {
   @Override
   public abstract int decompress(byte[] bs, int i, int j, byte[] cs, int k, int l);

   public abstract int decompress(ByteBuffer byteBuffer, int i, int j, ByteBuffer byteBuffer2, int k, int l);
