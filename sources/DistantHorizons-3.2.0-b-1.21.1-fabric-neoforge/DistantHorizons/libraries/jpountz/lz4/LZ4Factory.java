...
public final class LZ4Factory {
   ...
   private LZ4Factory(String impl) throws ClassNotFoundException, NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException, NoSuchMethodException, InstantiationException, InvocationTargetException {
      this.impl = impl;
      this.fastCompressor = classInstance("DistantHorizons.libraries.jpountz.lz4.LZ4" + impl + "Compressor");
      this.highCompressor = classInstance("DistantHorizons.libraries.jpountz.lz4.LZ4HC" + impl + "Compressor");
      this.fastDecompressor = classInstance("DistantHorizons.libraries.jpountz.lz4.LZ4" + impl + "FastDecompressor");
      this.safeDecompressor = classInstance("DistantHorizons.libraries.jpountz.lz4.LZ4" + impl + "SafeDecompressor");
