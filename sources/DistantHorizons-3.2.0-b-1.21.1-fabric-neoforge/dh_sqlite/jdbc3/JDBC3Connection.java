...
import dh_sqlite.SQLiteOpenMode;
...
public abstract class JDBC3Connection extends SQLiteConnection {
   ...
   @Override
   public abstract Statement createStatement(int i, int j, int k) throws SQLException;
   ...
   @Override
   public abstract PreparedStatement prepareStatement(String string, int i, int j, int k) throws SQLException;
