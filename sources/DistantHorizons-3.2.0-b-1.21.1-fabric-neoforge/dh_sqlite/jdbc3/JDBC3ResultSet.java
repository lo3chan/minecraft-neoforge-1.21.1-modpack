...
import dh_sqlite.core.CoreResultSet;
...
public abstract class JDBC3ResultSet extends CoreResultSet {
   ...
   public boolean next() throws SQLException {
      if (this.open && !this.emptyResultSet && !this.pastLastRow) {
         ...
         if (this.row == 0) {
            this.row++;
            return true;
         } else if (this.maxRows != 0L && this.row == this.maxRows) {
            return false;
         } else {
         ...
         case 3:
            ...
            if ("".equals(dateText)) {
               ...
               try {
                  ...
                  throw new SQLException("Error parsing date", var4);
               }
            }
         case 4:
         default:
         ...
         case 3:
            ...
            if ("".equals(dateText)) {
               ...
               try {
                  ...
                  throw new SQLException("Error parsing time stamp", var5);
               }
            }
         case 4:
         default:
   ...
   public double getDouble(int col) throws SQLException {
      return this.safeGetColumnType(this.markCol(col)) == 5 ? 0.0 : this.safeGetDoubleCol(col);
   }
   ...
   public float getFloat(int col) throws SQLException {
      return this.safeGetColumnType(this.markCol(col)) == 5 ? 0.0F : (float)this.safeGetDoubleCol(col);
   }
         ...
         case 3:
            ...
            if ("".equals(dateText)) {
               ...
               try {
                  ...
                  throw new SQLException("Error parsing time", var4);
               }
            }
         case 4:
         default:
         ...
         case 3:
            ...
            if ("".equals(dateText)) {
               ...
               try {
                  ...
                  throw new SQLException("Error parsing time", var5);
               }
            }
         case 4:
         default:
         ...
         case 3:
            ...
            if ("".equals(dateText)) {
               ...
               try {
                  ...
                  throw new SQLException("Error parsing time stamp", var4);
               }
            }
         case 4:
         default:
   ...
   private Calendar julianDateToCalendar(Double jd, Calendar cal) {
      if (jd == null) {
         ...
         int mm = E - (E < 13.5 ? 1 : 13);
         int yyyy = C - (mm > 2.5 ? 4716 : 4715);
         double jjd = B - D - (int)(30.6001 * E) + F;
         int dd = (int)jjd;
         double hhd = jjd - dd;
         int hh = (int)(24.0 * hhd);
         double mnd = 24.0 * hhd - hh;
         int mn = (int)(60.0 * mnd);
         double ssd = 60.0 * mnd - mn;
         int ss = (int)(60.0 * ssd);
         double msd = 60.0 * ssd - ss;
