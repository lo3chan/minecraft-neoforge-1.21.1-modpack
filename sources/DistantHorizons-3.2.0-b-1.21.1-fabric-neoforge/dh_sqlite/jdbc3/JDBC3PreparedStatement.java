...
import dh_sqlite.core.CorePreparedStatement;
...
public abstract class JDBC3PreparedStatement extends CorePreparedStatement {
   ...
   public void addBatch() throws SQLException {
      this.checkOpen();
      this.batchPos = this.batchPos + this.paramCount;
   ...
   public int getParameterType(int pos) throws SQLException {
      ...
      if (paramValue == null) {
         return 0;
      } else if (paramValue instanceof Integer || paramValue instanceof Short || paramValue instanceof Boolean) {
         return 4;
      } else if (paramValue instanceof Long) {
         return -5;
      } else {
         return !(paramValue instanceof Double) && !(paramValue instanceof Float) ? 12 : 7;
      }
   }
   ...
   public void setCharacterStream(int pos, Reader reader, int length) throws SQLException {
      try {
         ...
         throw new SQLException("Cannot read from character stream, exception message: " + var7.getMessage());
      }
   }
