...
import dh_sqlite.jdbc3.JDBC3ResultSet;
...
public class JDBC4ResultSet extends JDBC3ResultSet implements ResultSet, ResultSetMetaData {
   ...
   public <T> T getObject(int columnIndex, Class<T> type) throws SQLException {
      if (type == null) {
         ...
         try {
            ...
            return date != null ? type.cast(date.toLocalDate()) : null;
         ...
         try {
            ...
            return time != null ? type.cast(time.toLocalTime()) : null;
         ...
         try {
            ...
            return timestamp != null ? type.cast(timestamp.toLocalDateTime()) : null;
   ...
   public Clob getClob(int col) throws SQLException {
      ...
      return clob == null ? null : new JDBC4ResultSet.SqliteClob(clob);
   }
