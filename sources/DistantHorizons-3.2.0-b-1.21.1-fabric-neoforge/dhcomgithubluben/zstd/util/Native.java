package dhcomgithubluben.zstd.util;
...
public enum Native {
   ...
   private static final String libnameShort = "zstd-jni_dh-1.5.7-6";
   private static final String libname = "libzstd-jni_dh-1.5.7-6";
   ...
   private static String resourceName() {
      ...
      return "/" + var0 + "/" + var1 + "/" + "libzstd-jni_dh-1.5.7-6" + "." + libExtension();
   }
      ...
      if (!loaded.get()) {
         ...
         if (var2 != null) {
            ...
            try {
               ...
               loadLibrary("libzstd-jni_dh-1.5.7-6");
               loaded.set(true);
            } catch (Throwable var28) {
               InputStream var3 = Native.class.getResourceAsStream(var1);
               if (var3 == null) {
                  try {
                     loadLibrary("zstd-jni_dh-1.5.7-6");
                     loaded.set(true);
                  ...
                  try {
                     var4 = File.createTempFile("libzstd-jni_dh-1.5.7-6", "." + libExtension(), file);
                     var4.deleteOnExit();
