...
import com.seibel.distanthorizons.common.wrappers.gui.updater.UpdateModScreen_neoforge;
...
public class DhUpdateScreenBase_neoforge {
         ...
         runnable = () -> {
            ...
            if (versionId == null) {
               ...
               RenderThreadTaskHandler.INSTANCE.queueRunningOnRenderThread("Update Screen", () -> {
                  try {
                     DhScreenUtil_neoforge.setScreen(new UpdateModScreen_neoforge(new TitleScreen(false), versionId));
