...
import com.seibel.distanthorizons.common.render.openGl.GlDhRenderApiDefinition_fabric;
import com.seibel.distanthorizons.common.wrappers.block.BlockStateTextureProvider_fabric;
import com.seibel.distanthorizons.common.wrappers.gui.LangWrapper_fabric;
...
import com.seibel.distanthorizons.common.wrappers.minecraft.MinecraftServerWrapper_fabric;
...
public class DependencySetup_fabric {
   protected static final DhLogger LOGGER = new DhLoggerBuilder().build();
   private static boolean renderingApiBindingsSet = false;

   public static void createSharedBindings() {
      SingletonInjector.INSTANCE.bind(ILangWrapper.class, LangWrapper_fabric.INSTANCE);
      SingletonInjector.INSTANCE.bind(IVersionConstants.class, VersionConstants.INSTANCE);
      SingletonInjector.INSTANCE.bind(IWrapperFactory.class, WrapperFactory_fabric.INSTANCE);
      SingletonInjector.INSTANCE.bind(IKeyedClientLevelManager.class, new KeyedClientLevelManager_fabric());
   ...
   public static void createServerBindings() {
      SingletonInjector.INSTANCE.bind(IMinecraftSharedWrapper.class, MinecraftServerWrapper_fabric.INSTANCE);
   }

   public static void createClientBindings() {
      SingletonInjector.INSTANCE.bind(IMinecraftClientWrapper.class, MinecraftClientWrapper_fabric.INSTANCE);
      SingletonInjector.INSTANCE.bind(IMinecraftSharedWrapper.class, MinecraftClientWrapper_fabric.INSTANCE);
      SingletonInjector.INSTANCE.bind(IMinecraftRenderWrapper.class, MinecraftRenderWrapper_fabric.INSTANCE);
      SingletonInjector.INSTANCE.bind(IConfigGui.class, ClassicConfigGUI_fabric.CONFIG_CORE_INTERFACE);
      SingletonInjector.INSTANCE.bind(IBlockStateFaceTextureProvider.class, BlockStateTextureProvider_fabric.INSTANCE);
   }
   ...
   public static synchronized void setRenderingApiBindings() {
      if (renderingApiBindingsSet) {
         ...
         if (renderingApiEnum == EDhApiRenderingEngine.OPEN_GL) {
            validApi = true;
            renderDefinition = new GlDhRenderApiDefinition_fabric();
         } else {
         ...
         if (!validApi) {
            ...
            EDhApiRenderingApi mcRenderApi = MinecraftRenderWrapper_fabric.INSTANCE.getMcRenderingApi();
