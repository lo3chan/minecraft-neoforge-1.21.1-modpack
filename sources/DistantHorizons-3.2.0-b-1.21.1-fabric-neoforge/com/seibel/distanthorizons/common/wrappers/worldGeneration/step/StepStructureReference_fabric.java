...
public final class StepStructureReference_fabric extends AbstractWorldGenStep_fabric {
   private static final class_2806 STATUS = class_2806.field_16422;
   private final BatchGenerationEnvironment_fabric environment;

   public StepStructureReference_fabric(BatchGenerationEnvironment_fabric batchGenerationEnvironment) {
   ...
   public void generateGroup(ThreadWorldGenParams_fabric tParams, DhLitWorldGenRegion_fabric worldGenRegion, ArrayGridList<ChunkWrapper_fabric> chunkWrappers) {
      for (ChunkWrapper_fabric chunkWrapper : this.getChunkWrappersToGenerate(chunkWrappers)) {
         ...
         this.environment.globalParams.generator.method_16130(worldGenRegion, tParams.structFeatManager.forWorldGenRegion(worldGenRegion), chunk);
      }
   }
}
