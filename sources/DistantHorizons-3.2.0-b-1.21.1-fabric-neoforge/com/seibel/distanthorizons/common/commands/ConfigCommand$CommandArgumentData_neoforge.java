...
class ConfigCommand$CommandArgumentData_neoforge<T> {
   ...
   public ConfigCommand$CommandArgumentData_neoforge(
      Class<T> argumentClass, Supplier<ArgumentType<T>> argumentTypeSupplier, BiFunction<CommandContext<CommandSourceStack>, String, T> valueGetter
   ) {
   ...
   public ConfigCommand$CommandArgumentData_neoforge(
      ...
      Function<ConfigEntry<T>, ArgumentType<T>> argumentTypeFunction,
