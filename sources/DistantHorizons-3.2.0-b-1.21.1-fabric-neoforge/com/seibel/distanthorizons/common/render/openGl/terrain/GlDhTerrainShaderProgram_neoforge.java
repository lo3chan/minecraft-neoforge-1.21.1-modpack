...
public class GlDhTerrainShaderProgram_neoforge extends GlShaderProgram implements IDhApiShaderProgram {
   ...
   public GlDhTerrainShaderProgram_neoforge() {
      super(
      ...
      if (bufferContainers != null) {
         for (int lodIndex = 0; lodIndex < bufferContainers.size(); lodIndex++) {
            ...
            if (bufferContainer.buffersUploaded) {
               ...
               GlDhMetaRenderer_neoforge.INSTANCE.shaderProgramForThisFrame.bind();
               GlDhMetaRenderer_neoforge.INSTANCE.shaderProgramForThisFrame.setModelOffsetPos(MODEL_POS);
                  ...
                  if (vbo != null) {
                     ...
                     try {
                        if (vbo.getVertexCount() != 0 && vbo.getId() != 0 && vbo.getQuadIBO().getId() != 0) {
                           ...
                           vbo.bind();
                           vbo.getQuadIBO().bind();
                           GlDhMetaRenderer_neoforge.INSTANCE.shaderProgramForThisFrame.bindVertexBuffer(vbo.getId());
