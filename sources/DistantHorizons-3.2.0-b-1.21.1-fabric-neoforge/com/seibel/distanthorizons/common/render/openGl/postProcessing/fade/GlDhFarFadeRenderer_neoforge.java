...
public class GlDhFarFadeRenderer_neoforge implements IDhFarFadeRenderer {
   public static GlDhFarFadeRenderer_neoforge INSTANCE = new GlDhFarFadeRenderer_neoforge();
   ...
   private GlDhFarFadeRenderer_neoforge() {
   }

   public void init() {
      if (!this.init) {
         this.init = true;
         GlDhFarFadeShader_neoforge.INSTANCE.init();
   ...
   public void render(RenderParams renderParams) {
      try {
         ...
         GlDhFarFadeShader_neoforge.INSTANCE.frameBuffer = this.fadeFramebuffer;
         GlDhFarFadeShader_neoforge.INSTANCE.setProjectionMatrix(renderParams);
         GlDhFarFadeShader_neoforge.INSTANCE.render(renderParams);
         GlDhFarFadeApplyShader.INSTANCE.fadeTexture = this.fadeTexture;
         GlDhFarFadeApplyShader.INSTANCE.readFramebuffer = GlDhFarFadeShader_neoforge.INSTANCE.frameBuffer;
         GlDhFarFadeApplyShader.INSTANCE.drawFramebuffer = GlDhMetaRenderer_neoforge.INSTANCE.getActiveFramebufferId();
