...
import com.seibel.distanthorizons.common.render.openGl.postProcessing.fade.GlDhFarFadeRenderer_fabric;
import com.seibel.distanthorizons.common.render.openGl.postProcessing.fade.GlVanillaFadeRenderer_fabric;
import com.seibel.distanthorizons.common.render.openGl.postProcessing.fog.GlDhFogRenderer_fabric;
import com.seibel.distanthorizons.common.render.openGl.postProcessing.ssao.GlDhSSAORenderer_fabric;
import com.seibel.distanthorizons.common.render.openGl.test.GlTestTriangleRenderer_fabric;
...
public class GlDhRenderApiDefinition_fabric extends AbstractDhRenderApiDefinition {
   @Override
   ...
   public IDhMetaRenderer getMetaRenderer() {
      return GlDhMetaRenderer_fabric.INSTANCE;
   }

   @Override
   public IDhTerrainRenderer getTerrainRenderer() {
      return GlDhTerrainRenderer_fabric.INSTANCE;
   }

   @Override
   public IDhSsaoRenderer getSsaoRenderer() {
      return GlDhSSAORenderer_fabric.INSTANCE;
   }

   @Override
   public IDhFogRenderer getFogRenderer() {
      return GlDhFogRenderer_fabric.INSTANCE;
   }

   @Override
   public IDhFarFadeRenderer getFarFadeRenderer() {
      return GlDhFarFadeRenderer_fabric.INSTANCE;
   }
   ...
   public IDhVanillaFadeRenderer getVanillaFadeRenderer() {
      return GlVanillaFadeRenderer_fabric.INSTANCE;
   }

   @Override
   public IDhTestTriangleRenderer getTestTriangleRenderer() {
      return GlTestTriangleRenderer_fabric.INSTANCE;
   }
