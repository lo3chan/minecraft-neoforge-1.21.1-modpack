...
public class GlDhSSAOApplyShader_neoforge extends GlAbstractShaderRenderer {
   public static GlDhSSAOApplyShader_neoforge INSTANCE = new GlDhSSAOApplyShader_neoforge();
   ...
   protected void onRender() {
      ...
      GLMC.glBindFramebuffer(36008, GlDhSSAOShader_neoforge.INSTANCE.frameBuffer);
