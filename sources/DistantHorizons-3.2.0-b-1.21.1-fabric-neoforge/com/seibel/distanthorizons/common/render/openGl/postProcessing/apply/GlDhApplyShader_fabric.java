...
public class GlDhApplyShader_fabric extends GlAbstractShaderRenderer {
   public static GlDhApplyShader_fabric INSTANCE = new GlDhApplyShader_fabric();
   private static final DhLogger LOGGER = new DhLoggerBuilder().build();
   private static final MinecraftGLWrapper GLMC = MinecraftGLWrapper.INSTANCE;
   public int gDhColorTextureUniform;
   public int gDepthMapUniform;

   private GlDhApplyShader_fabric() {
   }
   ...
   private void renderToFrameBuffer() {
      ...
      if (targetFrameBuffer != -1) {
         try (GLState state = new GLState()) {
            ...
            GLMC.glBindTexture(GlDhMetaRenderer_fabric.INSTANCE.getActiveColorTextureId());
   ...
   private void renderToMcTexture() {
      ...
      if (targetColorTextureId != -1) {
         int dhFrameBufferId = GlDhMetaRenderer_fabric.INSTANCE.getActiveFramebufferId();
