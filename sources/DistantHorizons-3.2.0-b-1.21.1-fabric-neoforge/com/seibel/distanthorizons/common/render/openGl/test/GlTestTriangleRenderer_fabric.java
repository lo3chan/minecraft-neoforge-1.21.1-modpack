...
public class GlTestTriangleRenderer_fabric implements IDhTestTriangleRenderer {
   public static final DhLogger LOGGER = new DhLoggerBuilder().build();
   private static final IMinecraftRenderWrapper MC_RENDER = SingletonInjector.INSTANCE.get(IMinecraftRenderWrapper.class);
   private static final MinecraftGLWrapper GLMC = MinecraftGLWrapper.INSTANCE;
   public static final GlTestTriangleRenderer_fabric INSTANCE = new GlTestTriangleRenderer_fabric();
   ...
   private GlTestTriangleRenderer_fabric() {
   }
