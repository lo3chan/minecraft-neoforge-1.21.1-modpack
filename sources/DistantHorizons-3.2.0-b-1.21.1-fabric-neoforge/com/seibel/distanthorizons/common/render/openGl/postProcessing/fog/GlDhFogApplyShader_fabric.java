...
public class GlDhFogApplyShader_fabric extends GlAbstractShaderRenderer {
   public static GlDhFogApplyShader_fabric INSTANCE = new GlDhFogApplyShader_fabric();
   ...
   protected void onRender() {
      ...
      GLMC.glBindFramebuffer(36008, GlDhFogShader_fabric.INSTANCE.frameBuffer);
