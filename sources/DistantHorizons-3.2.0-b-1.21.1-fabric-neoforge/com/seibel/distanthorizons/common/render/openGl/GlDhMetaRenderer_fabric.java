...
import com.seibel.distanthorizons.common.render.openGl.postProcessing.apply.GlDhApplyShader_fabric;
...
public class GlDhMetaRenderer_fabric implements IDhMetaRenderer {
   ...
   public static final DhLogger RATE_LIMITED_LOGGER = new DhLoggerBuilder()
      ...
      .maxCountPerSecond(4)
      .build();
   public static final GlDhMetaRenderer_fabric INSTANCE = new GlDhMetaRenderer_fabric();
   ...
   public void runRenderPassSetup(RenderParams renderParams) {
      ...
      this.shaderProgramForThisFrame = GlDhTerrainRenderer_fabric.INSTANCE.getTerrainShaderProgram();
   ...
   public void applyToMcTexture(RenderParams renderParams) {
      GlDhApplyShader_fabric.INSTANCE.render(renderParams);
   }
   ...
   public void bindLightmap(ILightMapWrapper lightMapWrapper) {
      LightMapWrapper_fabric lightMap = (LightMapWrapper_fabric)lightMapWrapper;
