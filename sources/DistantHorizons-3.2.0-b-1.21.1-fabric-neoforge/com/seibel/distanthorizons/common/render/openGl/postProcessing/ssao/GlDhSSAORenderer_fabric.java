...
public class GlDhSSAORenderer_fabric implements IDhSsaoRenderer {
   public static GlDhSSAORenderer_fabric INSTANCE = new GlDhSSAORenderer_fabric();
   ...
   private GlDhSSAORenderer_fabric() {
   }

   public void init() {
      if (!this.init) {
         this.init = true;
         GlDhSSAOShader_fabric.INSTANCE.init();
         GlDhSSAOApplyShader_fabric.INSTANCE.init();
      }
   }
   ...
   public void render(RenderParams renderParams) {
      try (GLState state = new GLState()) {
         ...
         GlDhSSAOShader_fabric.INSTANCE.frameBuffer = this.ssaoFramebuffer;
         GlDhSSAOShader_fabric.INSTANCE.setProjectionMatrix(renderParams.dhProjectionMatrix);
         GlDhSSAOShader_fabric.INSTANCE.render(renderParams);
         GlDhSSAOApplyShader_fabric.INSTANCE.ssaoTexture = this.ssaoTexture;
         GlDhSSAOApplyShader_fabric.INSTANCE.render(renderParams);
      }
   }
