...
public class GlVanillaFadeRenderer_neoforge implements IDhVanillaFadeRenderer {
   public static GlVanillaFadeRenderer_neoforge INSTANCE = new GlVanillaFadeRenderer_neoforge();
   ...
   private GlVanillaFadeRenderer_neoforge() {
   }

   public void init() {
      if (!this.init) {
         this.init = true;
         GlDhVanillaFadeShader_neoforge.INSTANCE.init();
   ...
   public void render(RenderParams renderParams) {
      ...
      if (depthTextureId != -1) {
         ...
         try (
            ...
            GlDhVanillaFadeShader_neoforge.INSTANCE.frameBuffer = this.fadeFramebuffer;
            GlDhVanillaFadeShader_neoforge.INSTANCE.setProjectionMatrix(renderParams);
            GlDhVanillaFadeShader_neoforge.INSTANCE.setLevelMaxHeight(renderParams.clientLevelWrapper.getMaxHeight());
            GlDhVanillaFadeShader_neoforge.INSTANCE.render(renderParams);
            if (MC_RENDER.mcRendersToFrameBuffer()) {
               GlDhFarFadeApplyShader.INSTANCE.fadeTexture = this.fadeTexture;
               GlDhFarFadeApplyShader.INSTANCE.readFramebuffer = GlDhVanillaFadeShader_neoforge.INSTANCE.frameBuffer;
   ...
   public void free() {
      GlDhVanillaFadeShader_neoforge.INSTANCE.free();
