...
public class DHGenericTransformer {
    public static void transform(ASTParser t, TranslationUnit tree, Root root, Parameters parameters) {
        ...
        if (parameters.type.glShaderType == ShaderType.VERTEX) {
            ...
            tree.parseAndInjectNodes(t, ASTInjectionPoint.BEFORE_DECLARATIONS, new String[]{"uniform mat4 iris_ProjectionMatrix;", "uniform mat4 iris_ModelViewMatrix;", "vec4 getVertexPosition() { return vec4(_vert_position, 1.0); }"});
