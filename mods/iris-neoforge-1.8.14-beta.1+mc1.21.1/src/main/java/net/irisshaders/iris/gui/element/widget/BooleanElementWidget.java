...
extends BaseOptionElementWidget<OptionMenuBooleanOptionElement> {
    private static final Component TEXT_TRUE = Component.translatable((String)"label.iris.true").withStyle(ChatFormatting.GREEN);
    private static final Component TEXT_FALSE = Component.translatable((String)"label.iris.false").withStyle(ChatFormatting.RED);
    private static final Component TEXT_TRUE_DEFAULT = Component.translatable((String)"label.iris.true");
    private static final Component TEXT_FALSE_DEFAULT = Component.translatable((String)"label.iris.false");
