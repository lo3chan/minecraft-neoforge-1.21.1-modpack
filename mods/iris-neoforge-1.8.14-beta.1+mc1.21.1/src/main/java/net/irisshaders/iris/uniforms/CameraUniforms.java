...
public class CameraUniforms {
    ...
    private static int getRenderDistanceInBlocks() {
        return CameraUniforms.client.options.getEffectiveRenderDistance() * 16;
    }

    public static Vector3d getUnshiftedCameraPosition() {
        return JomlConversions.fromVec3(CameraUniforms.client.gameRenderer.getMainCamera().getPosition());
    }
