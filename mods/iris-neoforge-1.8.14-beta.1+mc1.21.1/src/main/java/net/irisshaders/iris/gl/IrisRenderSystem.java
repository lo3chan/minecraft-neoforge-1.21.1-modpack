...
public class IrisRenderSystem {
    ...
    public static void setShadowProjection(Matrix4f shadowProjection) {
        ...
        RenderSystem.setProjectionMatrix((Matrix4f)shadowProjection, (VertexSorting)VertexSorting.ORTHOGRAPHIC_Z);
    }

    public static void restorePlayerProjection() {
        RenderSystem.setProjectionMatrix((Matrix4f)backupProjection, (VertexSorting)VertexSorting.DISTANCE_TO_ORIGIN);
