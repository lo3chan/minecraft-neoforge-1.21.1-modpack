...
implements PBRDumpable {
    ...
    public PBRAtlasTexture(TextureAtlas atlasTexture, PBRType type) {
        ...
        this.type = type;
        this.id = ResourceLocation.fromNamespaceAndPath((String)atlasTexture.location().getNamespace(), (String)(atlasTexture.location().getPath().replace(".png", "") + type.getSuffix() + ".png"));
    }
    ...
    public void upload(int atlasWidth, int atlasHeight, int mipLevel) {
        ...
        for (AtlasPBRLoader.PBRTextureAtlasSprite sprite : this.texturesByName.values()) {
            try {
                ...
                CrashReport crashReport = CrashReport.forThrowable((Throwable)throwable, (String)"Stitching texture atlas");
                CrashReportCategory crashReportCategory = crashReport.addCategory("Texture being stitched together");
                crashReportCategory.setDetail("Atlas path", (Object)this.id);
                crashReportCategory.setDetail("Sprite", (Object)sprite);
    ...
    protected void uploadSprite(AtlasPBRLoader.PBRTextureAtlasSprite sprite) {
        ...
        if (spriteTicker != null) {
            ...
            SpriteContents.Ticker sourceTicker = ((SpriteContentsExtension)sprite.getBaseSprite().contents()).getCreatedTicker();
            SpriteContents.Ticker targetTicker = ((SpriteContentsExtension)sprite.contents()).getCreatedTicker();
    ...
    public void dumpContents(ResourceLocation id, Path path) {
        ...
        TextureUtil.writeAsPNG((Path)path, (String)fileName, (int)this.getId(), (int)this.mipLevel, (int)this.width, (int)this.height);
