    ...
    public static String getInvalidStatus(List<FeatureFlags> invalidFeatureFlags) {
        ...
        if (unsupportedIris) {
            if (unsupportedHardware) {
                return I18n.get((String)"iris.unsupported.irisorpc", (Object[])new Object[0]);
            }
            return I18n.get((String)"iris.unsupported.iris", (Object[])new Object[0]);
        }
        if (unsupportedHardware) {
            return I18n.get((String)"iris.unsupported.pc", (Object[])new Object[0]);
        }
        return null;
    }
