...
public class ShadowRenderingState {
    ...
    public static interface BlockEntityRenderFunction {
        public int renderBlockEntities(ShadowRenderer var1, RenderBuffers var2, PoseStack var3, Camera var4, double var5, double var7, double var9, float var11, boolean var12, boolean var13);
    }
}
