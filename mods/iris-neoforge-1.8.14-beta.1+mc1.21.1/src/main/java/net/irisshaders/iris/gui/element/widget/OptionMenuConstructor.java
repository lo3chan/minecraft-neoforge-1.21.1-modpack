...
public final class OptionMenuConstructor {
    ...
    static {
        OptionMenuConstructor.registerScreen(OptionMenuMainElementScreen.class, screen -> new ElementWidgetScreenData((Component)Component.literal((String)Iris.getCurrentPackName()).append(Iris.isFallback() ? " (fallback)" : "").withStyle(ChatFormatting.BOLD), false));
        OptionMenuConstructor.registerScreen(OptionMenuSubElementScreen.class, screen -> new ElementWidgetScreenData((Component)GuiUtil.translateOrDefault(Component.literal((String)screen.screenId), "screen." + screen.screenId, new Object[0]), true));
