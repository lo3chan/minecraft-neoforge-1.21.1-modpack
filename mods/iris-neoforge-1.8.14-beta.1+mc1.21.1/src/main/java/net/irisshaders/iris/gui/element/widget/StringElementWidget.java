...
extends BaseOptionElementWidget<OptionMenuStringOptionElement> {
    ...
    public void init(ShaderPackScreen screen, NavigationController navigation) {
        ...
        this.prefix = Component.literal((String)(Language.getInstance().has("prefix." + this.option.getName()) ? Language.getInstance().getOrDefault("prefix." + this.option.getName()) : ""));
        this.suffix = Component.literal((String)(Language.getInstance().has("suffix." + this.option.getName()) ? Language.getInstance().getOrDefault("suffix." + this.option.getName()) : ""));
        this.setLabel(GuiUtil.translateOrDefault(Component.literal((String)this.option.getName()), "option." + this.option.getName(), new Object[0]));
    ...
    protected Component createValueLabel() {
        return this.prefix.copy().append((Component)GuiUtil.translateOrDefault(Component.literal((String)this.getValue()).append((Component)this.suffix), "value." + this.option.getName() + "." + this.getValue(), new Object[0])).withStyle(style -> style.withColor(TextColor.fromRgb((int)0x6688FF)));
    }
