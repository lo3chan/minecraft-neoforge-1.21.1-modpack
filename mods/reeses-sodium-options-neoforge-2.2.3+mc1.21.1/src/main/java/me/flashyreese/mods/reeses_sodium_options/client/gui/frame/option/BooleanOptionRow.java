...
extends AbstractOptionRow {
    ...
    public List<ControlGuide> controlGuides() {
        return this.canShowControlGuide() ? List.of(ControlGuide.press((Component)Component.translatable((String)"rso.controller.guide.toggle"))) : List.of();
    }
    ...
    protected Component narrationValue() {
        return this.option.showControl() ? CommonComponents.optionStatus((boolean)((Boolean)this.option.getValidatedValue())) : null;
    }
    ...
    protected void updateControlNarration(NarrationElementOutput builder) {
        ...
        boolean checked = (Boolean)this.option.getValidatedValue();
        if (this.isFocused()) {
            builder.add(NarratedElementType.USAGE, (Component)Component.translatable((String)(checked ? "narration.checkbox.usage.focused.uncheck" : "narration.checkbox.usage.focused.check")));
        } else if (this.isHovered()) {
            builder.add(NarratedElementType.USAGE, (Component)Component.translatable((String)(checked ? "narration.checkbox.usage.hovered.uncheck" : "narration.checkbox.usage.hovered.check")));
        }
    }
