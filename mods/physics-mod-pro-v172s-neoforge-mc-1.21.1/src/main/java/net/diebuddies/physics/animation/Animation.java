...
public class Animation {
    ...
    @Adjustable(id="Despawn Speed", min=0.0, max=30.0, step=0.01, translationId="physicsmod.prop.animation.length")
    public float speed;
    ...
    public void addParticleSpawn(ParticleOptions particle, int amount, double spread, double spawnChance, double vx, double vy, double vz, double soundVolume, SoundEvent sound) {
