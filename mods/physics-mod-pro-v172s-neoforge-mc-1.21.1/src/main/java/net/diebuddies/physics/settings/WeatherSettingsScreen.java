...
extends LegacyOptionsSubScreen {
    ...
    private static final ProgressOption PHYSICS_WEATHER_PARTICLES_RAIN_AMOUNT = new ProgressOption("physicsmod.menu.weather.particlesamountrain", 1.0, 30.0, 0.01f, gameOptions -> ConfigClient.weatherRainParticleAmount, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.particlesamountrain", String.format("%.0f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.particlesamountrain.info"));
    private static final ProgressOption PHYSICS_WEATHER_PARTICLES_THUNDER_AMOUNT = new ProgressOption("physicsmod.menu.weather.particlesamountthunder", 1.0, 30.0, 0.01f, gameOptions -> ConfigClient.weatherThunderParticleAmount, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.particlesamountthunder", String.format("%.0f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.particlesamountthunder.info"));
    private static final ProgressOption WEATHER_CLEAR_STRENGTH = new ProgressOption("physicsmod.menu.weather.clearstrength", 0.0, 4.0, 0.01f, gameOptions -> ConfigClient.weatherClearStrength, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.clearstrength", String.format("%.2f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.rainstrength.info"));
    private static final ProgressOption WEATHER_RAIN_STRENGTH = new ProgressOption("physicsmod.menu.weather.rainstrength", 0.0, 4.0, 0.01f, gameOptions -> ConfigClient.weatherRainStrength, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.rainstrength", String.format("%.2f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.rainstrength.info"));
    private static final ProgressOption WEATHER_THUNDER_STRENGTH = new ProgressOption("physicsmod.menu.weather.thunderstrength", 0.0, 4.0, 0.01f, gameOptions -> ConfigClient.weatherThunderStrength, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.thunderstrength", String.format("%.2f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.rainstrength.info"));
    private static final ProgressOption WEATHER_RAIN_OPACITY = new ProgressOption("physicsmod.menu.weather.rainopacity", 0.0, 1.0, 0.01f, gameOptions -> ConfigClient.particleRainOpacity, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.rainopacity", String.format("%.2f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.opacity.info"));
    private static final ProgressOption WEATHER_SNOW_OPACITY = new ProgressOption("physicsmod.menu.weather.snowopacity", 0.0, 1.0, 0.01f, gameOptions -> ConfigClient.particleSnowOpacity, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.snowopacity", String.format("%.2f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.opacity.info"));
    private static final ProgressOption WEATHER_DUST_OPACITY = new ProgressOption("physicsmod.menu.weather.dustopacity", 0.0, 1.0, 0.01f, gameOptions -> ConfigClient.particleDustOpacity, (gameOptions, value) -> {
        ...
        ConfigClient.save();
    }, (gameOptions, option) -> option.customFormat("physicsmod.menu.weather.dustopacity", String.format("%.2f", option.get((Options)gameOptions))), minecraft -> Component.translatable((String)"physicsmod.menu.weather.opacity.info"));
    private LegacyOptionsList list;

    public WeatherSettingsScreen(Screen parent, Options options) {
        super(parent, options, (Component)Component.translatable((String)"physicsmod.menu.weather.title"));
    }
    ...
    protected void init() {
        ...
        this.addRenderableWidget((GuiEventListener)ButtonSettings.builder(this.width / 2 - 80, this.height - 27, 75, 20, (Component)Component.translatable((String)"physicsmod.gui.reset"), button -> PopupWidget.create(Language.getInstance().getOrDefault("physicsmod.menu.weather.reset"), this, widget -> this.addRenderableWidget((GuiEventListener)widget), widget -> this.removeWidget((GuiEventListener)widget), response -> {
            if (response == PopupWidget.PopupResponse.YES) {
                ConfigClient.resetWeatherSettings();
                this.list.children().clear();
                this.minecraft.setScreen((Screen)new WeatherSettingsScreen(this.lastScreen, this.options));
            }
        })));
    }
