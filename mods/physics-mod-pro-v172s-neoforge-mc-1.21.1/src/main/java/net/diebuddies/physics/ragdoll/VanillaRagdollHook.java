...
public class VanillaRagdollHook
implements RagdollHook {
    @Override
    public void map(Ragdoll ragdoll, Entity entity, EntityModel model) {
        block163: {
            block165: {
                Iterator<ModelPart> body;
                RagdollMapper.Counter counter;
                block161: {
                    int count;
                    int hatOffset;
                    int leftLegOffset;
                    ...
                    block170: {
                        ...
                        block171: {
                            block169: {
                                block168: {
                                    block167: {
                                        block166: {
                                            block164: {
                                                block162: {
                                                    if (!(model instanceof PiglinModel)) break block162;
                                                    ...
                                                    RagdollMapper.Counter counter2 = new RagdollMapper.Counter();
                                                    while (head.hasNext()) {
                                                        RagdollMapper.getCuboids(ragdoll, head.next(), counter2, true);
                                                    }
                                                    int headOffset2 = 0;
                                                    int bodyOffset2 = counter2.count;
                                                    Iterator<ModelPart> body2 = ReflectionsForge.bodyParts(animal).iterator();
                                                    int rightArmOffset2 = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int leftArmOffset2 = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int rightLegOffset2 = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int leftLegOffset2 = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    ragdoll.addConnection(4, headOffset2);
                                                    ragdoll.addConnection(5, headOffset2);
                                                    ragdoll.addConnection(headOffset2, bodyOffset2);
                                                    ragdoll.addConnection((int)rightArmOffset2, (int)bodyOffset2).stopCollision = true;
                                                    ragdoll.addConnection((int)leftArmOffset2, (int)bodyOffset2).stopCollision = true;
                                                    ragdoll.addConnection(rightLegOffset2, bodyOffset2);
                                                    ragdoll.addConnection(leftLegOffset2, bodyOffset2);
                                                    int hatOffset2 = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int leftPantsOffset = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int rightPantsOffset = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int leftSleeveOffset = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int rightSleeveOffset = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    int jacketOffset = RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    if (piglin.hat.visible) {
                                                        ragdoll.addConnection(hatOffset2, headOffset2, true, true);
                                                    }
                                                    if (piglin.leftPants.visible) {
                                                        ragdoll.addConnection(leftPantsOffset, leftLegOffset2, true, true);
                                                    }
                                                    if (piglin.rightPants.visible) {
                                                        ragdoll.addConnection(rightPantsOffset, rightLegOffset2, true, true);
                                                    }
                                                    if (piglin.leftSleeve.visible) {
                                                        ragdoll.addConnection(leftSleeveOffset, leftArmOffset2, true, true);
                                                    }
                                                    if (piglin.rightSleeve.visible) {
                                                        ragdoll.addConnection(rightSleeveOffset, rightArmOffset2, true, true);
                                                    }
                                                    if (piglin.jacket.visible) {
                                                        ragdoll.addConnection(jacketOffset, bodyOffset2, true, true);
                                                    }
                                                    while (body2.hasNext()) {
                                                        RagdollMapper.getCuboids(ragdoll, body2.next(), counter2, true);
                                                    }
                                                    break block163;
                                                }
                                                if (!(model instanceof VexModel)) break block164;
                                                HierarchicalModel animal = (HierarchicalModel)model;
                                                int headOffset3 = 0;
                                                int bodyOffset3 = 1;
                                                int clothOffset = 2;
                                                int rightArmOffset3 = 3;
                                                int leftArmOffset3 = 4;
                                                int rightWingOffset = 5;
                                                int leftWingOffset = 6;
                                                ragdoll.addConnection((int)headOffset3, (int)bodyOffset3).stopCollision = true;
                                                ragdoll.addConnection(clothOffset, bodyOffset3, true);
                                                ragdoll.addConnection((int)rightArmOffset3, (int)bodyOffset3).stopCollision = true;
                                                ragdoll.addConnection((int)leftArmOffset3, (int)bodyOffset3).stopCollision = true;
                                                ragdoll.addConnection(rightWingOffset, bodyOffset3, true);
                                                ragdoll.addConnection(leftWingOffset, bodyOffset3, true);
                                                RagdollMapper.getCuboids(ragdoll, ((HierarchicalModel)model).root(), new RagdollMapper.Counter());
                                                break block163;
                                            }
                                            if (!(model instanceof HumanoidModel)) break block165;
                                            AgeableListModel animal = (AgeableListModel)model;
                                            Iterator<ModelPart> head = ReflectionsForge.headParts(animal).iterator();
                                            counter = new RagdollMapper.Counter();
                                            while (head.hasNext()) {
                                                RagdollMapper.getCuboids(ragdoll, head.next(), counter);
                                            }
                                            headOffset = 0;
                                            bodyOffset = counter.count;
                                            body = ReflectionsForge.bodyParts(animal).iterator();
                                            rightArmOffset = RagdollMapper.getCuboids(ragdoll, body.next(), counter);
                                            leftArmOffset = RagdollMapper.getCuboids(ragdoll, body.next(), counter);
                                            rightLegOffset = RagdollMapper.getCuboids(ragdoll, body.next(), counter);
                                            leftLegOffset = RagdollMapper.getCuboids(ragdoll, body.next(), counter);
                                            ...
                                            hatOffset = RagdollMapper.getCuboids(ragdoll, body.next(), counter);
                                            if (((HumanoidModel)model).hat.visible) {
                                                ragdoll.addConnection(hatOffset, headOffset, true, true);
                                            }
                                            if (!(model instanceof PlayerModel)) break block166;
                                            ...
                                            catch (Exception leftPantsOffset) {}
                                            break block161;
                                        }
                                        if (!(model instanceof ArmorStandModel)) break block167;
                                        try {
                                        ...
                                        catch (Exception rightBodyStickOffset) {}
                                        break block161;
                                    }
                                    if (!(model instanceof BoggedModel)) break block168;
                                    ...
                                    for (int i = 0; i < ragdoll.bodies.size(); ++i) {
                                        ...
                                        if (!(b.feature instanceof ItemInHandLayer)) continue;
                                        ragdoll.addConnection(i, rightArmOffset, true);
                                        hasBow = true;
                                    }
                                    int count3 = RagdollMapper.countModelParts(entity, model);
                                    if (sheared) {
                                        if (count3 + (hasBow ? 1 : 0) < ragdoll.bodies.size()) {
                                            ragdoll.addOverlayConnections(true, count3 * 2, hasBow ? 1 : 0);
                                        }
                                    } else {
                                ...
                                if (!(model instanceof SkeletonModel)) break block169;
                                boolean hasBow = false;
                                for (int i = 0; i < ragdoll.bodies.size(); ++i) {
                                    PhysicsEntity b = ragdoll.bodies.get(i);
                                    if (!(b.feature instanceof ItemInHandLayer)) continue;
                                ...
                                int count4 = RagdollMapper.countModelParts(entity, model);
                                if (count4 + (hasBow ? 1 : 0) < ragdoll.bodies.size()) {
                                    ragdoll.addOverlayConnections(true, count4 * 2, hasBow ? 1 : 0);
                                }
                                break block161;
                            }
                            if (!(model instanceof DrownedModel)) break block170;
                            count2 = RagdollMapper.countModelParts(entity, model);
                            if (ragdoll.bodies.size() <= count2 * 2) break block171;
                        ...
                        if (count2 >= ragdoll.bodies.size()) break block161;
                        ragdoll.addOverlayConnections(true);
                        break block161;
                    }
                    if (model instanceof EndermanModel) {
                        ragdoll.addOverlayConnections(true);
                    } else if (model instanceof ZombieVillagerModel && (count = RagdollMapper.countModelParts(entity, model)) < ragdoll.bodies.size()) {
                        int nbodyOffset = 0;
                        int nrightArmOffset = 2;
                        int nleftArmOffset = 3;
                        int nrightLegOffset = 4;
                        int nleftLegOffset = 5;
                        int overlays = (int)Math.ceil((double)ragdoll.bodies.size() / (double)count);
            ...
            if (model instanceof QuadrupedModel) {
                ...
                ragdoll.addConnection((int)rightFrontLegOffset, (int)body0Offset).stopCollision = true;
                ragdoll.addConnection((int)rightHindLegOffset, (int)body0Offset).stopCollision = true;
                ragdoll.addConnection((int)leftMiddleFrontLegOffset, (int)body0Offset).stopCollision = true;
                ragdoll.addConnection((int)leftHindLegOffset, (int)body0Offset).stopCollision = true;
                ragdoll.addConnection((int)rightMiddleHindLegOffset, (int)body0Offset).stopCollision = true;
                ragdoll.addConnection((int)rightMiddleFrontLegOffset, (int)body0Offset).stopCollision = true;
                ragdoll.addConnection((int)leftMiddleHindLegOffset, (int)body0Offset).stopCollision = true;
                ragdoll.addConnection((int)leftFrontLegOffset, (int)body0Offset).stopCollision = true;
                ...
                if (ragdoll.bodies.size() == 6) {
                    ragdoll.addConnection(pumpkinOffset, headOffset, true);
                }
                ...
                ragdoll.bodies.get((int)bodyOffset).backfaceCulling = false;
                ...
                boolean hasSaddle = ReflectionsForge.headParts((AgeableListModel)animal).iterator().next().getChild((String)"left_saddle_mouth").visible;
                int neckOffset = 0;
                int bodyOffset = counter.count;
                Iterator<ModelPart> body = ReflectionsForge.bodyParts(animal).iterator();
                int rightHindLegOffset = RagdollMapper.getCuboids(ragdoll, body.next(), counter);
                ...
                if (hasSaddle) {
                    ...
                    mane = 6;
                    tail = 12;
                    if (model instanceof ChestedHorseModel && (hasChests2 = ((AbstractChestedHorse)entity).hasChest())) {
                        saddleOffset = 12;
                        tail = 13;
                    }
                ...
                } else if (model instanceof ChestedHorseModel && (hasChests = ((AbstractChestedHorse)entity).hasChest())) {
                    tail = 8;
                }
                ...
                boolean saddle = body.getChild((String)SADDLE).visible;
                boolean reins = head.getChild((String)REINS).visible;
                int rightFrontLegOffset = 0;
                int rightHindLegOffset = 1;
                int leftHindLegOffset = 2;
                int bodyOffset = 3;
                ...
                FrogModel frog = (FrogModel)model;
                int leftLeg = 0;
                int leftFoot = 1;
                int rightLeg = 2;
                int rightFoot = 3;
            ...
            } else if (model instanceof AllayModel) {
                AllayModel allay = (AllayModel)model;
                int head = 0;
                int body = 1;
                int body2 = 2;
                int rightArm = 3;
                ...
                WardenModel warden = (WardenModel)model;
                boolean bone = false;
                int leftLeg = 0;
                int rightLeg = 1;
                int body = 2;
                ...
                for (int i = 0; i < 5; ++i) {
                    ...
                    if (i == 0) continue;
                    ragdoll.addConnection((i - 1) * 2, i * 2);
                }
                int offset = 10;
                int head0 = 0 + offset;
                int head1 = 1 + offset;
                ...
                for (int i = 0; i < 12; ++i) {
                    ...
                    if (i == 0) continue;
                    ragdoll.addConnection((i - 1) * 2 + offset, i * 2 + offset);
                }
    ...
    public void filterCuboidsFromEntities(List<PhysicsEntity> blockifiedEntity, Entity entity, EntityModel model) {
        ...
        } else if (model instanceof TropicalFishModelB || model instanceof TropicalFishModelA || model instanceof SkeletonModel || model instanceof HorseModel || model instanceof LlamaModel || model instanceof DrownedModel || model instanceof IllagerModel || model instanceof VillagerModel || model instanceof EndermanModel) {
            count = RagdollMapper.countModelParts(entity, model);
            if (!ragdollsEnabled) {
        ...
        while (it.hasNext()) {
            ...
            if (!(physicsEntity.feature instanceof HumanoidArmorLayer) && !(physicsEntity.feature instanceof CustomHeadLayer) && !(physicsEntity.feature instanceof ElytraLayer) && !(physicsEntity.feature instanceof ItemInHandLayer) && !(physicsEntity.feature instanceof ArrowLayer) && !(physicsEntity.feature instanceof Deadmau5EarsLayer) && !(physicsEntity.feature instanceof CapeLayer) && !(physicsEntity.feature instanceof SpinAttackEffectLayer) && !(physicsEntity.feature instanceof ParrotOnShoulderLayer) && !(physicsEntity.feature instanceof BeeStingerLayer) || model instanceof SkeletonModel && physicsEntity.feature instanceof ItemInHandLayer) continue;
            it.remove();
        }
    }
}
