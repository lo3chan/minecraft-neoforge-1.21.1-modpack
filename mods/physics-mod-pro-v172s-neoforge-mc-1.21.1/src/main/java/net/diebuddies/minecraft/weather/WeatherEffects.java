...
public class WeatherEffects {
    ...
    public static final ResourceLocation WIND_SOUND_ID = ResourceLocation.fromNamespaceAndPath((String)"physicsmod", (String)"wind");
    public static final SoundEvent WIND_SOUND_EVENT = SoundEvent.createVariableRangeEvent((ResourceLocation)WIND_SOUND_ID);
    public static final ResourceLocation SPLASH_SOUND_ID = ResourceLocation.fromNamespaceAndPath((String)"physicsmod", (String)"splash_sound");
    public static final SoundEvent SPLASH_SOUND_EVENT = SoundEvent.createVariableRangeEvent((ResourceLocation)SPLASH_SOUND_ID);
}
