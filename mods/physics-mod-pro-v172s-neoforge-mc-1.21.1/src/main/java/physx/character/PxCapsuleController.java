...
public class PxCapsuleController
extends PxController {
    public static final int SIZEOF = PxCapsuleController.__sizeOf();
    ...
    public static PxCapsuleController arrayGet(long baseAddress, int index) {
        ...
        return PxCapsuleController.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public float getRadius() {
        this.checkNotNull();
        return PxCapsuleController._getRadius(this.address);
    }
    ...
    public boolean setRadius(float radius) {
        this.checkNotNull();
        return PxCapsuleController._setRadius(this.address, radius);
    }
    ...
    public float getHeight() {
        this.checkNotNull();
        return PxCapsuleController._getHeight(this.address);
    }
    ...
    public boolean setHeight(float height) {
        this.checkNotNull();
        return PxCapsuleController._setHeight(this.address, height);
    }
    ...
    public PxCapsuleClimbingModeEnum getClimbingMode() {
        this.checkNotNull();
        return PxCapsuleClimbingModeEnum.forValue(PxCapsuleController._getClimbingMode(this.address));
    }
    ...
    public boolean setClimbingMode(PxCapsuleClimbingModeEnum mode) {
        this.checkNotNull();
        return PxCapsuleController._setClimbingMode(this.address, mode.value);
    }
