...
extends PxControllerDesc {
    ...
    public static PxBoxControllerDesc createAt(long address) {
        PxBoxControllerDesc.__placement_new_PxBoxControllerDesc(address);
    ...
    public PxBoxControllerDesc() {
        this.address = PxBoxControllerDesc._PxBoxControllerDesc();
    }
    ...
    public void destroy() {
        ...
        PxBoxControllerDesc._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public float getHalfHeight() {
        this.checkNotNull();
        return PxBoxControllerDesc._getHalfHeight(this.address);
    }
    ...
    public void setHalfHeight(float value) {
        this.checkNotNull();
        PxBoxControllerDesc._setHalfHeight(this.address, value);
    }
    ...
    public float getHalfSideExtent() {
        this.checkNotNull();
        return PxBoxControllerDesc._getHalfSideExtent(this.address);
    }
    ...
    public void setHalfSideExtent(float value) {
        this.checkNotNull();
        PxBoxControllerDesc._setHalfSideExtent(this.address, value);
    }
    ...
    public float getHalfForwardExtent() {
        this.checkNotNull();
        return PxBoxControllerDesc._getHalfForwardExtent(this.address);
    }
    ...
    public void setHalfForwardExtent(float value) {
        this.checkNotNull();
        PxBoxControllerDesc._setHalfForwardExtent(this.address, value);
    }
    ...
    public void setToDefault() {
        this.checkNotNull();
        PxBoxControllerDesc._setToDefault(this.address);
    }
