...
public class PxDistanceJointFlags
extends NativeObject {
    public static final int SIZEOF = PxDistanceJointFlags.__sizeOf();
    ...
    public static PxDistanceJointFlags arrayGet(long baseAddress, int index) {
        ...
        return PxDistanceJointFlags.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxDistanceJointFlags createAt(long address, short flags) {
        PxDistanceJointFlags.__placement_new_PxDistanceJointFlags(address, flags);
        PxDistanceJointFlags createdObj = PxDistanceJointFlags.wrapPointer(address);
    ...
    public PxDistanceJointFlags(short flags) {
        this.address = PxDistanceJointFlags._PxDistanceJointFlags(flags);
    }
    ...
    public void destroy() {
        ...
        PxDistanceJointFlags._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public boolean isSet(PxDistanceJointFlagEnum flag) {
        this.checkNotNull();
        return PxDistanceJointFlags._isSet(this.address, flag.value);
    }
    ...
    public void raise(PxDistanceJointFlagEnum flag) {
        this.checkNotNull();
        PxDistanceJointFlags._raise(this.address, flag.value);
    }
    ...
    public void clear(PxDistanceJointFlagEnum flag) {
        this.checkNotNull();
        PxDistanceJointFlags._clear(this.address, flag.value);
    }
