...
import physx.geometry.PxTriangleMeshAnalysisResultEnum;

public class PxTriangleMeshAnalysisResults
extends NativeObject {
    public static final int SIZEOF = PxTriangleMeshAnalysisResults.__sizeOf();
    ...
    public static PxTriangleMeshAnalysisResults arrayGet(long baseAddress, int index) {
        ...
        return PxTriangleMeshAnalysisResults.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxTriangleMeshAnalysisResults createAt(long address, int flags) {
        PxTriangleMeshAnalysisResults.__placement_new_PxTriangleMeshAnalysisResults(address, flags);
        PxTriangleMeshAnalysisResults createdObj = PxTriangleMeshAnalysisResults.wrapPointer(address);
    ...
    public PxTriangleMeshAnalysisResults(int flags) {
        this.address = PxTriangleMeshAnalysisResults._PxTriangleMeshAnalysisResults(flags);
    }
    ...
    public void destroy() {
        ...
        PxTriangleMeshAnalysisResults._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public boolean isSet(PxTriangleMeshAnalysisResultEnum flag) {
        this.checkNotNull();
        return PxTriangleMeshAnalysisResults._isSet(this.address, flag.value);
    }
    ...
    public void raise(PxTriangleMeshAnalysisResultEnum flag) {
        this.checkNotNull();
        PxTriangleMeshAnalysisResults._raise(this.address, flag.value);
    }
    ...
    public void clear(PxTriangleMeshAnalysisResultEnum flag) {
        this.checkNotNull();
        PxTriangleMeshAnalysisResults._clear(this.address, flag.value);
    }
