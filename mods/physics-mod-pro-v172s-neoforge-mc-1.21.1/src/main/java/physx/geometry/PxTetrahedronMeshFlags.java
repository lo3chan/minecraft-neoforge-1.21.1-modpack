...
import physx.geometry.PxTetrahedronMeshFlagEnum;

public class PxTetrahedronMeshFlags
extends NativeObject {
    public static final int SIZEOF = PxTetrahedronMeshFlags.__sizeOf();
    ...
    public static PxTetrahedronMeshFlags arrayGet(long baseAddress, int index) {
        ...
        return PxTetrahedronMeshFlags.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxTetrahedronMeshFlags createAt(long address, byte flags) {
        PxTetrahedronMeshFlags.__placement_new_PxTetrahedronMeshFlags(address, flags);
        PxTetrahedronMeshFlags createdObj = PxTetrahedronMeshFlags.wrapPointer(address);
    ...
    public PxTetrahedronMeshFlags(byte flags) {
        this.address = PxTetrahedronMeshFlags._PxTetrahedronMeshFlags(flags);
    }
    ...
    public void destroy() {
        ...
        PxTetrahedronMeshFlags._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public boolean isSet(PxTetrahedronMeshFlagEnum flag) {
        this.checkNotNull();
        return PxTetrahedronMeshFlags._isSet(this.address, flag.value);
    }
    ...
    public void raise(PxTetrahedronMeshFlagEnum flag) {
        this.checkNotNull();
        PxTetrahedronMeshFlags._raise(this.address, flag.value);
    }
    ...
    public void clear(PxTetrahedronMeshFlagEnum flag) {
        this.checkNotNull();
        PxTetrahedronMeshFlags._clear(this.address, flag.value);
    }
