...
public class PxHeightFieldSample
extends NativeObject {
    public static final int SIZEOF = PxHeightFieldSample.__sizeOf();
    ...
    public static PxHeightFieldSample arrayGet(long baseAddress, int index) {
        ...
        return PxHeightFieldSample.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxHeightFieldSample createAt(long address) {
        PxHeightFieldSample.__placement_new_PxHeightFieldSample(address);
        PxHeightFieldSample createdObj = PxHeightFieldSample.wrapPointer(address);
    ...
    public PxHeightFieldSample() {
        this.address = PxHeightFieldSample._PxHeightFieldSample();
    }
    ...
    public void destroy() {
        ...
        PxHeightFieldSample._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public short getHeight() {
        this.checkNotNull();
        return PxHeightFieldSample._getHeight(this.address);
    }
    ...
    public void setHeight(short value) {
        this.checkNotNull();
        PxHeightFieldSample._setHeight(this.address, value);
    }
    ...
    public byte getMaterialIndex0() {
        this.checkNotNull();
        return PxHeightFieldSample._getMaterialIndex0(this.address);
    }
    ...
    public void setMaterialIndex0(byte value) {
        this.checkNotNull();
        PxHeightFieldSample._setMaterialIndex0(this.address, value);
    }
    ...
    public byte getMaterialIndex1() {
        this.checkNotNull();
        return PxHeightFieldSample._getMaterialIndex1(this.address);
    }
    ...
    public void setMaterialIndex1(byte value) {
        this.checkNotNull();
        PxHeightFieldSample._setMaterialIndex1(this.address, value);
    }
    ...
    public byte tessFlag() {
        this.checkNotNull();
        return PxHeightFieldSample._tessFlag(this.address);
    }
    ...
    public void clearTessFlag() {
        this.checkNotNull();
        PxHeightFieldSample._clearTessFlag(this.address);
    }
    ...
    public void setTessFlag() {
        this.checkNotNull();
        PxHeightFieldSample._setTessFlag(this.address);
    }
