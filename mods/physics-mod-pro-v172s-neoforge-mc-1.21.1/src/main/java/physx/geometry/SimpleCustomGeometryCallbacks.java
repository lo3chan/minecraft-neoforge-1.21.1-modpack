...
extends NativeObject {
    ...
    public void destroy() {
        ...
        SimpleCustomGeometryCallbacks._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public float getPersistentContactManifold_outBreakingThreshold() {
        this.checkNotNull();
        return SimpleCustomGeometryCallbacks._getPersistentContactManifold_outBreakingThreshold(this.address);
    }
    ...
    public void setPersistentContactManifold_outBreakingThreshold(float value) {
        this.checkNotNull();
        SimpleCustomGeometryCallbacks._setPersistentContactManifold_outBreakingThreshold(this.address, value);
    }
    ...
    public PxBounds3 getLocalBoundsImpl(PxGeometry geometry) {
        this.checkNotNull();
        return PxBounds3.wrapPointer(SimpleCustomGeometryCallbacks._getLocalBoundsImpl(this.address, geometry.getAddress()));
    }
    ...
    public boolean generateContactsImpl(PxGeometry geom0, PxGeometry geom1, PxTransform pose0, PxTransform pose1, float contactDistance, float meshContactMargin, float toleranceLength, PxContactBuffer contactBuffer) {
        this.checkNotNull();
        return SimpleCustomGeometryCallbacks._generateContactsImpl(this.address, geom0.getAddress(), geom1.getAddress(), pose0.getAddress(), pose1.getAddress(), contactDistance, meshContactMargin, toleranceLength, contactBuffer.getAddress());
    }
    ...
    public int raycastImpl(PxVec3 origin, PxVec3 unitDir, PxGeometry geom, PxTransform pose, float maxDist, PxHitFlags hitFlags, int maxHits, PxGeomRaycastHit rayHits, int stride) {
        this.checkNotNull();
        return SimpleCustomGeometryCallbacks._raycastImpl(this.address, origin.getAddress(), unitDir.getAddress(), geom.getAddress(), pose.getAddress(), maxDist, hitFlags.getAddress(), maxHits, rayHits.getAddress(), stride);
    }
    ...
    public boolean overlapImpl(PxGeometry geom0, PxTransform pose0, PxGeometry geom1, PxTransform pose1) {
        this.checkNotNull();
        return SimpleCustomGeometryCallbacks._overlapImpl(this.address, geom0.getAddress(), pose0.getAddress(), geom1.getAddress(), pose1.getAddress());
    }
    ...
    public boolean sweepImpl(PxVec3 unitDir, float maxDist, PxGeometry geom0, PxTransform pose0, PxGeometry geom1, PxTransform pose1, PxGeomSweepHit sweepHit, PxHitFlags hitFlags, float inflation) {
        this.checkNotNull();
        return SimpleCustomGeometryCallbacks._sweepImpl(this.address, unitDir.getAddress(), maxDist, geom0.getAddress(), pose0.getAddress(), geom1.getAddress(), pose1.getAddress(), sweepHit.getAddress(), hitFlags.getAddress(), inflation);
    }
    ...
    public void computeMassPropertiesImpl(PxGeometry geometry, PxMassProperties massProperties) {
        this.checkNotNull();
        SimpleCustomGeometryCallbacks._computeMassPropertiesImpl(this.address, geometry.getAddress(), massProperties.getAddress());
    }
    ...
    public boolean usePersistentContactManifoldImpl(PxGeometry geometry) {
        this.checkNotNull();
        return SimpleCustomGeometryCallbacks._usePersistentContactManifoldImpl(this.address, geometry.getAddress());
    }
