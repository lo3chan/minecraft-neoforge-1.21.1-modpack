...
extends PxGeometry {
    public static final int SIZEOF = PxSphereGeometry.__sizeOf();
    ...
    public static PxSphereGeometry arrayGet(long baseAddress, int index) {
        ...
        return PxSphereGeometry.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxSphereGeometry createAt(long address, float ir) {
        PxSphereGeometry.__placement_new_PxSphereGeometry(address, ir);
        PxSphereGeometry createdObj = PxSphereGeometry.wrapPointer(address);
    ...
    public PxSphereGeometry(float ir) {
        this.address = PxSphereGeometry._PxSphereGeometry(ir);
    }
    ...
    public void destroy() {
        ...
        PxSphereGeometry._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public float getRadius() {
        this.checkNotNull();
        return PxSphereGeometry._getRadius(this.address);
    }
    ...
    public void setRadius(float value) {
        this.checkNotNull();
        PxSphereGeometry._setRadius(this.address, value);
    }
