...
public class PxMeshScale
extends NativeObject {
    public static final int SIZEOF = PxMeshScale.__sizeOf();
    ...
    public static PxMeshScale arrayGet(long baseAddress, int index) {
        ...
        return PxMeshScale.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxMeshScale createAt(long address) {
        PxMeshScale.__placement_new_PxMeshScale(address);
        PxMeshScale createdObj = PxMeshScale.wrapPointer(address);
    ...
    public static PxMeshScale createAt(long address, float r) {
        PxMeshScale.__placement_new_PxMeshScale(address, r);
        PxMeshScale createdObj = PxMeshScale.wrapPointer(address);
        createdObj.isExternallyAllocated = true;
        return createdObj;
    }
    ...
    public static PxMeshScale createAt(long address, PxVec3 s, PxQuat r) {
        PxMeshScale.__placement_new_PxMeshScale(address, s.getAddress(), r.getAddress());
        PxMeshScale createdObj = PxMeshScale.wrapPointer(address);
        createdObj.isExternallyAllocated = true;
        return createdObj;
    }
    ...
    public void destroy() {
        ...
        PxMeshScale._delete_native_instance(this.address);
        this.address = 0L;
    }
