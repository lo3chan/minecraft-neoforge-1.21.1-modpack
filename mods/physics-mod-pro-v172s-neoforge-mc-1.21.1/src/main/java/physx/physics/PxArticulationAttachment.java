...
import physx.physics.PxArticulationTendonLimit;

public class PxArticulationAttachment
extends NativeObject {
    public static final int SIZEOF = PxArticulationAttachment.__sizeOf();
    ...
    public static PxArticulationAttachment arrayGet(long baseAddress, int index) {
        ...
        return PxArticulationAttachment.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxArticulationAttachment._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public NativeObject getUserData() {
        this.checkNotNull();
        return NativeObject.wrapPointer(PxArticulationAttachment._getUserData(this.address));
    }
    ...
    public void setUserData(NativeObject value) {
        this.checkNotNull();
        PxArticulationAttachment._setUserData(this.address, value.getAddress());
    }
    ...
    public void setRestLength(float restLength) {
        this.checkNotNull();
        PxArticulationAttachment._setRestLength(this.address, restLength);
    }
    ...
    public float getRestLength() {
        this.checkNotNull();
        return PxArticulationAttachment._getRestLength(this.address);
    }
    ...
    public void setLimitParameters(PxArticulationTendonLimit parameters) {
        this.checkNotNull();
        PxArticulationAttachment._setLimitParameters(this.address, parameters.getAddress());
    }
    ...
    public PxArticulationTendonLimit getLimitParameters() {
        this.checkNotNull();
        return PxArticulationTendonLimit.wrapPointer(PxArticulationAttachment._getLimitParameters(this.address));
    }
    ...
    public void setRelativeOffset(PxVec3 offset) {
        this.checkNotNull();
        PxArticulationAttachment._setRelativeOffset(this.address, offset.getAddress());
    }
    ...
    public PxVec3 getRelativeOffset() {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxArticulationAttachment._getRelativeOffset(this.address));
    }
    ...
    public void setCoefficient(float coefficient) {
        this.checkNotNull();
        PxArticulationAttachment._setCoefficient(this.address, coefficient);
    }
    ...
    public float getCoefficient() {
        this.checkNotNull();
        return PxArticulationAttachment._getCoefficient(this.address);
    }
    ...
    public PxArticulationLink getLink() {
        this.checkNotNull();
        return PxArticulationLink.wrapPointer(PxArticulationAttachment._getLink(this.address));
    }
    ...
    public PxArticulationAttachment getParent() {
        this.checkNotNull();
        return PxArticulationAttachment.wrapPointer(PxArticulationAttachment._getParent(this.address));
    }
    ...
    public boolean isLeaf() {
        this.checkNotNull();
        return PxArticulationAttachment._isLeaf(this.address);
    }
    ...
    public PxArticulationSpatialTendon getTendon() {
        this.checkNotNull();
        return PxArticulationSpatialTendon.wrapPointer(PxArticulationAttachment._getTendon(this.address));
    }
    ...
    public void release() {
        this.checkNotNull();
        PxArticulationAttachment._release(this.address);
    }
