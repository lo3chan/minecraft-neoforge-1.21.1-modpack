...
extends PxBase {
    ...
    public void destroy() {
        ...
        PxArticulationJointReducedCoordinate._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxArticulationLink getParentArticulationLink() {
        this.checkNotNull();
        return PxArticulationLink.wrapPointer(PxArticulationJointReducedCoordinate._getParentArticulationLink(this.address));
    }
    ...
    public void setParentPose(PxTransform pose) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setParentPose(this.address, pose.getAddress());
    }
    ...
    public PxTransform getParentPose() {
        this.checkNotNull();
        return PxTransform.wrapPointer(PxArticulationJointReducedCoordinate._getParentPose(this.address));
    }
    ...
    public PxArticulationLink getChildArticulationLink() {
        this.checkNotNull();
        return PxArticulationLink.wrapPointer(PxArticulationJointReducedCoordinate._getChildArticulationLink(this.address));
    }
    ...
    public void setChildPose(PxTransform pose) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setChildPose(this.address, pose.getAddress());
    }
    ...
    public PxTransform getChildPose() {
        this.checkNotNull();
        return PxTransform.wrapPointer(PxArticulationJointReducedCoordinate._getChildPose(this.address));
    }
    ...
    public void setJointType(PxArticulationJointTypeEnum jointType) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setJointType(this.address, jointType.value);
    }
    ...
    public PxArticulationJointTypeEnum getJointType() {
        this.checkNotNull();
        return PxArticulationJointTypeEnum.forValue(PxArticulationJointReducedCoordinate._getJointType(this.address));
    }
    ...
    public void setMotion(PxArticulationAxisEnum axis, PxArticulationMotionEnum motion) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setMotion(this.address, axis.value, motion.value);
    }
    ...
    public PxArticulationMotionEnum getMotion(PxArticulationAxisEnum axis) {
        this.checkNotNull();
        return PxArticulationMotionEnum.forValue(PxArticulationJointReducedCoordinate._getMotion(this.address, axis.value));
    }
    ...
    public void setLimitParams(PxArticulationAxisEnum axis, PxArticulationLimit limit) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setLimitParams(this.address, axis.value, limit.getAddress());
    }
    ...
    public PxArticulationLimit getLimitParams(PxArticulationAxisEnum axis) {
        this.checkNotNull();
        return PxArticulationLimit.wrapPointer(PxArticulationJointReducedCoordinate._getLimitParams(this.address, axis.value));
    }
    ...
    public void setDriveParams(PxArticulationAxisEnum axis, PxArticulationDrive drive) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setDriveParams(this.address, axis.value, drive.getAddress());
    }
    ...
    public void setDriveTarget(PxArticulationAxisEnum axis, float target) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setDriveTarget(this.address, axis.value, target);
    }
    ...
    public void setDriveTarget(PxArticulationAxisEnum axis, float target, boolean autowake) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setDriveTarget(this.address, axis.value, target, autowake);
    }
    ...
    public float getDriveTarget(PxArticulationAxisEnum axis) {
        this.checkNotNull();
        return PxArticulationJointReducedCoordinate._getDriveTarget(this.address, axis.value);
    }
    ...
    public void setDriveVelocity(PxArticulationAxisEnum axis, float targetVel) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setDriveVelocity(this.address, axis.value, targetVel);
    }
    ...
    public void setDriveVelocity(PxArticulationAxisEnum axis, float targetVel, boolean autowake) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setDriveVelocity(this.address, axis.value, targetVel, autowake);
    }
    ...
    public float getDriveVelocity(PxArticulationAxisEnum axis) {
        this.checkNotNull();
        return PxArticulationJointReducedCoordinate._getDriveVelocity(this.address, axis.value);
    }
    ...
    public void setArmature(PxArticulationAxisEnum axis, float armature) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setArmature(this.address, axis.value, armature);
    }
    ...
    public float getArmature(PxArticulationAxisEnum axis) {
        this.checkNotNull();
        return PxArticulationJointReducedCoordinate._getArmature(this.address, axis.value);
    }
    ...
    public void setFrictionCoefficient(float coefficient) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setFrictionCoefficient(this.address, coefficient);
    }
    ...
    public float getFrictionCoefficient() {
        this.checkNotNull();
        return PxArticulationJointReducedCoordinate._getFrictionCoefficient(this.address);
    }
    ...
    public void setMaxJointVelocity(float maxJointV) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setMaxJointVelocity(this.address, maxJointV);
    }
    ...
    public float getMaxJointVelocity() {
        this.checkNotNull();
        return PxArticulationJointReducedCoordinate._getMaxJointVelocity(this.address);
    }
    ...
    public void setJointPosition(PxArticulationAxisEnum axis, float jointPos) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setJointPosition(this.address, axis.value, jointPos);
    }
    ...
    public float getJointPosition(PxArticulationAxisEnum axis) {
        this.checkNotNull();
        return PxArticulationJointReducedCoordinate._getJointPosition(this.address, axis.value);
    }
    ...
    public void setJointVelocity(PxArticulationAxisEnum axis, float jointVel) {
        this.checkNotNull();
        PxArticulationJointReducedCoordinate._setJointVelocity(this.address, axis.value, jointVel);
    }
    ...
    public float getJointVelocity(PxArticulationAxisEnum axis) {
        this.checkNotNull();
        return PxArticulationJointReducedCoordinate._getJointVelocity(this.address, axis.value);
    }
