...
public class PxQueryHit
extends NativeObject {
    public static final int SIZEOF = PxQueryHit.__sizeOf();
    ...
    public static PxQueryHit arrayGet(long baseAddress, int index) {
        ...
        return PxQueryHit.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxQueryHit._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public int getFaceIndex() {
        this.checkNotNull();
        return PxQueryHit._getFaceIndex(this.address);
    }
    ...
    public void setFaceIndex(int value) {
        this.checkNotNull();
        PxQueryHit._setFaceIndex(this.address, value);
    }
