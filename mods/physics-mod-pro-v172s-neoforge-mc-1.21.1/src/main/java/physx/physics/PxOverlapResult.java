...
extends PxOverlapCallback {
    ...
    public PxOverlapResult() {
        this.address = PxOverlapResult._PxOverlapResult();
    }
    ...
    public void destroy() {
        ...
        PxOverlapResult._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxOverlapHit getBlock() {
        this.checkNotNull();
        return PxOverlapHit.wrapPointer(PxOverlapResult._getBlock(this.address));
    }
    ...
    public void setBlock(PxOverlapHit value) {
        this.checkNotNull();
        PxOverlapResult._setBlock(this.address, value.getAddress());
    }
    ...
    public boolean getHasBlock() {
        this.checkNotNull();
        return PxOverlapResult._getHasBlock(this.address);
    }
    ...
    public void setHasBlock(boolean value) {
        this.checkNotNull();
        PxOverlapResult._setHasBlock(this.address, value);
    }
    ...
    public int getNbAnyHits() {
        this.checkNotNull();
        return PxOverlapResult._getNbAnyHits(this.address);
    }
    ...
    public PxOverlapHit getAnyHit(int index) {
        this.checkNotNull();
        return PxOverlapHit.wrapPointer(PxOverlapResult._getAnyHit(this.address, index));
    }
    ...
    public int getNbTouches() {
        this.checkNotNull();
        return PxOverlapResult._getNbTouches(this.address);
    }
    ...
    public PxOverlapHit getTouch(int index) {
        this.checkNotNull();
        return PxOverlapHit.wrapPointer(PxOverlapResult._getTouch(this.address, index));
    }
