...
extends NativeObject {
    ...
    public static PxActorFlags createAt(long address, byte flags) {
        PxActorFlags.__placement_new_PxActorFlags(address, flags);
    ...
    public PxActorFlags(byte flags) {
        this.address = PxActorFlags._PxActorFlags(flags);
    }
    ...
    public void destroy() {
        ...
        PxActorFlags._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public boolean isSet(PxActorFlagEnum flag) {
        this.checkNotNull();
        return PxActorFlags._isSet(this.address, flag.value);
    }
    ...
    public void raise(PxActorFlagEnum flag) {
        this.checkNotNull();
        PxActorFlags._raise(this.address, flag.value);
    }
    ...
    public void clear(PxActorFlagEnum flag) {
        this.checkNotNull();
        PxActorFlags._clear(this.address, flag.value);
    }
