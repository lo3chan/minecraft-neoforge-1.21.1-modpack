...
import physx.physics.PxArticulationTendonJoint;
import physx.physics.PxArticulationTendonLimit;

public class PxArticulationFixedTendon
extends PxArticulationTendon {
    public static final int SIZEOF = PxArticulationFixedTendon.__sizeOf();
    ...
    public static PxArticulationFixedTendon arrayGet(long baseAddress, int index) {
        ...
        return PxArticulationFixedTendon.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxArticulationFixedTendon._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxArticulationTendonJoint createTendonJoint(PxArticulationTendonJoint parent, PxArticulationAxisEnum axis, float coefficient, float recipCoefficient, PxArticulationLink link) {
        this.checkNotNull();
        return PxArticulationTendonJoint.wrapPointer(PxArticulationFixedTendon._createTendonJoint(this.address, parent.getAddress(), axis.value, coefficient, recipCoefficient, link.getAddress()));
    }
    ...
    public int getNbTendonJoints() {
        this.checkNotNull();
        return PxArticulationFixedTendon._getNbTendonJoints(this.address);
    }
    ...
    public void setRestLength(float restLength) {
        this.checkNotNull();
        PxArticulationFixedTendon._setRestLength(this.address, restLength);
    }
    ...
    public float getRestLength() {
        this.checkNotNull();
        return PxArticulationFixedTendon._getRestLength(this.address);
    }
    ...
    public void setLimitParameters(PxArticulationTendonLimit parameter) {
        this.checkNotNull();
        PxArticulationFixedTendon._setLimitParameters(this.address, parameter.getAddress());
    }
    ...
    public PxArticulationTendonLimit getLimitParameters() {
        this.checkNotNull();
        return PxArticulationTendonLimit.wrapPointer(PxArticulationFixedTendon._getLimitParameters(this.address));
    }
