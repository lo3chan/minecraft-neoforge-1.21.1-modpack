...
public class PxDominanceGroupPair
extends NativeObject {
    public static final int SIZEOF = PxDominanceGroupPair.__sizeOf();
    ...
    public static PxDominanceGroupPair arrayGet(long baseAddress, int index) {
        ...
        return PxDominanceGroupPair.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public PxDominanceGroupPair(byte a, byte b) {
        this.address = PxDominanceGroupPair._PxDominanceGroupPair(a, b);
    }
    ...
    public void destroy() {
        ...
        PxDominanceGroupPair._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public byte getDominance0() {
        this.checkNotNull();
        return PxDominanceGroupPair._getDominance0(this.address);
    }
    ...
    public void setDominance0(byte value) {
        this.checkNotNull();
        PxDominanceGroupPair._setDominance0(this.address, value);
    }
    ...
    public byte getDominance1() {
        this.checkNotNull();
        return PxDominanceGroupPair._getDominance1(this.address);
    }
    ...
    public void setDominance1(byte value) {
        this.checkNotNull();
        PxDominanceGroupPair._setDominance1(this.address, value);
    }
