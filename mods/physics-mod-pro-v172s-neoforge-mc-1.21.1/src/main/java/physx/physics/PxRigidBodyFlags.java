...
public class PxRigidBodyFlags
extends NativeObject {
    public static final int SIZEOF = PxRigidBodyFlags.__sizeOf();
    ...
    public static PxRigidBodyFlags arrayGet(long baseAddress, int index) {
        ...
        return PxRigidBodyFlags.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxRigidBodyFlags createAt(long address, byte flags) {
        PxRigidBodyFlags.__placement_new_PxRigidBodyFlags(address, flags);
        PxRigidBodyFlags createdObj = PxRigidBodyFlags.wrapPointer(address);
    ...
    public PxRigidBodyFlags(byte flags) {
        this.address = PxRigidBodyFlags._PxRigidBodyFlags(flags);
    }
    ...
    public void destroy() {
        ...
        PxRigidBodyFlags._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public boolean isSet(PxRigidBodyFlagEnum flag) {
        this.checkNotNull();
        return PxRigidBodyFlags._isSet(this.address, flag.value);
    }
    ...
    public void raise(PxRigidBodyFlagEnum flag) {
        this.checkNotNull();
        PxRigidBodyFlags._raise(this.address, flag.value);
    }
    ...
    public void clear(PxRigidBodyFlagEnum flag) {
        this.checkNotNull();
        PxRigidBodyFlags._clear(this.address, flag.value);
    }
