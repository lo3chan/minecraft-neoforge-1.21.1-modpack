...
public class PxArray_PxContactPairPoint
extends NativeObject {
    public static final int SIZEOF = PxArray_PxContactPairPoint.__sizeOf();
    ...
    public static PxArray_PxContactPairPoint arrayGet(long baseAddress, int index) {
        ...
        return PxArray_PxContactPairPoint.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxArray_PxContactPairPoint createAt(long address) {
        PxArray_PxContactPairPoint.__placement_new_PxArray_PxContactPairPoint(address);
        PxArray_PxContactPairPoint createdObj = PxArray_PxContactPairPoint.wrapPointer(address);
    ...
    public static PxArray_PxContactPairPoint createAt(long address, int size) {
        PxArray_PxContactPairPoint.__placement_new_PxArray_PxContactPairPoint(address, size);
        PxArray_PxContactPairPoint createdObj = PxArray_PxContactPairPoint.wrapPointer(address);
        createdObj.isExternallyAllocated = true;
        return createdObj;
    }
    ...
    public PxArray_PxContactPairPoint() {
        this.address = PxArray_PxContactPairPoint._PxArray_PxContactPairPoint();
    }

    private static native long _PxArray_PxContactPairPoint();

    public PxArray_PxContactPairPoint(int size) {
        this.address = PxArray_PxContactPairPoint._PxArray_PxContactPairPoint(size);
    }
    ...
    public void destroy() {
        ...
        PxArray_PxContactPairPoint._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxContactPairPoint get(int index) {
        this.checkNotNull();
        return PxContactPairPoint.wrapPointer(PxArray_PxContactPairPoint._get(this.address, index));
    }
    ...
    public void set(int index, PxContactPairPoint value) {
        this.checkNotNull();
        PxArray_PxContactPairPoint._set(this.address, index, value.getAddress());
    }
    ...
    public PxContactPairPoint begin() {
        this.checkNotNull();
        return PxContactPairPoint.wrapPointer(PxArray_PxContactPairPoint._begin(this.address));
    }
    ...
    public int size() {
        this.checkNotNull();
        return PxArray_PxContactPairPoint._size(this.address);
    }
    ...
    public void pushBack(PxContactPairPoint value) {
        this.checkNotNull();
        PxArray_PxContactPairPoint._pushBack(this.address, value.getAddress());
    }
    ...
    public void clear() {
        this.checkNotNull();
        PxArray_PxContactPairPoint._clear(this.address);
    }
