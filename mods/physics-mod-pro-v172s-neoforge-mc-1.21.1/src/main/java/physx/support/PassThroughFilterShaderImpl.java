...
public class PassThroughFilterShaderImpl
extends PassThroughFilterShader {
    public static final int SIZEOF = PassThroughFilterShaderImpl.__sizeOf();
    ...
    public static PassThroughFilterShaderImpl arrayGet(long baseAddress, int index) {
        ...
        return PassThroughFilterShaderImpl.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PassThroughFilterShaderImpl._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    private int _filterShader(int attributes0, int filterData0w0, int filterData0w1, int filterData0w2, int filterData0w3, int attributes1, int filterData1w0, int filterData1w1, int filterData1w2, int filterData1w3) {
        return this.filterShader(attributes0, filterData0w0, filterData0w1, filterData0w2, filterData0w3, attributes1, filterData1w0, filterData1w1, filterData1w2, filterData1w3);
    }
