...
public class PxU32ConstPtr
extends NativeObject {
    public static final int SIZEOF = PxU32ConstPtr.__sizeOf();
    ...
    public static PxU32ConstPtr arrayGet(long baseAddress, int index) {
        ...
        return PxU32ConstPtr.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxU32ConstPtr._delete_native_instance(this.address);
        this.address = 0L;
    }
