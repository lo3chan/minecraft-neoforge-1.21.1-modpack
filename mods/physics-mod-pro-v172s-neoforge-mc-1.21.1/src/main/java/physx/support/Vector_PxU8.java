...
@Deprecated
public class Vector_PxU8
extends NativeObject {
    public static final int SIZEOF = Vector_PxU8.__sizeOf();
    ...
    public static Vector_PxU8 arrayGet(long baseAddress, int index) {
        ...
        return Vector_PxU8.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public Vector_PxU8() {
        this.address = Vector_PxU8._Vector_PxU8();
    }

    private static native long _Vector_PxU8();

    public Vector_PxU8(int size) {
        this.address = Vector_PxU8._Vector_PxU8(size);
    }
    ...
    public void destroy() {
        ...
        Vector_PxU8._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public byte at(int index) {
        this.checkNotNull();
        return Vector_PxU8._at(this.address, index);
    }
    ...
    public NativeObject data() {
        this.checkNotNull();
        return NativeObject.wrapPointer(Vector_PxU8._data(this.address));
    }
    ...
    public int size() {
        this.checkNotNull();
        return Vector_PxU8._size(this.address);
    }
    ...
    public void push_back(byte value) {
        this.checkNotNull();
        Vector_PxU8._push_back(this.address, value);
    }
    ...
    public void clear() {
        this.checkNotNull();
        Vector_PxU8._clear(this.address);
    }
