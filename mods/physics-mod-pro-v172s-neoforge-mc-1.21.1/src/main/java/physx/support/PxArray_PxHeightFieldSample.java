...
public class PxArray_PxHeightFieldSample
extends NativeObject {
    public static final int SIZEOF = PxArray_PxHeightFieldSample.__sizeOf();
    ...
    public static PxArray_PxHeightFieldSample arrayGet(long baseAddress, int index) {
        ...
        return PxArray_PxHeightFieldSample.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxArray_PxHeightFieldSample createAt(long address) {
        PxArray_PxHeightFieldSample.__placement_new_PxArray_PxHeightFieldSample(address);
        PxArray_PxHeightFieldSample createdObj = PxArray_PxHeightFieldSample.wrapPointer(address);
    ...
    public static PxArray_PxHeightFieldSample createAt(long address, int size) {
        PxArray_PxHeightFieldSample.__placement_new_PxArray_PxHeightFieldSample(address, size);
        PxArray_PxHeightFieldSample createdObj = PxArray_PxHeightFieldSample.wrapPointer(address);
        createdObj.isExternallyAllocated = true;
        return createdObj;
    }
    ...
    public PxArray_PxHeightFieldSample() {
        this.address = PxArray_PxHeightFieldSample._PxArray_PxHeightFieldSample();
    }

    private static native long _PxArray_PxHeightFieldSample();

    public PxArray_PxHeightFieldSample(int size) {
        this.address = PxArray_PxHeightFieldSample._PxArray_PxHeightFieldSample(size);
    }
    ...
    public void destroy() {
        ...
        PxArray_PxHeightFieldSample._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxHeightFieldSample get(int index) {
        this.checkNotNull();
        return PxHeightFieldSample.wrapPointer(PxArray_PxHeightFieldSample._get(this.address, index));
    }
    ...
    public void set(int index, PxHeightFieldSample value) {
        this.checkNotNull();
        PxArray_PxHeightFieldSample._set(this.address, index, value.getAddress());
    }
    ...
    public PxHeightFieldSample begin() {
        this.checkNotNull();
        return PxHeightFieldSample.wrapPointer(PxArray_PxHeightFieldSample._begin(this.address));
    }
    ...
    public int size() {
        this.checkNotNull();
        return PxArray_PxHeightFieldSample._size(this.address);
    }
    ...
    public void pushBack(PxHeightFieldSample value) {
        this.checkNotNull();
        PxArray_PxHeightFieldSample._pushBack(this.address, value.getAddress());
    }
    ...
    public void clear() {
        this.checkNotNull();
        PxArray_PxHeightFieldSample._clear(this.address);
    }
