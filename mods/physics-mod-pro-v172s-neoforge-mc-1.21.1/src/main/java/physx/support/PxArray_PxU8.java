...
extends NativeObject {
    ...
    public static PxArray_PxU8 createAt(long address) {
        PxArray_PxU8.__placement_new_PxArray_PxU8(address);
    ...
    public static PxArray_PxU8 createAt(long address, int size) {
        PxArray_PxU8.__placement_new_PxArray_PxU8(address, size);
        PxArray_PxU8 createdObj = PxArray_PxU8.wrapPointer(address);
        createdObj.isExternallyAllocated = true;
        return createdObj;
    }
    ...
    public PxArray_PxU8() {
        this.address = PxArray_PxU8._PxArray_PxU8();
    }

    private static native long _PxArray_PxU8();

    public PxArray_PxU8(int size) {
        this.address = PxArray_PxU8._PxArray_PxU8(size);
    }
    ...
    public void destroy() {
        ...
        PxArray_PxU8._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public byte get(int index) {
        this.checkNotNull();
        return PxArray_PxU8._get(this.address, index);
    }
    ...
    public void set(int index, byte value) {
        this.checkNotNull();
        PxArray_PxU8._set(this.address, index, value);
    }
    ...
    public NativeObject begin() {
        this.checkNotNull();
        return NativeObject.wrapPointer(PxArray_PxU8._begin(this.address));
    }
    ...
    public int size() {
        this.checkNotNull();
        return PxArray_PxU8._size(this.address);
    }
    ...
    public void pushBack(byte value) {
        this.checkNotNull();
        PxArray_PxU8._pushBack(this.address, value);
    }
    ...
    public void clear() {
        this.checkNotNull();
        PxArray_PxU8._clear(this.address);
    }
