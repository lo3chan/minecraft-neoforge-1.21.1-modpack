...
public class PxRealConstPtr
extends NativeObject {
    public static final int SIZEOF = PxRealConstPtr.__sizeOf();
    ...
    public static PxRealConstPtr arrayGet(long baseAddress, int index) {
        ...
        return PxRealConstPtr.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxRealConstPtr._delete_native_instance(this.address);
        this.address = 0L;
    }
