...
public class PassThroughFilterShader
extends PxSimulationFilterShader {
    public static final int SIZEOF = PassThroughFilterShader.__sizeOf();
    ...
    public static PassThroughFilterShader arrayGet(long baseAddress, int index) {
        ...
        return PassThroughFilterShader.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PassThroughFilterShader._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public int getOutputPairFlags() {
        this.checkNotNull();
        return PassThroughFilterShader._getOutputPairFlags(this.address);
    }
    ...
    public void setOutputPairFlags(int value) {
        this.checkNotNull();
        PassThroughFilterShader._setOutputPairFlags(this.address, value);
    }
    ...
    public int filterShader(int attributes0, int filterData0w0, int filterData0w1, int filterData0w2, int filterData0w3, int attributes1, int filterData1w0, int filterData1w1, int filterData1w2, int filterData1w3) {
        this.checkNotNull();
        return PassThroughFilterShader._filterShader(this.address, attributes0, filterData0w0, filterData0w1, filterData0w2, filterData0w3, attributes1, filterData1w0, filterData1w1, filterData1w2, filterData1w3);
    }
