...
public class PxArray_PxVec4
extends NativeObject {
    public static final int SIZEOF = PxArray_PxVec4.__sizeOf();
    ...
    public static PxArray_PxVec4 arrayGet(long baseAddress, int index) {
        ...
        return PxArray_PxVec4.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static PxArray_PxVec4 createAt(long address) {
        PxArray_PxVec4.__placement_new_PxArray_PxVec4(address);
        PxArray_PxVec4 createdObj = PxArray_PxVec4.wrapPointer(address);
    ...
    public static PxArray_PxVec4 createAt(long address, int size) {
        PxArray_PxVec4.__placement_new_PxArray_PxVec4(address, size);
        PxArray_PxVec4 createdObj = PxArray_PxVec4.wrapPointer(address);
        createdObj.isExternallyAllocated = true;
        return createdObj;
    }
    ...
    public PxArray_PxVec4() {
        this.address = PxArray_PxVec4._PxArray_PxVec4();
    }

    private static native long _PxArray_PxVec4();

    public PxArray_PxVec4(int size) {
        this.address = PxArray_PxVec4._PxArray_PxVec4(size);
    }
    ...
    public void destroy() {
        ...
        PxArray_PxVec4._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxVec4 get(int index) {
        this.checkNotNull();
        return PxVec4.wrapPointer(PxArray_PxVec4._get(this.address, index));
    }
    ...
    public void set(int index, PxVec4 value) {
        this.checkNotNull();
        PxArray_PxVec4._set(this.address, index, value.getAddress());
    }
    ...
    public PxVec4 begin() {
        this.checkNotNull();
        return PxVec4.wrapPointer(PxArray_PxVec4._begin(this.address));
    }
    ...
    public int size() {
        this.checkNotNull();
        return PxArray_PxVec4._size(this.address);
    }
    ...
    public void pushBack(PxVec4 value) {
        this.checkNotNull();
        PxArray_PxVec4._pushBack(this.address, value.getAddress());
    }
    ...
    public void clear() {
        this.checkNotNull();
        PxArray_PxVec4._clear(this.address);
    }
