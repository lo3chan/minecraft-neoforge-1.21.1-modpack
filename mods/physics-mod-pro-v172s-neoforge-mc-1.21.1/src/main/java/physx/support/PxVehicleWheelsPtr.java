...
public class PxVehicleWheelsPtr
extends NativeObject {
    public static final int SIZEOF = PxVehicleWheelsPtr.__sizeOf();
    ...
    public static PxVehicleWheelsPtr arrayGet(long baseAddress, int index) {
        ...
        return PxVehicleWheelsPtr.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxVehicleWheelsPtr._delete_native_instance(this.address);
        this.address = 0L;
    }
