...
extends NativeObject {
    ...
    public PxMat33() {
        this.address = PxMat33._PxMat33();
    }

    private static native long _PxMat33();

    public PxMat33(PxIDENTITYEnum r) {
        this.address = PxMat33._PxMat33(r.value);
    }
    ...
    public void destroy() {
        ...
        PxMat33._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxVec3 getColumn0() {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxMat33._getColumn0(this.address));
    }
    ...
    public void setColumn0(PxVec3 value) {
        this.checkNotNull();
        PxMat33._setColumn0(this.address, value.getAddress());
    }
    ...
    public PxVec3 getColumn1() {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxMat33._getColumn1(this.address));
    }
    ...
    public void setColumn1(PxVec3 value) {
        this.checkNotNull();
        PxMat33._setColumn1(this.address, value.getAddress());
    }
    ...
    public PxVec3 getColumn2() {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxMat33._getColumn2(this.address));
    }
    ...
    public void setColumn2(PxVec3 value) {
        this.checkNotNull();
        PxMat33._setColumn2(this.address, value.getAddress());
    }
