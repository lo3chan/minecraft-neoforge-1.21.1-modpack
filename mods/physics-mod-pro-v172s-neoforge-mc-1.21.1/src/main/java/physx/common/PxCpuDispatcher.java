...
public class PxCpuDispatcher
extends NativeObject {
    public static final int SIZEOF = PxCpuDispatcher.__sizeOf();
    ...
    public static PxCpuDispatcher arrayGet(long baseAddress, int index) {
        ...
        return PxCpuDispatcher.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxCpuDispatcher._delete_native_instance(this.address);
        this.address = 0L;
    }
