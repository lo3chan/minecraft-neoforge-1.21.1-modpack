...
public class PxInputData
extends NativeObject {
    public static final int SIZEOF = PxInputData.__sizeOf();
    ...
    public static PxInputData arrayGet(long baseAddress, int index) {
        ...
        return PxInputData.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxInputData._delete_native_instance(this.address);
        this.address = 0L;
    }
