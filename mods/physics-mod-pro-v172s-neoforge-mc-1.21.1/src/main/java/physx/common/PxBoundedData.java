...
extends PxStridedData {
    ...
    public static PxBoundedData createAt(long address) {
        PxBoundedData.__placement_new_PxBoundedData(address);
    ...
    public PxBoundedData() {
        this.address = PxBoundedData._PxBoundedData();
    }
    ...
    public void destroy() {
        ...
        PxBoundedData._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public int getCount() {
        this.checkNotNull();
        return PxBoundedData._getCount(this.address);
    }
    ...
    public void setCount(int value) {
        this.checkNotNull();
        PxBoundedData._setCount(this.address, value);
    }
