...
public class PxTopLevelFunctions
extends NativeObject {
    public static final int SIZEOF = PxTopLevelFunctions.__sizeOf();
    ...
    public static PxTopLevelFunctions arrayGet(long baseAddress, int index) {
        ...
        return PxTopLevelFunctions.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public static int getPHYSICS_VERSION() {
        return PxTopLevelFunctions._getPHYSICS_VERSION();
    }

    private static native int _getPHYSICS_VERSION();

    public static PxSimulationFilterShader DefaultFilterShader() {
        return PxSimulationFilterShader.wrapPointer(PxTopLevelFunctions._DefaultFilterShader());
    }
    ...
    public static void setupPassThroughFilterShader(PxSceneDesc sceneDesc, PassThroughFilterShader filterShader) {
        PxTopLevelFunctions._setupPassThroughFilterShader(sceneDesc.getAddress(), filterShader.getAddress());
    }
    ...
    public static PxControllerManager CreateControllerManager(PxScene scene) {
        return PxControllerManager.wrapPointer(PxTopLevelFunctions._CreateControllerManager(scene.getAddress()));
    }
    ...
    public static PxControllerManager CreateControllerManager(PxScene scene, boolean lockingEnabled) {
        return PxControllerManager.wrapPointer(PxTopLevelFunctions._CreateControllerManager(scene.getAddress(), lockingEnabled));
    }
    ...
    public static PxFoundation CreateFoundation(int version, PxDefaultAllocator allocator, PxErrorCallback errorCallback) {
        return PxFoundation.wrapPointer(PxTopLevelFunctions._CreateFoundation(version, allocator.getAddress(), errorCallback.getAddress()));
    }
    ...
    public static PxPhysics CreatePhysics(int version, PxFoundation foundation, PxTolerancesScale params) {
        return PxPhysics.wrapPointer(PxTopLevelFunctions._CreatePhysics(version, foundation.getAddress(), params.getAddress()));
    }
    ...
    public static PxPhysics CreatePhysics(int version, PxFoundation foundation, PxTolerancesScale params, PxPvd pvd) {
        return PxPhysics.wrapPointer(PxTopLevelFunctions._CreatePhysics(version, foundation.getAddress(), params.getAddress(), pvd != null ? pvd.getAddress() : 0L));
    }
    ...
    public static PxPhysics CreatePhysics(int version, PxFoundation foundation, PxTolerancesScale params, PxPvd pvd, PxOmniPvd omniPvd) {
        return PxPhysics.wrapPointer(PxTopLevelFunctions._CreatePhysics(version, foundation.getAddress(), params.getAddress(), pvd != null ? pvd.getAddress() : 0L, omniPvd != null ? omniPvd.getAddress() : 0L));
    }
    ...
    public static PxPvdTransport DefaultPvdSocketTransportCreate(String host, int port, int timeoutInMilliseconds) {
        ...
        return PxPvdTransport.wrapPointer(PxTopLevelFunctions._DefaultPvdSocketTransportCreate(host, port, timeoutInMilliseconds));
    }
    ...
    public static PxOmniPvd CreateOmniPvd(PxFoundation foundation) {
        PlatformChecks.requirePlatform(7, "physx.PxTopLevelFunctions");
        return PxOmniPvd.wrapPointer(PxTopLevelFunctions._CreateOmniPvd(foundation.getAddress()));
    }
    ...
    public static PxD6Joint D6JointCreate(PxPhysics physics, PxRigidActor actor0, PxTransform localFrame0, PxRigidActor actor1, PxTransform localFrame1) {
        return PxD6Joint.wrapPointer(PxTopLevelFunctions._D6JointCreate(physics.getAddress(), actor0 != null ? actor0.getAddress() : 0L, localFrame0.getAddress(), actor1 != null ? actor1.getAddress() : 0L, localFrame1.getAddress()));
    }
    ...
    public static PxDistanceJoint DistanceJointCreate(PxPhysics physics, PxRigidActor actor0, PxTransform localFrame0, PxRigidActor actor1, PxTransform localFrame1) {
        return PxDistanceJoint.wrapPointer(PxTopLevelFunctions._DistanceJointCreate(physics.getAddress(), actor0 != null ? actor0.getAddress() : 0L, localFrame0.getAddress(), actor1 != null ? actor1.getAddress() : 0L, localFrame1.getAddress()));
    }
    ...
    public static PxFixedJoint FixedJointCreate(PxPhysics physics, PxRigidActor actor0, PxTransform localFrame0, PxRigidActor actor1, PxTransform localFrame1) {
        return PxFixedJoint.wrapPointer(PxTopLevelFunctions._FixedJointCreate(physics.getAddress(), actor0 != null ? actor0.getAddress() : 0L, localFrame0.getAddress(), actor1 != null ? actor1.getAddress() : 0L, localFrame1.getAddress()));
    }
    ...
    public static PxPrismaticJoint PrismaticJointCreate(PxPhysics physics, PxRigidActor actor0, PxTransform localFrame0, PxRigidActor actor1, PxTransform localFrame1) {
        return PxPrismaticJoint.wrapPointer(PxTopLevelFunctions._PrismaticJointCreate(physics.getAddress(), actor0 != null ? actor0.getAddress() : 0L, localFrame0.getAddress(), actor1 != null ? actor1.getAddress() : 0L, localFrame1.getAddress()));
    }
    ...
    public static PxRevoluteJoint RevoluteJointCreate(PxPhysics physics, PxRigidActor actor0, PxTransform localFrame0, PxRigidActor actor1, PxTransform localFrame1) {
        return PxRevoluteJoint.wrapPointer(PxTopLevelFunctions._RevoluteJointCreate(physics.getAddress(), actor0 != null ? actor0.getAddress() : 0L, localFrame0.getAddress(), actor1 != null ? actor1.getAddress() : 0L, localFrame1.getAddress()));
    }
    ...
    public static PxSphericalJoint SphericalJointCreate(PxPhysics physics, PxRigidActor actor0, PxTransform localFrame0, PxRigidActor actor1, PxTransform localFrame1) {
        return PxSphericalJoint.wrapPointer(PxTopLevelFunctions._SphericalJointCreate(physics.getAddress(), actor0 != null ? actor0.getAddress() : 0L, localFrame0.getAddress(), actor1 != null ? actor1.getAddress() : 0L, localFrame1.getAddress()));
    }
    ...
    public static PxConvexMesh CreateConvexMesh(PxCookingParams params, PxConvexMeshDesc desc) {
        return PxConvexMesh.wrapPointer(PxTopLevelFunctions._CreateConvexMesh(params.getAddress(), desc.getAddress()));
    }
    ...
    public static PxTriangleMesh CreateTriangleMesh(PxCookingParams params, PxTriangleMeshDesc desc) {
        return PxTriangleMesh.wrapPointer(PxTopLevelFunctions._CreateTriangleMesh(params.getAddress(), desc.getAddress()));
    }
    ...
    public static PxHeightField CreateHeightField(PxHeightFieldDesc desc) {
        return PxHeightField.wrapPointer(PxTopLevelFunctions._CreateHeightField(desc.getAddress()));
    }
