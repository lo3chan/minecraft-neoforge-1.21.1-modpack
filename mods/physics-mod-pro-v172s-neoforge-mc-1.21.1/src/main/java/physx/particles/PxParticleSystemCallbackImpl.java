...
import physx.particles.PxParticleSystemCallback;

public class PxParticleSystemCallbackImpl
extends PxParticleSystemCallback {
    ...
    public static PxParticleSystemCallbackImpl arrayGet(long baseAddress, int index) {
        ...
        return PxParticleSystemCallbackImpl.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxParticleSystemCallbackImpl._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    static {
        ...
        SIZEOF = PxParticleSystemCallbackImpl.__sizeOf();
    }
}
