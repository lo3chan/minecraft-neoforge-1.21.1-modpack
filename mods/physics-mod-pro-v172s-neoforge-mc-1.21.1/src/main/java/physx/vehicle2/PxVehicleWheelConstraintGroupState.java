...
public class PxVehicleWheelConstraintGroupState
extends NativeObject {
    public static final int SIZEOF = PxVehicleWheelConstraintGroupState.__sizeOf();
    ...
    public static PxVehicleWheelConstraintGroupState arrayGet(long baseAddress, int index) {
        ...
        return PxVehicleWheelConstraintGroupState.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public PxVehicleWheelConstraintGroupState() {
        this.address = PxVehicleWheelConstraintGroupState._PxVehicleWheelConstraintGroupState();
    }
    ...
    public void destroy() {
        ...
        PxVehicleWheelConstraintGroupState._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public int getNbGroups() {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getNbGroups(this.address);
    }
    ...
    public void setNbGroups(int value) {
        this.checkNotNull();
        PxVehicleWheelConstraintGroupState._setNbGroups(this.address, value);
    }
    ...
    public int getNbWheelsPerGroup(int index) {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getNbWheelsPerGroup(this.address, index);
    }
    ...
    public void setNbWheelsPerGroup(int index, int value) {
        this.checkNotNull();
        PxVehicleWheelConstraintGroupState._setNbWheelsPerGroup(this.address, index, value);
    }
    ...
    public int getGroupToWheelIds(int index) {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getGroupToWheelIds(this.address, index);
    }
    ...
    public void setGroupToWheelIds(int index, int value) {
        this.checkNotNull();
        PxVehicleWheelConstraintGroupState._setGroupToWheelIds(this.address, index, value);
    }
    ...
    public int getWheelIdsInGroupOrder(int index) {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getWheelIdsInGroupOrder(this.address, index);
    }
    ...
    public void setWheelIdsInGroupOrder(int index, int value) {
        this.checkNotNull();
        PxVehicleWheelConstraintGroupState._setWheelIdsInGroupOrder(this.address, index, value);
    }
    ...
    public float getWheelMultipliersInGroupOrder(int index) {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getWheelMultipliersInGroupOrder(this.address, index);
    }
    ...
    public void setWheelMultipliersInGroupOrder(int index, float value) {
        this.checkNotNull();
        PxVehicleWheelConstraintGroupState._setWheelMultipliersInGroupOrder(this.address, index, value);
    }
    ...
    public int getNbWheelsInGroups() {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getNbWheelsInGroups(this.address);
    }
    ...
    public void setNbWheelsInGroups(int value) {
        this.checkNotNull();
        PxVehicleWheelConstraintGroupState._setNbWheelsInGroups(this.address, value);
    }
    ...
    public void setToDefault() {
        this.checkNotNull();
        PxVehicleWheelConstraintGroupState._setToDefault(this.address);
    }
    ...
    public int getNbConstraintGroups() {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getNbConstraintGroups(this.address);
    }
    ...
    public int getNbWheelsInConstraintGroup(int i) {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getNbWheelsInConstraintGroup(this.address, i);
    }
    ...
    public int getWheelInConstraintGroup(int j, int i) {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getWheelInConstraintGroup(this.address, j, i);
    }
    ...
    public float getMultiplierInConstraintGroup(int j, int i) {
        this.checkNotNull();
        return PxVehicleWheelConstraintGroupState._getMultiplierInConstraintGroup(this.address, j, i);
    }
