...
public class PxVehicleTireGripState
extends NativeObject {
    public static final int SIZEOF = PxVehicleTireGripState.__sizeOf();
    ...
    public static PxVehicleTireGripState arrayGet(long baseAddress, int index) {
        ...
        return PxVehicleTireGripState.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxVehicleTireGripState._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public float getLoad() {
        this.checkNotNull();
        return PxVehicleTireGripState._getLoad(this.address);
    }
    ...
    public void setLoad(float value) {
        this.checkNotNull();
        PxVehicleTireGripState._setLoad(this.address, value);
    }
    ...
    public float getFriction() {
        this.checkNotNull();
        return PxVehicleTireGripState._getFriction(this.address);
    }
    ...
    public void setFriction(float value) {
        this.checkNotNull();
        PxVehicleTireGripState._setFriction(this.address, value);
    }
    ...
    public void setToDefault() {
        this.checkNotNull();
        PxVehicleTireGripState._setToDefault(this.address);
    }
