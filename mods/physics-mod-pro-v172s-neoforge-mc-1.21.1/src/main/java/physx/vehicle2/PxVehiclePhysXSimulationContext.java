...
public class PxVehiclePhysXSimulationContext
extends PxVehicleSimulationContext {
    public static final int SIZEOF = PxVehiclePhysXSimulationContext.__sizeOf();
    ...
    public static PxVehiclePhysXSimulationContext arrayGet(long baseAddress, int index) {
        ...
        return PxVehiclePhysXSimulationContext.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public PxVehiclePhysXSimulationContext() {
        this.address = PxVehiclePhysXSimulationContext._PxVehiclePhysXSimulationContext();
    }
    ...
    public PxConvexMesh getPhysxUnitCylinderSweepMesh() {
        this.checkNotNull();
        return PxConvexMesh.wrapPointer(PxVehiclePhysXSimulationContext._getPhysxUnitCylinderSweepMesh(this.address));
    }
    ...
    public void setPhysxUnitCylinderSweepMesh(PxConvexMesh value) {
        this.checkNotNull();
        PxVehiclePhysXSimulationContext._setPhysxUnitCylinderSweepMesh(this.address, value.getAddress());
    }
    ...
    public PxScene getPhysxScene() {
        this.checkNotNull();
        return PxScene.wrapPointer(PxVehiclePhysXSimulationContext._getPhysxScene(this.address));
    }
    ...
    public void setPhysxScene(PxScene value) {
        this.checkNotNull();
        PxVehiclePhysXSimulationContext._setPhysxScene(this.address, value.getAddress());
    }
    ...
    public PxVehiclePhysXActorUpdateModeEnum getPhysxActorUpdateMode() {
        this.checkNotNull();
        return PxVehiclePhysXActorUpdateModeEnum.forValue(PxVehiclePhysXSimulationContext._getPhysxActorUpdateMode(this.address));
    }
    ...
    public void setPhysxActorUpdateMode(PxVehiclePhysXActorUpdateModeEnum value) {
        this.checkNotNull();
        PxVehiclePhysXSimulationContext._setPhysxActorUpdateMode(this.address, value.value);
    }
    ...
    public float getPhysxActorWakeCounterResetValue() {
        this.checkNotNull();
        return PxVehiclePhysXSimulationContext._getPhysxActorWakeCounterResetValue(this.address);
    }
    ...
    public void setPhysxActorWakeCounterResetValue(float value) {
        this.checkNotNull();
        PxVehiclePhysXSimulationContext._setPhysxActorWakeCounterResetValue(this.address, value);
    }
    ...
    public float getPhysxActorWakeCounterThreshold() {
        this.checkNotNull();
        return PxVehiclePhysXSimulationContext._getPhysxActorWakeCounterThreshold(this.address);
    }
    ...
    public void setPhysxActorWakeCounterThreshold(float value) {
        this.checkNotNull();
        PxVehiclePhysXSimulationContext._setPhysxActorWakeCounterThreshold(this.address, value);
    }
    ...
    public PxVehiclePhysXSimulationContext transformAndScale(PxVehicleFrame srcFrame, PxVehicleFrame trgFrame, PxVehicleScale srcScale, PxVehicleScale trgScale) {
        this.checkNotNull();
        return PxVehiclePhysXSimulationContext.wrapPointer(PxVehiclePhysXSimulationContext._transformAndScale(this.address, srcFrame.getAddress(), trgFrame.getAddress(), srcScale.getAddress(), trgScale.getAddress()));
    }
