...
public class PxVehiclePhysXConstraintState
extends NativeObject {
    public static final int SIZEOF = PxVehiclePhysXConstraintState.__sizeOf();
    ...
    public static PxVehiclePhysXConstraintState arrayGet(long baseAddress, int index) {
        ...
        return PxVehiclePhysXConstraintState.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public PxVehiclePhysXConstraintState() {
        this.address = PxVehiclePhysXConstraintState._PxVehiclePhysXConstraintState();
    }
    ...
    public void destroy() {
        ...
        PxVehiclePhysXConstraintState._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public boolean getTireActiveStatus(int index) {
        this.checkNotNull();
        return PxVehiclePhysXConstraintState._getTireActiveStatus(this.address, index);
    }
    ...
    public void setTireActiveStatus(int index, boolean value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setTireActiveStatus(this.address, index, value);
    }
    ...
    public PxVec3 getTireLinears(int index) {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxVehiclePhysXConstraintState._getTireLinears(this.address, index));
    }
    ...
    public void setTireLinears(int index, PxVec3 value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setTireLinears(this.address, index, value.getAddress());
    }
    ...
    public PxVec3 getTireAngulars(int index) {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxVehiclePhysXConstraintState._getTireAngulars(this.address, index));
    }
    ...
    public void setTireAngulars(int index, PxVec3 value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setTireAngulars(this.address, index, value.getAddress());
    }
    ...
    public float getTireDamping(int index) {
        this.checkNotNull();
        return PxVehiclePhysXConstraintState._getTireDamping(this.address, index);
    }
    ...
    public void setTireDamping(int index, float value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setTireDamping(this.address, index, value);
    }
    ...
    public boolean getSuspActiveStatus() {
        this.checkNotNull();
        return PxVehiclePhysXConstraintState._getSuspActiveStatus(this.address);
    }
    ...
    public void setSuspActiveStatus(boolean value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setSuspActiveStatus(this.address, value);
    }
    ...
    public PxVec3 getSuspLinear() {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxVehiclePhysXConstraintState._getSuspLinear(this.address));
    }
    ...
    public void setSuspLinear(PxVec3 value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setSuspLinear(this.address, value.getAddress());
    }
    ...
    public PxVec3 getSuspAngular() {
        this.checkNotNull();
        return PxVec3.wrapPointer(PxVehiclePhysXConstraintState._getSuspAngular(this.address));
    }
    ...
    public void setSuspAngular(PxVec3 value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setSuspAngular(this.address, value.getAddress());
    }
    ...
    public float getSuspGeometricError() {
        this.checkNotNull();
        return PxVehiclePhysXConstraintState._getSuspGeometricError(this.address);
    }
    ...
    public void setSuspGeometricError(float value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setSuspGeometricError(this.address, value);
    }
    ...
    public float getRestitution() {
        this.checkNotNull();
        return PxVehiclePhysXConstraintState._getRestitution(this.address);
    }
    ...
    public void setRestitution(float value) {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setRestitution(this.address, value);
    }
    ...
    public void setToDefault() {
        this.checkNotNull();
        PxVehiclePhysXConstraintState._setToDefault(this.address);
    }
