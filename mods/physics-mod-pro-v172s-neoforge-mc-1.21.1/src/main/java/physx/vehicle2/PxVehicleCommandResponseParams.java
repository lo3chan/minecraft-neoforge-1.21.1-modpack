...
import physx.vehicle2.PxVehicleCommandNonLinearResponseParams;

public class PxVehicleCommandResponseParams
extends NativeObject {
    public static final int SIZEOF = PxVehicleCommandResponseParams.__sizeOf();
    ...
    public static PxVehicleCommandResponseParams arrayGet(long baseAddress, int index) {
        ...
        return PxVehicleCommandResponseParams.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public PxVehicleCommandResponseParams() {
        this.address = PxVehicleCommandResponseParams._PxVehicleCommandResponseParams();
    }
    ...
    public void destroy() {
        ...
        PxVehicleCommandResponseParams._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public PxVehicleCommandNonLinearResponseParams getNonlinearResponse() {
        this.checkNotNull();
        return PxVehicleCommandNonLinearResponseParams.wrapPointer(PxVehicleCommandResponseParams._getNonlinearResponse(this.address));
    }
    ...
    public void setNonlinearResponse(PxVehicleCommandNonLinearResponseParams value) {
        this.checkNotNull();
        PxVehicleCommandResponseParams._setNonlinearResponse(this.address, value.getAddress());
    }
    ...
    public float getWheelResponseMultipliers(int index) {
        this.checkNotNull();
        return PxVehicleCommandResponseParams._getWheelResponseMultipliers(this.address, index);
    }
    ...
    public void setWheelResponseMultipliers(int index, float value) {
        this.checkNotNull();
        PxVehicleCommandResponseParams._setWheelResponseMultipliers(this.address, index, value);
    }
    ...
    public float getMaxResponse() {
        this.checkNotNull();
        return PxVehicleCommandResponseParams._getMaxResponse(this.address);
    }
    ...
    public void setMaxResponse(float value) {
        this.checkNotNull();
        PxVehicleCommandResponseParams._setMaxResponse(this.address, value);
    }
