...
public class PxVehicleCommandState
extends NativeObject {
    public static final int SIZEOF = PxVehicleCommandState.__sizeOf();
    ...
    public static PxVehicleCommandState arrayGet(long baseAddress, int index) {
        ...
        return PxVehicleCommandState.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public PxVehicleCommandState() {
        this.address = PxVehicleCommandState._PxVehicleCommandState();
    }
    ...
    public void destroy() {
        ...
        PxVehicleCommandState._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public float getBrakes(int index) {
        this.checkNotNull();
        return PxVehicleCommandState._getBrakes(this.address, index);
    }
    ...
    public void setBrakes(int index, float value) {
        this.checkNotNull();
        PxVehicleCommandState._setBrakes(this.address, index, value);
    }
    ...
    public int getNbBrakes() {
        this.checkNotNull();
        return PxVehicleCommandState._getNbBrakes(this.address);
    }
    ...
    public void setNbBrakes(int value) {
        this.checkNotNull();
        PxVehicleCommandState._setNbBrakes(this.address, value);
    }
    ...
    public float getThrottle() {
        this.checkNotNull();
        return PxVehicleCommandState._getThrottle(this.address);
    }
    ...
    public void setThrottle(float value) {
        this.checkNotNull();
        PxVehicleCommandState._setThrottle(this.address, value);
    }
    ...
    public float getSteer() {
        this.checkNotNull();
        return PxVehicleCommandState._getSteer(this.address);
    }
    ...
    public void setSteer(float value) {
        this.checkNotNull();
        PxVehicleCommandState._setSteer(this.address, value);
    }
    ...
    public void setToDefault() {
        this.checkNotNull();
        PxVehicleCommandState._setToDefault(this.address);
    }
