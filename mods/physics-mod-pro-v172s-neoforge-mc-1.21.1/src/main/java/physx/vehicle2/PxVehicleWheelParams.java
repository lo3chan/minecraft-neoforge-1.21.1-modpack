...
public class PxVehicleWheelParams
extends NativeObject {
    public static final int SIZEOF = PxVehicleWheelParams.__sizeOf();
    ...
    public static PxVehicleWheelParams arrayGet(long baseAddress, int index) {
        ...
        return PxVehicleWheelParams.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public PxVehicleWheelParams() {
        this.address = PxVehicleWheelParams._PxVehicleWheelParams();
    }
    ...
    public void destroy() {
        ...
        PxVehicleWheelParams._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public float getRadius() {
        this.checkNotNull();
        return PxVehicleWheelParams._getRadius(this.address);
    }
    ...
    public void setRadius(float value) {
        this.checkNotNull();
        PxVehicleWheelParams._setRadius(this.address, value);
    }
    ...
    public float getHalfWidth() {
        this.checkNotNull();
        return PxVehicleWheelParams._getHalfWidth(this.address);
    }
    ...
    public void setHalfWidth(float value) {
        this.checkNotNull();
        PxVehicleWheelParams._setHalfWidth(this.address, value);
    }
    ...
    public float getMass() {
        this.checkNotNull();
        return PxVehicleWheelParams._getMass(this.address);
    }
    ...
    public void setMass(float value) {
        this.checkNotNull();
        PxVehicleWheelParams._setMass(this.address, value);
    }
    ...
    public float getMoi() {
        this.checkNotNull();
        return PxVehicleWheelParams._getMoi(this.address);
    }
    ...
    public void setMoi(float value) {
        this.checkNotNull();
        PxVehicleWheelParams._setMoi(this.address, value);
    }
    ...
    public float getDampingRate() {
        this.checkNotNull();
        return PxVehicleWheelParams._getDampingRate(this.address);
    }
    ...
    public void setDampingRate(float value) {
        this.checkNotNull();
        PxVehicleWheelParams._setDampingRate(this.address, value);
    }
    ...
    public PxVehicleWheelParams transformAndScale(PxVehicleFrame srcFrame, PxVehicleFrame trgFrame, PxVehicleScale srcScale, PxVehicleScale trgScale) {
        this.checkNotNull();
        return PxVehicleWheelParams.wrapPointer(PxVehicleWheelParams._transformAndScale(this.address, srcFrame.getAddress(), trgFrame.getAddress(), srcScale.getAddress(), trgScale.getAddress()));
    }
    ...
    public boolean isValid() {
        this.checkNotNull();
        return PxVehicleWheelParams._isValid(this.address);
    }
