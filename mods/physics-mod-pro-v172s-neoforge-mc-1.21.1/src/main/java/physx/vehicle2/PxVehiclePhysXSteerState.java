...
public class PxVehiclePhysXSteerState
extends NativeObject {
    public static final int SIZEOF = PxVehiclePhysXSteerState.__sizeOf();
    ...
    public static PxVehiclePhysXSteerState arrayGet(long baseAddress, int index) {
        ...
        return PxVehiclePhysXSteerState.wrapPointer(baseAddress + (long)SIZEOF * (long)index);
    }
    ...
    public void destroy() {
        ...
        PxVehiclePhysXSteerState._delete_native_instance(this.address);
        this.address = 0L;
    }
    ...
    public float getPreviousSteerCommand() {
        this.checkNotNull();
        return PxVehiclePhysXSteerState._getPreviousSteerCommand(this.address);
    }
    ...
    public void setPreviousSteerCommand(float value) {
        this.checkNotNull();
        PxVehiclePhysXSteerState._setPreviousSteerCommand(this.address, value);
    }
    ...
    public void setToDefault() {
        this.checkNotNull();
        PxVehiclePhysXSteerState._setToDefault(this.address);
    }
