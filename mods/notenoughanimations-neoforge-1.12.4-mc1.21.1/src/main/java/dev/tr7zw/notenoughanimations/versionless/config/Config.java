...
public class Config {
    ...
    public Set<String> holdingItems = new HashSet<String>(Arrays.asList("minecraft:clock", "minecraft:compass", "minecraft:torch", "minecraft:lantern", "minecraft:soul_torch", "minecraft:soul_lantern", "minecraft:recovery_compass", "quad-mstv-mtv:acacia_torch", "quad-mstv-mtv:bamboo_torch", "quad-mstv-mtv:birch_torch", "quad-mstv-mtv:cherry_torch", "quad-mstv-mtv:crimson_torch", "quad-mstv-mtv:dark_oak_torch", "quad-mstv-mtv:pale_oak_torch", "quad-mstv-mtv:jungle_torch", "quad-mstv-mtv:mangrove_torch", "quad-mstv-mtv:spruce_torch", "quad-mstv-mtv:warped_torch", "quad-mstv-mtv:acacia_soul_torch", "quad-mstv-mtv:bamboo_soul_torch", "quad-mstv-mtv:birch_soul_torch", "quad-mstv-mtv:cherry_soul_torch", "quad-mstv-mtv:crimson_soul_torch", "quad-mstv-mtv:dark_oak_soul_torch", "quad-mstv-mtv:pale_oak_soul_torch", "quad-mstv-mtv:jungle_soul_torch", "quad-mstv-mtv:mangrove_soul_torch", "quad-mstv-mtv:spruce_soul_torch", "quad-mstv-mtv:warped_soul_torch", "minecraft:copper_lantern", "minecraft:exposed_copper_lantern", "minecraft:waxed_copper_lantern", "minecraft:waxed_exposed_copper_lantern", "minecraft:waxed_oxidized_copper_lantern", "minecraft:weathered_copper_lantern", "minecraft:waxed_weathered_copper_lantern"));
    ...
    public float ladderAnimationArmSpeed = 2.0f;
    ...
    public Set<String> sheathSwords = new HashSet<String>(Arrays.asList("minecraft:wooden_sword", "minecraft:stone_sword", "minecraft:golden_sword", "minecraft:iron_sword", "minecraft:diamond_sword", "minecraft:netherite_sword"));
    ...
    public float holdUpItemOffset = 0.0f;
    ...
    public Set<String> hideItemsForTheseBows = new HashSet<String>();
    public Set<String> mapHolding = new HashSet<String>(Arrays.asList("minecraft:filled_map", "antiqueatlas:antique_atlas"));
    public boolean animateLanterns = true;
    public Set<String> lanternItems = new HashSet<String>(Arrays.asList("minecraft:waxed_copper_lantern", "minecraft:waxed_exposed_copper_lantern", "minecraft:soul_lantern", "minecraft:waxed_oxidized_copper_lantern", "minecraft:exposed_copper_lantern", "minecraft:lantern", "minecraft:waxed_weathered_copper_lantern", "minecraft:weathered_copper_lantern", "minecraft:oxidized_copper_lantern", "minecraft:copper_lantern"));
