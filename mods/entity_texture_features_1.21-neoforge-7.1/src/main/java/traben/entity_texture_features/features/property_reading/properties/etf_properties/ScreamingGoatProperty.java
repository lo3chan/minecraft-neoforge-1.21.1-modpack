...
public class ScreamingGoatProperty
extends BooleanProperty {
    protected ScreamingGoatProperty(Properties properties, int propertyNum) throws RandomProperty.RandomPropertyException {
        super(ScreamingGoatProperty.getGenericBooleanThatCanNull(properties, propertyNum, "screamingGoat", "screaming_goat"));
    }
    ...
    protected Boolean getValueFromEntity(ETFEntityRenderState etfEntity) {
        ETFEntity eTFEntity;
        if (etfEntity != null && (eTFEntity = etfEntity.entity()) instanceof Goat) {
            Goat goat = (Goat)eTFEntity;
