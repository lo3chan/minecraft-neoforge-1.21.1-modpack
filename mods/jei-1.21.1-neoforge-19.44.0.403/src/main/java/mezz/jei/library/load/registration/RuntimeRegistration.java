...
implements IRuntimeRegistration {
    ...
    public RuntimeRegistration(IRecipeManager recipeManager, IJeiHelpers jeiHelpers, IEditModeConfig editModeConfig, IIngredientManager ingredientManager, IRecipeTransferManager recipeTransferManager, IScreenHelper screenHelper, ISearchStorageBuilderFactory searchStorageBuilderFactory) {
    ...
    public ISearchStorageFactory getSearchStorageFactory() {
        return new ISearchStorageFactory(){
            ...
            public <T> ISearchStorage<T> createSearchStorage() {
                return RuntimeRegistration.this.searchStorageBuilderFactory.create().build();
            }
        };
    }
    ...
    public ISearchStorageBuilderFactory getSearchStorageBuilderFactory() {
        return this.searchStorageBuilderFactory;
    }
