...
extends AbstractRecipeCategory<RecipeHolder<StonecutterRecipe>> {
    public static final int width = 82;
    public static final int height = 34;

    public StoneCuttingRecipeCategory(IGuiHelper guiHelper) {
        super(RecipeTypes.STONECUTTING, (Component)Component.translatable((String)"gui.jei.category.stoneCutter"), guiHelper.createDrawableItemLike((ItemLike)Blocks.STONECUTTER), 82, 34);
    }
