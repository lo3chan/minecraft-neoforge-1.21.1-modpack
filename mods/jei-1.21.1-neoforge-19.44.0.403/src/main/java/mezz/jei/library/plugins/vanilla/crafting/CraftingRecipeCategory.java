...
implements IExtendableCraftingRecipeCategory {
    ...
    public CraftingRecipeCategory(IGuiHelper guiHelper) {
        super(RecipeTypes.CRAFTING, (Component)Component.translatable((String)"gui.jei.category.craftingTable"), guiHelper.createDrawableItemLike((ItemLike)Blocks.CRAFTING_TABLE), 116, 54);
