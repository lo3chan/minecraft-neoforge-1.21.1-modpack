...
public class AdvancedSearchRegistration
implements IAdvancedSearchRegistration {
    ...
    public ISearchStorageBuilderFactory getDefaultSearchStorageBuilderFactory() {
        return this.defaultSearchStorageBuilderFactory;
    }

    @Override
    public void replaceSearchStorage(final ISearchStorageFactory searchStorageFactory) {
        ErrorUtil.checkNotNull(searchStorageFactory, "searchStorageFactory");
        LOGGER.info("Replaced search storage factory: {}", (Object)searchStorageFactory);
    ...
    public void replaceSearchStorage(ISearchStorageBuilderFactory searchStorageBuilderFactory) {
        ...
        LOGGER.info("Replaced search storage factory: {}", (Object)searchStorageBuilderFactory);
    ...
    public Optional<ISearchStorageBuilderFactory> getSearchStorageBuilderFactoryOverride() {
        return Optional.ofNullable(this.searchStorageBuilderFactoryOverride);
    }
}
