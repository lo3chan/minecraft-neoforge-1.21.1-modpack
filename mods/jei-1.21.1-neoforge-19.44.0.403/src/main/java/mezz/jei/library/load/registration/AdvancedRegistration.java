...
import mezz.jei.library.load.registration.TypedRecipeManagerPluginAdapter;
...
implements IAdvancedRegistration {
    ...
    private final List<IRecipeButtonControllerFactory> recipeButtonControllerFactories = new ArrayList<IRecipeButtonControllerFactory>();
    ...
    public <T> void addTypedRecipeManagerPlugin(RecipeType<T> recipeType, ISimpleRecipeManagerPlugin<T> recipeManagerPlugin) {
        ...
        ErrorUtil.checkNotNull(recipeManagerPlugin, "recipeManagerPlugin");
        TypedRecipeManagerPluginAdapter<T> adapter = new TypedRecipeManagerPluginAdapter<T>(this.pluginHelper, recipeType, recipeManagerPlugin);
    ...
    public <T> void addRecipeCategoryDecorator(RecipeType<T> recipeType, IRecipeCategoryDecorator<T> decorator) {
        ...
        LOGGER.info("Added recipe category decorator: {} for recipe type: {}", decorator.getClass(), (Object)recipeType.getUid());
    ...
    public @Unmodifiable List<IRecipeButtonControllerFactory> getRecipeButtonControllerFactories() {
        return List.copyOf(this.recipeButtonControllerFactories);
    }

    public @Unmodifiable ImmutableListMultimap<RecipeType<?>, IRecipeCategoryDecorator<?>> getRecipeCategoryDecorators() {
