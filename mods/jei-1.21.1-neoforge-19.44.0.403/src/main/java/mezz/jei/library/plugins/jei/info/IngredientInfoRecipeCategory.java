...
extends AbstractRecipeCategory<IJeiIngredientInfoRecipe> {
    ...
    public IngredientInfoRecipeCategory(Textures textures) {
        super(RecipeTypes.INFORMATION, (Component)Component.translatable((String)"gui.jei.category.itemInformation"), textures.getInfoIcon(), 170, 125);
    }
