...
implements IDrawableAnimated {
    ...
    private static IDrawableAnimated.StartDirection invert(IDrawableAnimated.StartDirection startDirection) {
        return switch (startDirection) {
            ...
            case IDrawableAnimated.StartDirection.TOP -> IDrawableAnimated.StartDirection.BOTTOM;
            case IDrawableAnimated.StartDirection.BOTTOM -> IDrawableAnimated.StartDirection.TOP;
            case IDrawableAnimated.StartDirection.LEFT -> IDrawableAnimated.StartDirection.RIGHT;
            case IDrawableAnimated.StartDirection.RIGHT -> IDrawableAnimated.StartDirection.LEFT;
        };
    }
    ...
    public DrawableAnimated(IDrawableStatic drawable, int ticksPerCycle, IDrawableAnimated.StartDirection startDirection, boolean inverted) {
        IDrawableAnimated.StartDirection animationStartDirection = inverted ? DrawableAnimated.invert(startDirection) : startDirection;
    ...
    public void draw(GuiGraphics guiGraphics, int xOffset, int yOffset) {
        ...
        switch (this.startDirection) {
            ...
            default: {
                throw new IllegalStateException("Unknown startDirection " + String.valueOf((Object)this.startDirection));
            }
        }
