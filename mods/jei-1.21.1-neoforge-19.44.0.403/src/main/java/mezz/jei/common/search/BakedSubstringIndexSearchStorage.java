...
public class BakedSubstringIndexSearchStorage<T>
implements ISearchStorage<T> {
    ...
    public String statistics() {
        return "BakedSubstringIndexSearchStorage: baked=" + String.valueOf(this.bakedStorage) + ", runtimeStorage=" + this.mutableStorage.statistics();
    }
}
