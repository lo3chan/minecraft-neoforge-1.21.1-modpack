...
public class ClientToggleState
implements IClientToggleState {
    private final List<IClientToggleState.IEditModeListener> editModeListeners = new ArrayList<IClientToggleState.IEditModeListener>();
