...
implements IPlatformBrewingHelper {
    @Override
    public void registerCategoryExtensions(IExtendableBrewingRecipeCategory brewingCategory, IIngredientManager ingredientManager) {
    ...
    @Override
    public List<IJeiBrewingRecipe> getBrewingRecipes(IIngredientManager ingredientManager, IVanillaRecipeFactory vanillaRecipeFactory, PotionBrewing potionBrewing, BrewingExtensionHelper brewingExtensionHelper) {
        ...
        recipes.addAll(brewingExtensionHelper.getBrewingRecipes(potionBrewing.getRecipes(), vanillaRecipeFactory));
