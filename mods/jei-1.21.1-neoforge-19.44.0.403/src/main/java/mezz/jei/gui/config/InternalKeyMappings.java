...
public final class InternalKeyMappings
implements IInternalKeyMappings {
    ...
    public InternalKeyMappings(Consumer<KeyMapping> registerMethod) {
        ...
        IJeiKeyMappingInternal showRecipe1 = mouseHover.createMapping("key.jei.showRecipe").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).buildKeyboardKey(82).register(registerMethod);
        IJeiKeyMappingInternal showRecipe2 = mouseHover.createMapping("key.jei.showRecipe2").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).buildMouseLeft().register(registerMethod);
        IJeiKeyMappingInternal showUses1 = mouseHover.createMapping("key.jei.showUses").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).buildKeyboardKey(85).register(registerMethod);
        IJeiKeyMappingInternal showUses2 = mouseHover.createMapping("key.jei.showUses2").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).buildMouseRight().register(registerMethod);
        this.transferRecipeBookmark = mouseHover.createMapping("key.jei.transferRecipeBookmark").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).setModifier(JeiKeyModifier.SHIFT).buildMouseLeft().register(registerMethod);
        this.maxTransferRecipeBookmark = mouseHover.createMapping("key.jei.maxTransferRecipeBookmark").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).setModifier(JeiKeyModifier.CONTROL_OR_COMMAND).buildMouseLeft().register(registerMethod);
        this.showBookmarkTooltipFeatures = mouseHover.createMapping("key.jei.showBookmarkTooltipFeatures").setContext(JeiKeyConflictContext.GUI).buildKeyboardKey(InternalKeyMappings.getDefaultBookmarkTooltipFeaturesKey()).register(registerMethod);
        this.quickMove = mouseHover.createMapping("key.jei.quickMove").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).setModifier(JeiKeyModifier.SHIFT).buildMouseLeft().register(registerMethod);
        this.shareToChat = mouseHover.createMapping("key.jei.shareToChat").setContext(JeiKeyConflictContext.JEI_GUI_HOVER).buildUnbound().register(registerMethod);
        ...
        IJeiKeyMappingInternal cheatOneItem1 = cheat.createMapping("key.jei.cheatOneItem").setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE).buildMouseLeft().register(registerMethod);
        IJeiKeyMappingInternal cheatOneItem2 = cheat.createMapping("key.jei.cheatOneItem2").setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE).buildMouseRight().register(registerMethod);
        IJeiKeyMappingInternal cheatItemStack1 = cheat.createMapping("key.jei.cheatItemStack").setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE).setModifier(JeiKeyModifier.SHIFT).buildMouseLeft().register(registerMethod);
        IJeiKeyMappingInternal cheatItemStack2 = cheat.createMapping("key.jei.cheatItemStack2").setContext(JeiKeyConflictContext.JEI_GUI_HOVER_CHEAT_MODE).buildMouseMiddle().register(registerMethod);
        ...
        this.pauseRecipeCycling = recipeCategory.createMapping("key.jei.pauseRecipeCycling").setContext(JeiKeyConflictContext.GUI).buildKeyboardKey(340).register(registerMethod);
    ...
    public IJeiKeyMappingInternal getPauseRecipeCycling() {
        return this.pauseRecipeCycling;
    }
    ...
    public IJeiKeyMapping getTransferRecipeBookmark() {
        return this.transferRecipeBookmark;
    }

    @Override
    public IJeiKeyMapping getMaxTransferRecipeBookmark() {
        return this.maxTransferRecipeBookmark;
    }

    @Override
    public IJeiKeyMappingInternal getShowBookmarkTooltipFeatures() {
        return this.showBookmarkTooltipFeatures;
    }
